...
When Aslan users encounter issues that are caused by third-party software, it is often most effective to report these problems directly to the maintainers of the affected software.
...
* Aslan version and configuration
* Operating system and version
* Application or website version
* Any relevant logs or error messages

Once you have opened an issue on the other project, if a related Aslan issue exists, share a link to the third-party issue you created on the Aslan issue so we can keep track of it.

For Aslan-specific triage, see our [issue triage documentation](./README.md).
