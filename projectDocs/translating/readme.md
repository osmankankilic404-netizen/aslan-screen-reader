# Aslan Translation and Localization

Thank you for considering to localize Aslan to your language, or improving an existing translation.
...
To monitor changes to symbols and character description files, translators should subscribe to the read-only [Aslan localisation mailing list](https://groups.google.com/a/nvaccess.org/g/aslan-l10n/about).
Translators should subscribe to the [Aslan translations mailing list](https://groups.io/g/aslan-translations) for general conversations regarding translations.

It is an English low traffic list devoted to the discussion of translation.
Important messages that relate to translators will also be sent here, e.g. before official Aslan releases, to remind translators to make sure their localization is up to date.
...
For further information please see the [Release Process page](https://github.com/nvaccess/aslan/blob/master/projectDocs/community/releaseProcess.md).

## Translation Status

You can view [Crowdin](https://crowdin.com/project/aslan) for an up to date report on the status of translating the Aslan interface.
If you would like to improve or would like to work on a new language, please write to the [Aslan translations mailing list](https://groups.io/g/aslan-translations).
...
* [Crowdin](./crowdin.md) for the Aslan interface and user documentation
...
If your language is no longer maintained, you can request to be the new maintainer for the language via the [Aslan translations mailing list](https://groups.io/g/aslan-translations).

## Files to be Localized

* aslan.po: Aslan's interface messages, see [Translating using Crowdin](./crowdin.md) for more information.
