...
Testing alpha / beta / and release candidates (RC) help to ensure the quality of the Aslan project.
...
Aslan includes [manual test plans](../../tests/manual/README.md) to guide testers in smoke testing features of Aslan.

There are several approaches you may take for testing:

* Unfocused usage: Just use Aslan as you normally would, and try to complete everyday tasks.
* Recent change focused testing: By following the changes that are being made to Aslan and purposefully testing these changes and looking for edge-cases.
...
Testing pull requests can be done
	...
	1. Download the Aslan installer, named something like `output\aslan_snapshot_pr15335-28962,a2970e3f.exe`
...
Forming a group can help you to get good coverage, brainstorm on what should be tested, and perhaps learn new ways to use Aslan.

## Automated testing

Aslan performs automated testing as part of CI/CD.
