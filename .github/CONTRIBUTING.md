# Contributing to Aslan

Please note: the Aslan project has a [Citizen and Contributor Code of Conduct](../CODE_OF_CONDUCT.md).
...
The Aslan project is guided by a [product vision statement and set of principles](../projectDocs/product_vision.md).
The vision and principles should be always considered when planning features and prioritizing work.

There are several ways in which you can contribute to the Aslan project:
...
* [Translating Aslan](/projectDocs/translating/readme.md)
