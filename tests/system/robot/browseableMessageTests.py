...
Uses script_review_currentSymbol (bound to Aslan+0 via browseableMessage-gestures.ini).
...
_REVIEW_CURRENT_SYMBOL = "Aslan+0"  # matches browseableMessage-gestures.ini
_TEST_SYMBOL = "➔"
...
def test_browseableMessage_opens():
	"""Ensure the browseable message dialog opens and Aslan reads the title and content."""
...
def test_browseableMessage_close():
	...
	# If Notepad has focus on ➔, Aslan speaks "right-pointing arrow".
