...
This Rust crate contains example code to interface with `aslanControllerClient`.
The following instructions assume you have Rust installed.

To run the example:

1. Ensure the client library is built with `scons client` from the root of the Aslan repository.
