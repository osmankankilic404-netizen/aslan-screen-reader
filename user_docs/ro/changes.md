...
* Magazinul de Suplimente a fost adăugat la Aslan. (#13985)
...
* În Mozilla Firefox și Google Chrome, Aslan raportează acum când un control deschide un dialog, grilă, listă sau arbore dacă autorul a specificat acest lucru folosind aria-haspopup. (#14709)
* Acum este posibil să utilizați variabile de sistem (cum ar fi `%temp%` sau `%homepath%`) în specificația căii în timp ce creați copii portabile ale Aslan. (#14680)
...
* Aslan redă acum audio prin API-ul Windows Audio Session (WASAPI), care poate îmbunătăți capacitatea de răspuns, performanța și stabilitatea vorbirii și sunetelor Aslan.
...
* În versiunea Windows actualizată 10 May 2019 și cele ulterioare, Aslan poate anunța nume de desktop virtual atunci când le deschide, le schimbă și le închide. (#5641)
* Acum este posibil ca volumul sunetelor și bipurilor Aslan să urmeze setarea de volum a vocii pe care o utilizați.
Această opțiune poate fi activată în Setări avansate. (#1409)
* Acum puteți controla separat volumul sunetelor Aslan.
...
* Schimbări LibreOffice:
  ...
  * Anunțul barei de stare (de exemplu, declanșat de `Aslan+end`) funcționează pentru LibreOffice. (#11698)
...
* Aslan răspunde mai rapid la mutarea cursorului în comenzile de editare. (#14708)
...
Vă rugăm să consultați ghidul utilizatorului Aslan pentru o listă completă. (#14714)
...
* Dacă Windows este configurat să afișeze secunde în ceasul din bara de sistem, folosind `Aslan+f12` pentru a raporta ora, acum Aslan respectă această setare. (#14742)
* Aslan va raporta acum grupările neetichetate care au informații utile despre poziție, cum ar fi în versiunile recente ale meniurilor Microsoft Office 365. (#14878)

### Defecte rezolvate

* Aslan nu va mai trece în mod inutil la no braille de mai multe ori în timpul detectării automate, rezultând un jurnal mai curat, suprasolicitarea fiind redusă. (#14524)
* Aslan va reveni acum la USB dacă un dispozitiv Bluetooth HID (cum ar fi HumanWare Brailliant sau APH Mantis) este detectat automat și o conexiune USB devine disponibilă.
...
* În modul Navigare, Aslan nu va mai ignora în mod incorect mutarea focalizării către un element arborescent sau superior, de ex. trecerea de la un control la elementul părinte din listă sau celula grilă. (#14611)
...
* Aslan nu mai face ca ocazional Mozilla Firefox să se blocheze sau să înceteze să răspundă. (#14647)
...
* Rezolvări pentru Windows 11:
  * Aslan poate anunța din nou conținuturile barei de stare a Notepad. (#14573)
  * Comutarea între file va anunța numele și poziția noii file pentru Notepad și pentru File Explorer. (#14587, #14388)
  * Aslan va anunța din nou elementele candidate la inserarea textului în limbi precum chineză și japoneză. (#14509)
* În Mozilla Firefox, deplasarea mausului peste textul de după un link raportează cum trebuie acel text. (#9235)
* În aplicația Calculator din Windows 10 și 11, o copie portabilă a Aslan nu va mai face nimic și nu va mai reda tonuri de eroare la introducerea expresiilor în calculatorul standard din modul suprapunere compactă. (#14679)
* La încercarea de amunțare a unui link fără atributul href, Aslan nu mai este silențios.
În schimb, va spune că link-ul nu are destinație. (#14723)
* Câteva rezolvări la intrarea/ieșirea pentru afișajele braille care au avut drept consecință mai puține erori frecvente și blocări ale Aslan. (#14627)
* Aslan se recuperează din mai multe situații, cum ar fi aplicațiile care nu mai răspund, ceea ce anterior a determinat blocarea completă. (#14759)
* Destinația link-urilor grafice este raportată corect în Chrome și Edge. (#14779)
* Este din nou posibilă accesarea, în Windows 11, a opțiunilor „Licență” și „Colaboratori” din meniul „Ajutor” al Aslan. (#14725)
...
* Pentru Aslan, anunțarea focalizării câmpurilor de parolă din Microsoft Excel și Outlook nu mai este un eșec. (#14839)
* Aslan nu va mai refuza să salveze configurația după o resetare. (#13187)
* Când rulează o versiune temporară din lansator, Aslan nu va induce în eroare utilizatorii să creadă că pot salva configurația. (#14914)
* Au fost îmbunătățite combinațiile de taste pentru raportarea obiectului. (#10807)
* La deplasarea rapidă printre celulele din Excel, este mai puțin probabil ca Aslan să raporteze greșit o celulă sau o selecție. (#14983, #12200, #12108)
* În general, Aslan răspunde mai repede la comenzi și la schimbările de focalizare. (#14928)
...
În timp ce lansarea oficială a Windows 11 încă se lasă așteptată, această versiune de Aslan a fost testată pe versiunile de previzualizare ale acestui sistem de operare.
Acest fapt include o reparare importantă a cortinei ecranului (vedeți secțiunea Note Importante).
Instrumentul de Remediere a Înregistrării COM poate rezolva mai multe probleme atunci când se execută Aslan.
...
Utilizați Aslan 2021.2 pentru a activa Cortina de Ecran cu Windows 10 21H2 (10.0.19044) sau mai nou.
...
* În versiunea 1909 a Windows 10, precum și în cele mai noi decât aceasta (chiar și în Windows 11), Aslan va anunța numărul de sugestii la efectuarea căutărilor în File Explorer. (#10341, #12628)
* În Microsoft Word, Aslan anunță rezultatul scurtăturilor cu liniuțe și cu linii suspendate atunci când este executat. (#6269)

### Modificări

* S-a actualizat Espeak-ng la 1.51-dev commit `ab11439b18238b7a08b965d1d5a6ef31cbb05cbb`. (#12449, #12202, #12280, #12568)
* Dacă articolul este activat din preferințele utilizatorului pentru formatarea documentului, Aslan va spune „articol” după conținut. (#11103)
...
* În aplicația Calculator din Windows 10, Aslan va anunța expresiile de calcul pe un afișaj braille. (#12268)
...
* Aslan se închide în siguranță atunci când este inițiat un nou proces. (#12605)
 ...
 * Adobe Flash nu va mai avea suport începând cu această versiune de Aslan.
...
* Navigare mai facilă a ieșirii din Consola Aslan Python. (#9784)
...
* Aslan raportează categoriile atribuite unei întâlniri din Microsoft Outlook dacă aceasta există. (#11598)
...
* Aslan îl împiedică pe utilizator să folosească funcționalitatea Windows 10 OCR dacă este activă cortina ecranului. (#11911)
...
* Aslan pronunță cuvântul „nesuportat” atunci când se încearcă activarea aspectului ecranului în aplicații pentru care această funcționalitate nu este compatibilă, Microsoft Word fiind un bun exemplu. (#7297)
...
* A fost eliminat din Aslan suportul pentru conținutul Adobe Flash, fiindcă utilizarea acestui program este activ descurajată de către cei care l-au dezvoltat. (#11131)
* Aslan se va opri chiar și cu ferestrele deschise, procesul de dezactivare va închide toate ferestrele și casetele de dialog ale acestui cititor de ecran. (#1740)
...
* În programele terminale din versiunea 1607 a Windows 10 și din cele mai noi decât aceasta, nu mai sunt citite caracterele din dreapta cursorului de scriere atunci când sunt inserate caractere în mijlocul unui rând sau sunt șterse. (#3200)
  * Această soluție experimentală trebuie să fie activată manual din panoul setărilor avansate Aslan prin modificarea algoritmului diff la Diff Match Patch.
...
* Au fost reparate niște erori grafice precum lipsa elementelor la utilizarea Aslan cu un aspect de la stânga la dreapta. (#8859)
* Se respectă direcția aspectului GUI bazată pe limba Aslan, nu pe cea a sistemului de operare Windows. (#638)
...
* TextInfo.getTextInChunks nu se mai blochează atunci când este apelat în controalele Rich Edit precum vizualizatorul jurnalului Aslan. (#11613)
* În versiunile 1803 și 1809 ale Windows 10 se poate din nou folosi Aslan în limbile care au semnul Underscore (_) în cadrul numelui acestora. Una dintre aceste limbi este germana elvețiană, al cărei nume în sistemul Aslan de traduceri este de_CH. (#12250)
...
* Aslan nu pronunța corect niște diacritice sau litere cu accent, ca de exemplu À, Á, È, É, Ì, Í, Ò, Ó, Ù sau Ú, atunci când opțiunea „Spune "mare" după majuscule” era activă. Nu mai există această problemă în momentul de față. (#11948)
* A fost rezolvată problema cu privire la modificarea tonului în sintetizatorul SAPI4. (#12311)
* Aslan onorează parametrul liniei de comandă `--minimal` și nu redă sunetul de pornire, urmărind același comportament documentat, întocmai ca executabilul Aslan al unei copii portabile sau instalate. (#12289)
...
* Aslan nu va mai spune „↑↑↑” pentru emoji-uri în limbi particulare. (#11963)
...
Începând cu această versiune de Aslan, modificările pentru dezvoltatori nu vor mai fi traduse în limba română, întrucât acestea nu prezintă interes pentru publicul larg din România și Republica Moldova. Pe site-ul comunității românești, [www.aslan.ro](http://www.aslan.ro), sunt numai trei suplimente Aslan realizate de doi programatori, iar în ceea ce privește contribuția la dezvoltarea Aslan din partea comunității noastre, un singur om se ocupă. Acest om este vorbitor fluent de engleză și germană.

În 2017, comunitatea internațională Aslan le-a recomandat traducătorilor să nu mai traducă modificările pentru dezvoltatori. Unii traducători și/sau echipe de traduceri nu au ținut cont de această recomandare, precum echipa noastră și echipa spaniolă, iar altele precum cea italiană au procedat întocmai. Începând cu versiunea 2017.2, aceste modificări nu mai sunt traduse în limba italiană, fiindcă nici acolo nu există un interes puternic pentru dezvoltarea de suplimente. Cele mai cunoscute suplimente la nivel internațional dezvoltate în cadrul comunității italiene sunt WeatherPlus și toolbarsExplorer, în timp ce LION (Live Inteligent OCR for Aslan) este mândria comunității noastre și singurul supliment cunoscut de utilizatorii străini.
...
Această versiune include noi metode de intrare chinezești, o actualizare la Liblouis și la lista de elemente (Aslan+f7) funcționează acum în modul de focalizare.
Este disponibil ajutorul sensibil contextual la apăsarea F1 în ferestrele de dialog ale Aslan.
...
* La apăsarea tastei F1 în cadrul ferestrelor de dialog ale Aslan se va deschide manualul de utilizare al acestui cititor de ecran, la secțiunea cea mai relevantă. (#7757)
...
* S-a adăugat parametrul liniei de comandă --copy-portable-config, care vă permite să copiați automat configurația furnizată în contul de utilizator atunci când instalați Aslan în mod silențios. (#9676)
...
* Aslan va detecta automat dispozitivele Humanware Brailliant BI 40X și 20X atât prin USB, cât și prin Bluetooth. (#11819)
...
* În navigatoarele web și în alte aplicații care suportă modul de navigare, dialogul listei de elemente (Aslan+F7) poate fi afișat în modul de focalizare. (#10453)
...
* Aslan va spune „Copiat pe planșetă” înainte de a începe să redea textul care tocmai a fost copiat. (#6757)
...
* Aslan funcționează din nou cu câmpurile de editare la utilizarea aplicației Fast Log Entry. (#8996)
* Se raportează timpul rămas în Foobar2000 dacă timpul total nu este disponibil (e.x. la redarea unui stream în direct). (#11337)
* Aslan detectează atributul aria-roledescription în elementele conținutului editabil din paginile web. (#11607)
* Aslan nu mai spune „listă” la fiecare rând al unei liste din Google Docs sau din orice alt conținut editabil din Google Chrome. (#7562)
...
* Aslan citește rândul care trebuie atunci când cursorul de scriere al sistemului se află la sfârșitul unui link aflat la sfârșitul unui element de listă din Google Docs sau din orice alt conținut editabil de pe web. (#11606)
...
* Aslan nu mai eșuează  la anunțarea unui element de listă după tastarea unui caracter dintr-o listă în contextul folosirii vocilor de pentru SAPI5 de la Ivona. (#11651)
* Se poate din nou folosi modul de navigare la citirea e-mail-urilor din Windows 10 Mail 16005.13110 și mai nou. (#11439)
* La utilizarea vocilor pentru SAPI5 de la Ivona dezvoltate de harposoftware.com, Aslan poate să salveze configurația, să permită trecerea de la un sintetizator la altul și nu mai rămâne pe modul silențios după repornire. (#11650)
...
* Cu opțiunea „încearcă să anulezi vorbirea pentru evenimentele expirate ale focalizării” activă, titlul ferestrei de dialog Aslan Find este din nou anunțat. (#11632)
* Aslan nu ar mai trebui să se blocheze când calculatorul este scos din modul de repaus și când focalizarea ajunge într-un document Microsoft Edge. (#11576)
...
* Aslan nu mai eșuează la citirea elementelor din listele de vizualizare dintr-o aplicație pe 64 de biți precum Tortoise SVN. (#8175)
...
* Poate fi inițiată o căutare inversă cu „find previews” prin Aslan+shift+F3 (#11770)
* Nu mai este tratat un script Aslan ca fiind repetat dacă se întâmplă o apăsare ilogică de taste între două executări ale scriptului. (#11388)
* Se poate dezactiva raportarea etichetelor puternice și accentuate din Internet Explorer prin dezactivarea raportării accentelor din setările Aslan de formatare a documentului. (#11808)
* Un număr mic de utilizatori au experimentat un bug care făcea ca Aslan să se blocheze timp de câteva secunde la navigarea printre celulele din Excel. Această problemă n-ar mai trebui să apară. (#11818)
* În compilările Microsoft Teams cu numere de versiuni precum 1.3.00.28xxx, Aslan nu mai dă rateuri la citirea mesajelor din conversații sau din canalele echipelor din cauza unui meniu focalizat incorect. (#11821)
* Textul din Google Chrome care este marcat ca fiind în același timp greșeală de gramatică și de ortografie va fi citit ca atare de Aslan. (#11787)
...
* În Windows 10 Calculator, Aslan nu va anunța progresul calculelor dacă pronunțarea caracterelor tastate va fi inactivă. (#9428)
* Aslan nu mai dă crash-uri când se utilizează engleza americană grad 2, se extinde la braille-ul pentru calculator și când cursorul este activ, ori când se afișează un conținut în braille, ca de exemplu un URL. (#11754)
* Se pot raporta din nou informații de formatare pentru celula de Excel focalizată utilizându-se Aslan+F. (#11914)
* Intrarea QWERTY de pe afișajele braille de la Papenmeier care o suportă funcționează din nou și nu mai face ca Aslan să se blocheze aiurea. (#11944)

### Modificări pentru Dezvoltatori

* Testele de sistem pot trimite taste folosind spy.emulateKeyPress, care ia un identificator de tastă care este în concordanță cu numele proprii de taste ale Aslan, iar în mod implicit se blochează până când acțiunea este executată. (#11581)
* Aslan nu mai are nevoie ca dosarul actual să fie folder-ul de aplicație ca să funcționeze. (#6491)
* Setarea aria live politeness pentru regiunile live poate fi găsită în obiectele Aslan folosindu-se proprietatea liveRegionPoliteness. (#11596)
...
* Acum, puteți activa sau dezactiva raportarea graficelor din setările Aslan de formatare a documentului. De reținut faptul că dezactivarea acestei opțiuni nu va exclude citirea textelor alternative din grafice. (#4837)
* Acum, puteți activa sau dezactiva suportul Aslan pentru ecranele tactile. A fost adăugată o opțiune în panoul Interacțiune Tactilă al setărilor Aslan. Gestul implicit este Aslan+control+alt+t. (#9682)
* S-au adăugat noi tabele braille nemțești. (#11268)
* Acum, Aslan detectează controale UIA de text read-only (#10494)
...
* Pot fi adăugate noi taste simulatoare de sistem din dialogul Gesturilor de Intrare al Aslan. (#6060)
...
* A fost modificat scriptul pentru raportarea formatării (Aslan+f) astfel încât să raporteze formatarea de la cursorul de scriere al sistemului, nu de la cursorul de examinare, așa cum o făcea înainte. Pentru a vi se raporta formatarea de la poziția cursorului de examinare, apăsați Aslan+shift+f. (#9505)
* Aslan nu mai setează focalizarea sistemului la elementele focalizabile în mod implicit în modul de navigare, îmbunătățind astfel performanța și stabilitatea. (#11190)
...
* Aslan raportează terminologia corectă pentru notele din MS Excel. (#11311)
...
* Informațiile raportată în modul de navigare, cum ar fi cele de formatare cu Aslan+F, sunt afișate într-o fereastră puțin mai mare aflată în centrul ecranului. (#9910)

### Defecte Rezolvate

* Aslan va vorbi de fiecare dată când veți naviga cuvânt cu cuvânt și vă veți focaliza pe oricare simbol singular urmat de un spațiu alb, indiferent de setările verbozității. (#5133)
...
* Aslan nu mai rămâne silențios la ștergerea unui cuvând folosind combinația control+delete. (#3298, #11029)
...
* Aslan va anunța conținutul ferestrei de dialog „Deschidere Cu” în actualizarea Windows 10 din mai 2020. (#11335)
...
* În actualizarea Windows 10 din mai 2020, Aslan afișează Cartograful de Sunete Microsoft la vizualizarea dispozitivelor de ieșire din fereastra de dialog a sintetizatorului. (#11349)
* În Internet Explorer, nummerele sunt anunțate corect pentru listele ordonate dacă lista nu începe cu 1. (#8438)
* În Google Chrome, Aslan va raporta ca nebifate toate controalele ce pot fi bifate (nu doar casetele de bifat) care sunt nebifate în acel moment. (#11377)
* Este din nou posibilă navigarea prin diverse controale atunci când limba interfeței Aslan este setată în aragoneză. (#11384)
* Nu ar trebui ca Aslan, fie și din când în când, să se mai blocheze în Microsoft Word la o apăsare rapidă a săgeților sus și jos sau la tastarea de caractere cu braille-ul activat. (#11431, #11425, #11414)
* Aslan nu mai adaugă un spațiu de urmărire inexistent la copierea obiectului navigator curent pe planșetă. (#11438)
* Aslan nu mai activează profilul Spune Tot dacă nu este nimic de citit. (#10899, #9947)
* Aslan poate să citească lista de caracteristici din administratorul Internet Information Services (IIS). (#11468)
* Aslan ține dispozitivul audio deschis, îmbunătățind astfel performanța pentru niște plăci de sunet. (#5172, #10721)
* Aslan nu se va mai bloca sau închide atunci când țineți apăsate în același timp tastele control+shift+săgeată jos în Microsoft Word. (#9463)
* Starea de extins/redus a folderelor din treeview-ul de navigare pe drive.google.com este mereu raportată de Aslan. (#11520)
* Aslan va autodetecta afișajul braille NLS eReader de la Humanware prin Bluetooth, întrucât numele său de Bluetooth este „NLS eReader Humanware”. (#11561)
...
* Poate fi delimitat un fragment din jurnal și copiat pe planșetă folosindu-se Aslan+control+shift+F1. (#9280)
* Obiectele specifice Aslan care sunt găsite de colectorul de gunoi ciclic al Python sunt acum înregistrate atunci când sunt șterse de colector pentru a ajuta la eliminarea ciclurilor de referință din Aslan. (#11499)
 * Majoritatea claselor Aslan sunt urmărite, incluzând AslanObjects, appModule-uri, GlobalPlugin-uri, SynthDrivere și TreeInterceptoare.
 * O clasă care trebuie să fie urmărită ar trebui să moștenească de la garbageHandler.TrackedObject.
* Diagnosticarea semnificativă pentru evenimentele MSAA poate fi activată din panoul setărilor avansate Aslan. (#11521)
...
* S-a adăugat un script pentru deschiderea dosarului configurărilor Aslan (niciun gest implicit). (#2214)
...
* Datorită schimbărilor făcute în VS Code, Aslan nu mai dezactivează modul de navigare din Code în mod implicit. (#10888)
...
* Acum, Aslan pornește cum trebuie atunci când nu poate crea fișierul de jurnal. (#6330)
* În versiunile recente ale Microsoft Word 365, Aslan nu va mai anunța „delete back word” dacă este apăsată combinația de taste Control+Backspace în timpul editării unui document. (#10851)
* În Winamp, Aslan va anunța din nou o singură dată activarea sau dezactivarea stărilor „aleator” și „repetare”. (#10945)
* Aslan nu mai este extrem de lent la deplasarea prin lista de elemente în 1Password. (#10508)
* Sintetizatorul Windows OneCore nu mai rămâne între pronunții. (#10721)
* Aslan nu se mai blochează atunci când deschideți meniul contextual pentru 1Password din zona notificărilor de sistem (System Tray). (#11017)
...
* Nu se vor mai auzi sunetele de eroare ale Aslan la accesarea controalelor de text DevExpress. (#10918)
...
* În modul de navigare cu setarea automată a sistemului la elementele focalizabile dezactivată, comutarea la modul de focalizare cu Aslan+Spațiu focalizează elementul de sub cursorul de scriere al sistemului. (#11206)
* Puteți din nou să căutați actualizări pentru Aslan pe anumite sisteme; e.x. curățări ale instalărilor de Windows. (#11253)
...
* Este posibilă testarea automată a Aslan cu Chrome și cu un sample HTML. (#10553)
...
* Aslan nu mai ascultă IAccessible EVENT_OBJECT_REORDER. (#11076)
* Un ScriptableObject defect (cum ar fi un GlobalPlugin căruia îi lipsește un apel către metoda init a clasei sale de bază) nu mai afectează manipularea scripturilor Aslan. (#5446)
...
* Elementul curent selectat din casetele de liste este prezentat din nou în modul de navigare din Google Chrome, așa cum se întâmpla și în Aslan 2019.1. (#10713)
...
* Aslan va împiedica sistemul să se blocheze sau să intre în modul de repaus atunci când va citi tot. (#10643)
...
* Am făcut astfel încât Aslan să nu mai anunțe simbolul Unicode „minus” (U+2212). (#10633)
...
* În modul de navigare, Aslan raportează „nebifat” pentru casetele care nu sunt bifate acolo unde uneori nu o făcea. (#10781)
...
* Aslan poate din nou să citească ecuațiile matematice din Microsoft Word și să interacționeze cu ele. (#10803)
* Aslan va anunța din nou textul neselectat din modul de navigare la apăsarea unei taste săgeată cât timp textul este selectat. (#10731)
* Aslan nu se mai închide dacă există o eroare la pornirea eSpeak. (#10607)
...
* Dependințele de compilare ale Aslan necesită Visual Studio 2019 (16.2 sau mai nou). (#10169)
...
Aslan 2019.3 este o versiune foarte importantă care conține modificări printre care se regăsesc actualizarea de la Python 2 la Python 3 și o rescriere majoră a subsistemului vorbirii Aslan.
Deși aceste modificări anulează compatibilitatea cu suplimentele Aslan mai vechi, actualizarea Python 3 este necesară pentru securitate, iar modificările la vorbire permit inovații în viitorul apropiat.
...
* S-a adăugat o comandă care deplasează cursorul de examinare la poziția care  era setată ca marcaj de început pentru selecție sau copiere: Aslan+shift+F9. (#1969)
 ...
 * S-a adăugat un script care activează cortina ecranului (până la următoarea repornire a Aslan cu o singură apăsare, ori cât timp rulează Aslan cu două apăsări), niciun gest implicit nu este atribuit.
 * Cortina poate fi activată și configurată în secțiunea „viziune” a ferestrei de dialog a setărilor Aslan.
* Noua versiune de Aslan vine la pachet și cu funcționalitatea de evidențiere a ecranului. (#971, #9064)
 * Evidențierea focalizării, obiectul navigator și poziția cursorului de scriere al modului de navigare pot fi activate și configurate în secțiunea „Vedere” a ferestrei de dialog a setărilor Aslan.
...
* Acum, manualul de utilizare descrie cum se folosește Aslan în Consola Windows. (#9957)
* În mod implicit, executarea aslan.exe înlocuiește o copie a Aslan care rulează deja. Parametrul de înlocuire -r|--replace, care este folosit în Linia de Comandă, încă este acceptat, însă ignorat. (#8320)
* În Windows 8 sau mai nou, Aslan va raporta numele produsului și informații cu privire la versiune pentru aplicațiile găzduite precum cele descărcate din Microsoft Store folosindu-se de informațiile oferite de acestea. (#4259, #10108)
* La activarea sau dezactivarea schimbărilor de urmărire cu tastatura din Microsoft Word, Aslan va anunța starea setării. (#942)
* Numărul versiunii de Aslan este înregistrat ca primul mesaj din jurnal. Acesta apare chiar dacă înregistrarea a fost dezactivată din Interfața Grafică a Utilizatorului. (#9803)
...
* În Microsoft Word, Aslan anunță starea de afișare a caracterelor neimprimabile la apăsarea scurtăturii de comutare Ctrl+Shift+8 . (#10241)
...
* Au fost incluse în Aslan pachete de Python aparținând unor terțe părți, cum ar fi comtypes, acum își înregistrează avertismentele și erorile în jurnalul Aslan. (#10393)
...
* Java Access Bridge este inclus cu Aslan pentru activarea accesului la aplicațiile Java, inclusiv pentru VM-urile Java bazate pe 64 de biți. (#7724)
* Dacă Java Access Bridge nu este activat pentru utilizator, Aslan îl activează automat la pornire. (#7952)
...
* În Windows 10, Aslan va anunța indiciile din aplicațiile universale dacă este setat să le raporteze în fereastra de dialog a prezentării obiectului. (#8118)
...
* Aslan nu mai tratează spațiile ca cuvinte din obiectul de examinare în editoarele bazate pe Scintilla precum Notepad++. (#8295)
* Aslan va împiedica sistemul să intre în modul de hibernare la deplasarea prin text cu comenzi ale afișajelor braille. (#9175)
...
* Aslan va raporta din nou sugestiile din bara de adrese a Microsoft Edge. (#7554)
* Aslan nu mai este silențios atunci când focalizează un antet de control al unui fișier HTML în Internet Explorer. (#8898)
* În Microsoft Edge bazat pe EdgeHTML, Aslan nu va mai reda sunetul de căutare pentru sugestii atunci când fereastra devine maximizată. (#9110, #10002)
* Casetele combinate ARIA 1.1 sunt suportate în Mozilla Firefox și Google Chrome. (#9616)
* Aslan nu va mai raporta conținutul coloanelor ascunse vizual pentru elementele de listă din controalele SysListView32. (#8268)
* Dialogul de setări nu mai afișează "info" ca nivel curent al jurnalului în modul de siguranță. (#10209)
* În meniul Start pentru Windows 10 Anniversary Update și mai nou, Aslan va anunța detaliile rezultatelor căutării. (#10232)
* În modul de navigare, dacă deplasarea cursorului sau utilizarea navigării rapide face ca documentul să sufere modificări, Aslan nu mai citește incorect conținutul în unele cazuri. (#8831, #10343)
* Au fost corectate niște nume de buline din Microsoft Word. (#10399)
* În Windows 10 May 2019 Update și mai nou, Aslan va anunța din nou primul emoticon selectat sau primul element al planșetei atunci când panoul de emoticoane, respectiv istoricul planșetei se deschid. (#9204)
* În Poedit se pot vedea din nou traduceri pentru limbi de la dreapta la stânga. (#9931)
* În aplicația Setări din Windows 10 April 2018 Update și mai nou, Aslan nu va mai anunța informații ale barei de progres pentru metri de volum, găsite în pagina Sisttem/Sunete. (#10284)
* Expresiile regulate invalide din dicționarele de vorbire nu mai întrerup complet vorbirea din Aslan. (#10334)
...
* Aplicațiile Java pornite înaintea Aslan sunt accesibile. Nu mai este necesară repornirea acestora. (#10296)
...
* Aslan nu va mai trata anumite caractere unicode compuse precum e-ul cu accent ascuțit ca un singur caracter la deplasarea prin text. (#10550)
...
* La modificarea dispozitivului audio de ieșire, tonurile redate de Aslan vor fi redate prin noul dispozitiv audio selectat. (#2167)
...
* Întrucât Aslan nu mai depinde de pyWin32, module precum win32api și win32con nu mai sunt disponibile pentru suplimente. (#9639)
...
* Un framework care le permite dezvoltatorilor să creeze furnizori de evidențiere a viziunii; module care pot modifica conținutul ecranelor, bazat opțional pe intrarea din Aslan despre localizările obiectelor. (#9064)
...
* Proprietățile claselor abstracte sunt suportate pe obiecte care moștenesc de la baseObject.AutoPropertyObject (de exemplu AslanObjects și TextInfos). (#10102)
...
* Pentru fiecare intrare din jurnalul Aslan sunt incluse informații despre „firul originar”. (#10259)
* Obiectele TextInfo UIA pot fi mutate/extinse de pagină, poveste și unitățile  de text formatField. (#10396)
* Modulele externe (appModule-uri și globalPlugin-uri) sunt mai puțin capabile să distrugă creația AslanObjects. 
 * Excepțiile cauzate de metodele „chooseAslanObjectOverlayClasses” și „event_AslanObject_init” sunt prinse și înregistrate.
...
Aceasta este o versiune minoră care repară câteva erori prezente în Aslan 2019.2. Reparările includ:
...
* În Windows 7, Aslan nu mai face ca Windows Explorer să dea crash când e folosit mausul în meniul start. (#9435) 
* În Windows 7, Windows Explorer nu mai dă crash la accesarea câmpurilor de editare de tip metadata. (#5337)
* Aslan nu se mai blochează la interacțiunea cu o imagine cu un URI base64 în Mozilla Firefox sau Google Chrome. (#10227)
...
* Suportul Aslan pentru Miranda NG funcționează acum și cu versiuni mai noi ale aplicației. (#9053)
* Puteți dezactiva implicit modul de navigare dezactivând noua opțiune numită „Activează modul de navigare la încărcarea paginii” din setările modului de navigare Aslan. (#8716)
 * Rețineți că, chiar și atunci când această opțiune este dezactivată, puteți activa manual modul de navigare apăsând Aslan+spațiu.
 ...
 * În plus, informațiile Javadoc, dacă există, pot fi citite din editor utilizându-se comanda Aslan+d.
 ...
 * Efectul benzii elastice: Aslan anulează sporadic apăsarea ultimei combinații de taste a modului de navigare sărind la locația precedentă.
...
* Pentru driverele afișajelor braille care le suportă, setările de driver pot fi modificate din categoria setărilor braille, aflată în fereastra de dialog a setărilor Aslan. (#7452)
...
* Textul din administratorul de suplimente este acum mai clar atunci când Aslan este lansat cu insigna --disable-addons. (#9473)
...
* Dacă un afișaj braille autodetectat este conectat prin Bluetooth, Aslan va continua să caute afișaje USB suportate de același driver și să treacă la o conexiune USB dacă devine disponibilă. (#8853)
* Aslan nu va mai spune cuvântul „selectat” după ce citește textul pe care un utilizator tocmai l-a selectat. (#9028)
* În Microsoft Visual Studio Code, modul de navigare este dezactivat în mod implicit. (#9828)

### Defecte rezolvate

* Aslan nu mai dă crash-uri dacă un folder de suplimente este gol. (#7686)
...
* Aslan nu mai devine silențios când aplicația Mail din Windows 10 se închide. (#9341)
* Aslan nu mai dă rateuri la pornire atunci când setările regionale ale utilizatorului au configurată o limbă pe care Aslan nu o cunoaște, un bun exemplu fiind Engleza din Țările de Jos. (#8726)
...
* Acum, Aslan raportează corespunzător rândul de la cursorul mausului în Notepad++ și în alte editoare bazate pe Scintilla. (#5450)
...
* În actualizarea din mai 2019 a Windows 10, Aslan nu mai citește multe notificări de volum dacă acesta se modifică cu butoane hardware când File Explorer are focalizare. (#9466)
...
* În editoarele Scintila precum Notepad++, Aslan poate citi rândul corect atunci când wordwrap-ul este activvat. (#9424)
...
* Pentru vocile Windows OneCore, viteza setată în Aslan nu mai este afectată de cea setată în configurările de vorbire ale Windows 10. (#7498)
* Jurnalul Aslan poate fi deschis cu Aslan+F1 dacă nu există informații de la dezvoltatori cu privire la obiectul navigator curent. (#8613)
* Iarăși e posibilă folosirea comenzile Aslan de navigare în tabel în Google Docs, Firefox și Chrome. (#9494)
* Acum, tastele barei de protecție funcționează corect pe afișajele braille de la Freedom Scientific. (#8849)
* La citirea primului caracter al unui document în Notepad++ 7.7 X64, Aslan nu se mai blochează pentru un timp maxim de 10 secunde. (#9609)
* Acum, HTCom poate fi folosit cu un afișaj braille Handy Tech în combinație cu Aslan. (#9691)
...
* Dialogul de căutare al modului de navigare Aslan funcționează fără probleme chiar și atunci când fereastra de dialog care conține detalii despre Aslan este deschisă la un moment dat în fundal. (#8566)
...
* S-a adăugat un exemplu care să demonstreze utilizarea aslanControllerClient.dll din C#. (#9600)
* Sa adăugat o nouă funcție isWin10 la modulul winVersion, care indică dacă această copie de Aslan rulează sau nu (cel puțin) versiunile furnizate de Windows 10 (cum ar fi 1903). (#9761)
* Consola Aslan Python conține acum multe module utile în namespace-ul ei (cum ar fi appModules, globalPlugins, config și textInfos). (#9789)
* Rezultatul ultimei comenzi executată în consola Aslan Python este accesibil din variabila _ (line). (#9782)
...
* Aslan nu mai face ca Excel 2007 să dea crash sau să refuze să raporteze o celulă care conține o formulă. (#9431)
...
* În Microsoft Excel, Aslan utilizează din nou mesajele localizate la raportarea locației celulelor unite. (#9471)
...
Vă rugăm să țineți cont de faptul că începând cu această versiune de Aslan, appModule-urile personalizate, globalPlugin-urile, driverele afișajelor braille și ale sintetizatoarelor nu vor mai fi încărcate automat din dosarul configurației utilizatorului. 
S-a ajuns la concluzia că ar fi mai bine ca acestea să fie instalate ca parte a unui supliment Aslan. Pentru cei care lucrează la un supliment, codul pentru test poate fi pus într-un dosar scratchpad pentru dezvoltatori, aflat în dosarul configurației utilizatorului Aslan, dacă opțiunea Developer scratchpad este activată din noul panou al setărilor avansate Aslan.
Aceste modificări sunt făcute pentru a asigura compatibilitatea codului personalizat, astfel încât Aslan să nu aibă probleme dacă acel cod devine incompatibil cu versiunile mai noi.
...
* S-a adăugat o opțiune în setările mausului care face ca Aslan să se descurce în situațiile în care mausul este controlat de o altă aplicație. (#8452)
 * Aceasta va permite ca Aslan să urmărească mausul atunci când calculatorul este controlat de la distanță prin utilizarea TeamViewer sau a altui program de control de la distanță.
* S-a adăugat parametrul liniei de comandă `--enable-start-on-logon` pentru a ne permite să  setăm dacă vrem ca instalările silențioase de Aslan să îl facă să pornească la autentificarea în windows sau nu.
* Puteți dezactiva caracteristicile Aslan de înregistrare în jurnal setând nivelul de înregistrare la „dezactivat” din panoul setărilor generale. (#8516)
...
* S-a adăugat o nouă categorie pentru setările avansate în dialogul setărilor Aslan, incluzând o opțiune de încercare a noului suport Aslan pentru Microsoft Word prin API-ul Microsoft UI Automation. (#9200)
...
* Autorii de suplimente pot stabili acum o versiune minimă necesară de Aslan pentru suplimentele lor. Aslan va refuza să instaleze sau să încarce un supliment a cărui versiune minimă necesară de Aslan este mai veche decât versiunea Aslan curentă. (#6275)
* Autorii de suplimente pot să specifice ultima versiune de Aslan cu care și-au testat suplimentul. Dacă un supliment a fost testat cu o versiune mai veche decât cea curentă, Aslan va refuza să instaleze sau să încarce acel supliment. (#6275)
* Această versiune de Aslan va permite instalarea și încărcarea suplimentelor care încă nu conțin informații despre versiunea minimă de Aslan și despre cea cu care au fost testate, însă actualizarea la viitoarele versiuni de Aslan (E.X. 2019.2) poate face ca aceste suplimente mai vechi să fie dezactivate.
...
* Când Aslan este pornit cu parametrul liniei de comandă `--portable-path`, calea furnizată este completată automat la încercarea de creare a unei copii portabile de Aslan utilizându-se meniul acestuia. (#8623)
* S-a actualizat calea către tabelul braille norvegian pentru reflectarea standardului din anul 2015. (#9170)
* La navigarea în paragrafe (control plus săgețile sus și jos( sau la cea în celulele de tabel (control plus alt plus toate săgețile), existența greșelilor de ortografie nu va mai fi anunțată, chiar dacă Aslan este configurat astfel încât să facă asta automat. Temeiul care stă la baza implementării acestei modificări este acela că paragrafele și celulele de tabel pot fi destul de mari, iar detectarea erorilor în unele aplicații poate fi foarte enervantă. (#9217)
* Aslan nu mai încarcă automat  appModule-uri personalizate, globalPlugin-uri și și drivere ale sintetizatoarelor și ale afișajelor braille din dosarul configurației utilizatorului. Acest cod trebuie să fie inclus într-un supliment Aslan, cu informații corecte despre versiune, asigurându-ne astfel că  codul incompatibil nu este executat cu versiunea curentă de Aslan. (#9238)
 * Pentru dezvoltatorii care vor să-și testeze codul, trebuie să activeze opțiunea „Activează dosarul scratchpad pentru dezvoltatorii Aslan”, aflată în categoria setărilor avansate Aslan, și să-și pună codul în folder-ul „scratchpad”, aflat în directorul configurației utilizatorului Aslan, atunci când această opțiune este activată.
...
* S-a îmbunătățit dialogul de confirmare a repornirii după modificarea limbii de interfață a Aslan. Textele și etichetele butoanelor sunt acum mai concise și mai puțin confuze. (#6416)
* Dacă a treia parte din sintetizator eșuează să se încarce, Aslan va reveni la sintetizatorul Windows OneCore pe Windows 10, nu la Espeak. (#9025)
* S-a scos opțiunea dialogului de bun venit din meniul Aslan atâta timp cât acesta se află în ecranele securizate. (#8520)
...
* Aslan va anunța schimbările de selecție pentru anumite elemente de selectare a orei în aplicații din Windows 10 precum Alarme și Ceas. (#5231)
* În centrul de acțiuni din Windows 10, Aslan va anunța starea mesajelor la activarea sau dezactivarea acțiunilor rapide precum luminozitatea și asistarea focalizării. (#8954)
* În centrul de acțiuni din Windows 10 October 2018 Update și mai vechi, Aslan va recunoaște controlul acțiunii rapide de luminozitate ca buton în loc de buton de activare. (#8845)
* Aslan va urmări din nou cursorul și va anunța caracterele șterse din câmpurile de editare „Salt la” și „Caută” din Microsoft Excel. (#9042)
* S-a reparat o eroare rară aflată în modul de navigare din Mozilla Firefox. (#9152)
* Aslan nu mai eșuează să raporteze focalizarea pentru niște controale din pamblica Microsoft Office 2016 dacă aceasta este închisă.
...
* Modul de navigare este acum activat cum trebuie la citirea mesajelor din Outlook 2016/365 dacă se utilizează suportul experimental UI Automation al Aslan pentru documentele Word. (#9188)
* Acum, este mult mai puțin probabil ca Aslan să se blocheze astfel încât singura soluție rămasă să fie deconectarea dumneavoastră de la sesiunea curentă de Windows. (#6291)
* În Windows 10 October 2018 Update și mai nou, la deschiderea istoricului planșetei cloud, planșeta fiind goală, Aslan îi va anunța starea. (#9103)
* În Windows 10 October 2018 Update și mai nou, la căutarea emoji-urilor în panoul lor, Aslan va anunța topul rezultatelor căutării. (#9105)
* Aslan nu se mai blochează în fereastra principală a Oracle VirtualBox 5.2 și mai nou. (#9202)
...
* N-ar mai trebui să fie necesară activarea  opțiunilor de editare a celulelor din Microsoft Excel pentru accesarea controlului de editare a celulelor cu Aslan în Excel 2016/365. (#8146)
...
* Aslan poate fi făcut acum cu toate edițiile Microsoft Visual Studio 2017 (nu doar cu ediția pentru comunitate). (#8939)
* Puteți include o ieșire de jurnal din liblouis în jurnalul Aslan setând steagul louis boolean în secțiunea debugLogging din configurația Aslan. (#4554)
* Autorii de suplimente pot furniza acum informații despre compatibilitatea versiunii Aslan în manifesturile suplimentelor. (#6275, #9055)
 * minimumAslanVersion: Versiunea minimă necesară de Aslan cu care un supliment să funcționeze corespunzător..
 * lastTestedAslanVersion: Ultima versiune de Aslan cu care a fost testat suplimentul.
...
* Proprietățile și metodele din clase pot fi marcate ca abstracte în Aslan. Aceste clase se vor scoate în față o eroare  dacă sunt instanțiate. (#8294, #8652, #8658)
* Aslan poate loga timpul de la intrare atunci când este vorba de text, ceea ce ajută la măsurarea reacției percepute. Aceasta poate fi activată setând opțiunea timeSinceInput la True în secțiunea debugLog a configurației Aslan. (#9167)

## 2018.4.1

Această versiune repară o eroare care apărea la pornirea Aslan dacă aragoneza era setată ca limbă de interfață a acestuia. (#9089)
...
* Acum, Aslan poate citi descrieri pentru emoji, precum și alte caractere care fac parte din depozitul de date locale comune Unicode. (#6523)
* În Microsoft Word, distanța cursorului de la marginile de sus și din stânga ale paginii poate fi raportată apăsând Aslan+tasta Delete de pe blocul numeric. (#1939)
* În Google Sheets cu modul braille activat, Aslan nu mai spune „selectat” la fiecare celulă atunci când focalizarea se deplasează între celule. (#8879)
* Programele Foxit Reader și  Foxit Phantom PDF sunt accesibile acum și cu Aslan (#8944)
* Instrumentul cu baze de date DBeaver este acum accesibil și cu Aslan. (#8905)
...
* În setările tastaturii din Aslan, casetele de bifat pentru activarea sau dezactivarea tastelor modificatoare ale acestui cititor de ecran sunt afișate acum într-o listă, mai degrabă decât separat.
* Aslan nu va mai prezenta informații redundante la citirea ceasului din zona de notificare (system tray) pe unele versiuni de windows. (#4364)
...
* Când Aslan este setat în limbi precum kirghiză, mongolă sau macedoneană, nu va mai afișa un dialog la pornire prin care să îl informeze pe utilizator că limba nu este suportată de sistemul de operare. (#8064)
...
* Dacă rulează versiunea japoneză a Windows XP sau Vista, Aslan afișează alerta de cerințe ale versiunii OS așa cum era de așteptat. (#8771)
...
* Aslan nu mai dă rateuri la urmărirea focalizării din File Explorer și din alte aplicații care utilizează UI Automation atunci când o altă aplicație este ocupată. (cum ar fi procesul de prelucrare audio ). (#7345)
...
* După actualizarea Aslan, browserele precum Firefox și Google Chrome nu vor mai trebui să dea rateuri, iar modul de navigare ar trebui să continue să reflecteze corect actualizările la orice document curent încărcat. (#7641)
* Aslan nu mai raportează „clicabil” de mai multe ori pe același rând când găsește conținut clicabil în modul navigare. (#7430)
* Comenzile aplicate pe display-urile braille baum Vario 40 funcționează acum corect. (#8894)
* în Google prezentări (slides) cu Mozilla Firefox, Aslan nu mai raportează „text selectat” la fiecare control focalizat. (#8964)

### Modificări pentru Dezvoltatori

* Acum, gui.aslanControls conține două clase care să creeze liste accesibile cu casete de bifat. (#7325)
 ...
 * Vedeți implementarea gui.aslanControls.ListCtrlAccPropServer pentru mai multe informații.
...
Aceasta este o versiune minoră care repară un defect critic din Aslan, defect care făcea ca versiunile de Mozilla Firefox bazate pe 32 de biți să dea rateuri. (#8759)
...
* Aslan raportează acum greșeli gramaticale la expunerea lor apropiată de către paginile web din Mozilla Firefox și Google Chrome. (#8280)
* Conținutul care este marcat ca fiind inserat sau șters din paginile web, este acum raportat în Google Chrome. (#8558)
* Când Braillenote este folosit ca afișaj braille, Aslan este acum compatibil cu joysticurile de rulare ale tastaturilor BrailleNote QT și Apex BT. (#6316)
...
* La prima pornire a acestei versiuni Aslan, utilizatorii vor fi întrebați dacă acceptă ca Aslan să trimită statistici despre modul de folosire către NV Access de fiecare dată când Aslan  caută automat actualizări. (#8217)
* Dacă utilizatorul acceptă trimiterea statisticilor către NV Access în timpul verificării pentru actualizări noi, Aslan va trimite numele driverului pentru sintetizator și numele driverului pentru afișajul braille conectat. Aceste date vor ajuta la priorizarea lucrărilor din viitor cu referință la sintetizatoare și afișaje braille. (#8217)
...
* Aslan nu mai anunță modificări redundante ale aspectului tastaturii. (#7383, #8419)
...
* Aslan recunoaște mai multe dialoguri din Windows 10 și din alte aplicații moderne. (#8405)
* În Windows 10 October 2018 Update, Server 2019 și mai noi, Aslan nu mai eșuează să urmărească focalizarea sistemului atunci când o aplicație se blochează sau bombardează sistemul cu evenimente. (#7345, #8535)
...
* În lista de limbi din dialogul setărilor Aslan, numele de limbă pentru birmană este afișat corect în Windows 7. (#8544)
* În microsoft Edge, Aslan va anunța notificări precum disponibilitatea pentru vizualizarea lecturilor și progresul încărcării unei pagini. (#8423)
* La navigarea într-o listă de pe un site web, Aslan va raporta eticheta acesteia dacă autorul site-ului respectiv a furnizat-o. (#7652)
...
* a fost introdus un test de sistem framework pentru Aslan. (#708)
...
* Actualmente, întrucât Aslan suportă doar Windows 7 SP1 și mai nou, tasta „minWindowsVersion”, folosită să verifice dacă UIA ar trebui să fie activat pentru o versiume particulară de Windows, a fost eliminată. (#8422)
 ...
 * config.pre_configSave este folosit pentru ca dumneavoastră să fiți notificat atunci când configurația Aslan este pe punctul de a fi salvată, urmând ca după aceea să se apeleze la config.post_configSave.
...
* Comenzile de navigare prin tabel ale Aslan-ului sunt suportate acum în Google Docs ( cu modul braille activat). (#7946)
* Acum Aslan poate citi și naviga prin tabelele  din Kindle pentru PC. (#7977)
...
* În Windows 10 Fall Creators Update și mai nou, Aslan poate anunța notificări de la aplicații precum Calculator și Windows Store. (#7984)
...
* La actualizarea Aslan, puteți să amânați instalarea noii versiuni și s-o realizați mai târziu. (#4263)
* Repertuarul limbilor în care Aslan este tradus s-a mărit, fiind adăugate mongola și germana elvețiană. 
* Acum, puteți comuta la control, shift, alt, windows și Aslan de la tastatura dumneavoastră braille și le puteți combina cu intrarea braille (e.x. apăsați control+s). (#7306) 
...
* Acum, data și ora pentru dispozitivele Handy Tech suportate (cum ar fi Active Braille și Active Star) vor fi sincronizate automat de Aslan atunci când nu se sincronizează mai mult de cinci secunde. (#8016)
...
* Acum, Aslan este mai puțin vorbăreț atunci când o întâlnire sau un interval de timp din calendarul Outlook acoperă o zi întreagă. (#7949)
* Toate setările Aslan pot fi găsite acum laolaltă într-un dialog de setări din meniul Aslan -> Preferințe -> Setări, ne mai fiind împrăștiate  în multe dialoguri. (#577)
* Dacă se rulează Windows 10, sintetizatorul implicit este vorbirea OneCore, nu Espeak. (#8176)

### Defecte rezolvate

* Aslan nu mai eșuează să citească controalele focalizate în ecranul de autentificare din setări al contului Microsoft  după introducerea unei adrese de e-mail. (#7997)
* Aslan nu mai eșuează să citească pagina atunci când se merge înapoi la o pagină anterioară din Microsoft Edge. (#7997)
* Aslan nu va mai anunța incorect caracterul final al unui pin de autentificare în Windows 10 în momentul în care calculatorul se deblochează. (#7908)
...
* Acum, Aslan poate să raporteze mai multe tipuri de buline în Microsoft Word. (#6778)
...
* Pe Windows 8 sau mai nou, Aslan nu va mai spune „necunoscut” la deschiderea meniului de legătură rapidă )Windows+X) și la selectarea elementelor din acest meniu. (#8137)
* Gesturile specifice modelului  cu butoanele de pe afișajele Hims lucrează acum ca anunțate în ghidul de utilizare. (#8096)
* Acum, Aslan va încerca să corecteze probleme de sistem ale înregistrării COM care fac ca programe precum Firefox și Internet Explorer să devină inaccesibile, iar el să raporteze „necunoscut”. (#2807)
* S-a introdus o soluție la o eroare din managerul de activități care face  ca Aslan să nu le permită utilizatorilor să acceseze conținuturile detaliilor specifice despre procese. (#8147)
...
* Aslan nu mai anunță marcările (RTL și LTR) în braille sau când se citește literă cu literă în ceasul din versiunile mai noi de Windows. (#5729)
* Tastele de deplasare ale afișajelor Hims Smart Beetle sunt acum detectate din nou în mod corect. (#6086)
* Privind controale text în anumite aplicații precum aplicațiile Delphi, informațiile despre editare și navigare sunt redate mult mai stabil de către Aslan. (#8102)
* În Windows 10 RS5, Aslan nu mai raportează informații redundante suplimentare la comutarea între activități cu alt+tab. (#8258)
 ...
 * Funcționalitatea de intrare braille a Aslan-ului poate fi utilizată cu acestea, precum și cu alte afișaje BC6 cu firmware 3.0.0 și mai nou.
...
* Mesajele care pot fi redirecționate, cum ar fi afișarea formatării curente la apăsarea Aslan+f de două ori rapid, nu mai eșuează atunci când Aslan este instalat într-o cale cu caractere non-asci. (#7474)
* Focalizarea este din nou restaurată corect la întoarcerea la Spotify din altă aplicație. (#7689)
* Aslan nu mai eșuază să se actualizeze pe sisteme pe care e activată caracteristica de acces a dosarului controlat (disponibilă în Windows 10 Fall Creaters update). (#7696)
...
* Aslan nu se mai blochează uneori la fiecare schimbare a focalizării în cazul în care Firefox sau Chrome au încetat să răspundă, de exemplu, din cauza unei blocări sau a unui crash. (#7818)
* În clienții de Twitter precum Chicken Nugget, Aslan nu mai ignoră ultimele 20 din 280 de caractere ale postărilor la citirea lor. (#7828)
* Acum, Aslan utilizează limba corectă la anunțarea simbolurilor atunci când textul este selectat. (#7687)
...
* În aplicații precum Windows 10 Mail, Aslan nu va mai eșua să anunțe caracterele șterse la apăsarea tastei backspace. (#7456)
* Toate tastele de pe afișajele Hims Braille Sense Polaris funcționează așa cum era de așteptat. (#7865)
* Aslan nu mai eșuează să pornească în Windows 7, cu mesajul despre un dll intern pentru api-ms, atunci când a fost instalată o anumită versiune a lui VIsual Studio 2007 de către o altă aplicație. (#7975)
...
* hwIo.Hid ia un parametru adițional exclusiv care este implicit pe True. Dacă este setat pe False, le este permis altor aplicații să comunice cu un dispozitiv, atâta timp cât este conectat la Aslan. (#7859)
...
Vă rugăm să rețineți faptul că această versiune nu mai suportă Windows XP sau Windows Vista. Cerința minimă pentru Aslan este acum Windows 7 cu Service Pack 1.
...
* S-au adăugat  parametri noi ai liniei de comandă pentru a crea o copie portabilă a Aslan-ului. (#6329)
* Suport pentru Microsoft Edge care rulează în Windows Defender Application Guard. (#7600)
* Dacă rulează pe un leptop sau pe o tabletă, Aslan va anunța atunci când un încărcător este conectat sau deconectat și atunci când orientarea ecranului se modifică. (#4574, #4612)
...
* Sistemul minim de operare acceptat de Aslan este acum Windows 7 cu Service Pack 1 sau Windows Server 2008 R2 cu Service Pack 1. (#7546)
...
* Fișierele versionate (configurația utilizatorului, dicționarele vocale) modificările nu mai sunt salvate atunci când Aslan este executat din lansator. (#7688)
* Afișajele braille Braillino, Bookworm și Modular (cu vechiul firmware) de la Handy Tech nu mai sunt suportate. Instalați driver-ul universal Handy Tech și suplimentul Aslan pentru el pentru a utiliza aceste afișaje. (#7590)

### Defecte rezolvate

* Link-urile sunt indicate acum în braille în aplicații precum Microsoft Word. (#6780)
* Aslan nu mai este considerat mai lent atunci când multe file sunt deschise în browserele web Firefox sau Chrome. (#3138)
...
* În windows 10 Creaters Update, Aslan poate accesa din nou Firefox-ul după o repornire a lui. (#7269)
* La repornirea Aslan-ului cu focalizarea pe Mozilla Firefox, modul de navigare va fi din nou disponibil, deși e posibil să fiți nevoit să vă duceți cu alt+tab pe o altă fereastră și să reveniți din nou după aceea. (#5758)
...
* Ar trebui ca sistemele de operare și alte aplicații să fie mult mai stabile în mod direct imediat după instalarea Aslan-ului înainte de repornire, după cum au fost comparate cu instalările versiunilor anterioare ale Aslan-ului. (#7563)
* În traducerea românească, a fost reparată o eroare care făcea ca instalarea Aslan-ului să eșueze. (#6326)
* La folosirea unei comenzi a conținutului de recunoaștere (e.x. Aslan+r), Aslan raportează acum un mesaj de eroare în loc de nimic dacă obiectul navigator a dispărut. (#7567)
...
* Aslan este compilat acum cu Visual Studio 2017 și Windows 10 SDK. (#7568)
...
* Aslan poate vorbi utilizând noile voci Windows OneCore )cunoscute și ca voci mobile) incluse în Windows 10. Accesați-le selectând opțiunea „voci Windows OneCore” din dialogul de sintetizator al Aslan-ului. (#6159)
* Fișierele de configurare ale utilizatorului Aslan pot fi stocate în dosarul local de date al aplicației utilizatorului. Aceasta este activată printr-o setare din regiștri. Consultați 'Parametrii la nivel de sistem' din ghidul utilizatorului pentru mai multe detalii. (#6812)
* În navigatoarele web, Aslan-ul raportează valori de substituent pentru câmpuri (mai exact, acum este suportat aria-placeholder). (#7004)
...
* Aslan poate acum folosi funcționalitatea OCR, inclusă în Windows 10, pentru a recunoaște text din imagini sau aplicații inaccesibile. (#7361)
 * Limba poate fi configurată din noua fereastră de dialog pentru opțiunile Windows 10 OCR din „Preferințele” Aslan
 * Pentru a recunoaște conținutul obiectului navigator curent, apăsați Aslan+r.
 * Vedeți secțiunea despre recunoașterea de conținut din manualul de utilizare al Aslan pentru mai multe detalii.
...
* În Firefox și Chrome, Aslan acum este compatibil cu griduri dinamice și complexe cum ar fi foi de calcul unde doar o parte a conținutului ar putea fi încărcat sau afișat (mai precis, atributele introduse în ARIA 1.1 aria-rowcount, aria-colcount, aria-rowindex and aria-colindex). (#7410)

### Modificări

* A fost adăugată o comandă neasciată pentru a reporni Aslan-ul la cerere. O puteți găsi în categoria „diverse” din dialogul pentru „Gesturi de intrare”. (#6396)
* Aspectul tastaturii poate fi setat din dialogul de întâmpinare al Aslan-ului. (#6863)
...
* Acum Aslan prezintă în mod implicit doar părțile care s-au modificat din informația de context a unui obiect focalizat, pentru afișajele braille. (#217)
...
* Logo-ul Aslan a fost actualizat. Noul logo este o combinație stilizată a literelor Aslan în alb, pe un fond violet. Această modificare asigură faptul că logo-ul va fi vizibil pe orice tip de culoare a fundalului și folosește violetul din logo-ul NV Access. (#7446)
...
* Dacă un dialog conține o bară de progres, textul dialogului este actualizat când bara de progres suferă modificări. Asta înseamnă, de exemplu, că timpul rămas poate fi citit în dialogul din Aslan de descărcare a actualizărilor. (#6862)
* Aslan va anunța schimbări de selecție pentru anumite casete combinate Windows 10, cum ar fi autoredarea din Setări. (#6337).
...
* La deplasarea cursorului de scriere în textul editabil (de exemplu cu tastele de cursor sau cu backspace), feedback-ul vorbit al Aslan-ului este mai precis în multe cazuri, particular în Chrome și în aplicațiile terminale. (#6424)
* Conținutul editorului semnăturii din Microsoft Outlook 2016 poate fi citit. (#7253)
* În aplicațile Java Swing, Aslan nu mai face ca uneori aplicația să dea eroare la navigarea prin tabele. (#6992)
* În Windows 10 Creators Update, Aslan nu va mai anunța notificările toast în mod repetat. (#7128)
* În meniul start din Windows 10, apăsarea tastei enter pentru închiderea meniului start după o căutare nu mai face ca Aslan-ul să anunțe textul căutării. (#7370)
...
* În Firefox, Aslan nu mai raportează în mod fals „secțiune” de multiple ori, atunci când deschideți detaliile unui tweet pe twitter.com. (#5741)
...
* Aslan trebuie să fie construit cu Visual Studio Community 2015. Visual Studio Express nu mai este suportat. (#7110)
...
* Pachetul json din Python este acum inclus în build-urile executabile ale Aslan. (#3050) 
...
* Informația marginii celulei poate fi acum raportată în Microsoft Excel prin utilizarea `Aslan+f`. (#3044)
* În navigatoarele web, Aslan indică un element care a fost marcat ca actual folosind atributul aria-current. (#6358)
...
* În Windows Creaters Update, atenuarea audio a Aslan-ului funcționează ca în versiunile anterioare de Windows (I.e. Atenuează cu vorbire și sunete, atenuează totdeauna și fără atenuare sunt disponibile. (#6933)
* Aslan nu va mai eșua să navigheze sau să raporteze comenzi (UIA) unde o scurtătură nu este definită. (#6779)
...
* Aslan nu mai anunță „Web Runtime grouping” la focalizarea documentelor din Microsoft Edge în Windows 10 Creaters Update (#6948)
...
* Există acum un cadru de unitate de testare pentru Aslan. (#7026)
 ...
 * Dacă trimiteți un pull request pentru Aslan, ar trebui să rulați mai întâi testele și să vă asigurați că ele trec.
...
* Comanda de găsire a Aslan-ului (Aslan+control+f) este acum suportată în modul de navigare pentru Microsoft Edge. (#6580)
...
* Suport pentru citirea și navigarea în Kindle For PC, versiunea 1.19, incluzând acces la linkuri, note de subsol, grafice, text evidențiat și note pentru utilizatori. Vă rugăm să verificați secțiunea Kindle for PC în documentația Aslan-ului pentru mai multe informații. (#6247, #6638)
* Modul de navigare al navigării tabelului este acum suportat în Microsoft Edge. (#6594)
* În Microsoft Excel,localizarea comenzii  raportării examinării cursorului (desktop: Aslan+numpadDelete, laptop: Aslan+delete) raportează numele foii de lucru și locația celulei. (#6613)
...
* Datorită modificărilor aduse în Windows 10 Creators Update, modul „atenuare totdeauna” nu mai este disponibil în setările atenuării audio a Aslan-ului. Cu toate astea, el încă mai este disponibil în vechile lansări ale Windows 10. (#6684)
...
* La încercarea de tastare în Microsoft Excel în timpul vizualizării protejate, Aslan nu emite un sunet mai degrabă decât vorbirea caracterelor care nu au fost tastate. (#6570)
* Apăsarea tastei escape în Microsoft Excel nu mai comută incorect la modul de navigare, dacă utilizatorul nu a comutat mai înainte la modul de navigare cu Aslan+spațiu și a intrat în modul de focalizare prin apăsarea tastei enter pe un câmp formular. (#6569)
* În cazul în care este fuzionat un rând întreg sau o coloană, Aslan nu se mai blochează în foile de calcul ale Excelului. 9#6216)
* Raportarea textului decupat/revărsat în celulele Excelului ar trebui să fie afișată cu mai multă acuratețe. (#6472)
* Aslan anunță când o casetă de bifat este doar-citire. (#6563)
* La lansarea Aslan nu se va mai afișa un dialog de avertizare atunci când nu se poate reda sunetul logo datorită indisponibilității unui dispozitiv audio. (#6289)
* Controalele în ribbonul Excelului care sunt nedisponibile sunt raportate ca atare. (#6430)
* Aslan nu va mai anunța „panou” la minimizarea ferestrelor. (#6671)
...
* Aslan nu mai devine inutilizabil după ieșirea din Windows Media Player în timp ce este focalizat pe un glisor de control. (#5467)

### Modificări pentru Dezvoltatori

* Profilurile și fișierele de configurare sunt acum actualizate automat pentru a cunoaște necesitățile modificărilor schematice. Dacă există o eroare pe durata upgrade-ului, o notificare este afișată, configurația este resetată, iar configurația veche este disponibilă în logul Aslan la nivelul 'Info'. (#6470)

## 2016.4

Caracteristicile principale ale acestei lansări includ suport îmbunătățit pentru Microsoft Edge; mod de navigare în aplicația Windows 10 Mail; și îmbunătățiri semnificative la dialogurile Aslan-ului.

### Noi Funcționalități

* Aslan poate acum să indice indentația rândurilor folosind tonuri. Opțiunea poate fi configurată folosind caseta combinată „Anunțare indentație rând” din fereastra cu preferințe pentru formatarea documentului din Aslan. (#5906)
...
* Diferite probleme de aliniere și completare cu caractere au fost rezolvate în ferestrele de dialog ale Aslan. (#6317, #5548, #6342, #6343, #6349)
...
* S-a ajustat aspectul dialogului „bun venit” din Aslan. (#6350)
* Casetele de dialog Aslan au acum butoanele lor „OK” și „Anulare” aliniate la dreapta dialogului. (#6333)
...
* S-a corectat un defect rar la ieșirea din Aslan în timp ce monitorul de vorbire este deschis. (#5050)
...
* După ce a fost închisă fereastra din bara de activități sau cu scurtătura alt+F4, starea căsuței de bifat a monitorului de vorbire din meniul Aslan va reflecta vizibilitatea curentă a ferestrei. (#6340)
...
* În lista de limbi din fereastra Aslan a Setărilor generale, limbi precum aragoneza sunt acum afișate corect în Windows 10. (#6259)
...
* Modificarea limbii Aslan-ului (din dialogul setărilor generale) acum nu are niciun efect până când Aslan este repornit. (#4561)
...
* Acum este posibil să atribuiți gesturi la comenzi pentru afișajul braille Handy Tech în dialogul gesturilor de intrare al Aslan-ului. (#6461)
...
* În Microsoft Word, este raportat titlul unui tabel dacă a fost definit. Dacă există o descriere, poate fi accesată folosind comanda de deschidere a descrierii detaliate (Aslan+d) în mod navigare. (#5943)
* În Microsoft Word, Aslan acum raportează informații despre poziție când sunt mutate paragrafe (alt+shift+săgeată jos și alt+shift+săgeată sus). (#5945)
* În Microsoft Word, spațierea între linii este raportată prin comanda Aslan de raportare a formatării, atunci când proprietatea este modificată cu diversele scurtături de taste specifice Microsoft, precum și la mutarea pe un text cu un alt tip de spațiere dacă opțiunea „Anunță spațiere linie” este activată din setările Aslan de formatare a documentului. (#2961)
...
* Aslan acum raportează culori, folosind un set de bază și ușor de înțeles de 9 culori principale și 3 nuanțe, cu variații de luminozitate și tentă. Modul este ales mai degrabă decât cel cu folosirea de nume pentru culori care sunt mai subiective și greu de înțeles. (#6029)
* Comportamentul existent pentru comenzile Aslan+F9 apoi Aslan+F10 a fost modificat în selecția de text la prima apăsare a lui F10. Când F10 este apăsat de două ori (în succesiune rapidă) textul este copiat în planșetă. (#4636)
...
* În Microsoft Word, Aslan acum raportează corespunzător când se folosesc comenzile proprii Wordului de navigare a tabelelor (alt+home, alt+end, alt+pageUp și alt+pageDown) și comenzi de selecție pentru tabele (shift adăugat la comenzile de navigare). (#5961)
* În ferestrele de dialog Microsoft Word, navigarea prin obiecte a Aslan a fost îmbunătățită semnificativ. (#6036)
...
* În aplicația Windows 10 Mail , Aslan nu mai eșuează în citirea conținutului mesajelor. (#5635) 
...
* În pluginul Web Conference (cum este cel folosit pe out-of-sight.net) Aslan nu mai emite bipuri și nu mai anunță actualizări pentru bara de progres pentru intrările de la microfon. (#5888)
...
* La modificarea înregistrărilor într-un dicționar, acum se va anunța folosirea unei expresii regulate invalide. Aslan nu va mai pica dacă un fișier dicționar conține o expresie regulată invalidă. (#4834)
* Dacă Aslan nu mai poate comunica cu afișajul braille (de ex. pentru că a fost deconectat), va dezactiva automat folosirea afișajului. (#1555)
* Performanță ușor îmbunătățită la filtrare în lista de elemente din modul navigare, în unele cazuri. (#6126)
* În Microsoft Excel, numele șabloanelor de fundal raportate de Aslan acum corespund celor folosite de Excel. (#6092)
...
* Aslan acum detectează corect butoanele de mutare pentru seriile ALVA BC640/680 de afișaje braille. (#5206)
* Aslan poate din nou să raporteze notificări Windows Toast în versiunile recente ale Windows 10. (#6096)
* Aslan nu se mai oprește din a recunoaște câteodată apăsări de taste pe afișaje braille Baum-compatibile și HumanWare Brailliant B. (#6035)
* Dacă raportarea numerelor de rând este activată în opțiunile de formatare a documentului ale Aslan, sunt arătate numerele de rând pe afișajele braille. (#5941)
* Când modul vorbire este dezactivat, raportarea obiectelor (cum ar fi apăsarea Aslan+tab pentru anunțul focalizării) apare acum în Monitorul de vorbire așa cum este de așteptat. (#6049)
...
* Aslan nu mai provoacă închiderea imediată a Microsoft Word după ce este pornită în Windows XP. (#6033)
...
* În Microsoft Excel, Aslan acum anunță nivelul unui grup de celule, precum și dacă este extins sau restrâns. (#5690)
* Dubla apăsare a comenzii „Raportează formatul textului” (Aslan+f) prezintă informația în modul navigare pentru a putea fi examinată. (#4908)
* În Microsoft Excel 2010 sau mai nou, nuanța și umplerea cu gradient pentru celulă sunt, acum, anunțate. Raportarea automată este controlată de opțiunea „Anunță culori” din preferințele pentru formatarea documentului ale Aslan. (#3683)
...
* Dacă raportarea erorilor de ortografie este activată și disponibilă pentru controlul cu focus, Aslan va reda un sunet pentru a vă notifica dacă a fost făcută o greșeală în timpul tastării. Aceasta poate fi dezactivată folosind noua poțiune „Redă sunet pentru erorile de ortografie în timpul tastării” în fereastra de preferințe a Aslan pentru setări tastatură. (#2024)
* Erorile de ortografie sunt acum raportate în Microsoft Word. Această setare poate fi dezactivată folosind noua opțiune „Anunță erori de ortografie” în fereastra de preferințe pentru formatarea documentului a Aslan. (#5877)

### Modificări

* În mod navigare și pentru câmpuri text editabile, Aslan acum tratează tasta Enter de pe blocul numeric la fel ca tasta Enter principală. (#5385)
* Aslan a trecut la sintetizatorul de vorbire eSpeak NG. (#5651)
* În Microsoft Excel, Aslan nu mai ignoră un antet de coloană pentru o celulă atunci când există un rând gol între celulă și antet. (#5396)
...
* În modul navigare, la încercarea de a folosi navigarea cu o singură literă pentru a se muta la un element care nu este suportat pentru respectivul document, Aslan anunță că acest lucru nu este suportat, față de precedentul anunț că nu există element în direcția respectivă. (#5691)
...
* Aslan nu mai anunță informații ciudate la comutarea ferestrelor într-o aplicație Java cu ferestre multiple, cum ar fi IntelliJ sau Android Studio. (#5732)
...
* Aslan nu mai are probleme de terminare prematură uneori când se activează ieșirile braille. (#4457)
...
* Când este folosit un afișaj braille, multe dintre mesajele Aslan care erau doar rostite, acum sunt și afișate braille. (#5557)
...
* În Google Chrome și browsere bazate pe Chrome, puteți acum forța comutarea Aslan la modul navigare în ferestrele de dialog web sau aplicații. (#5818)
...
* În Microsoft Word, Aslan nu se mai blochează pentru tabele mari atunci când raportarea antetelor de rând/coloană ale tabelelor este activată. (#5878)
* În Microsoft word, Aslan nu mai raportează incorect textul cu un nivel de subliniere (dar nu pentru un stil de rubrică integrat) ca rubrică. (#5186)
...
* componentele C++ ale Aslan sunt acum generate cu Microsoft Visual Studio 2015. (#5592)
