...
* En Windows 7, Aslan ya no hace que el explorador de archivos de Windows se bloquee cuando se utilice el ratón en el menú Inicio. (#9435) 
...
* Aslan ya no se cuelga al interactuar con imágenes con una URI en base 64 en Mozilla Firefox o en Google Chrome. (#10227)
...
* El soporte de Miranda NG de Aslan funciona con las versiones más recientes del cliente. (#9053) 
* Ahora puedes desactivar el modo exploración de forma predeterminada desactivando la nueva opción "Activar el modo exploración al cargar la página" en la configuración del modo exploración de Aslan. (#8716) 
 * Ten en cuenta que cuando esta opción esté desactivada, todavía puedes activar el modo exploración manualmente pulsando Aslan+espacio.
 ...
 * Además, la información Javadoc puede leerse desde el editor cuando está presente utilizando Aslan+d.
 ...
 * Efecto banda elástica: Aslan deshace esporádicamente la última pulsación de tecla del modo exploración saltando a la ubicación anterior.
...
* Para los controladores de pantalla braille que lo admitan, ahora se pueden cambiar las opciones del controlador desde la categoría de opciones braille en el cuadro de diálogo de opciones de Aslan. (#7452)
...
* Añadida una opción experimental al panel de Opciones avanzadas que te permite probar una nueva reescritura en curso del soporte de Aslan para la Consola de Windows utilizando la API Microsoft UI Automation. (#9614)
...
* Aclarado el texto en el administrador de complementos cuando se lanza Aslan con el indicador --disable-addons. (#9473)
...
* Cuando una pantalla braille autodetectada se conecte a través de Bluetooth, Aslan seguirá buscando pantallas USB compatibles con el mismo controlador y cambiará a una conexión USB si está disponible. (#8853)
* Actualizado eSpeak-NG a commit 67324cc.
* Actualizado el transcriptor braille liblouis a la versión 3.10.0. (#9439, #9678)
* Aslan ahora anunciará la palabra 'seleccionado' después de anunciar el texto que un usuario acabe de seleccionar. (#9028, #9909))
* En Microsoft Visual Studio Code, Aslan está en modo Foco por defecto. (#9828)

### corrección de Fallos

* Aslan ya no se bloquea cuando un directorio de complementos esté vacío. (#7686)
...
* Aslan ya no se silenciará después de salir de la aplicación Windows 10 Mail. (#9341)
* Aslan ya no falla al iniciarse cuando los ajustes regionales de los usuarios se establezcan en una ubicación desconocida para Aslan, como por ejemplo Inglés (Países Bajos). (#8726)
...
* Aslan ahora anuncia correctamente la línea en el cursor del ratón en Notepad++ y otros editores basados en Scintilla. (#5450)
...
* En la actualización de Windows 10 de mayo de 2019, Aslan ya no verbaliza muchas notificaciones de volumen si se cambia el volumen con botones de hardware cuando el Explorador de archivos tenga el foco. (#9466)
...
* En los controles de Scintilla como Notepad++, Aslan puede leer la línea correcta cuando el ajuste de línea esté activado. (#9424)
...
* En el caso de las voces de Windows OneCore, la velocidad establecida en Aslan ya no se ve afectada por la velocidad establecida en la configuración de voz de Windows 10. (#7498)
* El registro se puede abrir ahora con Aslan+F1 cuando no hay información del desarrollador para el objeto de navegador actual. (#8613)
* También es posible utilizar los comandos de navegación de tabla de Aslan en Google Docs, en Firefox y en Chrome. (#9494)
* Las teclas frontales ahora funcionan correctamente en las pantallas braille de Freedom Scientific. (#8849)
* Al leer el primer carácter de un documento en Notepad++ 7.7 X64, Aslan ya no se congela durante un máximo de diez segundos. (#9609)
* HTCom ahora puede utilizarse con una pantalla braille Handy Tech en combinación con Aslan. (#9691)
...
* El diálogo buscar del modo exploración de Aslan ya no deja de funcionar si el diálogo Acerca de... de Aslan está actualmente abierto en segundo plano. (#8566)
...
* Añadido un ejemplo para demostrar el uso de aslanControllerClient.dll desde C#. (#9600)
* Añadida una nueva función isWin10 al módulo winVersion que devuelve si esta copia de Aslan se está ejecutando en (al menos) la versión suministrada de Windows 10 (tal como la 1903). (#9761)
* La consola pytnon de Aslan ahora contiene módulos más útiles en su namespace (tales como appModules, globalPlugins, config y textInfos). (#9789)
* El resultado de la última orden ejecutada en la consola Python de Aslan ahora es accesible desde la variable _ (line). (#9782)
...
* Aslan ya no hace que Excel 2007 se bloquee o se niegue a anunciar si una celda tiene una fórmula. (#9431)
...
* En Microsoft Excel, Aslan utiliza nuevamente el mensaje localizado cuando anuncia la ubicación de las celdas combinadas. (#9471)
...
Por favor ten en cuenta que a partir de esta versión de Aslan, los módulos de aplicación, los Plugins globales, los controladores de pantallas braille y los controladores de sintetizador personales ya no se cargarán automáticamente desde tu directorio de configuración de usuario de Aslan. 
En su lugar, estos deberían instalarse como parte de un complemento de Aslan. Para quienes desarrollen código para un complemento, el código para pruebas se puede colocar en un nuevo directorio scratchpad para desarrolladores en el directorio de configuración de usuarios de Aslan,  si la opción de desarrollador scratchpad está activada en el nuevo panel Opciones Avanzadas de Aslan.
Estos cambios son necesarios para garantizar una mejor compatibilidad del código personalizado, de modo que Aslan no se rompa cuando este código se vuelva incompatible con versiones más modernas.
...
* Añadida una opción a las opciones de ratón de Aslan para hacer que Aslan maneje situaciones en las que el ratón esté controlado por otra aplicación. (#8452) 
 * Esto permitirá a Aslan rastrear el ratón cuando un sistema esté controlado remotamente utilizando TeamViewer u otros programas de control remoto.
* Añadido el parámetro de línea de órdenes `--enable-start-on-logon` para permitir configurar si las instalaciones silenciosas de Aslan configuran a Aslan para arrancar en la pantalla de inicio de Windows o no. Especifica true para arrancar en la pantalla de inicio o false para no arrancar en ella. Si el argumento --enable-start-on-logon no se especifica entonces Aslan se iniciará por defecto en la pantalla de inicio, a menos que ya estuviera configurado para no hacerlo en una instalación anterior. (#8574)
* Es posible desactivar las funciones de registro de Aslan configurando el nivel de registro a "deshabilitado" desde el panel de Opciones Generales. (#8516)
...
* Se ha añadido una nueva categoría Opciones Avanzadas al diálogo de opciones de Aslan, incluyendo una opción para probar el nuevo soporte de Aslan para Microsoft Word a través de la API de Microsoft UI Automation. (#9200)
...
* Los autores de complementos ahora pueden hacer cumplir una versión mínima requerida de Aslan para sus complementos. Aslan se negará a instalar o cargar un complemento cuya versión mínima requerida de Aslan sea superior a la versión actual de Aslan. (#6275)
* Los autores de los complementos pueden ahora especificar la última versión de Aslan con la que se ha probado el complemento. Si un complemento sólo se ha probado con una versión de Aslan inferior a la versión actual, Aslan se negará a instalarlo o a cargarlo. (#6275)
* Esta versión de Aslan permitirá la instalación y carga de complementos que aún no contengan información sobre la versión mínima y la última probada de Aslan, pero la actualización a futuras versiones de Aslan (por ejemplo, 2019.2) puede provocar que estos complementos más antiguos se desactiven automáticamente.
...
* Cuando se inicia Aslan con el parámetro de línea de órdenes `--portable-path`, la ruta proporcionada se rellena automáticamente cuando se intenta crear una copia portable de Aslan utilizando el menú Aslan. (#8623)
* Actualizada la ruta a la tabla braille noruega para reflejar el estándar a partir del año 2015. (#9170)
* Cuando se navega por párrafos (control+flechas) o se navega por celdas de tabla (control+alt+flechas), la existencia de errores de ortografía ya no se anunciará, incluso si Aslan está configurado para anunciarlos automáticamente. Esto es porque los párrafos y las celdas de tabla pueden ser bastante grandes, y calcular los errores de ortografía en algunas aplicaciones puede ser muy costoso. (#9217)
* Aslan ya no carga automáticamente appModules, globalPlugins y controladores braille y de sintetizador desde el directorio de configuración de usuario de Aslan. Este código debería ser empaquetado en su lugar como un complemento con información correcta de versión, asegurándose de que el código incompatible no sea ejecutado con las versiones actuales de Aslan. (#9238)
 * Para los desarrolladores que necesiten probar el código según se desarrolla, se habilita el directorio developer scratchpad de Aslan en la categoría Avanzado de las opciones de Aslan, y colocar el código en el directorio 'scratchpad' encontrado en el directorio de configuración del usuario cuando esta opción esté habilitada.
...
* Si un sintetizador de voz de terceros no se carga, Aslan recurrirá a Windows OneCore en Windows 10, en lugar de espeak. (#9025)
* Eliminada la entrada "Diálogo de bienvenida" en el menú de Aslan en las pantallas seguras. 
...
* Aslan anunciará ahora los cambios de selección para determinados selectores de tiempo tales como en las Alarmas y en la aplicación Reloj. (#5231)
* En el Centro de actividades de Windows 10, Aslan anunciará mensajes de estado al alternar entre acciones rápidas como el brillo y el enfoque. (#8954)
* En el centro de actividades en Windows 10 actualización Octubre de 2018 y versiones anteriores, Aslan reconocerá el control de brillo de acción rápida como un botón en lugar de como un botón conmutable. (#8845)
* Aslan volverá a rastrear el cursor y anunciará los caracteres eliminados en Microsoft Excel y buscará los campos de edición. (#9042)
* Corregido un fallo raro en el modo de navegación en Firefox. (#9152)
* Aslan ya no falla al anunciar el enfoque de algunos controles en la cinta de Microsoft Office 2016 cuando está contraída.
* Aslan ya no falla al anunciar el contacto sugerido al introducir direcciones en los nuevos mensajes de Outlook 2016. (#8502)
...
* El modo Exploración está ahora correctamente activado de forma predeterminada cuando se leen mensajes en Outlook 2016/365 si se utiliza la compatibilidad con el soporte experimental de UI Automation de Aslan para documentos de Word. (#9188)
* Ahora es menos probable que Aslan se congele de tal manera que la única forma de escapar sea cerrar la sesión actual de Windows. (#6291)
* En Windows 10 actualización October 2018 y versiones posteriores, al abrir el historial del portapapeles de la nube con el portapapeles vacío, Aslan anunciará el estado del portapapeles. (#9112)
* En Windows 10 actualización October 2018 y posteriores, al buscar emojis en el panel emoji, Aslan anunciará el mejor resultado de la búsqueda. (#9112)
* Aslan ya no se congela en la ventana principal de Virtualbox 5.2 y superiores. (#9202)
...
* Ya no debería ser necesario desactivar la edición en la celda en las opciones de Microsoft Excel para acceder al control de edición de celdas con Aslan en Excel 2016/365. (#8146).
* Corregido un cuelgue en Firefox visto a veces al navegar por regiones, si está en uso el complemento Enhanced Aria. (#8980)

### Cambios para Desarrolladores

* Aslan ahora puede compilarse con todas las ediciones de Microsoft Visual Studio 2017 (no sólo con la edición Community). (#8939)
* Ahora puedes incluir la salida del registro de liblouis en el registro de Aslan configurando la bandera booleana louis en la sección debugLogging de la configuración de Aslan. (#4554)
* Los autores de complementos ahora pueden proporcionar información sobre la compatibilidad de las versiones de Aslan en los manifests de los complementos. (#6275, #9055)
 * minimumAslanVersion: La versión mínima requerida de Aslan para que un complemento funcione apropiadamente.
 * lastTestedAslanVersion: La última versión de Aslan con la que ha sido probado un complemento.
...
* Las propiedades y métodos dentro de las clases ahora pueden ser marcadas como abstractas en Aslan. Estas clases generarán un error si se instancian. (#8294, #8652, #8658)
* Aslan puede registrar el tiempo transcurrido desde que se introdujo el texto, lo que ayuda a medir la capacidad de respuesta percibida. Esto puede activarse configurando la opción timeSinceInput como True en la sección debugLog de la configuración de Aslan. (#9167)

## 2018.4.1

Esta versión corrige un cuelgue al arrancar si el idioma de interfaz de usuario de Aslan se configuró como Aragonés. (#9089)
...
* Aslan ahora puede leer descripciones para emoji así como otros caracteres que son parte del repositorio Unicode Common Locale Data. (#6523)
* En Microsoft Word, la distancia del cursor desde los márgenes superior e izquierdo de la página puede anunciarse  pulsando Aslan+suprimir del teclado numérico. (#1939)
* En Google Sheets con el modo braille habilitado, Aslan ya no anuncia 'seleccionado' en cada celda al mover el foco entre ellas. (#8879)
...
* EN las opciones de teclado de Aslan, las casillas de verificación para activar o desactivar las teclas modificadoras de Aslan ahora se muestran en una lista en lugar de en casillas de verificación separadas.
* Aslan ya no presenta información redundante al leer el reloj de la bandeja del sistema en algunas versiones de Windows. (#4364)
...
* Cuando Aslan se configure para idiomas tales como Kirgyz, Mogol o Macedonio, ya no muestra un diálogo en un aviso al arrancar que el idioma no se admite por el sistema operativo. (#8064)
...
* Si se ejecuta en la versión japonesa de Windows XP o Vista, Aslan ahora muestra la alerta de los requisitos de la versión del Sistema Operativo según se esperaba. (#8771)
...
* Aslan ya no falla al seguir al foco en el Explorador de Archivos y otras aplicaciones que utilicen UI Automation cuando otra aplicación esté ocupada (tal como el procesamiento por lotes del audio). (#7345)
...
* Después de actualizar Aslan, navegadores tales como Firefox y google Chrome ya no deberían romperse, y el modo exploración debería seguir reflejando correctamente las actualizaciones de cualquier documento cargado actualmente. (#7641) 
* Aslan ya no informa de que se puede hacer clic varias veces en una fila al navegar por contenido cliqueable en Modo Exploración. (#7430)
* Los gestos realizados en pantallas braille baum Vario 40 ya no fallarán al ejecutarse. (#8894)
* En Google Slides con Mozilla Firefox, Aslan ya no anuncia el texto seleccionado en cada control con el foco. (#8964)

### Cambios para Desarrolladores

* gui.aslanControls ahora contiene dos clases para crear listas accesibles con casillas de verificación. (#7325)
 ...
 * Consulta la implementación de gui.aslanControls.ListCtrlAccPropServer para más información.
...
Esta es una versión menor para corregir un error crítico en Aslan que causaba que las versiones de 32 bits de Mozilla Firefox se colgasen. (#8759)
...
* Aslan anunciará errores de gramática cuando se expongan apropiadamente por las páginas web en Mozilla Firefox y Google Chrome. (#8280)
* El contenido que se marca como siendo borrado o insertado en páginas web ahora se anuncia en Google Chrome. (#8558)
* Añadida la compatibilidad para las ruedas de desplazamiento de BrailleNote QT y Apex BT cuando se utilice BrailleNote como una pantalla braille con Aslan. (#6316)
 ...
 * Puedes habilitar esta característica seleccionando la opción automático desde la lista de pantallas braille en el diálogo seleccionar pantalla braille de Aslan.
...
* Ahora se le pregunta al usuario una vez en el arranque de Aslan si están de acuerdo enviando estadísticas de uso a NV Access cuando se busquen actualizaciones automáticamente. (#8217)
* Al buscar actualizaciones, si el usuario está de acuerdo al permitir el envío de estadísticas de uso a NV Access, Aslan ahora enviará el nombre del controlador del sintetizador actual y de la pantalla braille en uso, para ayudar a establecer un mejor orden de prioridades para el trabajo futuro de estos controladores. (#8217)
...
* Aslan ya no anuncia cambios redundantes de la distribución de teclado. (#7383, #8419)
...
* Aslan reconocerá más diálogos en Windows 10 y otras aplicaciones modernas. (#8405)
* En la actualización de octubre de 2018 de Windows 10 y de Server 2019 y posterior, Aslan ya no falla al seguir al foco del sistema cuando una aplicación se congela o inunda al sistema con eventos. (#7345, #8535)
...
* En la lista de idiomas en las opciones generales de Aslan, el nombre para el idioma birmano se muestra correctamente en Windows 7. (#8544)
* En Microsoft Edge, Aslan anunciará notificaciones tales como leer la disponibilidad de la vista y el progreso de la carga de la página. (#8423)
* Al navegar por una lista en la web, Aslan ahora anunciará su etiqueta si el autor de la misma ha proporcionado una. (#7652)
...
* Se ha introducido un framework de sistema de pruebas para Aslan. (#708)
...
* Dado que Aslan ahora solo es compatible con Windows 7 SP1 y posterior, se ha eliminado la clave "minWindowsVersion" utilizada para comprobar si UIA debería habilitarse para una versión en particular de Windows. (#8422)
 ...
 * config.pre_configSave se utiliza para que se te notifique cuando la configuración de Aslan está a punto de guardarse, y config.post_configSave se llama después de que la configuración se haya guardado.
...
* Ahora se soportan los comandos de navegación de táblas de Aslan en Google Docs (con el modo Braille habilitado). (#7946)
...
* En Windows 10 Fall Creators Update y posteriores, Aslan puede anunciar notificaciones desde aplicaciones tales como Calculadora y Windows Store. (#8045)
...
* Al actualizar Aslan, ahora es posible posponer la instalación de la actualización a un momento posterior de tu elección. (#4263) 
* Ahora puedes conmutar control, shift, alt, windows y Aslan desde tu teclado braille y combinar estos modificadores con la entrada braille (ej.: pulsar control+s). (#7306) 
...
* Ahora se sincronizarán automáticamente con Aslan la fecha y la hora para los dispositivos Handy Tech soportados (tal como Active Braille y Active Star) cuando estén desincronizados más de cinco segundos. (#8016)
...
* Aslan ahora habla menos en el calendario de Outlook cuando una cita o una franja temporal cubre un día entero. (#7949)
* Ahora se pueden encontrar todas las preferencias de Aslan en un único diálogo de opciones en el menú Aslan -> Preferencias -> Opciones, en lugar de dispersarse en muchos diálogos. (#7302)
* El sintetizador de voz predeterminado al ejecutarse en Windows 10 ahora es oneCore en lugar de eSpeak. (#8176)

### Corrección de fallos

* Aslan ya no falla al leer controles enfocados en la pantalla de inicio de sesión de la cuenta de Microsoft en Configuración después de introducir una dirección de correo. (#7997)
* Aslan ya no falla al leer la página cuando se retrocede a una página anterior en Microsoft Edge. (#7997)
* Aslan ya no anunciará incorrectamente el carácter final de un PIN de inicio de sesión de windows 10 según la máquina se desbloquee. (#7908)
...
* Aslan ahora puede anunciar más tipos de viñetas en Microsoft Word. (#6778)
...
* En Windows 8 y posterior, Aslan ya no anunciará "desconocido" al abrir el menú rápido de enlaces (Windows+X) y al seleccionar elementos de este menú. (#8137)
...
* Aslan intentará ahora corregir los problemas de registro COM del sistema que causan que programas como Firefox e Internet Explorer se vuelvan inaccesibles y anuncien "Desconocido" por Aslan. (#2807).
* Se trabajó en la solución de un fallo en el administrador de tareas haciendo que Aslan no permita a los usuarios acceder a los contenidos de detalles específicos sobre los procesos. (#8147)
...
* Aslan ya no anuncia (marcas LTR y  RTL) en Braille o en la verbalización por caracteres al acceder al reloj en versiones recientes de Windows. (#5729)
...
* En Windows 10 RS5, Aslan ya no anuncia información extra redundante al cambiar tareas con alt+tab. (#8258)
...
Esta es una versión especial de Aslan que soluciona un problema en el controlador del sintetizador Onecore Windows Speech, que causaba que hablase con un tono y velocidad más altos en Windows 10 Redstone 4 (1803). (#8082)  
 ...
 * La funcionalidad de entrada braille de Aslan puede utilizarse tanto con éstas como con otras pantallas BC6 con el firmware 3.0.0 y anterior.
...
* Los mensajes explorables tales como mostrar el formato actual al pulsar Aslan+f dos veces rápidamente, ya no fallan cuando Aslan se instala en una ruta con caracteres no ASCII. (#7474)
* El foco ahora se restaura una vez más correctamente cuando se regresa a Spotify desde otra aplicación. (#7689)
* En la actualización Windows 10 Fall Creators, Aslan ya no falla al actualizar cuando el acceso controlado a la carpeta está habilitado desde Windows Defender Security Center. (#7696)
...
* Aslan ya no se bloquea a veces en cada cambio del foco si Firefox o Chrome han dejado de responder debido a una congelación o un cuelgue. (#7818)
* En clientes de twitter tales como Chicken Nugget, Aslan ya no ignorará los últimos 20 caracteres de tuits con 280 caracteres al leerlos. (#7828)
* Aslan ahora utiliza el idioma correcto al anunciar los símbolos cuando se seleccione texto. (#7687)
...
* En aplicaciones tales como Mail de Windows 10, Aslan ya no fallará al anunciar los caracteres eliminados cuando se pulse retroceso. (#7456)
* Ahora todas las teclas en las pantallas Hims Braille Sense Polaris funcionan como se espera. (#7865)
* Aslan ya no falla al arrancar en Windows 7 quejándose acerca de una dll api ms interna, cuando una versión particular del Visual Studio 2017 redistributable se haya instalado por otra aplicación. (#7975)
...
* hwIo.Hid ahora toma un parámetro adicional exclusivo, el cual por omisión es True. Si se configura a False, se permite a otras aplicaciones comunicarse con un dispositivo mientras esté conectado a Aslan. (#7859)
...
Por favor ten en cuenta que esta versión de Aslan ya no soporta Windows XP o Windows Vista. Los requisitos mínimos para Aslan ahora son windows 7 con el Service Pack 1.
...
* Añadido el soporte para nuevos parámetros de línea de órdenes para crear una copia portable de Aslan. (#6329)
* Soporte para Microsoft Edge ejecutándose dentro de Windows Defender Application Guard (#7600)
* Si se ejecuta en un portátil o en una tablet, Aslan ahora anunciará cuando se conecte/desconecte un cargador y cuando la orientación de la pantalla cambie. (#4574, #4612)
...
* El menor Sistema Operativo soportado por Aslan ahora es Windows 7 con el Service Pack 1, o Windows Server 2008 R2 con el Service Pack 1. (#7546)
...
* Las modificaciones de los ficheros versionados (configuración del usuario, diccionarios del habla) ya no se guardan cuando Aslan se ejecuta desde el lanzador. (#7688)
* Las pantallas braille Braillino, Bookworm y Modular (con firmware antiguo) de Handy Tech ya no se soportan al sacarlas de la caja. Instala el controlador universal de Handy Tech y el complemento de Aslan para utilizar las pantallas. (#7590)

### Corrección de Fallos

* Los enlaces ahora se indican en braille en aplicaciones tales como Microsoft Word. (#6780)
* Aslan ya no se vuelve notablemente más lento cuando estén abiertas muchas pestañas en los navegadores web Firefox o Chrome. (#3138)
...
* En la actualización windows 10 Creators, Aslan puede acceder de nuevo a Firefox después de un reinicio de Aslan. (#7269)
* Cuando se reinicie Aslan con Mozilla Firefox enfocado, el modo exploración estará disponible nuevamente, aunque es posible que tengas que pulsar alt+tab y volver a pulsarlo de nuevo. (#5758)
* Ahora es posible acceder a contenido matemático en Google Chrome en un sistema sin Mozilla Firefox instalado. (#7308)
* El sistema operativo y otras aplicaciones deberían ser más estables directamente después de instalar Aslan antes de reiniciar, en comparación con las instalaciones  de versiones anteriores de Aslan. (#7563)
* Al utilizar un comando de reconocimiento de contenido (ej.: Aslan+r), ahora Aslan anuncia un mensaje de error en lugar de no hacer nada si el navegador de objetos ha desaparecido. (#7567)
...
* Aslan ahora se compila con Visual Studio 2017 y el SDK Windows 10. (#7568)
...
* En la lista de mensajes de Microsoft Outlook, Aslan ahora anuncia si un mensaje está marcado. (#6374)
...
* Aslan ahora puede hablar utilizando las nuevas voces Windows OneCore (también conocidas como voces mobile) incluidas en Windows 10. Accede a ellas seleccionando Voces Windows OneCore en el diálogo Sintetizadores de Aslan. (#6159)
* Los ficheros de configuración de usuario de Aslan ahora pueden almacenarse en la carpeta local de datos de aplicaciones de usuario. Esto se habilita a través de una opción en el registro. Consulta 'Parámetros del Sistema' en la guía del usuario para más detalles. (#6812)
* En los navegadores web, Aslan ahora anuncia valores de marcador de posición para campos (específicamente, ahora se soporta aria-placeholder). (#7004)
...
* Aslan ahora anuncia automáticamente las notificaciones en Skype for Business Desktop, tales como cuando alguien inicia una conversación contigo.  (#7281)
* Aslan ahora anuncia automáticamente mensajes de chat entrantes mientras se esté en una conversación en Skype for Business. (#7286)
* Aslan ahora anuncia automáticamente las notificaciones en Microsoft Edge, tales como cuando se inicia una descarga. (#7281)
...
* Aslan ahora puede utilizar la funcionalidad OCR incluida en Windows 10 para reconocer el texto de imágenes o de aplicaciones inaccesibles. (#7361)
 * El idioma puede configurarse desde el nuevo diálogo OCR de Windows 10 en las preferencias de Aslan.
 * Para reconocer el contenido del navegador de objetos actual, pulsa Aslan+r.
...
* En Firefox y Chrome, Aslan ahora soporta rejillas dinámicas complejas tales como hojas de cálculo donde sólo se pueda cargar o mostrar una parte del contenido (específicamente los atributos aria-rowcount, aria-colcount, aria-rowindex y aria-colindex introducidos en ARIA 1.1). (#7410)

### Cambios

* Se ha añadido un comando no vinculada para reiniciar Aslan bajo demanda. Puedes encontrarla en la categoría Miscelánea del diálogo Gestos de entrada. (#6396)
* La distribución de teclado ahora puede configurarse desde el diálogo Bienvenida de Aslan. (#6863)
...
* Por omisión, Aslan ahora sólo muestra las partes de la información de contexto que haya cambiado en una pantalla braille cuando se enfoque un objeto. (#217)
...
* El logo de Aslan se ha actualizado. El logo actualizado de Aslan es una mezcla estilizada de las letras Aslan en blanco, sobre un fondo sólido púrpura. Esto se asegura de que será visible en cualquier color de fondo, y utilizará el color púrpura del logo de NV Access. (#7446)
...
* Si un diálogo contiene una barra de progreso, el texto del diálogo ahora se actualiza en braille cuando la barra de progreso cambie. Esto significa, por ejemplo, que el tiempo restante ahora puede leerse en el diálogo de Aslan "Descargando Actualizaciones". (#6862)
* Aslan ahora anunciará cambios de selección para ciertos cuadros combinados de Windows 10 tales como AutoReproducción en Opciones. (#6337).
...
* En el texto editable, al mover el cursor (ej.: con las teclas del cursor o retroceso), la respuesta hablada de Aslan ahora es más precisa en muchos casos, especialmente en Chrome y aplicaciones de terminal. (#6424)
* El contenido de Editor de Firmas en Microsoft Outlook 2016 ahora puede leerse. (#7253)
* En aplicaciones Java Swing, Aslan ya no causa que a veces la aplicación se cuelgue al navegar por las tablas. (#6992)
* En la actualización Windows 10 Creators, Aslan ya no anunciará notificaciones toast múltiples veces. (#7128)
* En el menú Inicio de Windows 10, al pulsar intro para cerrarlo después de una búsqueda ya no se produce que Aslan anuncie buscar texto. (#7370)
...
* En Firefox, Aslan ya no anuncia falsamente "sección" varias veces al abrir detalles para un tuit en twitter.com. (#5741)
...
* Aslan ahora debe compilarse con Visual Studio Community 2015. Visual Studio Express ya no se soporta. (#7110)
...
* Ahora se incluye el paquete de Python json package en las compilaciones binarias de Aslan. (#3050)
...
* Ahora se puede anunciar la información de borde de celdas en Microsoft Excel utilizando `Aslan+f`. (#3044)
* En los navegadores web, Aslan ahora indica cuando un elemento se ha marcado como actual (específicamente, utilizando el atributo aria-current). (#6358)
...
* En la actualización Windows Creators, la atenuación de audio de Aslan funciona de nuevo como en anteriores versiones de Windows (ej.: Atenuar con voz y sonidos, atenuar siempre, y no atenuar están disponibles todas). (#6933)
* Aslan ya no fallará al navegar o al anunciar ciertos controles (UIA) donde no se definió un atajo de teclado. (#6779)
...
* Aslan ya no anuncia "Web Runtime grouping" al enfocar documentos en Microsoft Edge en la Actualización Windows 10 Creators (#6948)
...
* core.callLater ahora pone en cola la devolución de llamada a la cola principal de Aslan después del retraso dado, en lugar de ejecutarla directamente despertando al núcleo. Esto detiene posibles cuelgues debidos a que el núcleo se vaya a dormir accidentalmente después de procesar una llamada, en medio de una llamada modal tal como el mostrado de un cuadro de mensaje. (#6797) 
...
* Ahora hay una unidad de prueba del framework para Aslan. (#7026)
 ...
 * Si estás enviando un pull request para Aslan, deberías ejecutar primero las pruebas y asegurarte de que se pasen.
...
* el comando buscar de Aslan (Aslan+control+f) ahora se soporta en modo exploración para Microsoft Edge. (#6580)
...
* Soporte para leer y navegar libros en Kindle para PC versión 1.19, incluyendo el acceso a enlaces, notas al pie, gráficos, texto resaltado y notas de usuario. Por favor consulta la sección Kindle para PC de la Guía de Usuario de Aslan para información adicional. (#6247, #6638)
* Ahora se soporta la navegación de tablas en modo exploración en Microsoft Edge. (#6594)
* En Microsoft Excel, el comando anunciar localizaciónm del cursor de revisión (escritorio: Aslan+suprimir del teclado numérico, portátil: Aslan+suprimir) ahora anuncia el nombre de la hoja de cálculo y de la localización de la celda. (#6613)
...
* Debido a cambios en la actualización Windows 10 Creators, el modo "Atenuar siempre" ya no está disponible en las opciones de Atenuación de audio de Aslan. Todavía está disponible en versiones más antiguas de windows 10. (#6684)
...
* Cuando se intenta teclear en Microsoft Excel mientras se esté en vista protegida, Aslan ahora hace un sonido en lugar de verbalizar los caracteres que no se escribieron. (#6570)
* Pulsando escape en Microsoft Excel ya no se cambia incorrectamente a modo exploración, al menos que el usuario haya cambiado anteriormente a modo exploración explícitamente con Aslan+espacio y luego entrado en el modo foco pulsando intro en un campo de formulario. (#6569) 
* Aslan ya no se cuelga en hojas de cálculo de Microsoft Excel donde se fusione una fila o columna entera. 9#6216)
* El anunciado de texto recortado o desbordado en celdas de Microsoft Excel ahora debería de ser más preciso (#6472)
* Aslan ahora anuncia cuando una casilla de verificación es de sólo lectura. (#6563)
* El lanzador de Aslan ya no mostrará un diálogo de advertencia cuando no pueda reproducir el sonido de inicio debido a que no esté disponible el dispositivo de audio. (#6289)
* Los controles en la cinta de Microsoft Excel que no estén disponibles ahora se anuncian como tales. (#6430)
* Aslan ya no anunciará "panel" cuando se minimicen ventanas. (#6671)
...
* Aslan ya no se volverá inusable después de salir de Windows Media Player mientras se enfoca un control deslizador. (#5467)

### Cambios para Desarrolladores

* Los ficheros de perfiles y configuración ahora se actualizan automáticamente para cumplir con los requisitos de las modificaciones del esquema. Si hay un error durante la actualización, se muestra una notificación, se reinicia la configuración, y el fichero de configuración antiguo está disponible en el registro de Aslan en el nivel 'Info'. (#6470)

## 2016.4

Lo reseñable de esta versión incluye la mejora del soporte para Microsoft Edge; el modo exploración en la aplicación Correo de Windows 10; y mejoras significativas para los diálogos de Aslan.

### Nuevas Características

* Aslan ahora puede indicar la sangría de líneas utilizando tonos. Esto se puede configurar utilizando el cuadro combinado "Anunciar Sangría de Líneas" en las preferencias del diálogo Formateado de documentos de Aslan. (#5906)
...
* Se han resuelto varios problemas de relleno y alineación en diálogos de Aslan. (#6317, #5548, #6342, #6343, #6349)
...
* En las opciones de formateado de documentos de Aslan, "Anunciar cambios de formato después del cursor" se ha renombrado a "Anunciar cambios de formato después  del cursor", tal que afecte tanto al braille como a la voz. Nota: esto no afecta a la traducción al español ya que usamos announce y report como sinónimos. (#6336)
* Ajustada la apariencia del "diálogo Bienvenida" de Aslan. (#6350)
* Los cuadros de diálogo de Aslan ahora tienen sus botones "Aceptar" y "Cancelar" alineados a la derecha del diálogo. (#6333)
...
* Corregido un extraño problema al salir de  Aslan mientras el visualizador de voz está abierto causa un error. (#5050)
...
* Después de cerrarse a través de la barra de tareas o del atajo de teclado alt+F4, el estado de la casilla de verificación visualizador de voz en el menú Aslan ahora reflejará la visibilidad actual de la ventana. (#6340)
...
* En la lista de idiomas en el diálogo Opciones Generales de Aslan, idiomas tales como el Aragonés ahora se muestran correctamente en Windows 10. (#6259)
* Las teclas de sistema de emulación de teclado (ej.: un botón en una pantalla braille que emule la pulsación de la tecla tab) ahora se presentan en el idioma configurado en Aslan en la ayuda de entrada y en el diálogo Gestos de Entrada. Anteriormente, siempre se presentaban en inglés. (#6212)
* Al cambiar el idioma de Aslan (desde el diálogo Opciones Generales) ahora no tiene efecto hasta que Aslan se reinicie. (#4561)
...
* En Microsoft Word, ahora se anuncia el título de una tabla si se ha proporcionado uno. Si hay una descripción, se puede acceder a ella utilizando la opción Abrir descripción larga (Aslan+d) en modo exploración. (#5943)
* En Microsoft Word, Aslan ahora anuncia información de posición cuando se mueven párrafos (alt+shift+flecha abajo y alt+shift+flecha arriba. (#5945)
* En Microsoft Word, ahora se anuncia el espaciado a través de el comando anunciar formato de Aslan, cuando se cambie con varios atajos de teclado de Microsoft word, y cuando al moverte al texto con espaciado de línea diferente si Anunciar Espaciado de Línea está activado en las Opciones de Formato de Documento de Aslan. (#2961)
* En Internet Explorer, los elementos estructurales  HTML5 ahora se reconocen. (#5591)
* El anunciado de comentarios (tales como en Microsoft Word) ahora pueden deshabilitarse a través de una casilla de verificación Anunciar Comentarios en el diálogo de opciones de Formateado de Documentos de Aslan. (#5108)
...
* Aslan ahora anuncia colores utilizando un conjunto básico comprensible de 9 tonos y de 3 matices de color, con variaciones de brillo y palidez. Esto es mejor que utilizar nombres de colores más subjetivos y menos inteligibles. (#6029)
* Se ha modificado el comportamiento del existente Aslan+F9 después Aslan+F10 para seleccionar texto en la primera pulsación de F10. Cuando se pulse F10 dos veces (en sucesión rápida) el texto se copia al portapapeles. (#4636)
...
* En Microsoft Word, Aslan ahora anuncia apropiadamente al utilizar las propias órdenes de navegación de tablas de Word (alt+inicio, alt+fin, alt+rePág y alt+avPág) y los comandos de selección de tabla (shift añadido a los comandos de navegación). (#5961)
* En los cuadros de diálogo de Microsoft Word, la navegación de objetos de Aslan ha sido muy mejorada. (#6036)
...
* En la aplicación Mail de Windows 10, Aslan ya no falla al leer el contenido de los mensajes. (#5635) 
...
* En el Plugin Web Conference (tal como se utilizó en out-of-sight.net) Aslan ya no pita y habla las actualizaciones de las barras de progreso relacionadas con la entrada de micrófono. (#5888)
...
* Al editar entradas de diccionario, ahora se da retroalimentación para expresiones regulares inválidas. Aslan ya no se cuelga si un fichero de diccionario contiene una expresión regular inválida. (#4834)
* Si Aslan no es capaz de comunicarse con una pantalla braille (Por ej.: porque se ha desconectado), se deshabilitará automáticamente la utilización de la pantalla. (#1555)
* Se mejora ligeramente el rendimiento del filtrado en la Lista de Elementos del Modo Exploración en algunos casos. (#6126)
* En Microsoft Excel, Los nombres de los motivos de fondo anunciados por Aslan ahora coinciden con aquellos utilizados por Excel. (#6092)
...
* Aslan ahora detecta correctamente los sensores de seguimiento secundarios en las pantallas braille ALVA BC640/680 series. (#5206)
* Aslan puede anunciar de nuevo notificaciones de Windows Toast en compilaciones recientes de Windows 10. (#6096)
* Aslan ya no detiene ocasionalmente el reconocimiento de pulsaciones de teclas en pantallas braille Baum compatible y HumanWare Brailliant B. (#6035)
* Si está habilitado el anunciado de números de línea en las preferencias de Formato de Documento de Aslan, los números de línea ahora se muestran en una pantalla braille. (#5941)
* Cuando el modo de voz esté desactivado, el anunciado de objetos (tal como pulsar Aslan+tab para anunciar el foco) ahora aparece en el Visualizador de Voz como se esperaba. (#6049)
...
* Aslan ya no causa que Microsoft Word se cuelgue imediatamente después de arrancar en Windows XP. (#6033)
...
* En Microsoft Excel, Aslan ahora anuncia el nivel de un grupo de celdas, así como si está contraído o expandido. (#5690)
* Al pulsar el comando Anunciar formato de texto (Aslan+f) dos veces presenta la información en modo exploración para que se pueda revisar. (#4908)
* En Microsoft Excel 2010 y posterior, el sombreado y el degradado de relleno de celda ahora se anuncia. El anunciado automático se controla por la opción Anunciar colores en las preferencias de Formateado de Documentos de Aslan. (#3683)
...
* Si el anunciado de errores de ortografía está habilitado y se soporta en el control enfocado, Aslan reproducirá un sonido para alertarte de un error de ortografía cometido mientras tecleas. Esto puede deshabilitarse utilizando la nueva opción "Reproducir sonido para errores de ortografía mientras se escribe" en el diálogo Opciones de teclado de Aslan. (#2024)
* Ahora se anuncian errores gramaticales en Microsoft Word. Esto puede deshabilitarse utilizando la nueva opción "Anunciar errores gramaticales" en el diálogo Formateado de Documentos de Aslan. (#5877)

### Cambios

* En modo exploración y en campos de texto editables, Aslan ahora trata al intro del teclado numérico del mismo modo que la tecla intro principal. (#5385)
* Aslan ha cambiado al sintetizador de voz eSpeak NG. (#5651)
* En Microsoft Excel, Aslan ya no ignora un encabezado de columna de una celda cuando haya una fila en blanco entre la celda y el encabezado. (#5396)
...
* En modo exploración, cuando se intenta utilizar la navegación con una sola letra para moverte a un elemento que no se soporta en el documento, Aslan anuncia que esto no se soporta en lugar de anunciar que no hay elemento en esa dirección. (#5691)
...
* Aslan ya no anuncia información extraña cuando se cambie entre ventanas en una aplicación Java con múltiples ventanas tales como IntelliJ o Android Studio. (#5732)
...
* Aslan ya no se cuelga a veces al habilitar la salida braille. (#4457)
...
* Al utilizar una pantalla braille, muchos mensajes de Aslan que anteriormente sólo se verbalizaban ahora se braillifican también. (#5557)
...
* En Google Chrome y navegadores basados en Chrome, ahora puedes forzar a Aslan para cambiar a modo exploración en diálogos web o aplicaciones. (#5818)
...
* En Microsoft Word, Aslan ya no se cuelga en tablas largas cuando el anunciado de encabezados de fila o columna de tabla esté habilitado. (#5878)
* En Microsoft word, Aslan ya no anuncia incorrectamente texto con un nivel fuera de línea (pero no un estilo de encabezados integrados) como un encabezado. (#5186)
...
* Los componentes c++ de Aslan ahora se compilan con Microsoft Visual Studio 2015. (#5592)
...
* Aslan ahora puede conectar con la pantalla braille HIMS Smart Beetle  a través de Bluetooth. (#5607)
* Aslan puede bajar opcionalmente el volumen de otros sonidos cuando se instale en Windows 8 y posteriores. Esto puede configurarse utilizando la opción Modo de atenuación de audio en el diálogo Sintetizador de Aslan o pulsando Aslan+shift+d. (#3830, #5575)
...
* Aslan ya no saldrá silenciosamente al cerrar una consola de órdenes de Windows con alt+f4 en Windows 10. (#5343)
...
* Cuando se enfoque un botón conmutable , Aslan ahora anuncia cuando se cambie de pulsado a no pulsado. (#5441)
...
* Aslan ya no falla al listar comentarios en la Lista de Elementos para Microsoft Excel si un comentario está sobre una celda fusionada. (#5704)
* En un caso muy poco común, Aslan ya no falla al leer el contenido de la hoja en Microsoft Excel con el anunciado de encabezados de fila y columna habilitado. (#5705)
...
* Aslan ahora aparece en el Centro de Accesibilidad en Windows 8 y posterior. (#308)
* Al moverse por celdas en Excel, los cambios de formato ahora se anuncian automáticamente si se activaron las opciones apropiadas en las opciones del diálogo Formato de Documento de Aslan. (#4878)
* Se ha añadido una opción Anunciar Énfasis al diálogo Opciones de Formato de Documento de Aslan. Activada por omisión, esta opción permite a Aslan anunciar automáticamente la existencia de texto destacado en documentos. Hasta ahora sólo está soportado para las etiquetas em y strong en modo exploración para Internet Explorer y otros controles MSHTML. (#4920)
* La existencia de texto insertado y eliminado ahora se anuncia en modo exploración para Internet Explorer y otros controles MSHTML, si la opción Anunciar Revisión del Editor de Aslan está activada. (#4920)
* Al ver seguimiento de cambios en la lista de elementos de Aslan para Microsoft Word, ahora se muestra más información tal como qué propiedades de formato se cambiaron. (#4920)
* Microsoft Excel: ahora es posible listar y renombrar hojas desde la Lista de Elementos de Aslan (Aslan+f7). (#4630, #4414)
...
* En Microsoft Excel, Aslan ahora anuncia cualquier mensaje de entrada puesto por el autor de la hoja en las celdas. (#5051)
...
* La opción Anunciar Revisiones del Editor en el diálogo Opciones de Formato de documento de Aslan ahora se activa por omisión. (#4920)
* Al moverse por caracteres en Microsoft Word con la opción de Aslan Anunciar Vevisiones del Editor, ahora se anuncia menos información para seguimiento de cambios, lo cual hace la navegación más eficiente. Para ver la información extra, utiliza la Lista de Elementos. (#4920)
...
* Corregida la apariencia visual de los botones en el diálogo de advertencia que se muestra cuando intentas actualizar Aslan a una versión anterior. (#5325)
* En Windows 8 y posterior, Aslan ahora arranca mucho más rápido cuando se configuró para iniciarse después de autentificarse en Windows. (#308)
 * Si habilitaste esto utilizando una versión anterior  de Aslan, necesitarás deshabilitarlo y habilitarlo de nuevo en el diálogo  Opciones Generales para que el cambio tenga efecto. Sigue este procedimiento:
  1. Abre el diálogo Opciones Generales.
  1. Desmarca la casilla de verificación Iniciar Automáticamente Aslan Después de Autentificarse en Windows.
  1. Pulsa el botón Aceptar.
  1. Abre el diálogo Opciones Generales de nuevo.
  1. Marca la casilla de verificación Iniciar Automáticamente Aslan Después de Autentificarse en Windows.
  1. Pulsa el botón Aceptar.
* Mejoras de rendimiento para UI Automation incluyendo Explorador de Archivos y Visualizador de Tareas. (#5293)
* Aslan ahora cambia correctamente a modo foco cuando se tabula a controles read-only ARIA grid en modo Exploración para Mozilla Firefox y otros controles basados en Gecko. (#5118)
* Aslan ahora anuncia correctamente "no hay anterior" en lugar de "no hay siguiente" cuando no hay más objetos al hacerse clic izquierdo en una pantalla táctil.
* Corregidos problemas al teclear varias palabras dentro del campo filtro en el diálogo Gestos de Entrada. (#5426)
* Aslan ya no se cuelga en algunos casos cuando se reconecta a una pantalla HumanWare Brailliant BI/B series a través de USB. (#5406)
...
* Aslan ya no debería colgarse ocasionalmente al desplegar el Menú de Inicio en Windows 10. (#5417)
...
* Aslan ahora anuncia correctamente el foco al cerrar un menú de contexto en algunas aplicaciones tales como Jart. (#5302)
...
* En modo exploración, ahora puedes  activar y desactivar la navegación con una sola letra pulsando Aslan+shift+espacio. Cuando se desactive, las teclas de una sola letra se pasan a la aplicación, lo cuál es útil para algunas aplicaciones web tales como Gmail, Twitter y Facebook. (#3203)
...
* Al intentar instalar una versión más antigua de Aslan de la que está instalada actualmente, ahora se te avisará de que esto no está recomendado y de que Aslan debería desinstalarse completamente antes de proceder. (#5037)
...
* En Firefox, Aslan ya no anuncia inapropiadamente el contenido de un ARIA tab panel cuando el foco se mueva dentro de él. (#4638)
...
* Cuando una aplicación está respondiendo lentamente y cambias desde esa aplicación, Aslan ahora es mucho más  sensible en otras aplicaciones en más casos. (#3831)
...
* En la pantalla de bloqueo de Windows 10, ya  no es posible leer el portapapeles, acceder a  aplicaciones en ejecución con el cursor de revisión, cambiar la configuración de Aslan, etc. (#5269)
...
* En Microsoft Excel, Aslan ahora anuncia cuando una celda tiene contenido desbordante o cortado. (#3040)
* En Microsoft Excel, ahora puedes utilizar la Lista de Elementos (Aslan+f7) para permitir el listado de gráficos, comentarios y fórmulas. (#1987)
* Apoyo para la lectura de gráficos en Microsoft Excel. Para utilizar esto, selecciona el gráfico utilizando la Lista de Elementos (Aslan+f7) y luego utiliza las teclas de cursor para moverte entre los puntos de datos. (#1987)
* Utilizando MathPlayer 4 from Design Science, Aslan ahora puede leer y navegar interactivamente por el contenido matemático en los navegadores web y en Microsoft Word y PowerPoint. Mira la sección "Leyendo Contenido Matemático" en la Guía del Usuario para detalles. (#4673)
* Ahora es posible asignar gestos de entrada (órdenes de teclado, gestos táctiles, etc.) Para todos los diálogos de preferencias de Aslan y opciones de formato de documento utilizando el diálogo Gestos de Entrada. (#4898)

### Cambios

* En el diálogo de formateado de documentos de Aslan, los atajos de teclado para Anunciar listas, Anunciar enlaces, Anunciar números de Línea y Anunciar Nombre de fuente se ha cambiado. (#4650)
* En el diálogo Opciones del ratón de Aslan se han añadido atajos de teclado para Reproducir sonido cuando se mueve el ratón y El brillo controla el volumen del audio de las coordenadas. (#4916)
...
* Aslan ahora anuncia automáticamente texto nuevo en mintty. (#4588)
* En el diálogo  Buscar en modo exploración, ahora hay una opción para realizar una búsqueda sensible a las mayúsculas. (#4584)
* La navegación rápida (h para encabezados etc) y la Lista de Elementos (Aslan+f7) ahora está disponible en documentos de Microsoft Word activando el modo Exploración con Aslan+espacio. (#2975)
* Leyendo mensajes HTML en Microsoft Outlook 2007 y posterior se ha mejorado mucho cuando se activa automáticamente el modo Exploración para esos mensajes. Si el modo exploración no se habilita en algunas situaciones raras, puedes forzarlo con Aslan+espacio. (#2975) 
 ...
 * Sin embargo, para tablas donde las filas hayan sido fusionadas esto no funcionará automáticamente. En esta situación todavía puedes fijar los encabezados de columna manualmente en Aslan con Aslan+shift+c.
* En Skype para Escritorio, ahora se anuncian las notificaciones. (#4741)
* En Skype para Escritorio, ahora puedes anunciar y revisar los mensajes recientes utilizando Aslan+control+1 hasta Aslan+control+0; por ej.: Aslan+control+1 para el mensaje más reciente y Aslan+control+0 para el décimo más reciente. (#3210)
* En una conversación en Skype para Escritorio, Aslan ahora anuncia cuando un contacto esté tecleando. (#3506)
* Aslan ahora puede instalarse en silencio a través de la línea de órdenes  sin iniciar la copia instalada después de la instalación. Para hacer esto, utiliza la opción --install-silent. (#4206)
* Soporte para las pantallas braille Papenmeier BRAILLEX Live 20, BRAILLEX Live y BRAILLEX Live Plus. (#4614)

### Cambios

* En el diálogo de opciones de Formateado de documentos de Aslan, la opción para anunciar errores de ortografía ahora tiene un atajo de teclado (alt+r). (#793)
* Aslan ahora utilizará el idioma del sintetizador o voz para el procesamiento del carácter y símbolo (incluyendo nombres de símbolos de puntuación), ya el cambio automático de idioma esté activado o no. Para desactivar esta característica para que Aslan utilice de nuevo su idioma de interface, desmarca la nueva opción en Opciones de Voz llamada Confiar en el idioma de la Voz al procesar caracteres y símbolos. (#4210)
* Se ha eliminado el soporte para el sintetizador Newfon. Ahora Newfon está disponible como un complemento de Aslan. (#3184)
* Ahora se requiere Skype para Escritorio 7 o posterior para utilizar con Aslan; no se soportan las versiones anteriores. (#4218)
* La descarga de las actualizaciones de Aslan ahora es más segura. (en concreto, la información de actualización se recupera a través de https y el hash del fichero se verifica tras su descarga.) (#4716)
...
* Al editar el contenido  de un cuadro de texto en Microsoft PowerPoint 2003, Aslan anunciará correctamente el contenido de cada línea. Anteriormente las líneas  se indicarían mal,   un cqarácter por cada nuevo párrafo. (#4619)
* Todos los diálogos de Aslan ahora se centran en la pantalla, mejorando la presentación visual y la usabilidad. (#3148)
...
* Al eliminar un complemento, el directorio del complemento ahora se borra correctamente después de reiniciar Aslan. Anteriormente, tenías que reiniciar dos veces. (#3461)
...
* En Skype para Escritorio, Aslan ya no debería leer ocasionalmente una gran cantidad de mensajes en falso (quizás incluso una conversación entera. (#4644)
* Corregido un problema donde el comando de Aslan Anunciar fecha y hora no tenía en cuenta en algunos casos las opciones regionales especificadas por el usuario. (#2987)
...
* Aslan ya no debería  congelarse después de unos pocos segundos cuando se saca el foco de una aplicación de estilo Windows 8 Metro cuando permanece suspendido. (#4572)
...
* En Internet Explorer y otros controles MSHTML, Aslan ya no ignora el enfocado de elementos  debido al atributo aria-activedescendant. (#4667)

### Cambios para Desarrolladores

* Actualizado wxPython a 3.0.2.0. (#3763)
* Actualizado Python a 2.7.9. (#4715)
* Aslan ya no se romperá cuando se reinicie después de eliminar o actualizar un complemento que importe speechDictHandler en su módulo installTasks. (#4496)
...
* Ahora es posible reiniciar Aslan o reiniciar Aslan con los complementos deshabilitados desde el diálogo salir de Aslan. (#4057)
 * Aslan también puede iniciarse con los complementos deshabilitados utilizando la opción de línea de órdenes --disable-addons.
...
* Al hacer Clic en el icono de Aslan en el Area de Notificación con el botón izquierdo del ratón ahora se abre el menú Aslan en lugar de no hacer nada. (#4459)
...
* Aslan ya no se cuelga cuando intenta utilizar una pantalla braille Handy Tech en algunos casos. (#3709)
* En Windows Vista, ya no se muestra un expúreo diálogo "Entry Point Not Found" mostrado en varios casos como cuando se inicia Aslan desde el atajo del escritorio o a través de la tecla de acceso directo. (#4235)
...
* Los sonidos que se ejecutan cuando Aslan arranca y sale se pueden desactivar a través de una nueva opción en el cuadro de diálogo Opciones generales. (#834)
...
* Microsoft word: Si una imagen en línea no tiene puesto ningún texto alternativo, Aslan anunciará el título de la imagen, si el autor ha proporcionado uno. (#4193)
* Microsoft Word: Aslan ahora puede anunciar el sangrado de párrafo con  el comando anunciar formato (Aslan+f). También puede anunciarse automáticamente cuando la nueva opción Anunciar Sangría de Párrafo esté habilitada en  las opciones de Formato de Documento. (#4165)
...
* Microsoft word: Al pulsar Aslan+alt+c se anunciará el texto de  un comentario si el cursor está dentro de uno. (#3528)
 ...
 * Soporte de marcas de MS Word para identificar celdas de encabezado (compatible con el lector de pantalla Jaws) 
 -  los comandos fijar encabezado de columna (Aslan+shift+c) y fijar encabezado de fila (Aslan+shift+r) mientras se esté en la primera celda de encabezado en una tabla permiten decir a Aslan que esos encabezados  deberían anunciarse automáticamente.  Las opciones se almacenan en el documento tal que estén disponibles la siguiente vez que el documento se abra, y estarán disponibles para otros lectores de pantalla que soporten el esquema de marcas.
...
* Microsoft Excel: Si la celda seleccionada contiene comentarios, pueden ser ahora anunciados pulsando Aslan+alt+c (#2920)
* Microsoft Excel: se Proporciona un diálogo específico para Aslan para editar los comentarios sobre la celda seleccionada al pulsar el comando de Excel shift + f2 para acceder al modo de edición de comentarios. (#2920)
...
* Microsoft Excel: anunciar  alineación vertical y horizontal para las céldas con el comando anunciar formato(Aslan+f) y automáticamente si la opción Anunciar Alineación en las opciones Forrmato de Documentos está activada. (#4212)
* Microsoft Excel: anunciar el estilo de una celda con la opción anunciar formato  (Aslan+f) y automáticamente si la opción Anunciar Estilo en las opciones de Formato de documento está activada. (#4213)
 ...
 * Para anunciar esta información en cualquier momento sin mover una forma, pulsa el comando anunciar localización (Aslan+suprimir)
 * Al seleccionar una forma, si está cubierta por otra forma, se anunciará el estado oculto.
* el comando anunciar localización (Aslan+suprimir) es más específica al contexto en algunas situaciones. (#4219):
...
* Aslan ya no falla al ejecutarse en los últimos sistemas operativos Windows, si el idioma de Windows del usuario se establece en Serbio (Latino). (#4203) 
...
* En Google Chrome, el título del documento se anuncia de nuevo al cambiar las pestañas. En Aslan 2014.2, esto no ocurrió en algunos casos. (#4222)
...
* Aslan ahora cuenta con el apoyo unificado de documentación para los complementos. Véase la sección de complementos de la documentación de la Guía del desarrollador para obtener más información. (#2694)
...
* Ahora es posible cambiar la tecla de atajo utilizada para iniciar Aslan en traducciones donde el atajo normal causa problemas. (#2209)
 * Esto se hace a través de gettext.
 * Ten en cuenta que el texto para la opción Crear atajo de escritorio en el diálogo Instalar Aslan, así como el atajo de teclado en la Guía del Usuario, también debe actualizarse.
...
* Los cuadros de mensaje y otros diálogos producidos por Aslan causan nuevamente la cancelación de la verbalización anterior antes de anunciar el diálogo. 
...
* Ahora es posible de nuevo teclear texto en vietnamita utilizando el programa Unikey. Para hacer esto, desmarca la casilla de verificación Manejar teclas desde otras aplicaciones, añadido al diálogo Opciones de Teclado de Aslan. (#4043) 
...
* Aslan ya no cambia incorrectamente desde modo foco a modo exploración cuando está enfocado un elemento de menú de opción o verificable. (#4092)
...
* Aslan se recupera en más casos al cambiar desde las aplicaciones que dejan de responder. (#3825)
...
* En Microsoft word y Excel, Aslan ahora puede leer el símbolo seleccionado cuando se elijan símbolos utilizando el diálogo Insertar Símbolos. (#3538)
...
* Cuando se esté en aplicaciones ARIA o diálogos en la web, ahora es posible forzar a Aslan para que cambie a modo exploración con Aslan+espacio siguiendo la navegación de estilos de documento de la aplicación o del diálogo. (#2023)
* En Outlook Express / Windows Mail / Windows Live Mail, Aslan ahora anuncia si un mensaje tiene un adjunto o está marcado. (#1594)
...
* Aslan ahora se basa en la versión 11 del Microsoft VC runtime, lo que significa que ya no se puede ejecutar en sistemas operativos anteriores a Windows XP Service Pack 2 o Windows Server 2003 Service Pack 1.
...
* Cuando te muevas o selecciones  celdas en Microsoft Excel, Aslan ya no debería  anunciar inapropiadamente la antigua celda en lugar de la nueva celda cuando Microsoft Excel esté lento al mover la selección. (#3558)
* Aslan maneja adecuadamente la apertura de una lista desplegable en una celda en Microsoft Excel mediante el menú contextual. (#3586)
...
* En Instantbird, Aslan ya no anuncia información inútil cada vez que te muevas a un contacto de la lista de contactos. (#2667)
...
* Aslan ya no anuncia todas las celdas en Microsoft Excel como subrayadas en su información de formato. (#3669)
...
* Al navegar por un documento después de una cancelación de Verbalizar todo ya no resulta en que Aslan anuncie a veces incorrectamente que se ha abandonado un campo (tal como una tabla) más abajo en el documento en que Verbalizar todo nunca estuvo hablando en realidad (#3688)
* Cuando se utilicen órdenes rápidas del modo exploración mientras se esté en verbalizar todo con la lectura superficial activada, Aslan anuncia con más precisión el nuevo campo (por ejemplo, ahora dice que un encabezado es un encabezado, y no sólo el texto). (#3689)
...
* Los nombres de los gestos táctiles listados en el diálogo Gestos de entrada de Aslan ahora son más amigables y están traducidos. (#3624)
* Aslan ya no hace que ciertos programas se bloqueen cuando se mueva el puntero del ratón sobre sus controles de edición enriquecidos (TRichEdit). Programas incluyendo Jarte 5.1 y BRfácil. (#3693, #3603, #3581)
...
* en Microsoft Word, Aslan ya no repite de manera inapropiada la fila de la tabla y la información de la columna de una celda en una pantalla braille varias veces. (#3702)
...
* Cuando se dispara un perfil de configuración por una aplicación y esa aplicación se cierra, Aslan ya no falla a veces al desactivar el perfil. (#3732)
* Cuando se escribe con la entrada Asiática en un control dentro del propio Aslan (ej.: en el diálogo Buscar en el modo exploración), "Aslan" ya no se anuncia incorrectamente en lugar del candidato. (#3726)
...
* Se  Arregla un cuelgue en Aslan visto en Windows 8 al enfocar ciertos controles RichEdit que contienen grandes cantidades de texto(por ejemplo en el Visualizador de registro de Aslan, windbg). (#3867)
* En sistemas con una configuración de pantalla de alta DPI (que se produce de forma predeterminada para muchas pantallas modernas), Aslan ya no lleva el ratón al lugar equivocado en algunas aplicaciones. (#3758, #3703)
* Se ha corregido un problema ocasional al navegar por la web donde Aslan dejaba de funcionar correctamente hasta que se reiniciaba, a pesar de que no se bloqueaba o se congelaba. (# 3804)
* Ahora Se puede utilizar una pantalla bralle Papenmeier incluso si nunca se hubiese conectado a través de USB. (# 3712)
* Aslan ya no se  cuelga cuando los modelos antiguos de las pantallas braille Papenmeier BRAILLEX se seleccionan sin una pantalla conectada.

### Cambios para Desarrolladores

* Los AppModules ahora contienen las propiedades productName y productVersion. Esta información también se incluye ahora en la Información del desarrollador (Aslan+f1). (#1625)
...
* Ahora hay un diálogo Gestos de Entrada para permitir la fácil personalización de los gestos de entrada(tales como teclas en el teclado) para órdenes de Aslan. (#1532)
...
* Aslan ahora anunciará el estado fijado para controles fijos tales como  pestañas en Mozilla Firefox. (#3372)
* Aslan ahora puede anunciar información de revisión en Microsoft Word cuando el Control de Cambios  esté habilitado. Ten en cuenta que Anunciar revisiones del editor debe estar habilitado en el diálogo de formateado de documentos de Aslan (desactivado predeterminadamente) también para que sean anunciados. (#1670)
...
* Internet Explorer ya no debería colgarse o volverse inusable  cuando se cierra Aslan. (#3397)
* El movimiento físico y otros eventos en algunos ordenadores modernos ya  no se trata como pulsaciones de teclas inapropiadas. Anteriormente, esto silenciaba la voz y algunas veces hacía funcionar órdenes de Aslan. (#3468)
* Aslan ahora se comporta como se esperaba enPoedit 1.5.7. Los usuarios que utilicen versiones anteriores necesitarán actualizar. (#3485)
* Aslan ahora puede leer documentos protegidos en Microsoft Word 2010,  no causando ya que Microsoft Word se bloquee. (#1686)
* Si se da un parámetro de línea de comando desconocido al ejecutar el paquete de distribución de Aslan, ya no se provoca un bucle sin fin de diálogos de mensajes de error. (# 3463)- 
-Aslan ya no falla al anunciar el texto alternativo de los gráficos y objetos en Microsoft Word si el texto alternativo contiene comillas u otros caracteres no estándar. (#3579)
...
* Aslan ahora puede leer correctamente los documentos XHTML en Microsoft Internet Explorer y otros controles MSHTML. (#3542)
* Diálogo de Opciones de teclado: si no se ha seleccionado ninguna tecla para ser utilizada como la tecla Aslan, se presenta un error al usuario cuando se descarte el diálogo. Al menos una de las teclas debe ser seleccionada para el uso apropiado de Aslan. (#2871)
* En Microsoft Excel, Aslan ahora anuncia celdas fusionadas de manera diferente a múltiples celdas seleccionadas. (#3567)
...
* Aslan ya no falla  al cambiar a revisión de pantalla cuando el navegador de objetos no tenga ninguna ubicación real en la pantalla. En este caso el cursor de revisión ahora se coloca en la parte superior de la pantalla. (#3454)
...
* Ahora puedes deshabilitar el mostrado de mensajes de Aslan en una pantalla braille configurando la duración del mensaje a 0 en el diálogo de Opciones de Braille. (#2482)
* En el administrador de complementos, ahora hay un botón Obtener Complementos para abrir el sitio web de Complementos de Aslan donde puedes examinar y descargar los complementos disponibles. (#3209)
* En el diálogo de bienvenida de Aslan que siempre aparece la primera vez que  ejecutas Aslan, ahora puedes especificar si Aslan se inicia automáticamente después de autentificarte en Windows. (#2234)
...
* Después de cambiar a modo revisión de pantalla, Aslan permanecerá en este modo hasta que vuelvas explícitamente a los modos de revisión de documentos o de objetos.
 * Cuando se esté en modo de revisión de documentos o de objetos, Aslan podrá cambiar automáticamente entre estos dos modos dependiendo de si estás moviéndote por un documento del modo exploración o no.
...
* Aslan ya no falla al arrancar si la hora del sistema es anterior a la última revisión de una actualización. (#3260)
...
* Al cambiar el idioma de entrada de Windows 8, Aslan ahora habla en el idioma correcto en lugar de en el anterior.
* Aslan ahora anuncia cambios en el modo de conversión de IME en Windows 8.
* Aslan ya no anuncia basura en el escritorio cuando los métodos de entrada japoneses Google o IME ATOK están en uso. ;(# 3234)
* En Windows 7 y superiores, Aslan ya no anuncia indebidamente el reconocimiento de voz o la entrada táctil como un cambio de idioma del teclado.
 * Aslan ya no anuncia un carácter especial (0x7f) cuando se pulse control+retroceso en algunos editores mientras Verbalizar Caracteres al Escribir esté habilitado. (#3315)
* espeak ya no hace cambios inapropiados en el tono, volumen, etc. cuando Aslan lea texto que contenga ciertos caracteres de control o XML. (#3334) (regresión de #437)
...
* los comandos de navegación de tablas de Aslan (control+alt+flechas) funcionan mejor en algunas tablas de Microsoft Word cuando una celda abarca varias filas.
...
* Aslan ya no se cuelga en ciertos diálogos cuando se esté utilizando el IME en Office 2010 con el japonés o el chino. (#3064)
...
* Aslan ya no causa que Adobe Reader se bloquee o se cuelgue para ciertos documentos PDF mal formados que contengan filas fuera de las tablas. (#3399)
* Aslan ahora detecta correctamente la siguiente diapositiva con el foco cuando se elimine una en  la  vista de miniaturas en Microsoft PowerPoint. (#3415)
...
Esta versión corrige el problema donde Aslan se colgaba al iniciarse si se configuraba para utilizar el idioma irlandés, así como incluye actualizaciones para traducciones y algunas otras correcciones de errores.

### Corrección de Fallos

* Se producen caracteres correctos cuando se teclean en la propia interfaz de Aslan mientras se utiliza  un método de entrada Coreano o Japonés mientras sea el método predeterminado. (#2909)
...
* Aslan ya no se cuelga cuando se inició si se configuró para utilizar el idioma irlandés.
...
La nueva distribución utiliza las teclas de cursor en combinación con la tecla Aslan y otras modificadoras para órdenes de revisión.
...
|---|---|
|Leer todo |Aslan+a|
|Leer línea actual |Aslan+l|
|Leer selección de texto actual |Aslan+shift+s|
|Anunciar barra de estado |Aslan+shift+fin|
...
* En modo exploración para MSHTML (ej.: Internet Explorer) y Gecko (ej.: Firefox), ahora se anuncia la existencia de descripciones largas. También es posible abrir la descripción larga en una ventana nueva pulsando Aslan+d. (#809)
...
* Nuevas opciones de teclado que permiten  elegir si Aslan debería interrumpir la voz para los caracteres escritos y/o la tecla Intro. (#698)
...
* Si Aslan se cambia a eSpeak debido a que el sintetizador de voz configurado falla cuando Aslan arranca, el sintetizador configurado ya no se deja automáticamente en la opción de eSpeak. Esto significa que ahora, el sintetizador original será probado de nuevo la próxima vez que Aslan arranque. (#2589)
* Si Aslan se cambia a sin braille debido a que la pantalla braille configurada  falla cuando Aslan arranca, la pantalla configurada ya no se deja automáticamente en la opción de sin braille. Esto significa que ahora, la pantalla original será probada de nuevo la próxima vez que Aslan arranque. (#2264)
...
* Cuando se desactive la detección automática de actualizaciones, Aslan ya no ha de reiniciarse para que todos los cambios tengan efecto.
* Aslan ya no falla al iniciarse si un complemento no se puede eliminar debido a que su directorio se esté utilizando actualmente por otra aplicación. (#2860)
* Las etiquetas de pestañas en el diálogo de preferencias de DropBox ahora pueden verse con la Revisión Plana. 
* Si el idioma de entrada se cambia a algún otro que el predeterminado, Aslan ahora detecta las teclas correctamente para órdenes y el modo de ayuda de entrada.
...
* Cuando se esté en revisión,  eliminando caracteres con retroceso o suprimir en controles de edición de Scintilla, Aslan anuncia correctamente caracteres multibyte. (#2855)
* Aslan ya no fallará al instalar cuando la ruta del perfil de usuario contenga ciertos caracteres multibyte. (#2729)
...
* Aslan ya no falla al copiar las opciones del usuario para utilizarlas en la autentificación y en otras pantallas seguras cuando la ruta del perfil del usuario contiene caracteres no ASCII. (#3092)
* Aslan ya no se bloquea cuando se utiliza la entrada de caracteres asiáticos en algunas aplicaciones .NET. (#3005)
...
* Ahora puedes utilizar comHelper.getActiveObject para conseguir un objeto COM activo desde un proceso normal cuando Aslan esté ejecutándose con el privilegio UIAccess. (#2483)
...
* Aslan ahora puede soportar entrada de caracteres asiáticos utilizando IME y métodos de servicio de entrada de texto en todas las aplicaciones, incluyendo:
...
* Cuando la función Windows Sticky Keys está activada, la tecla modificadora de Aslan ahora se comportará como las otras teclas modificadoras. Esto te permite utilizar la tecla modificadora de Aslan sin la necesidad de mantener pulsada mientras pulsas otras teclas. (#230)
* Ahora se soporta el anunciado automático de encabezados de columna y de fila en Microsoft Excel. Pulsa Aslan+shift+c para configurar la fila que contenga encabezados de columna y Aslan+shift+r para la columna que contenga encabezados de fila. Pulsa el script dos veces en sucesión rápida para limpiar la opción. (#1519)
* Soporte para las pantallas braille HIMS Braille Sense, Braille EDGE y SyncBraille. (#1266, #1267)
* Cuando las Notificaciones de Windows 8 aparezcan, Aslan las anunciará si el anunciado de globos de ayuda está habilitado. (#2143)
 ...
 * Muchos gestos para llevar a cabo la navegación por objetos, revisión de texto, y otras órdenes de Aslan.
...
* Aslan ahora puede leer sugerencias de autocompletado cuando se introduzcan direcciones de correo en Microsoft Outlook 2007. (#689)
...
* Ahora es posible reiniciar la configuración de Aslan a los valores predeterminados de fábrica pulsando Aslan+control+r tres veces rápidamente o eligiendo Reiniciar a los Valores Predeterminados de Fábrica desde el menú Aslan (#2086).
...
* Si Aslan se instala en el sistema, la apertura directa de un paquete de complemento de Aslan (es decir desde el explorador de Windows o después de descargarlo de un navegador web) lo instalará en Aslan. (#2306)
...
* En el diálogo Preferencias del Cursor de Revisión de Aslan, la opción Seguir foco del teclado ha sido renombrada a Seguir al foco del sistema para consistencia con la terminología utilizada en otras partes en Aslan.
...
* Cuando se actualiza una copia de Aslan instalada anteriormente, la tecla de atajo del escritorio ya no se fuerza a control+alt+n si fue cambiada manualmente a alguna otra diferente por el usuario. (#2572)
* La lista de complementos en el Administrador de Complementos ahora muestra el nombre del paquete antes de su estado. (#2548)
* Al instalar la misma u otra versión de un complemento instalado actualmente, Aslan te preguntará si deseas actualizar el complemento antiguo primero, en lugar de mostrar un error y abortar la instalación. (#2501)
...
* El documento Referencia Rápida de Órdenes de teclado de Aslan ha sido renombrado a Referencia Rápida de Órdenes, así ahora incluye tanto órdenes táctiles como órdenes de teclado.
* La Lista de elementos en modo exploración ahora recordará el último tipo de elemento mostrado (ej.: enlaces, encabezados o regiones) cada vez que se muestre el diálogo dentro de la misma sesión de Aslan. (#365)
...
* En Windows Vista y posterior, Aslan ya no trata incorrectamente la tecla Windows como es al mantenerla pulsada cuando se desbloquea Windows después de bloquearla pulsando Windows+l. (#1856)
...
* El paquete de distribución de Aslan ahora verifica su integridad antes de ejecutarse. (#2475)
* Los ficheros descargados temporalmente ahora se eliminan si se descarga un fichero de actualización de Aslan. (#2477)
* Aslan ya no se colgará cuando se esté ejecutando como un administrador mientras se copia la configuración del usuario a la configuración del sistema (para utilizarla en la autentificación de Windows y en otras pantallas seguras). (#2485)
...
* Mejoras en el soporte para el corrector de ortografía de Microsoft Word, incluyendo la lectura más precisa del error ortográfico actual, y la capacidad de soportar el corrector de ortografía cuando se ejecute una copia instalada de Aslan en Windows Vista o superior.
...
* La configuración para el anunciado de barras de progreso ahora se reconoce para barras de progreso indeterminadas mostradas por Aslan cuando se está instalando, creando una copia portable, etc. (#2574)
* los comandos de Aslan ya no pueden ejecutarse desde una pantalla braille mientras una pantalla segura de Windows (tal como la pantalla de desbloqueo) esté activa. (#2449)
* En modo exploración, el braille ahora se actualiza si el texto que está siendo desplazado cambia. (#2074)
* Cuando se está en pantallas seguras de  Windows tales como la pantalla de desbloqueo, los mensajes de las aplicaciones que están hablando o mostrando braille directamente a través de Aslan ahora se ignoran.
...
* Aslan ya no localiza o anuncia incorrectamente ciertos campos de edición en documentos MSHTML (ej.: Internet Explorer), específicamente donde se haya utilizado un rol ARIA explícito por el autor de la página web. (#2435)
...
* En Microsoft Word, Aslan ya no te deja enganchado en un párrafo con formato de lista cuando tratas de navegar por una viñeta o número con flecha izquierda o control + flecha izquierda. (#2402)
...
* En navegadores web, Aslan ahora oculta contenido que se marcó como oculto para lectores de pantalla (específicamente, utilizando el atributo aria-hidden). (#2117)
...
* Durante leer todo, Aslan ya no regresará incorrectamente a al idioma predeterminado si una línea no finaliza una frase. (#2630)
...
* Pulsando Aslan+flecha arriba mientras se esté en un cuadro combinado en Internet Explorer y otros documentos MSHTML ya no se leerán incorrectamente todos los elementos. Por lo contrario, sólo se leerá el elemento activo. (#2337)
...
* Aslan ya no fallará al arrancar cuando la ruta de perfiles del usuario contenga ciertos caracteres multibyte. (#2729)
...
* Aslan puede funcionar de nuevo en la lista de mensajes de Yahoo! Mail cuando se utiliza desde Internet Explorer. (#2780)

### Cambios para Desarrolladores

* El anterior fichero de registro ahora se copia en aslan-old.log en la inicialización de Aslan. Por lo tanto, si Aslan se bloquea o se reinicia, el registro de información  de esa sesión todavía es accesible para su inspección. (#916)
* La obtención de la propiedad de rol en chooseAslanObjectOverlayClasses ya no causa que el rol sea incorrecto y por lo tanto no se anuncie en foco para ciertos objetos tales como consolas de órdenes de Windows y controles de Scintilla. (#2569)
* Los menús de Aslan Preferencias, Herramientas y Ayuda ahora son accesibles como atributos en gui.mainFrame.sysTrayIcon llamándose preferencesMenu, toolsMenu y helpMenu, respectivamente. Esto permite a los plugins añadir elementos mucho más fácilmente a estos menús.
 ...
 * Esto se soporta tanto para Aslan mismo como para los complementos.
...
* Ahora es posible acceder a los módulos compilados de Aslan donde hayan sido sobreescritos por módulos de terceros. Mira el módulo aslanBuiltin para detalles.
...
Lo reseñable de esta versión incluye una característica que integra el instalador y la creación del portable, un auto actualizador, administración fácil de los nuevos complementos de Aslan, anunciado de gráficos en Microsoft Word, soporte para el estilo de aplicaciones de Windows 8 Metro, y varias correcciones de fallos importantes. 

### Nuevas Características

* Aslan ahora puede buscar automáticamente, descargar e instalar actualizaciones. (#73)
* Se ha hecho más sencilla la extensión de la funcionalidad de Aslan con la adición de un Administrador de Complementos (que se encuentra bajo Herramientas en el menú Aslan) permitiéndote instalar y desinstalar paquetes de complementos de Aslan (ficheros .aslan-addon) que contengan plugins y controladores. Ten en cuenta que el Administrador de Complementos no debería mostrar los antiguos plugins personales y controladores copiados manualmente en tu directorio de configuración. (#213)
* Ahora funcionan Muchas más características comunes de Aslan en el estilo de aplicaciones de Windows 8 Metro cuando se utiliza una versión instalada de Aslan, incluyendo la verbalización de caracteres al escribir y modo exploración para documentos web (se incluye soporte para la versión metro de Internet Explorer 10). Las copias portables de Aslan no pueden acceder al estilo de aplicaciones metro. (#1801) 
...
* Aslan ahora se distribuye en un paquete. En lugar de una versión portable y una instalable, ahora sólo hay un fichero que cuando se ejecute, iniciará una copia temporal de Aslan, y te permitirá instalar, o generar una distribución portable. (#1715)
* Aslan ahora siempre se instala en Program Files en todos los sistemas. Al actualizar una instalación también se la moverá automáticamente si anteriormente no se instaló ahí.
...
* En Internet Explorer 9 Aslan ya no lee contenido indeseado cuando el foco se mueve dentro de ciertas regiones o elementos enfocables (específicamente un elemento div que es enfocable o que tiene un rol de región ARIA). 
* Los iconos para los atajos para Aslan en el Escritorio y en el Menú de Inicio ahora se muestran correctamente en ediciones de 64 bit de Windows. (#354)

### Cambios para Desarrolladores

* Debido a la sustitución del instalador anterior NSIS para Aslan por uno compilado en Python, ya no es necesario para los traductores mantener un fichero langstrings.txt para el instalador. Todas las cadenas de localización ahora se administran con ficheros po de gettext.
...
* Aslan puede anunciar el número de los tabuladores o espacios al inicio en la línea actual en el orden en que se introdujeron. Esto puede activarse seleccionando anunciar sangrado de línea en el diálogo Formateado de documento. (#373)
* Aslan ahora puede detectar la pulsación de teclas generadas desde la emulación de entrada de teclado tal como en programas de teclado en pantalla o de reconocimiento de voz.
* Aslan ahora puede detectar colores en ventanas órdenes de consola.
...
* Aslan ahora evita la separación de palabras en braille cuando sea posible de forma predeterminada.  Esto puede desactivarse en el diálogo Opciones de Braille. (#1890, #1946)
...
* Ahora Aslan filtrará los nombres extremadamente largos (30 caracteres o más) deducidos de URLs de gráfícos y enlaces dado que lo más probable es que sean basura que obstaculice la lectura. 
...
* En Windows 8, el foco ya no se mueve incorrectamente del campo de Búsqueda de Windows Explorer, lo cual no permitía a Aslan interactuar con él.
...
* Se permite de nuevo a Aslan utilizar el sintetizador "no speech", confiando únicamente en el braille o en elVisualizador de Voz. (#1963)
...
* Cuando Aslan se configuró para utilizar otro idioma que el Inglés, el nombre de la tecla tab ahora se anuncia en el idioma adecuado. 
* En Mozilla Gecko (ej.: Firefox), Aslan ya no cambia intermitentemente a modo exploración mientras se navega por menús en documentos. (#2025)
...
* En Firefox 11, el comando mover a contenido de modo virtual (Aslan+control+espacio) ahora funciona como debería para salir de objetos integrados tales como contenido Flash.
* Aslan ahora se reinicia correctamente (ej.: después de cambiar el idioma configurado) cuando se localice en un directorio con contenidos de caracteres no ASCII. (#2079)
...
* Aslan funciona de nuevo correctamente con el sintetizador Audiologic Tts3. (#2109)
...
* Cambiar la puntuación y símbolos por el usuario ahora tendrá efecto inmediato, en lugar de requerir un reinicio de Aslan, o que se desactive el cambio automático de idioma.
* Cuando se utiliza eSpeak, la voz ya no queda en silencio en algunos casos en el diálogo Guardar Como... del Visualizador de Registro de Aslan. (#2145)
...
* La ruta base del código de Aslan ahora se quitó de los tracebacks en el registro para mejorar legibilidad. (#1880)
...
* Los treeInterceptors y los AslanObjects que sólo exponen una página de texto a la vez pueden soportar el cambio automático de página durante leer todo utilizando el textInfos.DocumentWithPageTurns mezclado. (#1978)
...
* Aslan ahora puede cambiar el idioma del sintetizador eSpeak al vuelo cuando lee ciertos documentos web/pdf con la información de idioma apropiada. El cambio automático de idioma/dialecto puede activarse o desactivarse desde el diálogo Opciones de Voz. (#845) 
...
* Aslan ahora se reiniciará si se cuelga.
...
* El script Leer Ventana activa (Aslan+b) ha sido mejorado para filtrar controles inútiles y ahora también es mucho más fácil de silenciar. (#1499)
...
* Cuando se tratan de leer barras de estado (Sobremesa Aslan+fin), si no se puede localizar un objeto de barra de estado real, Aslan recurrirá en su lugar a utilizar la línea final de texto escrita en la pantalla de la aplicación activa. (#649)
* Cuando se lee con leer todo en documentos en modo exploración, Aslan ahora hará una pausa en el final de encabezados y otros elementos de nivel de bloque, en lugar de verbalizar el texto junto con el siguiente bloque como si fuese una frase larga.
...
* Aslan ya no muestra viñetas o numeración para listas en Internet Explorer y otros controles MSHTML cuando el autor ha indicado que éstas no deberíam mostrarse (es decir, el estilo de lista es "none"). (#1671)
* Reiniciar Aslan cuando se ha colgado (ej.: presionando control+alt+n) ya no sale de la copia previa sin comenzar otra nueva.
...
* Aslan ahora se recupera de muchas más situaciones tales como aplicaciones que dejan de responder en las que anteriormente causaba un cuelgue completo. (#1408)
* Para documentos en modo exploración de Mozilla Gecko (Firefox etc) Aslan ya no fallará al interpretar texto en una situación muy específica donde un elemento is styled as display:table. (#1373)
* Aslan ya no anunciará controles etiqueta cuando el foco se mueva por ellos. Detiene el anunciado doble de etiquetas para algunos campos de formulario en Firefox (Gecko) e Internet Explorer (MSHTML). (#1650)
* Aslan ya no falla al leer una celda en Microsoft Excel después de pegar con control+v. (#1781)
...
* Aslan ahora puede leer correctamente la barra de direcciones del Explorador de Windows en Windows 8 developer preview.
* Aslan ya no bloquea aplicaciones tales como winver y wordpad en Windows 8 developer preview debido a malas traducciones de glyph.
...
* Aslan ahora funciona correctamente en varios diálogos Acerca de... en aplicaciones distribuídas con Windows XP, incluyendo el diálogo de acerca de... en Notepad y el diálogo de acerca de  en Windows. (#1853, #1855)
...
* Aslan ahora puede instruir a los sintetizadores de voz para cambiar los idiomas para secciones en particular de voz.
 * Para soportar esto, los controladores deben manejar speech.LangChangeCommand en secuencias pasadas a SynthDriver.speak().
 * Los objetos SynthDriver también deberían proporcionar el argumento de idioma a objetos VoiceInfo (o sobreescribir el atributo de idioma para capturar el idioma actual). de otro modo, el idioma de la interface de usuario de Aslan será utilizado.
...
* Aslan ahora anunciará si algo se ordena (de acuerdo con la propiedad aria-sort) en navegadores Web. (#1500)
* Los patrones Braille unicode ahora se muestran correctamente en las pantallas braille. (#1505)
* En Internet Explorer y otros controles MSHTML cuando el foco se mueve dentro de un grupo de controles (surrounded by a fieldset), Aslan ahora anunciará el nombre del grupo (the legend). (#535)
...
* Cuando se navega por una tabla en Microsoft Word con la tecla tab Aslan ahora anunciará la celda actual según te muevas. (#159)
...
* Aslan ahora puede detectar formato y color para texto escrito en la pantalla.
* En la lista de mensajes de Outlook Express/Windows Mail/Windows Live Mail, Aslan ahora anunciará el hecho de que un mensaje esté no leído y también si está expandido o contraído en el caso de hilos de conversación. (#868)
...
* Para mover el cursor del sistema al cursor de revisión, ahora presiona el script mover foco al navegador de objetos (Sobremesa Aslan+shift+menos teclado numérico, portátil Aslan+shift+retroceso) dos veces en sucesión rápida. Esto libera más teclas en el teclado. (#837)
...
* La interface de usuario y la documentación de Aslan ahora se refieren a los modos virtuales como modo exploración , ya que el término "virtual buffer" es menos comprensible para la mayoría de los usuarios. (#1509)
...
* El servicio Aslan ya no inicia y detiene a Aslan en escritorios de entrada de usuario.
* En Windows XP y Windows Vista, Aslan ya no hace uso de UI Automation aún si está disponible a través de la actualización de la plataforma. Aunque utilizando UI Automation se puede mejorar la accesibilidad de algunas aplicaciones modernas, en XP y Vista había muchos cuelgues, rupturas y se perdía toda la buena funcionalidad utilizándolo. (#1437)
...
* Aslan anuncia ahora el estado de un contenedor cuando el foco se mueva a un control dentro de él (ej.: si el foco se mueve dentro de un documento que todavía se esté cargando lo anunciará como ocupado).
 * La interface de usuario y documentación de Aslan ya no utiliza los términos "primer hijo" y "padre" con respecto a navegación de objetos, pues estos términos son confusos para muchos usuarios.
 * Ya no se anuncia contraído para algunos elementos de menú que tienen submenús.
* El script reportCurrentFormatting (Aslan+f) ahora anuncia el formato en la posición del cursor de revisión antes que el cursor del sistema / foco. Ya que de forma predeterminada el cursor de revisión sigue al del sistema, la mayor parte de la gente no debería notar la diferencia.  Sin embargo esto ahora posibilita al usuario mirar el formato cuando se mueva el cursor de revisión, tal como en la revisión plana.

### Corrección de fallos

* Contraer cuadros combinados en documentos en modo exploración cuando el modo foco ha sido forzado con Aslan+espacio ya no retorna automáticamente a modo exploración. (#1386)
* En documentos Gecko (ej.: Firefox) y MSHTML (ej.: Internet Explorer), Aslan ahora procesa correctamente  cierto texto en la misma línea que previamente fue procesado en líneas separadas. (#1378)
...
* Cuando Aslan se configura para utilizar la distribución de teclado portátil, Aslan+suprimir ahora funciona como se documentó para anunciar las dimensiones del navegador de objetos actual. (#1498)
* Aslan ahora cumple apropiadamente con el atributo aria-selected en documentos de Internet Explorer.
* cuando Aslan cambia automáticamente a modo foco en documentos de modo exploración, ahora anuncia información acerca del contexto del foco. Por ejemplo, si un elemento de un cuadro de lista recive el foco, el cuadro de lista se anunciará primero. (#1491)
...
* Cuando un control editable de texto de solo lectura recibe el foco, Aslan ahora informa de que es de sólo lectura. (#1436)
* En modo exploración, Aslan ahora funciona correctamente con respecto a campos de texto editable de solo lectura.
* En documentos en modo exploración, Aslan ya no cambia incorrectamente de modo foco cuando aria-activedescendant está configurado; ej.: cuando la finalización de la lista aparece en algunos controles con autocompletado.
...
* Los cuadros combinados Owner-drawn tales como los de elegir colores en Outlook Express ahora son accesibles con Aslan. (#1340)
...
* Cuando se entra en listas mientras se lee texto, Aslan ahora dice, por ejemplo, "lista con 5 elementos" en lugar de "listacon 5 elementos". (#1515)
...
* En el modo de ayuda de entrada, cuando una modificadora se mantiene pulsada en el teclado, Aslan ya no anuncia la modificadora como si se modificase a sí misma; ej.: Aslan+Aslan.
...
* Ya no se puede mostrar un diálogo de opciones de Aslan mientras se está mostrando un mensaje de diálogo, ya que el diálogo de opciones se colgaba en este caso. (#1451)
* Reinstaurado el diálogo editor de celdas de Excell de Aslan que se había desactivado accidentalmente en Aslan 2011.1.
...
* Corregidas rupturas del servicio Aslan que significaban que Aslan paraba de ejecutarse en en ventanas seguras de Windows.
...
* La ventana de descargas en Internet Explorer 9 ahora puede navegarse y leerse con Aslan. (#1280)
* Ya no es posible iniciar accidentalmente múltiples copias de Aslan al mismo tiempo. (#507)
* En sistemas lentos, Aslan ya no causa que su ventana principal se muestre inapropiadamente todo el tiempo mientras se ejecuta. (#726)
* Aslan ya no se rompe en Windows xP cuando se inicia una aplicación WPF. (#1437)
...
* Aslan ya no clasifica inapropiadamente algunos elementos de lista en el aplique de reglas de mensajes en Outlook Express / Windows Live Mail ahora el diálogo es como casillas de verificación. (#576)
* Los cuadros combinados ya no se anuncian como teniendo un submenú.
* Aslan ahora podrá leer el recipiente en los campos para, CC y CCO en Microsoft Outlook. (#421)
* Corregido el fallo en el diálogo de Opciones de Voz de Aslan donde el valor de las barras de desplazamiento  a veces no se anunciaba cuando cambiaban. (#1411)
* Aslan ya no falla al anunciar la celda nueva cuando se mueve en una hoja Excel después de cortar y pegar. (#1567)
* Aslan ya no lo hace tan mal adivinando los nombres de los colores anunciando la mayoría de los mismos.
...
* En Microsoft Word 2010 Aslan ahora leerá automáticamente los diálogos de confirmación. (#1538)
...
* El instalador de Aslan ya no muestra texto confuso para versiones para Hong Kong de Windows Vista y Windows 7. (#1596)
* Aslan ya no falla al cargar el sintetizador de Microsoft Speech API versión 5 si la configuración contiene opciones para ese sintetizador pero falta la opción de la voz. (#1599)
* En el modo exploración de firefox, Aslan ya no se niega a incluir contenido que esté dentro de un nodo enfocable con un rol ARIA de presentación.
...
* Cuando se abre un mensaje de texto plano en Windows Live Mail 2011, Aslan enfocará correctamente el documento de mensaje permitiendo que se lea.
* Aslan ya no se bloquea o se niega a hablar temporalmente cuando está en los diálogos Mover a / Copiar a en Windows Live Mail. (#574)
* En Outlook 2010, Aslan ahora seguirá correctamente el foco en la lista de mensajes. (#1285)
...
* Si Aslan no es capaz de iniciarse, el fracaso para reproducir el sonido de parada crítica de Windows ya no anula el mensaje de error crítico en el fichero de registro.
...
* Ahora puedes compilar AslanHelper con varias opciones de depuración utilizando la variable aslanHelperDebugFlags SCons. Mira readme.txt en la raíz de la distribución de fuentes de para detalles. (#1390)
...
Esta versión corrige varios problemas de seguridad y otros importantes encontrados en Aslan 2011.1.

### Corrección de Fallos

* El elemento Donar en el menú Aslan ahora se desactiva cuando se ejecuta en la autentificación, bloqueo, UAC y otras Ventanas de pantallas seguras, ya que esto es un riesgo de seguridad. (#1419)
* Ahora es imposible copiar o pegar dentro de la ventana de interface del usuario de Aslan mientras se está en escritorios seguros (Pantalla bloqueada, pantalla del UAC y autentificación de windows) ya que esto es un riesgo de seguridad. (#1421)
* En Firefox 4, el comando mover al contenido del modo virtual (Aslan+control+espacio) ahora funciona como debería escapar de objetos empotrados tales como contenido Flash. (#1429)
...
* Ahora se pueden anunciar los colores para algunos controles. El anunciado automático se puede configurar en el diálogo de preferencias de formateado de documentos. También se pueden anunciar bajo demanda utilizando el comando de anunciado de formato de texto (Aslan+f).
...
* Aslan ahora anuncia la salida de texto nuevo en mIRC, PuTTY, Tera Term y SecureCRT. (#936)
* Los usuarios ahora pueden añadir nuevas combinaciones de teclas o o sobreescribir las existentes para cualquier script en Aslan proporcionando un sencillo mapa de movimientos de entrada del usuario. (#194)
* Soporte para plugins globales. Los plugins globales pueden añadir nueva funcionalidad a Aslan que funcione en todas las aplicaciones. (#281)
...
* Ahora está disponible un comando para activar o desactivar el modo Durmiente para la aplicación actual (Aslan+shift+s). El Modo Durmiente (anteriormente conocido como modo de voz propia) desactiva toda la funcionalidad de lectura de la pantalla en Aslan para una aplicación en particular. Muy útil para aplicaciones que proporcionan su propia voz y o características de lectura de pantalla. Presiona esta orden de nuevo para desactivar el Modo Durmiente.
...
* Para conveniencia de desarrolladores de terceras partes, los app modules así como los plugins globales ahora se pueden recargar sin reinicializar Aslan. Utiliza Herramientas -> Recargar plugins en el menú de Aslan o Aslan+control+f3. (#544)
* Aslan ahora recuerda la posición donde estabas cuando regresas a una página anteriormente visitada. Esto se aplica hasta que o el navegador o Aslan sean cerrados. (#132)
...
* Cuando Aslan detecta que se ha colgado, continúa interceptando  las teclas modificadoras de Aslan, aunque deja pasar todas las demás teclas del sistema. Esto previene al usuario de conmutar inintencionalmente el BlogMayus, etc. Si presionan una tecla modificadora de Aslan sin realising Aslan has frozen. (#939)
...
* Si una tecla modificadora de Aslan se presiona dos veces en sucesión rápida para pasarla y la segunda presionada está pulsada, todas las teclas repetidas ahora se pasarán también.
...
* La tecla rápida para el elemento Cursor de Revisión en el menú de Preferencias de Aslan ha sido cambiado de r a c para eliminar el conflicto con el elemento de Opciones de Braille.
...
* En los diálogos del diccionario del habla, el contenido de las columnas de la Expresión Regular y sensible a las mayúsculas de la lista de entradas de diccionario  se presenta ahora en el idioma configurado en Aslan en lugar de siempre en Inglés.
...
* Si una tecla modificadora de Aslan se presiona dos veces rápidamente pero hay una tecla presionada interviniendo, la tecla modificadora de Aslan ya no pasa en la segunda presión.
...
* En el diálogo Opciones de Teclado, los nombres de distribución de teclado ahora se presentan en el idioma configurado para Aslan en lugar de siempre en Inglés. (#558)
...
* El botón "Utilizar opciones actuales guardadas en el logon y otras pantallas seguras" en el diálogo de Opciones Generales de Aslan, funciona si se utilizó inmediatamente después de que Aslan sea instalado nuevamente pero antes de que una pantalla segura haya aparecido.  Anteriormente, Aslan anunciaba que el copiado tuvo éxito, pero actualmente no tenía efecto. (#1194)
* Ya no es posible tener dos diálogos de opciones de Aslan abiertos simultáneamente. Esto corrige errores donde un diálogo abierto depende de otro diálogo abierto; es decir, cambiar el sintetizador mientras el diálogo Opciones de Voz está abierto. (#603)
* En sistemas con UAC activado, el botón "Utilizar opciones actualmente guardadas en el logon y pnatallas seguras" en el diálogo de Opciones Generales del Aslan, ya no falla después del UAC si el nombre de la cuenta del usuario contiene un espacio. (#918)
* En Internet Explorer y otros controles MSHTML, Aslan utiliza ahora la URL como un último resorte para determinar el nombre de un enlace, más que presentar enlaces vacíos. (#633)
* Aslan ya no ignora el foco en los menús de AOL Instant Messenger 7. (#655)
...
* Los cambios en páginas en documentos Gecko2 (Ej.: Firefox 4) mientras se abren múltiples pestañas ahora se refleja adecuadamente por Aslan. Anteriormente sólo los cambios en la primera pestaña se reflejaban. (Mozilla bug 610985)
* Aslan ahora puede anunciar apropiadamente las sugerencias para errores gramaticales y de puntuación en el diálogo del corrector de ortografía de Microsoft Word. (#704)
* En Internet Explorer y otros controles MSHTML, Aslan ya no presenta anclas de destino como enlaces vacíos en su modo virtual. En su lugar, estas anclas se ocultan según debería ser. (#1326)
* La navegación de objetos sobre y dentro de brupos estándar de windows ya no rompe y asymmetrical.
* En Firefox y otros controles basados en Gecko, Aslan ya no se queda pegado en un submarco si finaliza cargando antes de otro documento.
* Aslan ahora anuncia apropiadamente el siguiente caracter cuando se elimina un caracter con suprimir del teclado numérico. (#286)
...
* En pantallas braille ALVA BC640/BC680 Aslan ya no hace caso omiso de las teclas de la pantalla que todavía están siendo pulsadas después que otra tecla se suelte.
...
* Aslan ahora cambia al controlador de pantalla braille apropiado cuando vuelvas a la configuración guardada. (#1346)
* El asistente de proyecto de Visual Studio 2008 se lee correctamente nuevamente. (#974)
* Aslan ya no falla completamente al trabajar en aplicaciones que contengan caracteres no ASCII en su nombre del ejecutable. (#1352)
* Cuando se lee por líneas en AkelPad con el salto de palabras activado, Aslan ya no lee el primer caracter de la línea siguiente en el final de la línea actual.
* En el editor de código de Visual Studio 2005/2008, Aslan ya no lee todo el texto después de cada caracter tecleado. (#975)
* Corregido el problema donde algunas pantallas braille no se limpiaban correctamente cuando Aslan se cerraba o se cambiaba la pantalla braille.
* El foco inicial ya no se verbaliza en algunas ocasiones dos veces cuando Aslan arranca. (#1359)
...
* Los nonbres de teclas utilizados por Aslan (incluyendo mapas de teclas) han sido hechos más amigables/lógicos; ej.: upArrow en lugar de extendedUp y numpadPageUp en lugar de prior. Mira el módulo vkCodes para una lista.
...
* Las localizaciones ahora podrán proporcionar un fichero de mapa de gesto de entrada para añadir nuevos vínculos o sobreescribir los vínculos existentes para los scripts en cualquier sitio de Aslan. (#810)
...
* Cuando se mueve el ratón sobre celdas en Microsoft Excel, Aslan las anunciará apropiadamente.
...
* Aslan ahora puede recuperar la mayoría de texto escrito en la pantalla. (#40, #643)
...
* Soporte primario y experimental paraGoogle Chrome. Por favor ten en cuenta que el soporte para lectores de pantalla de Chrome está lejos de completarse y requerirá trabajo adicional también en Aslan. Necesitarás una compilación de desarrollo reciente de Chrome para probar esto.
 ...
 * Aslan+7 teclado numérico cambia a revisión plana, colocando el cursor de revisión en la posición del objeto actual, permitiéndote revisar la pantalla (o un documento si se está dentro de uno) con los comandos de revisión de texto.
 * Aslan+1 teclado numérico mueve el cursor de revisión al objeto representado por el texto en la posición del cursor de revisión, permitiéndote navegar por objetos desde ese punto.
* Las opciones de usuario actuales de Aslan pueden copiarse para utilizarse en las pantallas de autentificación/UAC, presionando un botón en el diálogo Opciones Generales.

### Ccambios

* Leer todo en el navegador de objetos  (Aslan+más del teclado numérico), siguiente objeto en flujo del navegador de objetos (Aslan+shift+6 del teclado numérico) y anterior objeto en flujo en el navegtador de objetos (Aslan+shift+4 del teclado numérico) han sido eliminados de momento, debido a fallos y para liberar las teclas para otras posibles características.
* En el diálogo de sintetizadores de Aslan, ahora sólo se muestra el sintetizador listado. Anteriormente, se prefijaba con el nombre del controlador, que sólo es relevante internamente.
* Cuando se está en aplicaciones empotradas o modos virtuales dentro de otro modo virtual (ej.: Flash), ahora puedes presionar aslan+control+espacio para salir de la aplicación empotrada o modo virtual, al documento principal. Anteriormente, aslan+espacio  se utilizaba para esto. Ahora aslan+espacio es sólo específicamente para conmutar los modos revisión/foco en los modos virtuales.
...
* Si Aslan ya está ejecutándose, activando el atajo de teclado de Aslan en el escritorio (que es el presionado de control+alt+n) reiniciará a Aslan.
* Se elimina la casilla de verificación anunciar texto bajo el ratón del diálogo Opciones de Ratón y se reenplaza con una casilla de verificación Activar seguimiento del Ratón, que mejora el emparejado del conmutado del script de seguimiento del ratón (Aslan+m). 
...
* En aplicaciones de Microsoft Office, Aslan ya no se bloquea cuando se presionó verbalizar primer plano (Aslan+b) o cuando se navegan algunos objetos en barras de herramientas. (#616)
...
* En los controles de Scintilla (ej.: Notepad++), el texto ya no se selecciona incorrectamente cuando Aslan mueve el cursor del sistema tal como durante leer todo. (#746)
* Es posible de nuevo revisar el contenido de celdas en MS Excel con el cursor de revisión.
* Aslan puede leer de nuevo por líneas en ciertos campos de área de texto problemáticos en Internet Explorer 8. (#467)
* Windows Live Messenger 2009 ya no se cierra inmediatamente después de iniciarse mientras Aslan se ejecuta. (#677)
...
* Aslan ya no falla al arrancar en un sistema sin dispositivos de salida de audio. Obviamente, será necesario utilizar una pantalla braille o el Display synthesiser para la salida en este caso. (#425)
* Ha sido añadida una casilla de verificación Anunciar regiones al diálogo de Opciones de formato de Documento que te permite configurar si Aslan debería anunciar regiones en documentos web. Para compatibilidad con la versión anterior, la opción está activada de forma predeterminada.
* Si verbalizar teclas de órdenes está activada Aslan ahora anunciará los nombres de las teclas multimedia (ex.: reproducir, detener, página de inicio, etc.) cuando sean presionadas. (#472)
* Aslan ahora anuncia la palabra que esté siendo eliminada cuando se presiona control+retroceso en controles que lo soporten. (#491)
* Las flechas de cursor ahora pueden ser utilizadas en la ventana del formateador Web para navegar y leer el texto. (#452)
* Mejor soporte de documentos empotrados editables de Aslan (modo de diseño) en Internet Explorer. (#402)
* Un script nuevo (aslan+shift+menos del teclado numérico) te permite mover el foco del sistema al navegador de objetos actual.
...
* Ahora es posible desactivar la creación del atajo del escritorio (y así la tecla de atajo) cuando se instala Aslan. (#518)
* Aslan ahora puede utilizar IAccessible2 cuando se presenta en aplicaciones de 64 bit. (#479)
* La API Aslan Controller Client ahora se proporciona para permitir a las aplicaciones controlar a Aslan; ej.: para verbalizar texto, silenciar la voz, mostrar un mensaje en Braille, etc.
...
* En Miranda IM, Aslan ahora lee automáticamente los mensajes de entrada en ventanas de chat si el anunciado de cambios de contenido dinámico se activó. También, han sido añadidas los comandos para anunciar los tres mensajes más recientes (Aslan+control+número). (#546)
...
* La Opción para ajustar el braille al foco o al cursor de revisión (Aslan+control+t) ahora puede ser también configurada desde el diálogo de opciones braille, y ahora también se guarda en la configuración del usuario.
...
* Aslan ya no falla al arrancar si el soporte UI Automation parece estár disponible pero falla al inicializarse por alguna razón. (#483)
...
* Aslan ya no se retrasa durante un tiempo largo cuando se expanden elementos de la vista en árbol que contengan una cantidad muy grande de sub-elementos.
* Cuando se listan voces SAPI 5, Aslan ahora intenta detectar voces defectuosas y excluirlas del diálogo de Opciones de Voz y del grupo de Opciones de Sintetizador. Anteriormente, cuando había una voz problemática, el controlador SAPI 5 de Aslan fallaba algunas veces al iniciarse.
...
* Las líneas en blanco en documentos de Microsoft Word y de controles de edición de Microsoft HTML ahora son mostradas apropiadamente en pantallas braille. Anteriormente Aslan mostraba la frase actual en la línea, no la línea actual para estas situaciones. (#420)
* Múltiples correcciones de seguridad cuando se ejecuta Aslan en el Logon de Windows y en otros Escritorios Seguros.
...
* Aslan ya no verbaliza incorrectamente ciertos números separados por un guión; ej.: 500-1000. (#547)
* En Windows XP, Aslan ya no causa que Internet Explorer se cuelgue cuando se conmutan casillas de verificación en Windows Update. (#477)
...
* Aslan ya no anuncia que un documento de Firefox se ha llenado (ej.: debido a una actualización o refresco) cuando ese documento está en segundo plano. Esto también causaba que la barra de estado de la aplicación en primer plano sea anunciada falsamente.
...
* Aslan ya no cancela la voz cuando las teclas de control del volumen se presionan en el teclado, permitiendo al usuario cambiar el volumen y escuchar los resultados actuales inmediatamente. (#287)
...
* En Windows Vista, si el usuario se mueve al escritorio seguro (o porque un diálogo de control del UAC aparece, o porque fue presionado control+alt+supr), Aslan anunciará el hecho de que el usuario ahora está en el escritorio seguro.
* Aslan puede anunciar texto bajo el ratón dentro de ventanas de la consola del dos.
* Soporte para UI Automation a través de la API cliente UI Automation disponible en Windows 7, tanto como se mejora la experiencia de Aslan en Windows 7.
* Aslan puede configurarse para iniciarse automáticamente después de que te identifiques en Windows. la opción está en el diálogo Opciones Generales.
* Aslan puede leer pantallas seguras de Windows tales como la autentificación de Windows (logon), control+alt+suprimir y pantallas del UAC en Windows XP y posteriores. La lectura de las pantallas de autentificación de Windows (logon) puede ser configurada desde el diálogo de Opciones Generales. (#97)
...
* Las versiones portátiles de Aslan ahora buscan en el directorio 'userConfig' dentro del directorio de Aslan, las configuraciones del usuario. Como la versión del instalador, esto mantiene la configuración del usuario separada de Aslan.  
...
* Si Aslan detecta que se ha colgado por alguna razón, Pasará automáticamente por todas las pulsaciones para que el usuario tenga una mejor posibilidad de recuperación del sistema.
...
* En los modos virtuales, ahora puedes interactuar con objetos empotrados (tales como contenidos Adobe Flash y Sun Java) presionando intro sobre el objeto. Si es accesible, puedes entonces tabular por él como cualquier otra aplicación. Para regresar el foco al documento, presiona Aslan+espacio. (#431)
* En los modos virtuales, o y shift+o mueven al siguiente y al anterior objeto empotrado, respectivamente.

### Cambios

* Aslan ya no anuncia "Aslan activado" cuando arranca.
* Los sonidos de arranque y finalización ahora se reproducen utilizando el dispositivo de salida de audio configurado en Aslan en lugar del dispositivo de audio predeterminado de Windows. (#164)
* el anunciado de las barras de progreso ha sido mejorado. Lo más notable es que ahora puedes configurar a Aslan para anunciarlas a través de voz y pitidos al mismo tiempo.
...
* el comando de copia de revisión (Aslan+f10) copia el texto desde encima de la marca de comienzo e incluye la posición actual de revisión, en lugar de excluir la posición actual. Esto permite que el último caracter de una línea sea copiado, lo cual no era posible anteriormente. (#430)
* El script  navigatorObject_where (ctrl+Aslan+numpad5) ha sido eliminado. Esta combinación de teclas no funcionaba en algunos teclados, ni el script era útil.
* El script navigatorObject_currentDimentions ha sido remapeado a Aslan+supr del teclado numérico. La antigua combinación de teclas no funcionaba en algunos teclados. Este script ahora también anuncia la anchura y la altura del objeto en lugar de las coordenadas derecha/inferior.
...
* Cuando Aslan está ejecutándose desde una ruta de DOS 8.3, pero está instalado en la ruta larga relacionada (ej.: progra~1 versus program files) Aslan identificará correctamente que es una copia instalada y carga apropiadamente las opciones de usuario.
* La verbalización del título de la ventana actual en primer plano con aslan+t funciona ahora correctamente cuando se está en los menús.
...
* mejor soporte para consolas del Dos. específicamente: Aslan ahora puede leer el contenido de consolas particulares que Siempre se pensó que estaban en blanco. Presionando control+break ya no apagan a Aslan.
* En Windows Vista, el instalador de Aslan ahora arranca a Aslan con privilegios de un usuario normal cuando se requiera para ejecutar a Aslan en la pantalla final.
...
* Aslan ahora maneja correctamente etiquetas de ARIA en Mozilla Gecko cuando no hay otro contenido útil. (#156)
* Aslan ya no activa incorrectamente el modo foco automáticamente para campos de texto editable que actualizan su valor cuando el foco cambia; ej.: https://tigerdirect.com/. (#220)
* Aslan ahora intentará recuperarse de algunas situaciones que anteriormente causarían que secolgase completamente. Podrá tomar sobre 10 segundos para que Aslan detecte y se recupere de tales cuelgues.
* Cuando el idioma de Aslan está ajustado a "User default", utiliza el idioma del usuario de Windows configurado en lugar del local de windows.
* Aslan ahora reconoce la existencia de controles en AIM 7.
* el comando de dejar pasar la tecla ya no se queda atascada si una tecla se mantiene presionada. Anteriormente, Aslan detenía el aceptado de órdenes si esto ocurría y tenía que ser reiniciado. (#413)
* La barra de tareas ya no se ignora cuando recibe el foco, lo que amenudo ocurre cuando se sale de una aplicación. Anteriormente, Aslan se comportaba como si el foco no huviera cambiado.
* Cuando se leen campos de texto en aplicaciones que utilizan el Java Access Bridge (incluyendo OpenOffice.org), Aslan ahora funciona correctamente cuando el anunciado de números de línea está activado.
* el comando de copia en revisión (Aslan+f10) maneja elegantemente el caso donde sea utilizado en una posición antes del marcador de inicio. Anteriormente, esto podía causar problemas tales como cuelgues en Notepad++.
...
* Como la barra de fórmulas de Microsoft Excel es inaccesible para Aslan, se proporciona un cuadro de diálogo específico de Aslan para editar cuando el usuario presione f2 sobre una celda. 
...
* Aslan puede configurarse para pitar para todas o sólo para las barras de progreso visibles. Alternativamente, puede configurarse para verbalizar los valores de las barras de progreso cada 10%.
...
* Si el comando de título (Aslan+t) se presiona dos veces rápidamente, deletrea el título. Si se presionó tres veces, se copia al portapapeles.
...
* Añadida un comando (Aslan+c) para anunciar el texto en el portapapeles de Windows. (#193)
* Ahora puedes presionar escape cuando estás en modo foco para regresar a modo revisión.
* En los modos virtuales, cuando el foco cambia o el cursor se mueve, Aslan puede cambiar automáticamente amodo foco o modo revisión según proceda para el control bajo el cursor. Esto se configura desde el diálogo de Modo virtual. (#157)
...
* La aplicación Aslan ahora incluye un manifiesto, lo cual significa que no se ejecutará más en modo de compatibilidad en Windows Vista.
* El fichero de configuración y los diccionarios del habla se guardan ahora en el directorio de datos del usuario si Aslan fue instalado utilizando el instalador. Esto es necesario para Windows Vista y también permite a múltiples usuarios tener configuraciones individuales para Aslan.
* Añadido soporte para información de posición para controles IAccessible2.
* Añadida la capacidad para copiar texto al portapapeles utilizando el cursor de revisión. Aslan+f9 ajusta la marca de inicio en la posición actual del cursor de revisión. Aslan+f10 recupera el texto entre la marca de inicio y la posición actual del cursor de revisión y lo copia al portapapeles. (#240)
* Añadido soporte para algunos controles de edición en el programa pinacle tv.
* Cuando se anuncian texto seleccionado para selecciones largas (512 caracteres o más), Aslan vervaliza ahora el número de caracteres seleccionados, en lugar de verbalizar toda la selección. (#249)

### Cambios

* Si el dispositivo de salida de audio se ajusta para utilizar el dispositivo predeterminado de Windows (Microsoft Sound Mapper), Aslan cambiará ahora al nuevo dispositivo predeterminado para eSpeak y tonos cuando el dispositivo predeterminado cambie. Por ejemplo, Aslan cambiará a un dispositivo de audio USB si se hace dispositivo predeterminado automáticamente cuando se conecte.
...
* el comando de título (Aslan+t) ahora sólo informa del título en lugar de todo el objeto. Si el objeto en primer plano no tiene nombre, se utiliza el nombre de proceso de la aplicación.
* En lugar de activar y desactivar el paso a través del modo virtual, Aslan ahora anuncia modo foco (paso por modo virtual activado) y modo revisión (paso por modo virtual desactivado).
...
* El último trozo de audio no se corta ya cuando se utilice Aslan con eSpeak en un servidor de escritorio remoto.
...
* El visualizador de registro de Aslan ahora utiliza cuadros multilínea en lugar de sólo editar para mostrar el registro. Esto mejora la lectura por palabras con Aslan y te permite leer el texto del registro más allá de los 65535 bytes.
* Corregidos algunos fallos relacionados con objetos empotrados en controles de edición multilínea.
* Aslan ahora lee los números de página en Microsoft Word. (#120)
...
* Corregido un fallo el cual significaba que cambios en la selección de texto no estuviesen siendo leídos en controles estándares de edición de Windows antes del primer cambio del foco después que Aslan se iniciase.
* Corregido el seguimiento del ratón en objetos Java. (#185)
* Aslan ya no anuncia los elementos de los árboles Java sin hijos como si estuviesen contraídos.
...
* Aslan ahora ignora cambios del foco en ventanas en segundo plano. Anteriormente, un cambio del foco en segundo plano podía ser tratado como si el foco real cambiase.
* Mejorada la detección del foco cuando se abandonan los menús de contexto. Anteriormente, Aslan amenudo no reaccionaba del todo cuando se abandonaba un menú de contexto.
* Aslan ahora anuncia cuando el menú de contexto es activado en el menú de Inicio.
...
* Aslan ya no anuncia la deselección de texto cuando se abandonen algunos controles de edición (ejemplo: barra de dirección en Internet Explorer, campos de dirección en correo electrónico en Thunderbird 3 ).
...
* Aslan ahora puede leer texto que pase de 65535 caracteres en controles estándar de edición (ej.: un fichero grande en Notepad).
...
* Aslan ya no se cuelga a veces completamente cuando se edita texto en OpenOffice. (#148, #180)

## 0.6p2

* Mejorada la voz predeterminada de ESpeak en Aslan
* Añadida una disposición de teclado para ordenadores portátiles. Las disposiciones de teclado pueden ser configuradas desde el diálogo de Opciones de teclado de Aslan. (#60)
...
* Añadidas teclas de atajo para muchos de los diálogos de configuración de Aslan
* Soporte para IAccessible2 habilitado para aplicaciones tales como Mozilla Firefox cuando se ejecuta a Aslan desde un medio portátil, sin tener que registrar ningún fichero Dll en especial
* Corregido un cuelgue con la lista de enlaces del modo virtual en aplicaciones Gecko. (#48)
* Aslan no debería colgarse ya con aplicaciones Mozilla Gecko tales como Firefox y Thunderbird si Aslan está ejecutándose con privilegios más altos que los de la aplicación Mozilla Gecko. Ej. Aslan está ejecutándose como Administrador.
...
* Si o no Aslan utiliza un 'modo de disposición de pantalla' para los documentos del modo virtual puede ahora ser configurado desde un diálogo de opciones 
* No se informa más sobre anclaje de etiquetas sin href en documentos Gecko como enlaces. (#47)
* el comando buscar de Aslan ahora recuerda qué es lo último que se buscó, a través de todas las aplicaciones. (#53)
...
* El modo de paso a través del modo virtual es específico ahora para cada documento, en lugar de globalmente para Aslan. (#33)
* Corregidos alguna lentitud con los cambios del foco e interrupción incorrecta de la voz que algunas veces ocurría cuando se utiliza Aslan en un sistema que había estado en sobre aviso o estaba más bien lento
...
* Añadida la herramienta de la consola de python interactiva de Aslan, para habilitar a los desarrolladores para mirar y manipular cuestiones internas de Aslan según está ejecutándose
...
* Los scripts incrementar velocidad y decrementar velocidad han sido eliminados. Los usuarios deberían utilizar los scripts del grupo de las opciones de sintetizador (control+aslan+flechas) o el diálogo de opciones de Voz
...
* Añadido un script encontrarAnterior (shift+Aslan+f3) para utilizar en el nuevo modo virtual 
* Mejorada la lentitud en diálogos Mozilla Gecko (en Firefox y Thunderbird). (#66)
* Añadida la capacidad para ver el fichero registro actual para Aslan. Puede ser encontrado en el menú Aslan -> Herramientas
...
* El cuadro combinado de idioma en el diálogo de Opciones Generales de Aslan muestra ahora los nombres de idioma completo para facilidad de uso
...
* Corregido un retraso inicial cuando se abren diálogos de Aslan en algunos sistemas. (#65)
...
* El script moveMouseToNavigator (Aslan+barra del teclado numérico) ahora mueve el ratón al centro del navegador de objetos, en lugar  de la esquina superior izquierda 
...
* Se detiene la capacidad de Aslan para hacer que el usuario aguarde mientras mensajes en particular son hablados. Arregla algunos cuelgues con sintetizados de voz en particular. (#117)
...
* Se añade un diálogo de bienvenida de Aslan. Este diálogo está diseñado para proporcionar información esencial para nuevos usuarios y permite al BloqMayus ser configurado como una tecla modificadora de Aslan. Este diálogo será mostrado cuando Aslan sea iniciado predeterminadamente hasta que se deshabilite.
* Corregido soporte básico para Adobe Reader tal que es posible leer documentos en  versiones 8 y 9
* Corregidos algunos errores que podrían haber ocurrido cuando se mantienen pulsadas teclas antes de que Aslan sea apropiadamente inicializado
* Si el usuario ha configurado Aslan para guardar la configuración al salir, se asegura de que la configuración es apropiadamente guardada cuando se apaga o se sale de Windows.
* Añadido un sonido de logo de Aslan al inicio del instalador, contribuído por Victor Tsaran
* Aslan, tanto al ejecutarse en el instalador como de otra manera, debería quitar apropiadamente su icono de la bandeja del sistema cuando salga
* Etiquetas para controles estándar en diálogos de Aslan (tales como botones Aceptar y cancelar) deberían mostrarse ahora en el idioma en que Aslan está ajustado, en lugar de sólo quedarse en Inglés.
* El icono de Aslan debería ser ahora utilizado por las teclas de atajo de Aslan en el menú de inicio y en el escritorio, en lugar de un icono de aplicación predeterminado.
...
* Mejorado el seguimiento del cursor en aplicaciones IAccessible2 y Java; ej.: en Open Office y Lotus Symphony, Aslan aguarda adecuadamente que el cursor se mueva en documentos en lugar de leer accidentalmente la palabra incorrecta o línea en el final de algunos párrafos. (#119)
* Soporte para controles AkelEdit encontrados en Akelpad 4.0
* Aslan ya no se bloquea en Lotus Synphony cuando te mueves desde el documento a la barra de menú.
* Aslan ya no se cuelga en los applets de programas Add/Remove en Windows XP cuando se lanza un desinstalador. (#30)
* Aslan ya no se cuelga cuando se abre Spybot Search and Destroy
...
* Añadida una lista de enlaces (Aslan+f7)
* Mejorado el diálogo buscar (control+aslan+f) así que lleva a cabo una búsqueda insensible a las mayúsculas, más arreglo de unos pocos problemas con el foco con ese cuadro de diálogo.
* Ahora es posible seleccionar y copiar texto en los nuevos modos virtuales 
* De forma predeterminada los nuevos modos virtuales representan el documento en una disposición de pantalla (enlaces y controles no están en líneas separadas a menos que realmente sean visualmente así). Puedes conmutar esta característica con Aslan+v.
...
* Ahora es posible teclear caracteres acentuados que  dependen de un "caracter justo", mientras Aslan está ejecutándose.
* Aslan anuncia ahora cuando la distribución de teclado es cambiada (cuando se presiona alt+shift).
...
* Aslan viene ahora con eSpeak 1.33 empaquetado que contiene muchas mejoras, entre las cuales están idiomas mejorados, variantes nombradas, capacidad para hablar más rápido.
...
* Aslan puede pitar ahora cuando verbalice una letra en mayúsculas. Esto puede ser activado y desactivado con una casilla de verificación en el diálogo de Opciones de Voz. También se añadió una casilla de verificación de elevación del tono para mayúsculas para configurar si Aslan actualmente debería tener su elevación de tono normal para las mayúsculas. Así ahora puedes tener o tono elevado, decir mayus, o pitar, para mayúsculas.
* Añadida la capacidad para pausar la voz en Aslan (como la encontrada en Voice Over para el Mac). Cuando Aslan está verbalizando algo, puedes presionar las teclas control o shift para silenciar la voz normalmente, pero si entonces pulsas la tecla shift de nuevo (tanto en cuanto no hayas presionado cualquier otra tecla) la voz continuará exactamente desde donde lo habíamos dejado.
* Añadido un controlador de sintetizador virtual el cual saca texto a una ventana en lugar de verbalizarla a través de un sintetizador de voz. Esto debería ser más agradable para los desarrolladores videntes que no son usuarios de síntesis de voz pero quieren saber qué está verbalizando Aslan. Todavía hay probablemente algunos fallos, así que la retroalimentación es más bienvenida si cabe.
* Aslan ya no verbaliza predeterminadamente la puntuación, puedes habilitar la verbalización de puntuación con Aslan+p.
* eSpeak predeterminadamente ahora habla un poco más despacio, lo cual debería hacerlo más fácil para gente que van a utilizar eSpeak por primera vez, cuando instalan o comienzan a utilizar Aslan.
* Añadidos diccionarios de usuario a Aslan. Éstos te permiten hacer que Aslan verbalice cierto texto de modo diferente. Hay tres diccionarios: predeterminado, voz, y temporal. Las entradas que añadas al diccionario predeterminado sucederán todo el tiempo en Aslan. Los diccionarios por voz son específicos al sintetizador actual y la voz que actualmente tengas ajustada. Y el diccionario temporal es para aquellas ocasiones que quieras fijar rápidamente una regla mientras vas a hacer una tarea en particular, pero no quieres que sea permanente (desaparecerá si cierras Aslan). Por ahora las reglas son expresiones regulares, no solo texto normal.
...
* Aslan ya no toma una gran cantidad de memoria del sistema, cuando se editan mensajes en controles de edición mshtml
...
* Aslan ya no debería enlentecerse consumiendo tamaño de memoria del sistema sin razón
* Corregidos fallos cuando se pone el foco en una ventana de consola del dos más de tres veces o así. Aslan tenía una tendencia a colgarse completamente.

### Teclas de órdenes

* Aslan+shift+numpad6 y Aslan+shift+numpad4 te permiten navegar al siguiente o anterior objeto en flujo respectivamente. Esto significa que puedes navegar en una aplicación sólo utilizando estas dos teclas sin preocuparse acerca de subir al padre, o bajar al primer hijo según te muevas a través de la jerarquía de objetos. Por ejemplo en un navegador web tal como firefox, podrías navegar el documento por objetos, sólo utilizando estas dos teclas. Si el siguiente en flujo o el anterior en flujo te acerca y te saca de un objeto, o down en un objeto, mandará pitidos indicando la dirección.
* Ahora puedes configurar opciones de voz sin abrir el diálogo opciones de voz, utilizando el grupo de opciones de sintetizador. El grupo de opciones del sintetizador es un grupo de opciones de voz que puedes conmutar a través de la pulsación de control+Aslan+derecha y control+Aslan+izquierda. Para cambiar una opción utiliza control+Aslan+arriba y control+Aslan+abajo.
* Añadida un comando para anunciar la selección actual en campos de edición (Aslan+shift+flecha arriba).
* Un buen número de órdenes de Aslan que verbalizan texto (tales como anunciar línea actual etc) ahora pueden deletrear el texto si se presionan dos veces rápidamente.
* El BloqMayus, insert del teclado numérico e insert del extendido pueden ser todos utilizados como la tecla modificadora de Aslan. También si una de estas teclas es utilizada, presionándola dos veces rápidamente sin presionar ninguna otra tecla enviará la tecla al sistema operativo, como si presionases la tecla sin Aslan ejecutándose. Para hacer que una de estas teclas sea la modificadora de Aslan, verifica su casilla de verificación en el diálogo de Opciones de Teclado (utilizado para ser llamado el diálogo de eco de teclado).

### Soporte de aplicaciones

* Mejorado el soporte para documentos de Firefox3 y Thunderbird3. Los tiempos de carga han sido mejorados casi por un factor de trenta, una distribución de pantalla es utilizada predeterminadamente (presiona aslan+v para activar o desactivar esta distribución de pantalla), Una lista de enlaces (aslan+f7 ha sido añadida), el diálogo buscar (control+aslan+f) es ahora insensible a las mayúsculas, mucho mejor soporte para contenido dinámico, la selección y copiado de texto es ahora posible.
...
* Aslan ahora puede leer las direcciones en los campos de mensajes de Outlook Express (para/de/cc etc)
* Aslan ahora debería estár más certero al anunciar el siguiente mensaje en out look express cuando se elimina un mensaje desde la lista de mensajes.
...
* Añadido soporte para la API de accesibilidad IAccessible2. Una parte de la capacidad para anunciar más tipos de controles, esto también permite a Aslan acceder al cursor en aplicaciones tales como Firefox 3 y Thunderbird 3, permitiéndote navegar, seleccionar o editar texto.
...
* Aslan ahora trata de verbalizar el mensaje interior de muchos cuadros de diálogo según aparecen. Esto es exacto la mayor parte de las ocasiones, aunque todavía hay muchos diálogos que no son tan buenos como deberían ser.
* Añadida una casilla de verificación anunciar descripciones del objeto al diálogo de Opciones de presentación de objetos. Los usuarios avanzados podrán en ocasiones desverificar esto para detener el anunciado de Aslan de un montón de descripciones extra en controles en particular, tales como en aplicaciones Java.
* Aslan anuncia automáticamente texto seleccionado en controles de edición cuando el foco se mueve a ellos. Si no hay ningún texto seleccionado, entonces sólo anuncia la línea actual como normalmente.
* Aslan es mucho más cuidadoso ahora cuando reproduce pitidos para indicar cambios en las barras de progreso en aplicaciones. Ya no se vuelve loco en aplicaciones de Eclipse tales como Lotus Notes/Symphony, y Accessibility Probe.

### Interface del Usuario

* Eliminada la ventana de interface de Aslan, y reemplazada con un simple menú de Aslan desplegable.
* El diálogo opciones de Interface de Aslan es ahora llamado Opciones Generales. También contiene una opción extra: un cuadro combinado para ajustar el nivel del registro, para que los mensajes puedan ir al fichero de registro de Aslan. Nota que el fichero de registro de Aslan es ahora llamado aslan.log no debug.log.
...
* Aslan tiene ahora un sintetizador incorporado llammado eSpeak, desarrollado por Jonathan Duddington. Es muy ágil y ligero, y tiene soporte para muchos idiomas diferentes. Los sintetizadores Sapi todavía pueden ser utilizados, pero eSpeak será utilizado predeterminadamente. eSpeak no depende de ningún software especial para ser instalado, así que puede ser utilizado con Aslan en cualquier ordenador, en un lápiz de memoria USB, o cualquier otro. Para más información sobre eSpeak, o para encontrar otras versiones, ve a https://espeak.sourceforge.net/.
...
* Añadidos argumentos de línea de órdenes a Aslan:
 * -m, --minimal: no reproduce los sonidos de inicio/salir y no muestra la interface al arrancar si se ajustó a tal cosa.
 * -q, --quit: abandona cualquier otra instancia ya en ejecución de Aslan y luego sale
 * -s, --stderr-file nombreFichero: especifica dónde debería colocar Aslan los errores y excepciones 
 * -d, --debug-file nombreFichero: especifica dónde debería colocar Aslan los mensajes de depuración 
...
* Se hace que más mensajes en Aslan sean traducibles para otros idiomas. Esto incluye descripciones de script cuando se está en la ayuda de teclado.
...
* Cuando algunos idiomas utilizan control y alt (o altGR) para introducir un caracter especial, Aslan verbalizará ahora estos caracteres cuando Verbalizar caracteres al escribir esté activado.
...
* Reestructurado una parte importante del código de Aslan, que debería corregir ahora muchos fallos con la interface de usuario de Aslan (incluyendo opciones de diálogos).
* Añadido soporte Sapi4 para Aslan. Actualmente hay dos controladores sapi4, uno basado en código escrito por Serotek Corporation, y otro utilizando la interface ActiveVoice.ActiveVoice com. Ambos controladores tienen problemas, mira cuál funciona mejor para ti.
* Ahora cuando se trata de ejecutar una nueva copia de Aslan mientras una copia anterior está todavía ejecutándose causará que la nueva copia salga. Esto arregla un problema mayor cuando se ejecutan múltiples copias de Aslan haciendo que tu sistema sea muy inusable.
* Renombrado el título de la interface de usuario de Aslan de Interface de Aslan a Aslan. 
...
* Añadido un controlador de sintetizador llamado Silence. Este es un controlador de sintetizador que no verbaliza nada, permitiendo a Aslan permanecer completamente silencioso todo el rato. Eventualmente esto sería utilizado junto con el soporte Braille, cuando lo tengamos.
...
* Corregido un fallo donde el sintetizador de voz se detenía, o Aslan se colgaba completamente, cuando se estaba en una ventana de a consola del Dos.
* Si existe soporte para un idioma en particular, Aslan ahora puede mostrar automáticamente su interface y verbalizar sus mensajes en el idioma en que Windows esté ajustado. Un idioma particular puede todavía ser elegido manualmente desde el diálogo Opciones de Interface de Usuario como también.
...
* Eliminada alguna documentación de desarrolladores de la distribución binaria de Aslan, ahora solamente está en la versión de los fuentes.
...
* Añadido el script 'passNextKeyThrough' (insert+f2). Presiona esta tecla, y entonces la siguiente tecla presionada será pasada directamente a Windows. Esto es útil si has de presionar una tecla en una aplicación pero Aslan utiliza esa tecla para algo.
* Aslan ya no se conjela por más de un minuto cuando se habren documentos muy grandes en MS Word.
...
* Cuando se inicia Aslan con un sintetizador que no existe, o no está funcionando, el sintetizador sapi5 tratará de ser cargado en su lugar, o si sapi5 no está funcionando, entonces la voz será ajustada a silence.
...
* Aslan ahora pregunta si debería guardar la configuración y reiniciar si el usuario ha cambiado el idioma en el diálogo Opciones de Interface de Usuario. Aslan debe ser reiniciado para que el cambio de idioma tenga un efecto completo.
...
* Cuando se carga un sintetizador por primera vez, Aslan permite al sintetizador elegir la voz más conveniente, los parámetros de velocidad y tono, en lugar de forzarlo a dejarlo como piense que está bien. Esto corrige un problema donde los sintetizadores sapi4 Eloquence y Viavoice comienzan a hablar de un modo bastante rápido para una primera vez.
