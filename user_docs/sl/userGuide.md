# Aslan Aslan_VERSION Uporabniški Vodič

[TOC]

<!-- KC:title: Aslan Aslan_VERSION Hitra Referenca po Ukazih -->
...
Non Visual Desktop Access (Aslan) je prost in odprtokoden bralnik zaslona za operacijski sistem Microsoft Windows.
...
Aslan razvija [NV Access](https://www.nvaccess.org/) s sodelovanjem skupnosti.

### Splošne Značilnosti {#GeneralFeatures}

Aslan omogoča slepim in osebam s preostankom vida dostop in interakcijo z operacijskim sistemom Windows in veliko programi tretjih izdelovalcev.
...
Aslan podpira precej brajevih kodnih tabel vključno z računalniškimi, kratkopisnimi in normalnimi za veliko jezikov.

### Licenca in Avtorske Pravice {#LicenseAndCopyright}

Avtorske pravice Aslan_COPYRIGHT_YEARS nad Aslan pripadajo Aslan sodelujočim.

Aslan je na voljo pod pogoji GNU Splošne Javne Licence (druga različica) z dvema posebnima izjemama.
...
Aslan vključuje in uporablja tudi komponente, ki jih dajejo izdajatelji na voljo pod drugimi prostimi in odprtokodnimi licencami.
...
Za podrobnosti glede izjem dostopite do dokumenta z licenco iz menija Aslan v razdelku "pomoč".
 ...
 * V sistemu Windows 7 mora biti nameščen prvi paket popravkov ali novejši, da bo Aslan lahko delovala.
 * V sistemu Windows Server 2008 R2 mora biti nameščen prvi paket popravkov ali novejši, da bo Aslan lahko delovala.
* Pomnilnik: 256 MB RAMa ali več
* Procesorska hitrost: 1,0  GHz ali hitrejši
* Približno 90 MB prostora na disku

## Kako Dobiti in Postaviti Aslan {#GettingAndSettingUpAslan}

Če še nimate svoje kopije Aslan, jo lahko snamete s: [spletišča NV Access](Aslan_URL).

Pojdite na razdelek download in tam boste našli povezavo za prenos najnovejše različice Aslan.

Ko boste preneseno datoteko prvič zagnali, se bo namestila začasna kopija Aslan.
Potem vas bomo vprašali, če želite Aslan namestiti na vaš računalnik, izdelati prenosljivo kopijo na vaš USB ključ ali želite zgolj uporabljati to začasno kopijo.

Če želite Aslan vedno uporabljati na izbranem računalniku, potem boste želeli izbrati Namesti Aslan na ta računalnik.
Namestitev Aslan na računalnik vam omogoča med drugim interakcijo med vpisom in na varnih namizjih ter samodejni zagon po vpisu, kar ni možno, če imate prenosljivo ali začasno kopijo. Poleg tega omogoča tudi ustvarjanje programskega sklopa v začetnem meniju (meniju Start) in bližnjice na namizju.
Nameščena kopija Aslan omogoča, da si sami iz nje kadarkoli izdelate prenosljivo kopijo. 

Če želite s seboj vzeti Aslan na USB ključku ali drugem zapisljivem mediju, potem morate izbrati ustvari prenosljivo kopijo.
Prenosljiva kopija omogoča kasnejšo samonamestitev na izbranem računalniku.
Kakorkoli, če želite Aslan preslikati na medij, ki je samo za branje (CD ali drug), potem na medij zapišite samo paket, ki ste ga prenesli.
Poganjanje z medija, ki je samo za branje, trenutno ni podprto.

Možno je uporabiti tudi začasno kopijo (na primer za demonstracijske prikaze), čeprav je pot zagona Aslan v tem načinu precej dolga.

### Omejitve Začasne in Prenosljive Kopije {#PortableAndTemporaryCopyRestrictions}

Ločeno od tega, da se Aslan ne more samodejno zagnati pred in/ali po prijavi, imata prenosljiva in začasna kopija še naslednje omejitve:

* Nezmožnost biti v interakciji s programi, ki tečejo s skrbniškimi pravicami, dokler seveda tudi Aslan sama ne teče z istimi pravicami (ni priporočljivo).
...
* Windows 8 in kasnejši: Stišanje ostalih zvokov, ko Aslan govori, ni podprto.

### Namestitev Aslan {#InstallingAslan}

Če nameščate Aslan neposredno s paketa, ki ste ga prenesli na sistem, potem pritisnite gumb Namesti Aslan.
Če ste že zaprli to pogovorno okno ali pa želite namestiti Aslan iz prenosljive kopije, potem izberite menijsko postavko Namesti Aslan, ki jo najdete pod Orodji v meniju Aslan.

Pogovorno okno namestitve, ki se prikaže, potrdi, ali želite namestiti Aslan in pove tudi ali bo ta namestitev posodobila prejšnjo namestitev.
S pritiskom na gumb Nadaljuj, boste sprožili nameščanje Aslan.
...
Pritisk na gumb V redu na tej točki bo ponovno zagnal na novo nameščeno kopijo Aslan.
...
#### Uporabi Aslan ob Vpisu v Windows {#StartAtWindowsLogon}

Ta možnost omogoča, da se lahko Aslan samodejno zažene medtem, ko se vam ponudi okno za vpis, še pred vnosom gesla.
...
Ta možnost omogoča izbiro, če želite, da mora Aslan ustvariti bližnjico na namizju za zagon Aslan.
Ta bližnjica, če jo boste ustvarili, bo ustvarila tudi kombinacijo bližnjičnih tipk za zagon control+alt+a. S to kombinacijo tipk boste potem lahko Aslan zagnali, kadarkoli boste želeli.

#### Preslikaj Prenosljivo Konfiguracijo na Trenuten Uporabniški Račun {#CopyPortableConfigurationToCurrentUserAccount}

Ta možnost vam omogoča izbiro, ali mora ali pa ne, Aslan preslikati trenutno uporabniško konfiguracijo v uporabi v konfiguracijo trenutno vpisanega uporabnika za nameščeno kopijo Aslan.
...
Če ste že zaprli to pogovorno okno ali pa delate z že nameščeno kopijo Aslan, izberite menijsko postavko Ustvari Prenosljivo kopijo, ki jo najdete v podmeniju Orodja Aslan menija.
...
Tukaj je tudi možnost izbire,ali bi  Aslan morala ali pa ne,preslikati konfiguracijo trenutno prijavljenega uporabnika za uporabo v novo ustvarjeni prenosljivi kopiji.
...
## Kako začeti z Aslan {#GettingStartedWithAslan}
### Zagon Aslan {#LaunchingAslan}

Če ste namestili Aslan iz namestitvenega paketa, potem je zagon Aslan preprost. Zaženete jo lahko s pritiskom kombinacije tipk control+alt+a ali pa z izbiro menija Aslan v Začetnem meniju, kjer razprete seznam vseh nameščenih programov.
Kot dodatno možnost lahko uporabite pogovorno okno Zaženi, kjer vnesete Aslan in pritisnete Enter.
Če je Aslan v pogonu, se bo ponovno zagnala.
Lahko podate tudi nekaj [možnosti v ukazni vrstici,](#CommandLineOptions) ki vam omogočajo izhod iz Aslan (-q), onemogočanje dodatkov (--disable-addons) in drugo.

Za nameščene kopije, Aslan privzeto hrani konfiguracijo v mapi sleddenja programskih datotek trenutnega uporabnika (npr. "C:\Users\<uporabnik>\AppData\Roaming").
To je možno spremeniti na način, da Aslan naloži svojo konfiguracijo iz mape z lokalnimi programskimi podatki.
Oglejte si razdelek o [splošnih sistemskih parametrih](#SystemWideParameters) za več podrobnosti.

Za zagon prenosljive kopije pojdite v imenik, kjer ste ustvarili prenosljivo kopijo Aslan in pritisnite Enter nad Aslan.exe ali to ikono dvakrat kliknite.
Če je bila Aslan že v pogonu, se bo samodejno zaustavila pred zagonom prenosljive različice.

Ko se bo Aslan zagnala, boste slišali višajoč skupek tonov,  (ki povedo, da se Aslan nalaga).
Odvisno od tega, kako hiter je vaš računalnik, ali teče Aslan preko USB ključka ali drugega počasnejšega medija, lahko mine nekaj trenutkov, da se Aslan zažene.
Če zaganjanje traja izjemno dolgo, potem bi morala Aslan sporočiti: "Nalaganje Aslan. Prosimo, počakajte..."

Če ne slišite nič od tega, ali slišite Windows Zvok  "Napaka", ali nižajočo kombinacijo tonov, potem to pomeni, da je v Aslan napaka. To pomeni, da boste morda morali sporočiti "hrošča" razvijalcem.
Prosimo, preglejte spletno mesto Aslan, da izveste, kako to narediti.

#### Pogovorno okno Dobrodošlice {#WelcomeDialog}

Ko se Aslan zažene prvič, vas bo pozdravilo pogovorno okno, ki vas bo oskrbelo z nekaj osnovnimi informacijami o Aslan prikrojevalni tipki in o Aslan meniju.
...
Prvi izbirnik sprašuje, če naj Aslan obravnava Caps Lock kot Aslan prikrojevalno tipko.
Drugi določa ali naj se Aslan po prijavi v Windows zažene samodejno in je na voljo samo za namestitvene kopije Aslan.
Tretji sprašuje, če naj se to pogovorno okno pokaže vedno, ko se Aslan zažene.

#### Pogovorno okno uporabe statističnih podatkov {#UsageStatsDialog}

Od različice Aslan 2018.3, se uporabnike naproša, če  bi želeli dovoliti poslati podatke o uporabi organizaciji NV Access kot pomoč za izboljšanje Aslan v prihodnosti. 
Ob prvem zagonu  Aslan se bo prikazalo pogovorno okno, ki vas bo zaprosilo za vaše soglasje k pošiljanju podatkov NV Access med uporabo Aslan.
Več o zbiranju podatkov s strani NV Access lahko preberete in dobite informacije v razdelku Splošno v [Dovoli projektu Aslan zbiranje statistike rabe Aslan](#GeneralSettingsGatherUsageStats).
Pomnite: pritisk na "da" ali "ne" bo shranil to nastavitev in pogovorno okno se ne bo prikazalo nikdar več razen, če boste Aslan ponovno namestili.
Toda vi lahko ročno omogočite ali onemogočite potek zbiranja podatkov na plošči splošnih nastavitev za Aslan. Za ročno spremembo te nastavitve lahko izberete ali odznačite izbirnik, ki se imenuje [Dovoli projektu Aslan zbiranje statistike rabe Aslan](#GeneralSettingsGatherUsageStats).

### O Aslan tipkovničnih ukazih {#AboutAslanKeyboardCommands}
#### Aslan Prikrojevalna Tipka {#TheAslanModifierKey}

Večina Aslan-posebnih tipkovničnih ukazov sestoji iz pritiska posebne tipke imenovane prikrojevalna tipka Aslan v kombinaciji z eno ali več ostalimi tipkami.
...
Aslan se lahko nastavi tako, da se uporablja Glavni Insert, številski Insert, lahko pa tudi Caps Lock kot prikrojevalna Aslan tipka.
Privzeto velja, da sta tako številski kot Glavni Insert prikrojevalni Aslan tipki.

Če želite, da se ena od prikrojevalnih Aslan tipk obnaša kot je prvotno predvideno (npr. želite vključiti tipko Caps Lock, ko je Capslock nastavljena kot prikrojevalna tipka Aslan), potem izbrano tipko pritisnite dvakrat v hitrem zaporedju.

#### Postavitve Tipkovnice {#KeyboardLayouts}

Trenutno Aslan prihaja z dvema paketoma tipkovničnih ukazov, ki jih poznamo pod pojmom postavitve tipkovnice, kjer obstaja postavitev za običajne tipkovnice (s številskim delom) in postavitev za prenosnike.
Privzeto je Aslan nastavljena tako, da uporablja običajno postavitev tipk. Vedno pa lahko zamenjate postavitev tipk v zvrsti Tipkovnica v pogovornem oknu [Nastavitve Aslan](#AslanSettings), ki jo najdete pod Izbirami v Aslan meniju.
...
### Aslan Kretnje Dotika {#AslanTouchGestures}

Če poganjate Aslan na napravi z zaslonom na dotik na operacijskem sistemu Windows 8 ali novejšem, lahko Aslan nadzirate tudi neposredno preko zaslona na dotik.
Medtem, ko je Aslan vključena, bodo vsi dotiki zaslona šli neposredno na Aslan.
Torej dejavnosti, ki se izvajajo normalno brez Aslan, ne bodo delovale.
...
Ko bodo Aslan ukazi opisani pozneje v tem vodiču, le ti lahko vsebujejo tudi kretnjo dotika, ki se lahko uporabi za sprožitev tega ukaza z zaslonom na dotik.
...
Če se enak tap izvede enkrat ali večkrat znova v hitrem zaporedju, bo Aslan obravnavala namesto tega to kot več-dotikabilno kretnjo.
...
Ker je precej več ukazov, kot mogočih kretenj dotika, ima Aslan več možnih načinov delovanj dotika, med katerimi lahko preklapljate, kar prinaša določene podvrste ukazov, ki so navolja za upravljanje na dotik.
Dve delovanji sta delovanje besedila in predmetno delovanje.
Določeni Aslan ukazi, ki so razvrščeni v tem dokumentu, lahko imajo delovanje dotika zapisano v oklepajih za kretnjo dotika.
Na primer švig gor (delovanje besedila) pomeni, da se bo ukaz izvedel toda samo, ko bo Aslan v delovanju besedila.
...
Veliko Aslan ukazov je opisanih skozi ta uporabniški vodič, vendar je še lažja pot za raziskovanje teh ukazov ta, da se vključi delovanje pomoči za vnose.

Če želite vključiti delovanje pomoči za vnose, pritisnite Aslan+1.
Če to delovanje želite izključiti, ponovno pritisnite Aslan+1.
...
### Aslan Meni {#TheAslanMenu}

Aslan meni omogoča nadzor nad nastavitvami Aslan, dostop do pomoči, shranjevanje in obnavljanje vaše konfiguracije, spreminjanje slovarjev govora, dostop do dodatnih orodij in izhod iz Aslan.

Če želite dobiti Aslan meni na zaslon od kjerkoli v sistemu, medtem, ko Aslan teče, Pritisnite Aslan+n na tipkovnici ali izvedite dvoprstni dvojni tap na zaslonu na dotik.
Do menija Aslan lahko dostopate tudi skozi Območje za obvestila.
Neglede na to ali do Aslan menija dostopate preko desnega miškinega klika na sistemskem pladnju Oken ali pa dostopate do sistemskega pladnja s pomočjo pritiska Windows logo tipke+b, pritiskajte puščico dol do ikone Aslan in pritisnite tipko Applications, ki se nahaja zraven tipke desni control na večini tipkovnic.
...
### Aslan Osnovni ukazi {#BasicAslanCommands}
...
|Aslan Meni |Aslan+n |Aslan+n |dvoprstni dvojni tap |Dvigne meni Aslan, kar vam omogoči dostop do nastavitev, orodij, pomoči in drugih elementov.|
|Stikalo Delovanj Govora |Aslan+s |Aslan+s |brez |Preklaplja med različnimi delovanji govora. To so govor, zvočni signali ali izključitev.|
|Stikalo Delovanja Pomoči za Vnose |Aslan+1 |Aslan+1 |brez |Pritisk katerekoli tipke v tem načinu delovanja bo sprožil poročanje o tem, katero tipko se je pritisnilo in opis kateregakoli Aslan ukaza, ki je povezan s tipko, ki ste jo pritisnili.|
|Izhod iz Aslan |Aslan+q |Aslan+q |brez |Zapre Aslan.|
|Pusti naslednjo tipko skozi |Aslan+f2 |Aslan+f2 |brez |Pove Aslan naj naslednji pritisk spusti skozi naravnost k aplikaciji, ki je sedaj odprta, čeprav se to običajno obravnava kot Aslan ukaz.|
|Stikalo za vklop/izklop Delovanja Spanja Programa |Aslan+shift+s |Aslan+shift+z |brez |Delovanje spanja onemogoči vse Aslan ukaze in podajanje sporočil v govoru ali brajici za sedanjo aplikacijo. To je zelo uporabno v aplikacijah, ki same oskrbijo govorne ali zmožnosti branja zaslona. Pritisnite ta ukaz znova, da onemogočite delovanje spanja. Pomnite, da bo Aslan obdržala Nastavitev Spanja samo do naslednjega zagona Aslan.|
...
| Ime |tipka |Opis|
|---|---|---|
|Sporoči Datum in Čas |Aslan+f12 |Enojni pritisk sporoči trenutni čas, dvojni pa trenutni datum.|
|Sporoči stanje baterije |Aslan+shift+b |Poroča o stanju baterije t.j. ali se računalnik napaja iz električnega napajanja ali koliko odstotkov baterije je še na voljo|
|Poročaj o Besedilu v Odložišču |Aslan+c |Poroča o besedilu v odložišču, če ga je kaj.|

<!-- KC:endInclude -->

## krmiljenje z Aslan {#NavigatingWithAslan}

Aslan vam omogoča, da raziskujete in krmilite po sistemu na različne načine vključno z normalno interakcijo in pregledom.
...
|---|---|---|---|
|Sporoči trenutni položaj žarišča |Aslan+tab |Aslan+tab |naznani trenutni predmet ali kontrolnik, ki je v žarišču. Dvojni pritisk bo informacijo črkoval|
|Sporoči naslov |Aslan+t |Aslan+t |Poroča o naslovu trenutno aktivnega okna. Dvojni pritisk bo črkoval to informacijo. Trojni pritisk bo informacijo preslikal v odložišče|
|Beri aktivno okno |Aslan+b |Aslan+b |prebere kontrolnike v trenutno aktivnem oknu(uporabno pri obrazcih)|
|Poročaj o Vrstici Stanja |Aslan+end |Aslan+shift+end |Poroča o vrstici stanja, če jo Aslan najde. Ta ukaz tudi premakne predmet krmiljenja na ta položaj. Dvojni pritisk informacijo črkuje, trojni pritisk pa vsebino vrstice preslika v odložišče|
...
Aslan bo sporočila, ko se boste premikali po besedilu znak po znak, besedo po besedo ali vrstico po vrstico. Sporočeno bo tudi, če je besedilo označeno ali ne.

Aslan vas oskrbuje z naslednjimi ukazi glede na sistemsko kazalko:
<!-- KC:beginInclude -->

| Ime |Običajna razporeditev |razporeditev Prenosnik |Opis|
|---|---|---|---|
|Izgovori vse |Aslan+Puščica dol |Aslan+a |Začne brati od trenutnega položaja sistemske kazalke, se premikajoč tako kot sistemska kazalka|
|Preberi trenutno vrstico |Aslan+Puščica gor |Aslan+l |Prebere vrstico, kjer je trenutno postavljena sistemska kazalka. Dvojni pritisk vrstico črkuje in trojni pritisk jo črkuje s pomočjo opisov znakov.|
|Preberi trenutno besedilno označbo |Aslan+Shift+Puščica gor |Aslan+shift+s |Prebere vsako besedilo, ki je trenutno označeno|
...
Ko se premaknete na predmet, bo Aslan to poročala tako, kot to dela ob sistemskem žarišču.
...
| Ime |Običajna razporeditev |razporeditev Prenosnik |Dotik |Opis|
|---|---|---|---|---|
|Poročaj o trenutnem predmetu |Aslan+številski del5 |Aslan+shift+o |brez |Sporoča kateri predmet je trenutno predmet krmiljenja. Dvojni pritisk informacijo črkuje in trojni pritisk ime predmeta ter njegovo vrednost preslika v odložišče.|
|Premakni se na predmet z vsebino |Aslan+številski del8 |Aslan+shift+Puščica gor |švig gor (delovanje predmeta) |Premik na predmet, ki vsebuje trenutni predmet krmiljenja|
|Premakni se na predhodni predmet |Aslan+številski del4 |Aslan+shift+Puščica levo |švig levo (delovanje predmeta) |Premik pred trenuten predmet krmiljenja|
|Premakni se na naslednji predmet |Aslan+številski del6 |Aslan+shift+Puščica desno |švig desno (delovanje predmeta) |Premik na predmet za  trenutnim predmetom krmiljenja|
|Premakni se na prvi predmet z vsebino |Aslan+številski del2 |Aslan+shift+Puščica dol |švig dol (delovanje predmeta) |Premik na prvi predmet, ki je del vsebine trenutnega predmeta krmiljenja|
|Premakni se na predmet v žarišču |Aslan+številski delMinus |Aslan+vračalka |brez |Premik na predmet, ki vsebuje trenutno sistemsko žarišče ter postavi pregledno utripalko na položaj sistemske kazalke, če se prikazuje|
|Sproži trenutni predmet krmiljenja |Aslan+številski delEnter |Aslan+enter |dvojni tap |Sproži trenuten predmet krmiljenja (podobno kot pri klikih z miško ali pritisku preslednice, ko vsebuje sistemsko žarišče)|
|Premakni Sistemsko žarišče ali kazalko na trenuten položaj pregleda |Aslan+shift+številski delMinus |Aslan+shift+vračalka |brez |enojni pritisk Premakne Sistemsko žarišče na trenutni predmet krmiljenja, dvojni pritisk premakne sistemsko kazalko na položaj pregledne utripalke|
|Sporoči položaj pregledne utripalke |Aslan+številski delBriši |Aslan+Briši |brez |Sporoča položaj besedila ali predmeta nad pregledno utripalko. To lahko vključuje na primer odstotke preostanka dokumenta (odstotke razdalje od trenutnega položaja utripalke do konca dokumenta), razdaljo od roba strani ali točen položaj na zaslonu. Dvojni pritisk lahko oskrbi dodatne podrobnosti.|
...
Aslan vam omogoča prebiranje vsebine [zaslona](#ScreenReview), trenutnega [dokumenta](#DocumentReview) ali trenutnega [predmeta](#ObjectReview) znak po znak, besedo po besedo ali vrstico po vrstico.
...
| Ime |Običajna razporeditev |razporeditev Prenosnik |Dotik |Opis|
|---|---|---|---|---|
|Pomik v zgornjo vrstico pregleda |shift+številski del7 |Aslan+control+začetek |brez |Premakne pregledno utripalko v zgornjo vrstico z besedilom|
|Pomik v predhodno vrstico pregleda |številski del7 |Aslan+Puščica gor |švig gor(delovanje besedila) |Premakne pregledno utripalko v predhodno vrstico z besedilom|
|Poročaj o trenutni vrstici pregleda |številski del8 |Aslan+shift+. |brez |Naznani vrstico z besedilom, kjer je trenutno postavljena pregledna utripalka. Dvojni pritisk to vrstico črkuje  in trojni pritisk to vrstico črkuje z uporabo znakovnih opisov.|
|Pomik v naslednjo vrstico pregleda |številski del9 |Aslan+Puščica dol |švig dol (delovanje besedila) |Premakne pregledno utripalko v naslednjo vrstico z besedilom|
|Pomik v spodnjo vrstico pregleda |shift+številski del9 |Aslan+control+konec |brez |Premakne pregledno utripalko v spodnjo vrstico z besedilom|
|Pomik na predhodno besedo v pregledu |številski del4 |Aslan+control+Puščica levo |dvoprstni švig levo (delovanje besedila) |Premakne pregledno utripalko na predhodno besedo v besedilu|
|Poročaj o trenutni besedi v pregledu |številski del5 |Aslan+control+. |brez |Naznani besedo v besedilu, kjer je trenutno postavljena pregledna utripalka. Dvojni pritisk informacijo črkuje in trojni pritisk to informacijo črkuje s pomočjo opisov znakov.|
|Pomik na naslednjo besedo v pregledu |številski del6 |Aslan+control+Puščica desno |dvoprstni švig desno (delovanje besedila) |Premakne pregledno utripalko na naslednjo besedo v besedilu|
|Pomik na začetek vrstice v pregledu |shift+številski del1 |Aslan+začetek |brez |Premakne pregledno utripalko na začetek trenutne vrstice z besedilom|
|Pomik na predhodni znak v pregledu |številski del1 |Aslan+Puščica levo |švig levo (delovanje besedila) |Premakne pregledno utripalko na predhodni znak v trenutni vrstici z besedilom|
|Poročaj o trenutnem znaku v pregledu |številski del2 |Aslan+. |brez |Naznani trenutni znak v vrstici z besedilom, kjer je trenutno postavljena pregledna utripalka. Dvojni pritisk sporoči opis tega znaka ali primer njegove uporabe, trojni pritisk pa sporoči številsko vrednost tega znaka v desetiški in šestnajstiški obliki.|
|Pomik na naslednji znak v pregledu |številski del3 |Aslan+Puščica desno |švig desno (delovanje besedila) |Premakne pregledno utripalko na naslednji znak v vrstici z besedilom|
|Pomik na konec vrstice v pregledu |shift+številski del3 |Aslan+konec |brez |Premakne pregledno utripalko na konec trenutne vrstice z besedilom|
|Govori vse s pregledom |številski delPlus |Aslan+shift+a |troprstni švig dol (delovanje besedila) |Začetek branja od trenutnega položaja pregledne utripalke in se pri tem premikajoč tako, kot se giblje utripalka|
|Izbor in preslikava od pregledne utripalke |Aslan+f9 |Aslan+f9 |brez |začetek izbora in preslikave besedila od trenutnega položaja pregledne utripalke. Aktualno dejanje se ne bo izvedlo, dokler ne boste Aslan sporočili, kje se konča območje besedila|
|Izbor in preslikava do pregledne utripalke |Aslan+f10 |Aslan+f10 |brez |Ob prvem pritisku se označi območje od zaznamka, ki zaznamuje začetek besedila do vključno trenutnega položaja pregledne utripalke. Če sistemska kazalka lahko doseže besedilo, se bo premaknila na označeno besedilo.  Ob drugem hitrem zaporednem pritisku te kombinacije tipk se bo vsebina preslikala v odložišče Oken|
|Premakni se na zaznamovan začetek za preslikavo v pregledu |Aslan+shift+f9 |Aslan+shift+f9 |brez |Premakne pregledno utripalko na položaj, kjer se je že prej postavil zaznačevalec za preslikavo|
|Sporoči oblikovanje besedila |Aslan+f |Aslan+f |brez |Poroča o oblikovanju besedila, nad katerim je trenutno postavljena pregledna utripalka. Dvojni pritisk informacijo predstavi v brskalniškem delovanju.|
...
Aslan ukazi [za pregled besedila](#ReviewingText) lahko pregledujejo vsebino znotraj trenutnega predmeta krmiljenja, trenutnega dokumenta ali zaslona odvisno od tega, kateri pregled je trenutno izbran.
Delovanja pregleda so zamenjava za starejši koncept nestrukturiranega pregleda, obstajajočega v Aslan že prej.
...
| Ime |Običajna razporeditev |razporeditev Prenosnik |Dotik |Opis|
|---|---|---|---|---|
|Preklop na naslednje delovanje pregleda |Aslan+številski del7 |Aslan+stranGor |dvoprsti švig gor |preklopi na naslednje delovanje pregleda na voljo.|
|Preklop na predhodno delovanje pregleda |Aslan+številski del1 |Aslan+stranDol |dvoprsti švig dol |preklopi na predhodno delovanje pregleda na voljo.|
...
Opozarjamo, da Aslan samodejno preklopi v pregled dokumenta iz pregleda predmeta, ko se pregledujejo dokumenti v brskalniškem delovanju.
...
Opozarjamo, da Aslan v nekaterih novejših programih mogoče ne bo videla nekaj ali pa celo celotnega besedila, ki je lahko na zaslonu, zaradi uporabe novejših tehnologij za izrisovanje po zaslonu, kar trenutno ni možno podpreti.

### krmiljenje z Miško {#NavigatingWithTheMouse}

Ko premikate miško, Aslan privzeto poroča o besedilu, ki je neposredno pod miškinim kazalcem, ko se kazalec pomika nad njim.
Kjer je to podprto, bo Aslan prebrala pripadajoč odstavek z besedilom, čeprav se lahko nekateri kontrolniki preberejo samo v načinu vrstica za vrstico.

Aslan se lahko nastavi tudi tako, da naznani tip [predmeta](#Objects) pod miško, ko se zapelje nad njim (npr. seznam, gumb, in druge.).
To zna biti uporabno za popolnoma slepe uporabnice-ke, ko včasih samo besedilo ni dovolj.

Aslan uporabnicam-kom oskrbuje informacijo o položaju miške relativno glede na dimenzije zaslona skozi igranje trenutnih miškinih koordinat preko zvočnega podajanja.
...
Te dodatne značilnosti Aslan so privzeto izključene.
Če želite uporabljati te prednosti, jih lahko nastavite v zvrsti [Nastavitve miške](#MouseSettings), ki se nahaja v [Nastavitvah Aslan](#AslanSettings) v meniju Aslan Izbir.

Čeprav se mora za delo z miško uporabljati fizična miška ali drsna ploščica, Aslan lahko ponudi nekaj tipkovničnih ukazov, ki se nanašajo na delo z miško:
<!-- KC:beginInclude -->

| Ime |Običajna razporeditev |razporeditev Prenosnik |Dotik |Opis|
|---|---|---|---|---|
|Enojni klik z levim miškinim gumbom |številski delDeli |Aslan+š |brez |enako kot, če enkrat pritisneš na levi miškin gumb. Vsak dvojni klik se izvede tako, da dvakrat pritisnete isti gumb v hitrem zaporedju|
|Zakleni levi miškin gumb |shift+številski delDeli |Aslan+control+š |brez |Blokira levi miškin gumb. Ponovni pritisk ga spusti. Ob vlečenju miške pritisnite ta ukaz in premikajte fizično miško ali uporabite druge ukaze za premik miške|
|Desni miškin klik |številski delMnoži |Aslan+đ |tapni in zadrži |Enako kot pri enkratnem pritisku desnega miškinega gumba.|
|Zakleni desni miškin gumb |shift+številski delMnoži |Aslan+control+đ |brez |Zaklene desni miškin gumb. Ponovni pritisk ga spusti. Ob vlečenju miške pritisnite ta ukaz in premikajte fizično miško ali uporabite druge ukaze za premik miške|
|Pomik miške na trenutni predmet krmiljenja |Aslan+številski delDeli |Aslan+shift+m |brez |Pomakne miško na položaj trenutnega predmeta krmiljenja in pregledne utripalke|
|Pomik na predmet pod miško |Aslan+številski delMnoži |Aslan+shift+n |brez |Kot predmet krmiljenja nastavi predmet, ki je trenutno pod miško|

<!-- KC:endInclude -->

## Brskalniško Delovanje {#BrowseMode}

Kompleksne dokumente samo za branje, kot so spletne strani, v Aslan obravnavamo s pomočjo Brskalniškega delovanja.
...
Vsi Aslan ukazi za [sistemsko kazalko](#SystemCaret) bodo delovali v tem delovanju; npr. izgovori vse, sporoči oblikovanje, ukazi za pomikanje po tabeli, in drugi.
...
Ko ste v brskalniškem delovanju, Aslan privzeto samodejno preklopi v delovanje žarišča, če se premaknete na ali pa kliknete ustrezen kontrolnik, ki zahteva tako obravnavo.
Enako velja tudi za kontrolnike, ki ne potrebujejo delovanja žarišča, kar pomeni, da bo Aslan samodejno preklopila v brskalniško delovanje, ko se boste premaknili na tak kontrolnik.
...
| Ime |Tipka |Opis|
|---|---|---|
|Stikalo za preklop med brskalniškim delovanjem in delovanjem žarišča |Aslan+preslednica |Preklaplja med brskalniškim delovanjem in delovanjem žarišča|
...
|Osveži dokument v brskalniškem delovanju |Aslan+f5 |Ponovno naloži vsebino trenutnega dokumenta (uporabno, ko izgleda, da se del vsebine dokumenta ne prikazuje; v Microsoft Outlooku in Microsoft Wordu ni uporabno)|
|Najdi |Aslan+control+f |Dvigne pogovorno okno v katerem lahko natipkate besedilo, ki ga želite najti v dokumentu. Glejte [iskanje po besedilou](#SearchingForText) za več informacij.|
|Najdi naslednje |Aslan+f3 |Najde naslednji kos besedila v dokumentu, ki ste ga že iskali|
|Najdi predhodno |Aslan+shift+f3 |Najde predhodni kos besedila v dokumentu, ki ste ga že iskali|
|Odpri daljši opis |Aslan+d |Odpre novo okno, ki vsebuje daljši opis elementa na katerem ste, če ga vsebuje.|

<!-- KC:endInclude -->

### Enočrkovno krmiljenje {#SingleLetterNavigation}

Ko ste v brskalniškem delovanju, vas lahko Aslan oskrbi za hitrejše krmiljenje z enoznakovnimi ukazi za preskoke na različna polja v dokumentu.
...
Če to želite uporabljati medtem, ko so tipke za premik utripalke še vedno na voljo za branje v brskalniškem delovanju, lahko začasno onemogočite Aslan posamezne črke za krmiljenje.
<!-- KC:beginInclude -->
Pritisnite Aslan+Shift+Preslednico, če želite vključiti in/ali izključiti enočrkovno krmiljenje v trenutnem dokumentu.
<!-- KC:endInclude -->
...
| Ime |Tipka |Opis|
|---|---|---|
|seznam elementov v brskalniškem delovanju |Aslan+f7 |V ospredje postavi Seznam elementov, ki so del trenutnega dokumenta|
...
| Ime |Tipka |Opis|
|---|---|---|
|Najdi besedilo |Aslan+control+f |Odpre pogovorno okno iskanja|
|Najdi naslednje |Aslan+f3 |išče naslednji primerek trenutnega iskalnega pomena|
|Najdi predhodne |Aslan+shift+f3 |išče predhodni primerek trenutnega iskalnega pomena|
...
Kjerkoli se z njimi srečate v brskalniškem delovanju, bo Aslan sporočila "vdelan predmet", oziroma "program" ali "pogovorno okno".
...
| Ime |Tipka |Opis|
|---|---|---|
|Pomik v dokument z brskalniškim delovanjem |Aslan+control+preslednica |Premakne žarišče iz predmeta v dokument, ki ga vsebuje|

<!-- KC:endInclude -->

## Branje Matematične Vsebine {#ReadingMath}

Z uporabo MathPlayerja 4 iz podjetja Design Science Aslan lahko prebira in interaktivno krmili po podprti matematični vsebini.
...
Aslan podpira naslednje tipe matematične vsebine:
...
Ko boste prebirali dokument, bo Aslan izgovorila vsako podprto matematično vsebino, kjer se bo prikazala.
...
| Ime |Tipka |Opis|
|---|---|---|
|Interakcija z matematično vsebino |Aslan+alt+m |Začne interakcijo z matematično vsebino.|
...
Če posedujete brajevo vrstico, vam na njo Aslan lahko posreduje informacije.
...
Ta razdelek vsebuje tudi informacije o tem, katere vrstice podpirajo funkcijo samodejne zaznave brajeve v vrstice v ozadju prek Aslan.
Brajico lahko nastavite v [zvrsti Brajica](#BrailleSettings)  pogovornega okna [Nastavitve Aslan](#AslanSettings).

### Brajeve okrajšave mejnikov, stanja in tipov kontrolnika {#BrailleAbbreviations}

Zaradi posredovanja največjega možnega števila informacij na brajevo vrstico naenkrat, so v Aslan definirane okrajšave za indikacijo različnih tipov kontrolnikov in njihovih stanj, tako kot mejnikov.
...
Aslan podpira tako skrajšano brajevo vnašanje kot normalno prek brajeve tipkovnice.
Tabelo za prevod brajice v normalno besedilo lahko določite z izborom tabele s spustnega seznama [Tabel za vnos znakov](#BrailleSettingsInputTable)  v zvrsti Brajica pogovornega okna [Nastavitve Aslan](#AslanSettings).
...
Čeprav je Aslan  namenjena predvsem slepim in ljudem z okvaro vida, ki prvotno uporabljajo govor in/ali brajico pri delu z računalnikom, ta oskrbuje tudi vgrajene zmožnosti, ki zmorejo zamenjati vsebino ekrana.
Znotraj Aslan se tak pripomoček imenuje oskrba izboljšave vidnosti.

Aslan ponuja nekaj oskrb izboljšav vidnosti, ki so opisane v nadaljevanju.
Dodatne oskrbe izboljšave vidnosti se lahko doda preko [dodatkov za Aslan](#AddonsManager).

Aslan nastavitve vidnosti se lahko spremenijo v [zvrsti vidnost](#VisionSettings) pogovornega okna [Aslan Nastavitev](#AslanSettings).
...
Ko je Poudarek Žarišča omogočen v [zvrsti vidnost](#VisionSettings) pogovornega okna [Aslan Nastavitev](#AslanSettings), lahko [spreminjate, ali ja ali ne, poudariti žarišče, predmet krmiljenja ali kazalko brskalniškega delovanja](#VisionSettingsFocusHighlight).
...
Za tako situacijo Aslan vsebuje zmožnost, ki se imenuje "preveza čez ekran", ki se lahko omogoči za to, da ekran počrni.

 Prevezo čez Ekran lahko omogočite v [zvrsti vidnost](#VisionSettings) pogovornega okna [Aslan Nastavitev](#AslanSettings).
...
Aslan podpira funkcijo optične prepoznave znakov (z angleško kratico OCR), ki je že vgrajena v Windows 10 s pomočjo katere prepoznava besedilo s slik.
Dodatni prepoznavalniki vsebine se lahko dodajo v Aslan prek dodatkov.

Ko uporabite ukaz za prepoznavo, Aslan prepozna vsebino, ki je del trenutnega [predmeta krmiljenja](#ObjectNavigation).
...
To lahko uporabi Aslan, da lahko prepozna besedilo s slik ali nedostopnih programov.

Jezik, ki se bo uporabil za prepoznavo besedila, lahko nastavite v [zvrsti Windows 10 OCR](#Win10OcrSettings) pogovornega okna [Nastavitev Aslan](#AslanSettings).
...
<!-- KC:beginInclude -->
Za prepoznavo besedila znotraj trenutnega predmeta krmiljenja z uporabo Windows 10 OCR, pritisnite Aslan+r.
<!-- KC:endInclude -->

## Posebne Zmožnosti v Programih {#ApplicationSpecificFeatures}

Aslan vsebuje posebej prirejene zmožnosti za nekatere programe, da omogoči lažjo izvedbo nekaterih opravil ali pa za oskrbo dostopa do funkcionalnosti, ki drugače niso dostopne uporabnikom bralnikov zaslona.

### Microsoft Word {#MicrosoftWord}
#### Samodejno prebiranje Glav Vrstic in Stolpcev {#WordAutomaticColumnAndRowHeaderReading}

Aslan lahko samodejno naznanja ustrezne glave vrstic in stolpcev, ko se pomikate po tabelah v Microsoft Wordu.
Ob tem mora biti izpolnjen predpogoj, da je izbrana zmožnost Sporočanja Glav Vrstic in Stolpcev v Tabelah v nastavitvah Aslan Oblikovanje Dokumentov, ki se nahaja v pogovornem oknu [Nastavitev Aslan](#AslanSettings).
Prav tako mora Aslan vedeti, katera vrstica ali stolpec vsebuje glavo ali čelo tabele.
Po pomiku v prvo celico stolpca ali vrstice z glavo, uporabite naslednje ukaze:
<!-- KC:beginInclude -->

| Ime |Tipka |Opis|
|---|---|---|
|Postavi glave stolpca |Aslan+shift+c |Enojni pritisk pove Aslan, da je to prva celica z glavo v vrstici, ki vsebuje glave stolpca; ta bi morala biti samodejno naznanjena, ko se bomo premikali po stolpcih pod to vrstico. Dvojni pritisk bo zbrisal to nastavitev.|
|Postavi glave vrstice |Aslan+shift+r |Enojni pritisk pove Aslan, da je to prva celica z glavo v stolpcu, ki vsebuje glave vrstice; ta bi morala biti samodejno naznanjena, ko se bomo premikali po vrsticah za tem stolpcem. Dvojni pritisk bo zbrisal to nastavitev.|
...
<!-- KC:beginInclude -->
Za vklop in izklop Brskalniškega delovanja v Microsoft Wordu, pritisnite Aslan+preslednica.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Medtem, ko uporabljate Brskalniško delovanje v Microsoft Wordu, lahko do Seznama Elementov dostopate z ukazom Aslan+f7.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Za sporočanje katerihkoli komentarjev na trenutnem položaju kazalke, pritisnite Aslan+alt+c.
<!-- KC:endInclude -->
Vsi komentarji v dokumentu se lahko vzporedno z ostalimi sledenji spremembam razvrstijo tudi v Aslan Seznamu Elementov.

### Microsoft Excel {#MicrosoftExcel}
#### Samodejno prebiranje Glav Vrstic in Stolpcev {#ExcelAutomaticColumnAndRowHeaderReading}

Aslan lahko samodejno naznanja ustrezne glave stolpcev in vrstic medtem, ko se premikate po Excelovih preglednicah.
Ob tem mora biti izpolnjen predpogoj, da je izbrana zmožnost Sporočanja Glav Vrstic in Stolpcev v Tabelah v nastavitvah Aslan Oblikovanje Dokumentov, ki se nahaja v pogovornem oknu [Nastavitev Aslan](#AslanSettings).
Prav tako mora Aslan vedeti, katera vrstica ali stolpec vsebuje glavo ali čelo tabele.
Po pomiku v prvo celico stolpca ali vrstice z glavo, uporabite naslednje ukaze:
<!-- KC:beginInclude -->
...
Tako kot na spletu, ima Aslan Seznam Elementov tudi za Microsoft Excel, kar vam omogoča razvrstitev in lažji dostop do več različnih tipov informacij.
<!-- KC:beginInclude -->
Za dostop do Seznama Elementov v Excelu, pritisnite Aslan+f7.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Za sporočanje katerihkoli komentarjev za celico, ki je v središču, pritisnite Aslan+alt+c.
<!-- KC:endInclude -->
Vsi komentarji za delovni list se lahko razvrstijo tudi v Aslan Seznamu Elementov po pritisku Aslan+f7.

Aslan lahko prikaže tudi posebno pogovorno okno za dodajanje ali urejanje določenega komentarja.
Aslan preglasi domače MS Excelovo območje za urejanje komentarja zaradi omejitev dostopnosti, toda kombinacija tipk za prikaz pogovornega okna se podeduje iz MS Excela, torej je enaka in tako deluje tudi, če Aslan ne teče.
<!-- KC:beginInclude -->
Za dodajjanje ali urejanje določenega komentarja v celici v žarišču pritisnite shift+f2.
<!-- KC:endInclude -->

Ta kombinacija tipk ni na spregled in se ne more spremeniti v pogovornem oknu Aslan kretenj vnosa.
...
+Toda, to bo odprlo nedostopno območje za urejanje komentarja in ne posebnega pogovornega okna Aslan za urejanje komentarja.
...
<!-- KC:beginInclude -->
Za omogočanje premika v zaklenjene celice, preklopite v Brskalniško delovanje s pritiskom kombinacije Aslan+preslednica in potem uporabljajte standardne Excelove ukaze za premikanje, kot so puščice, ki jih uporabljate za premike med vsemi celicami v trenutnem delovnem listu.
<!-- KC:endInclude -->
...
| Ime |Tipka |Opis|
|---|---|---|
|Stikalo branja sporočil govorca |control+shift+s |Ko teče diaprojekcija, ta ukaz preklaplja med komentarji govorca za trenutni diapozitiv in vsebino diapozitiva. Ta ukaz ima učinek samo na to, kaj Aslan bere in ne na to, kaj je prikazano na zaslonu.|
...
| Ime |Tipka |Opis|
|---|---|---|
|Sporoči zadnje sporočilo |Aslan+control+1-4 |Posreduje eno od zadnjih sporočil, odvisno od tega, katero številko pritisnete; npr. Aslan+control+2 prebere predzadnje sporočilo.|
...
Aslan podpira branje knjig in premikanje po njih v aplikaciji Amazon Kindle za osebne računalnike.
...
V Aslan je vgrajena zgodnja podpora (se še razvija) za branje in interaktivno krmiljenje po matematični vsebini v knjigah z dostopno matematiko.
...
Med branjem v brskalniškem delovanju, Aslan te zabeležke obravnava kot komentarje.
...
Aslan oskrbuje podporo za Windows ukazno konzolo, ki se uporablja v Ukaznem Pozivu, konzoli PowerShell in Windows Podsistemu za Linux.
...
Besedilo, ki ni vidno prikazano v oknu, ni dostopno z Aslan ukazi za pregled besedila.
Tako je potrebno vrteti to konzolsko okno za branje zgodnejšega besedila.
<!-- KC:beginInclude -->
Sledeče vgrajene bližnjične tipke Windows Konzole bodo morda uporabne ob [pregledu besedila](#ReviewingText) z Aslan:
...
## Konfiguracija Aslan {#ConfiguringAslan}

Večino konfiguracije se lahko opravi v pogovornih oknih, ki so dostopna prek podmenija Izbire v meniju Aslan.
Večje število teh nastavitev se lahko najde v mnogostranskem pogovornem oknu imenovanem [pogovorno okno Aslan Nastavitev](#AslanSettings).
...
### Aslan Nastavitve {#AslanSettings}

<!-- KC:settingsSection: || Ime | Običajna razporeditev | razporeditev Prenosnik | Opis | -->
Pogovorno okno Aslan Nastavitev vsebuje precej konfiguracijskih parametrov, ki se lahko spreminjajo.
...
Če želite shraniti vaše nastavitve in zapreti pogovorno okno Aslan Nastavitev, lahko uporabite gumb V redu.

Nekaj zvrsti nastavitev ima dodeljene bližnjične tipke.
Če jih pritisnete, bodo te bližnjične tipke odprle pogovorno okno Aslan Nastavitev v tej nadrobni zvrsti.
...
Zzvrsti nastavitev, ki se nahajajo v pogovornem oknu Aslan Nastavitev, so orisane v nadaljevanju.

#### Splošno (Aslan+control+g) {#GeneralSettings}

Zvrst Splošno iz pogovornega okna Aslan Nastavitev postavlja vedenje Aslan v celoti, kot je jezik vmesnika in ali naj ali ne Aslan samodejno preverja, če obstajajo posodobitve.
Ta zvrst vsebuje naslednje možnosti:

##### Jezik {#GeneralSettingsLanguage}

To je spustni seznam, kjer izbirate jezik, v katerem naj se prikazuje Aslan uporabniški vmesnik in sporočila.
Na voljo je veliko jezikov, privzeto pa Aslan upošteva sistemski jezik "Windows".
Možnost Privzeto pove Aslan, da naj uporabi jezik operacijskega sistema, ki je trenutno nastavljen.

Prosimo, pomnite, Za uveljavitev spremembe jezika, morate Aslan znova zagnati.
...
Ta možnost v obliki izbirnika, ko je izbrana, pove Aslan, da naj ob izhodu trenutno konfiguracijo samodejno shrani.

##### Prikaži izhodne možnosti ob izhodu iz Aslan {#GeneralSettingsShowExitOptions}

Ta možnost je izbirnik, ki vam omogoča izbiro prikaza pogovornega okna ob izhodu iz Aslan, ki vas sprašuje, katero dejanje naj se izvede.
Če boste to možnost izbrali, se bo ob izhodu prikazalo pogovorno okno z vprašanjem, kaj želite storiti; ali želite zapreti Aslan, jo želite ponovno zagnati, jo želite ponovno zagnati z onemogočenimi dodatki ali namestiti čakajoče posodobitve, če so kakšne.
Ko ta možnost ni izbrana, se bo Aslan po ukazu nemudoma izključila.

##### Predvajaj zvok ob zagonu in izhodu iz Aslan {#GeneralSettingsPlaySounds}

Ta možnost je izbirnik, ki pove Aslan, naj, ali pa ne, predvaja zvok ob zagonu Aslan in izhodu iz nje.

##### Nivo beleženja {#GeneralSettingsLogLevel}

To je spustni meni, ki vas spodbuja k izbiri, koliko bo Aslan beležila medtem, ko bo v uporabi.
...
* Onemogočeno: Razen kratkega sporočila o zagonu, Aslan ne bo beležila ničesar medtem, ko bo v pogonu.
* Info: Aslan bo beležila osnovne informacije, kot so sporočila ob zagonu in informacije uporabne za razvijalce.
...
##### Samodejno zaženi Aslan po vpisu v Okna {#GeneralSettingsStartAfterLogOn}

Če boste izbrali to možnost, se bo Aslan zagnala takoj po vpisu v Okna.
Ta možnost je na voljo samo v nameščenih kopijah Aslan.

##### Uporabi Aslan med vpisom v Okna (potrebujete skrbniške pravice) {#GeneralSettingsStartOnLogOnScreen}

Če se v Okna vpisujete z uporabniškim imenom in geslom, se ob vključitvi te možnosti Aslan zaganja samodejno ob vpisu.
Ta možnost je na voljo samo v nameščenih kopijah Aslan.
...
Pritisk tega gumba preslika trenutno shranjene uporabniške nastavitve v imenik sistemskih nastavitev za Aslan. Tako bo Aslan uporabljala te nastavitve, ko bo tekla ob vpisu, ob NUR Nadzoru uporabniških računov in drugih varnih namizjih v Oknih.
Da se bodo zagotovo preslikale vse vaše nastavitve, najprej shranite vaše nastavitve s control+Aslan+c ali shranite konfiguracijo v meniju Aslan z ukazom Shrani konfiguracijo.
Ta možnost je na voljo samo v nameščenih kopijah Aslan.

##### Samodejno preveri, če obstajajo posodobitve za Aslan {#GeneralSettingsCheckForUpdates}

Če je ta možnost izbrana, bo Aslan samodejno preverjala, če obstajajo posodobitv in vas bo obvestila, ko bodo na voljo.
Lahko pa obstoj posodobitev preverite tudi ročno z ukazom Preveri, če obstaja posodobitev v razdelku Pomoč Aslan menija.
Neglede na to, ali ročno preverjate, če obstaja posodobitev ali pa to Aslan počne samodejno, je nujno, da Aslan pošlje nekaj informacij strežniku za nadgraditve zaradi tega, da lahko prejmete ustrezno posodobitev za vaš sistem.
Vedno se pošiljajo te informacije:

* Trenutna različica Aslan
* različica Operacijskega Sistema
* Ali je Operacijski Sistem 64 ali 32 biten

##### Dovoli projektu Aslan zbiranje statistike rabe Aslan {#GeneralSettingsGatherUsageStats}

Če je to omogočeno, bo NV Access uporabila informacije pridobljene ob preverjanju za posodobitve tako, da bo z njihovo pomočjo lažje ugotavljala število uporabnikov Aslan vključno z nekaterimi demografskimi podatki, kot so Operacijski sistem in država izvora.
...
Te informacije bodo močno pomagale NV Access določiti prioritete pri razvoju Aslan v prihodnosti.

##### Obvesti za čakajoče posodobitve ob zagonu {#GeneralSettingsNotifyPendingUpdates}

Če je to izbrano, vas bo Aslan imformirala, ko je ob zagonu na voljo čakajoča posodobitev in vam ponudila možnost, da jo namestite.
Lahko pa tudi ročno namestite čakajočo posodobitev prek pogovornega okna za izhod iz Aslan (če je omogočeno), iz menija Aslan ali, ko boste izvedli novo preverbo iz menija Pomoči.

#### Nastavitve Govora (Aslan+control+v) {#SpeechSettings}

Zvrst Govor, ki se nahaja v pogovornem oknu Aslan Nastavitev, vsebuje možnosti, ki vam omogočajo spreminjanje govorne sinteze kot tudi značilnosti glasu izbrane sinteze.
...
To pogovorno okno se odpre nad pogovornim oknom Nastavitev Aslan.
Shranitev ali zavrzitev nastavitev v pogovornem oknu Izbire Sinteze vas bo vrnila v pogovorno okno Aslan Nastavitev.
...
Če uporabljate govorno sintezo ESpeak NG, ki je vključena v namestitveni paket Aslan, ta spustni seznam omogoči izbiro, s kakšno barvo glasu bi ESpeak NG morala delovati.
...
Ta možnost, ki je privzeto vključena, pove Aslan, naj se pri obdelovanju znakov in simbolov zanaša na jezik osebe (slovar govorne sinteze preglasi slovar vgrajen v Aslan).
Če ugotovite, da Aslan napačno izgovarja posamezno ločilo v nekem jeziku ob nastavitvi glasu ali govorne sinteze v celoti, potem lahko to možnost izključite, da Aslan vsilite uporabo globalnih jezikovnih nastavitev.

##### Vključi podatke konzorcija Unicode (vključno z emojii) ko se obdeluje znake in simbole {#SpeechSettingsCLDR}

Ko bo ta izbirnik izbran, bo Aslan vključila dodatne slovarje za izgovorjavo simbolov, ko bo izgovarjala znake in simbole.
...
Če želite, da bo Aslan izgovarjala opise znakov za emojie, ki bazirajo na teh podatkih, morate to možnost omogočiti.
...
Vi lahko dodajate, urejate ali odstranite opise simbolov v Aslan [pogovornem oknu izgovorjave ločil/simbolov](#SymbolPronunciation).
...
Običajno, Aslan malenkostno dvigne višino glasu za vsako veliko črko, toda nekatere sinteze ne podpirajo te funkcije korektno.
...
Ta nastavitev je izbirnik in ko je izbran, pove Aslan, naj pred velikimi črkami reče "velika", ko črke izgovarja posamezno kot je črkovanje.

##### Oddaj pisk ob velikih črkah {#SpeechSettingsBeepForCaps}

Če je ta izbirnik izbran, bo Aslan oddala kratek pisk vedno, ko bo zaznala veliki znak.
...
#### Izbira Sinteze (Aslan+control+s) {#SelectSynthesizer}

Pogovorno okno Sinteze, ki se lahko odpre prek sprožitve Gumba Spremeni..., v zvrsti Govor pogovornega okna Aslan Nastavitev, vam omogoča izbiro, s katero govorno sintezo naj Aslan govori.
Ko izberete sintezo, pritisnite V redu in Aslan bo naložila izbrano sintezo.
Če pri nalaganju pride do napake, vas bo Aslan o tem obvestila in nadaljevala z uporabo prej izbrane sinteze.

##### Sinteza {#SelectSynthesizerSynthesizer}

Ta možnost vam omogoča izbiro sinteze, s katero želite, da Aslan govori.

Seznam podprtih govornih sintez se nahaja v razdelku [Podprte govorne sinteze](#SupportedSpeechSynths), prosimo, oglejte si ga.

Posebna postavka, ki se bo vedno prikazala, je "Brez govora", z izbiro katere Aslan ne govori več.
To je uporabno za tiste, ki želijo Aslan uporabljati samo z brajico ali za videčega razvijalca, ki bo uporabljal samo prikazovalnik govora.

##### Izhodna naprava {#SelectSynthesizerOutputDevice}

Ta možnost vam omogoča izbiro zvočne naprave, preko katere naj Aslan napoti zvok govorne sinteze.
...
V sistemu Windows 8 in novejših vam ta možnost omogoča, da Aslan zniža glasnost ostalih zvokov, ko Aslan govori ali stalno, ko Aslan teče.

* Brez Stišanja: Aslan ne bo nikoli stišala (znižala glasnosti) ostalih zvokov.
* Stišaj, ko Aslan govori ali oddaja lastne zvoke: Aslan bo znižala glasnost ostalih zvokov samo takratk, ko bo sama govorila ali oddajala lastne zvoke.
* Vedno stišaj: Ostali zvoki se bodo predvajali na naižji glasnosti ves čas medtem, ko bo Aslan v pogonu.

Ta možnost je na voljo samo takrat, ko je Aslan nameščena v sistemu.
Stišanja zvokov v prenosljivi in začasni kopiji Aslan ni mogoče podpreti.

#### Krog nastavitev sinteze {#SynthSettingsRing}

Če želite hitro spreminjati nekatere govorne nastavitve brez, da bi morali odpreti zvrst Nastavitev Govora v pogovornem oknu Aslan Nastavitev, imate na voljo nekaj Aslan ukazov, ki vam omogočajo spreminjanje najbolj uporabnih nastavitev od kjerkoli, ko je Aslan vključena:
<!-- KC:beginInclude -->

| Ime |Običajna razporeditev |razporeditev Prenosnik |Opis|
|---|---|---|---|
|Pomik na naslednjo nastavitev glasu |Aslan+control+Puščica desno |Aslan+shift+control+Puščica desno |Se pomakne na naslednjo nastavitev govora na voljo za trenutno, s preskokom na prvo, če smo na zadnji|
|Pomik na predhodno nastavitev glasu |Aslan+control+Puščica levo |Aslan+shift+control+Puščica levow |Se pomakne na predhodno nastavitev govora na voljo pred trenutno, s preskokom na zadnjo, če smo na prvi|
|Poveča trenutno glasovno nastavitev |Aslan+control+Puščica gor |Aslan+shift+control+Puščica gor |Poveča vrednost govorne nastavitve, kjer trenutno stojite. Npr. poveča hitrost, se premakne na naslednji glas ali poviša glasnost|
|Pomanjša trenutno glasovno nastavitev |Aslan+control+Puščica dol |Aslan+shift+control+Puščica dol |Pomanjša vrednost govorne nastavitve, kjer trenutno stojite. Npr. pomanjša hitrost, se premakne na predhodni glas ali zniža glasnost|

<!-- KC:endInclude -->

#### Nastavitve Brajice {#BrailleSettings}

Zvrst Brajica v pogovornem oknu Aslan Nastavitev vsebuje možnosti, ki vam omogočajo spremembo večih vidikov prikaza v brajici in vnosa v njej.
Ta zvrst vsebuje naslednje možnosti:

##### Zamenjaj brajevo vrstico {#BrailleSettingsChange}

Gumb Spremeni... v zvrsti Brajica v pogovornem oknu Aslan Nastavitev vzpostavi pogovorno okno [Izberi Brajevo Vrstico](#SelectBrailleDisplay), ki vam omogoča izbiro dejavne brajeve vrstice.
To pogovorno okno se odpre nad pogovornim oknom Aslan Nastavitev.
Shranitev ali zavrzitev nastavitev v pogovornem oknu Izbire Brajeve Vrstice vas bo vrnila nazaj v pogovorno okno Aslan Nastavitev.
...
Ta možnost je številčno polje, ki nadzira, koliko dolgo bodo sporočila Aslan prikazana na brajevi vrstici.
Nastavitev tega polja na 0 onemogoči prikaz teh sporočil.

##### Kaži Sporočila v Nedogled {#BrailleSettingsNoMessageTimeout}

Ta možnost omogoča sporočilom Aslan, da bodo prikazana na brajevi vrstici, toliko časa, dokler jih ne boste ročno zavrgli v obliki drugega sporočila s premikom žarišča ipd.

##### Navezava Brajice {#BrailleTether}

Tipka: Aslan+control+t
...
Ko je "Samodejno" izbrano, bo privzeto Aslan sledila sistemskemu žarišču in kazalki.
V tem primeru, ko je predmet krmiljenja ali položaj pregledne utripalke spremenjen zaradi določne uporabnikove interakcije, se bo Aslan začasno navezala na pregled do naslednje spremembe žarišča ali kazalke.
Če želite, da se sledi samo žarišču in kazalki , morate nastaviti navezavo brajice na žarišče.
V tem primeru brajica ne bo sledila Aslan krmiljenju med krmiljenjem predmeta ali pregledni utripalki med pregledom.
...
Ta možnost vam omogoča izbiro, kaj od  informacije o kontekstu vam bo Aslan pokazala tudi na vaši brajevi vrstici, ko se predmet postavi v žarišče.
...
Prosimo, oglejte si razdelek o [predmetu krmiljenja](#ObjectNavigation) za več informacij o hierarhiji, ki se nanaša na predmete v Aslan.

Ko je izbrana možnost Zapolni vrstico s spremembami konteksta, bo Aslan poskušala prikazati toliko informacij, kot bo le mogoče na brajevi vrstici, vendar to velja samo za dele konteksta, ki so se spremenili.
Za zgornji primer to pomeni, ko se bo žarišče postavilo na seznam, bo Aslan na brajevi vrstici pokazala postavko na seznamu.
Poleg tega, če bo ostalo dovolj prostora na brajevi vrstici, bo Aslan skušala pokazati tudi, da je ta postavka na seznamu del seznama.
Če se potem začnete s puščicami pomikati po seznamu, se predpostavlja, da veste, da ste še vedno na seznamu.
Tako bo, ob preostalih postavkah na seznamu, ki jih boste postavili v žarišče, Aslan na vrstici pokazala samo postavko na seznamu, ki je v žarišču.
...
Ko je možnost nastavljena na Vedno zapolni vrstico, Aslan poskuša pokazati toliko kontekstnih informacij, kot je možno na brajevi vrstici; neglede na to, kje ste videli enako kontekstno informacijo prej.
Prednost tega je, da bo Aslan dobavila na vrstico toliko informacij, kot je mogoče.
...
To je bilo privzeto vedenje v različicah Aslan 2017.2 in prejšnjih.

Ko nastavite možnost žarišča informacije konteksta na "Samo ob pomiku nazaj", vam Aslan privzeto ne bo nikoli pokazala informacije o kontekstu na vaši brajevi vrstici.
Tako vam bo v zgornjem primeru Aslan pokazala samo, da je v žarišču postavka na seznamu.
...
#### Izberi Brajevo Vrstico (Aslan+control+a) {#SelectBrailleDisplay}

Pogovorno okno Izbire Brajeve Vrstice, ki se lahko odpre prek sprožitve gumba Spremeni... v zvrsti Brajica pogovornega okna Aslan Nastavitev, vam omogoča izbiro vrstice, ki jo mora Aslan uporabljati  za prikaz brajice.
Ko ste enkrat izbrali vašo željeno brajevo vrstico, lahko pritisnete gumb V redu in Aslan bo potem naložila izbrano vrstico.
Če se pojavi napaka pri poskusu naložitve gonilnika brajeve vrstice, vas bo Aslan o tem obvestila s sporočilom ter nadaljevala z uporabo prejšnje vrstice, če se je uporabljala.
...
Možnost samodejne prepoznave bo dovolila Aslan, da bo iskala med večjim številom podprtih brajevih vrstic v ozadju.
Ko je ta značilnost izbrana in priključite podprto vrstico z uporabo USB ali Bluetooth povezave, se Aslan samodejno poveže s to vrstico.
...
Privzeto Aslan izbere samodejno zaznavo vrat, kar pomeni, da bo povezava z brajevo napravo vzpostavljena samodejno z iskanjem USB in bluetooth naprav na vašem sistemu.
Kakorkoli, za nekatere brajeve vrstice boste verjetno morali sami jasno določiti, katera vrata naj se uporabljajo.
Možnosti, ki so na voljo, so "Samodejno", (kar pove Aslan naj uporabi privzeto proceduro samodejne izbire), "USB", "Bluetooth" in običajna serijska vrata, če vaša brajeva vrstica podpira ta tip komunikacije.
...
Zvrst Vidnost v pogovornem oknu Aslan Nastavitev vam dovoljuje omogočiti, onemogočiti in nastaviti [pripomočke za vidnost](#Vision).

Pomnite, da se lahko možnosti, ki so na voljo v tej zvrsti, razširijo z [Aslan dodatki](#AddonsManager).
Privzeto ta zvrst nastavitev vsebuje sledeče možnosti:

##### Poudarek Žarišča {#VisionSettingsFocusHighlight}

Izbirniki v skupini Poudarka Žarišča nadzirajo vedenje v Aslan vgrajene zmožnosti [Poudarka Žarišča](#VisionFocusHighlight).
...
Dodatne oskrbe izboljšave vidnosti se lahko oskrbijo v [dodatkih za Aslan](#AddonsManager).
...
#### Tipkovnica (Aslan+control+k) {#KeyboardSettings}

Zvrst Tipkovnica v pogovornem oknu Aslan Nastavitev vsebuje možnosti, ki določajo, kako se obnaša Aslan, ko uporabljate in tipkate na tipkovnico.
Ta zvrst nastavitev vsebuje naslednje možnosti:

##### Razporeditev tipk {#KeyboardSettingsLayout}

Na tem spustnem seznamu se nahajajo razporeditve tipk, po katerih mora delati Aslan. Izbirate lahko med večimi razporeditvami. Trenutno sta na voljo razporeditvi "Običajna" in Prenosnik.

##### Določi Aslan Prikrojevalne Tipke {#KeyboardSettingsModifiers}

Izbirnik na tem seznamu nadzira, katere tipke se lahko uporabijo kot [Aslan prikrojevalne tipke](#TheAslanModifierKey).

* Tipka Caps Lock
* Tipka insert na številskem delu
* Tipka insert (običajno postavljena nad puščicami, zraven tipk home in end)

Če nobena tipka ni izbrana kot Aslan prikrojevalna tipka, potem se ne mora izvesti cela kopica ukazov nad Aslan.
Zaradi tega bo pogovorno okno Aslan Nastavitev prikazalo sporočilo o napaki, če ob pritisku gumba V redu ne bo izbrana nobena tipka.
...
Ko je ta zmožnost omogočena, bo Aslan naznanila vse znake, ki jih boste tipkali na tipkovnici.

##### Izgovori Natipkane Besede {#KeyboardSettingsSpeakTypedWords}

Tipka: Aslan+3

Ko je ta zmožnost omogočena, bo Aslan naznanila vse besede, ki jih boste tipkali na tipkovnici.
...
Če je vključeno, precej ukazov za krmiljenje, (kot so hitre tipke za krmiljenje v brskalniškem delovanju ali premik po vrstici in odstavku), ne bodo zaustavile branja celotnega besedila, na mesto tega bo Aslan preskočila na nov položaj in od tam nadaljevala z branjem.
...
Ko je to omogočeno, Aslan naznani vse pritiske na tipkovnici, ki niso nujno povezani s pisanjem črk. To vključuje pritiske kombinacij tipk, na primer Control+črka.

##### Oddaj zvok ob napaki v črkovanju med tipkanjem {#KeyboardSettingsAlertForSpellingErrors}

Ko bo ta možnost vključena, bo Aslan predvajala kratek praskajoč zvok ob besedi, pri kateri bo zaznana napaka črkovanja.
Ta možnost bo na voljo samo takrat, ko bo Sporočanje napak črkovanja omogočeno v [Nastavitvah Oblikovanja Dokumentov](#DocumentFormattingSettings), ki se nahajajo v pogovornem oknu Aslan Nastavitev.

##### Obravnavaj pritiske tipk s strani drugih programov {#KeyboardSettingsHandleKeys}

Ta možnost omogoča uporabniku nadzor nad tem, kako Aslan obravnava pritiske tipk, ki jih prožijo drugi programi, kot so tipkovnice na zaslonu ali programi za prepoznavo govora. Če je možnost vključena, potem to vpliva na delovanje Aslan.
Ta možnost je ob namestitvi Aslan privzeto vključena, toda nekateri uporabniki jo bodo morda morali izključiti. Taki so uporabniki, ki tipkajo v Vietnamščini, saj ta možnost povzroča napačne vnose v programu UniKey typing.

#### Miška (Aslan+control+m) {#MouseSettings}

Zvrst Miška v pogovornem oknu Aslan Nastavitev dovoljuje Aslan, da sledi miško, igra miškine koordinate s piski in določa druge možnosti za miško.
Ta zvrst vsebuje naslednje možnosti:

##### Poročaj o Spremembi Oblike Miške {#MouseSettingsShape}

Je izbirnik in ko je izbran, bo Aslan naznanila spremembo oblike miškinega kazalca vedno, ko se bo ta spremenila.
...
Ko je ta možnost izbrana, bo Aslan naznanjala besedilo, ki je v tem trenutku pod miškinim kazalcem, ko miško premikate po zaslonu. To vam omogoča, da najdete predmete na zaslonu s premikanjem prave miške namesto uporabe skozi krmiljenje predmeta.

##### Resolucija enote besedila {#MouseSettingsTracking}

Če ste Aslan nastavili tako, da pove, kaj je pod miško, ko jo premikate, vam ta možnost ponuja izbiro, koliko besedila naj se prebere.
...
Če je ta možnost izbrana, bo Aslan naznanila vlogo (tip) predmeta, ko se miška pomika po njem.

##### Zaigraj avdio koordinate, ko se miška premika {#MouseSettingsAudio}

Izbira te možnosti naroča Aslan, naj oddaja piske, ko se miška premika, tako da uporabnik lahko ugotavlja kje je miška v odnosu na zaslonski položaj.
...
Če izberete to možnost in hkrati imate izbrano tudi možnost "Omogoči sledenje miške", vam Aslan ne bo naznanila, kaj je pod miško, ko se bo miška premikala zaradi drugega programa.

#### Interakcija z Dotikom {#TouchInteraction}

Ta zvrst nastavitev, ki je na voljo samo na računalnikih, kjer tečejo Windows 8 ali novejši in z zaznavami dotika, vam omogoča nastaviti, kako seAslan obnaša na zaslonih na dotik.
Ta zvrst vsebuje naslednje možnosti:
...
Zvrst Pregledna Utripalka v pogovornem oknu Aslan Nastavitev se uporablja za nastavitev vedenja pregledne utripalke Aslan.
...
Ko boste možnost vključili, bo Aslan izvedla filtracijo v hierarhiji predmetov, po katerih se lahko premikamo, z izključitvijo predmetov, ki niso za uporabnika. To so na primer navidezni predmeti in predmeti, ki so tu predvsem zaradi oblikovanja.
...
#### Predstavitev Predmeta (Aslan+control+o) {#ObjectPresentationSettings}

Zvrst Predstavitev Predmeta v pogovornem oknu Aslan Nastavitev se uporablja za določitev, koliko informacij vam bo Aslan predstavila o kontrolnikih, kot je opis, informacija o položaju in tako naprej.
Ta zvrst nastavitev vsebuje naslednje možnosti:

##### Sporočaj Zaslonske Namige {#ObjectPresentationReportToolTips}

To je izbirnik, ki Aslan sporoča, naj pove, kaj vsebujejo zaslonski namigi, ko je izbran.
...
Ko je ta izbirnik izbran, pove Aslan, naj sporoča vsebino oblačkov pomoči in pojavnih obvestil, ko se pokažejo.
...
Ko je ta izbirnik izbran, Aslan poleg vseh predmetov in kontrolnikov sporoča tudi bližnjične tipke, ki so z njimi povezane.
...
Če je poročanje o informaciji položaja predmeta vključeno, ta možnost omogoča Aslan ugibanje o informaciji položaja predmeta, če je drugače nedosegljiva za dan kontrolnik.

Ko je možnost vključena, Aslan sporoča informacijo o položaju večih kontrolnikov, kot so meniji in orodne vrstice, čeprav dejansko stanje lahko malenkostno odstopa od sporočene informacije.
...
* izključeno - Aslan stanja napredka ne bo sporočala.
* govori - Aslan bo sporočala potek napredka v odstotkih. Vedno, ko bo prejela informacijo o poteku napredka, bo to sporočila.
* oddaj pisk - Izbor te možnosti pove Aslan, naj odda pisk vedno, ko se posodobi informacija o poteku napredka. Višji, kot je pisk, bližje je konec operacije v teku.
* Oddaj pisk in govori - Ta možnost naroča Aslan, da posodobitve napredka oznani tako s piskom kot z govorno informacijo.

##### Sporočaj napredek v ozadju {#ObjectPresentationReportBackgroundProgressBars}

To je možnost, ki, ko je izbrana, pove Aslan, naj podaja informacijo o poteku napredka tudi, če se dogaja v ozadju.
Če minimirate ali se premaknete iz trenutnega okna, ki vsebuje črto poteka napredka, bo Aslan vseeno poročala o napredku in to vam bo omogočilo, da boste lahko delali druge stvari medtem, ko bo Aslan spremljala napredek.
...
Preklaplja možnost naznanitve prikaza samodejnih predlogov in če je stikalo vključeno, bo Aslan zaigrala zvok in tako nakazala pojavitev predlogov.
...
V nekaterih poljih za urejanje, kot so iskalna polja v različnih Windows 10 aplikacijah, vas lahko Aslan obvesti, da se je prikazal seznam predlogov medtem, ko ste vnašali besedilo.
Seznam samodejnih predlogov bo izginil, ko se boste enkrat premaknili iz polja za urejanje in za nekatera polja, vas lahko Aslan obvesti o tem, ko se to zgodi.

#### Vnos Večznakovnih Znakov {#InputCompositionSettings}

Zvrst Vnos Večznakovnih Znakov vam omogoča nadzor nad načinom poročanja Aslan o vnosu azijskih znakov kot na primer z UMV (urejevalnikom metode vnosa) ali s storitvijo metod vnosa besedila.
...
Ta možnost, ki je privzeto vključena, vam omogoča izbiro, ali naj Aslan samodejno sporoča vse vidne kandidate na seznamu kandidatov, ko se prikaže ali na strani, ki je bila spremenjena.
...
Vendar za fonetične metode vnosov, kot je nova kitajska fonetika, je verjetno Aslan bolj uporabna, ko je ta možnost izključena,saj bodo vsi simboli zveneli enako. Tako bo treba uporabljati puščice za krmiljenje po seznamu simbolov in njihovih opisih, da bomo dobili več informacij o posameznem kandidatu.

##### Naznani Izbranega Kandidata {#InputCompositionAnnounceSelectedCandidate}

Ta možnost, ki je privzeto vključena, vam omogoča izbiro, ali naj Aslan naznani kandidata, ko se pojavi seznam kandidatov ali takrat, ko se spremeni izbira.
...
Ta možnost, ki je privzeto vključena, vam omogoča izbiro, ali vas mora Aslan oskrbeti s kratkim opisom vsakega znaka v kandidatu, ko je izbran ali pa naj bo samodejno prebran, ko se pojavi seznam kandidatov.
...
S to možnostjo lahko izbirate med tem ali mora Aslan naznaniti nove znake, ki jih tipkate v ta niz branja.
Ta možnost je privzeto vključena.
...
Ta možnost vam omogoča izbiro ali mora Aslan poročati o novih simbolih, ko se pojavijo v skladnji niza.
Ta možnost je privzeto vključena.

#### Brskalniško Delovanje (Aslan+control+b) {#BrowseModeSettings}

Zvrst Brskalniško Delovanje v pogovornem oknu Aslan Nastavitev se uporablja za nastavitev vedenja Aslan, ko prebirate in se premikate po kompleksnih dokumentih, kot so spletne strani.
Ta zvrst vsebuje naslednje možnosti:
...
Če je možnost izbrana, potem Aslan prikazuje elemente tako, kot so na zaslonu; če ni izbrana, potem polja postavlja vsakega v novo vrsto.
...
Ta možnost določa, kako Aslan obravnava tabele, ki so namenjene predvsem postavitvi oblikovanja.
Ko jo vključite, bo Aslan obravnavala te tabele kot normalne tabele na način, kot je določeno v [Nastavitvah Oblikovanja Dokumenta](#DocumentFormattingSettings) in se na nje umesti s pomočjo hitrih tipk za krmiljenje.
Ko je izključena, Aslan o teh tabelah niti ne bo poročala, niti se na nje ne bo umeščala s hitrim krmiljenjem.
...
Prosimo, oglejte si možnosti v [zvrsti Oblikovanja Dokumentov](#DocumentFormattingSettings), ki je del pogovornega okna [Aslan Nastavitev](#AslanSettings) za nastavljanje poročanja o elementih ob navigaciji, kot so povezave, naslovi in tabele.
...
Ta možnost, ko je izbrana, omogoča Aslan, da vstopa in zapušča delovanje žarišča tudi s puščicami.
Na primer, ko se premikate s puščicami po spletni strani in vstopite na polje za urejanje, bo Aslan samodejno vklopila delovanje žarišča.
Ko s puščicami izstopite iz polja za urejanje, bo Aslan preklopila nazaj v brskalniško delovanje. 

##### Zvočna indikacija delovanja Žarišča in Brskalniškega delovanja {#BrowseModeSettingsPassThroughAudioIndication}

Če je ta možnost izbrana, bo Aslan oddajala posebne zvoke ob preklopu med brskalniškim delovanjem in delovanjem žarišča namesto govornega obvestila o spremembi.

##### Onemogoči vpliv kretenj, ki niso ukazi, na dokument {#BrowseModeSettingsTrapNonCommandGestures}

Ta možnost, ki je privzeto vključena, vam omogoča izbiro ali naj kretnje (pritiski tipk), ki niso ukazi Aslan, niti to niso splošni ukazi, ne vplivajo na dokument.
Na primer, v primeru, ko je možnost vključena, pritisk črke j ali druge tipke,  ne bo vplival na dokument, čeprav to niti ni ukaz Aslan, niti ni to splošen ukaz v programu.
v tem slučaju bo Aslan naročila sistemu Windows, da naj zaigra privzeti zvok, kadarkoli se bo pritisnila tipka, ki se blokira.

#### Oblikovanje Dokumentov (Aslan+control+d) {#DocumentFormattingSettings}

Večina izbirnikov v tej zvrsti določa, kako poročati o tipih oblikovanja, ko se z utripalko sprehajate po dokumentih.
Na primer, ko izberete izbirnik ime pisave, bo vedno, ko se boste premaknili na besedilo z drugačno pisavo od prejšnje, Aslan sporočila ime pisave v uporabi.

Možnosti oblikovanja dokumenta so razvrščene v skupine.
V Aslan lahko nastavite poročanje za:
...
Če je izbrana, ta nastavitev pove Aslan, naj poskuša zaznati vse spremembe v oblikovanju v vrstici, ki jo trenutno predstavlja in te podrobnosti sporočiti, čeprav to lahko zniža učinkovitost Aslan.

Privzeto bo Aslan zaznavala spremembe na položaju pregledne utripalke/sistemske kazalke in včasih bo zaznavala oblikovanje v drugih delih vrstice samo, če to ne bo upočasnilo njenega delovanja.
...
Ta možnost vam omogoča nastavitev, kako naj Aslan sporoča zamik vrstice na njenem začetku.
Spustni seznam Sporočaj zamik vrstice prek ima 4 možnosti.

* Izključeno: Aslan zamika ne bo posebej sporočala.
* Govora: Če je ta možnost izbrana, bo, ko se bo zamik vrstice spremenil, Aslan povedala nekaj takega kot "12 presledek" ali "4 tabulator."
* Tonov: Ko bo izbrana ta možnost, bo Aslan oddala ton, ko se bo zamik vrstice spremenil.
...
Opozorilo! Nastavitve v tej zvrsti so namenjene naprednim uporabnikom in lahko povzročijo, da  Aslan ne bo delovala pravilno, če jo boste napačno nastavili.
Te nastavitve spreminjajte samo, če ste popolnoma gotovi, da veste, kaj delate ali če so vam izretsno tako naročili razvijalci Aslan.
...
Ko se razvija dodatke za Aslan, je uporabno, da ima razvijalec priložnost testiranja kode že medtem, ko se jo piše.
Ta možnost, ko je omogočena, dovoljuje Aslan nalaganje kode po meri (programske Module, globalne Vtičnike, Gonilnike za brajeve Vrstice in Gonilnike za sinteze, iz posebnega imenika za razvijalce scratchpad v vašem Aslan uporabniškem konfiguracijskem imeniku.
Pred tem bi Aslan lahko naložila kodo po meri neposredno iz imenika namenjenega uporabniški konfiguraciji, brez možnosti onemogočenja kode.
Ta možnost je privzeto izključena, zaradi zagotovitve, da nobena koda, ki se ni testirala, se nikoli ne izvaja v Aslan brez uporabnikove izrecne vednosti.
Če boste želeli razširiti kodo po meri med druge, jo boste morali zapakirati kot Aslan dodatek.
...
Ta gumb je na voljo samo takrat, ko je Aslan nastavljena tako, da dovoli kodo po meri iz Imenika Scratchpad za Razvijalce.

##### Uporabi UI (UV) automation za dostop do kontrolnikov Microsoft Word dokumenta, ko so na voljo {#AdvancedSettingsUseUiaForWord}

Ko je ta možnost vključena, bo Aslan poskušala uporabiti Microsoft UI (UV) Automation accessibility API (API za dostopnost), da bi pridobila informacije iz kontrolnikov v Microsoft Word dokumentu.
To vključuje kontrolnike znotraj Microsoft Worda, samega in tudi pregledovalnik sporočil Microsoft Outlook in urejevalnik.
Za najbolj posodobljene različice Microsoft Offica 2016/365, ki tečejo v windows 10, je podpora za UI (UV) Automation dodelana dovolj,da  lahko Aslan oskrbi dostop do Microsoft Word dokumentov skoraj tako dobro kot s trenutno podporo Aslan za Microsoft Word, z dodatno vrednostjo precej izboljšane odzivnosti.
...
Bolj določno, hitro premikanje skozi sporočila v pošti Gmail z brskalnikom  Chrome lahko povzroči, da Aslan izgovarja zastarele informacije.
Ta funkcionalnost je preizkusni fazi v različici Aslan 2020.2 in naprej do preklica.
...
Ko je omogočeno, to predstavlja privzeto delovanje Aslan od različice 2019.1 nazaj.
...
Ta zmožnost je v preizkušanju od različice Aslan 2019.2.

##### Zakasnitev premika kazalke (v MS) {#AdvancedSettingsCaretMoveTimeout}

Ta možnost vam omogoča nastavitev števila milisekund, v katerih bo Aslan čakala na premik kazalke (točke vnosa) v kontrolnikih, kjer se lahko ureja besedilo.
Če boste ugotovili, da izgleda, da Aslan neustrezno sledi kazalko, npr. izgleda, da je zmeraj znak zadaj ali ponavlja vrstice, boste morda želeli poskusiti s povečanjem te vrednosti.

##### Zvrsti beleženja hroščev {#AdvancedSettingsDebugLoggingCategories}

Izbirniki na tem seznamu vam dovoljujejo omogočiti točno določene zvrsti sporočil o hroščih v Aslan dnevniku.
Beleženje teh sporočil se lahko odrazi v zmanjšani učinkovitosti in velikih dnevniških ddatotekah.
Eno od njih vključite samo, če vam je tako izrecno naročeno s strani razvijalca Aslan; npr., ko se ugotavlja, zakaj gonilnik brajeve vrstice ne dela pravilno.

### Raznotere Nastavitve {#MiscSettings}

Razen pogovornega okna [Aslan Nastavitev](#AslanSettings), podmeni Izbire menija Aslan vsebuje več drugih postavk, ki so orisane v nadaljevanju.

#### Slovarji govora {#SpeechDictionaries}

Meni slovarjev govora, ki se nahaja v Nastavitvah, vsebuje pogovorna okna, ki vam omogočajo upravljanje, kako Aslan izgovarja različne besede ali fraze.
Trenutno obstajajo trije različni slovarji govora.
Ti so:

* Privzet: Pravila v tem slovarju vplivajo na vsak izgovor v Aslan.
* Glas: Pravila v tem slovarju vplivajo na govorno sintezo, ki je trenutno v uporabi.
* Začasen: Pravila v tem slovarju vplivajo na ves govor v Aslan, toda to velja samo za trenutno sejo. Ta pravila so začasna in bodo izgubljena, ko se Aslan ponovno zažene.
...
Pravila Aslan govornega slovarja vam omogočajo spreminjanje enega niza znakov v drugega.
Na primer, lahko bi ustvarili pravilo, ki naroča Aslan, da namesto besede "žaba" izgovori "ptič", vedno, ko naleti na to besedo.
...
Toda Slovarji govora v Aslan zmorejo še več kot preprosto zamenjavo besed.
Pogovorno okno dodajanja pravila vsebuje tudi izbirnik, s katerim lahko izbirate ali naj bo vaše pravilo občutljivo na velike črke ali ne. To pomeni, da Aslan pravilo obravnava drugače takrat, ko je beseda zapisana z velikimi črkami kot takrat, ko je beseda zapisana z malimi.
Privzeto Aslan ni občutljiva na velike črke.

Na koncu vam set radijskih gumbov omogoča, da Aslan sporočite ali naj se vzorec uporablja kjerkoli, ali naj se vzorec uporablja samo takrat, ko je to cela beseda ali naj se vzorec obravnava kot "regularen izraz".
...
Opozarjamo, da se to pogovorno okno zanaša na "Zaupaj jeziku osebe za procesiranje simbolov in znakov", možnost, ki se nahaja v [zvrsti Nastavitev Govora](#SpeechSettings) pogovornega okna [Aslan Nastavitev](#AslanSettings); tako Aslan uporablja jezik osebe namesto globalne nastavitve za jezik, ko to možnost omogočite.
...
* Spustni seznam "Pošlji aktualen simbol na sintezo" določa, kdaj bo Aslan obravnavo izgovorjave dotičnega simbola prepustila izbrani govorni sintezi (namesto podatkov iz polja Zamenjave.)
...
V tem pogovornem oknu lahko prilagajate kretnje vnosa, kot so tipke na tipkovnici, gumbi na brajevi vrstici, in podobno ukazom za Aslan.
...
To pogovorno okno vsebuje drevo, kjer so razvrščeni Aslan ukazi, ki so na voljo ločeni po kategorijah.
...
Privzeto bo Aslan samodejno shranila vaše nastavitve ob izhodu.
Vendar to lahko spremenite v splošnih možnostih pod Nastavitvami.
Če želite kadarkoli ročno shraniti nastavitve, izberite postavko Shrani konfiguracijo v glavnem meniju Aslan (Nastavitve)

Če kadarkoli naredite napako pri vaših nastavitvah in želite, da se Aslan povrne na zadnje shranjeno stanje, izberite postavko "Vrni na zadnjo shranjeno konfiguracijo" v glavnem meniju Aslan.
Lahko pa vedno ponastavite Aslan na tovarniške nastavitve z izbiro postavke Ponastavi na tovarniško konfiguracijo, ki se prav tako nahaja v meniju Aslan.

Naslednji Aslan ukazi so tudi na voljo:
<!-- KC:beginInclude -->

| ime |Običajna razporeditev |razporeditev Prenosnik |Opis|
|---|---|---|---|
|Shrani konfiguracijo |Aslan+control+c |Aslan+control+c |Shrani vašo zadnjo konfiguracijo tako, da ni izgubljena, ko zapustite Aslan.|
|Povrni konfiguracijo |Aslan+control+r |Aslan+control+r |Enojni pritisk povrne na stanje zadnje shranjene konfiguracije. Trojni pritisk povrne stanje konfiguracije na tovarniško.|
...
Na primer, da želite, da Aslan poroča o zamikih (imate to možnost vključeno) medtem, ko urejate ali da je vključeno poročanje o lastnostih pisave, ko dokument oblikujete.
To vam Aslan omogoča skozi uporabo Profilov Konfiguracije.

Profil konfiguracije vsebuje samo tiste nastavitve, ki so se spremenile med tem, ko je bil profil v urejanju.
V profilih konfiguracije se lahko spremenijo skoraj vse nastavitve razen tistih v zvrsti  Splošno v pogovornem oknu [Aslan Nastavitev](#AslanSettings), ki vplivajo na delovanje Aslan v celoti.
...
S profili konfiguracije lahko upravljate z izbiro Profilov Konfiguracije v meniju Aslan.
To lahko storite tudi z uporabo sledečega ukaza na tipkovnici:
<!-- KC:beginInclude -->

* Aslan+control+p: Pokaži pogovorno okno Profilov Konfiguracije.
...
Na primer, če profil sproži trenuten program in je poročanje povezav omogočeno v tem profilu, vendar je ista nastavitev v profilu, ki se ročno aktivira izključena, Aslan ne bo sporočala povezav.
Toda, če zamenjate glas v profilu na prožilec in tega niste nikoli storili v profilu, ki se aktivira ročno, bo Aslan upoštevala nastavitev profila na prožilec.
...
* Trenuten program: Ta prožilec aktivira profil, ko se odpre program, ki teče takoj za Aslan nastavitvami. To pomeni, da se prožilec veže na program, s katerega ste odprli nastavitve Aslan. Pozor, Če želite nastaviti prožilec za izbran program, mora program teči v ospredju.
...
Prenosljive različice Aslan hranijo vse nastavitve in dodatke v imeniku z imenom userConfig, ki se nahaja v imeniku Aslan.

Nameščene različice Aslan hranijo vse nastavitve in dodatke v posebnem imeniku, ki se nahaja v vašem uporabniškem profilu.
To pomeni, da ima lahko vsak uporabnik svoj set nastavitev v Aslan.
...
Poleg tega lahko v nameščeni različici Aslan, lahko greste v začetnem meniju prek programov -> Aslan -> razišči imenik uporabniške konfiguracije.

Nastavitve Aslan, ko deluje med vpisom ali na NUR namizjih, se hranijo v imeniku systemConfig v namestitvenem imeniku Aslan.
Običajno se teh nastavitev ne bi smelo dotikati.
Za spremembo delovanja Aslan med vpisom ali na NUR namizjih nastavite Aslan, kot želite, da deluje medtem, ko ste vpisani v Okna, shranite to konfiguracijo in potem pritisnite gumb "Uporabljaj trenutno shranjene nastavitve med vpisom in drugih "varnih" namizjih" v zvrsti Splošno pogovornega okna [Aslan Nastavitev](#AslanSettings).

## Dodatna Orodja {#ExtraTools}
### Preglej Dnevnik {#LogViewer}

Pregledovalnik dnevnika, ki se nahaja v Orodjih v meniju Aslan, vam omogoča ogled vseh zabeleženih dogodkov v dnevnik od zadnjega zagona Aslan pa do trenutka, ko ste začeli pregledovati dnevnik.
Uporaba ukaza Aslan+F1 bo odprla pregledovalnik dnevnika in prikazala informacije za razvijalce o trenutnem predmetu krmiljenja.
...
Za videče razvijalce programov ali za ljudi, ki predstavljajo Aslan videči publiki, je na voljo plavajoče okno, ki vam omogoča spremljanje vsega besedila, ki ga Aslan trenutno izgovarja.

Če želite omogočiti prikazovalnik govora, označite menijsko postavko "Prikazovalnik Govora" v Orodjih menija Aslan.
...
Če ga izberete, se bo prikazovalnik govora pokazal takoj ob zagonu Aslan.
...
Kakorkoli, če kliknete ali postavite žarišče znotraj prikazovalnika, bo Aslan začasno prenehala posodabljati besedilo, tako da ga boste lažje izbrali ali preslikali.
...
Za videče razvijalce programov ali za ljudi, ki predstavljajo Aslan videči publiki, je na voljo plavajoče okno, ki vam dovoljuje prikaz brajevega iznosa in besedilo, ki je enako vsakemu brajevemu znaku.
...
Za omogočitev prikazovalnika brajice izberite menijsko postavko "Prikazovalnik Brajice" v Orodjih v meniju Aslan.
...
Če je izbran, se bo prikazovalnik brajice odprl, ko se bo Aslan zagnala.
...
Aslan Python konzola, ki se nahaja v Orodjih menija Aslan, je orodje za razvijalce, ki je uporabno za razhroščevanje, splošno inšpekcijo Aslan notranjosti ali inšpekcijo hierarhije dostopnosti v programu.
Več informacij, prosimo, poiščite v [Vodiču za Razvijalce  Aslan (v Angleščini)](https://www.nvaccess.org/files/aslan/documentation/developerGuide.html).

### Upravitelj Dodatkov {#AddonsManager}

Upravitelj dodatkov, dostopen preko izbire Orodij v meniju Aslan, vam omogoča namestitev in odstranitev paketov z dodatki za Aslan ter njihovo začasno izključitev ali vključitev.
Te dodatke je oskrbela skupnost in vsebujejo prilagojeno kodo, ki lahko doda ali spremeni značilnosti v Aslan ali celo doda podporo večim brajevim vrsticam ali govornim sintezam.

Upravitelj dodatkov vsebuje seznam, ki prikazuje vse dodatke trenutno nameščene v vaši Aslan uporabniški konfiguraciji.
...
Ta gumb odpre [stran z dodatki za Aslan](https://addons.aslan-project.org/).
Če je Aslan nameščena v vaš računalnik in v njem tudi teče v času nameščanja dodatka, lahko dodatek odprete neposredno iz brskalnika za začetek poteka namestitve, kot je opisano spodaj.
...
To vam bo omogočilo brskanje za paketom dodatka (aslan-addon datoteko) nekje na vašem računalniku ali mreži.
Ko enkrat pritisnete Odpri, se bo začel potek namestitve.

Ko se namešča dodatek, vas bo Aslan najprej zaprosila za potrditev, da  res želite namestiti dodatek.
Ker je funkcionalnost dodatka znotraj Aslan brez omejitev, kar v teoriji vključuje tudi dostop do vaših osebnih podatkov ali lahko tudi do samega jedra sistema, če je Aslan na sistemu nameščena; je zelo pomembno, da nameščate dodatke samo iz virov, ki jim zaupate.
Ko se dodatek namesti, morate Aslan ponovno zagnati, da se dodatek spravi v pogon.
...
Aslan vas bo vprašala, če res želite to storiti.
Tako kot pri namestitvi, se mora Aslan znova zagnati, da se dodatek popolnoma odstrani.
...
Ob vsakem pritisku gumba Omogoči/onemogoči, se stanje dodatka spremeni, tako da boste lahko vedeli, v kakšnem stanju bo deloval dodatek, ko boste Aslan ponovno zagnali.
...
Tako kot ob namestitvi ali odstranitvi dodatka, je tudi tu potreben ponovni zagon Aslan, da bodo spremembe stopile v veljavo.

Upravitelj dodatkov vsebuje tudi gumb Zapri, s katerim lahko zaprete pogovorno okno.
Neglede na to, če ste namestili, spremenili ali odstranili dodatek, vas bo Aslan vprašala, če jo želite ponovno zagnati, da se bodo lahko spremembe, ki ste jih naredili, uveljavile.

Nekateri starejši dodatki verjetno ne bodo več združljivi s to različico Aslan, ki jo imate.
Ob uporabi starejše različice Aslan prav tako nekateri novejši dodatki ne bodo združljivi.
...
Dodatki se ocenijo kot nezdružljivi takrat, ko se niso posodobili tako, da bi delovali skladno z večjimi spremembami v Aslan ali, ko se zanašajo na zmožnost, ki ni na voljo v različici Aslan, katera se uporablja.
Upravitelj nezdružljivih dodatkov vsebuje kratko sporočilo o njegovem namenu kot tudi različico Aslan.
...
To bo odprlo pogovorno okno, ki vam dovoljuje ustvarjanje prenosljive kopije Aslan iz nameščene različice.
Po drugi strani, ko bo tekla prenosljiva kopija Aslan, se bo v dodatnem podmeniju Orodij pokazala menijska postavka "namesti Aslan na ta PC" namesto "ustvari prenosljivo kopijo".

Pogovorno okno za ustvarjanje prenosljive kopije Aslan ali za namestitev Aslan na ta PC vasbo pozval k izbiri poti za mapo, kjer bi morala Aslan ustvariti prenosljivo kopijo ali v katero bi se morala Aslan namestiti.

V tem pogovornem oknu lahko omogočite ali onemogočite sledeče:

* Preslikaj trenutno uporabniško konfiguracijo  (to vključuje datoteke v %appdata%\roaming\Aslan ali v uporabniški konfiguraciji vaše prenosljive kopije in vključuje tudi dodatke in druge module)
* Zaženi novo prenosljivo kopijo po njeni stvaritvi ali zaženi Aslan po namestitvi (samodejno zažene Aslan po stvaritvi prenosljive kopije ali po namestitvi)
...
* Aslan sporoča "neznano", ko se krmili v brskalnikih, kot so Firefox, Thunderbird in drugi.
* Aslan ne uspe pretikati med delovanjem žarišča in brskalniškim delovanjem
* Aslan je zelo počasna, ko se krmili v brskalnikih ob uporabi brskalniškega delovanja
* In verjetno tudi druge težave.

### Ponovno Naloži vtičnike {#ReloadPlugins}

Ta postavka, ko jo sprožite, ponovno naloži aplikacijske module in globalne vtičnike brez potrebe po ponovnem zagonu Aslan, kar je lahko uporabno za razvijalce.

## Podprte Govorne Sinteze {#SupportedSpeechSynths}

Ta razdelek vsebuje informacije o govornih sintezah, ki jih podpira Aslan.
Za bolj razširjen seznam tako brezplačnih kot plačljivih govornih sintez, ki jih lahko kupite in prenesete za uporabo z Aslan, si, prosimo, oglejte [stran z dodatnimi glasovi za Aslan](https://github.com/nvaccess/aslan/wiki/ExtraVoices).

### eSpeak NG {#eSpeakNG}

Govorna sinteza [eSpeak NG](https://github.com/espeak-ng/espeak-ng) je vgrajena neposredno v Aslan in ne potrebuje namestitve posebnih gonilnikov ali drugih komponent.
Aslan privzeto začne uporabljati eSpeak NG v operacijskih sistemih Windos 7, 8 in 8.1, v operacijskem sistemu Windows 10 pa privzeto uporablja [Windows OneCore](#OneCore).
Ker je ta sinteza vgrajena v Aslan, je to čudovita izbira, ko Aslan poganjamo z USB ključka na drugih sistemih.
...
Aslan še vedno podpira to možnost, če imajo uporabniki sinteze temelječe na SAPI 4, že nameščene.
Toda Microsoft te možnosti ne podpira več in tudi potrebnih komponent Microsoft ne ponuja več.

Ko boste uporabljali take sinteze z Aslan, bodo prikazani vsi možni glasovi (dostopni v [zvrsti  Govor](#SpeechSettings) pogovornega okna [Aslan Nastavitev](#AslanSettings) ali prek [Kroga Nastavitev Sinteze](#SynthSettingsRing)), iz vseh SAPI 4 pogonov, ki so se našli v vašem sistemu.
...
Ko uporabljate to sintezo z Aslan, bodo na voljo vsi glasovi (dostopni prek [zvrsti Govor](#SpeechSettings) pogovornega okna [Aslan Nastavitev](#AslanSettings) ali prek [Kroga Nastavitev Sinteze](#SynthSettingsRing)) iz vseh pogonov, ki jih je Aslan našla na vašem sistemu.
...
Ti glasovi pa se lahko uporabljajo tudi z Aslan.
...
V Windows 10 Aslan privzeto uporablja glasove Windows OneCore ([eSpeak NG](#eSpeakNG) se uporablja v drugih izdajah).
...
Ta razdelek vsebuje informacije o brajevih vrsticah, ki jih podpira Aslan.

### Vrstice, ki podpirajo samodejno zaznavo v ozadju {#AutomaticDetection}

Aslan je zmožna zaznati precejšnje število brajevih vrstic v ozadju samodejno tako prek USB povezave kot prek Bluetooth povezave.
To vedenje se doseže z izbiro možnosti Samodejno kot prednostne brajeve vrstice iz Aslan [pogovornega okna Nastavitev Brajice](#BrailleSettings).
...
Privzeto Aslan zna samodejno zaznati in se s temi vrsticami tudi povezati prek USB ali bluetooth povezave.
Vseeno pa lahko ob konfiguraciji vrstice eksplicitno določite "USB" ali "bluetooth" vrata, da omejite tip povezave v uporabi.
To je lahko uporabno ob tem, ko želite Focus vrstico priključiti na računalnik in jo povezati z Aslan prek bluetooth povezave, vseeno pa jo želite polniti prek USB vhoda, ko je tako priključena v sistem.
Funkcija Samodejne zaznave brajevih vrstic v Aslan bo zaznala tudi vrstico na vratih USB ali povezavi Bluetooth.

Sledeče prirejene tipke predstavljajo naslednje Aslan ukaze za to vrstico.
...
|meni Aslan |brailleSpaceBar+dot1+dot3+dot4+dot5|
...
Potrebno je samo, da se vrstica priključi in nastavi Aslan.

Pomnite: Aslan verjetno ne bo mogla uporabljati vrstico ALVA BC6 prek povezave Bluetooth, ko bo sparjena z uporabo orodja ALVA Bluetooth.
Ko ste sparili svojo napravo z uporabo tega orodja in Aslan ne zaznava vaše naprave, vam priporočamo, da sparite vašo vrstico ALVA po navadni poti z uporabo nastavitev Windows Bluetooth.

Pomnite: čeprav ima nekaj od teh vrstic brajevo tipkovnico, te privzeto same upravljajo s prevodom iz brajice v besedilo.
To pomeni, da sistem brajevega vnosa, ki ga uporablja Aslan, ni v uporabi v privzeti situaciji (t.j. nastavitev za tabelo brajevega vnosa nima nobenega učinka).
...
Sledeče tipke so pripete k naslednjim ukazom v Aslan za to vrstico.
...
Aslan podpira večino vrstice [podjetja Handy Tech,](https://www.handytech.de/) ko so priključene na računalnik prek vrat USB, serijskih vrat ali bluetooth povezave.
...
Sledeče vrstice niso podprte "iz škatle" vendar se jih lahko uporablja s pomočjo [handy Techovega univerzalnega gonilnika](https://handytech.de/en/service/downloads-and-manuals/handy-tech-software/braille-display-drivers) in Aslan dodatka:
...
Sledeče tipke so ukazi za vrstice Handy Tech ob uporabi z Aslan.
...
Vrstico je potrebno samo priključiti in konfigurirati Aslan.

Ta vrstica ne podpira funkcije samodejne zaznave brajeve vrstice v ozadju v Aslan.

Sledeče tipke so prirejene za uporabo te vrstice z Aslan.
...
Sledeče tipke teh vrstic so prirejene za delovanje skupaj z Aslan.
...
Sledeče tipke so prirejene za delovanje z Aslan.
...
Sledeče tipke na vrsticah Brailliant BI/B and BrailleNote touch so prirejene za delovanje z Aslan.
...
|Meni Aslan |space+dot1+dot3+dot4+dot5 (space+n)|
...
Aslan podpira Braille Sense, Braille EDGE, Smart Beetle in vrstice Sync Braille iz podjetja [Hims,](https://www.hims-inc.com/) ko jih priključite prek USB ali bluetooth. 
...
Sledijo tipke, ki so pripete k posameznim Aslan ukazom.
...
Brajeve vrstice Seika v različici 3, 4 in 5 (40 celic) in Seika80 (80 celic) iz podjetja [Nippon Telesoft](https://www.nippontelesoft.com/) Aslan podpira.
...
Sledijo tipke, ki so pripete k Aslan ukazom.
...
Te vrstice ne podpirajo funkcije samodejne zaznave brajeve vrstice v ozadju v Aslan.

Če je bil BrxCom nameščen, bo Aslan BrxCom uporabila.
...
Sledijo s strani proizvajalca Papenmeier določeni ukazi za Aslan:
<!-- KC:beginInclude -->
...
Trenutno Aslan desne palčne tipke ne uporablja.
...
Zaradi tega te vrstice ne podpirajo funkcije samodejne zaznave brajeve vrstice v ozadju v Aslan.
...
Aslan podpira beležnice iz podjetja [Humanware](https://www.humanware.com), ko se obnašajo kot prikazni terminali za bralnik zaslona.
...
Če vaša naprava podpira več vrst povezave, ko vašo beležnico BrailleNote priključujete v Aslan, boste morali določiti vrata brajevega terminala v možnosteh brajevega terminala.
Prosimo, podrobnosti preverite v priročniku za uporabo, ki ste ga prejeli zraven vaše beležnice BrailleNote.
Verjetno boste morali vrata določiti tudi v meniju Aslan v pogovornem oknu [Izberi Brajevo Vrstico](#SelectBrailleDisplay).
...
Na BrailleNote Apex BT lahko uporabite vrteče se kolesce, ki je nameščeno med pikama 1 in 4 za različne ukaze za Aslan.
...
Sledijo BrailleNote ukazi, ki so zvezani na Aslan.
...
Aslan podpira EcoBraille vrstice iz ustanove [ONCE](https://www.once.es/).
Podprti so naslednji modeli:
...
Serijska vrata, prek katerih je vrstica priključena v sistem, v Aslan lahko izberete v pogovornem oknu [Izberi Brajevo Vrstico #SelectBrailleDisplay.
Te vrstice ne podpirajo funkcije samodejne zaznave brajeve vrstice v ozadju v Aslan.

Sledijo ukazi v Aslan s posameznimi tipkami z vrstice.
...
Zaradi tega in zaradi vzdrževanja združljivosti z ostalimi bralniki zaslona, ki se uporabljajo na Tajvanu, je v Aslan na voljo dvoje  tipkovničnih ukazov, s katerima lahko pomikate brajevo vrstico:
+<!-- KC:beginInclude -->
...
Vrstice Esys, Esytime in Iris iz [Eurobraille](https://www.eurobraille.fr/) so podprte v Aslan.
...
Aslan podpira vrstice iz [Nattiq Technologies,](https://www.nattiq.com/) ko jih priključite prek USB.
...
Sledijo tipkovne navezave za vrstice Nattiq Technologies z Aslan.
...
[BRLTTY](https://www.brltty.com/) je program neodvisen od Aslan, ki pa ga vseeno lahko uporabimo zaradi podpore večjega števila brajevih vrstic.
...
Tako nastavitev vnosne brajeve tabele v Aslan ni relevantna.

BRLTTY ni vključen v funkcijo samodejne zaznave brajeve vrstice v ozadju v Aslan.

Sledeči ukazi so BRLTTY ukazi, ki jih razume Aslan.
...
Aslan lahko sprejme več dodatnih možnosti ob zagonu, ki potem vplivajo na njeno delovanje.
Uporabite lahko toliko možnosti, kot jih potrebujete.
Te možnosti se lahko uporabijo ob zagonu Aslan prek bližnjice (v lastnostih bližnjice), v pogovornem oknu Zaženi (v začetnem meniju -> Zaženi ali Windows+r) ali v ukazni konzoli Oken.
Možnosti morajo biti ločene od imena izvršljive datoteke Aslan in drugih možnosti s presledki.
Na primer,  uporabna možnost je --disable-addons, ki naroča Aslan, naj zaustavi vse dodatke, ki so v uporabi.
...
Kot primer uporabe teh možnosti lahko v pogovornem oknu Zaženi zaprete trenutno kopijo Aslan z vnosom naslednje vsebine v polje pogovornega okna:
...
|aslan -mc CONFIGPATH |To bo zagnalo Aslan z onemogočenimi zvočnimi signali in sporočilom ob zagonu in določeno konfiguracijo|
|aslan -mc CONFIGPATH --disable-addons |Enako kot zgoraj, vendar bodo zraven onemogočeni tudi dodatki.|
...
|aslan -l 10 |Pove naj se Aslan zažene z nastavitvijo zapisovanja v dnevnik na nivoju razhroščevanja.|
|aslan --log-file=c:\aslan.log |Pove Aslan, naj dnevnik zapiše v  c:\aslan.log|
|aslan --log-level=20 -f c:\aslan.log |Pove Aslan, naj se zažene tako, da bo nivo zapisovanja v dnevnik na nivoju informacij in naj dnevnik zapiše v c:\aslan.log|

Aslan pozna naslednje možnosti ukazne vrstice:

| Kratka |Dolga |Opis|
|---|---|---|
|-h |--help |Pokaže pomoč ukazne vrstice in Izhod|
|-q |--quit |Zapre kopijo Aslan v pomnilniku (zaključi z izvajanjem trenutne kopije Aslan).|
|-k |--check-running |Sporoča, če je Aslan v pogonu. To sporoča z uporabo izhodne kode. Nič (0) pomeni, da teče in ena (1) pomeni, da Aslan ni v pogonu.|
...
|-c CONFIGPATH |--config-path=CONFIGPATH |Prostor, kjer so shranjene vse nastavitve za Aslan.|
|-m |--minimal |Brez zvokov, brez vmesnika, brez sporočila po zagonu ipd.|
|-s |--secure |Varni način: onemogoči Python konzolo, zmožnosti profilov, kot so ustvarjanje, izbris, preimenovanje profilov ipd., preverjanje posodobitve, nekaj izbirnikov v pogovornem oknu dobrodošlice  in v zvrsti splošnih nastavitev (npr. Uporabi Aslan med vpisom v Okna, Shrani konfiguracijo ob izhodu ipd.), kot tudi pregledovalnik dnevnika in zmožnosti beleženja (pogosto v uporabi na varnih namizjih). Pomnite, da bo ta ukaz onemogočil tudi  možnost shranitve nastavitev v sistemsko konfiguracijo in mapa kretenj ne bo shranjena na disk.|
|None |--disable-addons |Dodatki nimajo vpliva na Aslan. Isto, kot če v Aslan dodatkov ne bi bilo.|
|None |--debug-logging |Nastavi nivo beleženja na Razhroščevanje samo za naslednji zagon Aslan. Ta nastavitev bo preglasila katerikoli drug dan argument nivoja beleženja ( --loglevel, -l), ki definira nivo beleženja vključno z možnostjo brez beleženja.|
|None |--no-logging |Popolnoma onemogoči beleženje med uporabo Aslan. Ta nastavitev se lahko preglasi, če je nivo beleženja ( --loglevel, -l) definirano prek ukazne vrstice ali, če je vključeno beleženje razhroščevanja.|
|None |--no-sr-flag |Ne zamenjaj stanja globalne sistemske zastavice za bralnik zaslona.|
|None |--install |Namesti Aslan (na novo nameščeno kopijo Aslan tudi zažene).|
|None |--install-silent |Tiho namesti Aslan (na novo nameščene kopije Aslan ne zažene).|
|None |--enable-start-on-logon=True|False |Ob namestitvi omogoči možnost v Aslan [Uporabi Aslan med vpisom v Okna](#StartAtWindowsLogon)|
|None |--create-portable |Ustvari prenosljivo kopijo Aslan (to novo kopijo potem tudi nemudoma zažene). Obvezno je treba določiti parameter --portable-path|
|None |--create-portable-silent |Ustvari prenosljivo kopijo Aslan (te nove kopije potem ne zažene). Obvezno je treba določiti parameter --portable-path|
...
Aslan dovoli, da se nekatere vrednosti lahko nastavijo v sistemskem registru, ki določa vedenje Aslan na ravni splošnega sistema.
Te vrednosti se hranijo v registru pod enim izmed teh ključev:

* 32-bitni sistem: "HKEY_LOCAL_MACHINE\SOFTWARE\aslan"
* 64-bitni sistem: "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\aslan"

Sledeče vrednosti se torej lahko nastavijo v tem registerskem ključu:

| Ime |Tip |Možne vrednosti |Opis|
|---|---|---|---|
|configInLocalAppData |DWORD |0 (privzeto) za izključitev, 1 to vključitev |Če je omogočeno, hrani Aslan uporabniško konfiguracijo kot lokalne programske podatke namesto the kot programske podatke, ki sledijo uporabniku|
...
Če potrebujete več informacij ali pomoč pri uporabi Aslan, prosimo, obiščite spletno mesto Aslan na Aslan_URL.
Tu boste našli drugo dokumentacijo, tako kot tehnično podporo in vire, ki jih je prispevala skupnost.
Na spletnem mestu so tudi informacije in viri, ki se dotikajo razvoja za Aslan.
