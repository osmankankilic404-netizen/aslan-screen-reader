...
Los sons d'error pueden enchegar-sen en as compilacions estables d'o Aslan a traviés d'una opción nueva en as opcions abanzadas.
...
A causa d'una actualización d'o nuestro certificau de seguranza, un chico numero d'usuarios obtiene una error en que lo Aslan 2021.2 mira actualizacions.
Lo Aslan agora demanda a lo Windows que esvielle los certificaus de seguranza, lo que privará ixa error en o futuro.
...
* Suporte pa la nueva especificación HID braille que pretende estandarizar lo suporte pa las linias Braille. (#12523)
  * Lo Aslan autodetectará los dispositivos que admitan ixa especificación.
  * Pa mas detalles tecnicos sobre la implementación d'o Aslan d'ixa especificación, mira-te https://github.com/nvaccess/aslan/blob/master/devdocs/hidbrailletechnicalnotes.md
* S'ha anyadiu lo suporte pa lo dispositivo braille VisioBraille Vario 4. (#12607)
* Se puet enchegar las notificacions d'error (opcions abanzadas) en que s'emplegue qualsiquier versión d'o Aslan. (#12672)
* En o Windows 10 y posteriors, lo Aslan anunciará lo recuento de sucherencias en introducir termins de busca en as aplicacions como la configuración y la Botiga de Microsoft. (#7330, #12758, #12790)
...
* Lo Aslan emplegará por defecto lo eSpeak si no bi ha voces OneCore instaladas que admitan l'idioma preferiu en o Aslan. (#10451)
* Si las voces OneCore no charran con consistencia se torna a emplegar lo eSpeak como sintetizador. (#11544)
* En leyer la barra d'estau con `Aslan+fin`, lo cursor de revisión ya no se mueve t'a suya localización.
...
* En ubrir un quadro de dialogo d'opcions que ya estase ubierto, lo Aslan mete lo foco en o quadro de dialogo existent en cuenta de chenerar una error. (#5383)
...
* Lo Aslan ya no mirará de salir-ne en que los dialogos sigan alguardando una acción reqiesta (eix.: Confirmar/cancelar). (#12984)

### Corrección d'errors

* Lo seguimiento d'as teclas modificaderas (como Control, u Ficar) ye mas robusto quan lo watchdog se siga recuperando. (#12609)
* Torna a estar posible comprebar las actualizacions d'o Aslan en bells sistemas; por eixemplo, en as instalacions limpias d'o Windows. (#12729)
* Lo Aslan anuncia correctament las celdas d'a tabla en blanco en o Microsoft Word quan s'emplega l'UI automation. (#11043)
...
* Lo Aslan ya no informa d'una valor numerica pa los eslizadors UIA que tiengan definida una representación textual d'a suya valor. (Agora se prefiere UIA ValuePattern que no RangeValuePattern). (#12724)
* Lo Aslan ya no tracta la valor d'os eslizadors de UIA como si estase siempre percentual.
...
* Lo Aslan ya no estableix configuracions rechionals de Python no validas. (#12753)
...
* En utilizar l'UI automation pa acceder t'os controls d'as fuellas de calculo d'o Microsoft Excel, lo Aslan ya no anuncia de forma redundant quan se triga una sola celda. (#12530)
...
* Quan se leye correus electronicos en l'Outlook y lo Aslan ye accedendo t'o mensache con l'UI automation, bellas tablas se marcan agora como tablas de disenyo, lo que significa que ya no s'anunciarán por defecto. (#11430)
...
* En navegar por lo calandario d'a servilla d'o sistema d'o Windows, lo Aslan agora anuncia lo día d'a semana en a suya totalidat. (#12757)
...
* En o Windows 11, lo Aslan ya no anunciará "panel" en pretar Alt+Tab pa cambiar de programa. (#12648)
...
* Compilar lo Aslan agora requiere d'o Visual Studio 2019 16.10.4 u posterior.
...
* `AslanObjects.UIA.winConsoleUIA.WinConsoleUIA.isImprovedTextRangeAvailable` son estaus marcaus como obsoletos y s'eliminarán en 2022.1. (#12660)
...
Encara son disponibles a libel de modulo, pero son obsoletos y s'eliminarán en o Aslan 2022.1. (#12753)
...
La ferramienta d'apanyo d'o rechistro COM agora puede resolver mas problemas en que s'executa lo Aslan.
...
Fe servir lo Aslan 2021.2 pa enchegar la Cortina de Pantalla con o Windows 10 21H2 (10.0.19044) u posteriors.
...
* En o Windows 10 Versión 1909 y posteriors (incluyindo lo Windows 11), lo Aslan anunciará lo recuento de sucherencias en rializar buscas en o Explorador de Fichers. (#10341, #12628)
* En o Microsoft Word, lo Aslan agora anuncia lo resultau d'os alcorces de sangría y sangría francesa en que s'executen. (#6269)

### Cambeos

* Lo Espeak-ng s'ha esviellau ta 1.51-dev commit `ab11439b18238b7a08b965d1d5a6ef31cbb05cbb`. (#12449, #12202, #12280, #12568)
* Si s'enchega articlo en as preferencias d'usuario pa formatiau de documentos, lo Aslan anuncia "articlo" dimpués d'o conteniu. (#11103)
...
* En a Calculadera d'o Windows 10, lo Aslan anunciará las expresions d'a calculadera sobre la linia braille. (#12268)
...
* Lo Aslan sale de traza segura en que s'inicie un nuevo proceso. (#12605)
...
* Navegación mas facil d'a salida en a Consola Python d'o Aslan. (#9784)
  * alt+alto/abaixo blinca t'o resultau anterior/siguient (anyade-bi mayus pa trigar-ne).
  * control+l borra lo panel de salida.
* Lo Aslan agora anuncia las categorías asignadas a una cita en o Microsoft Outlook si bi'n ha. (#11598)
...
* Lo Aslan agora priva que l'usuario realice l'OCR d'o Windows 10 si la cortina de pantalla ye enchegada. (#11911)
...
* Lo suporte pa conteniu d'Adobe Flash s'ha eliminau d'o Aslan a causa que Adobe  desaconsella activament l'uso d'o Flash. (#11131)
* Lo Aslan saldrá mesmo con finestras encara ubiertas, lo proceso de salida agora zarra todas las finestras y dialogos d'o Aslan. (#1740)
...
* En programas de terminal en o Windows 10 versión 1607 y posteriors, en ficar u eliminar caracters en meyo d'una linia, ya no se leyen los caracters a la dreita d'o cursor. (#3200)
  * ixa corrección experimental ha d'enchegar-se manualment en o panel d'opcions abanzadas d'o Aslan cambiando l'algorismo diff a Diff Match Patch.
...
* S'ha correchiu errors graficas como la falta d'elementos en utilizar lo Aslan con un disenyo de dreita ta zurda. (#8859)
* Se respecta l'adreza d'a disposición d'a GUI basada en l'idioma d'o Aslan, no pas en a configuración rechional d'o sistema. (#638)
...
* TextInfo.getTextInChunks ya no se conchela quan se clame a controls d'edición enriquida como lo visor de rechistro de Aslan. (#11613)
* Torna a estar posible utilizar lo Aslan en idiomas que contiengan guións baixos en o nombre d'a configuración rechional, como de_CH, en o Windows 10 1803 y 1809. (#12250)
* En o WordPad, la configuración de l'anunciau de superindiz y subindiz funciona como s'asperaba. (#12262)
* Lo Aslan ya no falla en anunciar lo conteniu recientment enfocau en una pachina web si l'antigo foco desapareix y ye reemplazau por lo nuevo foco en a mesma posición. (#12147)
...
* L'instalador d'o Aslan agora tamién respecta lo parametro de linia de comandos `--minimal` y no reproduz lo son d'inicio, seguindo lo mesmo comportamiento documentau que un executable d'o Aslan instalau u con copia portable. (#12289)
...
* Lo Aslan ya no anunciará "↑↑↑" pa emojis en idiomas en particular. (#11963)
...
* Lo sistema de compilación d'o Aslan agora obtiene todas las pendencias de Python con pip y las almagazena en un entorno virtual de Python. Tot ixo se fa de forma transparent.
  * Pa compilar lo Aslan, s'ha de seguir utilizando SCons d'a forma habitual. Por eixemplo, executando scons.bat en a radiz d'o repositorio. Executar `py -m SCons` ya no s'admite, y `scons.py` tamién s'ha eliminau.
  * Pa executar lo Aslan dende lo codigo fuent, en cuenta d'executar `source/aslan.pyw` dreitament, lo desembolicador agora ha d'utilizar `runaslan.bat` en a radiz d'o repositorio. Si se mira d'executar `source/aslan.pyw`, un quadro de mensache te alvertirá que ixo ya no s'admite.
...
* La propiedat `AslanObject` (y derivaus) agora torna estrictament la clase Enum `controlTypes.IsCurrent`. (#11782)
...
* Lo modulo gui.accPropServer, asinas como las clases AccPropertyOverride y ListCtrlAccPropServer d'o modulo gui.aslanControls s'han eliminau en favor d'o suporte nativo de WX pa anular las propiedatz d'accesibilidat. En amillorar l'accesibilidat d'os controls WX, implementa wx.Accessible en cuenta. (#12215)
...
* S'ha eliminau `easeOfAccess.isSupported`, lo Aslan nomás admite versions d'o Windows en as qualas s'avalúa como `True`. (#12222)
...
* Han cambeau `AslanObjects.UIA.WinConsoleUIA` (#12094)
  * `AslanObjects.UIA.winConsoleUIA.is21H1Plus` s'ha renombrau como `AslanObjects.UIA.winConsoleUIA.isImprovedTextRangeAvailable`.
  * `AslanObjects.UIA.winConsoleUIA.consoleUIATextInfo` s'ha renombrau como lo nombre d'a clase d'inicio en mayusclas.
  * `AslanObjects.UIA.winConsoleUIA.consoleUIATextInfoPre21H1` s'ha renombrau como `AslanObjects.UIA.winConsoleUIA.ConsoleUIATextInfoWorkaroundEndInclusive`
...
Ista versión inclui metodos nuevos de dentrada de chinés, una actualización d'o Liblouis y la Lista d'Elementos (Aslan+f7) agora marcha en o modo de foco.
L'aduya sensible a lo contexto agora ye disponible en pretar F1 en dialogos d'o Aslan.
...
* En pretar F1 adintro d'os dialogos d'o Aslan agora s'ubrirá lo fichero d'aduya pa la sección mas relevant. (#7757)
...
* S'ha anyadiu lo parametro de linia de comandos --copy-portable-config que te permite copiar automaticament la configuración furnida a la cuenta d'usuario en que s'instala lo Aslan en silencio. (#9676)
...
* Lo Aslan agora detectará automaticament los dispositivos Humanware Brailliant BI 40X y 20X a traviés d'USB y Bluetooth. (#11819)
...
* En navegadors web y atras aplicacions que suporten lo modo de navegación, lo dialogo de lista d'elementos (Aslan+F7) agora puede clamar-se en estar en o modo de foco. (#10453)
...
* Lo Aslan agora anunciará "copiau en o portafuellas" antis d'o texto copiau. (#6757)
...
* Lo Aslan torna a marchar correctament con os campos d'edición en utilizar l'aplicación Fast Log Entry. (#8996)
...
* Lo Aslan agora respecta l'atributo aria-roledescription en os elementos en conteniu editable en as pachinas web. (#11607)
...
* Lo Aslan agora leye la linia correcta quan lo cursor se cala en o final d'un vinclo en o final d'un elemento de lista en o Google Docs u belatro conteniu editable en a web. (#11606)
...
* Lo Aslan ya no falla en anunciar un elemento de lista dimpués d'escribir un caracter en una lista en que se charra con as voces Ivona SAPI5 . (#11651)
...
* En que s'use las voces  Ivona SAPI5 dende harposoftware.com, lo Aslan agora ye capaz d'alzar la configuración, cambiar de sintetizador y ya no se quedará en silencio dimpués de reenchegar-se. (#11650)
...
* Con o "intentar cancelar la voz pa los eventos d'o foco expiraus" enchegau lo titol d'o dialogo mirar d'o Aslan s'anuncia de nuevo. (#11632)
* Lo Aslan ya no habría de chelar-se en que se dispierte l'ordinador y lo foco aterrice en un documento d'o Microsoft Edge. (#11576)
...
* Lo Aslan ya no falla en leyer elementos en envistas de lista dentro d'una aplicación de 64 bits tal como Tortoise SVN. (#8175)
* Los ARIA treegrids agora s'exposan como tablas normals en o modo de navegación tanto en o Firefox como en o Chrome. (#9715)
* Agora se puede empecipiar una busca inversa con 'buscar l'anterior' a traviés de Aslan+mayus+F3 (#11770)
* Un script de Aslan ya no se considera repetiu si ocurre una pretada de tecla no relacionada entre las dos execucions d'o script. (#11388) 
* Puede tornar-se a suprimir l'anunciau d'as etiquetas strong y emphasis en l'Internet Explorer desenchegando l'anunciar l'enfasi en as opcions de formatiau de documentos d'o Aslan. (#11808)
...
* En as compilacions de Microsoft Teams con numers de versión como 1.3.00.28xxx, Aslan ya no falla en leyer mensaches en os chats u en as canals de Teams a causa d'un menú enfocau incorrectament. (#11821)
* Lo Aslan anunciará apropiadament como error ortografica y gramatical Lo texto marcau de vez como error ortografica y gramatical en o Google Chrome. (#11787)
...
* En a calculadera d'o Windows 10, lo Aslan no anunciará lo progreso d'os calculos si se desenchega lo verbalizar los caracters en escribir-los. (#9428)
* Lo Aslan ya no se bloca en que s'utilice l'anglés grau 2 d'Estaus unius y se desancha ta braille computerizau en que siga sobre lo cursor en amostrar bell conteniu como una URL en braille. (#11754)
* Torna a estar posible anunciar información de formato pa la celda enfocada de l'Excel fendo servir Aslan+F. (#11914)
* La dentrada QWERTY en as linias braille de Papenmeier que lo suportan torna a marchar y ya no causa que lo Aslan se chele aliatoriament. (#11944)

### Cambios pa los Desembolicadors

* Las prebas de sistema agora pueden ninviar teclas utilizando spy.emulateKeyPress, que prene un identificador de tecla que s'achusta a los propios nombres de tecla d'o Aslan y por defecto tamién la bloca dica que s'execute l'acción. (#11581)
* Lo Aslan ya no requiere que lo directorio actual siga lo directorio de l'aplicación Aslan pa marchar. (#6491)
* La opción aria live politeness pa rechions vivas agora puede trobar-se en obchectos d'o Aslan que fagan servir la propiedat liveRegionPoliteness. (#11596)
...
* Agora puetz conmutar l'anunciau d'os graficos dende las opcions de Formatiau de Documentos d'o Aslan.  Tiene en cuenta que desenchegando ista opción encara leyerá lo texto alternativo d'os graficos. (#4837)
* Agora puetz commutar lo suporte de pantallas tactils d'o Aslan. S'ha anyadiu una opción a lo panel d'interacción tactil d'as opcions d'o Aslan. Lo cenyo predeterminau ye Aslan+control+alt+t. (#9682)
* S'ha anyadiu nuevas tablas braille pa l'alemán. (#11268)
* Lo Aslan agora detecta controls de texto de nomás lectura de UIA. (#10494)
* La existentcia de conteniu marcau (resaltau) s'informa tanto en voz como en braille en totz los navegadors web. (#11436)
 * Ixo puede enchegar-se y desenchegar-se con una nueva opción de formatiau de documento d'o Aslan pa resaltau.
* Se puede anyadir nuevas teclas a lo sistema de teclau emulau dende lo dialogo de cenyos de dentrada d'o Aslan. (#6060)
...
* Lo programa d'anunciar lo formato (Aslan+f) agora s'ha cambiau pa anunciar lo formato en o cursor d'o sistema en cuenta d'en a posición d'o cursor de revisión.  Pa anunciar lo formato en a posición d'o Cursor de Revisión agora emplega Aslan+mayus+f. (#9505)
* Lo Aslan ya no mete automaticament lo foco d'o sistema en os elementos enfocables por defecto en o modo de navegación, amillorando lo rendimiento y la estabilidat. (#11190)
...
* Lo Aslan agora anuncia la terminolochía correcta pa las notas en o MS Excel. (#11311)
...
* La información anunciada en o modo de navegación, como la información de formato con Aslan+F, s'amuestra agora en una finestra licherament mas gran centrada en a pantalla. (#9910)

### Corrección d'Errors

* Lo Aslan agora charra siempre en navegar por parolas y aterriza en qualsiquier simbolo seguiu por un espacio en blanco, qualsiquiera que sigan las opcions de verbosidad. (#5133)
* En las aplicacions que fagan servir lo QT 5.11 u mas modernas, las descripcions d'os obchectos s'anuncian unatra vez. (#8604)
* En eliminar una parola con control+suprimir, lo Aslan ya no remaneix en silencio. (#3298, #11029)
...
* Lo Aslan anunciará dialogo ubierto Con conteniu en l'actualización de mayo de 2020 d'o Windows 10. (#11335)
...
* En l'actualización de mayo d'o 2020 d'o Windows 10, lo Aslan agora amuestra lo Mapiador de Son de Microsoft en revisar los dispositivos de salida dende lo dialogo de sintetizador. (#11349)
...
* En o Google chrome, lo Aslan agora anunciará no marcau pa totz los controls marcables (no nomás caixetas de verificación) que actualment no sigan marcaus. (#11377)
* Unatra vez ye posible navegar por quantos controls quan l'idioma de Aslan siga meso en aragonés. (#11384)
* Lo Aslan ya no habría de chelar-se a veces en o Microsoft Word en mover rapidament las flechas alto y abaixo u en escribir caracters con o Braille enchegau. (#11431, #11425, #11414)
* Lo Aslan ya no anyade un espacio no existent en l'arrociegue en copiar lo navegador d'obchectos actual en o portafuellas. (#11438)
* Lo Aslan ya no enchega lo perfil de leyer-lo tot si no bi ha cosa que leyer. (#10899, #9947)
* Lo Aslan ya no ye incapaz de leyer la lista de caracteristicas en l'administrador Internet Information Services (IIS). (#11468)
* Lo Aslan agora mantiene lo dispositivo d'audio ubierto amillorando lo rendimiento en qualques tarchetas de son (#5172, #10721)
* Lo Aslan ya no se chelará ni s'amortará en que mantiengas preto control+mayus+flecha abaixo en o Microsoft Word. (#9463)
* Agora lo Aslan siempre anuncia Lo estau desplegau/plegau d'os directorios en l'arbol de navegación de drive.google.com. (#11520)
* Lo Aslan detectará automaticament la linia braille NLS eReader Humanware a traviés de Bluetooth, ya que lo suyo nombre Bluethooth ye agora "NLS eReader Humanware". (#11561)
...
* Agora se puede delimitar un fragmento d'o rechistro y dimpués copiar-lo en o portafuellas fendo servir Aslan+control+mayus+F1. (#9280)
* Los obchectos especificos d'o Aslan que lo replegador de vasuera ciclica d'o Python troba por agora se rechistran en que lo replegador los borra pa aduyar en a eliminación d'os ciclos de referencia d'o Aslan. (#11499)
 * La mayoría d'as clases de Aslan se rastreyan incluyindo AslanObjects, appModules, GlobalPlugins, SynthDrivers, y TreeInterceptors.
 * Una clase que cal rastriar ha d'heredar de garbageHandler.TrackedObject.
* Lo rechistro de depuración significativo pa los eventos de MSAA agora puede enchegar-se en a configuración abanzada d'o Aslan. (#11521)
...
* S'ha anyadiu un programa pa ubrir lo directorio de configuración d'o Aslan (sin cenyo predeterminau). (#2214)
...
* A causa de cambios feitos en o VS Code, lo Aslan ya no desenchega lo modo de navegación en Code por defecto. (#10888)
* Lo Aslan ya no anuncia los mensaches "cobalto" y "cobaixo" en mover lo cursor de revisión dreitament t'a primer u zaguer linia de l'actual navegador d'obchectos con os programas de mover lo cursor de revisión t'alto u t'abaixo respectivament. (#9551)
* Lo Aslan ya no anuncia los mensaches "cucha" y "dreita" en mover lo cursor de revisión dreitament t'o primer u zaguer caracter de l'actual navegador d'obchectos con os programas de mover lo cursor de revisión t'a zurda u t'a dreita respectivament. (#9551)

### Corrección d'Errors

* Lo Aslan agora ranca correctament quan lo fichero de rechistro no se puet creyar. (#6330)
* En as versions recients d'o Microsoft Word 365, lo Aslan ya no anunciará "borrar la parola de dezaga" en que se prete control+recule mientras s'edita un documento. (#10851)
* En o Winamp, lo Aslan torna a anunciar lo estau d'aliatorio u de repetir. (#10945)
* Lo Aslan ya no ye extremadament lento en mover-te dentro d'a lista d'elementos en 1Password. (#10508)
* Lo sintetizador de voz Windows OneCore ya no tiene retardo entre las frases. (#10721)
* Lo Aslan ya no se chela en ubrir lo menú  de contexto pa 1Password en l'aria de notificacions d'o sistema. (#11017)
...
* Ya no s'escuita los sons d'error d'o Aslan en acceder ta controls de texto de DevExpress. (#10918)
...
* En o modo de navegación con o foco automatico d'o sistema configurau a elementos enfocables desenchegau, cambear t'o modo de foco con Aslan+espacio agora enfoca l'elemento baixo lo cursor. (#11206)
* Torna a estar posible mirar actualizacions d'o Aslan en bells sistemas. p. eix. en as instalacions limpias d'o Windows. (#11253)
...
* Agora ye posible la comprebación automatizada d'o Aslan con o Chrome y un eixemplo HTML. (#10553)
...
* Lo Aslan ya no escuita a lo IAccessible EVENT_OBJECT_REORDER. (#11076)
* Un ScriptableObject esmarchinau (tal como un GlobalPlugin que pierda una clamada a la suya clase base ' metodo init ) ya no creba lo maneyo de programas d'o Aslan. (#5446)
...
* L'elemento actualment trigau en quadros de lista se presienta atra vez en o modo de navegación en o Chrome, semellant a Aslan 2019.1. (#10713)
...
* Lo Aslan privará que lo sistema se bloque u se suspenda quan siga leyendo-lo tot. (#10643)
...
* En o modo de navegación, lo Aslan agora anuncia "no marcau" pa caixetas de verificación no marcadas que no lo i feba en ocasions anteriorment. (#10781)
...
* Lo Aslan puede leyer y interactugar de nuevas con equacions matematicas en o Microsoft Word. (#10803)
* Lo Aslan anunciará unatra vez lo texto que se deseleccione en o modo de navegación si se preta una flecha mientras lo texto se triga. (#10731).
* Lo Aslan ya no sale si bi ha una error inicializando lo eSpeak. (#10607)
...
* Las pendencias de compilación d'o Aslan agora requieren lo Visual Studio 2019 (16.2 u mas recient). (#10169)
...
Lo Aslan 2019.3 ye una versión bien significativa que contién a saber-los cambios en o nuclio incluindo l'esvielle d'o Python 2 t'o Python 3, y una reescritura mayor d'o subsistema de fabla d'o Aslan.
Anque ixos cambios creban la compatibilidat con os complementos mas antigos d'o Aslan, l'esvielle t'o Python 3 ye menester por seguridat, y los cambios en a fabla permiten bellas innovacions emocionants en o futuro cercano.
...
* S'ha anyadiu un comando pa mover lo cursor de revisión t'a posición achustada anteriorment como marca de prencipio d'a selección u copia: Aslan+mayus+F9. (#1969)
 ...
 * S'ha anyadiu un programa pa enchegar la cortina de pantalla (dica lo siguient renchegue con una sola pretada, u siempre mientras lo Aslan siga en execución con dos pretadas), no se i asigna garra cenyo predeterminau.
 * Puet enchegar-se y configurar-se a traviés d'a categoría 'visión' en o dialogo d'opcions d'o Aslan.
* S'ha anyadiu a lo Aslan la funcionalidat de resaltau de pantalla. (#971, #9064)
 * Lo resaltau d'o foco, d'o navegador d'obchectos y d'a posición d'o cursor d'o modo de navegación puet enchegar-se y configurar-se a traviés d'a categoría 'visión' en o dialogo d'opcions d'o Aslan.
...
* La Guida de l'Usuario agora describe cómo fer servir lo Aslan en a consola d'o Windows. (#9957)
* La execución de aslan.exe agora ye predeterminada pa reemplazar una copia ya en execución d'o Aslan. Lo parametro de linia de comandos -r|--replace encara s'accepta, pero s'ignora. (#8320)
* En o Windows 8 y posteriors, lo Aslan agora anunciará la información de nombre d'o producto y de versión pa las aplicacions nativas tals como las aplicacions descargadas d'a Botiga de Microsoft fendo servir información furnida por l'aplicación. (#4259, #10108)
* En activar y desactivar los cambios de seguimiento con o teclau d'o Microsoft Word, lo Aslan anunciará lo estau d'a configuración. (#942) 
* Lo numero de versión d'o Aslan agora se rechistra como lo primer mensache en o rechistro. Ixo ocurre mesmo si s'ha desenchegau lo rechistro dende la Interficie Grafica d'Usuario. (#9803)
...
* En o Microsoft Word, lo Aslan agora anuncia lo estau de visualización d'os caracters no imprimibles en pretar l'alcorce commutable Ctrl+mayus+8. (#10241)
...
* Los paquetz python de tercers incluyius en o Aslan como comtypes, agora rechistran las suyas alvertencias y errors en o rechistro d'o Aslan. (#10393)
...
* Agora s'inclui lo Java Access Bridge con o Aslan pa permitir l'acceso a aplicacions Java, mesmo pa maquinas Java de 64 bits. (#7724)
* Si lo Java Access Bridge no ye enchegau pa l'usuario, lo Aslan l'enchega automaticament en rancar. (#7952)
...
* En o Windows 10, lo Aslan anunciará los consellos d'as aplicacions universals si lo Aslan se configura pa anunciar los consellos en o dialogo de presentación d'obchectos. (#8118)
...
* Lo Aslan ya no tracta los espacios como parolas en revisión d'obchectos en editors basaus en o Scintilla tals como lo Notepad++. (#8295)
* Lo Aslan privará que lo sistema dentre en o modo adurmient en desplazar-se por lo texto con cenyos d'a linia braille. (#9175)
...
* Lo Aslan tornará a anunciar las sucherencias en a barra d'adreza d'o Microsoft Edge. (#7554)
* Lo Aslan ya no se silencia en que s'enfoque bell control de capitero de pestanya HTML en l'Internet Explorer. (#8898)
* En o Microsoft Edge basau en EdgeHTML, lo Aslan ya no reproducirá lo son de sucherencia de busca en maximizar la finestra. (#9110, #10002)
* Los quadros combinaus d'ARIA 1.1 agora s'admiten en o Mozilla Firefox y en o Google Chrome. (#9616)
* Lo Aslan ya no anunciará lo conteniu d'as columnas visualment amagau  pa los elementos de lista en controls SysListView32. (#8268)
* Lo dialogo d'opcions ya no amuestra "info" como lo libel de rechistro actual quan se siga en o modo seguro. (#10209)
* En o menú inicio d'o Windows 10 Anniversary Update y posteriors, lo Aslan anunciará los detalles d'os resultaus d'a busca. (#10232)
* En o modo de navegación, si en mover lo cursor u en emplegar la navegación rapeda se produz bell cambio en o documento, lo Aslan ya no charra conteniu incorrecto en qualques casos. (#8831, #10343)
* S'ha correchiu qualques nombres de viñetas en o Microsoft Word. (#10399)
* En l'actualización de mayo de 2019 d'o Windows 10 y posteriors, lo Aslan anunciará unatra vez lo primer emoticono u elemento d'o portafuellas trigau en que s'ubra lo panel d'emoticonos y lo historial d'o portafuellas respectivament. (#9204)
* En o Poedit, torna a estar posible veyer qualques traduccions pa los idiomas de dreita ta zurda. (#9931)
* En l'aplicación de configuración de l'actualización d'abril de 2018 d'o Windows 10 y posteriors, lo Aslan ya no anunciará la información d'as barras de progreso d'os mesuradors de volumen que se troba en a pachina de sistema/Son. (#10284)
* Las expresions regulars invalidas en os diccionarios d'a fabla ya no aturan de raso la voz en o Aslan. (#10334)
...
* Las aplicacions Java enchegadas antis que no lo Aslan agora son accesibles sin a necesidat de renchegar l'aplicación Java. (#10296)
...
* Lo Aslan agora tractará bells caracters de composición unicode tals como e-acute como un solo caracter en mover-se por lo texto. (#10550)
...
* En cambiar lo dispositivo de salida d'audio, los tons reproducius por lo Aslan agora se reproducirán por lo dispositivo recientment trigau. (#2167)
...
* Como lo Aslan ya no pende de modulos pyWin32, tals como lo win32api y lo win32con ya no son disponibles pa los complementos. (#9639)
...
* S'ha anyadiu Un marco de treballo que permite a los desembolicadors creyar furnidors d'amilloras visuals; modulos que pueden cambiar lo conteniu d'a pantalla, opcionalment basaus en a dentrada d'o Aslan sobre localizacions d'os obchectos. (#9064)
 ...
 * Los furnidors d'amillora d'a visión s'enchegan y configuran a traviés d'a categoría 'visión' en o dialogo d'opcions d'o Aslan.
* Las propiedatz d'a clase Abstract agora se suportan en obchectos que heredan de baseObject.AutoPropertyObject (eix.:. AslanObjects y TextInfos). (#10102)
...
* Pa cada dentrada en o rechistro d'o Aslan, agora s'inclui información sobre lo filo orichinal. (#10259)
...
* Los modulos externos (appModules y globalPlugins) agora ye menos probable que puedan crebar la creyación de AslanObjects. 
 * Las excepcions causadas por los metodos "chooseAslanObjectOverlayClasses" y "event_AslanObject_init" agora son correctament capturadas y rechistradas.
...
* En Windows 7, Aslan ya no fa que lo explorador de fichers de Windows se bloque quan s'utilice lo rato en o menú Encieto. (#9435) 
* Lo Explorador de Fichers de Windows en Windows 7 ya no se bloca en acceder a los campos d'edición d'os metadatos. (#5337) 
* Aslan ya no se pencha a lo interactuar con imachens con una URI en base 64 en Mozilla Firefox u en Google Chrome. (#10227)
 ...
 * Lo historial de busca se borra quan se reenchegue lo Aslan u se'n salga.
* Lo suporte d'o Aslan pa lo Miranda NG marcha con as versions mas recients d'o client. (#9053) 
* Agora puetz desenchegar lo modo de navegación de traza predeterminada desenchegando la nueva opción d'"enchegar lo modo de navegación en cargar la pachina" en a configuración d'o modo de navegación d'o Aslan. (#8716) 
 * Tiene en cuenta que en que ixa opción siga desenchegada, encara puetz activar lo modo de navegación manualment pretando Aslan+espacio.
 ...
 * Amás, la información d'o Javadoc puede leyer-se dende lo editor quan ye present fendo servir Aslan+d.
 ...
 * Lo efecto de goma elastica: Lo Aslan desfá esporadicament la zaguer pretada de tecla d'o modo de navegación brincando t'a ubicación anterior.
...
* Pa los controladors de linia braille que l'admitan, agora se puede cambiar las opcions d'o controlador dende la categoría d'opcions braille en o quadro de dialogo d'opcions d'o Aslan. (#7452)
...
* S'ha aclariu lo texto en l'administrador de complementos en rancar lo Aslan con l'indicador --disable-addons. (#9473)
...
* En connectar una linia braille autodetectada a traviés d'o Bluetooth, lo Aslan seguirá mirando linias USB compatibles con o mesmo controlador y cambiará ta una connexión USB si ye disponible. (#8853)

### corrección d'errors

* Lo Aslan ya no se bloca en que bell directorio de complementos siga laso. (#7686)
...
* Lo Aslan ya no se silenciará dimpués de salir de l'aplicación Windows 10 Mail. (#9341)
* Lo Aslan ya no falla en enchegar-se quan los achustes rechionals d'os usuarios s'estableixcan en una ubicación desconoixida pa lo Aslan, como por eixemplo inglés (Países Baixos). (#8726)
...
* Lo Aslan agora anuncia correctament la linia en o cursor d'o churi en o Notepad++ y atros editors basaus en o Scintilla. (#5450)
...
* En l'actualización de mayo de 2019 d'o Windows 10, lo Aslan ya no diz muitas notificacions de volumen si se cambia lo volumen con os botons de hardware quan lo Explorador de fichers tienga lo foco. (#9466)
...
* En os controls d'o Scintilla como lo Notepad++, lo Aslan puede leyer la linia correcta quan l'achuste de linia siga enchegau. (#9424)
...
* En o caso d'as voces d'o Windows OneCore, la velocidat establida en o Aslan ya no se veye afectada por la velocidat establida en a configuración de voz d'o Windows 10. (#7498)
* Lo rechistro se puede ubrir agora con Aslan+F1 quan no bi ha información d'o desembolicador pa l'obchecto de navegador actual. (#8613)
* Tamién ye posible fer servir los comandos de navegación de tabla d'o Aslan en o Google Docs, en o Firefox y en o Chrome. (#9494)
* Las teclas frontals agora funcionan correctament en as linias braille de Freedom Scientific. (#8849)
* En leyer lo primer caracter d'un documento en o Notepad++ 7.7 X64, lo Aslan ya no se conchela entre un maximo de diez segundos. (#9609)
...
* S'ha anyadiu un eixemplo pa contrimostrar l'uso de aslanControllerClient.dll dende C#. (#9600)
...
Por favor para cuenta que dende ista versión d'o Aslan los modulos d'aplicación, los complementos globals, los controladors de linias braille y los controladors de sintetizador personals ya no se cargarán automaticament dende lo tuyo directorio de configuración d'usuario d'o Aslan. 
En cuenta deberían instalar-sen como parti d'un complemento d'o Aslan. Pa qui desemboliquen codigo pa bell complemento, lo codigo pa prebas se puet calar en un nuevo directorio scratchpad pa desembolicadors en o directorio de configuración d'usuarios d'o Aslan,  si la opción de desembolicador scratchpad ye enchegada en o nuevo panel d'opcions Abanzadas d'o Aslan.
Ixos cambios fan falta pa guarenciar una millor compatibilidat d'o codigo personalizau, de modo que lo Aslan no se crebe quan ixe codigo se torne incompatible con versions más nuevas.
...
* S'ha anyadiu una opción a las opcions d'o churi d'o Aslan pa fer que lo Aslan maneye situgacions en que lo rato siga controlau por unatra aplicación. (#8452) 
 * Ixo permitirá a lo Aslan rastriar lo churi quan un sistema siga controlau remotament fendo servir lo TeamViewer u atros programas de control remoto.
* S'ha anyadiu lo parametro de linia de comandos `--enable-start-on-logon` pa permitir configurar que las instalacions silenciosas d'o Aslan ranquen en a pantalla d'inicio de sesión u no pas. Especifica verdadero pa rancar en a pantalla d'inicio u falso pa no fer-lo. Si no se define lo parametro --enable-start-on-logon allora lo Aslan ranca por defecto en a pantalla d'inicio de sesión, difuera que ya estase configurau a no por bella instalación previa. (#8574)
* Ye posible desenchegar las funcions de rechistro d'o Aslan configurando lo libel de rechistro a "desenchegau" dende lo panel d'opcions chenerals. (#8516)
...
* S'ha anyadiu una nueva categoría d'opcions abanzadas en o dialogo d'opcions d'o Aslan, incluyindo una opción pa prebar lo nuevo suporte d'o Aslan pa lo Microsoft Word a traviés de l'API d'o Microsoft UI Automation. (#9200)
...
* Los autors de complementos agora pueden fer complir una versión minima requiesta d'o Aslan pa los suyos complementos. Lo Aslan refusará instalar u cargar un complemento que la suya versión minima   requiesta d'o Aslan  ye posterior que no la versión actual d'o Aslan. (#6275)
* Los autors de complementos agora pueden especificar la zaguer versión d'o Aslan contra la quala s'ha prebau lo complemento. Si bell complemento  no s'ha prebau que con una versión d'o Aslan anterior que no la versión actual, allora lo Aslan refusará instalar u cargar lo complemento. (#6275)
* Ista versión d'o Aslan permitirá la instalación y carga de complementos que agún no contiengan la información d'a versión minima d'o Aslan y la zaguera prebada, pero l'actualización ta versions venideras d'o Aslan (por eixemplo 2019.2) puet fer que ixos complementos mas antigos se desencheguen automaticament.
...
* Quan s'encieta lo Aslan con o parametro de linia de comandos `--portable-path`, la rota furnida se replena automaticament en que se mira de creyar una copia portable d'o Aslan fendo servir lo menú d'o Aslan. (#8623)
* S'ha esviellau la rota t'a tabla braille noruega pa refleixar lo estandard a partir de l'anyo 2015. (#9170)
* Quan se navega por paragrafos (control+flechas alto u abaixo) u se navega por celdas de tablas (control+alt+flechas), la existencia d'errors d'ortografía ya no s'anunciará, mesmo si lo Aslan ye configurau pa anunciar-las automaticament. Ixo ye porque los paragrafos y las celdas de tabla pueden estar pro grans, y calcular las errors d'ortografía en qualques aplicacions puede estar bien costoso. (#9217)
* Lo Aslan ya no carga automaticament appModules, globalPlugins y controladors braille y de sintetizador dende lo directorio de configuración de l'usuario d'o Aslan. Ixe codigo habría d'estar empaquetau en cuenta como un complemento con información correcta de versión, guarenciando que lo codigo incompatible no s'execute con as versions actuals d'o Aslan. (#9238)
 * Pa los desembolicadors que lis faga falta prebar lo codigo seguntes se desembolica, s'ha habilitau lo directorio developer scratchpad d'o Aslan en a categoría d'abanzau d'as opcions d'o Aslan, y colocar lo codigo en o directorio 'scratchpad' trobau en o directorio de configuración de l'usuario quan ixa opción siga enchegada.
...
* S'ha amillorau lo dialogo de confirmación de reenchegue dimpués de cambiar l'idioma d'a interficie d'o Aslan. Lo texto y las etiquetas d'os botons son agora mas breus y menos trafucaderas. (#6416)
* Si bell sintetizador de voz de tercers no se carga lo Aslan recorrerá a lo Windows OneCore en o Windows 10, en cuenta d'espeak. (#9025)
* S'ha eliminau la dentrada d'o dialogo de bienvenida en o menú d'o Aslan en as pantallas seguras. 
...
* Lo Aslan anunciará agora los cambios de selección pa determinaus selectors de tiempo tals como en as Alarmas y en l'aplicación d'o reloch en o Windows 10. (#5231)
* En o Centro d'actividatz d'o Windows 10 lo Aslan anunciará los mensaches d'estau a lo alternar entre accions rapidas como lo brilo y l'enfoque. (#8954)
* En o centro d'actividatz en l'actualización d'o Windows 10 d'octubre de 2018 y versions anteriors lo Aslan reconoixerá lo control de brilo d'acción rapeda como un botón en cuenta de como un botón commutable. (#8845)
* Lo Aslan tornará a rastriar lo cursor y anunciará los caracters eliminaus en o Microsoft Excel y buscará los campos d'edición. (#9042)
* S'ha correchiu una error rara en o modo de navegación en o Firefox. (#9152)
* Lo Aslan ya no falla en anunciar l'enfoque de qualques controls en a cinta d'o Microsoft Office 2016 quan ye contraita.
* Lo Aslan ya no falla en anunciar lo contacto sucheriu en ficar adrezas en os nuevos mensaches de l'Outlook 2016. (#8502)
...
* Lo modo de navegación s'enchega agora correctament de traza predeterminada quan se leye mensaches en l'Outlook 2016/365 si s'usa la compatibilidat con o suporte experimental de l'UI Automation d'o Aslan pa los documentos d'o Word. (#9188)
* Agora ye menos prebable que lo Aslan se chele de tal traza que la sola forma d'eslampar-ne siga zarrar la sesión actual d'o Windows. (#6291)
* En l'actualización d'octubre d'o 2018 d'o Windows 10 y las versions posteriors, en ubrir lo historial d'o portafuellas d'a boira con o portafuellas vuedo, lo Aslan anunciará lo estau d'o portafuellas. (#9103)
* En l'actualización d'octubre d'o 2018 d'o Windows 10 y las versions posteriors, en buscar emoticonos en o panel d'emoticonos, lo Aslan anunciará lo millor resultau. (#9105)
* Lo Aslan ya no se chela en a finestra prencipal de l'Oracle VirtualBox 5.2 y superiors. (#9202)
...
* Ya no habría d'estar necesario desenchegar la edición en a celda en as opcions d'o Microsoft Excel pa acceder t'o control d'edición de celdas con o Aslan en l'Excel 2016/365. (#8146).
...
* Lo Aslan agora puede compilar-se con totas las edicions d'o Microsoft Visual Studio 2017 (no nomás con a edición Community). (#8939)
* Agora puetz incluyir la salida d'o rechistro d'o liblouis en o rechistro d'o Aslan configurando la bandera booleana louis en a sección debugLogging d'a configuración d'o Aslan. (#4554)
* Los autors de complementos agora pueden furnir información sobre la compatibilidat d'as versions d'o Aslan en os manifests d'os complementos. (#6275, #9055)
 * minimumAslanVersion: La versión minima reqiesta d'o Aslan pa que un complemento marche como cal.
 * lastTestedAslanVersion: La zaguer versión d'o Aslan con a quala ye estau prebau bell complemento.
...
* Las propiedatz y metodos adintro d'as clases agora pueden estar marcadas como abstractas en o Aslan. Ixas clases chenerarán una error si se instancian. (#8294, #8652, #8658)
* Lo Aslan puede rechistrar lo tiempo transcorriu dende que s'introdució lo texto, lo que aduya a medir la capacidat de respuesta percita. Esto puede activar-se configurando la opción timeSinceInput como True en a sección debugLog d'a configuración d'o Aslan. (#9167)

## 2018.4.1

Ista versión apanya una crebadura en rancar si l'idioma d'a interficie d'usuario d'o Aslan ye establiu en aragonés. (#9089)
...
* Lo Aslan agora puet leyer descripcions pa emoticonos asinas como atros caracters que fan parti d'o repositorio Unicode Common Locale Data. (#6523)
* En o Microsoft Word, la distancia d'o cursor dende los cantos superior y cucho d'a pachina puet anunciar-se  pretando Aslan+suprimir d'o teclau numerico. (#1939)
* En as fuellas de Google con o modo de braille enchegau lo Aslan ya no anuncia 'trigau' en cada celda en mover lo foco entre ellas. (#8879)
...
* EN AS opcions d'o teclau d'o Aslan las caixetas de verificación pa enchegar u desenchegar las teclas modificaderas d'o Aslan agora s'amuestran en una lista en cuenta d'en caixetas de verificación deseparadas.
* Lo Aslan ya no presienta información redundant en leyer lo reloch d'a servilla d'o sistema en qualques versions d'o Windows. (#4364)
...
* Quan lo Aslan se configura pa idiomas tals como Kirgyz, Mongol u Macedonio, ya no amuestra un dialogo en un aviso en rancar que l'idioma no s'admite por lo sistema operativo. (#8064)
...
* Si s'executa en a versión chaponesa d'o Windows XP u Vista, lo Aslan agora amuestra l'alerta d'os requisitos d'a versión d'o Sistema Operativo seguntes s'asperaba. (#8771)
...
* Lo Aslan ya no falla en seguir a lo foco en o Explorador de Fichers y atras aplicacions que fagan servir l'UI Automation quan unatra aplicación siga ocupada (tal como lo procesamiento por lotes de l'audio). (#7345)
...
* Dimpués d'esviellar lo Aslan los navegadors tals como lo Firefox y lo google Chrome ya no habrían de trencar-sen, y lo modo de navegación habría de seguir reflectando correctament las actualizacions de qualsiquier documento cargau actualment. (#7641) 
* Lo Aslan ya no informa que se puet fer clic quantas veces en una ringlera en navegar por conteniu clicable en o Modo de navegación. (#7430)
* Los cenyos realizaus en las linias braille baum Vario 40 ya no fallarán en executar-sen. (#8894)
* En o Google Slides con o Mozilla Firefox, lo Aslan ya no anuncia lo texto trigau en cada control con o foco. (#8964)

### Cambios pa los Desembolicadors

* gui.aslanControls agora contiene dos clases pa creyar listas accesibles con caixetas de verificación. (#7325)
 ...
 * Mira-te la implementación de gui.aslanControls.ListCtrlAccPropServer pa mas información.
...
Ista ye una versión menor pa correchir una error critica en o Aslan que feba que las versions de 32 bits d'o Mozilla Firefox se penchasen. (#8759)
...
* Lo Aslan anunciará las errors gramaticals quan las pachinas web en o Mozilla Firefox y lo Google Chrome las exposen apropiadament. (#8280)
* Lo conteniu que se marca como estando borrau u ficau en as pachinas web agora s'anuncia en o Google Chrome. (#8558)
* S'ha adhibiu lo suporte pa las ruedas de desplazamiento d'o BrailleNote QT y l'Apex BT quan s'emplega lo BrailleNote como una linia braille con o Aslan. (#6316)
 ...
 * Puetz habilitar ista caracteristica trigando la opción d'automatico dende la lista de linias braille en o dialogo de seleccionar linia braille d'o Aslan.
...
* Agora se le pregunta a l'usuario una vez en o ranque d'o Aslan si ye d'alcuerdo en ninviar estatisticas d'uso ta NV Access quan se mire actualizacions automaticament. (#8217)
* En mirar actualizacions, si l'usuario ye d'alcuerdo en permitir lo ninvio d'estatisticas d'uso ta NV Access, lo Aslan agora ninviará lo nombre d'o controlador d'o sintetizador actual y d'a linia braille en uso, pa aduyar a establir un millor orden de prioridatz pa lo treballo futuro d'ixos controladors. (#8217)
...
* Lo Aslan ya no anuncia cambios redundants d'a distribución de teclau. (#7383, #8419)
...
* Lo Aslan reconoixerá mas dialogos en o Windows 10 y atras aplicacions modernas. (#8405)
* En l'actualización d'octubre d'o 2018 d'o Windows 10 y d'o Server 2019 y posteriors lo Aslan ya no falla en seguir a lo foco d'o sistema quan una aplicación se conchela u engarona a lo sistema d'escayecimientos. (#7345, #8535)
...
* En a lista d'idiomas en as opcions chenerals d'o Aslan lo nombre pa l'idioma birmano s'amuestra correctament en o Windows 7. (#8544)
* En o Microsoft Edge lo Aslan anunciará notificacions tals como leyer la disponibilidat d'a envista y lo progreso d'a carga d'a pachina. (#8423)
* En navegar por una lista en a web lo Aslan agora anunciará la suya etiqueta si l'autor d'a pachina en ha furniu una. (#7652)
...
* S'ha ficau un marco de treballo de sistema de prebas pa lo Aslan. (#708)
...
* Dau que lo Aslan agora nomás ye compatible con o Windows 7 SP1 y posteriors, s'ha eliminau la clau "minWindowsVersion" utilizada pa comprebar si l'UIA habría d'enchegar-se pa una versión en particular d'o Windows. (#8422)
 ...
 * config.pre_configSave s'emplega pa que se te notifique quan la configuración d'o Aslan ye a pocas d'alzar-se, y config.post_configSave se clama dimpués que la configuración s'haiga alzada.
...
* Agora se suporta las ordens de navegación de táblas d'o Aslan en o Google Docs (con o modo de braille enchegau). (#7946)
...
* En l'actualización Fall Creators d'o Windows 10 y posteriors lo Aslan puet anunciar notificacions dende aplicacions tals como a calculadora y o Windows Store. (#8045)
...
* En esviellar o Aslan, agora ye posible de posposar a instalación de l'actualización pa un momento posterior. (#4263) 
* Nuevos idiomas: Mongol, Alemán de Suiza.
* Agora puetz commutar control, shift, alt, windows y Aslan dende lo tuyo teclau braille y combinar ixos modificadors con a dentrada braille (eix.: pretar control+s). (#7306) 
...
* Agora se sincronizará automaticament con o Aslan la calendata y la hora pa los dispositivos Handy Tech suportaus (tals como l'Active Braille y l'Active Star) quan sigan desincronizaus mas de cinco segundos. (#8016)
* En as listas de mensaches d'o Microsoft Outlook o Aslan agora informa si bel mensache ha estau respondiu u reninviau. (#6911)
...
* O Aslan agora charra menos en o calandario de l'Outlook quan una cita u una francha temporal cubre un día entero. (#7949)
* Agora se puet trobar todas as preferencias d'o Aslan en un unico dialogo d'opcions en o menú Aslan -> Preferencias -> Opcions, en cuenta de deseparar-sen en muitos dialogos. (#7302)
...
* O Aslan ya no falla en leyer controls enfocaus en a pantalla d'inicio de sesión d'a cuenta de Microsoft en Configuración dimpués de calar-bi una adreza de correu. (#7997)
* O Aslan ya no falla en leyer a pachina quan se recula ta bella pachina anterior en o Microsoft Edge. (#7997)
* O Aslan ya no anunciará incorrectament o caracter final d'un PIN d'inicio de sesión d'o windows 10 seguntes a maquina se desbloqueye. (#7908)
...
* O Aslan agora puet anunciar mas tipos de vinyetas en o Microsoft Word. (#6778)
...
* En o Windows 8 y posterior, o Aslan ya no anunciará "desconoixiu" en ubrir o menú rapedo de vinclos (Windows+X) y en trigar elementos d'ixe menú. (#8137)
...
* O Aslan mirará agora de correchir os problemas de rechistro COM d'o sistema que causan que programas como lo Firefox y l'Internet Explorer se tornen inaccesibles y anuncien "Desconoixiu" por o Aslan. (#2807).
* S'ha treballau en a solución d'un fallo en l'alministrador de fayenas fendo que o Aslan no permita a os usuarios accedir t'os contenius de detalles especificos sobre os procesos. (#8147)
...
* O Aslan ya no anuncia (marcas LTR y  RTL) en Braille u en a verbalización por caracters en accedir t'o reloch en as versions recients d'o Windows. (#5729)
 ...
 * A funcionalidat de dentrada braille d'o Aslan puet emplegar-se tanto con istas como con atras linias BC6 con o firmware 3.0.0 y anteriors.
...
* Os mensaches explorables tals como amostrar o formato actual en pretar Aslan+f dos veces a escape ya no fallan quan o Aslan s'instala en una rota con caracters que no sigan ASCII. (#7474)
* O foco agora se restaura correctament atra vez quan se torna t'o Spotify dende belatra aplicación. (#7689)
* En l'actualización Fall Creators d'o Windows 10 o Aslan ya no falla en esviellar-se quan l'acceso controlau a la carpeta ye enchegau dende o Windows Defender Security Center. (#7696)
* A detección d'as teclas de desplazamiento en as linias Hims Smart Beetle ya no ye fulera. (#6086)
...
* O Aslan ya no se conchela a veces en cada cambio d'o foco si o Firefox u lo Chrome han deixau de responder a causa d'una conchelación u una penchada. (#7818)
* En clients de twitter tals como lo Chicken Nugget o Aslan ya no ignorará los zaguers 20 caracters de tuits con 280 caracters en leyer-los. (#7828)
* O Aslan agora fa servir l'idioma correcto en anunciar os simbolos en que se seleccione texto. (#7687)
...
* En aplicacions tals como lo Mail d'o Windows 10 o Aslan ya no fallará en anunciar os caracters eliminaus quan se prete o recule. (#7456)
* Agora todas as teclas en as linias Hims Braille Sense Polaris funcionan como se'n alguarda. (#7865)
* O Aslan ya no falla en rancar en o Windows 7 ronyando sobre una dll interna d'api quan unatra aplicación haiga instalau una versión particular d'os redistribuibles d'o Visual Studio 2017. (#7975)
...
* hwIo.Hid agora prene un parametro adicional exclusivo que por defecto ye verdadero. Si se mete como falso, se permite a atras aplicacions de comunicar-sen con un dispositivo entre que siga connectau a lo Aslan. (#7859)
...
Por favor tiene en cuenta que ista versión d'o Aslan ya no suporta o Windows XP u lo Windows Vista. O requisito minimo pa o Aslan agora ye o windows 7 con o Service Pack 1.
...
* S'ha adhibiu lo suporte pa nuevos parametros de linia de comandos pa creyar una copia portable d'o Aslan. (#6329)
* Suporte pa o Microsoft Edge executando-se dentro de Windows Defender Application Guard (#7600)
* Si s'executa en un portatil u en una tableta o Aslan agora anunciará quan se connecte/desconnecte un cargador y quan la orientación d'a pantalla cambeye. (#4574, #4612)
...
* O menor Sistema Operativo suportau por o Aslan agora ye o Windows 7 con o Service Pack 1, u lo Windows Server 2008 R2 con o Service Pack 1. (#7546)
...
* As modificacions d'os fichers versionaus (configuración de l'usuario, diccionarios d'a fabla) ya no s'alzan quan o Aslan s'executa dende o lanzador. (#7688)

### Corrección d'Errors

* Os vinclos agora s'indican en braille en aplicacions tals como lo Microsoft Word. (#6780)
* O Aslan ya no se torna notablement mas lento quan siga ubiertas muitas pestanyas en os navegadors web Firefox u Chrome. (#3138)
...
* En l'actualización Creators d'o windows 10 lo Aslan puet accedir de nuevas ta Firefox dimpués d'un renchegue d'o Aslan. (#7269)
* Quan se renchegue o Aslan con o Mozilla Firefox enfocau, o modo de navegación será disponible nuevament, encara que ye posible que haigas de pretar alt+tab y tornar a pretar-lo de nuevas. (#5758)
* Agora ye posible accedir ta conteniu matematico en o Google Chrome en un sistema sin o Mozilla Firefox instalau. (#7308)
* O sistema operativo y atras aplicacions habrían d'estar mas estables dreitament dimpués d'instalar o Aslan antis de no renchegar en contimparanza con as instalacions  de versions anteriors d'o Aslan. (#7563)
* En emplegar una orden de reconoixencia de conteniu (eix.: Aslan+r), agora o Aslan anuncia un mensache d'error en cuenta de no fer cosa si o navegador d'obchectos ye desapareixiu. (#7567)
...
* As linias braille Braillino, Bookworm y Modular (con firmware antigo) de Handy Tech ya no se suportan en quitar-las d'a caixa. Instala o controlador universal de Handy Tech y o complemento d'o Aslan pa emplegar las linias. (#7590)
...
* O Aslan agora se compila con o Visual Studio 2017 y o SDK d'o Windows 10. (#7568)
...
* En a lista de mensaches d'o Microsoft Outlook, o Aslan agora anuncia si bell mensache ye marcau. (#6374)
...
* O Aslan agora puet charrar fendo servir as nuevas voces Windows OneCore (tamién conoixidas como voces mobils) incluidas en o Windows 10. Accedes ta ellas trigando Voces Windows OneCore en o dialogo de sintetizadors d'o Aslan. (#6159)
* Os fichers de configuración de l'usuario d'o Aslan agora se pueden almagazenar en o directorio local de datos d'aplicación de l'usuario. Ixo s'activa a traviés d'una propiedat en o rechistro. Mira-te 'parametros d'o sistema' en a guida de l'usuario pa mas detalles. (#6812)
* En os navegadors web o Aslan agora anuncia as valors d'os marcadors de posición d'os campos (especificament, agora se suporta aria-placeholder). (#7004)
...
* O Aslan agora anuncia automaticament as Notificacions en o Skype de negocio pa l'escritorio  tals como quan belún prencipia una conversa con tu.  (#7281)
* O Aslan agora anuncia automaticament os mensaches de conversa dentrants entre que se siga en una conversa en o Skype pa negocios. (#7286)
* O Aslan agora anuncia automaticament as notificacions en o Microsoft Edge tals como quan prencipia bella descarga.  (#7281)
...
* O Aslan agora puet emplegar a funcionalidat OCR incluida en o Windows 10 pa reconoixer o texto d'imachens u d'aplicacions inaccesibles. (#7361)
 * L'idioma se puet configurar dende o nuevo dialogo OCR d'o Windows 10 en as preferencias d'o Aslan.
 * Pa reconoixer o conteniu d'o navegador d'obchectos actual preta Aslan+r.
...
* En o Firefox y o Chrome o Aslan agora suporta reixetas dinamicas compleixas tals como fuellas de cálculo end que nomás se puet cargar u amostrar una parti d'o conteniu (especificament os atributos aria-rowcount, aria-colcount, aria-rowindex y aria-colindex introducius en ARIA 1.1). (#7410)

### Cambios

* S'ha adhibiu una orden no vinculada (script_restart) pa permitir renchegar o Aslan rapedament. Puetz trobar-la en a categoría Miscelania d'o dialogo de cenyos de dentrada. (#6396)
* A distribución d'o teclau agora se puet configurar dende o dialogo de bienvenida d'o Aslan. (#6863)
...
* Por defecto lo Aslan agora no amuestra que as partis d'a información d'o contexto que haigan cambiadas en una linia braille en que s'enfoque un obchecto. (#217)
...
* O logo d'o Aslan s'ha esviellau. O logo esviellau d'o Aslan ye una mezcla estilizada d'as letras Aslan en blanco sobre un fondo soliu purpura. Ixo asegura que será visible en qualsiquier color de fundo, y ferá servir a color purpura d'o logo de NV Access. (#7446)
...
* Si bell dialogo contién una barra de progreso, o texto d'o dialogo agora s'esviella en braille en que a barra de progreso cambeye. Ixo significa, por eixemplo, que o tiempo restant agora puet leyer-se en o dialogo d'o Aslan "Se son descargando Actualizacions". (#6862)
* O Aslan agora anunciará os cambios de selección pa bells quadros combinaus d'o Windows 10 tals como as opcions d'autoreproducción. (#6337).
...
* En o texto editable, en mover o cursor (p. eix. con as teclas d'o cursor u retroceso), a respuesta charrada d'o Aslan agora ye mas precisa en muitos casos, especialment en o Chrome y as aplicacions de terminal. (#6424)
* Agora se puet leyer o conteniu de leditor de sinyaturas en o Microsoft Outlook 2016. (#7253)
* En as aplicacions de Java Swing o Aslan ya no fa que l'aplicación se penche bella vez en navegar por as tablas. (#6992)
* En l'actualización Windows 10 Creators, o Aslan ya no anunciará las notificacions de birosta qualques veces. (#7128)
* En o menú Inicio d'o Windows 10 en pretar l'intro pa zarrar-lo dimpués d'una busca ya no se produz que o Aslan anuncie mirar texto. (#7370)
...
* En o Firefox o Aslan ya no anuncia falsament "sección" qualques veces en ubrir os detalles pa un tuit en o twitter.com. (#5741)
...
* O Aslan agora s'ha de construir con Visual Studio Community 2015. O Visual Studio Express ya no se suporta. (#7110)
...
* Agora s'inclui o paquete de Python json package en as compilacions binarias d'o Aslan. (#3050)
...
* Agora se puet anunciar a información d'os cantos d'a celda en o Microsoft Excel fendo servir `Aslan+f`. (#3044)
* En os navegadors web o Aslan agora indica quan bell elemento ye marcau como actual (especificament, fendo servir l'atributo aria-current). (#6358)
...
* En l'actualización Creators d'o Windows l'achiquida d'audio d'o Aslan marcha unatra vez como en versions anteriors d'o Windows (p.eix. achiquir en que salga voz y sons, achiquir siempre y no achiquir nunca, son todas disponibles). (#6933)
* O Aslan ya no fallará en navegar u en anunciar qualques controls (UIA) en que no bi ha definiu garra alcorce de teclau. (#6779)
...
* O Aslan ya no anuncia "Web Runtime grouping" en enfocar documentos d'o Microsoft Edge en l'actualización Creators d'o Windows 10. (#6948)
...
* O core.callLater agora mete en coda la tornada de clamada a la coda prencipal d'o Aslan dimpués d'a tardanza dada en cuenta d'eixecutar-la dreitament dispertando a o nuclio. Ixo atura posibles crebaduras debidas a que o nuclio se'n vaiga a adormir accidentalment dimpués de procesar una clamada, en meyo d'una clamada modal tal como lamostrau de bell quadro de mensache. (#6797) 
...
* Agora bi ha una biblioteca de prebas unitarias pa o Aslan. (#7026)
 ...
 * Si yes puyando una petición de pull pa o Aslan en primeras has de correr as prebas y asegurar-te que pasan.
...
* O comando de busca d'o Aslan (Aslan+control+f) agora se suporta en o modo de navegación en o Microsoft Edge. (#6580)
...
* Suporte pa leyer y navegar por libros en a versión 1.19 d'o Kindle pa PC, incluindo acceso t'os vinclos, notas a o piet, graficos, texto resaltau y notas d'usuario. Mira-te a sección d'o Kindle pa PC d'a guida de l'usuario d'o Aslan pa información mas detallada. (#6247, #6638)
* Agora se suporta a navegación por tablas en o modo de navegación en o Microsoft Edge. (#6594)
* En o Microsoft Excel, o comando pa anunciar a ubicación d'o cursor de revisión (escritorio: Aslan+suprimir d'o teclau numerico, portatil: Aslan+suprimir) agora anuncia o nombre d'a fuella de treballo y a ubicación d'a celda. (#6613)
...
* A causa de cambios en l'actualización Creators d'o Windows 10 o modo "achiquir siempre" ya no ye disponible en as opcions d'achiquida d'audio d'o Aslan. Agún ye disponible en versions anteriors d'o windows 10. (#6684)
...
* En mirar d'escribir en o Microsoft Excel estando en una envista protechida, o Aslan agora fa un son en cuenta de dicir os caracters que realment no s'han escritos. (#6570)
* Pretar o escape en o Microsoft Excel ya no cambia incorrectament t'o modo de navegación, difuera que l'usuario haiga cambiau previament t'o modo de navegación explicitament con Aslan+espacio y siga dentrau to modo de foco pretando l'intro en un campo de formulario. (#6569) 
* O Aslan ya no se conchela en fuellas de calculo d'o Microsoft Excel en que se mezcle bella ringlera u columna completa. (#6216)
* L'anunciau de texto retallau u sobreixiu  en celdas d'o Microsoft Excel habría a estar mas preciso. (#6472)
* O Aslan agora anuncia quan bella caixeta de verificación ye de nomás lectura. (#6563)
* O disparador d'o Aslan ya no amostrará un dialogo d'alvertencia quan no se pueda reproducir o son d'inicio debiu a que o dispositivo d'audio no siga disponible. (#6289)
* Os Controls en a cingla d'o Microsoft Excel que no sigan disponibles agora s'anuncian como tals. (#6430)
* O Aslan ya no anunciará "panel" en minimizar finestras. (#6671)
...
* O Aslan ya no esdeviene inemplegable dimpués de salir d'o Windows Media Player entre que o foco ye en bell control eslizant. (#5467)

### Cambios pa os desembolicadors

* Os perfils y os fichers de configuración agora s'esviellan automaticament pa meter-ie os requisitos d'as modificacions d'o esquema. Si bi ha bella error mientras l'actualización s'amuestra una notificación, a configuración se reenchega y o viello fichero de configuración ye disponible en o rechistro d'o Aslan en libel 'Info'. (#6470)

## 2016.4

Lo resinyable d'ista versión inclui a millora d'o refirme pa o Microsoft Edge, modo de navegación en l'aplicación Correo d'o Windows 10 y milloras significativas en os dialogos d'o Aslan.

### Nuevas caracteristicas

* O Aslan agora puet endicar a sangría de linia fendo servir tons. Ixo se puet configurar fendo servir o quadro combinau d'anunciar a sangría de linia en o dialogo de preferencias de formatiau de documentos d'o Aslan. (#5906)
...
* S'ha resuelto qualques problemas de repleno y aliniación en os dialogos d'o Aslan. (#6317, #5548, #6342, #6343, #6349)
...
* En o dialogo de formatiau de documentos d'o Aslan "Anunciar os cambeos dimpués d'o cursor" s'ha renombrau pa que afecte tanto a lo braille como a la voz (en a traducción aragonesa no bi ha diferencia). (#6336)
* S'ha achustau l'apariencia d'o dialogo de bienvenida d'o Aslan. (#6350)
* Os quadros de dialogo d'o Aslan agora tienen os botons d'acceptar y cancelar aliniaus a la dreita d'o dialogo. (#6333)
...
* S'ha apanyau una error rara en salir d'o Aslan entre que o visor d'a voz ye ubierto. (#5050)
...
* Dimpués d'haber-se zarrau a traviés d'a barra de quefers u l'alcorce alt+F4, a caixeta de verificación d'o visualizador d'a voz en o menú d'o Aslan refleixará a visibilidat real d'a finestra. (#6340)
...
* En a lista d'idiomas en o dialogo d'opcions chenerals d'o Aslan, idiomas como l'aragonés agora s'amuestran correctament en o Windows 10. (#6259)
* As teclas emuladas d'o teclau d'o sistema (p. eix. un botón en una linia braille que emula pretar a tecla tabulador) agora se presentan en l'idioma configurau n o Aslan en l'aduya de dentrada y en o dialogo de cenyos de dentrada. Anteriorment siempre se presentaban en anglés. (#6212)
* Agora cambiar l'idioma d'o Aslan (dende o dialogo d'opcions chenerals) no fa efecto dica que se reenchega o Aslan. (#4561)
...
* Agora ye posible asignar cenyos a comandos pa o controlador d'a linia braille Handy Tech en o dialogo de cenyos de dentrada d'o Aslan. (#6461)
...
* En o Microsoft Word agora s'anuncia o titol d'una tabla si se'n ha furniu un. Si bi ha bella descripción se puet accedir ta ella fendo servir o comando d'ubrir a descripción luenga (Aslan+d) en o modo de navegación. (#5943)
* En o Microsoft Word o Aslan agora anuncia a información de posición en mover paragrafos (alt+mayus+flecha abaixo y alt+mayus+flecha alto). (#5945)
* En o Microsoft Word agora s'anuncia o espaciau de linia a traviés d'o comando d'o Aslan d'anunciar o formato quan se cambeye con qualques alcorces de teclau d'o Microsoft word y quan te'n muevas ta texto con diferent espaciau de linia si l'anunciau d'o espaciau de linia ye enchegau en as opcions de formatiau de documentos d'o Aslan. (#2961)
* En l'Internet Explorer agora se reconoix os elementos HTML 5 estructurals. (#6044)
* Agora se puet desenchegar l'anunciau de comentarios (como en o Microsoft Word) a traviés d'a caixeta de verificación d'anunciar os comentarios en o dialogo de formatiau de documentos d'o Aslan. (#5108)
...
* O Aslan agora anuncia as colors fendo servir un conchunto basico de 9 tons de color y 3 matices de buen entender con variacions de brilo y esbufalera. Ixo ye millor que no fer servir nombres de color mas subchectivos y menos replecables. (#6029)
* S'ha modificau o comportamiento existent de Aslan+F9 y dimpués  Aslan+F10 pa seleccionar texto en a primer pretada de F10. Quan se preta F10 dos veces (en sucesión rapeda) se copia o texto en o portafuellas. (#4636)
...
* En o Microsoft Word o Aslan agora informa apropiadament quan se fa servir os comandos propios de navegación de tablas d'o Word (alt+inicio, alt+fin, alt+re.pach y alt+av.pach) y os comandos de selección de tablas (mayus adhibiu a os comandos de navegación). (#5961)
* En os quadros de dialogo d'o Microsoft Word s'ha amillorau a saber-lo a navegación d'obchectos d'o Aslan. (#6036)
...
* En l'aplicacion Mail d'o Windows 10, o Aslan ya no falla en leyer o conteniu d'os mensaches. (#5635) 
...
* En o complemento Web Conference (como l'usau en out-of-sight.net) o Aslan ya no chufla y charra as actualizacions d'a barra de progreso referents a la dentrada d'o microfón. (#5888)
...
* En editar dentradas de diccionario agora s'obtién respuesta pa expresions regulars invalidas. O Aslan ya no se cala si un fichero de diccionario contién una expresión regular invalida. (#4834)
* Si o Aslan no ye capable de comunicar-se con una linia braille (p. eix. porque s'ha desconnectau) se desenchegará automaticament l'uso d'a linia. (#1555)
* S'ha amillorau licherament a realización de tresminaus en a lista d'elementos d'o modo de navegación en bells casos. (#6126)
* En o Microsoft Excel os nombres d'os patrons de fondo anunciaus por o Aslan agora coinciden con os usaus por l'Excel. (#6092)
...
* O Aslan agora detecta correctament os botons secundarios de seguimiento en as linias braille d'as series ALVA BC640/680. (#5206)
* O Aslan puet anunciar unatra vez as notificacions rustidas d'o Windows en compilacions recients d'o Windows 10. (#6096)
* O Aslan ya no deixa de reconoixer ocasionalment as pretadas de teclas en linias braille Baum compatible y HumanWare Brailliant B. (#6035)
* Si ye enchegau l'anunciau d'os numers de linia en as opcions de formatiau de documentos d'o Aslan agora s'amuestra os numers de linia en una linia braille. (#5941)
* Quan o modo de voz yed desactivau, l'anunciau d'obchectos (como pretar Aslan+tabulador pa anunciar o foco) agora amaneix en o visor d'a voz como s'asperaba. (#6049)
...
* O Aslan ya no causa que o Microsoft Word se penche immediatament dimpués de rancar en o Windows XP. (#6033)
...
* En o Microsoft Excel, o Aslan agora anuncia o libel d'un grupo de celdas, asinas como si ye plegau u desplegau. (#5690)
* En pretar dos vegadas o comando d'anunciar o formato de texto (Aslan+f) se presienta la información en o modo de navegación y asinas se puet revisar. (#4908)
* En o Microsoft Excel 2010 y posteriors agora s'anuncia o uembrau de celdas y o degradau de repleno. L'anunciau automatico se controla con a opción d'anunciar as colors en as preferencias de Formatiau de Documentos d'o Aslan. (#3683)
...
* Si ye enchegau l'anunciau d'errors d'ortografía y suportau en o control enfocau, o Aslan reproducirá un son t'alvertir-te d'una error d'ortografía feita en ir escribindo. Ixo puet desenchegar-se fendo servir a nueva opción "Reproducir son pa las errors d'ortografía entre que s'escribe" en o dialogo d'opcions de teclau d'o Aslan. (#2024)
* Agora s'anuncia as errors gramaticals en o Microsoft Word. Ixo puet desenchegar-se fendo servir a nueva opción "Anunciar as errors gramaticals" en o dialogo d'opcions de formatiau de documentos d'o Aslan. (#5877)

### Cambeos

* En o modo de navegación y os campos de texto editable o Aslan agora tracta l'intro d'o teclau numerico igual como a tecla intro prencipal. (#5385)
* O Aslan ha cambiau t'o sintetizador de voz eSpeak NG. (#5651)
* En o Microsoft Excel o Aslan ya no ignora o capitero de columna pa una celda quan bi ha una ringlera en blanco entre a celda y o capitero. (#5396)
...
* En o modo de navegación, quan se mira de fer servir a navegación con una sola letra pa mover-se-ne ta un elemento que no se suporta en o documento, o Aslan anuncia que ixo no se suporta en cuenta de anunciar que no bi ha elemento en ixa adreza. (#5691)
...
* O Aslan ya no anuncia información rara quan se cambie entre finestras en una aplicación Java con qualques finestras tals como l'IntelliJ u l'Android Studio. (#5732)
...
* O Aslan ya no peta de cabo ta quan en enchegar a salida braille. (#4457)
...
* En usar una linia braille muitos mensaches d'o Aslan que antis nomás se charraban agora se meten en braille como cal. (#5557)
...
* En o Google Chrome y os navegadors basaus en o Chrome agora puetz aforzar o Aslan a cambiar t'o modo de navegación en dialogos u aplicacions web. (#5818)
...
* En o Microsoft Word o Aslan ya no se conchela en tablas grans quan l'anunciau de capiters de ringlera y columna ye enchegau. (#5878)
* En o Microsoft word o Aslan ya no anuncia incorrectament texto con unn libel d'esquema (pero no pas un estilo de capitero encorporau) como un capitero. (#5186)
...
* Os components de c++ d'o Aslan agora se compilan con o Microsoft Visual Studio 2015. (#5592)
...
* O Aslan agora puet connectar-se a una linia braille HIMS Smart Beetle a traviés de bluetooth. (#5607)
* O Aslan puet opcionalment baixar o volumen d'atros sons si ye instalau en o Windows 8 u superiors. Ixo se puet configurar fendo servir a opción modo d'achiquida d'audio en o dialogo d'o sintetizador d'o Aslan u pretando Aslan+mayus+d. (#3830, #5575)
...
* O Aslan ya no sale silenciosament en zarrar una consola de comandos d'o Windows con alt+f4 en o Windows 10. (#5343)
...
* En que un botón conmutable s'enfoca o Aslan agora anuncia en que cambie de pretau ta no pretau. (#5441)
...
* O Aslan ya no falla en listar comentarios en a lista d'Elementos pa o Microsoft Excel si un comentario ye  en una celda combinada. (#5704)
* En un caso muit raro, o Aslan ya no falla en leyer o conteniu d'una fuella en o Microsoft Excel con l'anunciau de capiters de celda y columna enchegau (#5705)
...
* O Aslan agora amaneix en o centro d'accesibilidat en o Windows 8 y superiors. (#308)
* En mover-se-ne por as celdas en l'Excel os cambeos de formato agora s'anuncian automaticament si as opcions apropiadas son enchegadas en o dialogo d'opcions de formatiau de documentos d'o Aslan. (#4878)
* S'ha adhibiu una opción t'anunciar o enfasi en o dialogo d'opcions de Formatiau de Documentos d'o Aslan. Enchegada por defecto, ixa opción permit a lo Aslan anunciar automaticament a existencia de texto enfatizau en os documentos. Por agora no ye suportau que t'as etiquetas em y strong en o modo de navegación ta l'Internet Explorer y atros controls MSHTML. (#4920)
* A existencia de texto ficau y borrau s'anuncia agora en o modo de navegación ta l'Internet Explorer y atros controls MSHTML, si a opción d'o Aslan d'anunciar as revisións de l'editor ye activada. (#4920)
* En veyer o seguimiento  de cambeos en a lista d'elementos d'o Aslan t'o Microsoft Word agora s'amuestra más información tal como qué propiedatz d'o formato han cambiau. (#4920)
* Microsoft Excel: Agora ye posible listar y renombrar as fuellas dende a lista d'elementos d'o Aslan (Aslan+f7). (#4630, #4414)
...
* En o Microsoft Excel o Aslan agora anuncia qualsiquier mensache de dentrada establiu por l'autor d'a fuella en as celdas. (#5051)
...
* A opción d'anunciar as Revisions de l'editor en o dialogo d'opcions de formatiau de documentos d'o Aslan agora s'enchega por defecto. (#4920)
* En mover-se-ne por os caracters en o Microsoft Word con a opción d'anunciar as revisions de l'editor d'o Aslan enchegada agora s'anuncia menos información  t'os cambeos de seguimiento, o que fa más eficient a navegación. Ta veyer a información extra fe servir a lista d'elementos. (#4920)
...
* Apanyada l'aparencia visual d'os botons en o dialogo d'alvertencia que s'amuestra quan miras de baixar de versión o Aslan. (#5325)
* En o Windows 8 y superiors o Aslan agora ranca a saber-lo más rapedo quan ye configurau ta rancar dimpués d'encetar a sesión en o Windows. (#308)
 * Si activés ixo fendo servir una versión anterior d'o Aslan amenistarás desactivar-lo y activar-lo de nuevas ta que o cambeo tienga efecto. Sigue o siguient procedimiento:
  1. Ubre o dialogo d'opcions chenerals.
  1. Desmarca la caixeta encetar o Aslan automaticament dimpués d'autentificar-se en Windows.
  1. Preta o botón d'acceptar.
  1. Ubre o dialogo d'opcions chenerals unatra vegada.
  1. Marca la caixeta encetar o Aslan automaticament dimpués d'autentificar-se en Windows.
  1. Preta o botón d'acceptar.
* Milloras de rendimiento ta l'UI Automation incluindo explorador de fichers y visor de fainas. (#5293)
* O Aslan agora cambia correctament t'o modo de foco en que se tabula ta controls read-only ARIA grid en o modo de navegación t'o Mozilla Firefox y atros controls basaus en Gecko. (#5118)
* O Aslan agora anuncia correctament "no bi ha anterior" en cuenta de "no bi ha siguient" quan no bi ha más obchectos en  fer un truquet ent'a cucha en una pantalla tactil.
* Apanyaus problemas en escribir qualques parolas en o campo de tresmín en o dialogo de cenyos de dentrada. (#5426)
* O Aslan ya no se conchela en bells casos en reconnectar-se-ne a una linia HumanWare Brailliant BI/B series a traviés de l'USB. (#5406)
...
* O Aslan ya no habría de conchelar-se ocasionalment en desplegar o menú d'inicio en o Windows 10. (#5417)
...
* O Aslan agora anuncia correctament o foco en desplegar un menú contextual en bellas aplicacions como lo Jart. (#5302)
...
* En o modo de navegación agora puetz enchegar y desenchegar a navegación d'una sola letra  pretando Aslan+mayus+espacio. Quan siga desenchegada as teclas d'una letra se pasan ta l'aplicación que ye util ta bellas aplicacions web tals como lo Gmail, o Twitter y o Facebook. (#3203)
...
* Quan mires d'instalar una versión más viella d'o Aslan que l'actualment  instalada, agora te s'alvertirá que ixo no ye recommendau y que o Aslan habrá de desinstalar-se de raso antis de no i proceder. (#5037)
...
* En o Firefox o Aslan ya no anuncia inapropiadament o conteniu d'o panel de pestanyas ARIA en que o foco se'n mueve t'adintro d'ell. (#4638)
...
* Quan una aplicación ye respondendo lentament y cambias difuera d'ixa aplicación o Aslan responde muito millor en atras aplicacions en a mayoría d'os casos. (#3831)
...
* En a pantalla de bloqueyo d'o Windows 10 ya no ye posible leyer o portafuellas, accedir t'as aplicacions en marcha con o cursor de revisión, cambiar a configuración d'o Aslan, etc. (#5269)
...
* En o Microsoft Excel o Aslan agora anuncia quan una celda tien conteniu desbordant u tallau. (#3040)
* En o Microsoft Excel agora puetz fer servir a lista d'elementos (Aslan+f7) ta permitir un listau de graficos, comentarios y formulas. (#1987)
* Suporte ta leyer graficos en o Microsoft Excel. Ta fer servir ixo Selecciona o grafico fendo servir a lista d'elementos (Aslan+f7) y allora fe servir as teclas de flecha ta mover-te-ne entre os puntos de datos. (#1987)
* Fendo servir o MathPlayer 4 de Design Science, o Aslan agora puet leyer y navegar interactivament por conteniu matematico en os navegadors web y en o Microsoft Word y PowerPoint. Mira-te a sección "Leyer conteniu mathematico" en a Guida de l'usuario  ta detalles. (#4673)
* Agora ye posible asignar cenyos de dentrada (comandos de teclau, cenyos tactils, etc.) Ta totz os dialogos de preferencias d'o Aslan y as opcions de formatiau de documentos fendo servir o dialogo de Cenyos de Dentrada. (#4898)

### Cambeos

* En o dialogo de formatiau de documentos d'o Aslan os alcorces de teclau t'anunciar as listas, anunciar os vinclos, anunciar os numeros de Línea y anunciar o Nombre d'a fuent s'ha cambiau. (#4650)
* En o dialogo Opcions d'o churi d'o Aslan s'ha adhibiu alcorces de teclau ta reproducir as coordenadas d'audio en que se mueve o churi y o brilo controla o volumen d'as coordenadas d'audio. (#4916)
...
* O Aslan agora anuncia automaticament o nuevo texto en o mintty. (#4588)
...
* A  navegación rapida (pretar la h ta mover-se-ne por os capiters etc.) y a Lista d'Elementos (Aslan+f7) agora son disponibles en os documentos d'o Microsoft Word activando lo modo de navegación con Aslan+espacio. (#2975)
* O leyer mensaches HTML en o Microsoft Outlook 2007 y posteriors s'ha amillorau muito en que s'activa automaticament o modo de navegación ta ixos mensaches. Si o modo de navegación no s'habilita en qualques situacions raras puetz aforzar-lo con Aslan+espacio. (#2975) 
 ...
 * Sin d'embargo, t'as tablas que as ringleras sigan estadas fusionadas ixo no marchará automaticament. En ista situgación encara puetz fixar os capiters de columna manualment en o Aslan con Aslan+mayus+c.
* En o Skype t'o escritorio agora s'anuncian as notificacions. (#4741)
* En o Skype t'o escritorio agora puetz  anunciar y revisar os mensaches recients  fendo servir dende Aslan+control+1 dica Aslan+control+0; p.eix. Aslan+control+1 t'o mensache más recient  y Aslan+control+0 t'o deceno más recient. (#3210)
* En una conversa en o Skype t'o escritorio lo Aslan agora anuncia quan un contacto ye escribindo. (#3506)
* Agora se puet instalar o Aslan silenciosament a traviés d'a linia de comandos sin que ixo ranque a copia instalada dimpués d'a instalación. Ta fer ixo fe servir a opción --install-silent. (#4206)
* Suporte t'as linias braille Papenmeier BRAILLEX Live 20, BRAILLEX Live y BRAILLEX Live Plus. (#4614)

### Cambeos

* En o dialogo d'opcions de formatiau de documentos d'o Aslan la opción t'anunciar as errors d'ortografía agora tien un alcorce de teclau (alt+r). (#793)
* O Aslan agora ferá servir l'idioma d'a voz d'o sintetizador en procesar caracters y simbolos (incluindo os nombres d'os simbolos y a puntuación) sin mirar que siga enchegau o cambeo automatico d'idioma. Ta desenchegar ista caracteristica ta que o Aslan torne a fer servir l'idioma d'interficie d'ell desmarca a nueva opción clamada Confidar en l'idioma d'a voz en procesar caracters y simbolos en as opcions d'a voz. (#4210)
* S'ha eliminau o suporte t'o sintetizador Newfon . O Newfon agora ye disponible como un complemento d'o Aslan. (#3184)
* Agora se requier o Skype t'o escritorio 7 u superior ta fer-se servir con o Aslan; as versions anteriors no son suportadas. (#4218)
* Descargar actualizacions d'o Aslan agora ye más seguro. (Specificament a información de l'actualización se recupera a traviés d'o https y l'hash d'o fichero se verifica dimpués de descargau.) (#4716)
...
* En editar o conteniu d'un quadro de texto en o Microsoft PowerPoint 2003 o Aslan anunciará correctament o conteniu de cada linia. Anteriorment en cada paragrafo as linias se'n iban incrementando un. (#4619)
* Totz os dialogos d'o Aslan son agora centraus en a pantalla amillorando a presentación visual y a usabilidat. (#3148)
...
* En eliminar un complemento lo directorio d'ell agora se borra correctament dimpués de reenchegar o Aslan. Anteriorment hebas de reenchegar-lo dos vegadas. (#3461)
...
* En o Skype t'o escritorio lo Aslan ya no habría de leyer ocasionalment 	 un gran fluxo de mensaches (talment mesmo una conversación entera). (#4644)
* Apanyau un problema que o comando de l'anunciau de calendata y hora d'o Aslan no feba honra a las opcions rechionals especificadas por l'usuario en bells casos. (#2987)
...
* O Aslan ya no habría de conchelar-se dimpués d'uns pocos segundos en mover o foco difuera d'una aplicación d'a tienda de Windows que ha plegau a suspender-se. (#4572)
...
* En l'Internet Explorer y atros controls MSHTML o Aslan ya no ignora l'enfocau  d'elementos a causa de l'atributo aria-activedescendant. (#4667)

### Cambeos ta desembolicadors

* Esviellau lo wxPython ta 3.0.2.0. (#3763)
* Esviellau lo Python to 2.7.9. (#4715)
* O Aslan ya no se creba en reenchegar-se dimpués de borrar u esviellar un complemento que importa speechDictHandler en o modulo installTasks  d'ell. (#4496)
...
* Agora ye posible reenchegar o Aslan  u reenchegar-lo con os complementos desenchegaus dende o dialogo de salida d'o Aslan. (#4057)
 * O Aslan tamién puet enchegar-se  con os complementos desenchegaus fendo servir a opción de linia de comandos --disable-addons.
...
* En fer clic en l'icono d'o Aslan en l'aria de Notificacions con o botón cucho d'o churi agora s'ubre o menú d'o Aslan en cuenta de no'n fer cosa. (#4459)
...
* O Aslan ya  no se creba en prebar a  fer servir una linia braille d'Handy Tech en qualques casos. (#3709)
* En o Windows Vista, ya no s'amuestra un dialogo falso "No s'ha trobau punto de dentrada" en qualques casos tals como quan se ranca o Aslan dende l'icono d'o escritorio u atraviés de l'alcorce de teclau. (#4235)
...
* Os sons reproducius en que o Aslan s'enchega y desenchega se pueden desactivar a traviés d'una nueva opción en o dialogo d'as opcions chenerals. (#834)
...
* Microsoft word: Si una imachen en linia no tien establiu garra texto alternativo lo Aslan anunciará en cuenta o titol d'a imachen si l'autor en proporcionó un. (#4193)
* Microsoft Word: O Aslan agora puet anunciar o sangrau d'o paragrafo con o comando d'anuncio de formato (Aslan+f). En puet estar anunciau automaticament quan a nueva opción anunciar a sangría de  paragrafos   ye activada en as opcions d'o formatiau de documentos. (#4165).
...
* Microsoft word: Pretar Aslan+alt+c anunciará  o texto d'un comentario si o cursor en i ye adintro. (#3528)
 ...
 * Microsoft Excel: Si a celda seleccionada contién comentarios agora en podrán estar anunciaus pretando Aslan+alt+c. (#2920)
* Microsoft Excel: Se proporciona un dialogo especifico d'o Aslan pa editar os comentarios en a celda seleccionada actualment en pretar o comando d'Excel mayus+f2 ta dentrar en o modo d'edición de comentarios. (#2920)
 ...
 * Microsoft Excel: Agora se pueden anunciar as aliniacions vertical y horizontal  t'as celdas con o comando d'anunciau de formato (Aslan+f). En puet estar anunciau automaticament si a opción d'anunciar l'aliniación ye activada en as opcions de formatiau de documentos. (#4212)
 * Microsoft Excel: Agora se puet anunciar o estilo d'una celda con o comando d'anunciau de formato (Aslan+f). En puet estar anunciau automaticament si a opción danunciar o estilo ye activada en as opcions de formatiau de documentos. (#4213)
 ...
 * T'anunciar ista información en qualsiquier inte sin mover una forma, preta o comando d'anunciar a localización (Aslan+suprimir).
 * En seleccionar una forma, si ye cubierta por unatra forma, o Aslan anunciará que'n ye amagada.
 * O comando d'anunciar a localización (Aslan+suprimir) ye mas especifico a lo contexto en qualques situacions. (#4219)
...
* O Aslan ya no falla en executar-se en os zaguers sistemas operativos Windows, si l'idioma de Windows de l'usuario s'estableix en Serbio (Latino). (#4203) 
...
* En o Google Chrome s'anuncia unatra vegada o titol d'o documento en cambiar de pestanyas. En o Aslan 2014.2 isto no ocurriba en qualques casos. (#4222)
...
* O Aslan agora ha unificau o suporte t'a documentación d'os complementos. Vei a sección d'a documentación de complementos d'a guida de l'usuario ta mas detalles. (#2694)
...
* Agora ye posible cambiar l'alcorce de teclau que se fa servir ta enchegar o Aslan t'as localizacions que l'alcorce de teclau normal fa problemas. (#2209)
 * Isto se fa a traviés de gettext.
 * Para cuenta que o texto d'a opción Crear acceso dreito d'o escritorio en o quadro de dialogo Instalar o Aslan asinas como a tecla d'acceso dreito en a Guida de l'usuario, tamién s'han d'esviellar.
...
* Os quadros de mensache y belatros dialogos producius por o Aslan causan atra vegada a cancelación d'a fabla anterior antis d'anunciar o dialogo. 
...
* Agora torna a estar posible escribir texto vietnamita fendo servir o software Unikey. Ta fer ixo, desmarca a nueva caixeta de verificación Teclas de maneyo d'atras aplicacions, en o dialogo d'opcions de teclau d'o Aslan. (#4043) 
...
* O Aslan ya no cambea incorrectament dende o modo foco t'o modo navegación en que se triga un elemento de menú que siga botón d'opción u caixeta de verificación. (#4092)
...
* O Aslan se recupera en mas casos en que se cambia difuera d'as aplicacions que han deixau de responder. (#3825)
...
* En o Microsoft Word y l'Excel o Aslan agora puet leyer o simbolo trigau en que s'esleigan simbolos en o dialogo Ficar simbolo. (#3538)
...
* Quan se siga en aplicacions ARIA u dialogos en a web, agora ye posible aforzar a lo Aslan ta que cambee t'o modo navegación con Aslan+espacio seguindo a navegación d'estilos de documento de l'aplicación u d'o dialogo. (3#2023)
* En l'Outlook Express / Windows Mail / Windows Live Mail, o Aslan agora anuncia si un mensache tien un adchunto u ye marcau. (#1594)
...
* O Aslan agora se basa en a versión 11 d'o Microsoft VC runtime, o que significa que ya no puet executar-se en sistemas operativos anteriors a lo Windows XP Service Pack 2 u lo Windows Server 2003 Service Pack 1.
...
* En que te muevas u selecciones  celdas en o Microsoft Excel, Aslan ya no habría d'anunciar  inadequadament l'antiga celda en cuenta d'a nueva celda quan o Microsoft Excel siga lento en mover a selección. (#3558)
* O Aslan manella adequadament a obridura d'una lista desplegable en una celda en o Microsoft Excel por meyo d'o menú contextual. (#3586)
...
* En l'Instantbird, o Aslan ya no anuncia información inutil cada vegada que te muevas ta un contacto d'a lista de contactos. (#2667)
...
* O Aslan ya no anuncia todas as celdas en o Microsoft Excel como subrayadas en a información de formato d'ellas. (#3669)
...
* A lo navegar por un documento dimpués d'una cancelación de Verbalizar-lo tot ya no fa que o Aslan anuncie a vegadas incorrectament que s'ha abandonau un campo (tal como una tabla) mas abaixo en o documento en que Verbalizar-lo tot nunca no estió charrando en realidat (#3688)
* Quan se faigan servir ordens rapidas d'o modo navegación mientras se siga en verbalizar-lo tot con a lectura superficial activada, o Aslan anuncia con mas precisión o nuevo campo (por eixemplo, agora diz que un capitero ye un capitero, y no pas nomás o texto). (#3689)
...
* Os nombres d'os cenyos tactils listaus en o dialogo Cenyos de dentrada d'o Aslan agora son mas amigables y son traducius. (#3624)
* O Aslan ya no fa que bells programas se bloquen quan se mueva o puntero d'o churi sobre os controls d'edición enriquius d'ell (TRichEdit). Programas incluindo Jarte 5.1 y BRfácil. (#3693, #3603, #3581)
...
* En o Microsoft Word, o Aslan ya no repite inapropiadament a información de ringlera y columna de tabla  ta una celda en una linia braille quantas vegadas. (#3702)
...
* En que  se dispara un perfil de configuración ta una aplicación y se sale d'ixa aplicación, Aslan ya no falla a vegadas en desactivar o perfil. (#3732)
* En que s'escribe con a dentrada Asiatica en un control adentro d'o propio Aslan (eix.: en o dialogo Mirar en o modo navegación), "Aslan" ya no s'anuncia incorrectament en cuenta d'o candidato. (#3726)
 ...
 * S'Apanya  un penche en o Aslan visto en o Windows 8 en enfocar bells controls RichEdit que contienen grans cantidatz de texto(por eixemplo en o Visualizador de rechistro d'o Aslan, windbg). (#3867)
* En os sistemas con una configuración de pantalla d'alta DPI (que se produz de traza predeterminada ta muitas pantallas modernas), o Aslan ya no leva o churi t'o puesto entivocau en qualques aplicacions. (#3758, #3703)
* S'ha correchiu un problema ocasional en navegar por a web an o Aslan deixaba de funcionar correctament dica que se reenchegaba, tot y que no se blocaba u se conchelaba. (# 3804)
* Agora Se puet emplegar una pantalla bralle Papenmeier mesmo si nunca s'hese connectau a traviés d'USB. (#3712)
* O Aslan ya no se conchela en que se trigan linias braille d'os modelos antigos de Papenmeier BRAILLEX sin una pantalla connectada.

### Cambeos ta desembolicadors

* Os AppModules agora contienen as propiedatz productName y productVersion. Ista información tamién s'incluye agora en a información d'o desembolicador (Aslan+f1). (#1625)
...
* Agora bi ha un dialogo Cenyos de Dentrada ta permitir a facil personalización d'os cenyos de dentrada(tals como teclas en o teclau) ta ordens de Aslan. (#1532)
...
* Aslan agora anunciará o estau fixau ta controls fixos tals como  pestanyas en Mozilla Firefox. (#3372)
* Aslan agora puet anunciar a información de revisión en Microsoft Word quan o Control de Cambeos  siga habilitau. para cuenta que Anunciar as revisions d'o editor debe estar habilitau en o dialogo de formatiau de documentos de Aslan (desactivau predeterminadament) tamién ta que sigan anunciaus. (#1670)
...
* Internet Explorer ya no habría a penchar-se u tornar-se inusable  quan se zarra Aslan. (#3397)
* O movimiento fisico y atros eventos en qualques ordinadors modernos ya  no se tracta como pulsacions de teclas inadequadas. Anteriorment, isto silenciaba a voz y qualques vegadas feba funcionar ordens de Aslan. (#3468)
* O Aslan agora se comporta como s'asperaba enPoedit 1.5.7. Os usuarios que en faigan servir versions anteriors amenesterán actualizar-ne. (#3485)
* O Aslan agora puet leyer documentos protechius en Microsoft Word 2010,  no causando ya que se'n bloque. (#1686)
* Si se da un parametro de linia de comando desconoixiu en executar o paquet de distribución de Aslan, ya no se provoca un bucle sin fin de dialogos de mensaches d'error. (#3463).
-O Aslan ya no falla en anunciar o texto alternativo d'os graficos y obchectos en Microsoft Word si o texto alternativo contién cometas u atros caracters no estandar. (#3579)
...
* Aslan agora puet leyer correctament os documentos XHTML en Microsoft Internet Explorer y belatros controls 	MSHTML. (#3542)
* Dialogo d'Opcions de teclau: si no s'ha seleccionau garra tecla ta fer-la servir como a tecla Aslan, se presienta una error a l'usuario en  que se zarra o dialogo. A lo menos cal seleccionar una d'as teclas ta l'emplego apropiau de Aslan. (#2871)
* En o Microsoft Excel, agora o Aslan anuncia as celdas mezcladas de traza diferent que as celdas multiples seleccionadas. (#3567)
...
* O Aslan ya no falla  en que s'esleye a revisión de pantalla quan o navegador d'obchectos  no i tien un puesto real. En iste caso o cursor de revisión agora se  mete en l'alto d'a pantalla. (#3454)
...
* Agora puetz deshabilitar l'amostrau de mensaches de Aslan en una linia braille configurando a durada d'o mensache a 0 en o dialogo d'Opcions de Braille. (2482)
* En l'administrador de complementos, agora bi ha un botón Obtener Complementos ta ubrir o puesto web de Complementos de Aslan an puetz examinar y descargar os complementos disponibles. (3209)
* En o dialogo de bienvenida de Aslan que siempre amaneix a primera vegada que  executas Aslan, agora puetz especificar si Aslan s'encieta automaticament dimpués d'autentificar-te en Windows. (2234)
...
* Dimpués de cambiar t'o modo revisión de pantalla, Aslan remanirá en iste modo dica que tornes explicitament t'os modos de revisión de documentos u d'obchectos.
 * Quan se siga en o modo de revisión de documentos u d'obchectos, Aslan podrá cambiar automaticament entre istos dos modos dependendo de si yes movendo-te por un documento d'o modo navegación u no pas.
...
* Aslan ya no falla en rancar si a hora d'o sistema ye anterior a la zaguera revisión d'una actualización. (3260)
...
* A lo cambiar l'idioma de dentrada de Windows 8, Aslan agora charra en l'idioma correcto en cuenta d'en l'anterior.
* Aslan agora anuncia os cambeos en o modo de conversión de IME en Windows 8.
* Aslan ya no anuncia a vasuera en o escritorio quan os metodos de dentrada chaponeses Google u IME ATOK son en uso. ;(# 3234)
* En Windows 7 y superiors, Aslan ya no anuncia indebidament a reconoixencia de voz u a dentrada tactil como un cambeo d'idioma d'o teclau.
 * Aslan ya no anuncia un caracter especial (0x7f) en pretar control+retroceso en qualques editors mientras Charrar os Caracters en Escribir siga enchegau. (3315)
* espeak ya no fa cambeos inadequaus en o ton, volumen, etc. quan Aslan leiga texto que contienga bells caracters de control u XML. (3334) (regresión de 437)
...
* As ordens de navegación de tablas de Aslan (control+alt+flechas) funcionan millor en qualques tablas de Microsoft Word quan una celda abarca quantas ringleras.
...
* Aslan ya no se pencha en bells dialogos quan se siga utilizando o IME en Office 2010 con o chaponés u lo chino. (3064)
...
* Aslan ya no causa que l'Adobe Reader se bloque u se penche ta bells documentos PDF mal formaus que contiengan ringleras difuera d'as tablas. (3399)
* Aslan agora detecta correctament a siguient diapositiva con o foco quan s'elimine una en  la  vista de miniaturas en Microsoft PowerPoint. (3415)
...
Ista versión apanya lo problema que feba crebar Aslan  en rancar quan yera configurau ta fer servir l'idioma irlandés.

### Corrección d'errors

* Se producen caracters correctos en escribir en a interficie d'usuario propia de Aslan entre que s'usa un metodo de dentrada coreano u chaponés, mientras siga o metodo por defecto. (# 2909)
...
* Aslan ya no se creba en rancar quan s'ha configurau l'idioma irlandés.
...
A nueva distribución emplega as teclas de cursor en combinación con a tecla Aslan y atras modificaderas ta ordens de revisión.

Por favor tien en cuenta os siguients  cambeos ta ordens comunament emplegadas:

| Nombre |Tecla|
|---|---|
|Leyer-lo tot |Aslan+a|
|Leyer a linia actual |Aslan+l|
|Leyer a selección de texto actual |Aslan+shift+s|
|Anunciar a barra d'estau |Aslan+shift+fin|
...
* En modo Navegación ta MSHTML (eix.: Internet Explorer) y Gecko (eix.: Firefox), agora s'anuncia a existencia de descripcions largas. Tamién ye posible ubrir a descripción larga en una finestra nueva pretando Aslan+d. (#809)
...
* Nuevas opcions de teclau que permiten a esleción de si Aslan habría d'interrumpir o discurso de caracters escritos y/u la tecla Intro. (# 698)
...
* Si Aslan se reenchega sin eSpeak u no bi ha voz a causa d'a falta d'un sintetizador de voz configurau quan Aslan ranca, a opción configurada ya no s'estableix automaticament en o sintetizador de reserva. Isto significa que agora, se prebará de nuevo o sintetizador orichinal a proxima vegada que s'enciete Aslan. (# 2589)2589)
* Si Aslan se configura sin braille porque falla a linia Braille configurada quan Aslan ranca, a linea configurada ya no se configura automaticament sin braille. Isto significa que agora, a visualización orichinal s'intentará de nuevo a proxima vegada que s'enciete Aslan. (# 2264)
...
* Quan se desactiva a detección automatica d'actualizacions, Aslan ya no ha d'estar reiniciau ta que totz os cambeos tiengan efecto.
* Aslan ya no falla en encetar-se si un complemento no se puet eliminar a causa que o suyo directorio se siga utilizando actualment por unatra aplicación. (#2860)
* As etiquetas de pestanyas en o dialogo de preferencias de DropBox agora pueden veyer-se con a Revisión Plana. 
* Si l'idioma de dentrada se cambea a belatro que o predeterminau, Aslan agora detecta as teclas correctament ta ordens y o modo d'aduya de dentrada.
...
* Quan se siga en revisión,  eliminando caracters con retroceso u suprimir en controls d'edición de Scintilla, Aslan anuncia correctament os caracters multibyte. (#2855)
* Aslan ya no fallará en instalar quan a rota d'o perfil d'usuario contienga bells caracters multibyte. (#2729)
...
* Aslan ya no falla en copiar a configuración de l'usuario ta usar l'inicio de sesión y atras pantallas seguras quan a rota d'o perfil de l'usuario contién caracters que no son ASCII. (# 3092)	
* Aslan ya no se conchela en emplegar a dentrada de caracters asiaticos en qualques aplicacions .NET. (# 3005)
...
* Agora se puet usar comHelper.getActiveObject ta obtener un obchecto COM activo d'un proceso normal quan Aslan s'executa con o privilechio UIAccess. (# 2483)
...
* Aslan agora puet suportar dentrada de caracters asiaticos utilizando IME y metodos de servicio de dentrada de texto en todas as aplicacions, incluindo:
...
* Quan a función Windows Sticky Keys ye activada, a tecla modificadera de Aslan agora se comportará como as atras teclas modificaderas. Isto te permite utilizar a tecla modificadera de Aslan sin a necesidat de mantener pretada mientras pretas atras teclas. (#230)
* Agora se suporta l'anunciau automatico de capiters de columna y de ringlera en Microsoft Excel. Preta Aslan+shift+c ta configurar a ringlera que contienga capiters de columna y Aslan+shift+r t'a columna que contienga capiters de ringlera. Preta o script dos vegadas en succesión rapida ta limpiar a opción. (#1519)
* Suporte t'as linias braille HIMS Braille Sense, Braille EDGE y SyncBraille. (#1266, #1267)
* Quan as Notificacions de Windows 8 amaneixcan, Aslan las anunciará si l'anunciau de globos d'aduya ye habilitau. (#2143)
 ...
 * Muitos cenyos ta levar a cabo a navegación por obchectos, revisión de texto, y atras ordens de Aslan.
...
* Aslan agora puet leyer sucherencias d'autocompletau quan s'introduzcan adrezas de correu en Microsoft Outlook 2007. (#689)
...
* Agora ye posible reiniciar a configuración de Aslan a las valors predeterminadas de fabrica pretando Aslan+control+r tres vegadas rapidament u trigando Reiniciar a las Valors Predeterminadas de Fabrica dende o menú Aslan (#2086).
...
* Si Aslan s'instala en o sistema, a obridura directa d'un paquet de complemento de Aslan (ye decir dende l'explorador de Windows u dimpués de descargar-lo d'un navegador web) lo instalará en Aslan. (#2306)
...
* En o dialogo Preferencias d'o Cursor de Revisión de Aslan, a opción Siguir foco d'o teclau ha estau renombrada a Siguir a o foco d'o sistema ta consistencia con a terminolochía utilizada en atras partes en Aslan.
...
* Quan s'actualiza una copia de Aslan instalada anteriorment, a tecla d'alcorce d'o escritorio ya no se forza a control+alt+n si estió cambiada manualment a belatra diferent por l'usuario. (#2572)
* A lista de complementos en l'Administrador de Complementos agora amuestra o nombre d'o paquet antis d'o suyo estau. (#2548)
* A lo instalar a mesma u unatra versión d'un complemento instalau actualment, Aslan te preguntará si deseyas actualizar o complemento antigo primer, en cuenta d'amostrar una error y abortar a instalación. (#2501)
...
* O documento Referencia Rapida d'Ordens de teclau de Aslan ha estau renombrau a Referencia Rapida d'Ordens, asinas agora incluye tanto ordens tactils como ordens de teclau.
* A Lista d'elementos en Modo Navegación agora recordará o zaguer tipo d'elemento amostrau (eix.: vinclos, capiters u zonas) cada vegada que s'amuestre o dialogo dentro d'a mesma sesión de Aslan. (#365)
...
* En Windows Vista y posterior, Aslan ya no tracta incorrectament a tecla Windows como ye en mantener-la pretada quan se desbloqueya Windows dimpués de bloqueyar-la pretando Windows+l. (#1856)
...
* O paquet de distribución de Aslan agora verifica a suya integridat antis d'executar-se. (#2475)
* Os fichers descargaus temporalment agora s'eliminan si se descarga un fichero d'actualización de Aslan. (#2477)
* Aslan ya no se penchará quan se siga executando como un administrador mientras se copia a configuración de l'usuario a la configuración d'o sistema (ta utilizar-la en l'autentificación de Windows y en atras pantallas seguras). (#2485)
...
* Milloras en o suporte t'o corrector d'ortografía de Microsoft Word, incluindo a lectura mas precisa d'a error ortografica actual, y a capacidat de suportar o corrector d'ortografía quan s'execute una copia instalada de Aslan en Windows Vista u superior.
...
* A configuración ta l'anunciau de barras de progreso agora se reconoixe ta barras de progreso indeterminadas amostradas por Aslan quan se ye instalando, creyando una copia portable, etc. (#2574)
* As ordens de Aslan ya no pueden executar-se dende una linia braille entre que una pantalla segura de Windows (tal como a pantalla de desbloqueyo) siga activa. (#2449)
* En modo navegación, o braille agora s'actualiza si o texto que ye estando desplazau cambea. (#2074)
* Quan se ye en pantallas seguras de  Windows tals como a pantalla de desbloqueo, os mensaches d'as aplicacions que son charrando u amostrando braille dreitament a traviés de Aslan agora s'ignoran.
...
* Aslan ya no localiza u anuncia incorrectament bells campos d'edición en documentos MSHTML (eix.: Internet Explorer), especificament an s'haiga utilizau un paper ARIA explicito por l'autor d'a pachina web. (#2435)
...
* En Microsoft Word, Aslan ya no te deixa enganchau en un paragrafo con formato de lista quan tractas de navegar por una vinyeta u numero con flecha cucha u control + flecha cucha. (#2402)
...
* En navegadors web, Aslan agora amaga conteniu que se marcó como amagau ta lectors de pantalla (especificament, utilizando l'atributo aria-hidden). (#2117)
...
* Entre leyer tot, Aslan ya no tornará incorrectament a a l'idioma predeterminau si una linia no finaliza una frase. (#2630)
...
* En pretar Aslan+flecha alto mientras se siga en un quadro combinau en Internet Explorer y atros documentos MSHTML ya no se leyerán incorrectament totz os elementos. Por lo contrario, solament se leyerá l'elemento activo. (#2337)
...
* Aslan ya no fallará en rancar quan a rota de perfils de l'usuario contienga bells caracters multibyte. (#2729)
...
* Aslan puet funcionar de nuevo en a lista de mensaches de Yahoo! Mail quan s'utiliza dende Internet Explorer. (#2780)

### Cambeos ta Desembolicadors

* L'anterior fichero log agora se copia en aslan-old.log en a inicialización de Aslan. Por tanto, si Aslan se bloca u se reinicia, o rechistro d'información  d'ixa sesión encara ye accesible t'a suya inspección. (#916)
* A obtención d'a propiedat de paper en chooseAslanObjectOverlayClasses ya no causa que o paper siga incorrecto y por tanto no s'anuncie en foco ta bells obchectos tals como consolas d'ordens de Windows y controls de Scintilla. (#2569)
* Os menús de Aslan Preferencias, Ferramientas y Aduya agora son accesibles como atributos en gui.mainFrame.sysTrayIcon clamando-se preferencesMenu, toolsMenu y helpMenu, respectivament. Isto permite a os plugins adhibir elementos muito mas facilment a istos menús.
 ...
 * Isto se suporta tanto ta Aslan mesmo como t'os complementos.
...
* Agora ye posible accedir a os modulos compilaus de Aslan an haigan estau sobrescritos por modulos de tercers. Mira o modulo aslanBuiltin ta detalles.
...
Lo resenyable d'ista versión incluye una caracteristica que integra l'instalador y a creyación d'o portable, un auto actualizador, administración facil d'os nuevos complementos de Aslan, anunciau de graficos en Microsoft Word, suporte t'o estilo d'aplicacions de Windows 8 Metro, y quantas correccions de fallos importants. 

### Nuevas Caracteristicas

* Aslan agora puet buscar automaticament, descargar y instalar actualizacions. (#73)
* S'ha feito mas sencilla a extensión d'a funcionalidat de Aslan con l'adición d'un Administrador de Complementos (que se troba baixo Ferramientas en o menú Aslan) permitindo-te instalar y desinstalar paquetz de complementos de Aslan (fichers .aslan-addon) que contiengan plugins y controladors. Tiene en cuenta que l'Administrador de Complementos no habría d'amostrar os antigos plugins personals y controladors copiaus manualment en o tuyo directorio de configuración. (#213)
* Agora funcionan Muitas mas caracteristicas comunas de Aslan en o estilo d'aplicacions de Windows 8 Metro quan s'utiliza una versión instalada de Aslan, incluindo a verbalización de caracters en escribir y modo navegación ta documentos web (s'incluye suporte t'a versión metro d'Internet Explorer 10). Las copias portables de Aslan no pueden accedir a o estilo d'aplicacions metro. (#1801) 
...
* Aslan agora se distribuye en un paquet. En cuenta d'una versión portable y una instalable, agora solament bi ha un fichero que quan s'execute, encetará una copia temporal de Aslan, y te permitirá instalar, u chenerar una distribución portable. (#1715)
* Aslan agora siempre s'instala en Program Files en totz os sistemas. A lo actualizar una instalación tamién le la moverá automaticament si anteriorment no s'instaló astí.
...
* En Internet Explorer 9 Aslan ya no leye conteniu indeseyau quan o foco se mueve dentro de bellas zonas u elementos enfocables (especificament un elemento div que ye enfocable u que tien un paper de zona ARIA). 
* Os iconos t'os alcorces ta Aslan en o Escritorio y en o Menú d'Inicio agora s'amuestran correctament en edicions de 64 bit de Windows. (#354)

### Cambeos ta Desembolicadors

* A causa d'a substitución de l'instalador anterior NSIS ta Aslan por un compilau en Python, ya no ye necesario t'os traductors mantener un fichero langstrings.txt ta l'instalador. Todas as cadenas de localización agora s'administran con fichers po de gettext.
...
* Aslan puet anunciar o numero d'os tabuladors u espacios a l'inicio en a linia actual en l'orden en que s'introducioron. Isto puet activar-se seleccionando anunciar sangrau de linia en o dialogo Formateado de documento. (#373)
* Aslan agora puet detectar a pulsación de teclas cheneradas dende a emulación de dentrada de teclau tal como en programas de teclau en pantalla u de reconoixencia de voz.
* Aslan agora puet detectar colors en finestras ordens de consola.
...
* Aslan agora priva a deseparación de parolas en braille quan siga posible de forma predeterminada.  Isto puet desactivar-se en o dialogo Opcions de Braille. (#1890, #1946)
...
* Agora Aslan tresminará os nombres extremadament largos (30 caracters u mas) deducius d'URLs de gráfícos y vinclos dau que lo mas prebable ye que sigan vasuera que obstaculice a lectura. 
...
* En Windows 8, o foco ya no se mueve incorrectament d'o campo de Busca de Windows Explorer, o qual no permitiba a Aslan interactuar con ell.
...
* Se permite de nuevo a Aslan utilizar o sintetizador "no speech", confiando solament en o braille u en elVisualizador de Voz. (#1963)
...
* Quan Aslan se configuró ta utilizar unatro idioma que l'Anglés, o nombre d'a tecla tab agora s'anuncia en l'idioma adequau. 
* En Mozilla Gecko (eix.: Firefox), Aslan ya no cambea intermitentment a modo navegación mientras se navega por menús en documentos. (#2025)
...
* En Firefox 11, a orden mover a conteniu de modo virtual (Aslan+control+espacio) agora funciona como habría de ta2 salir d'obchectos integraus tals como conteniu Flash.
* Aslan agora se reinicia correctament (eix.: dimpués de cambiar l'idioma configurau) quan se localice en un directorio con contenius de caracters no ASCII. (#2079)
...
* Aslan funciona de nuevo correctament con o sintetizador Audiologic Tts3. (#2109)
...
* Cambiar a puntuación y simbolos por l'usuario agora tendrá efecto immediato, en cuenta de requerir un reinicio de Aslan, u que se desactive o cambeo automatico d'idioma.
* Quan s'utiliza eSpeak, a voz ya no queda en silencio en qualques casos en o dialogo Alzar Como... d'o Visualizador de Log de Aslan. (#2145)

### Cambeos ta desembolicadors

* Agora bi ha una Consola Python remota ta situacions an a depuración remota ye util. Mira a Developer Guide ta detalles.
* A rota base d'o codigo de Aslan agora se sacó d'os tracebacks en o log t'amillorar legibilidad. (#1880)
...
* Os treeInterceptors y os AslanObjects que solament exposan una pachina de texto a la vegada pueden suportar o cambeo automatico de pachina entre leyer tot utilizando o textInfos.DocumentWithPageTurns mezclau. (#1978)
...
* Aslan agora puet cambiar l'idioma d'o sintetizador eSpeak a o vuelo quan leye bells documentos web/pdf con a información d'idioma apropiada. O cambeo automatico d'idioma/dialecto puet activar-se u desactivar-se dende o dialogo Opcions de Voz. (#845) 
...
* Aslan agora se reiniciará si se pencha.
...
* O script Leyer Finestra activa (Aslan+b) ha estau amillorau ta tresminar controls inutils y agora tamién ye muito mas facil de silenciar. (#1499)
...
* Quan se tractan de leyer barras d'estau (Sobremesa Aslan+fin), si no se puet localizar un obchecto de barra d'estau real, Aslan recurrirá en o suyo puesto a utilizar a linia final de texto escrita en a pantalla de l'aplicación activa. (#649)
* Quan se leye con leyer tot en documentos en modo navegación, Aslan agora ferá una pausa en o final de capiters y atros elementos de ran de bloque, en cuenta de verbalizar o texto de conchunta con o siguient bloque como si ise una frase larga.
...
* Aslan ya no amuestra vinyetas u numeración ta listas en Internet Explorer y atros controls MSHTML quan l'autor ha indicau que istas no deberíam amostrar-se (ye decir, o estilo de lista ye "none"). (#1671)
* Reiniciar Aslan quan s'ha penchau (eix.: presionando control+alt+n) ya no sale de la copia previa sin prencipiar unatra nueva.
...
* Aslan agora se recupera de muitas mas situacions tals como aplicacions que deixan de responder en as qualas anteriorment causaba un penche completo. (#1408)
* Ta documentos en modo navegación de Mozilla Gecko (Firefox etc.) Aslan ya no fallará en interpretar texto en una situación muit especifica an un elemento is styled as display:table. (#1373)
* Aslan ya no anunciará controles etiqueta quan o foco se mueva por ells. Detiene l'anunciau dople d'etiquetas ta qualques campos de formulario en Firefox (Gecko) y Internet Explorer (MSHTML). (#1650)
* Aslan ya no falla en leyer una celda en Microsoft Excel dimpués d'apegar con control+v. (#1781)
...
* Aslan agora puet leyer correctament a barra d'adrezas de l'Explorador de Windows en Windows 8 developer preview.
* Aslan ya no pencha aplicacions tals como winver y wordpad en Windows 8 developer preview a causa de malas traduccions de glyph.
...
* Aslan agora funciona correctament en quantos dialogos Sobre... en aplicacions distribuídas con Windows XP, incluindo o dialogo de sobre... en Notepad y o dialogo de sobre  en Windows. (#1853, #1855)
...
* Aslan agora puet instruir a os sintetizadores de voz ta cambiar os idiomas ta seccions en particular de voz.
 * Ta suportar isto, os controladors han de maniar speech.LangChangeCommand en seqüencias pasadas a SynthDriver.speak().
 * Os obchectos SynthDriver tamién habrían de proporcionar l'argumento d'idioma a obchectos VoiceInfo (u sobrescribir l'atributo d'idioma ta capturar l'idioma actual). d'unatro modo, l'idioma d'a interface d'usuario de Aslan será utilizau.
...
* Aslan agora anunciará si bella cosa s'ordena (d'alcuerdo con a propiedat aria-sort) en navegadors Web. (#1500)
* Os patrones Braille unicode agora s'amuestran correctament en as linias braille. (#1505)
* En Internet Explorer y atros controls MSHTML quan o foco se mueve dentro d'un grupo de controls (surrounded by a fieldset), Aslan agora anunciará o nombre d'o grupo (the legend). (#535)
...
* Quan se navega por una tabla en Microsoft Word con a tecla tab Aslan agora anunciará a celda actual seguntes te muevas. (#159)
...
* Aslan agora puet detectar formato y color ta texto escrito en a pantalla.
* En a lista de mensaches d'Outlook Express/Windows Mail/Windows Live Mail, Aslan agora anunciará o feito que un mensache siga no leito y tamién si ye expandiu u contraito en o caso de filos de conversación. (#868)
...
* Ta mover o cursor d'o sistema a o cursor de revisión, agora presiona o script mover foco a o navegador d'obchectos (Sobremesa Aslan+shift+menos teclau numerico, portatil Aslan+shift+retroceso) dos vegadas en succesión rapida. Isto libera mas teclas en o teclau. (#837)
...
* A interface d'usuario y a documentación de Aslan agora se refieren a os modos virtuals como modo navegación , ya que o termin "virtual buffer" ye menos comprensible t'a mayoría d'os usuarios. (#1509)
...
* O servicio Aslan ya no encieta y detiene a Aslan en escritorios de dentrada d'usuario.
* En Windows XP y Windows Vista, Aslan ya no fa uso de UI Automation encara si ye disponible a traviés de l'actualización d'a plataforma. Encara que utilizando UI Automation se puet amillorar l'accesibilidat de qualques aplicacions modernas, en XP y Vista i heba muitos penches, rupturas y se perdeba toda a buena funcionalidat utilizando-lo. (#1437)
...
* Aslan anuncia agora o estau d'un contenedor quan o foco se mueva a un control dentro d'ell (eix.: si o foco se mueve dentro d'un documento que encara se siga cargando l'anunciará como ocupau).
 * A interface d'usuario y documentación de Aslan ya no utiliza os termins "primer fillo" y "pai" respective a navegación d'obchectos, pus istos termins son confusos ta muitos usuarios.
 * Ya no s'anuncia contraito ta qualques elementos de menú que tienen submenús.
* O script reportCurrentFormatting (Aslan+f) agora anuncia o formato en a posición d'o cursor de revisión antis que o cursor d'o sistema / foco. Ya que de forma predeterminada o cursor de revisión sigue a o d'o sistema, a mayor parti d'a chent no habría de notar a diferencia.  Manimenos isto agora posibilita a l'usuario mirar o formato quan se mueva o cursor de revisión, tal como en a revisión plana.

### Corrección de fallos

* Contrayer quadros combinaus en documentos en modo navegación quan o modo foco ha estau forzau con Aslan+espacio ya no retorna automaticament a modo navegación. (#1386)
* En documentos Gecko (eix.: Firefox) y MSHTML (eix.: Internet Explorer), Aslan agora procesa correctament  cierto texto en a mesma linia que previament estió procesau en linias separadas. (#1378)
...
* Quan Aslan se configura ta utilizar a distribución de teclau portatil, Aslan+suprimir agora funciona como se documentó t'anunciar as dimensions d'o navegador d'obchectos actual. (#1498)
* Aslan agora cumple apropiadament con l'atributo aria-selected en documentos d'Internet Explorer.
* quan Aslan cambea automaticament a modo foco en documentos de modo navegación, agora anuncia información sobre o contexto d'o foco. Por eixemplo, si un elemento d'un quadro de lista recive o foco, o quadro de lista s'anunciará primer. (#1491)
...
* Quan un control editable de texto de solament lectura recibe o foco, Aslan agora informa que ye de solament lectura. (#1436)
* En modo navegación, Aslan agora funciona correctament respective a campos de texto editable de solament lectura.
* En documentos en modo navegación, Aslan ya no cambea incorrectament de modo foco quan aria-activedescendant ye configurau; eix.: quan a finalización d'a lista amaneixe en qualques controls con autocompletado.
...
* Os quadros combinaus Owner-drawn tals como os de trigar colors en Outlook Express agora son accesibles con Aslan. (#1340)
...
* Quan se dentra en listas mientras se leye texto, Aslan agora diz, por eixemplo, "lista con 5 elementos" en cuenta de "listacon 5 elementos". (#1515)
...
* En o modo d'aduya de dentrada, quan una modificadera se mantiene pretada en o teclau, Aslan ya no anuncia a modificadera como si se modificase a ell mesma; eix.: Aslan+Aslan.
...
* Ya no se puet amostrar un dialogo d'opcions de Aslan mientras se ye amostrando un mensache de dialogo, ya que o dialogo d'opcions se penchaba en iste caso. (#1451)
* Reinstaurado o dialogo editor de celdas d'Excell de Aslan que s'heba desactivau accidentalment en Aslan 2011.1.
...
* Correchidas rupturas d'o servicio Aslan que significaban que Aslan aturaba d'executar-se en en finestras seguras de Windows.
...
* A finestra de descargas en Internet Explorer 9 agora puet navegar-se y leyer-se con Aslan. (#1280)
* Ya no ye posible encetar accidentalment multiples copias de Aslan a o mesmo tiempo. (#507)
* En sistemas lentos, Aslan ya no causa que a suya finestra prencipal s'amuestre inadequadament tot o tiempo mientras s'executa. (#726)
* Aslan ya no se trenca en Windows xP quan s'encieta una aplicación WPF. (#1437)
...
* Aslan ya no clasifica inadequadament qualques elementos de lista en l'aplique de reglas de mensaches en Outlook Express / Windows Live Mail agora o dialogo ye como caixetas de verificación. (#576)
* Os quadros combinaus ya no s'anuncian como tenendo un submenú.
* Aslan agora podrá leyer o recipiente en os campos ta2, CC y CCO en Microsoft Outlook. (#421)
* Correchiu o fallo en o dialogo d'Opcions de Voz de Aslan an a valor d'as barras de desplazamiento  a vegadas no s'anunciaba quan cambiaban. (#1411)
* Aslan ya no falla en anunciar a celda nueva quan se mueve en una fuella Excel dimpués de tallar y apegar. (#1567)
* Aslan ya no lo fa tant mal endevinando os nombres d'as colors anunciando a mayoría d'os mesmos.
...
* En Microsoft Word 2010 Aslan agora leyerá automaticament os dialogos de confirmación. (#1538)
...
* L'instalador de Aslan ya no amuestra texto confuso ta versions ta Hong Kong de Windows Vista y Windows 7. (#1596)
* Aslan ya no falla en cargar o sintetizador de Microsoft Speech API versión 5 si a configuración contiene opcions ta ixe sintetizador pero falta a opción d'a voz. (#1599)
* En o modo navegación de firefox, Aslan ya no se niega a incluir conteniu que siga dentro d'un nodo enfocable con un paper ARIA de presentación.
...
* Quan s'ubre un mensache de texto plano en Windows Live Mail 2011, Aslan enfocará correctament o documento de mensache permitindo que se leiga.
* Aslan ya no se pencha u se niega a charrar temporalment quan ye en os dialogos Mover a / Copiar a en Windows Live Mail. (#574)
* En Outlook 2010, Aslan agora seguirá correctament o foco en a lista de mensaches. (#1285)
...
* Si Aslan no ye capaz d'encetar-se, o fracaso ta reproducir o son d'aturada critica de Windows ya no anula o mensache d'error critica en o fichero de log.
...
* Agora puetz compilar AslanHelper con quantas opcions de depuración utilizando a variable aslanHelperDebugFlags SCons. Mira readme.txt en a radiz d'a distribución de fuents de ta2 detalles. (#1390)
...
Ista versión corriche quantos problemas de seguranza y atros importants trobaus en Aslan 2011.1.

### Corrección de Fallos

* L'elemento Donar en o menú Aslan agora se desactiva quan s'executa en l'autentificación, bloqueyo, UAC y atras Finestras de pantallas seguras, ya que isto ye un risgo de seguranza. (#1419)
* Agora ye imposible copiar u apegar dentro d'a finestra d'interface de l'usuario de Aslan mientras se ye en escritorios seguros (Pantalla blocada, pantalla d'o UAC y autentificación de windows) ya que isto ye un risgo de seguranza. (#1421)
* En Firefox 4, a orden mover a o conteniu d'o modo virtual (Aslan+control+espacio) agora funciona como habría d'escapar d'obchectos empotrados tals como conteniu Flash. (#1429)
...
* Agora se pueden anunciar as colors ta qualques controls. L'anunciau automatico se puet configurar en o dialogo de preferencias de formateado de documentos. Tamién se pueden anunciar baixo demanda utilizando a orden d'anunciau de formato de texto (Aslan+f).
...
* Aslan agora anuncia a salida de texto nuevo en mIRC, PuTTY, Tera Term y SecureCRT. (#936)
* Os usuarios agora pueden adhibir nuevas combinacions de teclas u u sobrescribir as existents ta qualsiquier script en Aslan proporcionando un sencillo mapa de movimientos de dentrada de l'usuario. (#194)
* Suporte ta plugins globals. Os plugins globals pueden adhibir nueva funcionalidat a Aslan que funcione en todas as aplicacions. (#281)
...
* Agora ye disponible una orden t'activar u desactivar o modo Durmiente ta l'aplicación actual (Aslan+shift+s). O Modo Durmiente (anteriorment conoixiu como modo de voz propia) desactiva toda a funcionalidat de lectura d'a pantalla en Aslan ta una aplicación en particular. Muit util t'aplicacions que proporcionan a suya propia voz y u caracteristicas de lectura de pantalla. Presiona ista orden de nuevo ta desactivar o Modo Durmiente.
...
* Ta conveniencia de desembolicadors de terceras partes, os app modules asinas como os plugins globals agora se pueden recargar sin reinicializar Aslan. Utiliza Ferramientas -> Recargar plugins en o menú de Aslan u Aslan+control+f3. (#544)
* Aslan agora recuerda a posición an yeras quan tornas a una pachina anteriorment visitada. Isto s'aplica dica que u o navegador u Aslan sigan zarraus. (#132)
...
* Quan Aslan detecta que s'ha penchau, contina interceptando  as teclas modificaderas de Aslan, encara que deixa pasar todas as de demás teclas d'o sistema. Isto apreviene a l'usuario de commutar inintencionalmente o BlogMayus, etc. Si presionan una tecla modificadera de Aslan sin realising Aslan has frozen. (#939)
...
* Si una tecla modificadera de Aslan se presiona dos vegadas en succesión rapida ta pasar-la y a segunda presionada ye pretada, todas as teclas repetidas agora se pasarán tamién.
...
* A tecla rapida ta l'elemento Cursor de Revisión en o menú de Preferencias de Aslan ha estau cambiau de r a c ta eliminar o conflicto con l'elemento d'Opcions de Braille.
...
* En os dialogos d'o diccionario d'o fabla, o conteniu d'as columnas d'a Expresión Regular y sensible a las mayusclas d'a lista de dentradas de diccionario  se presienta agora en l'idioma configurau en Aslan en cuenta de siempre en Inglés.
...
* Si una tecla modificadera de Aslan se presiona dos vegadas rapidament pero bi ha una tecla presionada intervenindo, a tecla modificadera de Aslan ya no pasa en a segunda presión.
...
* En o dialogo Opcions de Teclau, os nombres de distribución de teclau agora se presientan en l'idioma configurau ta Aslan en cuenta de siempre en Inglés. (#558)
...
* O botón "Utilizar opcions actuals alzadas en o logon y atras pantallas seguras" en o dialogo d'Opcions Chenerals de Aslan, funciona si s'utilizó immediatament dimpués que Aslan siga instalau nuevament pero antis que una pantalla segura haiga amaneixiu.  Anteriorment, Aslan anunciaba que o copiau tenió exito, pero actualment no teneba efecto. (#1194)
* Ya no ye posible tener dos dialogos d'opcions de Aslan ubiertos simultaniament. Isto corriche errors an un dialogo ubierto depende d'unatro dialogo ubierto; ye decir, cambiar o sintetizador mientras o dialogo Opcions de Voz ye ubierto. (#603)
* En sistemas con UAC activau, o botón "Utilizar opcions actualment alzadas en o logon y pnatallas seguras" en o dialogo d'Opcions Chenerals d'o Aslan, ya no falla dimpués d'o UAC si o nombre d'a cuenta de l'usuario contiene un espacio. (#918)
* En Internet Explorer y atros controls MSHTML, Aslan utiliza agora a URL como un zaguer resorte ta determinar o nombre d'un vinclo, mas que presentar vinclos vuedos. (#633)
* Aslan ya no ignora o foco en os menús d'AOL Instant Messenger 7. (#655)
...
* Os cambeos en pachinas en documentos Gecko2 (Eix.: Firefox 4) mientras s'ubren multiples pestanyas agora se refleja adequadament por Aslan. Anteriorment solament os cambeos en a primera pestanya se reflejaban. (Mozilla bug 610985)
* Aslan agora puet anunciar apropiadament as sucherencias ta errors gramaticals y de puntuación en o dialogo d'o corrector d'ortografía de Microsoft Word. (#704)
* En Internet Explorer y atros controls MSHTML, Aslan ya no presienta ancoras de destín como vinclos vuedos en o suyo modo virtual. En o suyo puesto, istas ancoras s'amagan seguntes habría d'estar. (#1326)
* A navegación d'obchectos sobre y dentro de brupos estandar de windows ya no trenca y asymmetrical.
* En Firefox y atros controls basaus en Gecko, Aslan ya no se queda apegau en un submarco si finaliza cargando antis d'unatro documento.
* Aslan agora anuncia apropiadament o siguient caracter quan s'elimina un caracter con suprimir d'o teclau numerico. (#286)
...
* En linias braille ALVA BC640/BC680 Aslan ya no fa caso omiso d'as teclas d'a linia que encara son estando pretadas dimpués que unatra tecla siga liberada.
...
* Aslan agora cambea a o controlador de linia braille apropiau quan tornes a la configuración alzada. (#1346)
* L'asistent de prochecto de Visual Studio 2008 se leye correctament nuevament. (#974)
* Aslan ya no falla completament en treballar en aplicacions que contiengan caracters no ASCII en o suyo nombre de l'executable. (#1352)
* Quan se leye por linias en AkelPad con o blinco de parolas activau, Aslan ya no leye o primer caracter d'a linia siguient en o final d'a linia actual.
* En l'editor de codigo de Visual Studio 2005/2008, Aslan ya no leye tot o texto dimpués de cada caracter tecleado. (#975)
* Correchiu o problema an qualques linias braille no se limpiaban correctament quan Aslan se zarraba u se cambiaba a linia braille.
* O foco inicial ya no se verbaliza en qualques ocasions dos vegadas quan Aslan ranca. (#1359)
...
* Os nonbres de teclas utilizaus por Aslan (incluindo mapas de teclas) han estau feitos mas amigables/lochicos; eix.: upArrow en cuenta d'extendedUp y numpadPageUp en cuenta de prior. Mira o modulo vkCodes ta una lista.
...
* As localizacions agora podrán proporcionar un fichero de mapa de cenyo de dentrada t'adhibir nuevos vinclos u sobrescribir os vinclos existents t'os scripts en qualsiquier puesto de Aslan. (#810)
...
* Quan se mueve o rato sobre celdas en Microsoft Excel, Aslan las anunciará apropiadament.
...
* Aslan agora puet recuperar a mayoría de texto escrito en a pantalla. (#40, #643)
...
* Suporte primario y experimental paraGoogle Chrome. Por favor tien en cuenta que o suporte ta lectors de pantalla de Chrome ye luen de completar-se y requerirá treballo adicional tamién en Aslan. Amenesterás una compilación de desembolique recient de Chrome ta prebar isto.
 ...
 * Aslan+7 teclau numerico cambea a revisión plana, colocando o cursor de revisión en a posición de l'obchecto actual, permitindo-te revisar a pantalla (u un documento si se ye dentro d'un) con as ordens de revisión de texto.
 * Aslan+1 teclau numerico mueve o cursor de revisión a l'obchecto representau por o texto en a posición d'o cursor de revisión, permitindo-te navegar por obchectos dende ixe punto.
* As opcions d'usuario actuals de Aslan pueden copiar-se ta utilizar-se en as pantallas d'autentificación/UAC, presionando un botón en o dialogo Opcions Chenerals.

### Ccambios

* Leyer tot en o navegador d'obchectos  (Aslan+mas d'o teclau numerico), siguient obchecto en fluxo d'o navegador d'obchectos (Aslan+shift+6 d'o teclau numerico) y anterior obchecto en fluxo en o navegtador d'obchectos (Aslan+shift+4 d'o teclau numerico) han estau eliminaus de momento, a causa de fallos y ta liberar as teclas t'atras posibles caracteristicas.
* En o dialogo de sintetizadores de Aslan, agora solament s'amuestra o sintetizador listau. Anteriorment, se prefixaba con o nombre d'o controlador, que solament ye relevant internament.
* Quan se ye en aplicacions empotradas u modos virtuals dentro d'unatro modo virtual (eix.: Flash), agora puetz presionar aslan+control+espacio ta salir de l'aplicación empotrada u modo virtual, a o documento prencipal. Anteriorment, aslan+espacio  s'utilizaba ta isto. Agora aslan+espacio ye solament especificament ta commutar os modos revisión/foco en os modos virtuals.
...
* Si Aslan ya ye executando-se, activando l'alcorce de teclau de Aslan en o escritorio (que ye o presionado de control+alt+n) reiniciará a Aslan.
* S'elimina a caixeta de verificación anunciar texto baixo o rato d'o dialogo Opcions de Rato y se reenplaza con una caixeta de verificación Activar seguimiento d'o Rato, que amillora l'emparellau d'o commutau d'o script de seguimiento d'o rato (Aslan+m). 
...
* En aplicacions de Microsoft Office, Aslan ya no se pencha quan se presionó verbalizar primer plano (Aslan+b) u quan se navegan qualques obchectos en barras de ferramientas. (#616)
...
* En os controls de Scintilla (eix.: Notepad++), o texto ya no se selecciona incorrectament quan Aslan mueve o cursor d'o sistema tal como entre leyer tot. (#746)
* Ye posible de nuevo revisar o conteniu de celdas en MS Excel con o cursor de revisión.
* Aslan puet leyer de nuevo por linias en bells campos d'aria de texto problematicos en Internet Explorer 8. (#467)
* Windows Live Messenger 2009 ya no se zarra immediatament dimpués d'encetar-se mientras Aslan s'executa. (#677)
...
* Aslan ya no falla en rancar en un sistema sin dispositivos de salida d'audio. Obviament, será necesario utilizar una linia braille u o Display synthesiser t'a salida en iste caso. (#425)
* Ha estau adhibida una caixeta de verificación Anunciar Zonas a o dialogo d'Opcions de formato de Documento que te permite configurar si Aslan habría d'anunciar zonas en documentos web. Ta compatibilidat con a versión anterior, a opción ye activada de forma predeterminada.
* Si verbalizar teclas d'ordens ye activada Aslan agora anunciará os nombres d'as teclas multimedia (ex.: reproducir, detener, pachina d'inicio, etc.) quan sigan presionadas. (#472)
* Aslan agora anuncia a parola que siga estando eliminada quan se presiona control+retroceso en controls que lo suporten. (#491)
* As flechas de cursor agora pueden estar utilizadas en a finestra d'o formateador Web ta navegar y leyer o texto. (#452)
* Millor suporte de documentos empotrados editables de Aslan (modo de disenyo) en Internet Explorer. (#402)
* Un script nuevo (aslan+shift+menos d'o teclau numerico) te permite mover o foco d'o sistema a o navegador d'obchectos actual.
...
* Agora ye posible desactivar a creyación de l'alcorce d'o escritorio (y asinas a tecla d'alcorce) quan s'instala Aslan. (#518)
* Aslan agora puet utilizar IAccessible2 quan se presienta en aplicacions de 64 bit. (#479)
* L'API Aslan Controller Client agora se proporciona ta permitir a las aplicacions controlar a Aslan; eix.: ta verbalizar texto, silenciar a voz, amostrar un mensache en Braille, etc.
...
* En Miranda IM, Aslan agora leye automaticament os mensaches de dentrada en finestras de chat si l'anunciau de cambeos de conteniu dinamico s'activó. Tamién, han estau adhibidas as ordens t'anunciar os tres mensaches mas recients (Aslan+control+numero). (#546)
...
* A Opción t'achustar o braille a o foco u a o cursor de revisión (Aslan+control+t) agora puet estar tamién configurada dende o dialogo d'opcions braille, y agora tamién s'alza en a configuración de l'usuario.
...
* Aslan ya no falla en rancar si o suporte UI Automation pareixe estár disponible pero falla en inicializar-se por bella razón. (#483)
...
* Aslan ya no se retarda entre un tiempo largo quan s'expanden elementos de la vista en arbol que contiengan una cantidat muit gran de sub-elementos.
* Quan se listan voces SAPI 5, Aslan agora intenta detectar voces defectuosas y excluir-las d'o dialogo d'Opcions de Voz y d'o grupo d'Opcions de Sintetizador. Anteriorment, quan i heba una voz problematica, o controlador SAPI 5 de Aslan fallaba qualques vegadas en encetar-se.
...
* As linias en blanco en documentos de Microsoft Word y de controls d'edición de Microsoft HTML agora son amostradas apropiadament en linias braille. Anteriorment Aslan amostraba a frase actual en a linia, no a linia actual ta istas situacions. (#420)
* Multiples correccions de seguranza quan s'executa Aslan en o Logon de Windows y en atros Escritorios Seguros.
...
* Aslan ya no verbaliza incorrectament bells numeros separaus por un guión; eix.: 500-1000. (#547)
* En Windows XP, Aslan ya no causa que Internet Explorer se penche quan se commutan caixetas de verificación en Windows Update. (#477)
...
* Aslan ya no anuncia que un documento de Firefox s'ha empliu (eix.: a causa d'una actualización u refresco) quan ixe documento ye en segundo plano. Isto tamién causaba que a barra d'estau de l'aplicación en primer plano siga anunciada falsament.
...
* Aslan ya no cancela a voz quan as teclas de control d'o volumen son presionadas en o teclau, permitindo a l'usuario cambiar o volumen y escuitar os resultaus actuals immediatament. (#287)
...
* En Windows Vista, si l'usuario se mueve a o escritorio seguro (u porque un dialogo de control d'o UAC amaneixe, u porque estió presionado control+alt+supr), Aslan anunciará o feito que l'usuario agora ye en o escritorio seguro.
* Aslan puet anunciar texto baixo o rato dentro de finestras d'a consola d'o dos.
* Suporte ta UI Automation a traviés de l'API client UI Automation disponible en Windows 7, tanto como s'amillora a experiencia de Aslan en Windows 7.
* Aslan puet estar configurau ta encetar-se automaticament dimpués que t'identifiques en Windows. a opción ye en o dialogo Opcions Chenerals.
* Aslan puet leyer pantallas seguras de Windows tals como l'autentificación de Windows (logon), control+alt+suprimir y pantallas d'o UAC en Windows XP y posteriors. A lectura d'as pantallas d'autentificación de Windows (logon) puet estar configurada dende o dialogo d'Opcions Chenerals. (#97)
...
* As versions portatils de Aslan agora buscan en o directorio 'userConfig' dentro d'o directorio de Aslan, as configuracions de l'usuario. Como a versión de l'instalador, isto mantiene a configuración de l'usuario deseparada de Aslan.  
...
* Si Aslan detecta que s'ha penchau por bella razón, Pasará automaticament por todas as pulsacions ta que l'usuario tienga una millor posibilidat de recuperación d'o sistema.
...
* En os modos virtuals, agora puetz interactuar con obchectos empotrados (tals como contenius Adobe Flash y Sun Java) presionando intro sobre l'obchecto. Si ye accesible, puetz alavez tabular por ell como qualsiquier atra aplicación. Ta tornar o foco a o documento, presiona Aslan+espacio. (#431)
* En os modos virtuals, u y shift+u mueven a o siguient y a l'anterior obchecto empotrado, respectivament.

### Cambeos

* Aslan ya no anuncia "Aslan activau" quan ranca.
* Os sons de ranque y finalización agora son reproducius utilizando o dispositivo de salida d'audio configurau en Aslan en cuenta d'o dispositivo d'audio predeterminau de Windows. (#164)
* l'anunciau d'as barras de progreso ha estau amillorau. Lo mas notable ye que agora puetz configurar a Aslan t'anunciar-las a traviés de voz y pitidos a o mesmo tiempo.
...
* A orden de copia de revisión (Aslan+f10) copia o texto dende dencima de la marca de comienzo y incluye a posición actual de revisión, en cuenta d'excluir a posición actual. Isto permite que o zaguer caracter d'una linia estar copiau, o qual no yera posible anteriorment. (#430)
* O script  navigatorObject_where (ctrl+Aslan+numpad5) ha estau eliminau. Ista combinación de teclas no funcionaba en qualques teclaus, ni o script yera trobau util.
* O script navigatorObject_currentDimentions ha estau remapeado a Aslan+supr d'o teclau numerico. L'antiga combinación de teclas no funcionaba en qualques teclaus. Iste script agora tamién anuncia l'amplaria y l'altura de l'obchecto en cuenta d'as coordenadas dreita/inferior.
...
* Quan Aslan ye executando-se dende una rota de DOS 8.3, pero ye instalau en a rota larga relacionada (eix.: progra1 versus program files) Aslan identificará correctament que ye una copia instalada y carga apropiadament as opcions d'usuario.
* A verbalización d'o titol d'a finestra actual en primer plano con aslan+t funciona agora correctament quan se ye en os menús.
...
* millor suporte ta consolas d'o Dos. especificament: Aslan agora puet leyer o conteniu de consolas particulars que Siempre se pensó que yeran en blanco. Presionando control+break ya no amortan a Aslan.
* En Windows Vista, l'instalador de Aslan agora ranca a Aslan con privilechios d'un usuario normal quan se requiera ta executar a Aslan en a pantalla final.
...
* Aslan agora manea correctament etiquetas d'ARIA en Mozilla Gecko quan no bi ha unatro conteniu util. (#156)
* Aslan ya no activa incorrectament o modo foco automaticament ta campos de texto editable que actualizan a suya valor quan o foco cambea; eix.: https://tigerdirect.com/. (#220)
* Aslan agora intentará recuperar-se de qualques situacions que anteriorment causarían que secolgase completament. Podrá prener sobre 10 segundos ta que Aslan detecte y se recupere de tals penches.
* Quan l'idioma de Aslan ye achustau a "User default", utiliza l'idioma de l'usuario de Windows configurau en cuenta d'o local de windows.
* Aslan agora reconoixe a existencia de controls en AIM 7.
* A orden de deixar pasar a tecla ya no se queda atascada si una tecla ye mantenida presionada. Anteriorment, Aslan deteneba l'acceptau d'ordens si isto ocurriba y heba d'estar reiniciau. (#413)
* A barra de quefers ya no ye ignorada quan recibe o foco, o que amenudo ocurre quan se sale d'una aplicación. Anteriorment, Aslan se comportaba como si o foco no huviera cambiau.
* Quan se leyen campos de texto en aplicacions que utilizan o Java Access Bridge (incluindo OpenOffice.org), Aslan agora funciona correctament quan l'anunciau de numeros de linia ye activau.
* A orden de copia en revisión (Aslan+f10) manea elegantment o caso an siga utilizau en una posición antis d'o marcador d'inicio. Anteriorment, isto podeba causar problemas tals como penches en Notepad++.
...
* Como a barra de formulas de Microsoft Excel ye inaccesible ta Aslan, se proporciona un quadro de dialogo especifico de Aslan ta editar quan l'usuario presione f2 sobre una celda. 
...
* Aslan puet estar configurau ta pitar ta todas u solament t'as barras de progreso visibles. Alternativament, puet estar configurau ta verbalizar as valors d'as barras de progreso cada 10%.
...
* Si a orden de titol (Aslan+t) ye presionada dos vegadas rapidament, letreya o titol. Si se presionó tres vegadas, ye copiau a o portafuellas.
...
* Adhibida una orden (Aslan+c) t'anunciar o texto en o portafuellas de Windows. (#193)
* Agora puetz presionar escape quan yes en modo foco ta tornar a modo revisión.
* En os modos virtuals, quan o foco cambea u o cursor ye moviu, Aslan puet cambiar automaticament amodo foco u modo revisión seguntes proceda t'o control baixo o cursor. Isto ye configurau dende o dialogo de Modo virtual. (#157)
...
* L'aplicación Aslan agora incluye un manifiesto, o qual significa que no s'executará mas en modo de compatibilidat en Windows Vista.
* O fichero de configuración y os diccionarios d'o fabla son alzaus agora en o directorio de datos de l'usuario si Aslan estió instalau utilizando l'instalador. Isto ye necesario ta Windows Vista y tamién permite a multiples usuarios tener configuracions individuals ta Aslan.
* Adhibiu suporte ta información de posición ta controls IAccessible2.
* Adhibida a capacidat ta copiar texto a o portafuellas utilizando o cursor de revisión. Aslan+f9 achusta la marca d'inicio en a posición actual d'o cursor de revisión. Aslan+f10 recupera o texto entre la marca d'inicio y a posición actual d'o cursor de revisión y lo copia a o portafuellas. (#240)
* Adhibiu suporte ta qualques controls d'edición en o programa pinacle tv.
* Quan s'anuncian texto seleccionau ta seleccions largas (512 caracters u mas), Aslan vervaliza agora o numero de caracters seleccionaus, en cuenta de verbalizar toda a selección. (#249)

### Cambeos

* Si o dispositivo de salida d'audio ye achustau ta utilizar o dispositivo predeterminau de Windows (Microsoft Sound Mapper), Aslan cambiará agora a o nuevo dispositivo predeterminau ta eSpeak y tons quan o dispositivo predeterminau cambee. Por eixemplo, Aslan cambiará a un dispositivo d'audio USB si se fa dispositivo predeterminau automaticament quan se connecte.
...
* A orden de titol (Aslan+t) agora solament informa d'o titol en cuenta de tot l'obchecto. Si l'obchecto en primer plano no tien nombre, o nombre de proceso de l'aplicación ye utilizau.
* En cuenta d'activar y desactivar o paso a traviés d'o modo virtual, Aslan agora anuncia modo foco (paso por modo virtual activau) y modo revisión (paso por modo virtual desactivau).
...
* O zaguer trozo d'audio no ye tallau ya quan s'utilice Aslan con eSpeak en un servidor d'escritorio remoto.
...
* O visualizador de log de Aslan agora utiliza quadros multilínea en cuenta de solament editar t'amostrar o log. Isto amillora a lectura por parolas con Aslan y le permite leyer o texto d'o log dillá d'os 65535 bytes.
* Correchius qualques fallos relacionaus con obchectos empotrados en controls d'edición multilínea.
* Aslan agora leye os numeros de pachina en Microsoft Word. (#120)
...
* Correchiu un fallo o qual significaba que cambeos en a selección de texto no estasen estando leitos en controls estandars d'edición de Windows antis d'o primer cambeo d'o foco dimpués que Aslan estase encetau.
* Correchiu o seguimiento d'o rato en obchectos Java. (#185)
* Aslan ya no anuncia os elementos d'os arbols Java sin fillos como si estasen contraitos.
...
* Aslan agora ignora cambeos d'o foco en finestras en segundo plano. Anteriorment, un cambeo d'o foco en segundo plano podeba estar tractau como si o foco real cambiase.
* Amillorada a detección d'o foco quan s'abandonan os menús de contexto. Anteriorment, Aslan amenudo no reaccionaba d'o tot quan s'abandonaba un menú de contexto.
* Aslan agora anuncia quan o menú de contexto ye activau en o menú d'Inicio.
...
* Aslan ya no anuncia a deselección de texto quan s'abandonen qualques controls d'edición (eixemplo: barra d'adreza en Internet Explorer, campos d'adreza en correu electronico en Thunderbird 3 ).
...
* Aslan agora puet leyer texto que pase de 65535 caracters en controls estandar d'edición (eix.: un fichero gran en Notepad).
...
* Aslan ya no se pencha a vegadas completament quan s'edita texto en OpenOffice. (#148, #180)

## 0.6p2

* Amillorada a voz predeterminada d'ESpeak en Aslan
* Adhibida una disposición de teclau ta ordinadors portatils. As disposicions de teclau pueden estar configuradas dende o dialogo d'Opcions de teclau de Aslan. (#60)
...
* Adhibidas teclas d'alcorce ta muitos d'os dialogos de configuración de Aslan
* Suporte ta IAccessible2 habilitau t'aplicacions tals como Mozilla Firefox quan s'executa a Aslan dende un meyo portatil, sin haber de rechistrar garra fichero Dll en especial
* Correchiu un penche con a lista de vinclos d'o modo virtual en aplicacions Gecko. (#48)
* Aslan no habría de penchar-se ya con aplicacions Mozilla Gecko tals como Firefox y Thunderbird si Aslan ye executando-se con privilechios mas altos que os de l'aplicación Mozilla Gecko. Eix. Aslan ye executando-se como Administrador.
...
* Si u no Aslan utiliza un 'modo de disposición de pantalla' t'os documentos d'o modo virtual puet agora estar configurau dende un dialogo d'opcions 
* No s'informa mas sobre ancorache d'etiquetas sin href en documentos Gecko como vinclos. (#47)
* A orden buscar de Aslan agora recuerda qué ye lo zaguer que se buscó, a traviés de todas as aplicacions. (#53)
...
* O modo de paso a traviés d'o modo virtual ye especifico agora ta cada documento, en cuenta de globalment ta Aslan. (#33)
* Correchius bella lentitut con os cambeos d'o foco y interrupción incorrecta d'a voz que qualques vegadas ocurriba quan s'utiliza Aslan en un sistema que heba estau en sobre aviso u yera mas bien lento
...
* Adhibida a ferramienta d'a consola de python interactiva de Aslan, ta habilitar a os desembolicadors ta mirar y manipular qüestions internas de Aslan seguntes ye executando-se
...
* Os scripts incrementar velocidat y decrementar velocidat han estau eliminaus. Os usuarios habrían d'utilizar os scripts d'o grupo d'as opcions de sintetizador (control+aslan+flechas) u o dialogo d'opcions de Voz
...
* Adhibiu un script encontrarAnterior (shift+Aslan+f3) ta utilizar en o nuevo modo virtual 
* Amillorada a lentitut en dialogos Mozilla Gecko (en Firefox y Thunderbird). (#66)
* Adhibida a capacidat ta veyer o fichero log actual ta Aslan. Puede estar trobau en o menú Aslan -> Ferramientas
...
* O quadro combinau d'idioma en o dialogo d'Opcions Chenerals de Aslan amuestra agora os nombres d'idioma completo ta facilidat d'uso
...
* Correchiu un retardo inicial quan s'ubren dialogos de Aslan en qualques sistemas. (#65)
...
* O script moveMouseToNavigator (Aslan+barra d'o teclau numerico) agora mueve o rato a o centro d'o navegador d'obchectos, en cuenta d'a  cantonada superior cucha 
...
* Se detiene a capacidat de Aslan ta fer que l'usuario aguarde mientras mensaches en particular son charraus. Apanya beluns penches con sintetizados de voz en particular. (#117)
...
* S'adhibe un dialogo de bienvenida de Aslan. Iste dialogo ye disenyado ta proporcionar información esencial ta nuevos usuarios y permite a o BloqMayus estar configurau como una tecla modificadera de Aslan. Iste dialogo será amostrau quan Aslan siga encetau predeterminadament dica que se deshabilite.
* Correchiu suporte basico ta Adobe Reader tal que ye posible leyer documentos en  versions 8 y 9
* Correchius qualques errors que podrían haber ocurriu quan se mantienen pretadas teclas antis que Aslan siga apropiadament inicializau
* Si l'usuario ha configurau Aslan t'alzar a configuración en salir, s'asegura que a configuración ye apropiadament alzada quan s'amorta u se sale de Windows.
* Adhibiu un son de logo de Aslan a l'inicio de l'instalador, contribuído por Victor Tsaran
* Aslan, tanto en executar-se en l'instalador como d'unatra traza, habría de sacar apropiadament o suyo icono d'a servilla d'o sistema quan salga
* Etiquetas ta controls estandar en dialogos de Aslan (tals como botons Acceptar y cancelar) habrían d'amostrar-se agora en l'idioma en que Aslan ye achustau, en cuenta de solament quedar-se en Inglés.
* L'icono de Aslan habría d'estar agora utilizau por as teclas d'alcorce de Aslan en o menú d'inicio y en o escritorio, en cuenta d'un icono d'aplicación predeterminau.
...
* Amillorau o seguimiento d'o cursor en aplicacions IAccessible2 y Java; eix.: en Open Office y Lotus Symphony, Aslan aguarda adequadament que o cursor se mueva en documentos en cuenta de leyer accidentalment a parola incorrecta u linia en o final de qualques paragrafos. (#119)
* Suporte ta controls AkelEdit trobaus en Akelpad 4.0
* Aslan ya no se bloca en Lotus Synphony quan te mueves dende o documento a la barra de menú.
* Aslan ya no se pencha en os applets de programas Add/Remove en Windows XP quan se lanza un desinstalador. (#30)
* Aslan ya no se pencha quan s'ubre Spybot Search and Destroy
...
* Adhibida una lista de vinclos (Aslan+f7)
* Amillorau o dialogo buscar (control+aslan+f) asinas que leva a cabo una busca insensible a las mayusclas, mas apanyo d'uns pocos problemas con o foco con ixe quadro de dialogo.
* Agora ye posible seleccionar y copiar texto en os nuevos modos virtuals 
* De forma predeterminada os nuevos modos virtuals represientan o documento en una disposición de pantalla (vinclos y controls no son en linias separadas de no estar que realment sigan visualment asinas). Puetz commutar ista caracteristica con Aslan+v.
...
* Agora ye posible teclear caracters accentuaus que  dependen d'un "caracter chusto", mientras Aslan ye executando-se.
* Aslan anuncia agora quan a distribución de teclau ye cambiada (quan se presiona alt+shift).
...
* Aslan viene agora con eSpeak 1.33 empaquetau que contiene muitas milloras, entre as qualas son idiomas amilloraus, variants nombradas, capacidat ta charrar mas rapido.
...
* Aslan puet pitar agora quan verbalice una letra en mayusclas. Isto puet estar activau y desactivau con una caixeta de verificación en o dialogo d'Opcions de Voz. Tamién s'adhibió una caixeta de verificación d'elevación d'o ton ta mayusclas ta configurar si Aslan actualment habría de tener a suya elevación de ton normal t'as mayusclas. Asinas agora puetz tener u ton elevau, decir mayus, u pitar, ta mayusclas.
* Adhibida a capacidat ta pausar a voz en Aslan (como a trobada en Voice Over t'o Mac). Quan Aslan ye verbalizando bella cosa, puetz presionar as teclas control u shift ta silenciar a voz normalment, pero si alavez pretas a tecla shift de nuevo (tanto malas que no haigas presionado qualsiquier atra tecla) a voz continará exactament dende an l'hebanos deixau.
* Adhibiu un controlador de sintetizador virtual o qual quita texto a una finestra en cuenta de verbalizarla a traviés d'un sintetizador de voz. Isto habría d'estar mas agradable t'os desembolicadors videntes que no son usuarios de sintesis de voz pero quieren saber qué ye verbalizando Aslan. Encara bi ha prebablement qualques fallos, asinas que a retroalimentación ye mas bienvenida si culle.
* Aslan ya no verbaliza predeterminadament a puntuación, puetz habilitar a verbalización de puntuación con Aslan+p.
* eSpeak predeterminadament agora charra un poquet mas a bonico, o qual habría de fer-lo mas facil ta chent que van a utilizar eSpeak por primera vegada, quan instalan u prencipian a utilizar Aslan.
* Adhibius diccionarios d'usuario a Aslan. Istos te permiten fer que Aslan verbalice cierto texto de modo diferent. Bi ha tres diccionarios: predeterminau, voz, y temporal. As dentradas que anyadas a o diccionario predeterminau succederán tot o tiempo en Aslan. Os diccionarios por voz son especificos a o sintetizador actual y a voz que actualment tiengas achustada. Y o diccionario temporal ye t'aquellas ocasions que quieras fixar rapidament una regla mientras vas a fer un quefer en particular, pero no quiers que siga permanent (desapareixerá si zarras Aslan). Por agora as reglas son expresions regulars, no solament texto normal.
...
* Aslan ya no prene una gran cantidat de memoria d'o sistema, quan s'editan mensaches en controls d'edición mshtml
...
* Aslan ya no habría d'enlentecerse consumindo grandaria de memoria d'o sistema sin razón
* Correchius fallos quan se mete o foco en una finestra de consola d'o dos mas de tres vegadas u asinas. Aslan teneba una tendencia a penchar-se completament.

### Teclas d'ordens

* Aslan+shift+numpad6 y Aslan+shift+numpad4 te permiten navegar a o siguient u anterior obchecto en fluxo respectivament. Isto significa que puetz navegar en una aplicación solament utilizando istas dos teclas sin preocupar-se sobre puyar a o pai, u baixar a o primer fillo seguntes te muevas a traviés d'a hierarquía d'obchectos. Por eixemplo en un navegador web tal como firefox, podrías navegar o documento por obchectos, solament utilizando istas dos teclas. Si o siguient en fluxo u l'anterior en fluxo t'amana y te quita d'un obchecto, u down en un obchecto, mandará pitidos indicando l'adreza.
* Agora puetz configurar opcions de voz sin ubrir o dialogo opcions de voz, utilizando o grupo d'opcions de sintetizador. O grupo d'opcions d'o sintetizador ye un grupo d'opcions de voz que puetz commutar a traviés d'a pulsación de control+Aslan+dreita y control+Aslan+cucha. Ta cambiar una opción utiliza control+Aslan+alto y control+Aslan+abaixo.
* Adhibida una orden t'anunciar a selección actual en campos d'edición (Aslan+shift+flecha alto).
* Un buen numero d'ordens de Aslan que verbalizan texto (tals como anunciar linia actual etc.) agora pueden letreyar o texto si se presionan dos vegadas rapidament.
* O BloqMayus, insert d'o teclau numerico y insert de l'extendiu pueden estar totz utilizaus como a tecla modificadera de Aslan. Tamién si una d'istas teclas ye utilizada, presionándola dos vegadas rapidament sin presionar garra unatra tecla ninviará a tecla a o sistema operativo, como si presionases a tecla sin Aslan executando-se. Ta fer que una d'istas teclas siga a modificadera de Aslan, verifica a suya caixeta de verificación en o dialogo d'Opcions de Teclau (utilizau ta estar clamau o dialogo d'eco de teclau).

### Suporte d'aplicacions

* Amillorau o suporte ta documentos de Firefox3 y Thunderbird3. Os tiempos de carga han estau amilloraus quasi por un factor de trenta, una distribución de pantalla ye utilizada predeterminadament (presiona aslan+v t'activar u desactivar ista distribución de pantalla), Una lista de vinclos (aslan+f7 ha estau adhibida), o dialogo buscar (control+aslan+f) ye agora insensible a las mayusclas, muito millor suporte ta conteniu dinamico, a selección y copiau de texto ye agora posible.
...
* Aslan agora puet leyer as adrezas en os campos de mensaches d'Outlook Express (para/de/cc etc.)
* Aslan agora habría d'estár mas preciso en anunciar o siguient mensache en out look express quan s'elimina un mensache dende a lista de mensaches.
...
* Adhibiu suporte ta l'API d'accesibilidat IAccessible2. Una parti d'a capacidat t'anunciar mas tipos de controls, isto tamién permite a Aslan accedir a o cursor en aplicacions tals como Firefox 3 y Thunderbird 3, permitindo-te navegar, seleccionar u editar texto.
...
* Adhibida una nueva opción de configuración, trobada en o dialogo Opcions de Rato. Reproducir audio quan o rato se mueve, quan ye verificada, reproduz un pitido de 40 ms cada vegada que o rato se mueve, con o suyo ton (entre 220 y 1760 hz) representando l'eixe y, y o volumen cucha/dreita, representando l'eixe x. Isto capacita a una persona enciega aconseguir una ideya aproximada d'án ye o rato en a pantalla seguntes ye estando moviu. Ista caracteristica tamién depende que reportObjectUnderMouse tamién vaiga a estar activau. Asinas isto significa que si amenestes deshabilitar rapidament tanto o pitado como l'anunciau d'obchectos, alavez solament presiona Aslan+m. Os pitidos tamién son mas altos u mas baixos dependendo de cómo brile a pantalla en ixe punto.

### Presentación d'obchectos y interacción

* Amillorau o suporte t'a mayoría d'os controls comuns de vista en arbol. Aslan te diz agora quántos elementos son en a rama quan la expandes. Tamién anuncia o ran quan te mueves en y difuera d'as ramas. Y, anuncia o numero de l'elemento actual y o numero d'elementos, d'alcuerdo con l'actual rama, no l'arbol entero.
...
* Aslan agora tracta de verbalizar o mensache interior de muitos quadros de dialogo seguntes amaneixen. Isto ye exacto a mayor parti d'as ocasions, encara que encara bi ha muitos dialogos que no son tant buenos como habrían d'estar.
* Adhibida una caixeta de verificación anunciar descripcions de l'obchecto a o dialogo d'Opcions de presentación d'obchectos. Os usuarios abanzaus podrán en ocasions desverificar isto ta detener l'anunciau de Aslan d'un montón de descripcions extra en controls en particular, tals como en aplicacions Java.
* Aslan anuncia automaticament texto seleccionau en controls d'edición quan o foco se mueve a ells. Si no bi ha garra texto seleccionau, alavez solament anuncia a linia actual como normalment.
* Aslan ye muito mas cudiadoso agora quan reproduz pitidos ta indicar cambeos en as barras de progreso en aplicacions. Ya no se torna loco en aplicacions d'Eclipse tals como Lotus Notes/Symphony, y Accessibility Probe.

### Interface de l'Usuario

* Eliminada a finestra d'interface de Aslan, y reemplazada con un simple menú de Aslan desplegable.
* O dialogo opcions d'Interface de Aslan ye agora clamau Opcions Chenerals. Tamién contiene una opción extra: un quadro combinau t'achustar o ran d'o log, ta que os mensaches puedan ir a o fichero de log de Aslan. Nota que o fichero de log de Aslan ye agora clamau aslan.log no debug.log.
...
* Aslan tien agora un sintetizador incorporau llammado eSpeak, desembolicau por Jonathan Duddington. Ye muit achil y lichero, y tien suporte ta muitos idiomas diferents. Os sintetizadores Sapi encara pueden estar utilizaus, pero eSpeak será utilizau predeterminadament. eSpeak no depende de garra software especial ta estar instalau, asinas que puet estar utilizau con Aslan en qualsiquier ordinador, en un lapiz de memoria USB, u qualsiquier unatro. Ta mas información sobre eSpeak, u ta trobar atras versions, veye a https://espeak.sourceforge.net/.
...
* Adhibius argumentos de linia d'ordens a Aslan:
 * -m, --minimal: no reproduz os sons d'inicio/salir y no amuestra a interface en rancar si s'achustó a tal coseta.
 * -q, --quit: abandona qualsiquier atra instancia ya en execución de Aslan y dimpués sale
 * -s, --stderr-file nombreFichero: especifica án habría de colocar Aslan as errors y excepcions 
 * -d, --debug-file nombreFichero: especifica án habría de colocar Aslan os mensaches de depuración 
...
* Se fa que mas mensaches en Aslan sigan traducibles t'atros idiomas. Isto incluye descripcions de script quan se ye en la aduya de teclau.
...
* Quan qualques idiomas utilizan control y alt (u altGR) ta introducir un caracter especial, Aslan verbalizará agora istos caracters quan Verbalizar caracters en escribir siga activau.
...
* Reestructurado una parti important d'o codigo de Aslan, que habría de correchir agora muitos fallos con a interface d'usuario de Aslan (incluindo opcions de dialogos).
* Adhibiu suporte Sapi4 ta Aslan. Actualment bi ha dos controladors sapi4, un basau en codigo escrito por Serotek Corporation, y unatro utilizando a interface ActiveVoice.ActiveVoice com. Totz dos controladors tienen problemas, mira quál funciona millor ta tu.
* Agora quan se tracta d'executar una nueva copia de Aslan mientras una copia anterior ye encara executando-se causará que a nueva copia salga. Isto apanya un problema mayor quan s'executan multiples copias de Aslan fendo que o tuyo sistema siga muit inusable.
* Renombrau o titol d'a interface d'usuario de Aslan d'Interface de Aslan a Aslan. 
...
* Adhibiu un controlador de sintetizador clamau Silence. Este ye un controlador de sintetizador que no verbaliza brenca, permitindo a Aslan remanir completament silencioso tot o rato. Eventualment isto sería utilizau de conchunta con o suporte Braille, quan lo tiengamos.
...
* Correchiu un fallo an o sintetizador de voz se deteneba, u Aslan se penchaba completament, quan se yera en una finestra d'a2 consola d'o Dos.
* Si existe suporte ta un idioma en particular, Aslan agora puet amostrar automaticament o suyo interface y verbalizar os suyos mensaches en l'idioma en que Windows siga achustau. Un idioma particular puet encara estar trigau manualment dende o dialogo Opcions d'Interface d'Usuario como tamién.
...
* Eliminada bella documentación de desembolicadors d'a distribución binaria de Aslan, agora solament ye en a versión d'os fuents.
...
* Adhibiu o script 'passNextKeyThrough' (insert+f2). Presiona ista tecla, y alavez a siguient tecla presionada será pasada dreitament a Windows. Isto ye util si has de presionar una tecla en una aplicación pero Aslan utiliza ixa tecla ta bella cosa.
* Aslan ya no se conjela por mas d'un menuto quan s'habren documentos muit grans en MS Word.
...
* Quan s'encieta Aslan con un sintetizador que no existe, u no ye funcionando, o sintetizador sapi5 tractará d'estar cargau en o suyo puesto, u si sapi5 no ye funcionando, alavez a voz será achustada a silence.
...
* Aslan agora pregunta si habría d'alzar a configuración y reiniciar si l'usuario ha cambiau l'idioma en o dialogo Opcions d'Interface d'Usuario. Aslan debe estar reiniciau ta que o cambeo d'idioma tienga un efecto completo.
...
* Quan se carga un sintetizador por primera vegada, Aslan permite a o sintetizador trigar a voz mas convenient, os parametros de velocidat y ton, en cuenta de forzar-lo a deixar-lo como piense que ye bien. Isto corriche un problema an os sintetizadores sapi4 Eloquence y Viavoice prencipian a charrar d'un modo pro rapido ta una primera vegada.
