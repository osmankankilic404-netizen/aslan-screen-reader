# Guida de l'Usuario d'o Aslan Aslan_VERSION

[TOC]

<!-- KC:title: Aslan Aslan_VERSION Referencia Rapida d'Ordens  -->



## Introducción {#Introduction}

Bienveniu/bienvenida en o Aslan!

O NonVisual Desktop Access (Aslan) ye un lector de pantalla libre y de codigo ubierto  pa o Sistema Operativo  Microsoft Windows.
...
O Aslan ye desembolicau por [NV Access](https://www.nvaccess.org/), con  colaboracions d'a comunidat.

### Caracteristicas chenerals {#GeneralFeatures}

O Aslan permite a personas ciegas y deficients visuals d'accedir y interactuar con o Sistema Operativo Windows y muitas aplicacions de tercers. 
...
Actualment o Aslan ye estau traduciu en 54 idiomas antiparti de l'anglés incluindo: Afrikaans, albanés, amárico, arabe, aragonés, Burmés, catalán, chinés tradicional y simplificau, crovata, checo, danés, holandés, farsi, finlandés, francés, gallego, griego, Cheorchiano, alemán (Alemania y Suiza), hebreu, hindi, hungaro, islandés, irlandés, italián , chaponés, Kyrgyz, coreán, lituánn, Macedonio, Mongol, nepalí, noruego, polaco, portugués (Brasil y Portugal), panyabí, rumano, ruso, serbio, eslovaco, esloveno, espanyol (Eespanya y Colombia), sueco, tamil, tailandés, turco, ucrainés, virmán y vietnamita.

### Suporte de Sintesi de Voz {#SpeechSynthesizerSupport}

Amás de furnir os suyos mensaches y interficie en quantos idiomas, o Aslan tamién puet posibilitar a l'usuario pa leyer contenius en qualsiquier idioma, malas que tiengan un sintetizador de voz que pueda charrar ixe idioma en particular. 

O Aslan ye equipau con [eSpeak NG](https://github.com/espeak-ng/espeak-ng), un sintetizador de voz multilingüe, libre, de codigo ubierto.

Se puet trobar información sobre atros sintetizadors de voz que suporta lo Aslan en a sección [Sintetizadors de Voz suportaus](#SupportedSpeechSynths).

### Suporte Braille {#BrailleSupport}

Pa los usuarios que poseigan una linia de braille dinamico, lo Aslan puet amostrar a suya información en braille. 
Tamién se suporta tanto la dentrada de braille no contraito como contraito a traviés d'un teclau braille.
Amás lo Aslan detectará muitas linias braille automaticament de traza predeterminada.
...
O Aslan suporta codigos braille pa muitos idiomas, incluindo codigos braille contraito, no contraito y computerizau.

### Licencia y dreitos d'autor {#LicenseAndCopyright}

Lo Aslan ye copyright Aslan_COPYRIGHT_YEARS por los colaboradors d'o Aslan.

Lo Aslan ye disponible baixo la licencia publica cheneral de GNU  versión 2, con dos excepcions especials. 
...
Lo Aslan tamién incluye y emplega components que son disponibles baixo diferents licencias de codigo ubierto y franco.
...
Pa detalles arredol d'as excepcions, accede t'o documento d'a licencia dende lo menú d'o Aslan baixo la sección d'"aduya".
...
* Pa lo Windows 7 lo Aslan requier  lo Service Pack 1 u superior.
* Pa lo Windows Server 2008 R2 lo Aslan requier  lo Service Pack 1 u superior.
* A lo menos 150 MB d'espacio d'almagazenamiento.

## Obtenendo y Instalando lo Aslan {#GettingAndSettingUpAslan}

Si agún no tiens una copia d'o Aslan, puetz descargar-la dende [la pachina web de NV Access](Aslan_URL).

Ves t'a sección download y bi trobarás un vinclo pa descargar la zaguer versión d'o Aslan.

En executar lo fichero que has descargau prencipiará una copia temporal d'o Aslan.
 Allora te se preguntará si quiers instalar o Aslan, creyar una copia portable, u nomás continar emplegando a copia temporal.

Si planeyas emplegar siempre lo Aslan en iste ordinador, trigarás instalar lo Aslan.
A lo instalar Aslan permitirás funcionalidat adicional tal como tener-lo encetau automaticament dimpués d'autentificar-te, que siga capaz de leyer as pantallas d'autentificación de Windows y as pantallas seguras (coseta que las copias portables y temporals no pueden fer), y a creyación d'os alcorces d'o menú Encieto y d'o Escritorio.
A copia instalable tamién ye capable de creyar una copia portable por si mesma en qualsiquier momento.

Si quiers tener o Aslan con tu en un lapiz USB u unatro meyo portatil, allora habrías a trigar creyar una copia portable.
A copia portable tamién tien a capacidat d'instalar-se en qualsiquier ordinador en una con posterioridat.
Manimenos, si deseyas copiar o Aslan en un meyo de nomás lectura tal como un CD, solament habrías de copiar o paquet descargau.
Executar a versión portable dreitament dende meyos de nomás lectura no ye suportau por agora.

Emplegar a copia temporal d'o Aslan ye tamién una opción, p. eix.: con propositos de contrimostración, ya que encetar o Aslan d'iste modo cada vez puet plegar a estar muit incomodo.

### Restriccions d'as Copias Portable y Temporal {#PortableAndTemporaryCopyRestrictions}

Amás d'a incapacidat d'encetar-se automaticament entre y/u dimpués de l'autentificación, as copias portable y temporal d'o Aslan tamién tienen as siguients restriccions:

* A incapacidat pa interactuar con as aplicacions que s'executen con privilechios d'administrador, a lo menos que, profés, o mesmo Aslan tamién siga estau executau con istos privilechios (no ye recomendable).
...
### Instalando lo Aslan {#InstallingAslan}

Si t'instalas o Aslan dreitament dende o paquet descargau d'o Aslan, preta o botón Instalar o Aslan.
Si ya has zarrau iste dialogo, u quiers instalar-lo dende una copia portable, por favor triga l'elemento de menú Instalar o Aslan que se troba baixo Ferramientas en o menú Aslan.

O dialogo d'instalación que amaneix confirmará si quiers instalar o Aslan, y tamién te dirá si ista instalación esviellará una instalación anterior.
en Pretar o botón Continar prencipiará a Instalación d'o Aslan.
...
En pretar Acceptar en iste punto se reiniciará la copia nueva instalada d'o Aslan.
...
#### Emplegar lo Aslan entre que s'inicia la sesión {#StartAtWindowsLogon}

Ista opción te permite trigar si lo Aslan habría a rancar automaticament u no pas entre que inicias la sesión en o Windows, antis de no haber ficau garra clau.
...
Ista opción te permite trigar si o Aslan habría a creyar u no pas un alcorce en o escritorio ta encetar o Aslan. 
Si en ye creyau, a iste alcorce tamién le'n asignará un alcorce de teclas control+alt+n permitindo-te encetar o Aslan en qualsiquier inte con ista combinación de teclas.

#### Copiar la configuración portable de l'actual cuenta d'usuario {#CopyPortableConfigurationToCurrentUserAccount}

Ista opción te permite trigar si lo Aslan habría a copiar u no pas la configuración de l'usuario de l'actual Aslan en execución en a configuración pa l'usuario actualment autentificau, t'a copia instalada d'o Aslan. 
...
Si se creya una copia portable dreitament dende o paquet descargau d'o Aslan, simplament preta o botón Creyar Copia Portable.
Si ya has zarrau iste dialogo u yes executando una copia instalada d'o Aslan, triga l'elemento de menú Creyar una Copia Portable que se troba baixo Ferramientas en o menú Aslan.
...
Tamién bi ha una opción ta trigar si o Aslan habría a copiar a sesión de configuración actual de l'usuario d'o Aslan ta emplegar-la con a nueva copia portable creyada.
...
## Prencipiando con o Aslan {#GettingStartedWithAslan}
### Lanzando lo Aslan {#LaunchingAslan}

Si has instalau o Aslan con l'instalador, allora rancar Aslan ye tant facil como pretar control+Alt+n, u trigar Aslan dende lo menú d'o Aslan en o menú d'inicio, submenú Programas. 
Adicionalment puetz tecliar Aslan en o dialogo Executar y pretar l'Intro.
Si lo Aslan ya se ye executando allora se renchegará.
...
Pa las copias instaladas, o Aslan almagazena la configuración en a carpeta roaming application data de l'usuario actual por defecto (p. eix. "C:\Users\<user>\AppData\Roaming").
Ye posible cambiar ixo de forma que lo Aslan cargue a suya configuración dende a carpeta local de datos d'aplicación en cuenta.
Consulta la sección arredol de [parámetros d'o sistema](#SystemWideParameters) pa mas detalles.

Pa rancar la versión portable, ves t'o directorio que i descomprimiés lo Aslan y preta l'intro u fe doble clic sobre aslan.exe.
Si lo Aslan ya yera en execución, s'aturará automaticament dimpués de rancar la versión portable.

En que o Aslan ranque en primeras escuitarás un grupo ascendent de tons (que te dicen que o Aslan ye cargando-se). 
Pendendo cuán rapido siga o tuyo ordinador, u si yes executando lo Aslan dende un lapiz USB u belatro meyo lento, podrá demorar un poquet mientras ranca. 
Si ye tardando un tiempo extra largo en rancar, o Aslan habría a dicir "Se ye cargando lo Aslan. Aspera por favor...”

Si no escuitas brenca d'isto, escuitas o son d'error de Windows, u un grupo descendent de tons, allora isto significa que o Aslan tien una error, y posiblement amenesterás informar d'un fallo a os desembolicadors. 
Por favor investiga en o puesto Web d'o Aslan pa saber cómo fer ixo.

#### Dialogo de bienvenida {#WelcomeDialog}

Quan o Aslan ranque por primer vez, se te dará a bienvenida por meyo d'un quadro de dialogo que te furne bella información basica sobre a tecla modificadera d'o Aslan y d'o menú d'o Aslan. 
...
La primer caixeta de verificación te permite controlar si lo Aslan habría de fer servir lo BloqMayus como una tecla modificadera d'o Aslan.
La segunda especifica si lo Aslan habría de rancar automaticament dimpués d'autentificar-te en o Windows y nomás ye disponible pa copias instaladas d'o Aslan.
La tercera te permite controlar si iste dialogo de bienvenida habría d'amaneixer cada vez que lo Aslan ranque.

#### Dialogo d'estatisticas de datos d'uso {#UsageStatsDialog}

A partir d'o Aslan 2018.3, se pregunta a l'usuario si quiere permitir que los datos d'uso se ninvien ta NV Access pa aduyar a amillorar-lo en o futuro. 
En iniciar lo Aslan por primer vez, amaneixerá un dialogo que te preguntará si quiers acceptar lo ninvio de datos ta NV Access entre que lo emplegas.
Puetz leyer mas información sobre los datos replegaus por NV Access en a sección d'opcions chenerals, [permitir a lo prochecto Aslan que replegue estatisticas d'emplego d'o Aslan](#GeneralSettingsGatherUsageStats).
Nota: en pretar en "sí" u "no" s'alzará ixe achuste y lo dialogo no amaneixerá nunca mas de no estar que reinstales lo Aslan.
Manimenos, puetz enchegar u desenchegar lo proceso de replega de datos a man en o panel d'as opcions chenerals d'o Aslan. Pa cambiar ixa opción a man, puetz marcar u desmarcar la caixeta de verificación clamada [permitir a lo prochecto Aslan que replegue estatisticas d'emplego d'o Aslan](#GeneralSettingsGatherUsageStats).

### Sobre as Ordens de teclau d'o Aslan {#AboutAslanKeyboardCommands}
#### A Tecla Modificadera d'o Aslan {#TheAslanModifierKey}

A mayoría d'as ordens especificas de teclau d'o Aslan consisten normalment en a pulsación d'a tecla modificadera d'o Aslan, de conchunta con una u mas teclas. 
...
O Aslan puet configurar-se de traza que a tecla Insert d'o teclau numerico, a Insert de l'extendiu y/u o BloqMayus puedan emplegar-sen como teclas modificaderas d'o Aslan.
...
Si deseyas fer que una d'as teclas modificaderas d'o Aslan actúe como usualment si o Aslan no estase enchegau (por eixemplo deseyas activar o BloqMayus quan tiens configurada o BloqMayus ta que siga una tecla modificadera d'o Aslan) puetz pretar a tecla dos veces en succesión rapida.

#### Distribucions de Teclau {#KeyboardLayouts}

Actualment o Aslan vien con dos conchuntos de  teclas d'ordens conoixidas como distribucions de teclau: a distribución sobremesa y a distribución portátil.
De traza predeterminada o Aslan ye configurau pa emplegar a distribución de sobremesa, anque puetz cambiar t'a distribución de portatils en a categoría de teclau d'o dialogo d'[opcions d'o Aslan](#AslanSettings) que se troba baixo as preferencias en o menú Aslan.
...
### Cenyos tactils d'o Aslan {#AslanTouchGestures}

Si yes executando lo Aslan en un dispositivo con una pantalla tactil y yes executando lo Windows 8 u superior, tamién puetz controlar lo Aslan dreitament a traviés de cenyos tactils.
Entre que lo Aslan siga en execución, fueras que lo suporte d'interacción tactil siga desenchegau, toda la dentrada tactil irá dreitament t'o Aslan. 
Por tanto, las accions que puedan efectuar-sen normalment sin o Aslan no funcionarán.
<!-- KC:beginInclude -->
Pa conmutar lo suporte d'interacción tactil, preta Aslan+control+alt+t.
<!-- KC:endInclude -->
Tamién puetz enchegar u desenchegar lo [suporte d'interacción tactil](#TouchSupportEnable) dende la categoría d'interacción tactil d'as opcions d'o Aslan.
...
Quan se describa las ordens d'o Aslan d'agora en adebant en ista guida de l'usuario, podrán listar un cenyo tactil que se puet emplegar pa enchegar ixa orden con a pantalla tactil.
...
Si o mesmo toque se realiza una u mas veces en succesión rapida, Aslan lo tractará en cuenta como un cenyo multi-toque.
...
Tal como bi ha muitas ordens d'o Aslan tamién bi ha atros cenyos tactils. O Aslan tien quantos modos tactils entre os quals puetz cambiar, que fan disponibles bells subconchuntos d'ordens.
Totz dos modos que existen por agora son o modo de texto y o modo d'obchecto. 
Bellas ordens d'o Aslan amostradas en iste documento podrán tener un modo tactil amostrau entre parentesi dimpués d'o cenyo tactil.
...
En que trobes a tecla que deseyes pretar, toca dos veces a tecla u devanta o dido, seguntes las opcions trigadas dende la [categoría d'opcions d'interacción tactil](#TouchInteraction) d'as preferencias d'o Aslan.
...
T'activar l'aduya de dentrada, preta Aslan+1.
Pa desactivar-la, preta Aslan+1 de nuevas.
...
### O Menú d'o Aslan {#TheAslanMenu}

O menú Aslan te permite controlar as opcions d'o Aslan, acceder ta l'aduya, alzar/tornar t'a tuya configuración, Modificar os diccionarios d'a fabla, leyer o fichero d'o rechistro, y salir d'o Aslan.

Pa desplegar o menú Aslan dende qualsiquier puesto d'o Windows mientras o Aslan se siga executando, preta Aslan+n en o teclau u fe un dople toque con 2 didos en a pantalla tactil. 
Tamién puetz desplegar o menú Aslan a traviés d'a servilla de sistema d'o Windows.
u fendo clic con o botón dreito sobre l'icono Aslan trobau en a servilla de sistema, u accedindo t'a servilla de sistema pretando a tecla con o logo de Windows+B, flecha abaixo dica l'icono d'o  Aslan y pretando a tecla aplicacions trobada de seguida a la tecla de control d'a dreita en a mayoría d'os teclaus. 
Quan amaneixca o menú, puetz emplegar as teclas de cursor pa navegar por o menú, y a tecla intro pa enchegar bell elemento.

### Comandos Basicos d'o Aslan {#BasicAslanCommands}

<!-- KC:beginInclude -->

| Nombre |Tecla escritorio |tecla portatil |Tactil |Descripción|
|---|---|---|---|---|
|Rancar u reenchegar lo Aslan |Control+alt+n |Control+alt+n |no |Ranca u reenchega lo Aslan dende lo Escritorio si ixe alcorce d'o Windows s'enchega mientras lo proceso d'instalación d'o Aslan. Iste ye un alcorce especifico d'o Windows conque no se puede reasignar en o dialogo de cenyos de dentrada.|
...
|Menú d'o Aslan |Aslan+n |Aslan+n |dople toque con 2 didos |desplega lo menú d'o Aslan pa permitir-te accedir ta preferencias, ferramientas, aduya etc.|
|Commutar lo Modo d'Aduya de dentrada |Aslan+1 |Aslan+1 |no |Pretando qualsiquier tecla  en iste modo s'anunciará la tecla, y la descripción de qualsiquier orden d'o Aslan asociada con ella|
|Commutar lo Modo de Voz |Aslan+s |Aslan+s |no |Commuta lo modo de voz entre charrar, chuflius y desactivau.|
|Salir d'o Aslan |Aslan+q |Aslan+q |no |Sale d'o Aslan|
|Deixar pasar la siguient tecla |Aslan+f2 |Aslan+f2 |no |Diz a lo Aslan que deixe pasar la siguient tecla pretada dreitament ta l'aplicación activa, si ye tractada por un regular como una tecla d'ordens d'o Aslan|
|activar y desactivar lo modo d'aplicación silencioso |Aslan+mayus+s |Aslan+mayus+z |no |Lo modo silencioso desactiva todas las ordens d'o Aslan y la salida de voz/braille pa l'aplicación actual. Isto ye mas util en aplicacions que furneixen la suya propia voz u caracteristicas de lectura de pantalla. Preta ista orden nuevament pa desactivar lo modo silencioso.|
...
|---|---|---|
|Anunciar la calendata/hora |Aslan+f12 |Pretando-lo una vez anuncia la hora actual, pretando-lo dos veces anuncia la calendata.|
|Anunciar lo estau d'a batería |Aslan+mayus+b |Anuncia lo estau d'a batería, ye decir si la electricidat ye emplegando-se u lo porcentache actual d'a carga.|
|Anunciar lo texto en o portafuellas |Aslan+c |Anuncia lo Texto en o portafuellas si bi'N ha belún.|

<!-- KC:endInclude -->

## Navegando con o Aslan {#NavigatingWithAslan}

O Aslan te permite d'explorar y navegar o sistema de quantas trazas, incluindo interacción normal y revisión.
...
|---|---|---|---|
|Anunciar lo foco actual |Aslan+tabulador |Aslan+tabulador |anuncia l'obchecto actual u lo control que tienga lo foco d'o sistema. Pretando-lo dos veces letriará la información|
|Anunciar lo titol |Aslan+t |Aslan+t |Anuncia lo titol d'a finestra activa actualment. Pretando-lo dos veces letriará la información. Pretando-lo tres veces la copiará t'o portafuellas|
|Leyer la finestra activa |Aslan+b |Aslan+b |leye totz los controls en a finestra actualment activa (util pa dialogos)|
|Anunciar la Barra d'Estau |Aslan+fin |Aslan+mayus+fin |Anuncia la barra d'estau si lo Aslan en troba una. En pretar dos veces letreya la información. En pretar tres veces lo copiará en o portafuellas|
...
Lo Aslan anunciará seguntes te muevas por caracters, parolas, linias, y tamién anunciará la selección y no selección de texto.

Lo Aslan furneix las siguients teclas d'ordens en relación a lo cursor d'o sistema:
<!-- KC:beginInclude -->

| nombre |tecla sobremesa |tecla portatil |descripción|
|---|---|---|---|
|Leyer-lo tot |Aslan+flecha abaixo |Aslan+A |Prencipia la lectura dende la posición actual d'o cursor d'o sistema movendo-lo seguntes se desplaza|
|Leyer la linia actual |Aslan+flecha alto |Aslan+L |Leye la linia en que siga situau actualment lo cursor d'o sistema. Pretando-lo dos veces letreya la linia. Pretando-lo tres veces letreya la linia fendo servir descripcions de caracters.|
|Leyer la selección de texto actual |Aslan+mayus+flecha alto |Aslan+mayus+S |Leye qualsiquier texto seleccionau actualment|
|Anunciar lo formato de texto |Aslan+f |Aslan+f |Anuncia lo formato d'o texto en que siga situau actualment lo cursor. Pretando-lo dos veces amuestra la información en o modo de navegación|
...
Quan te'n muevas ta un obchecto, o Aslan l'anunciará de modo semellant a l'anunciau d'o foco d'o sistema.
...
|---|---|---|---|---|
|Anunciar l'obchecto actual |Aslan+5 Teclau numerico |Aslan+control+i |no |Anuncia lo navegador d'obchectos actual. Pretando-lo dos veces letreya la información y pretando-lo 3 veces copia ixe nombre y valor de l'obchecto en o portafuellas.|
|Navegar ta l'obchecto contenedor |Aslan+8 teclau numerico |Aslan+mayus+i |eslizar ent'alto (Modo d'obchecto) |Navega t'o contenedor d'o navegador d'obchectos actual|
|Navegar ta l'obchecto anterior |Aslan+4 teclau numerico |Aslan+control+j |eslizar t'a cucha (modo d'obchecto) |Navega ta l'obchecto dreitament antis de l'actual navegador d'obchectos|
|Navegar t'o siguient obchecto |Aslan+6 teclau numerico |control+Aslan+l |eslizar t'a dreita (modo d'obchecto) |Navega ta l'obchecto dreitament dimpués de l'actual navegador d'obchectos|
|Navegar t'o primer obchecto conteniu |Aslan+2 teclau numerico |Aslan+mayus+coma |eslizar ent'abaixo (modo d'obchecto) |Navega t'o primer obchecto conteniu por l'actual navegador d'obchectos|
|Navegar t'a fin d'o foco |Aslan+Menos teclau numerico |Aslan+Retroceso |no |Navega ta l'obchecto que tien actualment lo foco d'o sistema, y tamién coloca lo cursor de revisión en a posición d'o cursor d'o Sistema, si s'amuestra|
|Activar l'actual navegador d'obchectos |Aslan+Intro teclau numerico |Aslan+Intro |dople toque |Activa l'actual navegador d'obchectos (semellant a fer clic con o churi u pretar l'espacio quan tien lo foco d'o sistema)|
|Mover lo foco d'o Sistema ta l'actual navegador d'obchectos |Aslan+mayus+Menos teclau numerico |Aslan+mayus+retroceso |no |pretau una vez Mueve lo foco d'o Sistema t'o navegador d'obchectos actual, pretau dos veces mueve lo cursor d'o sistema t'a posición d'o cursor de revisión|
|Anunciar la ubicación d'o cursor de revisión |Aslan+Suprimir teclau numerico |Aslan+suprimir |no |Anuncia información arredol d'a ubicación d'o  texto u obchecto en o cursor de revisión.  Por eixemplo ixo puet incluir o porcentache  a traviés d'o documento a distancia dende lo canto d'a pachina u  la posición exacta en a pantalla. En pretar-lo dos veces puet anunciar-se-ne mas información.|
|Mover lo cursor de revisión t'a barra d'estau |garra |garra |garra |Anuncia la barra d'estau  si lo Aslan en troba una. Tamién mueve lo navegador d'obchectos ta ixa ubicación.|
...
Lo Aslan te permite leyer lo conteniu d'a [pantalla](#ScreenReview), [documento actual](#DocumentReview) u l'[obchecto actual](#ObjectReview) por caracters, parolas u linias.
...
| Nombre |Tecla Sobremesa |Tecla Portatil |Tactil |Descripción|
|---|---|---|---|---|
|mover-se t'a linia superior en revisión |mayus+7 teclau numerico |Aslan+7 |no |Mueve lo cursor de revisión t'a linia superior d'o texto|
|Mover-se t'a linia anterior en revisión |7 teclau numerico |Aslan+u |eslizar enta alto (modo de texto) |Mueve lo cursor de revisión t'a linia anterior de texto|
|Anunciar la linia actual en revisión |8 teclau numerico |Aslan+i |no |Anuncia la linia actual de texto en do siga colocau lo cursor de revisión. Pretando-lo dos veces letreya la linia, Pretando-lo tres veces letreya la linia emplegando descripcions de caracters.|
|Mover-se t'a linia siguient en revisión |9 teclau numerico |Aslan+u |eslizar enta abaixo (modo de texto) |Mueve lo cursor de revisión t'a linia siguient de texto|
|Mover-se t'a linia inferior en revisión |mayus+9 teclau numerico |Aslan+9 |no |Mueve lo cursor de revisión t'a linia inferior de texto|
|Mover-se t'a parola anterior en revisión |4 teclau numerico |Aslan+j |eslizar con 2 didos t'a cucha (modo de texto) |Mueve lo cursor de revisión t'a parola anterior en o texto|
|Anunciar la parola actual en revisión |5 teclau numerico |Aslan+k |no |Anuncia la parola actual en o texto en do siga colocau lo cursor de revisión. Pretando-lo dos veces letreya la parola, pretando-lo tres veces letreya la parola emplegando descripcions de caracters.|
|Mover-se t'a siguient parola en revisión |6 teclau numerico |Aslan+l |desplazar con 2 didos ta la dreita (modo de texto) |Mueve lo cursor de revisión t'a siguient parola en o texto|
|mover-se ta l'inicio d'a linia en revisión |mayus+1 teclau numerico |Aslan+mayus+u |no |Mueve lo cursor de revisión t'o comienzo d'a linia actual en o texto|
|Mover-se t'o caracter anterior en revisión |1 teclau numerico |Aslan+m |eslizar t'a cucha (modo de texto) |Mueve lo cursor de revisión t'o caracter anterior en a linia actual en o texto|
|Anunciar lo caracter actual en revisión |2 teclau numerico |Aslan+coma |no |Anuncia lo caracter actual en a linia de texto en do siga colocau lo cursor de revisión. Pretando-lo dos veces anuncia una descripción u eixemplo d'ixe caracter. Pretando-lo tres veces anuncia la valor numerica d'o caracter en decimal y hexadecimal.|
|Mover-se t'o siguient caracter en revisión |3 teclau numerico |Aslan+punto |eslizar t'a dreita (modo de texto) |Mueve lo cursor de revisión t'o siguient caracter en a linia actual de texto|
|Mover-se t'a fin d'a linia en revisión |mayus+3 teclau numerico |Aslan+mayus+u |no |Mueve o cursor de revisión t'a fin d'a linia actual de texto|
|Leyer-lo tot con revisión |Mas teclau numerico |Aslan+mayus+Flecha abaixo |eslizar con 3 didos enta abaixo (modo de texto) |Leye dende la posición actual d'o cursor de revisión, movendo-lo seguntes baixa|
|Seleccionar y copiar dende lo cursor de revisión |Aslan+f9 |Aslan+f9 |no |Prencipia lo proceso de selección y copia dende la posición actual d'o cursor de revisión. L'acción actual no se leva a cabo dica que digas a lo Aslan dó ye lo final de rango de texto|
|Seleccionar y copiar en o cursor de revisión |Aslan+f10 |Aslan+f10 |no |En a primer pretada se copia lo texto dende la posición previament  establida como marcador d'inicio dica la posición actual d'o cursor de revisión incluindo-la.  Dimpués de pretar ista tecla una segunda vez se copiará lo texto  en o portafuellas d'o Windows|
|Mover-se t'a marca d'inicio pa copiar en a revisión |Aslan+shift+f9 |Aslan+shift+f9 |no |Mueve lo cursor de revisión t'a posición achustada previament como marca d'inicio pa copiar|
|Anunciar lo formato d'o texto |Aslan+mayus+f |Aslan+mayus+f |no |Informa d'o formato d'o texto en que siga colocau actualment lo cursor de revisión. Pretando-lo dos veces amuestra la información en o modo de navegación|
...
As ordens de revisión de texto d'o Aslan pueden revisar o conteniu adintro d'o navegador d'obchectos actual, documento actual, u pantalla, pendendo d'o modo de revisión seleccionau.
Os modos de revisión son un  reemplazo ta l'antigo concepto de revisión plana d'o Aslan.
...
| Nombre |Tecla Escritorio |Tecla Portatil |Tactil |Descripción|
|---|---|---|---|---|
|Cambiar t'o  modo de revisión siguient |Aslan+7 teclau numerico |Aslan+rePach |eslizar 2 didos enta alto |cambea t'o siguient modo de revisión disponible.|
|Cambiar t'o modo de revisión anterior |Aslan+1 teclau numerico |Aslan+avPach |eslizar 2 didos enta baixo |Cambea ta l'anterior modo de revisión disponible.|
...
Para cuenta que o Aslan cambiará t'a revisión de documentos dende a revisión d'obchectos automaticament quan te muevas por documentos en o modo de navegación.
...
Isto ye semellant a la funcionalidat de revisión de pantalla u cursor d'o churi en muitos atros lectors de pantalla ta Windows.
 ...
 Para cuenta que en qualques aplicacions modernas, o Aslan podría no veyer belún u tot o texto disponible en a pantalla, a causa de l'uso d'as recients tecnolochías de dibuixo en pantalla que son imposibles de suportar en istos intes.

### Navegando con o churi {#NavigatingWithTheMouse}

En que mueves o churi, o Aslan informa de traza predeterminada d'o texto que siga dreitament baixo o puntero d'o mesmo, seguntes se mueva sobre ell. 
Do siga suportau, o Aslan leyerá a valor d'un paragrafo de texto, encara que qualques controls solament podrán leyer-se por linias.

O Aslan tamién puet configurar-se ta anunciar a mena de control u obchecto sobre o qual siga actualment o churi seguntes se mueva (p. eix.: lista, botón etc.). 
Isto podrá estar util ta usuarios ciegos totals quan qualques veces o texto no siga prou.

O Aslan proporciona un modo ta que os usuarios comprendan do ye o churi respective a las dimensions d'a pantalla, fendo sonar as coordenadas actuals d'o churi seguntes l'audio chufle. 
...
Istas caracteristicas extra d'o churi no son activadas de traza predeterminada en o Aslan. 
Si deseyas quitar partiu d'ellas, puetz configurar-las dende la categoría d'[opcions d'o churi](#MouseSettings), d'o dialogo d'[opcions d'o Aslan](#AslanSettings) que se troba en o menú de preferencias d'o Aslan.

Si bien un churi fisico u un trackpad se podrían emplegar pa navegar con o churi, o Aslan furneix bellas ordens relacionadas con o churi:
<!-- KC:beginInclude -->

| Nombre |Tecla sobremesa |Tecla Portatil |Toque |Descripción|
|---|---|---|---|---|
|Clic d'o botón cucho d'o churi |Dividir teclau numerico |Aslan+Flecha cucha |Denguno |Fa clic en o botón cucho d'o churi una vez. Lo común dople clic puet levar-se a cabo pretando ista tecla dos veces en rapida succesión|
|Blocar lo botón cucho d'o churi |mayus+Dividir teclau numerico |Aslan+mayus+Flecha cucha |Denguno |Mantién preto lo botón cucho d'o churi. Preta-lo de nuevo pa liberar-lo. Pa arrocegar lo churi,  preta ista tecla pa blocar lo botón cucho y allora mueve lo churi fisicament u fe servir belatra d'as ordens d'enrutamiento d'o churi|
|Clic d'o botón dreito d'o churi |Multiplicar teclau numerico |Aslan+flecha dreita |Tocar y tener |Fa Clic en o botón dreito d'o churi una vez, por un regular emplegau pa ubrir lo menú contextual en a ubicación d'o churi.|
|Blocar lo botón dreito d'o churi |mayus+Multiplicar teclau numerico |Aslan+mayus+flecha dreita |Denguno |Mantién preto lo botón dreito d'o churi. Preta unatra vez pa liberar-lo. Pa arrocegar o churi,  preta ista tecla  pa blocar lo botón dreito y allora mueve o churi fisicament u fe servir belatra d'as ordens d'enrutamiento d'o churi|
|Mover lo churi t'o navegador d'obchectos actual |Aslan+Dividir teclau numerico |Aslan+mayus+f9 |Denguno |Mueve lo churi t'a posición d'o navegador d'obchectos actual y lo cursor de revisión|
|navegar ta l'obchecto baixo lo churi |Aslan+Multiplicar teclau numerico |Aslan+mayus+f10 |Denguno |Mete lo navegador d'obchectos en l'obchecto localizau en a posición d'o churi|

<!-- KC:endInclude -->

## Modo de navegación {#BrowseMode}

Os documentos complexos de nomás lectura, tals como as pachinas Web, son representaus en o Aslan con un modo de navegación. 
...
Todas las teclas d'ordens d'o [cursor d'o sistema](#SystemCaret) d'o Aslan funcionarán en iste modo; p. eix.: leyer-lo tot, anunciar o formato, ordens de navegación de tabla, etc.
Quan lo [resaltau visual](#VisionFocusHighlight) siga enchegau, la localización d'o foco d'o sistema actual tamién se exposa visualment.
...
Quan se ye en modo Navegación, por defecto, o Aslan cambiará automaticament t'o modo de foco si tabulas ta u fas clic sobre un control en particular que lo requiera.
...
| Nombre |Tecla |Descripción|
|---|---|---|
|Commutar os modos de navegación/foco |Aslan+espacio |Commuta entre o modo de foco y o modo de navegación|
|Salir d'o modo de foco |escape |Cambea t'o modo de navegación si o modo de foco anteriorment heba cambiau automaticament|
|Refrescar o documento en o modo de navegación |Aslan+f5 |Recarga o conteniu d'o documento actual (util si bells contenius pareixen estar desapareixius d'o documento. No disponible en o Microsoft Word y l'Outlook)|
|Mirar |Aslan+control+f |Desplega un dialogo en que puetz tecliar bell texto pa trobar en  o documento actual. Mira-te [mirar texto](#SearchingForText) pa mas información.|
|Mirar a siguient |Aslan+f3 |Troba la siguient  ocurrencia d'o texto en o documento que mirés anteriorment|
|Mirar l'anterior |Aslan+mayus+f3 |Troba la ocurrencia anterior d'o texto en o documento que mirés anteriorment|
|ubrir a descripción luenga |Aslan+d d| Ubre una finestra nueva que contién una descripción luenga ta l'elemento sobre o qual sigas si en tien una.|

<!-- KC:endInclude -->

### Navegación con una sola letra {#SingleLetterNavigation}

Mientras se siga en o modo de navegación, ta una navegación mas rapida o Aslan tamién proporciona teclas d'un solo caracter ta blincar ta bells campos en o documento.
...
Si quiers fer servir-ne sin deixar d'estar capable de fer servir as teclas de cursor ta leyer en o modo de navegación puetz desenchegar temporalment as teclas de navegación d'una sola letra d'o Aslan.
<!-- KC:beginInclude -->
Pa enchegar u desenchegar a navegación d'una sola letra en o documento actual preta Aslan+mayus+espacio.
<!-- KC:endInclude -->
...
| Nombre |Tecla |Descripción|
|---|---|---|
|Lista d'elementos d'o modo de navegación |Aslan+f7 |Desplega a lista d'elementos que contién vinclos, capiters y zonas ARIA d'o documento actual|
...
| Nombre |Tecla |Descripción|
|---|---|---|
|Mirar texto |Aslan+control+f |Ubre lo dialogo de mirar|
|Mirar lo siguient |Aslan+f3 |Mira la siguient ocurrencia d'o termin actual mirau|
|Mirar l'anterior |Aslan+mayus+f3 |Mira la ocurrencia anterior d'o termin actual mirau|
...
Do istas se troben en un modo de Navegación, o Aslan anunciará "obchecto integrau", "aplicación" u "dialogo", respectivament.
...
| Nombre |Tecla |Descripción|
|---|---|---|
|Mover-se-ne t'o conteniu d'o modo de navegación |Aslan+control+espacio |Mueve o foco difuera de l'actual obchecto integrau y lo mete adintro d'o documento que lo contién|

<!-- KC:endInclude -->

## Leyer lo conteniu Matematico {#ReadingMath}

Fendo servir lo MathPlayer 4 de Design Science, lo Aslan puet leyer y navegar interactivament  por lo conteniu matematico suportau.
...
Lo Aslan suporta las siguients menas de conteniu matematico:
...
En leyer un documento, o Aslan charrará qualsiquier conteniu matematico suportau do se produzca.
...
| Nombre |Tecla |Descripción|
|---|---|---|
|Interactuar con conteniu matematico |Aslan+alt+m |Empecipia a interacción con o conteniu matematico.|
...
Si tiens una linia braille lo Aslan puet amostrar información en braille.
...
Ixa sección tamién contién información sobre qué linias son compatibles con a función de detección automatica de linias braille d'o Aslan.
Puetz configurar o braille fendo servir la [categoría d'opcions d'o braille](#BrailleSettings) d'o dialogo d'[opcions d'o Aslan](#AslanSettings).
...
Lo Aslan suporta a dentrada de braille  contraito y no contraito a traviés d'un teclau braille.
Puetz trigar a tabla de transcripción emplegada pa transcribir o braille en o texto fendo servir la opción de [tabla de dentrada](#BrailleSettingsInputTable) en a categoría d'o braille en o dialogo d'[opcions d'o Aslan](#AslanSettings).
...
Tot y que lo Aslan ye endrezau prencipalment a personas ciegas u con problemas de visión que fagan servir prencipalment la voz y/u lo braille pa maniar un ordinador, tamién ufre funcions incorporadas pa cambiar lo conteniu d'a pantalla.
Adintro d'o Aslan, ixa aduya visual se denomina furnidor de millora d'a visión.

Lo Aslan ufre quantos furnidors de millora d'a visión incorporaus que se describe contino.
Se puede proporcionar furnidors adicionals de millora d'a visión en [complementos d'o Aslan](#AddonsManager).

Las opcions d'a visión d'o Aslan pueden cambiar-sen en a [categoría de visión](#VisionSettings) d'o dialogo d'[Opcions d'o Aslan](#AslanSettings).
...
Quan lo resaltau visual ye enchegau en a [categoría de visión](#VisionSettings) d'o dialogo d'[opcions d'o Aslan](#AslanSettings), [puetz cambiar si deseyas u no pas resaltar lo cursor d'o foco, d'o navegador d'obchectos u d'o modo de navegación](#VisionSettingsFocusHighlight).
...
Pa ixa situgación, lo Aslan contiene una caracteristica clamada "cortina de pantalla" que puede enchegar-se pa fer que la pantalla siga negra.

Puetz enchegar la Cortina de Pantalla en a [categoría de visión](#VisionSettings) d'o dialogo d'[opcions d'o Aslan](#AslanSettings).
...
Fe servir lo Aslan 2021.2 pa activar la cortina de pantalla con o Windows 10 21H2 (10.0.19044) u superiors.
...
Lo Aslan suporta la funcionalidat de reconoixencia optica de caracters (OCR) integrada en o Windows 10 y superiors pa reconoixer texto dende imachens.
Puet furnir-se reconoixedors de conteniu adicionals en complementos d'o Aslan.

Quan emplegues un comando de reconoixencia de conteniu, o Aslan reconoix conteniu dende o [navegador d'obchectos](#ObjectNavigation) actual.
...
Lo Aslan puet fer-lo servir pa reconoixer texto dende imachens u aplicacions inaccesibles.

Puetz configurar l'idioma a emplegar pa la reconoixencia de texto en a [categoría d'OCR d'o Windows](#Win10OcrSettings)d'o dialogo d'[opcions d'o Aslan](#AslanSettings).
...
L'OCR d'o Windows puet estar en parti u de raso incompatible con as [milloras d'a visión d'o Aslan](#Vision) u atras aduyas visuals externas. Puetz haber de desenchegar ixas aduyas antis de no proceder con un reconoiximiento.

<!-- KC:beginInclude -->
Pa reconoixer lo texto en l'actual navegador d'obchectos fendo servir l'OCR d'o Windows, preta Aslan+r.
<!-- KC:endInclude -->

## Caracteristicas Especificas pa aplicacións {#ApplicationSpecificFeatures}

O Aslan proporciona as suyas propias caracteristicas extra pa qualques aplicacions pa fer mas facils bells quefers u pa furnir acceso ta funcionalidat que d'unatro modo no ye accesible pa os usuarios d'un lector de pantalla.

### Microsoft Word {#MicrosoftWord}
#### Lectura automatica de capiters de columna y ringlera {#toc63}

O Aslan ye capable d'anunciar automaticament os capiters de ringlera y columna apropiaus en navegar por as tablas en o Microsoft Word.
Ixo requier en primeras que a opción d'anunciar os capiters de ringlera y columna de tabla en o dialogo de formatiau de documentos d'o Aslan, que se troba en o dialogo d'[opcions d'o Aslan](#AslanSettings), siga enchegada.
En segundas o Aslan amenista conoixer qué ringlera u columna contién os capiters en una tabla dada.
...
| Nombre |Tecla |Descripción|
|---|---|---|
|Establir o capitero de columna |Aslan+mayus+c |Pretando isto una vez diz a lo Aslan que ista ye a primera celda de capitero en a ringlera que contién capiters de columna, que habría d'estar anunciada automaticament en mover-te-ne entre columnas baixo ista ringlera. Pretando-ne dos veces sacará ista opción.|
|Establir o capitero de ringlera |Aslan+mayus+r |Pretando isto una vez diz a lo Aslan que ista ye a primera celda de capitero en a columna que contién capiters de ringlera, que habría d'estar anunciau automaticament quan te'n desplaces entre as ringleras dimpués d'ista columna. Pretando-ne dos veces eliminará ista opción.|
...
<!-- KC:beginInclude -->
Pa activar u desactivar o modo de navegación en o Microsoft Word, preta Aslan+espacio.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Mientras yes en o modo de navegación en o Microsoft Word puetz accedir t'a lista d'elementos pretando Aslan+f7.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Pa anunciar qualsiquier comentario en a posición actual d'o puntero preta Aslan+alt+c.
<!-- KC:endInclude -->
Totz os comentarios d'o documento de conchunta con o seguimiento d'atros cambeos tamién se pueden listar en a lista d'elementos d'o Aslan  en seleccionar anotacions como a mena.

### Microsoft Excel {#MicrosoftExcel}
#### Lectura automatica de capiters de columna y ringlera {#ExcelAutomaticColumnAndRowHeaderReading}

O Aslan ye capable d'anunciar automaticament os capiters de ringlera y columna apropiaus en navegar por as tablas en o Microsoft Excel.
Ixo requier en primeras que a opción d'anunciar os capiters de ringlera y columna de tabla en o dialogo de formatiau de documentos d'o Aslan, que se troba en o dialogo d'[opcions d'o Aslan](#AslanSettings), siga enchegada.
En segundas a lo Aslan le fa falta conoixer qué ringlera u columna contién os capiters en una tabla dada.
Dimpués de mover-te-ne t'a primera celda en a columna u ringlera que contién os capiters, fe servir un d'os siguients comandos:
<!-- KC:beginInclude -->

| Nombre |Tecla |Descripción|
|---|---|---|
|Establir a ringlera de capiters de columna |Aslan+mayus+c |Pretando isto una vez diz a lo Aslan que ista ye a ringlera que contién capiters de columna, que habrían d'anunciar-se automaticament quan te'n muevas entre columnas por ista ringlera. Pretando-ne dos veces limpiará a opción.|
|Establir a columna de capiters de ringlera |Aslan+mayus+r |Pretando isto una vez  diz a lo Aslan que ista ye a columna que contién capiters de ringlera, que s'habrían d'anunciar automaticament  quan te'n muevas entre ringleras dimpués d'ista columna. Pretando-ne dos veces limpiará la opción.|
...
Igual como en a  web, o Aslan tien una lista d'elementos t'o Microsoft Excel que te permit  listar y accedir ta quantas menas diferents d'información.
<!-- KC:beginInclude -->
Pa accedir t'a lista d'elementos en l'Excel preta Aslan+f7.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Pa anunciar qualsiquier nota pa la celda actualment enfocada preta Aslan+alt+c.
En o Microsoft 2016, 365 y mas recients, s'ha renombrau los clasicos comentarios d'o Microsoft Excel como "notas".
<!-- KC:endInclude -->
Todas las notas d'a fuella de treballo pueden listar-sen tamién en a lista d'elementos d'o Aslan dimpués de pretar Aslan+F7.

Lo Aslan también puet amostrar un dialogo especifico pa anyadir u editar una determinada nota.
Lo Aslan sobrescribe la rechión d'edición de notas nativa d'o MS Excel a causa de restriccions d'accesibilidat, pero la pretada de tecla pa amostrar lo dialogo s'hereda d'o MS Excel y, por tanto, funciona tamién sin o Aslan executando-se.
<!-- KC:beginInclude -->
Pa anyadir u editar una determinada nota, en bella celda enfocada, preta mayus+f2.
<!-- KC:endInclude -->

Ixe alcorce de teclau no apareix y no se puet cambear en o dialogo de cenyos de dentrada d'o Aslan.
...
Manimenos, ixo ubrirá la rechión d'edición de notas inaccesible y no pas lo dialogo d'edición de notas especifico d'o Aslan.
...
<!-- KC:beginInclude -->
Pa permitir mover-se-ne ta celdas blocadas cambea t'o modo de navegación pretando Aslan+espacio y allora fe servir os comandos estandar de movimiento de l'Excel como as teclas de flecha por todas as celdas en a fuella de treballo actual.
<!-- KC:endInclude -->
...
| Nombre |Tecla |Descripción|
|---|---|---|
|commutar a lectura de notas de l'orador |control+mayus+s |Quan se ye en una presentación en execución, ista orden commutará entre las notas de l'orador t'a diapositiva y o conteniu d'a diapositiva. Isto solament afecta a o que leye o Aslan, no a o que s'amuestra en a pantalla.|
...
| Nombre |Tecla |Descripción|
|---|---|---|
|Anunciar un mensache recient |Aslan+control+1-4 |Anuncia un d'os mensaches recients pendendo d'o numero pretau; p. eix.: Aslan+control+2 leye o segundo mensache mas recient.|
...
Lo Aslan suporta leyer y navegar por libros en l'Amazon Kindle pa PC.
...
O Aslan furne suporte anticipau pa leyer y navegar interactivament en o conteniu matematico pa os libros con matematicas accesibles.
...
En leyer en o modo de navegación o Aslan se refier a istas notas como comentarios.
...
Lo Aslan furneix compatibilidat pa la consola de comandos d'o Windows emplegada por l'indicativo d'o sistema, PowerShell, y lo  subsistema Windows pa Linux.
...
Lo texto que no s'amuestra visiblement en a finestra no ye accesible con os comandos de revisión de texto d'o Aslan.
Por tanto, ye necesario desplazar-se por la finestra d'a consola pa leyer lo texto anterior.
<!-- KC:beginInclude -->
Los siguients metodos abreviaus de teclau incorporaus en a Consola d'o Windows pueden estar utils a lo [revisar texto](#ReviewingText) con o Aslan:
...
## Configurando lo Aslan {#ConfiguringAslan}

La mas gran parti d'a configuración puet realizar-se fendo servir dialogos que se i accede por meyo d'o submenú de preferencias d'o menú Aslan.
Muitas d'istas opcions pueden trobar-sen en o dialogo multipachina d'[opcions d'o Aslan](#AslanSettings).
...
### Opcions d'o Aslan {#AslanSettings}

<!-- KC:settingsSection: || Nombre | Tecla Escritorio | Tecla Portatil | Descripción | -->
Lo dialogo d'opcions d'o Aslan contién muitos parametros de configuración que se pueden cambiar.
...
Si deseyas alzar la configuración y zarrar lo dialogo d'opcions d'o Aslan, puetz utilizar lo botón d'acceptar.

Qualques categorías d'opcions tienen un alcorce de teclau adedicau.
Si se preta, ixe alcorce de teclau ubrirá  lo dialogo d'opcions d'o Aslan en ixa categoría en particular.
...
Las categorías  d'opcions que se troba en o dialogo d'opcions d'o Aslan se describirán contino.

#### Cheneral (Aslan+control+g) {#GeneralSettings}

La categoría Cheneral d'o dialogo d'opcions d'o Aslan estableix lo comportamiento cheneral d'o Aslan, como l'idioma d'a interficie y si s'habría de comprebar las actualizacions u no pas.
Ista categoría contién las siguients opcions:

##### Idioma {#GeneralSettingsLanguage}

Isto ye un quadro combinau que te permite seleccionar l'idioma en que habría d'amostrar-se a interficie d'usuario y os mensaches d'o Aslan. 
Bi ha muitos idiomas, manimenos a zaguera esleción en a lista ye clamada "Predeterminau pa l'usuario". 
Ista esleción dirá a lo Aslan que faiga servir l'idioma en que lo Windows siga actualment configurau. 

Por favor para cuenta que lo Aslan ha d'estar reenchegau en que se cambeye l'idioma. 
...
Ista opción ye una caixeta de verificación que quan se marca diz a lo Aslan que alce automaticament l'actual configuración en que salgas d'o Aslan. 

##### Amostrar las opcions de salida en salir d'o Aslan {#GeneralSettingsShowExitOptions}

Ista opción ye una caixeta de verificación que te permite trigar si amaneix u no pas un dialogo en que salgas d'o Aslan que te pregunte qué acción quiers fer.
Quan siga marcada, un dialogo amaneixerá en que intentes salir d'o Aslan preguntando-te si quiers salir, reenchegar, reenchegar con os complementos desenchegaus u instalar actualizacions pendients si bi'n ha.
Quan no siga marcada, se saldrá d'o Aslan inmediatament.

##### Reproducir sons en enchegar u desenchegar lo Aslan {#GeneralSettingsPlaySounds}

Ista Opción ye una caixeta de verificación que quan ye marcada diz a lo Aslan que reproduzca sons quan s'enchegue u desenchegue.

##### Libel de mensaches alzaus en o rechistro {#GeneralSettingsLogLevel}

Isto ye un quadro combinau que te permite trigar quánta información meterá lo Aslan en o rechistro seguntes s'executa. 
...
* Desenchegau: Antiparti d'un breu mensache d'inicio, lo Aslan no rechistrará cosa mientras s'execute.
* Información: Lo Aslan rechistrará la información basica tal como los mensaches d'inicio y información util pa los desembolicadors.
...
##### Rancar lo Aslan automaticament dimpués de que s'inicie la sesión {#GeneralSettingsStartAfterLogOn}

Si ista opción ye activada, lo Aslan rancará automaticament malas que t'autentifiques en o Windows. 
Ista opción nomás ye disponible pa las copias instaladas d'o Aslan.

##### Rancar lo Aslan enentre que s'inicia la sesión (requiere privilechios d'administrador) {#GeneralSettingsStartOnLogOnScreen}

Si t'autentificas en o Windows furnindo un nombre d'usuario y una clau, allora activar ista opción ferá que lo Aslan ranque automaticament en a finestra d'autentificación en que lo Windows ranque. 
Ista opción nomás ye disponible pa las copias instaladas d'o Aslan.
...
En pretar iste botón copias la tuya configuración d'usuario d'o Aslan actualment alzada t'o directorio de sistema de configuración d'o Aslan, de tal forma que lo Aslan lo ferá servir quan s'execute en l'autentificación, en o control de cuentas d'usuario (UAC) y en atras pantallas seguras d'o Windows.
Pa estar seguro que todas as tuyas opcions se transfieren, asegura-te d'alzar en primeras a tuya configuración con control+Aslan+c u alza a configuración en o menú Aslan.
Ista opción solament ye disponible pa las copias instaladas d'o Aslan.

##### Mirar automaticament as actualizacions d'o Aslan {#GeneralSettingsCheckForUpdates}

Si isto ye activau, o Aslan mirará automaticament versions esvielladas y t'informará quan una actualización siga disponible.
Tamién puetz mirar as actualizacions manualment seleccionando Mirar as Actualizacions baixo lo menú d'aduya en o menú Aslan.
En mirar actualizacions manual u automaticament, ye necesario pa Aslan ninviar bella información t'o servidor d'actualizacions pa recibir l'actualización correcta pa lo tuyo sistema.
Se ninvia siempre la siguient información: 

* Versión actual d'o Aslan
* Versión d'o Sistema Operativo
* Si lo Sistema Operativo ye de 64 u de 32 bits

##### Permitir a lo Prochecto Aslan que replegue Estatisticas d'emplego d'o Aslan {#GeneralSettingsGatherUsageStats}

Si isto ye activau, NV Access fará servir la información d'as buscas d'actualizacions pa seguir lo numero d'usuarios d'o Aslan incluyindo datos demograficos particulars tals como lo Sistema Operativo y lo país d'orichen.
...
* Idioma d'a interficie d'o Aslan
* Si ista copia d'o Aslan ye portable u instalada
...
Ixa información aduya enormement a NV Access a priorizar lo desembolique futuro d'o Aslan.

##### Notificar las actualizacions pendients en enchegar {#GeneralSettingsNotifyPendingUpdates}

Si isto ye enchegau o Aslan t'informará en que bi haiga una actualización pendient en echegar-se, ufrindo-te a posibilidat d'instalar-la.
Tamién puetz instalar manualment l'actualización pendient dende lo dialogo de salir d'o Aslan (si ye enchegau), dende o menú Aslan, u en rializar una nueva busca dende o menú d'aduya.

#### Opcions de Voz (Aslan+control+v) {#SpeechSettings}

La categoría de voz en o dialogo d'opcions d'o Aslan contién achustes que te permiten de cambiar lo sintetizador de voz asinas como caracteristicas d'a voz pa lo sintetizador esleixiu.
...
Ixe dialogo s'ubre por dencima d'o dialogo d'opcions d'o Aslan.
Alzando u descartando los achustes en o dialogo de seleccionar lo sintetizador tornarás t'o dialogo d'opcions d'o Aslan.
...
Si yes emplegando lo sintetizador Espeak NG empaquetau de conchunta con o Aslan, Iste ye un quadro combinau que te permite seleccionar la variant con que lo sintetizador habría de charrar. 
...
Ista caixeta de verificación te permite d'activar u de desactivar si lo Aslan habría de cambiar los idiomas d'o sintetizador de voz automaticament si lo texto pa leyer especifica lo suyo idioma.
...
Enchegada por defecto, ista opción le diz a lo Aslan si se puet confidar en l'idioma d'a voz actual en procesar simbolos y caracters .
Si trobas que lo Aslan ye leyendo puntuación en l'idioma incorrecto  pa bell sintetizador u voz particular  puetz querer  desenchegar ixo pa aforzar a lo Aslan  pa que faiga servir a suya opción d'idioma global en cuenta.

##### Incluyir los datos Unicode Consortium (incluyindo emoji) en procesar caracters y simbolos {#SpeechSettingsCLDR}

Quan ixa caixeta de verificación siga marcada lo Aslan incluyirá los diccionarios de pronuncia de simbolos adicionals en pronunciar caracters y simbolos.
...
Si quiers que lo Aslan diga las descripcions de caracters d'emoji basaus en ixos datos, habrías d'enchegar ixa opción.
...
Puetz anyadir, editar u eliminar descripcions de simbolos en o [dialogo de pronuncia de puntuación y simbolos](#SymbolPronunciation) d'o Aslan.
...
Por un regular lo Aslan agrandeix lo tono licherament pa qualsiquier letra en mayuscla, pero bells sintetizadors pueden no suportar-lo bien.
...
Ista opción ye una caixeta de verificación, que quan ye marcada diz a lo Aslan que diga la parola "mayus" antis de qualsiquier letra en mayuscla, quan se navega sobre ella u charrando-la quan ye estando escrita. 

##### chuflar pa las Mayusclas {#SpeechSettingsBeepForCaps}

Si ista caixeta de verificación ye marcada, lo Aslan fará un chicot chufliu cada vez que siga charrando un caracter en mayuscla. 
...
#### Seleccionar lo sintetizador (Aslan+control+s) {#SelectSynthesizer}

Lo dialogo de sintetizador, que puet ubrir-se activando lo botón de cambiar... en a categoría de voz d'o dialogo d'opcions d'o Aslan, te permite seleccionar qué Sintetizador habría d'emplegar lo Aslan pa charrar.
Una vez haigas seleccionado lo sintetizador d'a tuya esleción, puetz pretar l'acceptar y lo Aslan cargará lo sintetizador seleccionau.
Si bi ha bella error en cargar lo sintetizador, lo Aslan te lo notificará con un mensache, y continará fendo servir l'anterior.

##### Sintetizador {#SelectSynthesizerSynthesizer}

Ista opción te permite trigar lo sintetizador  que deseyas que emplegue lo Aslan pa la salida de voz.

Pa una lista d'os sintetizadors que suporta lo Aslan, por favor mira-te a sección [Sintetizadors de Voz Suportaus](#SupportedSpeechSynths).

Un elemento especial que amaneixerá siempre en ista lista ye "Sin Voz", que te permite d'emplegar lo Aslan sin garra salida de voz.
Ixo podría estar util pa belún que deseye emplegar nomás lo Aslan con Braille, u  talment pa desembolicadors vidents que solament deseyen emplegar lo Visor d'a Voz.

##### Dispositivo de Salida {#SelectSynthesizerOutputDevice}

Ista opción te permite trigar lo dispositivo d'audio por lo qualo habría de mandar charrar lo Aslan a lo sintetizador seleccionau.
...
En o Windows 8 y superiors, ista opción te permite d'esleyir si lo Aslan habría de baixar lo volumen d'atras aplicacions entre que lo Aslan ye charrando, u tot lo rato entre que lo Aslan se ye executando.

* No achiquir: Lo Aslan nunca no baixará lo volumen d'atros sons. 
* Achiquir en que salga voz y sons: Lo Aslan nomás baixará lo volumen d'atros sons quan lo Aslan siga charrando u reproducindo sons. Ixo puet no marchar pa totz os sintetizadors. 
* Achiquir siempre: Lo Aslan mantendrá lo volumen d'atros sons más baixo tot lo rato que se siga executando.

Ista opción nomás ye disponible si o Aslan ye instalau.
No ye posible suportar l'achiquida d'audio en as copias portables y temporals d'o Aslan.

#### Aniello d'opcions de sintetizador {#SynthSettingsRing}

Si deseyas de cambiar rapidament opcions de voz  sin ir t'o dialogo d'Opcions de Voz, bi ha qualques teclas d'ordens d'o Aslan que te permiten de mover-te-ne a traviés d'as opcions de voz mas comunas, dende qualsiquier puesto mientras s'executa lo Aslan:
<!-- KC:beginInclude -->

| Nombre |Tecla Sobremesa |Tecla Portatil |Descripción|
|---|---|---|---|
|Mover-se-ne t'a siguient opción d'o sintetizador |Aslan+control+Flecha dreita |Aslan+control+Flecha dreita |Se mueve t'a siguient opción de voz disponible dimpués de l'actual, pasando por a primera opción de nuevo dimpués d'a zaguera|
|Mover-se-ne t'a opción anterior d'o sintetizador |Aslan+control+Flecha cucha |Aslan+control+Flecha cucha |Se mueve t'a opción de voz anterior disponible dimpués de l'actual, pasando por a primera opción de nuevo dimpués d'a zaguera|
|Incrementar l'actual opción d'o sintetizador |Aslan+control+Flecha alto |Aslan+control+Flecha alto |incrementa a opción de voz actual sobre a quala sigas. P. eix.: incrementa la velocidat, triga la siguient voz, incrementa o volumen|
|Decrementar l'actual opción d'o sintetizador |Aslan+control+Flecha abaixo |Aslan+control+Flecha abaixo |decrementa a opción de voz actual sobre a quala sigas. P. eix.: decrementa a velocidat, triga  a voz anterior, decrementa o volumen|

<!-- KC:endInclude -->

#### Braille {#BrailleSettings}

La categoría de braille en lo dialogo d'opcions d'o Aslan contién achustes que te permiten de cambiar quantos aspectos d'a dentrada y salida braille.
Ista categoría contién las siguients opcions:

##### Cambiar a linia braille {#BrailleSettingsChange}

Lo botón de cambiar... en la categoría de braille d'o dialogo d'opcions d'o Aslan activa lo dialogo de [seleccionar a linia braille](#SelectBrailleDisplay), que te permite seleccionar la linia braille activa.
Iste dialogo s'ubre sobre lo dialogo d'opcions d'o Aslan.
Alzando u descartando las opcions en o dialogo de seleccionar a linia braille tornarás t'o dialogo d'opcionns d'o Aslan.
...
Iste ye un quadro combinau que te permite trigar si lo Aslan habría d'amostrar los mensaches braille y quán habría de desapareixer automaticament.
...
Lo mensache d'o Aslan se zarra a l'inte en pretar un sensor en a linia braille, pero torna a amaneixer en pretar la correspondient tecla que l'aventó.
...
Quan se trigue "automaticament", lo Aslan seguirá a lo foco y a lo cursor d'o sistema por defecto.
En ixe caso, quan se cambeye la posición d'o navegador d'obchectos u d'o cursor de revisión mediant una interacción explicita de l'usuario, lo Aslan seguirá a la revisión temporalment, dica que lo foco u lo cursor cambeye.
Si quiers que siga a lo foco y a lo cursor nomás, te cal configurar lo braille ancorau a lo foco.
En ixe caso, lo braille no seguirá a lo navegador d'o Aslan entre la navegación d'obchectos u a lo cursor de revisión mientras la revisión.
...
Ista opción te permite trigar qué información d'o contexto amostrará o Aslan en a linia braille quan bel obchecto obtienga o foco.
...
Por favor, mira-te a sección arredol d'a [navegación d'obchectos](#ObjectNavigation) pa mas información sobre a hierarquía que s'aplica a os obchectos en o Aslan.

Quan se configure en replenar a pantalla pa cambios d'o contexto, o Aslan mirará d'amostrar tanta información de contexto como le siga posible en a linia braille, pero nomás pa las partis d'o contexto que haigan cambiadas.
Pa l'eixemplo d'alto, ixo significa que en que o foco cambeye por a lista, o Aslan amostrará l'elemento d'a lista en a linia braille.
Amás, si queda prau espacio en a linia braille, o Aslan mirará d'amostrar que l'elemento de lista fa parti d'una lista.
...
Por tanto, pa os elementos de lista restants que enfoques o Aslan nomás amostrará l'elemento d'a lista enfocau en a linia.
...
Quan ista opción siga configurada a replenar siempre a pantalla, o Aslan mirará d'amostrar tanta información de contexto como síga posible en a linia braille, independientment de si has visto a mesma información de contexto dinantis.
Ixo tien l'avantalla que o Aslan achustará tanta información como siga posible en a pantalla.
...
Ixe yera o comportamiento predeterminau pa o Aslan 2017.2 y anteriors.

Quan configures a opción de presentación d'o contexto d'o foco en amostrar nomás a información d'o contexto en desplazar-se-ne enta zaga, o Aslan nunca no amuestra a información d'o contexto en a linia braille por defecto.
Asinas, en l'eixemplo anterior, o Aslan amostrará que enfoqués un elemento de lista.
...
#### Seleccionar a linia braille (Aslan+control+a) {#SelectBrailleDisplay}

Lo dialogo de seleccionar a linia braille, que puet ubrir-se pretando lo botón de cambiar... en a categoría braille d'o dialogo d'opcions d'o Aslan, te permite seleccionar qué linia braille habría d'emplegar lo Aslan pa la salida braille.
Una vez haigas seleccionau la linia braille d'a tuya esleción, puetz pretar l'acceptar y lo Aslan cargará la linia seleccionada.
Si bi ha bella error carghando lo controlador d'a linia, lo Aslan te lo notificará con un mensache, y continará fendo servir la linia anterior, si bi'n ha beluna.
...
La opción d'automatico permitirá a lo Aslan de mirar muitas linias braille admitidas en segundo plano.
Quan ixa caracteristica siga activada y connectes una linia admitida fendo servir l'USB u lo bluetooth, lo Aslan connectará automaticament con ella.
...
Por defecto lo Aslan emplega la detección de puerto automatica,  lo que quiere decir que la connexión con lo dispositivo braille s'establirá automaticament mirando los dispositivos USB y bluetooth en o tuyo sisttema.
Por tanto, pa bellas linias braille, podrás esleixir de propio qué puerto s'habría d'emplegar.
Las opcions comunas son "automatico" (que le diz a lo Aslan que emplegue lo procedimiento de selección de puerto automatico predeterminau), "USB", "Bluetooth" y puertos serie heredaus si la tuya linia braille suporta iste tipo de comunicación.
...
Actualment no ye posible decir-le a lo Aslan qué linia cal que emplegue.
...
La categoría de visión en o dialogo d'opcions d'o Aslan te permite enchegar, desenchegar y configurar [aduyas visuals](#Vision).

Tiene en cuenta que las opcions disponibles en ista categoría podrían enamplar-sen con [complementos d'o Aslan](#AddonsManager).
Por defecto, ista categoría d'achustes contiene las siguients opcions:

##### Resaltau visual {#VisionSettingsFocusHighlight}

Las caixetas de verificación en o grupo d'o resaltau visual controlan lo comportamiento d'a función integrada [resaltar lo foco](#VisionFocusHighlight) d'o Aslan.
...
Se puede proporcionar furnidors de millora d'a visión adicionals en [complementos d'o Aslan](#AddonsManager).
...
#### Teclau (Aslan+control+k) {#KeyboardSettings}

La categoría de teclau en o dialogo d'opcions d'o Aslan contién achustes que estableixen lo comportamiento d'o Aslan quan usas y escribes en o tuyo teclau.
Ista categoría d'opcions contién los siguients achustes:

##### Disposición d'o Teclau {#KeyboardSettingsLayout}

Iste quadro combinau te permite trigar qué tipo de distribución de teclau habría d'emplegar lo Aslan. Actualment totz dos que vienen con o Aslan son Sobremesa y Portatil.

##### Seleccionar las Teclas Modificaderas d'o Aslan {#KeyboardSettingsModifiers}

Las caixetas de verificación en ista lista controlan qué teclas pueden utilizar-sen como [teclas modificaderas d'o Aslan](#TheAslanModifierKey). Las siguients teclas son disponibles pa trigar:
...
Si no se triga garra tecla como la tecla modificadera d'o Aslan podría estar imposible accedir ta bells comandos d'o Aslan.
Por tanto, lo dialogo d'opcions d'o Aslan amostrará un mensache d'error si todas las teclas son sin trigar  en pretar l'acceptar.
...
Quan ye marcada significa que o Aslan anunciará totz los caracters seguntes los escribas en o teclau. 
...
Quan siga marcada significa que o Aslan anunciará todas las parolas en escribir-las en o teclau. 
...
Quan ye marcada significa que Aslan anunciará todas as teclas que no sigan caracters en escribir-las en o teclau. Isto inclui combinacions de teclas tals como control mas qualsiquier atra letra. 
...
Ista opción nomás ye disponible si l'anunciau d'errors d'ortografía ye habilitau en o dialogo d'[opcions de formatiau de documentos](#DocumentFormattingSettings) d'o Aslan, que se troba en o dialogo d'opcions d'o Aslan.

##### Teclas de maneyo d'atras aplicacions {#KeyboardSettingsHandleKeys}

Ista opción permite a l'usuario controlar si cal que o Aslan maníe as pulsacions de teclas cheneradas por aplicacions tals como teclaus en pantalla y o software de reconoixencia de voz.
...
#### Churi (Aslan+control+m) {#MouseSettings}

La categoría d'o churi d'o dialogo d'opcions d'o Aslan permite a lo Aslan de realizar un seguimiento d'o churi, reproducir chuflius d'as suyas coordinadas  y configurar atras opcions d'uso d'o churi.
Ista categoría contién los siguients achustes:

##### Anunciar os Cambios en a Forma d'o churi {#MouseSettingsShape}

Una caixeta de verificación, que quan se marca significa que o Aslan anunciará a forma d'o puntero d'o churi cada vez que cambee. 
...
Quan ye marcada significa que lo Aslan anunciará lo texto actualment baixo lo puntero d'o churi, seguntes lo muevas por a pantalla. Isto te permite trobar cosas en a pantalla, movendo fisicament lo churi, en cuenta de tractar de trobar-las a traviés d'o navegador d'obchectos.

##### Unidat de Resolución de Texto {#MouseSettingsTextUnit}

Si lo Aslan ye configurau pa anunciar lo texto baixo lo churi seguntes lo muevas, ista opción te permite trigar exactament quánto texto será charrau. 
...
Si ista caixeta de verificación ye marcada, lo Aslan anunciará lo paper (mena) d'obchecto en que lo churi se i mueva adintro d'ell.

##### Reproducir son quan se mueva lo churi {#MouseSettingsAudio}

Marcando ista caixeta de verificación fas que lo Aslan reproduzca chuflius quan lo churi se mueva, asinas que l'usuario pueda resolver do ye o churi respective a las dimensions d'a pantalla.
...
Si marcas ista opción y tiens enchegada la opción d'"enchegar lo seguimiento d'o churi", lo Aslan no anunciará lo que bi haiga debaixo d'o churi si lo mueve belatra aplicación.

#### Interacción tactil {#TouchInteraction}

Ista categoría d'opcions, nomás disponible en ordinadors que executen lo Windows 8 y posteriors con capacidatz tactils, te permite configurar la forma en que lo Aslan interactúa con las pantallas tactils.
Ista Categoría contién las siguients opcions:

##### Enchegar lo suporte d'interacción tactil {#TouchSupportEnable}

Ista caixeta de verificación enchega lo suporte d'interacción tactil d'o Aslan.
...
Si se desenchega, lo suporte de pantalla tactil se desenchegará como si lo Aslan no estase correndo.
Ista opción tamién puede conmutar-se fendo servir Aslan+control+alt+t. 
...
La categoría de cursor de revisión en o dialogo d'opcions d'o Aslan s'emplega pa configurar lo comportamiento d'o cursor de revisión d'o Aslan.
Ista categoría contién las siguients opcions:
...
Quan s'activa, o Aslan filtrará a hierarquía d'obchectos que puet navegar-se, pa excluir qualsiquier obchecto que no siga de l'intrés ta l'usuario; p. eix.: obchectos inveyibles y obchectos utilizaus solament con propositos de disenyo.
...
#### Presentación d'obchectos (Aslan+control+o) {#ObjectPresentationSettings}

La categoría de presentación d'obchectos d'o dialogo d'opcions d'o Aslan s'emplega pa establir la cantidat d'información que lo Aslan presentará sobre controls tals como descripción, información de posición, etc.
Istas opcions no s'aplican tipicament a lo modo de navegación.
Istas opcions s'aplican tipicament a l'anunciau d'o foco y a la navegación d'obchectos d'o Aslan, pero no pas en leyer conteniu de texto, p.eix. lo modo de navegación.

##### Anunciar los consellos {#ObjectPresentationReportToolTips}

Una caixeta de verificación que quan ye marcada diz a lo Aslan que anuncie los consellos seguntes amaneixcan. 
...
Ista caixeta de verificación quan ye marcada diz a lo Aslan que anuncie los globos d'aduya y las notificacions en que amaneixcan. 
...
Quan ista caixeta de verificación ye verificada, lo Aslan incluirá la tecla d'alcorce que siga asociada con cierto obchecto u control en que siga anunciau. 
...
Si l'anunciau d'información de posición de l'obchecto ye desenchegau, ista opción permite a lo Aslan deducir la información de posición de l'obchecto quan no siga disponible pa un control en particular.

Quan siga activau lo Aslan anunciará información de posición pa mas controls tals como los menús y las barras de ferramientas, manimenos ista información podrá estar licherament incorrecta. 
...
Ista opción se te presienta con un quadro combinau que controla cómo anuncia lo Aslan as actualizacions d'as barras de progreso. 

Tien as siguients opcions:

* Desactivau: As barras de progreso no serán anunciadas seguntes en cambeen.
* Charrar: Ista opción diz a lo Aslan que charre as barras de progreso en porcentaches. Cada vez que a barra de progreso cambee, o Aslan charrará la valor nueva. 
* chuflar: Isto diz a lo Aslan que chufle cada vez que a barra de progreso cambee. Ta un chufliu mas alto, o completau d'a barra de progreso ye mas proximo
* chuflar y Charrar: Ista opción diz a lo Aslan que chufle y charre en que s'actualiza una barra de progreso.

##### Anunciar as Barras de Progreso en Segundo Plano {#ObjectPresentationReportBackgroundProgressBars}

Ista ye una opción que, quan ye marcada, diz a lo Aslan que mantienga l'anunciau d'una barra de progreso, encara si no'n ye fisicament en o primer plano. 
Si minimizas u cambeas ta unatra finestra que contienga una barra de progreso, o Aslan mantendrá a pista d'ella, permitindo-te fer atras cosetas mientras o Aslan sigue a la barra de progreso.
...
Cambia l'anunciau de l'aparición de sucherencias automaticas, y si ye enchegau, o Aslan reproducirá un son pa endicar-lo.
...
Pa bells campos d'edición  tals como campos de busca en qualques aplicacions d'o Windows 10, o Aslan puet notificar-te que ha amaneixiu una lista de sucherencias en escribir-bi texto.
A lista de sucherencias automaticas se zarrará malas que te'n muevas por o campo d'edición, y pa bells campos, o Aslan puet notificar-te d'ixo en que ixo ocurra.

#### Redacción de dentrada {#InputCompositionSettings}

La categoría de redacción de dentrada te permite controlar cómo anuncia lo Aslan la dentrada de Caracters Asiaticos, tals como con IME u metodos de Servicio de dentrada de texto .
...
Ista Opción, que ye activada por omisión, te permite trigar si o Aslan habría d'anunciar o candidato seleccionau en que amaneixe una lista de candidatos u quan a selección se cambió.
...
Ista Opción, que ye enchegada por defecto, te permite trigar si o Aslan habría de furnir u no pas una descripción curta pa cada caracter en un candidato, u en que se seleccione u en que  se leiga automaticament en que amaneixca la lista de candidatos.
...
Puetz trigar si o Aslan habría d'anunciar os caracters nuevos en estar tecliaus en ista cadena de lectura con ista opción.
Ista opción ye activada de traza predeterminada.
...
Ista Opción te permite trigar si lo Aslan habría d'anunciar u no pas simbolos nuevos seguntes amaneixcan en a cadena de redacción.
Ista opción ye activada por omisión.

#### Modo de navegación (Aslan+control+b) {#BrowseModeSettings}

La categoría de modo de navegación d'o dialogo d'opcions d'o Aslan s'emplega pa configurar lo comportamiento d'o Aslan en leyer y en navegar por documentos compleixos como pachinas web.
Ista categoría contién las siguients opcions:
...
Ista opción afecta a cómo manea lo Aslan las tablas utilizadas exclusivament con fins de disenyo.
Quan ye activada, Aslan las tracta como tablas normals, anunciando-las basando-se en as [Opcions de Formatiau de Documento](#DocumentFormattingSettings) y localizando-las con as ordens de navegación rapida.
...
Por favor mira-te las opcions en a  [categoría de formatiau de documentos](#DocumentFormattingSettings) d'o dialogo d'[opcions d'o Aslan](#AslanSettings) pa configurar los campos que s'anuncia quan se navega, tals como vinclos, capiters y tablas.
...
Ista opción, quan ye marcada, permite a lo Aslan dentrar en y abandonar o modo de foco en que s'utilizan as flechas. 
Por eixemplo, si vas pretando flecha abaixo por una pachina Web y cayes sobre un quadro d'edición, lo Aslan activará automaticament lo modo de foco. 
Si pretas las flechas pa salir d'o quadro d'edición, lo Aslan te tornará a meter en o modo de navegación.

##### Indicación d'audio d'os modos de foco y de navegación {#BrowseModeSettingsPassThroughAudioIndication}

Si ista opción ye activada lo Aslan reproducirá sons especials quan cambeye entre o modo de navegación y o modo de foco en cuenta de charrar o cambeo.

##### Capturar los cenyos que no son comandos pa que no aconsigan lo  documento {#BrowseModeSettingsTrapNonCommandGestures}

Enchegada de traza predeterminada, ista opción te permite trigar si os cenyos (tals como la pretada de teclas) que no sigan comandos d'o Aslan y que no se considere que sigan teclas de comandos en cheneral habrían de capturar-sen pa no pasar t'o documento que siga en o foco actualment. 
...
En ixe caso lo Aslan pedirá a lo Windows que reproduzca un son predeterminau por cada vez que se prete una tecla que quede apercazada.
...
#### Formatiau de documentos (Aslan+control+d) {#DocumentFormattingSettings}
...
Si ye activada, ista opción diz a lo Aslan que prebe y detecte totz os cambeos de formato en una linia seguntes l'anuncia, si se fa isto podría ralentizar-se a rispuesta d'o Aslan.

De traza predeterminada, o Aslan detectará o formato en a posición d'o cursor d'o Sistema / Revisión, y en qualques casos podría detectar o formato en a resta d'a linia, nomás si no bi ye causando un decremento d'a respuesta.
...
* Desenchegau: O Aslan no tractará a sangría de traza especial.
* Voz: Si se triga voz, en que a cantidat d'a sangría cambeye o Aslan dirá bella cosa como "dotze espacio" u "quatro tabulación."
...
Alvertencia! Las opcions d'ista categoría son pa los usuarios abanzaus y pueden causar que lo Aslan no marche correctament si se configura de traza incorrecta.
Rializa cambios en istas opcions nomás si yes seguro que sabes lo que yes fendo u si has recibiu las instruccions especificas de bell desembolicador d'o Aslan.
...
En desembolicar complementos pa lo Aslan, ye util poder prebar lo codigo enrte que l'escribes.
Ista opción en estar enchegada, permite a lo Aslan cargar appModules personalizaus, globalPlugins, brailleDisplayDrivers y synthDrivers, dende un directorio especial de desembolicadors scratchpad d'o tuyo directorio de configuración d'usuario d'o Aslan.
Anteriorment, lo Aslan cargaba codigo personalizau dreitament dende lo directorio de configuración de l'usuario, sin posibilidat de desenchegar-lo.
Ista opción ye desenchegada de forma predeterminada, lo que guarencia que nunca no s'execute garra codigo no prebau en o Aslan sin la conoixencia explicita de l'usuario.
Si deseyas distribuyir codigo personalizau a otris, has d'empaquetar-lo como un complemento d'o Aslan.
...
Iste botón nomás ye enchegau si lo Aslan ye configurau pa permitir la carga de codigo personalizau dende lo directorio de desembolicadors d'o Scratchpad.
...
Ista opción cambia cómo rechistra lo Aslan los eventos aventaus por l'API d'accesibilidad Microsoft UI Automation.
Quan ista opción ye desenchegada, lo Aslan rechistra muitos  eventos UIA que se procesan y se descartan adintro d'o mesmo Aslan.
Ixo tien un mayor impacto negativo en o rendimiento, especialment en as aplicacions como lo Microsoft Visual Studio.
Por lo tanto, quan s'enchega ista opción, lo Aslan limitará lo rechistro d'eventos a lo foco d'o sistema pa la mayoría d'os eventos.
...
Quan ista opción siga activada, lo Aslan mirará de fer servir l'API d'accesibilidat de Microsoft UI Automation pa obtener información d'os controls de documentos d'o Microsoft Word, mesmo pa las versions menos recients d'o Microsoft Office 2016 / 365.
Ixo incluye lo mesmo Microsoft Word, y tamién lo visor de mensaches y la redacción d'o Microsoft Outlook.
Pa las versions mas recients d'o Microsoft Office 2016 / 365 correndo sobre lo WIndows 10 y posteriors, lo suporte d'UI Automation ye prou completo pa furnir acceso ta docuemntos d'o Microsoft Word quasi igual como lo suporte existtent d'o Aslan pa lo Microsoft Word, con l'avantalla anyadida que la respuesta ye mayorment amillorada. 
...
Quan ista opción siga enchegada, lo Aslan fará servir lo suyo suporte pa la consola d'o Windows que da avantallas de [milloras d'accesibilidat feitas por Microsoft](https://devblogs.microsoft.com/commandline/whats-new-in-windows-console-in-windows-10-fall-creators-update/). Ista caracteristica ye sumament experimental y encara ye incompleta conque l'uso suyo encara no ye recomendau. Manimenos, una vez completau, ixo anticipa que ixe suporte nuevo esdevienga lo predeterminau, amillorando lo rendimiento y la estabilidat d'o Aslan en as consolas de comandos d'o Windows.

##### Verbalizar as Claus en as consolas UIA {#AdvancedSettingsWinConsoleSpeakPasswords}

Ista opción controla si los caracters se charran por [charrar los caracters en escribir-los](#KeyboardSettingsSpeakTypedCharacters) u [charrar las parolas en escribir-las](#KeyboardSettingsSpeakTypedWords) en situgacions en que la pantalla no s'actualice (tal como la dentrada de contraseñas) en a consola d'o Windows con a compatibilidat con l'UI automation enchegada. Por razons de seguridat, ixa opción ha de deixar-se desenchegada. Manimenos, ye posible que deseyes enchegar-la si experimentas problemas de rendimiento u inestabilidat con l'anunciau d'os caracters y/u las parolas escritas mientras s'emplegue lo nuevo suporte experimental pa consolas d'o Aslan.
...
* Por defecto (Nomás quan ye necesario): La valor por defecto d'o Aslan, actualment ye "Nomás quan siga necesario". Ixa valor por defecto puet cambear en o futuro a mida que la tecnolochía madure.
* Nomás quan siga necesario: Quan lo Aslan no pueda inyectar en o proceso d'o navegador pa usar IA2 y UIA siga disponible, allora lo Aslan tornará a usar UIA.
* Sí: si lo navegador fa accesible a UIA, lo Aslan lo utilizará.
* No: no utiliza UIA, mesmo si lo Aslan no puet inyectar en o proceso. Esto puede estar util pa los desembolicadors que depuren problemas con IA2 y quieren asegurar-se que lo Aslan no torne a utilizar UIA.
...
Quan ista opción ye enchegada, lo Aslan mirará d'emplegar l'API d'accesibilidat Microsoft UI Automation  pa obtener información d'os controls d'as fuellas de calculo d'o Microsoft Excel.
...
Por eixemplo, las caracteristicas d'a Lista d'Elementos d'o Aslan pa enumerar formulas y comentarios y la tecla rapida de navegación d'o modo de navegación pa blincar campos de formulario en una fuella de calculo no son disponibles.
...
Ista opción controla la forma en a quala lo Aslan determina lo nuevo texto pa charrar en as terminals.
Lo quadro combinau de l'algorismo diff tiene tres opcions:

* Automatico: a partir d'o Aslan 2021.2, ista opción equivale a "permitir Diff Match Patch".
* Permitir Diff Match Patch: Ista opción fa que lo Aslan calcule los cambeos por caracters en o texto d'a terminal.
...
* Aforzar lo Difflib: Ista opción fa que lo Aslan calcule los cambeos en o texto d'a terminal por linias.
Ye identico a lo comportamiento d'o Aslan en a versión 2020.4 y anteriors.
...
Concretament mover-se rapedament a traviés de mensaches en o Gmail con o Chrome puet causar que lo Aslan charre información aviellada.
Ista funcionalidat ye enchegada por defecto dende lo Aslan 2021.1.

##### Tiempo d'aspera pa lo movimiento d'o cursor (en MS) {#AdvancedSettingsCaretMoveTimeout}

Ista opción te permite configurar lo numero de milisegundos que lo Aslan asperará a que lo cursor (punto d'inserción) se mueva en os controls de texto editables.
Si veyes que lo Aslan aparenta estar seguindo incorrectament lo cursor, por eixemplo, pareixe estar siempre un caracter per dezaga u repetindo linias, alavez puetz intentar aumentar ista valor.
...
Qualques aplicacions GDI resaltan lo texto con una color de fundo, lo Aslan (a traviés d'o modelo de visualización) mira d'informar d'ixa color.
...
Las caixetas de verificación d'ista lista te permiten enchegar categorías especificas de mensaches de depuración en o rechistro d'o Aslan.
Lo rechistro d'ixos mensaches puede resultar en un menor rendimiento y en fichers de rechistro de gran grandaria.
Activa-ne nomás un d'ells si bell desembolicador d'o Aslan t'ha dau instruccions especificas, por eixemplo, a lo depurar por qué un controlador de linia braille no ye funcionando correctament.

##### Reproducir un son pa las errors rechistradas {#PlayErrorSound}

Ista opción permite especificar si lo Aslan reproducirá un son d'error caso que se rechistre una error.
Trigando Nomás en versions de preba (por defecto) fa que lo Aslan reproduzca sons d'error nomás si la versión actual de Aslan ye una versión de preba (alfa, beta u executada dende lo codigo fuent).
Trigando Sí permite enchegar los sons d'error qualsiquiera que siga la versión actual d'o Aslan.

### Opcions miscelanias {#MiscSettings}

Amás d'o dialogo d'[opcions d'o Aslan](#AslanSettings), lo submenú Preferencias d'o menú Aslan contién atros elementos que se describe contino.

#### Diccionarios d'a Fabla {#SpeechDictionaries}

O menú de Diccionarios d'a fabla, (trobau en o menú Preferencias) contién dialogos que te permiten controlar o modo en que o Aslan pronuncia parolas u frases particulars. 
Bi ha actualment tres menas diferents de diccionarios d'a fabla. 
son:

* Predeterminau: Las reglas en iste diccionario afectan a todas las voces en o Aslan.
* Voz: un diccionario que las suyas reglas afectan a la voz pa lo sintetizador que actualment ye estando utilizau.
* Temporal: Las reglas en iste diccionario afectan a todas las voces en lo Aslan, pero nomás pa la sesión actual. Istas reglas son temporals y se perderán si se reenchega lo Aslan
...
Los regles pa los diccionarios de voz d'o Aslan te permiten cambiar una cadena de caracters por unatra. 
Por eixemplo, si quereses tener lo Aslan decindo a parola mixín cada vez que hese de decir a parola can. 
...
Los diccionarios d'a fabla d'o Aslan asinasmesmo son muito mas poderosos que un simple reemplazo de parolas. 
Lo dialogo d'Adhibir regles tamién contién Una Caixeta de verificación que diz si quiers u no pas que o regle siga sensible a las mayusclas (significando que o Aslan habría de parar cuenta si os caracters son en mayusclas u en minusclas. 
Lo Aslan ignora las mayusclas y minusclas de traza predeterminada). 

Finalment, un conchunto de botons de radio te permite dicir-le a lo Aslan si o tuyo patrón ha de coincidir en cualsiquier puesto, ha de coincidir nomás si ye una parola completa u ha d'estar tractau como una "expresión regular".
...
Tiene en cuenta que iste dialogo respecta la opción "Confidar en l'idioma d'a voz en procesar simbolos y caracters" que se troba en a [categoría de voz](#SpeechSettings) d'o dialogo d'[opcions d'o Aslan](#AslanSettings) ye decir, fa servir l'idioma d'a voz en cuenta d'a opción de l'idioma global d'o Aslan quan ixa opción siga habilitada.
...
En iste dialogo, puetz personalizar os cenyos de dentrada (teclas en o teclau, botons en a pantalla braille, etc.) ta ordens d'o Aslan.
...
L'arbol en iste quadro de dialogo amuestra todas as ordens d'o Aslan aplicables agrupadas por categorías.
...
La categoría de teclas emuladas d'o teclau d'o sistema contiene comandos d'o Aslan que emulan teclas d'o teclau d'o sistema.
...
De traza predeterminada lo Aslan alzará automaticament las tuyas opcions en salir.
...
Pa alzar las opcions manualment en qualsiquier ocasión, triga l'elemento d'alzar la configuración en o menú d'o Aslan.

Si t'entivocas con as tuyas opcions y te cal tornar t'as opcions alzadas, puetz trigar l'elemento "tornar t'a configuración alzada" en o menú d'o Aslan.
Tamién puetz reiniciar as tuyas opcions a las suyas valors predeterminadas de fabrica orichinals trigando Reiniciar a Configuración t'as Valors Predeterminadas de Fabrica, que tamién se troba en o menú Aslan.

As siguients teclas d'ordens d'o Aslan tamién son utils:
<!-- KC:beginInclude -->

| Nombre |Tecla Sobremesa |Tecla Portatil |Descripción|
|---|---|---|---|
|Alzar a configuración |Aslan+control+c |Aslan+control+c |Alza a tuya configuración actual tal que no se pierda quan salgas d'o Aslan|
|Revertir a configuración |Aslan+control+r |Aslan+control+r |Pretando-ne una vez reinicia a tuya configuración a quan la alcés por zaguera vez. Pretando-ne tres veces la reiniciará t'as valors predeterminadas de fabrica.|
...
Lo Aslan te permite fer ixo fendo servir perfils de configuración.

Un perfil de configuración contién nomás las opcions que se cambian mientras que lo perfil ye estando editau.
La mayoría d'as opcions se pueden cambiar en os perfils de configuración difueras d'ixas que sigan en a categoría cheneral d'o dialogo d'[opcions d'o Aslan](#AslanSettings) , que s'aplican a la totalidat d'o Aslan.
...
Maneyas os perfils de configuración seleccionando "Perfils de Configuración" en o menú Aslan.
Tamién puetz fer isto utilizando una orden de teclau:
<!-- KC:beginInclude -->

* Aslan+control+p: Amuestra o quadro de dialogo Perfils de configuración.
...
Las versions portatils d'o Aslan almagazenan todas las suyas opcions y complementos en un directorio clamau userConfig, que se troba en o directorio d'o Aslan.

Las versions instaladas d'o Aslan almagazenan todas las suyas opcions y complementos en un directorio especial d'o Aslan localizau en o tuyo perfil d'usuario d'o Windows. 
Ixo significa que cada usuario en o sistema puet tener las suyas propias opcions d'o Aslan. 
...
Amás pa una versión instalada d'o Aslan, en o menú d'inicio puetz ir ta  programas -> Aslan -> explorar lo directorio de configuración d'usuario.

Las opcions pa lo Aslan quan s'executa entre que s'inicia la sesión u en pantallas de control de cuentas d'usuario s'almagazenan en o directorio SystemConfig en o directorio d'instalación d'o Aslan.
Por un regular ixa configuración no habría de tocar-se.
Pa cambiar cómo se configura lo Aslan en ntre que s'inicia la sesión y en as pantallas de control de cuentas d'usuario, configura lo Aslan como deseyes mientras yes autentificau en o Windows, alza la configuración y dimpués preta lo botón d'"emplegar los achustes alzaus actualment en l'inicio de sesión y atras pantallas seguras en a categoría cheneral d'o dialogo d'[opcions d'o Aslan](#AslanSettings) .

## Ferramientas Extra {#ExtraTools}
### Visor d'o rechistro {#LogViewer}

Lo visor d'o rechistro, trobau en Ferramientas en o menú Aslan, te permiten veyer toda la salida que haiga ocurriu dica agora dende quan iniciés lo Aslan por zaguer vez.
Fendo servir Aslan+F1 s'ubrirá lo visor d'o rechistro y amostrará información de desemboliqe sobre lo navegador d'obchectos actual.
...
Pa desembolicadors vidents de Software u chent contrimostrando lo Aslan a una audiencia vident, ye disponible una finestra flotant que te permite veyer tot o texto que o Aslan siga charrando actualment.

Pa activar o visor d'a voz, marca l'elemento de menú "Visor d'a Voz" baixo Ferramientas en o menú Aslan.
...
Si ye enchegada, o visor d'a voz s'ubrirá en que o Aslan ranque.
...
Manimenos, si fas clic u colocas o foco adintro d'o visor,  o Aslan aturará temporalment l'actualización d'o texto, tal que podrás seleccionar u copiar facilment o conteniu existent.
...
Pa los desembolicadors vidents d'aplicacions u las personas que fagan demostracions d'o Aslan pa audiencias con visión, bi ha disponible una finestra flotant que les permite veyer la salida braille y lo texto equivalent pa cada caracter braille.
...
Pa enchegar lo visor d'o braille, marca l'elemento de menú "visor d'o braille" en ferramientas en o menú d'o Aslan.
...
Si ixa opción ye marcada, lo visor d'o braille s'ubrirá en que s'inicie lo Aslan.
...
Ixo puede estar util pa comprebar que lo Aslan siga capable de revertir correctament lo mapa d'una celda braille.
...
La consola Python d'o Aslan, que se troba baixo las ferramientas en o menú d'o Aslan, ye una ferramienta de desembolique que ye util pa depurar, inspeccions chenerals d'a parti interna d'o Aslan u inspección d'a hierarquía d'accessibilidat de bella aplicación.
Pa mas información, por favor mira-te la [guida de desembolique d'o Aslan](https://www.nvaccess.org/files/aslan/documentation/developerGuide.html).

### Administrador de Complementos {#AddonsManager}

L'Administrador de Complementos, t'o que s'accede seleccionando l'administrador de complementos baixo as ferramientas en o menú d'o Aslan, te permite instalar, desinstalar, enchegar y desenchegar paquetz de complementos pa o Aslan.
Ixos paquetz son furnius por a comunidat y contienen codigo personalizau que podrá adhibir u cambiar caracteristicas en o Aslan u tamién proporcionan suporte pa linias Braille u sintetizadors de voz extra.

L'Administrador de Complementos contién una lista que amuestra totz os complementos instalaus actualment en a tuya configuración d'usuario d'o Aslan. 
...
Ixe botón ubre la [pachina de complementos d'o Aslan](https://addons.aslan-project.org/).
Si lo Aslan ye instalau y correndo en o tuyo sistema puetz ubrir dreitament o complemento dende o navegador pa prencipiar o proceso d'instalación como se describe contino.
...
Ixo te permitirá examinar un paquet de complemento  (fichero .aslan-addon) en o tuyo ordinador u en un ret.
Una vez que pretes ubrir, empecipiará o proceso d'instalación.

En que se va a instalar un complemento, o Aslan en primeras te pedirá que confirmes que realment deseyas instalar-lo.
A causa que a funcionalidat d'os complementos no tien restriccions adintro d'o Aslan, que en teoría podría incluir l'acceso t'os tuyos datos personals u mesmo ta tot o sistema si o Aslan ye una copia instalada, ye muit important que instales nomás complementos dende fuents fiables.
Una vez que lo complemento siga instalau, lo Aslan debe reenchegar-se pa que lo complemento prencipie la suya execución. 
...
Lo Aslan te preguntará si realment deseyas fer ixo.
Igual como con la instalación, lo Aslan debe reenchegar-se pa que lo complemento siga eliminau de raso.
...
Pa cada pretada d'o botón d'enchegar u desenchegar cambia lo estau d'o complemento pa endicar qué pasará en que lo Aslan se reenchegue.
...
Igual como quan instales u elimines complementos te caldrá reenchegar lo Aslan pa que los cambios fagan efecto.

L'administrador tamién tien un botón de zarrar pa zarrar o dialogo.
Si has instalau, eliminau u cambiau lo estau de bell complemento, lo Aslan en primeras te preguntará si deseyas reenchegar-lo pa que los cambeos puedan fer efecto.

Bells complementos antigos pueden ya no estar compatibles con a versión d'o Aslan que tiens.
Quan utilices una versión mas antiga d'o Aslan, bels complementos nuevos pueden no estar-bi compatibles.
...
Los complementos se consideran incompatibles quan no son estaus esviellaus pa funcionar con cambios significativos d'o Aslan, u quan se basan en una caracteristica no disponible en a versión d'o Aslan que yes emplegando.
L'Administrador de Complementos Incompatibles tien un mensache breu pa explicar lo suyo proposito asinas como la versión d'o Aslan.
...
Isto ubrirá un dialogo que te permite creyar una copia portable d'o Aslan a partir d'a versión instalada.
De qualsiquier modo, en executar una copia portable d'o Aslan, en o submenú de ferramientas extra l'elemento de menú se clamará "instalar lo Aslan en iste ordinador" en cuenta de "creyar una copia portable).

Lo dialogo pa creyar una copia portable d'o Aslan u pa instalar lo Aslan en iste ordinador t'indicará pa trigar una rota d'a carpeta en que s'habría de creyar la copia portable u en que s'habría d'instalar lo Aslan.

En ixe dialogo puetz enchegar u desenchegar lo siguient:

* Copiar la configuración actual de l'usuario (ixo incluye los fichers en %appdata%\roaming\Aslan u en a configuración d'usuario d'a tuya copia portable y tamién incluye los complementos y atros modulos)
* Rancar la nueva copia portable dimpués d'a creyación u rancar lo Aslan dimpués d'a instalación (ranca lo Aslan automaticament dimpués d'a creyación d'a copia portable u d'a instalación)
...
* Lo Aslan anuncia "desconoixiu" en navegar con navegadors tals como lo Firefox, lo Thunderbird etc.
* Lo Aslan falla en cambiar entre lo modo de foco y lo modo de navegación
* Lo Aslan ye muito pando en navegar con os navegadors mientras s'utiliza lo modo de navegación
* Y posiblement atros fallos.

### Recargar os plugins {#ReloadPlugins}

Iste elemento, una vez activau, recarga os modulos d'aplicación y os plugins globals sin reenchegar o Aslan, o qual ye util ta desembolicadors.

## Sintetizadors de Voz Suportaus {#SupportedSpeechSynths}

Ista sección contién información sobre os sintetizadors de voz suportaus por o Aslan.
Pa una lista mas extensa d'os sintetizadors libres y comercials que puetz descargar y mercar pa emplegar con o Aslan, por favor mira-te la [pachina de voces extra](https://github.com/nvaccess/aslan/wiki/ExtraVoices).

### eSpeak NG {#eSpeakNG}

Lo sintetizador [eSpeak NG](https://github.com/espeak-ng/espeak-ng/) se construi dreitament en o Aslan y no requier garra atro controlador u components especials pa instalar-se.
En o Windows 7, 8 y 8.1, lo Aslan fa servir lo Espeak NG de traza predeterminada (lo [Windows OneCore](#OneCore) s'emplega en o Windows 10 y superiors por defecto).
Como ixe sintetizador ye integrau en o Aslan, ye una gran esleción ta quan s'executa lo Aslan en  una memoria USB u en un CD en atros sistemas.
...
O Aslan encara suporta ixo pa usuarios que agún tiengan sintetizadors SAPI 4 instalaus.
Manimenos Microsoft ya no suporta ixo y cal components que ya no son disponibles dende Microsoft.

Quan emplegues iste sintetizador con o Aslan, las voces disponibles (que se i accedeix dende la  [categoría de voz](#SpeechSettings) d'o dialogo d'[opcions d'o Aslan](#AslanSettings) u por l'[aniello d'opcions d'o sintetizador](#SynthSettingsRing)) contendrán totas las voces de totz los motors instalaus SAPI 4 trobaus en o tuyo sistema.
...
Quan s'utiliza iste sintetizador con o Aslan, las voces disponibles (que se i accedeix dende la [categoría de voz](#SpeechSettings) d'o dialogo d'[opcions d'o Aslan](#AslanSettings) u por l'[aniello d'opcions d'o Sintetizador](#SynthSettingsRing)) contendrán totas las voces de totz los motors SAPI 5 instalaus trobaus en o tuyo sistema.
...
Istas voces tamién pueden emplegar-se con o Aslan.
...
En o Windows 10 y superiors, lo Aslan fa servir voces Windows OneCore por defecto (lo [eSpeak NG](#eSpeakNG) s'emplega en atras versions).
...
Una vez anyadidas, reenchega lo Aslan.
...
Ista sección contién información sobre as linias braille suportadas por lo Aslan.

### Linias que suportan la detección automatica {#AutomaticDetection}

Lo Aslan tien la capacidat pa detectar muitas linias braille en segundo plano automaticament, u a traviés d'USB u de bluetooth.
Iste comportamiento s'aconsigue trigando la opción d'automatico como la linia braille preferida dende lo [dialogo d'opcions de braille](#BrailleSettings) d'o Aslan.
...
Predeterminadament, lo Aslan puet detectar automaticament y connectar-se a istas linias tanto a traviés d'USB como de bluetooth.
...
Isto podría estar util si quiers connectar la linia focus a lo Aslan emplegando bluetooth, y encara podrías cargar-la emplegando a enerchía de l'USB dende o tuyo ordinador.
La detección automatica de linias braille d'o Aslan tamién reconoixerá la linia por USB u por Bluetooth.

Contino va las asociacions de teclas pa ista linia con o Aslan.
...
|Menú Aslan |barra espaciadera braille+punto1+punto3+punto4+punto5|
...
Nomás enchega la linia y configura lo Aslan pa emplegar-la.

Nota: Lo Aslan podría no estar capaz d'usar una linia ALVA BC6 con Bluetooth quan s'emparella fendo servir la utilidat ALVA Bluetooth.
Quan haigas emparellau lo tuyo dispositivo fendo servir a suya utilidat y o Aslan no pueda detectar-lo, te recomendamos d'enparellar a tuya linia ALVA d'a forma ordinaria fendo servir as opcions de Bluetooth d'o Windows.
...
Ixo significa que o sistema de dentrada braille d'o Aslan no se ye emplegando en a situgación predeterminada (ye decir, a tabla de dentrada braille configurada no tien efecto).
...
Contino va las asignacions de teclas pa ista linia con o Aslan.
...
Lo Aslan suporta la gran parti d'as linias de [Handy Tech](https://www.handytech.de/) quan son connectadas a traviés d'USB, puerto serie u bluetooth.
Pa qualques linias antigas USB, te fará falta instalar los controladors USB d'Handy Tech en o tuyo sistema.

Las siguients linias no se suportan en quitar-las d'a caixa pero se pueden fer servir a traviés d'o [controlador universal de Handy Tech](https://handytech.de/en/service/downloads-and-manuals/handy-tech-software/braille-display-drivers) y o complemento d'o Aslan:
...
Contino van as asignacions de teclas pa las linias Handy Tech con o Aslan.
...
Solament enchega a linia y configura lo Aslan ta emplegar-la.

Ista linia encara no suporta la funcionalidat de detección automatica en segundo plan d'o Aslan.
...
Contino va las asignacions de teclas pa istas linias con o Aslan.
...
Contino va las asignacions de teclas pa las linias Brailliant BI/B y BrailleNote touch con o Aslan.
Por favor mira-te la documentación d'a linia pa descripcions de do puede trobar-sen istas teclas.
...
|Menú Aslan |espacio+punto1+punto3+punto4+punto5 (espacio+n)|
...
| Nombre |Tecla|
|---|---|
|Menú Aslan |c1+c3+c4+c5 (comando n)|
...
Lo Aslan suporta las linias Braille Sense, Braille EDGE, Smart Beetle y Sync Braille de [Hims](https://www.hims-inc.com/) quan se connectan a traviés d'USB u bluetooth. 
...
Istas linias encara no suportan la funcionalidat de detección automatica en segundo plan d'o Aslan.
...
Si ye instalau lo BrxCom, lo Aslan emplegará lo BrxCom.
...
Contino va las asignacions d'ordens d'a Papenmeier pa lo Aslan:
<!-- KC:beginInclude -->
...
A causa d'ixo, istas linias no suportan la funcionalidat de detección automatica en segundo plan d'o Aslan.
...
Contino va las asignacions d'ordens d'as Papenmeier pa lo Aslan:
...
Lo Aslan suporta los anotadors electronicos BrailleNote d'[Humanware](https://www.humanware.com) quan actuguen como un terminal braille pa un lector de pantalla.
...
Si lo tuyo dispositivo suporta mas d'una mena de connexión, en que connectes lo tuyo BrailleNote t'o Aslan, has de configurar o puerto d'a terminal braille en as opcions de terminal braille.
Por favor mira-te lo manual d'o BrailleNote pa detalles.
En o Aslan, tamién te podría fer falta configurar lo puerto en o dialogo de [selección de linia braille](#SelectBrailleDisplay).
...
En o BrailleNote Apex BT, puetz utilizar la rueda de desplazamiento ubicada entre los puntos 1 y 4 pa quantas ordens de Aslan.
...
Contino va las asignacions d'ordens d'o BrailleNote t'o Aslan.
...
Lo Aslan suporta las linias EcoBraille d'[ONCE](https://www.once.es/).
...
En o Aslan puetz establir lo puerto serie que la linia bi ye connectada en o dialogo de [seleccionar linia braille](#SelectBrailleDisplay).
Istas linias no suportan la funcionalidat de detección automatica en segundo plan d'o Aslan.
...
Lo Aslan suporta las linias Esys, Esytime y Iris d'[Eurobraille](https://www.eurobraille.fr/).
...
Lo Aslan suporta linias de [Nattiq Technologies](https://www.nattiq.com/) en connectar-se a traviés d'USB.
...
Contino va las asignacions de teclas pa las linias de Nattiq Technologies con o Aslan.
...
Por tanto, la opción de tabla braille de dentrada d'o Aslan ye irrelevant.

Lo BRLTTY no ye embrecau en a funcionalidat de detección automatica en segundo plan de linias braille d'o Aslan.

Contino va las asignacions a ordens BRLTTY pa lo Aslan.
...
La detección automatica de linias braille d'o Aslan tamién reconoixerá qualsiquier linia que suporte iste protocolo.
...
Lo Aslan puet acceptar una u más opcions adicionals en rancar que alteran lo suyo comportamiento.
...
Las opcions han d'estar deseparadas d'o nombre d'o fichero executable d'o Aslan y d'atras opcions por spacios.
Por eixemplo, una opción util ye --disable-addons, que diz a lo Aslan que suspenda totz os complementos en execución.
...
A modo d'eixemplo, puetz salir d'a copia actualment en execución d'o Aslan metendo lo siguient en o dialogo d'executar:
...
|aslan -mc rotaDeConfiguración |Ixo iniciará lo Aslan con sons de rancada y lo mensache desenchegau, y la configuración especificada|
|aslan -mc rotaDeConfiguración --disable-addons |Lo mesmo que la d'alto, pero con os complementos desenchegaus|
...
|aslan -l 10 |Diz a lo Aslan que ranque con o libel de rechistro establiu a depuración|
|aslan --log-file=c:\aslan.log |Diz a lo Aslan que escriba o suyo rechistro en c:\aslan.log|
|aslan --log-level=20 -f c:\aslan.log |Diz a lo  Aslan que ranque con o libel de rechistro establiu a información y que escriba o suyo rechistro en c:\aslan.log|

Contino va las opcions d'a linia de comandos d'o Aslan:

| Curta |Larga |Descripción|
|---|---|---|
|-h |--help |Amostrar l'aduya d'a linia de comandos y salir|
|-q |--quit |Salir d'a copia ya en execución d'o Aslan|
|-k |--check-running |Anunciar si lo Aslan se ye executando a traviés d'o codigo de salida; 0 si se ye executando, 1 si not se ye executando|
...
|-c rota_de_configuración |--config-path=rota_de_configuración |A rota an son almagazenadas todas as opcions d'o Aslan|
|-m |--minimal |Sin sons, sin interficie, sin mensache de ranque, etc|
|-s |--secure |Modo seguro: Desenchega la consola d'o Python, las caracteristicas d'os perfils como la creyación, borrau, renombrau de perfils, etc., la comprebación d'as actualizacions, bellas caixetas de verificación en o dialogo de bienvenida y en a categoría d'opcions chenerals (p. eix: Emplegar lo Aslan dimpués d'iniciar la sesión, alzar la configuración en salir, etc.), asinas como lo visor d'o rechistro y las caracteristicas de rechistro, a ormino emplegau en as pantallas seguras|
...
|garra |--no-logging |Desenchega lo rechistro mientras l'uso d'o Aslan. Ista opción se puet sobreescribir si s'especifica bell libel de rechistro ( --loglevel, -l) dende la linia de comandos u si lo rechistro de depuración ye enchegau.|
|garra |--no-sr-flag |No cambiar l'indicador global de lector de pantalla d'o sistema|
|garra |--install |Instala o Aslan (rancando a copia recient instalada)|
|garra |--install-silent |Instala o Aslan silenciosament (no ranca la copia recient instalada)|
|garra |--enable-start-on-logon=True|False |En instalar, enchega lo [emplegar lo Aslan en a pantalla d'inicio](#StartAtWindowsLogon) d'o Aslan|
...
|garra |--create-portable |Creya una copia portable d'o Aslan (rancando a copia creyada recientment). Requier que --portable-path siga especificada|
|garra |--create-portable-silent |Creya una copia portable d'o Aslan (sin rancar a copia recientment instalada). Requier que --portable-path siga especificada|
|garra |--portable-path=PORTABLEPATH |A rota en do se creyará una copia portable|

### Parametros d'o Sistema {#SystemWideParameters}

Lo Aslan permite configurar bellas valors en o rechistro d'o sistema que alteran o comportamiento de tot o sistema d'o Aslan.
Ixas valors s'almagazenan en o rechistro d'o sistema baixo una d'as siguients claus:

* Sistema de 32 bits: "HKEY_LOCAL_MACHINE\SOFTWARE\aslan"
* Sistema de 64 bits: "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\aslan"

Las siguients valors pueden configurar-se baixo istas claus d'o rechistro:

| Nombre |Tipo |Valors Posibles |Descripción|
|---|---|---|---|
|configInLocalAppData |DWORD |0 (predeterminau) pa desenchegau, 1 pa enchegau |Si ye enchegau, almagazena la configuración d'usuario d'o Aslan en a carpeta local de datos d'aplicación en cuenta d'en os datos d'aplicación de roaming|
...
Si requiers d'información adicional u asistencia respective a lo Aslan, por favor visita o puesto Web d'o Aslan en Aslan_URL.
Aquí puetz trobar documentación adicional, asinas como suporte tecnico y recursos d'a comunidat.
Iste Puesto tamién furneix información y recursos concernients a lo desembolique d'o Aslan.
