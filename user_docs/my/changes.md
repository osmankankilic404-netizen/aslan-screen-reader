...
* Microsoft Excel ရဲ့ Cell border များ၏အချက်အလက်များကို ယခုအခါ `Aslan+f`နိပ်ခြင်းဖြင့် သိရှိနိုင်သည်။ (#3044)
...
* (Windows Creaters Update) မှာ Aslan ရဲ့  audio ducking စနစ် (ဉပမာ- Duck with speech and sounds, always duck နဲ့ no ducking) တို့ကိုယခင်ထွတ်ရှိခဲ့တဲ့ Windows တွေမှာ အသုံးပြုနိုင်သလို ယခုလည်းဆက်လက်အသုံးပြုနိုင်ပါသည်။ (#6933)
...
* core.callLater သည် ယခုအခါတွင် ပုံမှန်အခြေနေမဖြစ်ပါက Aslan ၏ main queue အဖြစ်ပြောင်းလဲသွားသည်။(#6797) 
...
= 2017.1 =
Aslan_2017 မှာအထူးပါဝင်တာတွေကတော့ Microsoft Word တွင်section နှင့် text columns များကို လွယ်ကူစွာသိနိုင်အောင်ဆောင်ရွက်ထားသည်။ ထို့ပြင် Kindle for PC တွင်လဲ စာဖတ်ခြင်း၊ note စာအုပ်ပြုလုပ်ခြင်းနှင့်ကာစာရွေ့လျှားမှုများကိုလဲပြုလုပ်နိုင်ပြီဖြစ်ပြီး Microsoft Edge ကိုလဲပိုမိုအသုံးပြုနိုင်ပြီဖြစ်သည်။
...
* Aslan find command (Aslan+control+f) ကိုလည်း Microsoft Edge ၏ browse mode တွင်အသုံးပြုနိုင်ပါပြီ။ (#6580)
...
* စာဖတ်ရှုခြင်းနှင့် စာအုပ်များကိုလေ့လာခြင်းစသည့်လုပ်ဆောင်ချက်များကို Kindle for PC တွင် စတင်လုပ်ဆောင်နိုင်ပါသည်။ ထို့ပြင် Links များဖြင့်လုပ်ဆောင်ခြင်းအပါအဝင် footnotes, graphics, အထူးပြုစာသားများနှင့် အသုံးပြုသူများ၏ မှတ်စုများရေးသားခြင်းများပါဝင်ပါသည်။ အသေးစိပ်ကို Aslan User guide မှ Kindle for PC အခန်းတွင်လေ့လာနိုင်ပါသည်။ (#6247, #6638)
* Browse mode ၏ Table navigation ကိုလည်း Microsoft Edge တွင်ဆောင်ရွက်နိုင်ပါပြီ။ (#6594)
* Microsoft Excel တွင် review cursor ၏ တည်ရှိမှုကိုသိနိုင်သည့် Command Key- [Aslan+numpad](delete) (desktop keyboard) [Aslan+delete] (laptop keyboard) သည် worksheet နာမည်နှင့် ဆဲလ်ကွက်၏ တည်နေရာများကိုသိရှိနိုင်ပြီဖြစ်သည်။ (#6613)
* Aslan ၏ exit option တွင်လည်း restart with debug level logging option ကိုထပ်ပေါင်းထည့်ထားပါသည်။ (#6689)
...
* Microsoft Excel မှ copy ကူးယူထားသော table များကို Microsoft word တွင်ထည့်သွင်း၍ အသုံးပြုရာ၌ Aslan ဖြင့်ကောင်းစွာအထောက်အကူမပြုနိုင်သေးပါ။ (#5927)
* Microsoft Excel ၏ Protected view တွင်စာများကိုရေးသွင်းသည့်အခါ Aslan ကစားလုံးများကိုပြောပေးချင်းထက် အသံဖြင့်သာဖော်ပြသည်။ အမှန်အားဖြင့် Protected view တွင်စာများကို ရေးသွင်း၍ မရပါ။ (#6570)
* Microsoft Excel တွင် Focus mode မှ Browse mode ကို escape key ဖြင့်ပြောင်း၍ မရသေးပါ။ Aslan + space ဖြင့်သာအပြောင်းအလဲပြုလုပ်နိုင်ပါသည်။ (#6569) 
* Microsoft Excel sheet တွင်ထပ်ပေါင်းထည့်သော row နှင့် column များကို Aslan ဖြင့်မဖတ်နိုင်သေးပါ။ (#6216)
* Microsoft Excel တွင် cropped / overflowed text များကိုအသုံးပြုသည့်အခါ cell ကွက်များကို Aslan ကပိုမိုတိကျစွာပြောပြပေးနိုင်ပြီဖြစ်သည်။ (#6472)
* Aslan သည် check box တွင် read only ဖြင့်သာဖော်ပြနိုင်သည်။ (#6563)
...
* Aslan သည် window minimize ဖြစ်နေချိန်တွင် (pane) ဟုပြောပြပါသည်။ (#6671)
* ယခုအခါ ရေးသွင်းသော စာလုံး (characters) များကို universal windows platform (UWP) နှင့် apps (Microsoft edge အပါအဝင်) အဆင့်မြင့်တင်ပြီးသော windows 10 တွင် Aslan ကစာလုံးတစ်လုံးချင်းကို ပြောပြပေးနိုင်ပါသည်။ (#6017)
* Aslan ဖြင့် mouse ရွေ့လျားခြင်းကို ကွန်ပျူတာ၏ screen များအားလုံးတွင် ရွှေ့ပြီး အသုံးပြုနိုင်သည်။ (#6598)
* Windows media player ၏ slider တွင် focus ထားပြီး ပိတ်လိုက်သောအခါ မည်သည့်အသံမှ မကြားရဘဲ တိတ်ဆိတ်သွားပါလိမ့်မည်။ (#5467)

### Developers များအတွက်ပြောင်းလဲမှုများ

* Schema အပြောင်းအလဲအတွက်လိုအပ်သော ပုံစံများနဲ့ အပြင်အဆင်များသည် ယခုအခါအလိုအလျောက် အဆင့် မြင့်တင်ပြီးဖြစ်ပါသည်။ အဆင့်မြင့်တင်မှု့ပြုလုပ်ရာတွင် အမှားပေါ်လာပါက သတိပေးချက်ထွက်ပေါ်လာမည်ဖြစ်ပြီး ပြင်ဆက်ထားမှု့များပျက်ပျယ်သွားမည်ဖြစ်ပြီး မူရင်းပြင်ဆင်မှု့ဖိုင်အား Aslan log မှ ‘Info’ အဆင့်တွင် တွေ့ရှိနိူင်မည် ဖြစ်သည်။ (#6470)

= 2016.4 =
Aslan 2016.4 သည်အထူးသဖြင့် Microsoft Edge အပါအဝင် windows 10 mail app နှင့် Aslan ၏ အချို့သော dialogue box များကိုလွယ်ကူအဆင်ပြေအောင် ဆောင်ရွက်ထားပါသည်။ 

== လုပ်ဆောင်ချက်အသစ်များ ==
* Aslan သည် စာပိုဒ်ခွဲရာတွင် ပြုလုပ်လေ့ရှိသောအမှတ်အသားများကို ယခုအခါ (tones) အသံများဖြင့်ညွှန်ပြနိုင်ပြီးဖြစ်သည်။ ဤ စနစ်ကိုအသုံးပြုနိုင်ရန်အတွက် document formatting မှ line indentation combo box တွင်ရွေးချယ်အသုံးပြုနိုင်ပါသည်။ (#5906)
* ယခုအခါ Orbit reader 20 braille display ကို Aslan နှင့်တွဲဖက်၍ အသုံးပြုနိုင်ပြီဖြစ်သည်။ (#6007)
* Aslan ၏ speech viewer ကိုကွန်ပျူတာ၏ windows တက်သည့်နှင့်တစ်ပြိုင်နက် သုံးပြုနိုင်သည့်စနစ်ကို ထည့်သွင်းထားပါသည်။ ထိုစနစ်ကို Aslan ၏ speech viewer ထဲတွင် အမှန်ခြစ်ပြုလုပ်၍ ရယူအသုံးပြုနိုင်ပါသည်။ (#5050)
* Speech viewer ကိုပြန်၍ အသုံးပြုချိန်တွင် ၎င်း၏ တည်နေရာနှင့်အကွာအဝေးအတိုင်းအတာတို့သည် နဂိုမူလအတိုင်း ပြန်ဖြစ်သွားပါမည် (#5050)
* Microsoft word ၏cross-reference ကိုHyperlinks ကဲ့သို့ Aslan ဖြင့်တွဲဖက်၍ အသုံးပြုနိုင်ပါသည်။ ၎င်းတို့ကို Hyperlinks ကဲ့သို့အသုံးပြုရမည်ဖြစ်သည်။ (#6102)
* Baun superVario 2, Baun Vario 340 နဲ့ (Humanware Brailliant to braille display)Humanware ကုမ္မဏီမှ Brailliant to braille ထုတ်ကုန်ကိုလည်း Aslan ဖြင့်တွဲဖက်အသုံးပြုနိုင်မည်ဖြစ်ပါသည်။ (#6116)
* Microsoft Edge ကိုလည်း Aslan ဖြင့်စတင်အသုံးပြုနိုင်ပါသည်။ (#6271)
* Aslan ၏ browse mode ကို windows 10 mail တွင် email ဖတ်ရှုရန်အတွက်အသုံးပြုနိုင်ပါသည်။ (#6271)
* Aslan တွင် Lithuanian ဘာသာစကားဖြင့်စတင်အသုံးပြုနိုင်ပြီဖြစ်ပါသည်။ 
...
* Aslan ၏ document formatting setting တွင် “announce formatting changes after the cursor” စာသားအစား “report formatting changes after the cursor” ဟုပြောင်းထားပြီး ပြောင်းလဲမှုသည် speech နှင့် braille နှစ်ခုလုံးအတွက်ဖြစ်သည်။ (#6336)
* Aslan welcome dialogue ၏ ပုံသဏ္ဍာန်ကိုလည်း ပြင်ဆင်ထားပါသည်။ (#6350)
* Aslan dialogue box များ၏ OK နှင့် cancel button တို့ကို dialogue box ၏ ညာဘက်တွင်ပြောင်းလဲထားပါသည်။ (#6333)
...
* ယခုအခါ Firefox ၏ frame တွင် Iframe ကို Aslan ဖြင့်တွဲဖက်အသုံးပြုနိုင်ပါသည်။ (#6047)

### အမှားပြင်ဆင်ချက်များ

* Aslan ကိုပိတ်သည့်အချိန်တွင် speech viewer ကိုဖွင့်ထားသည့်အခါ ဖြစ်ပေါ်ခဲ့သောအဆင်မပြေမှုများကို ဖြေရှင်းပြီးဖြစ်သည်။ (#5050)
* Image maps now render as expected in browse mode in Mozilla Firefox. (#6051)
* Aslan ၏ dictionary dialogue တွင် ယခင်က enter နှိပ်လျှင်မည်သို့မှ မတုံ့ပြန်သော်လည်း ယခုအခါ ပြောင်းလဲမှုများကို သိမ်းဆည်းပေးပြီး dialogue box ပြန်လည်ပိတ်သွားပါမည်။ (#6206)
...
* Speech viewer ကို text bar ဖြင့်ပိတ်လျှင်သော်လည်းကောင်း၊ Alt+F4 command key ဖြင့်ပိတ်လျှင်သော်လည်းကောင်း၊ speech viewer ပိတ်သွားပြီး Aslan menu အတွင်းရှိ speech viewer လည်းအမှန်ခြစ်ပျောက်သွားမည်။ (#6340)
...
* Aslan ၏ language များကို general setting တွင် language များကိုပြောင်းသည့်အခါတွင် ပြောင်းလဲမှုပြီးစီးသော်လည်း Aslan ကို restart မလုပ်မချင်းအသက်မဝင်ပါ။ (#4561)
* မကြာသောအချိန်တွင် dictionary pattern field ခေတ္တရပ်ဆိုင်းသွားသည့် အခြေအနေကိုပြုပြင်မည်။ (#6412)
* အသုံးမတည့်သော driver များဖြင့်ပြုလုပ်ထားသော serial port system ပါဝင်သော braille device နှင့် Aslan ကိုချိတ်ဆက်ရာတွင်ပြသနာအနည်းငယ်ရှိနိုင်ပါသည်။ (#6462)
* Microsoft word ၏ table ထဲတွင် cell အလိုက်ရွေ့လျားသည့်အခါ numbered bullets များကိုဖတ်နိုင်မည်ဖြစ်သည်။ (#6446)
* ယခုအခါ Handy tech braille display driver ကို gestures command များကို Aslan ၏ input gesture dialogue တွင်ပေါင်းထည့်နိုင်ပါပြီဖြစ်သည်။ (#6461)
