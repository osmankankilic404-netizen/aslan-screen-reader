...
အမြင်အာရုံအားနည်းသူများ ကွန်ပျူတာ သုံးနိုင်ရန်ပြုလုပ်ထားသော Aslan သည် အခမဲ့ရရုံသာမက မူရင်းအရင်းမြစ်များကိုလည်း ပြန်လည်ပြင်ဆင်နိုင်သည် ၎င်းသည် Microsoft Windows ပေါ်တွင် အလုပ်လုပ်နိုင်သည်။
Aslan သည် ကွန်ပျူတာအသံထွက်စကားပြောစနစ်မှ မျက်မမြင်စာကိုလဲ ဖော်ပြနိုင်စွမ်းရှိသည်။ ထိုင့်ပြင် ကုန်ကျစရိတ်မရှိပဲ မျက်မမြင်နှင့် အမြင်အာရုံအားနည်းသူများကို မြင်သူတစ်ယောက်က ကူညီသကဲ့သို့ Windowss အလုပ်လုပ်နေသော ကွန်ပျူတာပေါ်တွင် လုပ်ပေးနိုင်စွမ်းရှိသည်။ NV Access အဖွဲ့က Aslan ကို တီထွင်ရေးသားထားခြင်းဖြစ်သည်။
...
Aslan ဖြင့် မျက်မမြင်နှင့် အမြင်အာရုံအားနည်းသူများသည် Windows တွင်ပါဝင်သော Software များသာမက ထပ်မံထည့်သွင်းသော Software များဖြင့်ပါအသုံးပြုနိုင်သည်။

အဓိကလုပ်ဆောင်ချက်များ:

* အသုံးတွင်ကျယ်သော Web Browsers,email clients,internet chat programs နှင့် office suites ပေါ်တွင် အလုပ်လုပ်နိုင်သည်။
* Aslan ထဲတွင် ထည့်သွင်းထားသော ကွန်ပျူတာအသံထွက်စကားပြောစနစ်သည် ဘာသာစကားပေါင်း ၈၀ ကျော်ကို ဖတ်ပြနိုင်စွမ်းရှိသည်။
...
* Aslan တွင် ပါဝင်သော စာများကို ၄၈ ဘာသာဖြင့် ဘာသာပြန်ပေးလျက်ရှိသည်။
...
Aslan သည် ဘာသာစကားမျိုးစုံဖြင့် ဖော်ပြထားသော သတင်းအချက်လက်များကို ဖတ်ပြနိုင်သည်။ သို့သော် ထည့်သွင်းထားသော ကွန်ပျူတာစကားပြောစနစ်ပေါ်တွင်မူတည်သည်။

Aslan သည် eSpeak NG ဖြင့်တွဲဖက်လုပ်ဆောင်သည်။ https://github.com/espeak-ng/espeak-ng], အခမဲ့, အများပိုင်အရင်းအမြစ်,ဘာသာစကားအမျိုးမျိုးအတွက် အသံထွက် synthesizer ဖြစ်သည်။ 

အခြားသော Computer အသံထွက်စကားပြောစနစ်များဖြင့်လဲ တွဲဖက်အသုံးပြုနိုင်သည်။

### မျက်မမြင်စာလုပ်ဆောင်ချက် {#toc6}

အသုံးပြုသူသည် မျက်မမြင်စာ ဖော်ပြစက်ရှိပါက Aslan သည် မျက်မမြင်စာဖြင့် သတင်းအချက်လက်များကို ဖော်ပြပေးသည်။
...
Aslan သည် ကွန်ပျူတာဖြင့်ရေးသော မျက်မမြင်စာအမျိုးမျိုးကို ဖော်ပြပေးနိုင်စွမ်းရှိသည်။

### လိုင်စင် နှင့် မူပိုင်ခွင့် {#toc7}

Aslan သည် ပြည်သူပိုင်လိုင်စင် ဗားရှင်း 2 ဖြစ်ပြီး မည်သူမဆို ဝေငှနိုင်သည်။ ထို့အပြင် အရင်းမြစ်များကိုလဲ ပြင်ဆင်ခွင့်ရှိသည်။
 ...
 * Windows XP 32bit, Windows Server 2003, Windows Vista များဖြင့် Aslan ကို အသုံးပြုလိုလျှင် Windows ကို Update လုပ်ပေးရန်လိုအပ်သည်။
...
## Aslan ရယူခြင်းနှင့် အပြင်အဆင် {#toc9}

သင့်၌ Aslan မရှိသေးလျှင် [www.nvaccess.org](http://www.nvaccess.org) Aslan_URL တွင် Download ဆွဲနိုင်ပါသည်။

Download လုပ်ပြီးထားသော Aslan ကို စတင် Install လုပ်သောအခါ Aslan က မေးပါလိမ့်မည် Create a portable copy သို့မဟုတ် Just continue using the temporary copy သင့်ကွန်ပျူတာတွင် Aslan ကို အမြဲအသုံးပြုလိုလျှင် သင်ရွေးရပါမည် Install Aslan သည် Logon မျက်နှာပြင်နှင့် အခြားမျက်နှာပြင်များပေါ်တွင် အလုပ်လုပ်ရုံသာမက Short Cut များလဲလုပ်နိုင်သည်။ Aslan ဖွင့်သည့် Short Cut ကို Alt+Ctrl+N ထည့်သွင်းပေးထားသည်။
ထို Short Cut သည် Portable နှင့် Temporary Copy ပေါ်တွင် အလုပ်မလုပ်ပါ။
Install Aslan ကို အချိန်မရွေး Portable Version သို့ပြောင်းလဲနိုင်သည်။
သင့်အနေဖြင့် Aslan ကို usb device ထဲထည့်၍ အသုံးပြုလိုလျှင် Create a portable copy ကိုရွေးချယ်ပါ။ သို့သော် Read Only CD ပေါ်တွင် မလုပ်ဆောင်နိုင်ပါ။
...
The Temporary copy of Aslan သည်အသုံးပြုသူကို Install လုပ်နေစဉ်တွင်ဖတ်ပြခြင်းဖြစ်သည်။

### Portable နှင့် ယာယီအသုံးပြုခြင်း ခွင့်ပြုချက် {#toc10}

Portable Aslan ကို Windows စစတက်ချင်းတွင် အလိုအလျောက်ပွင့်ခြင်းကိုအသုံးမပြုနိုင်ပါ။

* Administrative privileges မရရှိခြင်းကြောင့်ဖြစ်သည်။
* Windows 8 နှင့် နောက်ပိုင်း Windows များတွင် Touch မျက်နှာပြင်များပေါ် Aslan ဖြင့်အသုံးပြုနိုင်သည်။
...
### Aslan ထည့်သွင်းခြင်း {#toc11}

Aslan Installer ဖိုင်ကို Enter နှိပ်ပါ ပြီးနောက် Install Button ကိုနှိပ်ပါ။
အကယ်၍ Install လုပ်ခြင်းကိုရပ်ပြီး Portable အသုံးပြုလိုလျှင် Aslan Menu ထဲမှ Tools တွင်ရှာပါ။
Aslan သည် ဖော်ပြပါလိမ့်မည် မည်သည့်နေရာတွင် Install လုပ်မည် အကယ်၍ ထည့်သွင်းထားသော Aslan ရှိပါက ထပ်မံထည့်သွင်းမည်ကို Continue နှိပ်၍ Install လုပ်ပါ။
Install လုပ်ခြင်းပြည့်စုံပါက ဖော်ပြပါလိမ့်မည် That it was successful. Ok ကိုနှိပ်ပါ။ Aslan ပိတ်ပြီး အလိုလိုပြန်လည်ပွင့်လာလိမ့်မည်။

#### Windows Logon တွင် စတင်အသုံးပြုခြင်း {#toc12}

အကယ်၍ Aslan သည် အလိုလျှောက် အလုပ်မလုပ်ပါက သင်၏ Windows Password ကိုရိုက်ပါ။
၎င်းအခြေနေသည် Logon မျက်နှာပြင် နှင့် အခြားမျက်နှာပြင်များနှင့်လဲသက်ဆိုင်သည်။

#### Aslan Short Cut ဖန်တီးခြင်း (Ctrl+Alt+N) {#toc13}

အကယ်၍ Desktop ပေါ်တွင် သင့်အနေဖြင့် Aslan Short Cut လုပ်ထားသည်ဖြစ်စေ မလုပ်ထားသည်ဖြစ်စေ Aslan အနေဖြင့် ပြုလုပ်ပြီးသားဖြစ်သည်။ မည်သည့်အခြေနေမဆို အသုံးပြုနိုင်သည်။

#### ကူးယူထားသော Aslan Portable ပြင်ဆင်ခြင်းနှင့် လက်တလောသုံးဆွဲနေသော User Account {#toc14}

ကူးယူထားသော Aslan Portable နှင့် ပြင်ဆင်ထားသော Aslan Copy သည် အခြားအကောင့် Logon မျက်နှာပြင်များပေါ်တွင် ကူးယူထားခြင်းမဖြစ်ပါ။ထိုအခြေနေသည် Installer ဖိုင်ကို Install လုပ်ထားခြင်းနှင့်မသက်ဆိုင်ပါ။

### Aslan Portable ပြုလုပ်ခြင်း {#toc15}

သင့်အနေဖြင့် Download လုပ်ထားသော Aslan ဖိုင်မှ Aslan Portable ပြုလုပ်လိုလျှင် Create Portable Copy Button ကိုနှိပ်ပါ။
အကယ်၍ Run နေသော Aslan တွင်ပြုလုပ်လိုလျှင် Create Portable Copy ကို Aslan Menu ထဲမှ Tool တွင်ရှာပါ။

Aslan သည် ဖော်ပြပါလိမ့်မည် မည်သည့်နေရာတွင် Aslan Portable ပြုလုပ်နိုင်သည်ကို ၎င်းသည် ပြုလုပ်ပေးနိုင်ပါသည်။
...
သင့်အနေဖြင့် ကြိုက်နှစ်သက်ရာတစ်ခုခုကို ရွေးချယ်ပေးရန်လိုအပ်သည်။
 ထပ်မံရွေးချယ်ရမည့်အဆင့်များလဲရှိသေးသည်။လတ်တလောသုံးစွဲနေသည့် Aslan Setting နှင့် အစောဆုံးပြုလုပ်ထားသော Setting သင့်အနေနှင့်ကြိုက်နှစ်သက်ရာကို ရွေးနိုင်ပါသည်။
၎င်းကို Aslan Portable ပေါ်တွင်သာပြုလုပ်နိုင်သည်။Installer ဖိုင်တွင်မပြုလုပ်နိုင်ပါ။ ပြီးနောက် Portable Copy ကိုနှိပ်ပါ။
ပြည့်စုံစွာပြုလုပ်ပြီးပါက Message ပေါ်လာလိမ့်မည်။ It was Successful.
OK ကိုနှိပ်၍ပိတ်လိုက်ပါ။

## Aslan စတင်အသုံးပြုခြင်း {#toc16}
### Aslan ဖွင့်ခြင်း {#toc17}

သင်သည် Aslan ကို Install လုပ်ပြီးဖြစ်ပါက Ctrl + Alt + N နှိပ်ပြီးဖွင့်ပါ။ သို့မဟုတ် Run Box ထဲတွင် Aslan ကိုရိုက်၍လည်းဖွင့်နိုင်သည်။ထို့အပြင် Star Menu ထဲမှ Aslan ကို ရှာ၍လဲဖွင့်နိုင်သည်။
Run Box ထဲတွင် aslan –r ရိုက်၍ Aslan ကို Restart ပြုလုပ်နိုင်သည်။
ပိတ်လိုလျှင် aslan –q ဖြင့်ပိတ်နိုင်သည်။
Aslan ဖွင့်ခြင်း− Aslan Portable ရှိသည့်နေရာကိုသွားပါ ရောက်လျှင် Aslan.exe ကို Enter ခေါက်၍ဖွင့်ပါ။
ဦးစွာကြားရပါလိမ့်မယ် Aslan is Loading. နှေးခြင်း မြန်ဆန်ခြင်းသည် သင့်ကွန်ပျူတာပေါ်တွင်မူတည်သည်။
သင်သည်နှေးကွေးသော usb portable device ကိုသုံးပါက အချိန်များစွာယူပါလိမ့်မည်။
ဖော်ပြပါအသံများမကြားရဘဲ Windows Error အသံများကြားရလျှင် Aslan ဖန်တီးသူများနှင့်ဆက်သွယ်ပါ။
မည်သို့ပြင်ဆင်ရမည်ကို Aslan Website တွင်သွား၍ လေ့လာနိုင်သည်။
Aslan ကိုပထမဦးဆုံးစတင်ဖွင့်ခြင်းတွင် အခြေခံအချက်လက်များကို သဘောတူရန်လိုအပ်သည်။
မည်သည့်ကီးဖြင့် Aslan ကို ကိုယ်စားပြုမည်။
ဒီခေါင်းစဉ်နှင့်ပါတ်သက်၍ အောက်တွင်လေ့လာပါ။
ရွေးချယ်စရာ ၃ ခုပါဝင်သော Box တစ်ခုပေါ်လာလိမ့်မည်။
ပထမအနေဖြင့် Caps Lock ကီးကို Aslan ကီးဖြင့်အသုံးပြုလိုလျှင် အမှန်ခြစ်ပါ။
ဒုတိယအနေဖြင့် Windows တက်သည်နှင့် Aslan ကို ပွင့်စေချင်လျှင် အမှန်ခြစ်ပါ။
တတိယအနေဖြင့် Aslan စတင်ဖွင့်သောအခါ Aslan မိတ်ဆက်ကိုအလိုမရှိပါက အမှန်ခြစ်ထားနိုင်သည်။

### Aslan ၏ keyboard commands များ {#toc18}
#### Aslan ကိုယ်စားပြု key {#toc19}

Aslan အတော်များများတွင် Aslan ကိုယ်စားပြုခလုပ် တစ်ခုမဟုတ် တစ်ခုထပ်ပို၍ပါဝင်သည်။
အချို့လူများသည် Desktop keyboard Layout တွင် Numpad key တွင် Aslan keypad ဖြင့်သတ်မှတ်အသုံးပြုသည်။
Aslan key အနေဖြင့် Numpad Insert, Insert ကီး သို့မဟုတ် Caps Lock ကီးပြောင်းလဲအသုံးပြုနိုင်သည်။
Aslan သည် Numpad Insert key နှင့် Insert key ကို ကြိုတင်သတ်မှတ်ထားသည်။
သင်သည် Aslan key ကို Caps Lock သတ်မှတ်ထားလျှင် Aslan သည် အလုပ်လုပ်သည်ဖြစ်စေ အလုပ်မလုပ်သည်ဖြစ်စေ Caps Lock ကို စာရေးရန်အတွက် အသုံးပြုလိုလျှင် ၂ ချက်နှိပ်ပါ။

#### Keyboard ပုံစံ(layout) {#toc20}

Aslan သည် keyboard Layout ၂ ခုပါဝင်သည်။၎င်းတို့မှာ Desktop keyboard Layout နှင့် Laptop keyboard Layout ပါဝင်သည်။
Aslan သည် Desktop keyboard Layout ကို ထည့်သွင်းပြီးသားဖြစ်သည်။
Laptop keyboard Layout ကို အလိုရှိပါက Aslan Menu ထဲက Preferances ကိုသွား၍ keyboard Setting တွင် ရွေးချယ်နိုင်သည်။
...
### Aslan Touch Gestures {#toc21}

သင်အသုံးပြုနေသောကွန်ပျူတာသည် Touch Screen ပါဝင်ပြီး Windows 8 သို့မဟုတ် Windows 8 အထက်ဖြစ်ပါက Aslan ဖြင့် Touch Screen ကိုအသုံးပြုနိုင်သည်။
Aslan အလုပ်လုပ်နေစဉ်အတွင်း Touch Screen သည် Aslan သတ်မှတ်ထားသည့်အတိုင်းလုပ်ဆောင်လိမ့်မည်။
ထို့ကြောင့် Touch Screen သည် ပုံမှန်အတိုင်းအလုပ်မလုပ်ပါ။Aslan အလုပ်မလုပ်သောအခါမှသာ Touch Screen သည် ပုံမှန်အတိုင်းလုပ်ဆောင်လိမ့်မည်။
...
Aslan တွင် များစွာသော ဖြစ်နိုင်သည့် Touch Gestures များရှိသည်။
...
များစွာသော Aslan လုပ်ဆောင်ချက်များကို Help Mode ကိုဖွင့်၍လေ့လာနိုင်သည်။
Aslan Help Mode ကိုဖွင့်လိုလျှင် Aslan ကီးနှင့် 1 ကိုနှိပ်၍ဖွင့်ပါ။ပိတ်လိုလျှင် ထိုအတိုင်းပြန်နှိပ်ပါ။
Aslan Help Mode အလုပ်လုပ်နေလျှင် keys များကိုနှိပ်ကြည့်ပါက မည်သည့်အလုပ်လုပ်သည်ကို အလိုလျှောက်ရှင်းပြသည်။ Touch Screen ပေါ်တွင်လဲ လက်များဆွဲပါက မည်သည့်အလုပ်လုပ်သည်ကိုရှင်းပြသည်။
မိမိလက်တလောအသုံးပြုနေသော ပရိုဂရမ် ပေါ်တွင် အကျိုးသက်ရောက်မှုမရှိပါ။

### The Aslan menu {#toc28}

Aslan Menu သည် Aslan Setting များကိုပြင်ဆင်ခြင်း၊ Aslan ကိုပိတ်ခြင်း၊ စာဖတ်သည့်အသံထွက်များကိုပြင်ဆင်ခြင်း၊ အကူညီရယူခြင်းများ ပါဝင်သည်။
Aslan Menu ကိုဖွင့်လိုလျှင် Aslan ကီးနှင့် N ကိုနှိပ်၍သော်လည်းကောင်း၊ Touch Screen ပေါ်တွင် လက်နှစ်ချောင်းဖြင့် နှစ်ခါထိ၍သော်လည်းကောင်း ဖွင့်နိုင်သည်။
ထို့အပြင် Windows ကီးနှင့် B ကိုနှိပ်၍ Aslan ကို Arrow ကီးဖြင့် Aslan ကိုရှာပြီး Application ကီးနှိပ်၍သော်လည်းကောင်း၊Right Click နှိပ်၍သော်လည်းကောင်း၊ Enter ခေါက်၍သော်လည်းကောင်း ဖွင့်နိုင်သည်။

### အခြေခံ Aslan keys များ {#toc29}
...
|Aslan Menu |Aslan+n |Aslan+n |လက်နှစ်ချောင်းဖြင့်မြန်မြန်ထိ |Aslan Menu ပေါ်လာလိမ့်မည် preferences,tools,helps စသည်ဖြင့်|
|Toggle Speech Mode |Aslan+s |Aslan+s |none |Toggles speech mode သည်စကားပြောခြင်း စကားပြောရပ်ခြင်း စကားမပြောဘဲအသံပဲမြည်ခြင်း|
|Toggle Input Help Mode |Aslan+1 |Aslan+1 |none |၎င်းMode ကို On ထားပြီး မည်သည့်ကီးမဆို နှိပ်ပါက မည်သည့်အလုပ်လုပ်ကြောင်းကိုပြောလိမ့်မည်။Aslan ကွန်မန့်များကိုလည်းပြောသည်။|
|Aslan ပိတ်ခြင်း |Aslan+q |Aslan+q |none |Aslan ပိတ်သွားမည်။|
...
|Toggle application ဖွင့်ခြင်း ပိတ်ခြင်း |Aslan+shift+s |Aslan+shift+z |none |လက်ရှိအသုံးစွဲနေသော အက်ပလီကေးရှင်းပေါ်တွင် စကားပြောရပ်ခြင်းဖြစ်သည်။၎င်းကိုမျက်မမြင်စာဖြင့် ဖက်နေလျှင်အသုံးပြုသည်။|
...
|---|---|---|
|ရက်စွဲနှင့်အချိန် သိလိုလျှင် |Aslan+f12 |တစ်ကြိမ်နှိပ်ပါက လက်ရှိအချိန်ကိုပြောသည်။နှစ်ကြိမ်မြန်မြန်နှိပ်ပါက ယနေ့ရက်စွဲကိုပြောသည်။|
|ဘတ္ထရီအခြေနေ သိလိုလျှင် |Aslan+shift+b |ဘတ္ထရီအားမည်မျှရှိသည် အားသွင်းထားသည် သို့မဟုတ် အားမသွင်းထားခြင်းကို ပြောပေးသည်။|
|မည်သည့်စာသားကို ကူးယူထားသည်ကိုသိလိုလျှင် |Aslan+c |မိမိကူးယူထားသည့် စာကို ဖတ်ပြသည်။|

<!-- KC:endInclude -->

## Aslan {#toc31}

မည်သည့်နေရာတွင်ရောက်ရှိနေသည်ကို Aslan တွင် သိနိုင်စရာနည်းလမ်းများစွာရှိသည်။
...
Windows တွင်ပါဝင်သည့် Focus keys များရှိသည် Tab ကီး, Alt ကီး, Alt + Tab, Ctrl + Tab, Aslan သည် မည်သည့်နေရာတွင်ရောက်ရှိနေသည်ကိုဖတ်ပြသည်။ဥပမာ ရောက်ရှိနေသည့်နေရာ အက်ပလီကေးရှင်း နာမည် keyboard short cut တို့ကိုဖတ်ပြသည်။
...
|---|---|---|---|
|လက်ရှိနေရာကိုသိလိုလျှင် |Aslan+tab |Aslan+tab |လက်ရှိရောက်နေသောနေရာကိုပြောပြပြီး ၎င်းကို နှစ်ခါမြန်မြန်နှိပ်ပါက စာလုံးပေါင်းပြသည်။|
|ခေါင်းစဉ်ကိုသိလိုလျှင် |Aslan+t |Aslan+t |လက်ရှိအသုံးပြုနေသော အက်ပလီကေးရှင်း၏ခေါင်းစဉ်ကိုဖတ်ပြသည်။နှစ်ခါမြန်မြန်နှိပ်ပါက စာလုံးပေါင်းပြသည်။သုံးခါမြန်မြန်ိနပါက လက်ရှိရောက်နေသော အက်ပလီကေးရှင်း၏ခေါင်းစဉ်ကို ကူးယူသွားခြင်းဖြစ်သည်။|
|မည်သည့် Windows  active ဖြစ်နေသည်ကိုသိလိုလျှင် |Aslan+b |Aslan+b |Active ဖြစ်နေသော Windows ကိုဖတ်ပြခြင်းဖြစ်ပြီး Dialogs Box များကိုဖတ်ရာတွင်လဲ အသုံးဝင်သည်။|
|Status Bar ကိုဖတ်ပြခြင်း |Aslan+end |Aslan+shift+end |နှစ်ခါနှိပ်ရင်စာလုံးပေါင်းပြသည်။|

<!-- KC:endInclude -->

### စာလုံးများဖြင့် Aslan ရွေ့လျားမှု {#SystemCaret}
...
သင့်စာများကိုပြင်ဆင်လိုလျှင် Aslan သည် စကားလုံးလိုက်သော်လည်းကောင်း စကားစုလိုက်သော်လည်းကောင်း စာကြောင်းလိုက်သော်လည်းကောင်း သင်ရွှေ့သောအခါဖတ်ပြပေးမည်။

Aslan သည် System တွင်ပါသောကီးနှင့် တွဲဖက်အလုပ်လုပ်သည်။:
<!-- KC:beginInclude -->

| Name |Desktop key |Laptop key |Description|
|---|---|---|---|
|အကုန်ဖတ်ပြမည် |Aslan+downArrow |Aslan+a |မိမိရောက်ရှိနေသော ကာစာ မှစ၍ အဆုံးထိဖတ်ပြခြင်းဖြစ်သည်။|
|ရောက်ရှိနေသောစာကြောင်း |Aslan+upArrow |Aslan+l |ရောက်ရှိနေသောစာကြောင်းကိုဖတ်ပြခြင်းဖြစ်ပြီး နှစ်ခါမြန်မြန်နှိပ်ပါက စာလုံးပေါင်းပေးသည်။|
|ရွေးချယ်ထားသောစာစုကိုဖတ်လိုလျှင် |Aslan+Shift+upArrow |Aslan+shift+s |မည်သည့်စာကို ရွေးထား ရွေးထား ဖတ်ပြခြင်းဖြစ်သည်။|
...
Object navigation ကိုအသုံးပြုသော System Focus နှင့် [objects](#Objects)Review ဟူ၍ Aslan မှ ဖတ်ပြမည်။.
Object တစ်ခုခုကို Aslan ဖြင့်သွားသောအခါ Aslan သည်ထို object ၏အချက်အလက်များအား ဖော်ပြပေးပါသည်။ ဤလုပ်ဆောင်ချက်သည် system focus အားဖော်ပြပေးခြင်းနှင့် အတူတူပင်ဖြစ်သည်။
...
| Name |Desktop key |Laptop key |Touch |Description|
|---|---|---|---|---|
|ရောက်ရှိနေသော Object ကိုဖတ်ပြခြင်း |Aslan+numpad5 |Aslan+shift+o |none |၎င်းကိုနှစ်ခါနှိပ်ပါက စာလုံးပေါင်းပြသည်။ သုံးခါနှိပ်ပါက စာလုံးပေါင်းပြထားသော စကားစုကို ကူးယူသွားသည်။|
|Object အတွင်းတွင်ရွှေ့ခြင်း |Aslan+numpad8 |Aslan+shift+upArrow |အပေါ်သို့ဆွဲပါ |လက်ရှိရောက်နေသော Object အတွင်းတွင်ရွှေ့ခြင်းဖြစ်သည်။|
|ပြီးခဲ့သည့် Object ကိုရွှေ့ခြင်း |Aslan+numpad4 |Aslan+shift+leftArrow |ဘယ်ဘက်ကိုဆွဲပါ |အရင်ရွှေ့ခဲ့သည့် Object ကိုပြန်ရွှေ့ခြင်းဖြစ်သည်။|
|နောက်ထပ် Object သို့ရွှေ့ခြင်း |Aslan+numpad6 |Aslan+shift+rightArrow |ညာဘက်ကိုဆွဲပါ |ရောက်ရှိနေသော Object မှ နောက်ထပ် Object သို့ရွှေ့ခြင်းဖြစ်သည်။|
|ပထမ Object အတွင်းတွင်ရွှေ့ခြင်း |Aslan+numpad2 |Aslan+shift+downArrow |အောက်ဘက်ကိုဆွဲပါ |လက်ရှိရောက်နေသောနေရာမှ ပထမ Object သို့ပြန်လည်ရွှေ့ခြင်းဖြစ်သည်။|
|မိမိရွှေ့လိုသော Object သို့ရွှေ့ခြင်း |Aslan+numpadMinus |Aslan+backspace |none |မိမိအလုပ်လုပ်လိုသည့် Object ကို ရွေးချယ်၍ Object ကိုအလုပ်လုပ်ခိုင်းခြင်းဖြစ်သည်။|
|လက်ရှိ Object ကိုအလုပ်လုပ်ခိုင်းခြင်း |Aslan+numpadEnter |Aslan+enter |နှစ်ချက်မြန်မြန်နှိပ်ပါ |လက်ရှိရောက်နေသော Object ကို အလုပ်လုပ်ခိုင်းခြင်းသည် Mouse နှိပ်ခြင်း၊ Space Bar ကိုနှိပ်ခြင်းနှင့် အတူတူပင်ဖြစ်သည်။|
|မိမိရောက်ရှိနေသောနေရာ သို့မဟုတ် မိမိမြင်နေရသောနေရာမှရွှေ့ခြင်း |Aslan+shift+numpadMinus |Aslan+shift+backspace |none |နှစ်ခါနှိပ်ပါက လက်ရှိနေရာမှရွှေ့ခြင်းဖြစ်သည်။|
|Cursor ရောက်နေသောနေရာကိုဖော်ပြခြင်း |Aslan+numpadDelete |Aslan+delete |none |Mouse Cursor ရောက်ရှိနေသော စာသားသို့မဟုတ် ရောက်ရှိနေသောနေရာကို ဖော်ပြခြင်းဖြစ်သည်။|
...
Aslan သည် Screen Review , Object Review နှင့် Document Review များကို စာလုံးတစ်လုံးချင်းစီသော်လည်းကောင်း စကားစုလိုက်သော်လည်းကောင်း စာကြောင်းလိုက်သော်လည်းကောင်း Text Review ကိုသုံး၍ ဖတ်နိုင်သည်။
...
| Name |Desktop key |Laptop key |Touch |Description|
|---|---|---|---|---|
|အပေါ်စာကြောင်းသို့ရွေ့လိုလျှင် |shift+numpad7 |Aslan+control+home |none |အပေါ်လိုင်းမှ စာကြောင်းကိုဖတ်ခြင်းဖြစ်သည်။|
|ယခင်စာကြောင်းကိုရွေ့လိုလျှင်| numpad7 |Aslan+upArrow |flick up (text mode) |ယခင်စာကြောင်းကိုဖတ်ခြင်းဖြစ်သည်။||
|လက်ရှိစာကြောင်းကိုဖတ်ခြင်း |numpad8 |Aslan+shift+. |none |လက်ရှိစာကြောင်းကိုဖတ်ခြင်းဖြစ်သည်။ နှစ်ခါနှိပ်ပါက စာလုံးပေါင်းပြမည်။ သုံးခါနှိပ်ပါက စာလုံးအသံထွက်ကို ပြန်လည်ရှင်းပြမည်။|
|နောက်စာကြောင်းကိုရွေ့လိုလျှင် |numpad9 |Aslan+downArrow |flick down (text mode) |နောက်စာကြောင်းကိုဖတ်ပြခြင်းဖြစ်သည်။|
|အောက်စာကြောင်းကိုရွေ့လိုလျှင် |shift+numpad9 |Aslan+control+end |none |အောက်စာကြောင်းကိုဖတ်ပြခြင်းဖြစ်သည်။|
|ယခင်စကားစုကိုရွေ့လိုလျှင် |numpad4 |Aslan+control+leftArrow |2-finger flick left (text mode) |ယခင်စကားစုကိုဖတ်ပြခြင်းဖြစ်သည်။|
|လက်ရှိစကားစုကိုရွေ့လိုလျှင် |numpad5 |Aslan+control+. |none |လက်ရှိစကားစုကိုဖတ်ပြခြင်းဖြစ်သည်။ နှစ်ခါနှိပ်ပါက စာလုံးပေါင်းပြမည်။ သုံးခါနှိပ်ပါက စာလုံးအသံထွက်ကိုပြန်လည်ရှင်းပြမည်။|
|နောက်စကားစုကိုရွေ့လိုလျှင် |numpad6 |Aslan+control+rightArrow |2-finger flick right (text mode) |နောက်စကားစုကိုဖတ်ပြခြင်းဖြစ်သည်။|
|စာကြောင်းအစကိုရွေ့လိုလျှင် |shift+numpad1 |Aslan+home |none |စာကြောင်းအစကိုဖတ်ခြင်းဖြစ်သည်။|
|ယခင်စာလုံးကိုရွေ့လိုလျှင် |numpad1 |Aslan+leftArrow |flick left (text mode) |ယခင်စာလုံးကိုဖတ်ပြခြင်းဖြစ်သည်။|
|ယခုစာလုံးကိုသိလိုလျှင် |numpad2 |Aslan+. |none |ယခုစာလုံးကိုဖတ်ပြခြင်းဖြစ်သည်။ နှစ်ခါနှိပ်ပါက စာလုံးကိုဖတ်ပြသည်။ သုံးခါနှိပ်ပါက စကားလုံး၏တန်ဖိုးကိုဖတ်ပြသည်။|
|နောက်စာလုံးကိုရွေ့လိုလျှင် |numpad3 |Aslan+rightArrow |flick right (text mode) |နောက်စာလုံးကိုဖတ်ပြခြင်းဖြစ်သည်။|
|စာကြောင်းအဆုံးကိုရွေ့လိုလျှင် |shift+numpad3 |Aslan+end |none |လက်ရှိရှိနေသော ကာစာကို စာကြောင်းအဆုံးသို့ ရွေ့ခြင်းဖြစ်သည်။|
|စာကြောင်းအားလုံးကိုပြန်ဖတ်လိုလျှင် |numpadPlus |Aslan+shift+a |3-finger flick down (text mode) |လက်ရှိရောက်နေသောကာစာမှ စာကြောင်းများ၏အဆုံးထိဖတ်ပြခြင်းဖြစ်သည်။|
|ကော်ပီကူးယူထားသောစာကြောင်းအားဖတ်ပြခြင်း |Aslan+f9 |Aslan+f9 |none |ရွေးချယ်၍ကူးယူထားသောစာကြောင်းကိုဖတ်ပြခြင်းဖြစ်သည်။|
|ရွေးချယ်ထားသောစာကြောင်းကိုကူးယူခြင်း |Aslan+f10 |Aslan+f10 |none |ရွေးချယ်ထားသောစာကြောင်းကိုကူးယူခြင်းဖြစ်သည်။|
|Text Format ကိုဖော်ပြခြင်း |Aslan+f |Aslan+f |none |Internet Browser ပေါ်တွင်အသုံးပြုခြင်းဖြစ်သည်။|
...
| Name |Desktop key |Laptop key |Touch |Description|
|---|---|---|---|---|
|ရှေ့  Review Mode ကိုဖွင့်လိုလျှင် |Aslan+numpad7 |Aslan+pageUp |2-finger flick up |ရှေ့ Review Mode ကိုဖတ်ပြခြင်းဖြစ်သည်။|
|နောက်  Review Mode ကိုဖွင့်လိုလျှင် |Aslan+numpad1 |Aslan+pageDown |2-finger flick down |နောက်  Review Mode ကိုဖတ်ပြခြင်းဖြစ်သည်။|
...
မှတ်ချက် Document Review နှင့် Object Review ကို Aslan သည် အလိုလျှောက်ပြောင်းလဲ​ပေးခြင်းဖြစ်သည်။
...
မှတ်ချက် အချို့သော ထပ်မံထွက်လာသော အက်ပလီကေးရှင်းအသစ်များ သို့မဟုတ် Drawing Technology  ကိုအသုံးပြုထားသော ဆော့ဝဲများတွင် Aslan သည် လတ်တလောမဖတ်နိုင်သေးပါ။

### Mouse ဖြင့်သွားလားခြင်း {#toc41}

Aslan သည် Mouse ရွေ့သောအခါ Mouse ကာစာရောက်ရှိနေသောနေရာကိုဖတ်ပြသည်။

Aslan တွင်ပြင်ဆင်နိုင်သည်  [object](#Objects) ဥပမာ List နှင့် Button 
၎င်းသည်မျက်မမြင်များအတွက်အသုံးဝင်သည်။သို့သော်လဲ တစ်ခါတစ်ရံလုံလောက်မှုမရှိပါ။

Aslan တွင် Mouse ရွေ့သည့်အခါ ဘယ် ညာ ခွဲနိုင်ရန် အသံထည့်သွင်းနိုင်သည်။ နားကြပ် သို့မဟုတ် ဘယ်သံ ညာသံ ခွဲနိုင်သော စပီကာ တစ်စုံ လိုအပ်သည်။

၎င်း Exter Mouse Features ကို အလိုလျောက် မထည့်သွင်းထားပေးပါ။ အကယ်၍ သင်သုံးလိုလျှင် Aslan ၏[Mouse settings](#MouseSettings) တွင်သွားရောက်ထည့်သွင်းနိုင်သည်။
...
| Name |Desktop key |Laptop key |Description|
|---|---|---|---|
|Mouse ၏ ဘယ်လက်ခလုတ်ကိုနှိပ်လိုလျှင် |numpadDivide |Aslan+[ |နှစ်ချက်နှိပ်ပါက ရွေချယ်ထားသော အရာကို အလုပ်လုပ်ခြင်းဖြစ်သည်။|
|Mouse ၏ ဘယ်ဘက်ခလုတ်ကို Lock လုပ်လိုလျှင် |shift+numpadDivide |Aslan+control+[ |တစ်ကြိမ်နှိပ်ပါက Lock လုပ်မည် ၊ နောက်တစ်ကြိမ်နှိပ်ပါက Unlock လုပ်မည်။|
|Mouse ၏ ညာဘက်ခလုတ်ကိုနှိပ်လိုလျှင် |numpadMultiply |Aslan+] |ညာဘက်ခလုတ်ကို တစ်ကြိမ်နှိပ်ပါ။|
|Mouse ၏ ညာဘက်ခလုတ်ကို Lock လုပ်လိုလျှင် |shift+numpadMultiply |Aslan+control+] |တစ်ကြိမ်နှိပ်ပါက Lock လုပ်မည် ၊ နောက်တစ်ကြိမ်နှိပ်ပါက Unlock လုပ်မည်။|
|လက်ရှိရောက်နေသော object ထဲရွေ့လိုလျှင် |Aslan+numpadDivide |Aslan+shift+m |လက်ရှိရောက်နေသော Mouse ကာစာကိုဖတ်ပြခြင်းဖြစ်သည်။|
|Object အတွင်းတွင်ရွေ့လိုလျှင် |Aslan+numpadMultiply |Aslan+shift+n |Mouse ရောက်ရှိနေသောနေရာကို ဖတ်ပြခြင်းဖြစ်သည်။|
...
ပုံမှန် Document များတွင် ပုံမှန် ကာစာ Key များဖြင့်ရွေ့နိုင်သော်လည်း Browse Mode Document များတွင် Aslan မှသတ်မှတ်ထားသော key များဖြင့်ပါရွေ့နိုင်သည်။ ဥပမာ say all, report formatting, table navigation commands, etc.
All of Aslan's [system caret](#SystemCaret) key commands will work in this mode;
...
| Name |Key |Description|
|---|---|---|
|Toggle browse/focus modes |Aslan+space |Toggles mode နှင့် Browse mode ကိုပြောင်းလဲခြင်းဖြစ်သည်။|
|Focus mode ကိုပိတ်ခြင်း |escape |Focus mode ကိုပိတ်သည်နှင့် Browse mode ပြောင်းလဲသွားသည်။|
|Browse mode document များကို Refresh ပြုလုပ်ခြင်း |Aslan+f5 |လက်ရှိရှိနေသော document များတွင် Link အသစ်များကိုထပ်မံဖော်ပြခြင်းဖြစ်သည်။(Microsoft နှင့်Outlook တွင် အသုံးမပြုနိုင်ပါ။)|
|ရှာဖွေခြင်း |Aslan+control+f |ရှာဖွေသည့် Dialog  Box ပေါ်လာသောအခါ စာလုံးအချို့ရိုက်၍ လက်ရှိ Document အတွင်းရှိ အချက်လက်များကိုရှာဖွေနိုင်သည်။|
|ထပ်မံရှာဖွေခြင်း |Aslan+f3 |လက်ရှိ Document အတွင်းရှိ ရှာဖွေခဲ့သည့်စာသားများအားထပ်မံရှာဖွေခြင်းဖြစ်သည်။|
|ယခင်အချက်လက်များပြန်လည်ရှာဖွေခြင်း |Aslan+shift+f3 |ယခင်ရှာဖွေခဲ့သည့် အချက်လက်များကို ပြန်လည်ရှာဖွေခြင်းဖြစ်သည်။|
|အဓိပ္ပါယ်ဖော်ပြချက်အရှည်ကိုသိလိုလျှင် |Aslan+d |မည်သည့်နေရာတွင်ရောက်ရှိနေသည်အပါအဝင် အချက်လက်အတော်များများကို ဖတ်ပြခြင်းဖြစ်သည်။|
...
<!-- KC:beginInclude -->
အက္ခရာများဖြင့် ရွေ့ခြင်း အဖွင့် နှင့် အပိတ် Aslan+shift+space.
<!-- KC:endInclude -->
...
| Name |Key |Description|
|---|---|---|
|Browse mode elements list |Aslan+f7 |လက်ရှိရောက်နေသော Document အတွင်းရှိ လင့်အမျိုးမျိုးကို List လုပ်နိုင်သည်။|
...
| Name |Key |Description|
|---|---|---|
|Browse mode document တွင် ရွေ့လိုလျှင် |Aslan+control+space |Document အတွင်းရှိ Embedded Objects မှ တခြား Embedded Objects သို့ရွေ့ခြင်းဖြစ်သည်။|

<!-- KC:endInclude -->

## သင်္ချာဖတ်ခြင်းနှင့်ဆိုင်သော {#toc45}

Aslan သည် MathPlayer 4 တွင် ဖတ်လဲဖတ်နိုင်သည် ရွေ့လဲ ရွေ့လျားနိုင်သည်။
...
Aslan သည် ဖော်ပြထားသော သင်္ချာနှင့်ဆိုင်သော ဆော့ဝဲများပေါ်တွင် အလုပ်လုပ်သည် :
...
Aslan သည် သင်္ချာနှင့်ဆိုင်သော သင်္ကေတများကို Document ပေါ်တွင် ဖတ်သည်။
...
Aslan သည် ကာစာများကို ရွေ့သောအခါ Microsoft ပေါ်တွင် Column နှင့် Row များကို အလိုလျှောက်ဖတ်သည်။
ပထမ လိုအပ်ချက်မှာ Aslan Setting ထဲရှိ Document Formatting တွင် Column နှင့် Row များကိုအမှန်ခြစ်ထားပေးရန်လိုအပ်သည်။
ဒုတိယအနေဖြင့် Aslan သည် Table တွင် ပါသော Column နှင့် Row များကို သိရှိသည်။
Tabel အတွက် Short Cut များ:
<!-- KC:beginInclude -->

| Name |Key |Description|
|---|---|---|
|Column ထည့်သွင်းခြင်း |Aslan+shift+c |တစ်ကြိမ်နှိပ်ရုံဖြင့် Aslan သည် Column ထည့်ပြီးကြောင်းပြောလိမ့်မည်။ နှိပ်ကြိမ်နှိပ်လျှင် Column ပြန်ဖြုတ်မည်။|
|Row ထည့်သွင်းခြင်း |Aslan+shift+r |တစ်ကြိမ်နှိပ်ရုံဖြင့် Aslan သည် Row ထည့်ပြီးကြောင်းပြောလိမ့်မည်။ နှိပ်ကြိမ်နှိပ်လျှင် Row ပြန်ဖြုတ်မည်။|
...
<!-- KC:beginInclude -->
Browse mode ကို Microsoft Word တွင် အပိတ် အဖွင့် လုပ်လိုလျှင် Aslan+space ကိုနှိပ်ပါ။
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Microsoft Word Browse mode တွင် List လုပ်လိုလျှင် Aslan+f7 ကိုနှိပ်ပါ။
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Character ရှိနေသည့်အနေထားကို သိလိုလျှင် Aslan+alt+c ကိုနှိပ်ပါ။
<!-- KC:endInclude -->
Document တွေနှင့် အခြားအပြောင်းအလဲများအတွက် comments တွေသည် Aslan ၏ Elements list တွင်ပေါ်လာရန်အတွက် စာရိုက်ရင်းနှင့် မှတ်စုများကိုမှတ်သားနိုင်သည်။

### Microsoft Excel {#toc53}
#### Column နှင့် Row များကို အလိုလျှောက်ဖတ်ခြင်း {#toc54}

Aslan သည် ကာစာများကို ရွေ့သောအခါ Excel Worksheeds ပေါ်တွင် Column နှင့် Row များကို အလိုလျှောက်ဖတ်သည်။
ပထမ လိုအပ်ချက်မှာ Aslan Setting ထဲရှိ Document Formatting တွင် Column နှင့် Row များကိုအမှန်ခြစ်ထားပေးရန်လိုအပ်သည်။
ဒုတိယအနေဖြင့် Aslan သည် Table တွင် ပါသော Column နှင့် Row များကို သိရှိသည်။
Tabel အတွက် Short Cut များ:
<!-- KC:beginInclude -->
...
<!-- KC:beginInclude -->
Excel တွင်Elements List  များကို စုစည်းလိုလျှင် Aslan+f7 ကိုနှိပ်ပါ။
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
လက်ရှိရောက်နေသော Cell ကိုသိလိုလျှင် Aslan+alt+c ကိုနှိပ်ပါ။
<!-- KC:endInclude -->
Worksheet အတွင်းရှိ Aslan Element List တွင် ၎င်းကိုအသုံးပြုနိုင်သည်။

#### Reading Protected Cells {#toc57}

အကယ်၍ Workbook ကို Protected လုပ်ထားလျှင် သက်ဆိုင်ရာ Cell များသို့ရွေ့လို့မရပါ။
<!-- KC:beginInclude -->
Block Cell များကို ရွေ့လိုလျှင် Aslan+space ကိုနှိပ်ပါ ပြီးလျင် ပုံမှန်အတိုင်း ရွေ့နိုင်ပါသည်။
<!-- KC:endInclude -->
...
| Name |Key |Description|
|---|---|---|
|Message ကိုသိလိုလျှင်| Aslan+control+1-4 |တွဲနှိပ်သည့် ဂဏာန်းပေါ်မူတည်၍ Message များကိုဖတ်ပြသွားမည်။ ဥပမာ  Aslan+control+2 ဖြင့်နှိပ်ပါက ဒုတိယ Message ကိုဖတ်ပြလိမ့်မည်။|
...
| Name |Key |Description|
|---|---|---|
|Message ဖတ်ခြင်း |Aslan+control+1-0 |တွဲနှိပ်သည့် ဂဏာန်းပေါ်မူတည်၍ Message များကိုဖတ်ပြသွားမည်။ ဥပမာ  Aslan+control+2 ဖြင့်နှိပ်ပါက ဒုတိယ Message ကိုဖတ်ပြလိမ့်မည်။|

<!-- KC:endInclude -->

### PC အတွက် Kindle {#toc64}

Aslan သည် Kindle for PC  ပေါ်တွင်လဲ အလုပ်လုပ်သည်။
...
Aslan Browse Mode တွင်၎င်းတို့ကိုဖတ်နိုင်သည်။
...
## Aslan  ပြင်ဆင်ခြင်း {#toc67}
### ပြင်ဆင်ခြင်း {#toc68}

<!-- KC:settingsSection: || Name | Desktop key | Laptop key | Description | -->
Aslan အတော်များများတွင် settings များကိုပြင်ဆင်နိုင်သည်။ 
...
#### General Settings (Aslan+control+g) {#toc69}
...
Aslan ကို restart မဖြစ်မနေလုပ်ပေးရမည်။
အကယ်၍ Restart လုပ်မည်ဆိုလျှင် Aslan က ရွေးချယ်ထားတဲ့အရာကို ပြောင်းလဲပေးပါလိမ့်မည်။
OK ကိုနှိပ်ပါ Aslan restart ဖြစ်သွားပါလိမ့်မည်။

##### Aslan ပိတ်သည်နှင့် မိမိ Setting များကို Save ခြင်း {#toc71}

Aslan ကို ပိတ်သည်နှင့် အလိုလျှောက် Save လိုလျှင် Save Configuration on exit ကို အမှန်ခြစ်ပေးရမည်။

##### Aslan ပိတ်သောအခါတွင် {#toc72}

Aslan ပိတ်သောအခါ မည်သည့်အရာမှ မမေးစေလိုလျှင် Show exit options when exiting Aslan ကို အမှန်ခြစ်ဖြုတ်ပေးရမည်။

##### Aslan အဖွင့် နှင့် အပိတ်မှာ အသံမြည်လိုလျှင် {#toc73}

Aslan စတင်သောအခါနှင့် ပိတ်သောအခါအသံထွက်မည်လား(Play sounds when it starts or exits Aslan)ကိုအမှန်ခြစ်ပေးရမည်။

##### Logging level {#toc74}

မိမိလိုချင်သော Logging စနစ်ကို Combo Box တွင်ရွေးရမည်။

##### အလိုလျှောက် Aslan ဖွင့်ခြင်း {#toc75}

Automatically start Aslan after I log on to Windowss ကိုအမှန်ခြစ်ထားခြင်းဖြင့် Windows တက်သည်နှင့်အလုပ်လုပ်သည်။
Install လုပ်ထားသော NVAD တွင်သာအလုပ်လုပ်နိုင်သည်။

##### Windows တက်သည်နှင့် Logon Screen တွင် Aslan ကိုဖတ်လိုလျှင် {#toc76}

Logon အနေထားတွင် Aslan အားအသုံးပြမည်(Use Aslan on the Windows Logon Screen) (require administrator privileges) ကိုအမှန်ခြစ်ထားရမည်။
Install လုပ်ထားသော NVAD တွင်သာအလုပ်လုပ်နိုင်သည်။
...
Automatically check for updates to Aslan ကိုအမှန်ခြစ်ထားပေးရမည်။
Install လုပ်ထားသော NVAD တွင်သာအလုပ်လုပ်နိုင်သည်။

#### Synthesizer ရွေးချယ်ခြင်း(Aslan+control+s) {#toc79}
...
Aslan သည် မည်သည့် Synthesizer များဖြင့်တွဲဖက်အလုပ်လုပ်သည်ကို [Supported Speech Synthesizers](#SupportedSpeechSynths) တွင် သွားရောက်လေ့လာနိုင်သည်။
...
Aslan အသံမှလွဲ၍ အခြားအသံများကိုတိုးပေးသည်။
-

Install လုပ်ထားသော NVAD တွင်သာအလုပ်လုပ်နိုင်သည်။
Portable Version တွင် အသုံးမပြုနိုင်ပါ။

#### Voice Settings ကို အသုံးပြုလိုလျှင်(Aslan+control+v) {#VoiceSettings}
...
Automatic Language Switching (When Supported) ကို အမှန်ခြစ်ထားလျှင် Language ကိုအလိုလျောက်ပြောင်းလဲပေးသည်။ Aslan Settion တွင် အမှန်ခြစ်ပြီးသားဖြစ်သည်။
...
ပုံမှန်အားဖြင့် ဤလုပ်ဆောင်ချက်သည် Aslan အား လက်ရှိအသုံးပြုနေသောဘာသာစကားသည် သင်္ကေတနှင့် အက္ခရာများအတွက် သင့်လျော်သောဘာသာစကား ဟုတ်မဟုတ်ပြောအသိပေးမည် ဖြစ်ပါသည်။ အကယ်၍ Aslan သည် synthesizer သို့ voice ဖြင့် ပုဒ်ဖြတ်၊ ပုဒ်ရပ်များအား ဘာသာစကားအမှားဖြင့်ဖတ်နေပါက NVD အား အပြည်ပြည်ဆိုင်ရာဘာသာစကားအပြင်အဆင်(global language setting) ဖြင့်အစားထိုးအသုံးပြုနိုင်ပါသည်။
...
| Name |Desktop key |Laptop key |Description|
|---|---|---|---|
|Synth setting များကိုအပြောင်းလဲလုပ်လိုလျှင် |Aslan+control+rightArrow |Aslan+shift+control+rightArrow |၎င်း short cut ကိုနှိပ်၍ Voice Setting ထဲတွင်ရှိသည့်အရာများကို ရွှေ့နိုင်သည်။|
|Synth setting များကိုအပြောင်းလဲလုပ်လိုလျှင် |Aslan+control+leftArrow |Aslan+shift+control+leftArrow |၎င်း short cut ကိုနှိပ်၍ Voice Setting ထဲတွင်ရှိသည့်အရာများကို ရွှေ့နိုင်သည်။|
|Synth setting များကို မြှင့်လိုလျှင် |Aslan+control+upArrow |Aslan+shift+control+upArrow |ဥပမာ Rate, Voice, Volume တို့ကို မြှင့်ခြင်း ဖြစ်သည်။|
|Synth setting များကို နှိမ့်လိုလျှင် |Aslan+control+downArrow |Aslan+shift+control+downArrow |ဥပမာ Rate, Voice, Volume တို့ကို နှိမ့်ခြင်း ဖြစ်သည်။|
...
Aslan အနေဖြင့် "USB"နှင့် "Bluetooth" ကိုရွေးချယ်ပေးသည်။ သို့သော် အချို့ Display များဖြင့်မကိုက်ညီပါ။
...
ဤ option သည်အမှတ်စဉ်အကွက်ဖြစ်ပြီး braille display တွင် Aslan မှ messages များမည်မျှအကြာထိဖော်ပြထားမည်ကို ချိန်ညှိရာအတွက်အသုံးပြုသည်။
...
#### Keyboard Settings (Aslan+control+k) {#toc113}
...
##### Aslan Key ကို capslock key ဖြင့် အသုံးပြုခြင်း {#toc115}

၎င်းကို အသုံးပြုလိုလျှင် Use Caplock as an Aslan modifier key ကို အမှန်ခြစ်ထားပါ။

##### Use extended insert as an Aslan modifier key {#toc116}

Insert အား Aslan ၏အထူးခလုပ်ဖြင့်အသုံးပြုလိုပါက (Use extended insert as an Aslan modifier key) ကိုအမှန်ခြစ်ထားပါ။ Home Key , End Key , Arrow Key များကို အစားထိုးအသုံးပြုခြင်းဖြစ်သည်။

##### Use numpad insert as an Aslan modifier key {#toc117}

Numpad နှင့် Aslan အား Aslan ၏အထူးခလုပ်ဖြင့်အသုံးပြုလိုပါက (Use numpad insert as an Aslan modifier key)ကိုအမှန်ခြစ်ထားပါ။  

အကယ်၍ Key တစ်ခုမျှ မရွေးချယ်ထားလျှင် Aslan မှ အနည်းဆုံး Key တစ်ခုရွေးချယ်ရန် Message Box ကျလာလိမ့်မည်။
...
#### Mouse Settings (Aslan+control+m) {#MouseSettings}
...
၎င်း Setting တွင် Aslan ကို စကားလုံးတစ်လုံးစီသော်လည်းကောင်း စကားစုတစ်စုစီသော်လည်းကောင်း စာပိုဒ်တစ်ပိုဒ်စီသော်လည်းကောင်း ဖတ်ပြရန်ရွေးချယ်နိုင်သည်။
...
၎င်းကိုအမှန်ခြစ်ထားလျှင် Aslan ရွှေ့သည့်အခါ အသံမြည်ခြင်းဖြစ်သည်။
...
၎င်း Setting သည် Aslan တွင် အမှန်မခြစ်ထားပါ။
...
#### Object Presentation Settings (Aslan+control+o) {#toc139}
...
ဤ option သည်ပုံမှန်အားဖြင့် select လုပ်ထားသော candidate list ထွက်ပေါ်လာသောအခါ သို့မဟုတ် select လုပ်ထားသော candidate ပြောင်းသွားသောအခါ Aslan မှသတိပေးချက်ပေးသော option တစ်ခုဖြစ်သည်။ 
...
ဤ option သည်ပုံမှန်အားဖြင့် candidate တစ်ခုခြင်းစီ၏အချက်အလက်အား select မှတ်ထားသောအခါတွင်လည်းကောင်း သို့မဟုတ် candidate list ထွက်ပေါ်လာသောအခါ အလိုအလျှောက်ဖတ်သောအခါ Aslan မှ အနည်းအကျဉ်းဖော်ပြပေးရန် သို့မဟုတ် မဖော်ပြပေးရန်အတွက် ရွေးချယ်နိုင်ခြင်းဖြစ်သည်။ 
...
ထို reading string တွင် ဤ option ဖြင့် characters အသစ်များရေးသောအခါ Aslan မှဖတ်ပြမည်၊ မဖတ်ပြမည်ဆိုသည်ကို သင်ရွေးချယ်နိုင်သည်။
...
#### Browse Mode Settings (Aslan+control+b) {#toc155}
...
Aslan တွင် အမှန်ခြစ်ပြီးသားဖြစ်သည်။

##### Include layout tables {#toc160}

၎င်း၏အကျိုးသက်ရောက်မှုသည် Aslan ဖြင့် Table များကို ကောင်းမွန်စွာ ရွှေ့နိုင်ခြင်းဖြစ်သည်။
...
၎င်းကို Aslan နေဖြင့် မူလတွင်ပိတ်ထားပေးသည်။
...
၎င်းကို မူလထဲက Aslan တွင်အမှန်ခြစ်ပြီးသားဖြစ်သည်။ ဥပမာ J ကိုနှိပ်လျှင် Application တွင် သတ်မှတ်ထားသောအလုပ်ကိုလုပ်ခြင်းဖြစ်သည်။ ၎င်းသည် Aslan ၏ Quick Navigation Key များမဟုတ်ပါ။ Application တွင် ထည့်သွင်းထားသော Key များသာဖြစ်သည်။
...
၎င်းကိုအမှန်ခြစ်ထားလျှင် စာတစ်ကြောင်းအား ပြင်ဆင်(format) ထားသောအချက်အလက်အသေးစိတ်ကို ဖတ်ပြပေးသည်။ သို့သော်ဤလုပ်ဆောင်ချက်အားအသုံးပြုပါက Aslan ၏လုပ်ဆောင်ချက်မှာ နှေးသွားလိမ့်မည်။

ပုံမှန်အားဖြင့် Aslan သည် System caret / Review Cursor ရှိသောနေရာမှတည်းဖြတ်ထားသောအချက်အလက်များကို မှတ်သားထားသည်။ တစ်ခါတစ်ရံတွင် စွမ်းစောင်ရည်ထိခိုက်နိုင်ခြင်းမရှိပါက စာကြောင်းအားလုံး၏တည်းဖြတ်ထားသောအချက်အလက်များကိုလည်း မှတ်သားထားပါလိမ့်မည်။
...
* Off: Aslan လုံး၀အလုပ်မလုပ်ပါ။
* Speech: အကယ်၍ ၎င်း ကိုရွေးချယ်ထားလျှင် Aslan မှ တစ်ခုခု ပြောပါလိမ့်မည်။ ဥပမာ Twelve Space နှင့် Four Tab။
...
Aslan's speech dictionary တွင် စကားလုံးများကိုကောင်းမွန်စွာ ပြောင်းလဲနိုင်သည်။
...
Aslan သည်မူလအနေဖြင့် Aslan ပိတ်သည်နှင့် Setting များကို အလိုလျှောက် Save ခြင်းဖြစ်သည်။
မှတ်ချက် သို့သော် General Setting ထဲတွင် Save configuration on exit ကိုအမှန်ခြစ်ဖြုတ်ထားနိုင်ပြီး Aslan Menu ထဲရှိ Save Configuration နှိပ်၍ မိမိလိုအပ်သည့်အခါ Save နိုင်သည်။

အကယ်၍ သင့်အနေဖြင့် ပြင်ဆင်မှုကို မှား၍ Save မိလျှင် Aslan Menu ရှိ Revert saved Configuration နှိပ်၍ ပြန်ပြင်ဆင်နိုင်သည်။ 
သင့်အနေဖြင့် Aslan ၏ Setting များကို မူလအတိုင်းပြန်လည်ဖြစ်လိုလျှင် Aslan Menu ထဲရှိ Reset configuration to factory defaults ကိုနှိပ်နိုင်သည်။
...
| Name |Desktop key |Laptop key |Description|
|---|---|---|---|
|Save configuration |Aslan+control+c |Aslan+control+c |လက်တလောပြင်ဆင်ထားသော Setting များကို Save ခြင်းဖြစ်သည်။|
|Revert  configuration |Aslan+control+r |Aslan+control+r |တစ်ကြိမ်နှိပ်ပါကနောက်ဆုံးပြင်ဆင်ခဲ့သည့်အခြေနေကိုရယူခြင်း သုံးကြိမ်နှိပ်ပါက Aslan ၏ မူလ Setting များကိုပြန်လည်ရယူခြင်းဖြစ်သည်။|
...
ဥပမာ သင့်အနေဖြင့် စာများကို အသေးစိတ် ဖတ်လိုသည့်အခါ Font Size , Font Colour စသော အသေးစိတ်အချက်လက်များကို Aslan ကဖတ်ပြနိုင်ရန်အတွက် Configuration Profiles ပြုလုပ်နိုင်ပါသည်။
...
Aslan menu ထဲတွင် Configuration Profile များကို ရွေးချယ်ပြုလုပ်နိုင်သည်။
Key command ဖြင့်လဲ ပြုလုပ်နိုင်သည်:
<!-- KC:beginInclude -->

* Aslan+control+p: Configuration Profiles dialog Box ပေါ်လာလိမ့်မည်။
...
Custom appModules နှင့် custom drivers များသည် Aslan Portable folder ထဲရှိ userConfig ထဲတွင်တွေ့နိုင်သည်။
...
Log viewer ကို Aslan menu Tool ထဲတွင်ရှာပါ။ Log viewer ထဲတွင် Aslan အသုံးပြုသည့် အသေးစိတ်အချိန်ဇယားများကိုတွေ့နိုင်ပါသည်။

Viewer File ထဲရှိအချက်လက်များကို ကူးယူနိုင်သည်။

### Speech Viewer {#toc183}

Aslan မှ ပြောဆိုသည့်အရာများကို Developer များနှင့် မျက်စိမြင်သူများ သိနိုင်ရန်အတွင် အပေါ် မှ အောက်သို့ စာတန်းဖြင့်ဖော်ပြပေးသည်။

Aslan menu ထဲမှ Tool တွင် နှိပ်၍ ပိတ်နိုင် ဖွင့်နိုင်သည်။

Windows တက်သည်နှင့် Speech Viewer ကိုတက်လိုလျှင် Show speech viewer on startup ကိုအမှန်ခြစ်ထားပါ။

Speech Viewer အလုပ်လုပ်နေလျှင် Aslan မှဖော်ပြလေသောစာများကိုကူးယူနိုင်သည်။
...
### Add-ons Manager {#toc184}
 ...
 Add-ons Manager ကို Aslan Menu Tool တွင်ရှာဖွေနိုင်သည်။ Install, Uninstall, Anable နှင့် Disable ပြုလုပ်နိုင်သည်။
...
၎င်း button မှဖွင့်ပေးပါလိမ့်မည် Aslan Add-ons Page ဖြစ်သော[Aslan Add-ons page](https://addons.aslan-project.org/)ကိုဖွင့်ပေးပါလိမ့်မည်။

Aslan Add-on Install လုပ်လိုလျှင် Install button ကိုနှိပ်ပါ။
ထို့နောက် add-on package ဖိုင်ကိုရှာ၍  နှိပ်ပါ။ထို့နောက် Installation စတင်မည်။

Installation စတင်သောအခါ ပထမဦးစွာ Aslan ကမေးပါလိမ့်မည်။ Install တကယ်လုပ်မလားဆိုတာကိုမေးပါလိမ့်မည်။
အဘယ်ကြောင့်ဆိုသော် မိမိကိုယ်ရေးကိုယ်တာအချက်လက်များကို ကာကွယ်ရန်ဖြစ်သည်။
Add-on Install လုပ်ပြီးသောအခါ Aslan ကို restart ချပြီးနောက် စတင်အလုပ်လုပ်မည်။
...
Aslan က တကယ်ဖျတ်မှာလားဆိုတာကိုမေးပါလိမ့်မည်။
...
Enable သို့မဟုတ် Disable ကိုနှိပ်သောအခါ Aslan Restart ဖြစ်သွာလိမ့်မည်။
Aslan ကို install သို့မဟုတ် remove လုပ်သောအခါ restart လုပ်ပေးရန်လိုအပ်သည်။

Add-on manager ကိုဖြုတ်လိုလျှင် Close button ကိုနှိပ်ပါ။

Aslan သည် copying individual plugins နှင့် drivers ကို Aslan user Configuration directory ထဲတွင် ကူးယူထားသည်။သို့သော် Add-on Manager တွင်ဖော်ပြထားခြင်းမရှိပါ။
...
Aslan Python console ကို Aslan menu tool ထဲတွင်ရှာဖွေနိုင်သည်။ ၎င်းသည် Developer Tool ဖြစ်ပြီး debugging ပြုလုပ်ရန်နှင့် Aslan ၏တည်စောက်ပုံအတွင်းပိုင်းအားစစ်စေးရန် သို့မဟုတ် Aslan application ၏ accessibility အခြေအနေအဆင့်ဆင့်ကို သိရှိနိုင်သည်။ 
အသေးစိတ်သိလိုပါက [the Development section of the Aslan web site](https://community.aslan-project.org/wiki/Development)တွင်သွားရောက်လေ့လာနိုင်ပါသည်။
...
အလကားရယူနိုင်သော synthesizer များနှင့် ဝယ်ယူသုံးစွဲရသော synthesizer များကို လေ့လာပါစို့[https://www.aslan-project.org/wiki/ExtraVoices](https://www.aslan-project.org/wiki/ExtraVoices).

### eSpeak NG {#toc188}

[eSpeak NG](https://github.com/espeak-ng/espeak-ng) eSpeak NG ကို Aslan တွင် မူလတည်းကထည့်သွင်းပြီးသားဖြစ်သည်။ Driver နှင့် အခြား component များ ထည့်သွင်းစရာမလိုပါ။
Aslan ကို USB thumb drive နှင့် အခြားသော System များပေါ်တွင်သုံးနိုင်သည်။
...
အသုံးပြုသူသည် SAPI 4 ကို install လုပ်ထားလျှင် Aslan သည်အလုပ်လုပ်နေဆဲဖြစ်သည်။
...
Microsoft Speech Platform သည် အသံများစွာနှင့် languages များစွာအတွက် အထောက်ကူပြုသည်။ ၎င်းအသံများကိုလဲ Aslan တွင်အသုံးပြုသည်။
...
### Nuance Vocalizer for Aslan {#toc193}
...
Aslan portable version တွင်လဲအသုံးပြုနိုင်သည်။

အသေးစိတ်အချက်လက်များနှင့် မည်သို့ဝယ်ယူရမည်ကို သိရှိလိုလျှင်[www.vocalizer-aslan.com](https://www.vocalizer-aslan.com/) တွင် သွားရောက်လေ့လာနိုင်ပါသည်။
ရောင်းရသည့် အမြတ်ငွေ၏ ရာခိုင်နှုန်းအချို့ကို Aslan အတွက်ပြန်လည်လှူဒါန်းသည်။
...
Aslan အနေဖြင့် USB သို့မဟုတ် bluetooth ဖြင့်အလိုလျောက်ချိတ်ဆက်သည်။
...
အောက်ပါ key assignments များသည် Aslan နှင့် display တွဲသုံးရန်ဖြစ်သည်။
...
အလွယ်တကူချိတ်ဆက်ပြီး Aslan တွင် configure လုပ်၍ သုံးနိုင်သည်။

၎င်း Display မှ Brail Keyboard ကိုသုံးလျှင် Brail to Text ကို အလိုလျှောက်ပြုလုပ်ပေးသည်။
Aslan ၏ braille input table setting နှင့် မသက်ဆိုင်ပါ။
...
Aslan သည် Handy Tech Displays အားလုံးပေါ်တွင်အလုပ်လုပ်သည်။[Handy Tech](https://www.handytech.de/) 
...
Aslan သည် Hims ၏ထုတ်ကုန်များဖြစ်သော Braille Sense၊ Braille EDGE နှင့် Smart Beetle displays [Hims](https://www.hims-inc.com/) တို့အား USB သို့မဟုတ် bluetooth ဖြင့်ချိတ်ဆက်ကာအသုံးပြုနိုင်သည်။
...
Aslan သည် [HIMS](https://www.hims-inc.com/) မှထုတ်လုပ်ထားသော SyncBraille Display များအားထောက်ပံ့ပေးနိုင်သည်။
...
အကယ်၍ BrxCom install လုပ်ထားလျှင် BrxCom ဖြင့် Aslan အသုံးပြုနိုင်သည်။
BrxCom သည် braille display function နှင့်မတူဘဲ screen reader မှာ လွယ်ကူစွာအသုံးပြုနိုင်သည်။
BrxCom version အသစ်သည် မကြာမီ Aslan အတွင် အလုပ်လုပ်လိမ့်မည်။
...
အောက်တွင်ပေးထားသော အချက်များသည် Aslan အတွက် Papenmeier command assignments များဖြစ်ကြသည်။
<!-- KC:beginInclude -->
...
Aslan သည် BrailleNote notetakers ဖြင့်အလုပ်လုပ်သည်။[Humanware](https://www.humanware.com) 
Aslan ဖြင့်အလုပ်လုပ်နိုင်သော models များ:
...
Aslan တွင် port ထည့်သွင်းရန် Braille Setting တွင်လိုအပ်သည်။
...
အောက်ပါအချက်များသည် Aslan အတွက် BrailleNote command assignments များဖြစ်ကြသည်။
...
Aslan သည် [ONCE](https://www.once.es/) မှ EcoBraille displays များအားထောက်ပံ့ပေးနိုင်သည်။ 
Aslan ဖြင့်အလုပ်လုပ်နိုင်သော models များ:
...
Aslan Braille Settings ထဲတွင် serial port ဖြင့်ချိတ်ပါ။
...
ထို့ကြောင့် Aslan table setting နှင့် မသက်ဆိုင်ပါ။

အောက်ပါအချက်များသည် Aslan အတွက် BRLTTY command assignments များဖြစ်သည်။ 
...
Aslan ကို Run Dialog ထဲမှလဲ Command ပေးနိုင်သည်။
လတ်တလော Run နေသော Aslan ကိုပိတ်လိုလျှင်:
...
|aslan -rm |aslan -rm သည် လက်ရှိ Run နေသော Aslan ကိုပိတ်ပြီး Aslan အသစ်စတင်ခြင်းဖြစ်သည်။ထို့ပြင် add-ons ကိုလဲ enable ပြုလုပ်ခြင်းဖြစ်သည်။|
|aslan -rm --disable-addons |aslan -rm --disable-addons သည်အပေါ်နှင့်တူသည်။သို့သော် add-ons ကို disabled ပြုလုပ်ခြင်းဖြစ်သည်။|
...
|aslan -l 10 |log level ကိုစတင်သတ်မှတ်ခြင်းဖြစ်သည်။|
|aslan --log-file=c:\aslan.log |Aslan log ဖိုင်ကို c:ထဲတွင်သိမ်းထားခြင်းဖြစ်သည်။|
|aslan --log-level=20 -f c:\aslan.log |Aslan log info ကိုစတင်သတ်မှတ်ခြင်းဖြစ်သည်။|
...
|-q |--quit |လတ်တလော Run နေသည့် Aslan ကိုပိတ်ခြင်း|
|-r |--replace |လတ်တလော Run နေသည့် Aslan ကိုပိတ်ပြီး အလိုလျောက်ပြန်လည်ဖွင့်ခြင်း|
|-k |--check-running |Aslan အလုပ်လုပ်သည် မလုပ်သည်ကိုစစ်ဆေးခြင်းဖြစ်သည်။0 ဆိုလျှင်အလုပ်လုပ်သည် ၊ 1 ဆိုလျှင်အလုပ်မလုပ်ပါ။|
...
|-c CONFIGPATH |--config-path=CONFIGPATH |Aslan Setting မည်သည့်နေရာသိမ်းမည်ကိုသတ်မှတ်ခြင်း|
...
|None |--install |Installs Aslan (Aslan အားတင်ပြီးသောအခါ အလုပ်လုပ်ပါ)|
|None |--install-silent |Silently installs Aslan (Aslan အားတင်ပြီးပြီးချင်း မစတင်ပါနှင့်)|

## Further Information {#toc214}

အကယ်၍ လိုအပ်လျှင် ဆက်လက်လေ့လာချင်ပါက ကျေးဇူးပြု၍ Aslan web site သို့ သွာရောက်လေ့လာနိုင်ပါသည်။ at Aslan_URL.
