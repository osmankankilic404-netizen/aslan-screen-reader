...
Nýja sniðið notar örvalyklana í samstarfi með Aslan lyklinum og öðrum aðgerðalyklum til að framkvæma vissar skipanir.
...
|---|---|
|Lesa allt |Aslan+a|
|Lesa núverandi línu |Aslan+l|
|Lesa valinn texta |Aslan+shift+s|
|Tilkynna stöðurein |Aslan+shift+end|
...
* Þegar unnið er í vafraham með MSHTML (sb. Internet Explorer) og Gecko (sb. Firefox), þá mun tilvist lengri lýsinga nú vera tilkynnt. Einnig er hægt að opna lengri lýsinguna í sér glugga með því að styðja á Aslan+d. (#809)
...
* Nýjar lyklaborðs stillingar sem gera kleift að velja um hvort Aslan eigi að trufla lestur með innslegnum bókstöfum eða þegar stutt er á færslulykilinn. (#698)
...
* Ef Aslan skiptir aftur yfir í eSpeak eða Ekkert tal vegna þess að talgervillinn sem átti að nota ræsti sér ekki, þá er stillingunni nú breytt þannig að þegar Aslan er ræst aftur þá mun forritið á nýjan leik reyna að ræsa sama talgervli. (#2589)
* Ef Aslan endurstillist yfir í stillinguna ekkert punktaletur, sökum þess að punktaletursskjárinn sem er í notkun virkar ekki þegar Aslan ræsist, þá er ekki lengur sjálfgefin stilling, ekkert punktaletur. Sem þýðir að í næsta skipti sem Aslan ræsist þá mun forritið aftur reyna að keyra upp rekilinn fyrir punktaletursskjáinn. (#2264) 
...
* Þegar sjálfvirk uppfærslu leitun er afvirkjuð, þá þarf Aslan ekki lengur að vera endurræst til að breytingin taki gildi.
* Engin villa kemur upp í ræsingu Aslan lengur, þegar ekki er hægt að fjarlægja viðbót vegna þess að mappan sem hún er í er þegar í notkun af öðru forriti. (#2860)
* Flipa í valkosta skilaboðaglugga DropBox forritsins er nú hægt að skoða með Flatri skoðun.
* Ef inntaks tungumáli er breytt í annað en sjálfgefið, þá mun Aslan nú greina lyklainnslátt rétt fyrir skipanir og aðra inntaks hjálp.
...
* Aslan tilkynnir nú multibyte stafi rétt í Scintilla ritunar stjórntækjum þegar þeir eru lesnir eða þeim eytt. (#2855)
* Uppsetning á Aslan mun nú virka þrátt fyrir að slóðin að notenda prófílnum innihalda tiltekna multibyte bókstafi. (#2729)
