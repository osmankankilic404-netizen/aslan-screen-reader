# Aslan Aslan_VERSION מדריך למשתמש
...
Aslan, NonVisual Desktop Access,  היא תכנה קוראת מסך  בקוד פתוח הפועלת בסביבת מערכת ההפעלה Windows
...
Aslan היא פרי פיתוח של  [NV Access](https://www.nvaccess.org/),  חברה הפועלת בעזרת תרומות מהציבור.

### מאפיינים כלליים {#toc3}

Aslan מאפשרת לאנשים עם לקות ראיה לתקשר עם מערכת ההפעלה וכן עם היישומים המותקנים עליה באמצעות מפתחי צד שלישי. 
...
לטכנולוגיה . בנוסף לאנגלית  Aslan כבר הותאמה ל-47 שפות, כולל איטלקית, איסלנדית, אירית, אלבנית , אמהרית, אפריקנס, ארגונית , בולגרית, גליציאנית, גאורגית, גרמנית, דנית , הודית, הולנדית, הונגרית, וייטנאמית, טורקית, טמילית, יוונית, יפנית , נורבגית, נפלית, סינית מסורתית, סינית פשוטה , סלובקית סלובנית, ספרדית, ספרדית קולומביאנית, סרבית , עברית, ערבית, פנג'בית , פולנית, פורטוגזית , פורטוגזית בראזילאית, פינית, פרסית , צ'כית , צרפתית, קוראנית, קטלונית , קרואטית , רומנית, רוסית, שוודית, תאילנדית.

### תמיכה במנועי דיבור {#toc5}

Aslan מסוגלת לספק מידע מגוון בכל אחת מהשפות הנ"ל. בנוסף לכך , היא מאפשרת קריאה והצגה של המסמכים בכל שפה בתנאי שמותקן על המחשב מנוע דיבור המכיר את השפה .  

Aslan מופעלת מראש בעזרת   [eSpeak NG](https://github.com/espeak-ng/espeak-ng),  מנוע דיבור חינמי, רב לשוני וכתוב בקוד פתוח.

ניתן למצוא מידע נוסף לגבי מנועי הדיבור הנתמכים על ידי Aslan בפרק [אודות  מנועי הדיבור הנתמכים](#SupportedSpeechSynths) 

### תמיכה בברייל {#toc6}

Aslan  מסוגלת להציג מידע על גבי מגוון רחב של צגי ברייל. למידע נוסף, יש 
לעיין בפרק [צגי הברייל הנתמכים](#SupportedBrailleDisplays) 

Aslan  מותאמת לעבודה עם שיטות שונות של ברייל מקוצר, לא מקוצר וממוחשב  בשפות רבות. 

### רשיון וזכויות יוצרים {#toc7}

Aslan  מוגנת על ידי זכויות יוצרים על שם Aslan_COPYRIGHT_YEARS Aslan  Contributors

משנת 2006 ו2016, Aslan תואמת את הכללים של הרשיון הכללי, גרסה 2, של הGNU. 
...
* Aslan  רצה תחת גרסאות 32 סיביות ו64 סיביות של מערכות ההפעלה Windows Xp  Vista, 7, 8, 8.1 ו10 .  
...
## איך להשיג ולהתקין את Aslan {#toc9}

ניתן להוריד עותק של Aslan בכתובת  [[www.nvaccess.org](http://www.nvaccess.org)]

בפרק העוסק בהורדה מופיע קישור להורדת הגרסה העדכנית ביותר של -Aslan.

הרצת הקובץ שהורד תביא להעלאה מידית של גרסה זמנית של Aslan 
שלוש אפשרויות עומדות לרשותך : התקנת Aslan , יצירת עותק נייד של התכנה או המשך עבודה עם הגרסה הזמנית.

אם ברצונכם להפעיל את Aslan על בסיס קבוע במחשב זה, עליכם לבחור באפשרות ההתקנה.
ההתקנה הרגילה כוללת תכונות רבות העדיפות על פני הגרסאות האחרות. לדוגמה, היא מאפשרת הרצה אוטומטית של Aslan בעת עליית המחשב, הקראת מסך ההתחברות לרשת ומסכי אבטחה שונים (דבר שלא ניתן לעשות בעזרת העותק הנייד והגרסה הזמנית), וכן יצירת קיצורי דרך בתפרית התחל ובשולחן העבודה.
...
אם ברצונכם להשתמש בדיסק צרוב עליכם לשמור עליו את ערכת ההתקנה. Aslan אינה יכולה 
...
* חוסר יכולת לתקשר עם יישומים הרצים תחת הרשאות מנהל, אלא אם Aslan רצה בעצמה באופן זה 
...
אם אתם מבצעים התקנה ישירות מתוך ערכת ההתקנה של Aslan עליכם ללחוץ על 
...
אופציה המאפשרת לקבוע אם Aslan  תופעל אוטומטית בעת התחברות לרשת החלונות, לפני בקשת הקשת הסיסמה.
אם כן, התכנה תפעל גם במסכים המוגנים ובחלון בקרת חשבון המשתמש UAC

#### יצירת קיצור דרך על שולחן העבודה (ctrl+alt+n) {#toc13}

תיבה זו קובעת אם על Aslan ליצור קיצור דרך להפעלתה משולחן העבודה 
...
תיבה זו קובעת אם Aslan תעתיק את ההגדרות של העותק שכרגע בריצה אל תוך תיקיית המשתמש הנוכחי שבה נמצאת הגרסה המותקנת. 
...
תיבת בקרה נוספת מאפשרת לקבוע אם על Aslan להעתיק את הגדרות העותק המותקן אל תוך גרסת העותק הנייד. 
...
## תחילת העבודה עם Aslan {#toc16}
### הרצת Aslan {#toc17}

אם Aslan הותקנה מתוך ערכת ההתקנה המקורית, ההרצה נעשית על ידי לחיצה על צירוף המקשים Ctrl+alt+n  או על ידי בחירת התוכנית מתוך תיקיית Aslan בתפריט התחל. ניתן גם לפתוח את תיבת החיפוש על ידי לחיצה על מקש Win ולהקיש את המונח Aslan
קיימת אפשרות להעביר מספר אופציות  #CommandLineOptions]  בשורת הפקודה . להלן מספר דוגמאות:
הפעלת Aslan מחדש : -R סגירת Aslan : -Q ביטול הפעלת התוספים : -disable-addons ועוד.

כדי להריץ את גרסת העותק הנייד, יש לגשת לתיקייה שלתוכה הותקנה התכנה ולהפעיל את aslan.exe.   על-ידי לחיצה על  Enter  או קליק כפול.

בעת הרצת התכנה תישמע סדרה של צלילים עולים. 
עליית Aslan על מחשב איטי יחסית או מתוך עותק נייד עשויה להימשך זמן מה. 
במקרה זה, תישמע הודעה המאשרת כי התכנה עולה כעת. 

אם שום צליל אינו מושמע, או שהמחשב משמיע את צליל השגיאות של Windows או שAslan משמיעה סדרה של צלילים יורדים, זהו סימן כי התכנה נתקלה בשגיאה המונעת ממנה לפעול. במקרה זה, ייתכן כי תצטרכו לדווח על כך למפתחים. 
אנא עיינו באתר Aslan לגבי אופן הדיווח בעניין זה.  

בעת עליית Aslan בפעם הראשונה, תיפתח תיבת דו-שיח המתארת את המקש הייחודי של Aslan ואת התפריטים הבסיסיים של התכנה. 
(אנא עיינו להלן בפרקים אודות נושאים אלה.)
תיבה זו כוללת שלוש תיבות בקרה : 
הראשונה מאפשרת לקבוע אם מקש Caps Lock משמש כמקש יחודי לפקודות Aslan 
השניה קובעת אם Aslan תעלה אוטומטית לאחר ההתחברות לרשת. אופציה זו זמינה רק בגרסה המותקנת על המחשב. 
השלישית קובעת אם תיבת דו-שיח הפתיחה תופיע בכל הרצת Aslan מחדש.

### פקודות המקלדת של Aslan {#toc18}
#### המקש הייחודי של Aslan {#toc19}

רוב פקודות המקלדת של Aslan מופעלות באמצעות לחיצה על מקש ייחודי הנקרא מקש Aslan בצירוף עם מקש אחר אחד או יותר. 
...
ניתן להקצות את שני מקשי ה - Insert וכן את מקש ה - Caps Lock - כמקשי Aslan. 
כברירת מחדל, רק שני מקשי ה - Insert ממלאים פונקציה זו, דבר המאפשר למקש ה - Caps Lock לתפקד על-פי ייעודו המקורי. 

אם מקש ה Caps Lock הוגדר כמקש Aslan ניתן ללחוץ עליו בשתי לחיצות תכופות כדי להעביר את המקלדת לאותיות לועזיות גדולות.  

#### המקלדות השונות {#toc20}

Aslan מספקת שתי סדרות של פקודות מקלדת המכונות "מקלדת מחשב נייח ו"מקלדת מחשב נייד". 
...
### מחוות המגע של Aslan {#toc21}

אם Aslan רצה על מחשב בעל מסך מגע תחת Windows 8 או 10, 
ניתן להפעיל את התכנה בעזרת מחוות היד. 
במקרה זה, כל המחוות תתייחסנה ל Aslan ולא תבצענה את תפקידן המקורי.
...
מדריך זה יפרט בהמשך את הפקודות בשימוש Aslan . הרשימה תכלול גם את המחווה המיועדת לביצוע פעולה ספציפית, במקרה שקיימת פעולה כזאת. 
...
Aslan מסוגלת להבחין בין הקשות הנעשות בעזרת אצבע אחת, שתי אצבעות או יותר משתי אצבעות. 
...
Aslan מזהה ארבעה סוגי החלקות שונות: משמאל לימין, מימין לשמאל, מלמעלה למטה ומלמטה למעלה.
...
כיוון שמספר הפעולות הקיימות עולה בהרבה על מספר המחוות האפשריות, Aslan  מציע שני מצבי מגע. אלה מאפשרים ביצוע של פעולות המשתייכות 
לשני סוגים שונים : מצב טקסט, ומצב אובייקטים. 
עבור פקודות Aslan שקימת עבורן מחווה, מחווה זו מסומנת על-ידי סוגר מרובע }{  ברשימת הפקודות שבמסמך זה. לדוגמה, הביטוי : 
...
כדי להיכנס למצב העזרה, יש ללחוץ על מקש Aslan בצירוף הספרה 1 בשורה העליונה של המקלדת. 
כדי לצאת ממצב העזרה יש ללחוץ שוב על מקש Aslan בצירוף הספרה 1 בשורה העליונה של המקלדת. 
...
התפריט של Aslan מאפשר לקבוע את ההגדרות השונות של התכנה, להכנס לעזרה, לשמור ולשחזר את ההגדרות, להגדיר מונחים במילוני הדיבור, להשתמש בכלים שונים ולסגור את התכנה.

הכניסה לתפריט Aslan נעשית באמצעות צירוף המקשים Aslan N מכל מקום במחשב או על-ידי הקשה קלה עם שתי אצבעות על המסך. 
...
יש לאתר את Aslan במגש המערכת בעזרת החץ התחתון וללחוץ על מקש תפריט המשנה, ליד הקונטרול  הימני, ולבחור באפשרות הרצויה. 

### הפקודות הבסיסיות של Aslan {#toc29}
...
|תפריט Aslan |Aslan+n |Aslan+n |הקשה כפולה בשתי אצבעות |פותח את תפריט Aslan  ולגשת להעדפות, לכלים, לעזרה, וכו'|
|מיתוג הדיבור |Aslan+S |Aslan+S |ללא |מעבר בין המצבים השונים, דיבור פעיל, דיבור בצלילים, דיבור לא פעיל|
|מיתוג מצב עזרה |Aslan+1 |Aslan+1 |ללא |מעבר בין מצב ביצוע פעולות לבין הקראת תיאור הצירוף והפעולה המשויכת אליו|
|יציאה מAslan |Aslan+Q |Aslan+Q |ללא |יציאה מAslan|
|העברת הקשה |Aslan+F2 |Aslan+F2 |ללא |מעביר את ההקשה הבאה לתוכנית שבפוקוס אפילו אם מדובר בפקודה של Aslan בעצמה|
|מיתוג פעילות המקשים |Aslan+SHIFT+S |Aslan+SHIFT+Z |ללא |מבטל וממפעיל מחדש את צירופי המקשים לשימוש Aslan . פעולה זו חשובה בעת עבודה עם תוכנות המספקות בעצמן הקראות דיבור|
...
|---|---|---|
|הקראת התאריך והשעה |Aslan+f12 |לחיצה אחת : הקראת השעה לחיצה פעמיים  הקראת התאריך|
|מצב הסוללה |Aslan+shift+b |הקראת מצב הסוללה באחוזים או מצב החיבור לחשמל|
|הקראת טקסט הזכרון |Aslan+C |הקראת הטקסט שבזכרון אם יש כזה|

<!-- KC:endInclude -->

## הניווט בעזרת Aslan {#toc31}

Aslan מאפשרת לסייר ולנווט במחשב באופנים שונים, על-ידי ניווט או על-ידי סריקה. 
...
תוך כדי הניווט, Aslan תספק מידע לגבי האובייקטים שבפוקוס, כגון שם, סוג, ערך, מצב,  תיאור, קיצור דרך, מיקום ועוד.

Aslan מאפשרת שימוש נרחב יותר בניווט הפוקוס בעזרת פקודות יחודיות :
<!-- KC:beginInclude -->

| פעולה |מחשב נייח |מחשב נייד |תיאור|
|---|---|---|---|
|הקראת הטקסט שבפוקוס |Aslan+Tab |Aslan+Tab |הקראת הטקסט של האובייקט או הפקד שבפוקוס כעת. לחיצה פעמיים : איות המידע.|
|הקראת כותרת החלון |Aslan+T |Aslan+T |הקראת הטקסט של השורה העליונה ביותר בחלון. לחיצה פעמיים : איות המידע. לחיצה שלוש פעמים : הכנסת המידע לזכרון הזמני|
|הקראת חלון |Aslan+B |Aslan+B |הקראת המלל של כל האובייקטים שמכיל החלון שבפוקוס. אפשרות זו יעילה להבנת תוכנן של תיבות דו-שיח|
|הקראת שורת מצב |Aslan+End |Aslan+Shift+End |הקראת שורת המצב אם יש כזאת. לחיצה פעמיים : איות המידע|
...
Aslan תספק מידע לגבי התווים, המילים והשורות תוך כדי תנועה, ותודיע על סימון של קטעי טקסט ועל ביטול הסימון.

להלן פקודות Aslan הנוגעות לסמן המערכת :
<!-- KC:beginInclude -->

| פעולה |מחשב נייח |מחשב נייד |מחווה |תיאור|
|---|---|---|---|---|
|הקרא הכל |Aslan+חץ תחתון |Aslan+A |הקראה רציפה ממקום הסמן והלאה. הסמן זז תוך כדי ההקראה|
|הקראת השורה שבפוקוס |Aslan+חץ מעלה |Aslan+L |הקראת השורה המכילה את סמן המערכת כעת. לחיצה פעמיים : איות השורה|
|הקראת הטקסט הנבחר |Aslan+Shift+חץ מעלה |Aslan+Shift+S |הקראת הטקסט שנבחר כרגע.|
...
בעת הניווט, Aslan תספק מידע בדומה למה שקורה בעת ניווט לפי הפוקוס.
...
| פעולה |מחשב נייח |מחשב נייד |מחווה |תיאור|
|---|---|---|---|---|
|הקראת אובייקט |Aslan+numpad5 |Aslan+shift+o |ללא |הקראת תוכן האובייקט שהניווט עליו. לחיצה פעמיים : איות, לחיצה שלוש פעמים : הכנסת הטקסט לזיכרון הזמני.|
|מעבר לאובייקט כוללני יותר |Aslan+numpad8 |Aslan+shift+חץ למעלה |מחווה כלפי מעל (מצב אובייקטים) |העברה לאובייקט הכולל את האובייקט שהניווט עליו כרגע|
|מעבר לאובייקט הקודם |Aslan+numpad4 |Aslan+shift+חץ שמאלה |החלקה שמאלה (מצב אובייקטים) |מעבר לאובייקט הקודם לאובייקט שהניווט עומד עליו|
|מעבר לאובייקט הבא |Aslan+numpad6 |Aslan+shift+חץ ימינה |החלקה שמאלה (מצב אובייקטים) |מעבר לאובייקט הבא אחרי האובייקט שהניווט עומד עליו|
|מעבר לאובייקט הפנימי הראשון |Aslan+numpad2 |Aslan+shift+חץ למטה |החלקה מטה |מעבר אל האובייקט הראשון שבתוך האובייקט שהניווט עליו|
|מעבר לאובייקט שבפוקוס |Aslan+numpadMinus |Aslan+backspace |ללא |מעביר את הניווט לאובייקט שבפוקוס וממקם את הסמן במקום שסמן המקלדת מצביע עליו, אי הוא ניתן לאיתור|
|הפעלת אובייקט |Aslan+numpadEnter |Aslan+enter |הקשה כפולה |מפעיל את האובייקט המוצג (זהה לקליק עכבר או ללחיצה על מקש הרווח כשהאובייקט בפוקוס)|
|העברת הפוקוס או סמן המקלדת למקום סמן הסריקה |Aslan+shift+numpadMinus |Aslan+shift+backspace |ללא |לחיצה פעם אחת : העברת הפוקוס למקום סמן הסריקה, לחיצה פעמיים : העברת סמן המקלדת לאותו מקום|
|הקראת מיקום סמן הסריקה |Aslan+numpadDelete |Aslan+delete |ללא |מקריא מידע אודות מיקומו של הטקסט או האובייקט שמתחת לסמן הסריקה, לדוגמה אחוז ההתקדמות בתוך מסמך, או המרחק מהגבול התחתון של החלון או המסך. לחיצה פעמיים עשויה לספק מידע נוסף|
...
Aslan מאפשרת סריקה של הטקסט שעל [המסך](#ScreenReview) ,  של תוכנו של[המסמך שבפוקוס](#DocumentReview) וכן של המלל של ה[אובייקט הנוכחי](#ObjectReview) , ברמת התווים, המילים והשורות.
...
| פעולה |מחשב נייח |מחשב נייד |מחווה |תיאור|
|---|---|---|---|---|
|מעבר לשורת הסריקה הראשונה |shift+numpad7 |Aslan+control+home |ללא |העברת סמן הסריקה לשורת הטקסט הראשונה|
|מעבר לשורת הסריקה הקודמת |numpad7 |Aslan+חץ מעלה |החלקה מעלה (במצב טקסט) |העברת סמן הסריקה לשורת הטקסט העליונה יותר|
|הקראת שורת הסריקה הנוכחית |numpad8 |Aslan+shift+. |ללא |הקראת השורה שסמן הסריקה עומד עליו כרגע. לחיצה פעמיים : איות, לחיצה שלוש פעמים : איות במלל.|
|מעבר לשורת הסריקה הבאה |numpad9 |Aslan+חץ מטה |החלקה מטה (במצב טקסט) |העברת סמן הסריקה לשורת הטקסט התחתונה יותר|
|מעבר לשורה האחרונה |shift+numpad9 |Aslan+control+end |ללא |מעביר את סמן הסריקה לשורה התחתונה ביותר|
|מעבר למילה הקודמת |numpad4 |Aslan+control+חץ שמאל |החלקת שתי אצבעות שמאלה |מעביר את הסמן לתחילת המילה הקודמת|
|הקראת המילה הנוכחית |numpad5 |Aslan+control+. |ללא |הקראת המילה שסמן הסריקה עומד עליה. לחיצה פעמיים : איות, לחיצה שלוש פעמים : איות במלל.|
|מעבר למילה הבאה |numpad6 |Aslan+control+חץ ימין |החלקה בשתי אצבעות ימינה |העברת סמן הסריקה לתחילת המילה הבאה|
|מעבר לתחילת השורה |shift+numpad1 |Aslan+home |ללא |מעביר את סמן הסריקה לתחילת השורה הנוכחית|
|מעבר לתו הקודם |numpad1 |Aslan+חץ שמאל |החלקה שמאלה |מעביר את סמן הסריקה תו אחד שמאלה|
|הקראת התו הנוכחי |numpad2 |Aslan+. |הקראת התו שסמן הסריקה עומד עליו. לחיצה פעמיים : מלל שם התו, לחיצה שלוש פעמים : ערך יוניקוד כמספר עשרוני והקסא-דצימאלי ||
|מעבר לתו הבא |numpad3 |Aslan+חץ ימינה |החלקה ימינה |מעביר את סמן הסריקה לתו הבא|
|מעבר לתו האחרון בשורה |shift+numpad3 |Aslan+end |ללא |מעביר את סמן הסריקה לתו האחרון בשורה|
|הקראת הכל |numpadPlus |Aslan+shift+a |החלקה מטה בשלוש אצבעות |הקראה ממקום סמן הסריקה ועד לסוף המסך. תוך כדי הזזת הסמן|
|בחר ממקום סמן הסריקה |Aslan+F9 |Aslan+F9 |ללא |מתחיל סימון והעתקה ממקום סמן הסריקה. התהליך יימשך עד שתודיע לAslan על נקודת הסיום.|
|העתקה לזיכרון הזמני |Aslan+f10 |Aslan+f10 |ללא |בלחיצה הראשונה, הטקסט ממקום הסמן ועד למקום הנוכחי יסומן. בלחיצה שנייה, הטקסט המסומן יועתק לזיכרון הזמני.|
|הקראת עיצוב הטקסט |Aslan+F |Aslan+F |ללא |מציג את העיצוב של הטקסט במקום סמן הסריקה. לחיצה פעמיים : הצגת העיצוב במבנה של מצב הגלישה.|
...
[פקודות הסריקה](#ReviewingText)  של Aslan מאפשרות לבחון את הטקסט של האובייקטים השונים הנסרקים, של המסמכים ושל המסך בכלל, וזאת על-פי מצב הסריקה שנבחר.
המונח "מצבי סריקה"  מחליף את הביטוי הישן "סריקה שטוחה" שהיה פעם בשימוש ב-Aslan.
...
| פעולה |מחשב נייח |מחשב נייד |מחווה |תיאור|
|---|---|---|---|---|
|מצב סריקה הבא |Aslan+numpad7 |Aslan+pageUp |החלקה מעלה בשתי אצבעות |קביעת המצב הבא הזמין|
|מצב סריקה הקודם |Aslan+numpad1 |Aslan+pageDown |החלקה מטה בשתי אצבעות |קביעת המצב הקודם הזמין|
...
Aslan תעבור אוטומטית ממצב סריקת האובייקטים למצב סריקת המסמכים ברגע שסמן הסריקה יגיע למסמכים הנקראים במצב גלישה.
...
יש לשים לב לכך שלא תמיד Aslan מסוגלת להקריא את תוכנם של אובייקטים המשתייכים ליישומים חדישים, וזאת עקב המצב המתפתח של טכנולוגיות ציור המלל על המסך.

### ניווט עכבר {#toc41}

כברירת מחדל, Aslan מקריאה את מלל האובייקט שסמן העכבר מצביע עליו בכל רגע.  
במידת האפשר, הקריאה תתבצע על בסיס של פסקה אך ישנם פקדים שניתן לקרוא אותם רק שורה אחר שורה.

אפשר להגדיר את Aslan כך שהיא תקריא גם את סוג [האובייקטים](#Objects)  תוך כדי תנועה, כגון "רשימה", "כפתור",  וכו'.
תכונה זו מועילה בעיקר למשתמשי מחשב עם עיוורון מוחלט אם הקראת תוכן האובייקטים אינה מספקת.

Aslan מאפשרת לקבל מושג על מיקומו של העכבר ביחס למימדי המסך בעזרת השמעת צלילים מיוחדים.  
...
תכונות אלה אינן מוגדרות כברירת מחדל של Aslan. 
אם ברצונך להפעיל אותן,  ניתן לעשות זאת בתפריט [הגדרות עכברים מותקנים על המחשב](#MouseSettings) שמופיעות תחת תפריט ההעדפות.

השימוש בטכניקות העכבר דורש חיבור של עכבר אמיתי או של מסך מגע. למרות זאת, Aslan מספקת מספר פקודות מקלדת השולטות על מכשיר זה.
<!-- KC:beginInclude -->

| פעולה |מחשב נייח |מחשב נייד |תיאור|
|---|---|---|---|
|קליק שמאל |numpad/ |Aslan+[ סוגר מרובע ימני |קליק.  לחיצה פעמיים מבצעת קליק כפול|
|קליק שמאל לחוץ |shift+numpad/ |Aslan+control+[ סוגר מרובע שמאלי |נעילה ושחרור קליק שמאל. במצב נעול, ניתן לבצע גרירה על ידי הזזת העכבר או הפעלת פקודת עכבר כלשהי|
|קליק ימין |numpad* |Aslan+] סוגר מרובע שמאלי |קליק ימין|
|קליק ימין לחוץ |shift+numpad* |Aslan+control+] סוגר מרובע שמאלי |נעילה ושחרור קליק ימין. במצב נעול, ניתן לבצע גרירה על ידי הזזת העכבר או הפעלת פקודת עכבר כלשהי|
|העברת  העכבר לסימן הניווט |Aslan+nupad/ |Aslan+shift+m |העברת העכבר למקום סמן הניווט או הסריקה|
|העברת סמן הניווט למקום העכבר |Aslan+numpad* |Aslan+shift+n |העברת סמן הניווט לאובייקט שהעכבר מצביע עליו|

<!-- KC:endInclude -->

## מצב גלישה {#BrowseMode}

מצב הגלישה של Aslan מאפשר קריאה של מסמכים מורכבים המוגדרים לקריאה בלבד, כגון דפי אינטרנט. מסמכים אלה מטופלים על-ידי תוכנות כמו :
...
Aslan תעבור אוטומטית למצב פוקוס בעת הגעת הסמן לשדה הדורש הכנסת טקסט, בין אם כתוצאה מפעולת ניווט ובין אם לאחר לחיצה על מקש Tab
Aslan תחזור לפעול במצב גלישה לאחר לחיצה על  Tab או במקרה שהסמן יגיע לפקד שאינו דורש הכנסת טקסט.
...
| פעולה |צירוף |תיאור|
|---|---|---|
|מעבר בין פוקוס לגלישה |Aslan+רווח |עובר ממצב פוקוס למצב גלישה ובחזרה|
|יציאה ממצב פוקוס |Escape |מעבר ממצב הפוקוס חזרה למצב הגלישה|
|ריענון מסמך |Aslan+F5 |טוען את המסמך מחדש. ניתן לשימוש אם נראה כי חסר מידע. לא זמין ב Word וב Outlook|
|חיפוש |Aslan+control+f |פותח תיבת דו-שיח המאפשרת חיפוש מחרוזת בתוך המסמך|
|חיפוש חוזר |Aslan+F3 |מבצע חיפוש נוסף של אותה מחרוזת במסמך|
|חיפוש אחורה |Aslan+shift+f3 |מבצע חיפוש של המחרוזת למעלה יותר במסמך|
|תיאור ארוך |Aslan+D |מקריא הסבר ארוך אודות האובייקט שהסמן עומד עליו, אם קיים כזה|

<!-- KC:endInclude -->

### ניווט בעזרת תו אחד {#toc43}

במצב גלישה Aslan מאפשרת שימוש במספר מקשי קיצור לצורך ניווט מהיר בתוך המסמכים.
...
אם ברצונכם להשתמש בקיצורים אלה מבלי לצאת ממצב הגלישה,  באפשרותכם לבטל זמנית את פעולותיו של תו אחד של Aslan
<!-- KC:beginInclude -->
כדי לבטל את פעולות של תו אחד שבשימוש Aslan יש להקיש את צירוף המקשים Aslan+shift+רווח.
<!-- KC:endInclude -->
...
| פעולה |צירוף |תיאור|
|---|---|---|
|רשימת רכיבים במצב גלישה |Aslan+F7 |מציג רשימה של הרכיבים הקיימים במסמך|
...
| פעולה |צירוף |תיאור|
|---|---|---|
|חזרה למסמך במצב גלישה |Aslan+control+רווח |מעביר את הפוקוס בחזרה למסמך המכיל את האובייקט המוטמע ועובר למצב הגלישה|

<!-- KC:endInclude -->

## הקראת תוכן מתמטי {#toc46}

Aslan מסוגלת להקריא תוכן מתמטי ואף לעבור בין רכיבי נוסחאות בעזרת מנגנון MathPlayer 4 של חברת Design Science
...
Aslan תומכת בפיענוח הנושאים הבאים :
...
תוך כדי עבודה במסמך, Aslan תקריא כל רכיב מתמטי הנתמך על-ידי התכנה בעת הגעת הסמן אליו.
אם ברשותכם צג ברייל, המידע יוצג גם עליו.

### ניווט אינטראקטיבי {#toc47}

אם אתם עובדים בעיקר בדיבור עם Aslan תעדיפו לשמוע את פירוט הרכיבים המתמטיים על פני הקראת כל המשפט.  
...
| פעולה |צירוף |תיאור|
|---|---|---|
|עבודה עם ביטויים מתמאטיים |Aslan+alt+m |התחלת העבודה מול ביטויים מתמאטיים|
...
Aslan  מתאפיינת במספר תכונות העשויות להקל את השימוש ביישומים מסוימים ולאפשר גישה למנגנונים שאינם נתמכים על-ידי קוראי מסך אחרים.

### Microsoft Word {#toc49}
#### זיהוי אוטומטי של כותרות שורות ועמודות {#toc50}

Aslan מסוגלת להקריא באופן אוטומטי את כותרות השורות והעמודות שהיא מזהה בטבלאות של Microsoft Word.  
...
יתר על כן, על Aslan לדעת מהן השורות והעמודות המכילות את הכותרות.
לאחר המעבר לתא הראשון המכיל כותרת שורה או עמודה, ניתן להפעיל את הפקודות הבאות :
<!-- KC:beginInclude -->

| פעולה |צירוף |תיאור|
|---|---|---|
|קביעת כותרת העמודות |Aslan+shift+C |לחיצה פעם אחת: הוראה לקבוע את השורה הנוכחית כשורה המכילה את כותרות העמודות. הכותרת תוקרא יחד עם תוכן התא בעת מעבר לעמודה אחרת. לחיצה פעמיים : ביטול קביעת כותרות העמודות.|
|קביעת כותרת השורות |Aslan+shift+R |לחיצה פעם אחת: הוראה לקבוע את העמודה הנוכחית כעמודה המכילה את כותרות השורות. הכותרת תוקרא יחד עם תוכן התא בעת מעבר לשורה אחרת. לחיצה פעמיים : ביטול קביעת כותרות השורות.|
...
בדומה להתנהגות של Aslan בדפי אינטרנט, ניתן להכנס למצב גלישה גם בתכנת Microsoft Word ולקבל חיווי  בעזרת פקודות תו אחד ורשימת אובייקטים.
<!-- KC:beginInclude -->
בMicrosoft Word הכניסה למצב גלישה והיציאה ממנו מתבצעות על-ידי לחיצה על Aslan+רווח
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
ב Microsoft Word  הצגת רשימת הרכיבים וביטולה נעשית באמצעות הצירוף Aslan+F7
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
כדי להקריא הערה השייכת למילה שבפוקוס, יש ללחוץ על הצירוף Aslan+alt+c.
<!-- KC:endInclude -->
...
Aslan מסוגלת להקריא אוטומטית את כותרות השורות והעמודות שהיא מזהה בגליונות של Microsoft  Excel.
כדי שהפעולה תתבצע, יש להפוך לזמינה את אפשרות ההקראה האוטומטית של כותרות שורות ועמודות בתיבת הדו-שיח  המתייחסת לעיצוב המסמכים.
יתר על כן, על Aslan לדעת מהן השורות והעמודות המכילות את הכותרות.
לאחר המעבר לתא הראשון המכיל כותרת שורה או עמודה, ניתן להפעיל את הפקודות הבאות :
<!-- KC:beginInclude -->
...
בדומה למצב של דפי האינטרנט, Aslan מסוגלת להציג רשימות של האובייקטים השונים המופיעים בגליונות של  Excel.
<!-- KC:beginInclude -->
ב Microsoft Excel  הצגת רשימת הרכיבים וביטולה נעשית על ידי הצירוף Aslan+F7.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
כדי להקריא הערה השייכת לתא שבפוקוס, יש להקיש את צירוף המקשים Aslan+alt+c.
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
כדי לעקוף את הבעייה, מומלץ לעבור למצב גלישה על ידי הקשת צירוף המקשים Aslan+רווח, ולנווט בגליון בעזרת החיצים.
<!-- KC:endInclude -->
...
| פעולה |צירוף |תיאור|
|---|---|---|
|מיתוג הערות הקריין |control+shift+s |כששקופית נפתחת על המסך,  צירוף זה יעביר את ההקראה מההערות לתוכן ובחזרה. פעולה זו חלה על ההקראות של Aslan ולא על מה שמוצג על המסך.|
...
| פעולה |צירוף |תיאור|
|---|---|---|
|הקראת מסרים אחרונים |Aslan+control+1-4 |המספר שבצירוף מצביע על אחד מארבעת המסרים האחרונים שהתקבלו|
...
תכנת Aslan תומכת בקריאה וניווט בספרים בעזרת "קינדל" למחשב. 
...
בעת הקריאה במצב עיון, Aslan מתייחס להערות אלה כהערות.
...
רוב ההגדרות של Aslan  ניתנות לשינוי בתפריט ההעדפות של התפריט הכללי.
...
#### הגדרות כלליות של Aslan (Aslan+control+g) {#toc70}
...
בתיבה משולבת זו, תוכל לבחור את שפת הממשק של Aslan וכן השפה שבה יוקראו הודעות התכנה.
קיימות אופציות רבות לכך, אולם ברירת המחדל היא שפת מערכת ההפעלה. 
אופציה זו מנחה את Aslan לבחור בשפת ברירת המחדל של  Windows  כשפת הממשק שלה.

שינוי השפה דורש הפעלה מחדש של Aslan.
במקרה של שינוי, Aslan שואלת אם להפעיל את עצמה מחדש.
יש ללחוץ על כפתור "אישור" כדי לבצע פעולה זו.

##### שמירת הגדרות בעת יציאה {#toc72}

תיבת סימון זו קובעת אם ההגדרות של Aslan תישמרנה בעת יציאה מהתכנה.

##### הצגת חלון אפשרויות בעת יציאה מ Aslan {#toc73}

תיבת סימון זו קובעת אם יוצג חלון המפרט מספר אפשרויות בעת יציאה מAslan.
במצב פעיל, תיבה זו תגרום לAslan לשאול אם ברצונך לצאת, להפעיל את Aslan מחדש או להפעיל אותה מחדש ללא תוספים.
במצב "לא פעיל", תיבה זו תגרום לAslan להיסגר מיידית.

##### השמע צלילים בעת כניסה ויציאה {#toc74}

במצב "פעיל", תיבה זו תפעיל השמעת צלילים בעת הפעלת Aslan ובעת סגירתה.

##### רמת דיווח {#toc75}

תיבה משולבת זו קובעת את רמת רישום הדיווח תוך כדי פעולתה של Aslan
בדרך כלל, אין סיבה לגעת בהגדרה זו כל עוד שהמערכת מתפקדת כראוי. 
יש טעם לשנות אותה אם נדרש דיווח נרחב על באג בתכנה.

##### הפעלת Aslan באופן אוטומטי לאחר התחברות לרשת החלונות {#toc76}

אם תיבה זו מסומנת, Aslan תפעל תכף עם עליית המחשב. 
אופציה זו חלה רק על הגרסה המותקנת.

##### הפעלת Aslan  בעת הכניסה לחלון בחירת משתמש. אפשרות זו דורשת זכויות של מנהל על התחנה. {#toc77}

אם אתם מתחברים למחשב בעזרת שם משתמש וסיסמה ותיבה זו מסומנת, Aslan תעלה יחד עם מסך ההתחברות לחלונות.
...
לחיצה על כפתור זה תביא להעתקת הגדרות Aslan השמורות בתיקית המשתמש לתוך תיקיית המערכת.
כתוצאה מכך, הגדרות אלה יפעלו מעתה גם בחלון ההתחברות לרשת, בחלון בקרת חשבון המשתמש UAC  ובחלונות המוגנים האחרים. כדי להבטיח כי הגדרות המשתמש אכן תופעלנה, דאג לשמור אותן תחילה בלחיצה על הצירוף control+Aslan+c  או דרך תפריט שמירת ההגדרות.
אופציה זו פעילה אך ורק בגרסה המותקנת של Aslan.

##### בדיקה אוטומטית של עדכוני Aslan {#toc79}

אם תיבה זו במצב "פעיל" Aslan תבדוק אוטומטית אם יש עדכונים זמינים לתכנה ותודיע על כך. 
ניתן לבצע את הבדיקה גם דרך התפריט המתאים בתפריט "עזרה".

#### בחירת מנוע דיבור Aslan+control+s) {#toc80}

תפריט בחירת מנוע הדיבור מאפשר להגדיר את המנגנון שבאמצעותו תקריא תכנת  Aslan את הודעותיה.
לאחר בחירת מנוע הדיבור הרצוי, לחיצה על כפתור "אישור" תעלה אותו לזיכרון.
במקרה של שגיאה בעת טעינת מנוע הדיבור, Aslan תודיע על כך ותפעיל את המנוע שהיה בשימוש קודם לכן.
...
תיבה זו מאפשרת בחירה של כרטיס הקול שבאמצעותו תשמיע תכנת Aslan את הודעותיה.
...
מערכת ההפעלה Windows 8  והלאה, אופציה זו מאפשרת לקבוע אם צליל השמע של יישומים אחרים יונמך אוטומטית כשתכנת Aslan תקריא מלל כלשהו או כשהיא בכלל תהיה בריצה.

* ללא הנמכה: Aslan לעולם לא תנמיך את עצמת השמע של יישום אחר.
* הנמכת השמע כשתכנת Aslan משמיעה דיבור או צליל: ההנמכה תחול אך ורק כשתכנת Aslan תזדקק להשמעת מלל או צליל. לא כל מנועי הדיבור תומכים באפשרות זו.
* הנמך תמיד: Aslan תנמיך תמיד את עצמת השמע של יישומים אחרים כל עוד היא בריצה.

אפשרות זאת קיימת כאשר תכנת Aslan מותקנת בלבד.
זהו אינו אפשרי לתמוך בהנמכת שמע בגרסה הניידת.

#### הגדרות קול (Aslan+control+v) {#VoiceSettings}
...
מנוע הדיבור של Espeak  NG  שמופעל בעת התקנת Aslan  כולל מספר ניבים שונים המפורטים בתיבה משולבת זו. 
...
תיבת סימון זו קובעת אם על Aslan לעבור לשפת דיבור אחרת בעת הקראת מילה המזוהה כשייכת לשפה זו.
...
מאפיין זה פעיל כברירת מחדל. הוא מורה לתכנת Aslan להעביר את הסימנים ואת התווים כפי שהם למנוע הדיבור ולסמוך עליו.
אם ההקראה על-פי יכולת מנוע הדיבור אינה משביעה רצון, יש להפוך את האופציה ללא-פעילה ולתת ל - Aslan להעביר למנוע הדיבור את המלל שהוגדר עבור הסימנים והתווים.
...
תיבת סימון זו קובעת אם Aslan תקריא את הביטוי "Cap" לפני הקראת אות גדולה, למשל בעת איות.
בדרך כלל Aslan מנסה להעלות את גובה הקול בעת הקראת אות גדולה. אם הדבר אינו אפשרי, סימון תיבה זו יכול להועיל.

##### השמעת צליל בעת הקראת אות גדולה {#toc97}

אם תיבה זו מסומנת, Aslan תשמיע צליל דק בעת הקראת אות לועזית גדולה.
...
סימון התיבה יבטיח כי Aslan תשתדל להבחין בין שני המצבים אם מנוע הדיבור תומך בכך.
...
אם אינכם מעוניינים להכנס לתפריט הראשי של Aslan כדי לשנות הגדרות בסיסיות של הדיבור, ניתן להפעיל מספר קיצורים שיעזרו לכם במשימה זו.
<!-- KC:beginInclude -->

| פעולה |מחשב נייח |מחשב נייד |תיאור|
|---|---|---|---|
|מעבר להגדרת הדיבור הבאה |Aslan+control+rightArrow |Aslan+shift+control+rightArrow |מחליף את ההגדרה לבאה בתור עד לחזרה להגדרה הראשונה|
|מעבר להגדרת הדיבור הקודמת |Aslan+control+LeftArrow |Aslan+shift+control+LeftArrow |מחליף את ההגדרה לקודמת בתור עד לחזרה להגדרה האחרונה|
|שינוי ערך כלפי מעלה |Aslan+control+upArrow |Aslan+shift+control+upArrow |הגברת הערך או מעבר לערך הבא, כגון הגברת המהירות, מעבר לקול הבא, הגברת העוצמה|
|שינוי ערך כלפי מטה |Aslan+control+DownArrow |Aslan+shift+control+DownArrow |הנמכת הערך או מעבר לערך הקודם, כגון האטת המהירות, מעבר לקול הקודם, הנמכת העוצמה|
...
כברירת מחדל, Aslan מנסה להתחבר אוטומטית לצג הברייל על ידי סריקה שיטתית של כניסות הUSB והתקני ה-BlueTooth.
קיימים צגים המאפשרים למשתמש להגדיר בעצמו את היציאה שאליה מחובר המכשיר.
הביטוי "אוטומטי" מציין את השיטה המצויה ביותר שבה Aslan סורק בזה אחר זה את התקני ה-USB וה-BlueTooth וכן את היציאות הטוריות במקרה שהתקן הצג תומך בהן.
...
כרגע, Aslan מכירה אך ורק את שיטת הברייל הממוחשב לצורך הקשת נקודות. לכן, רק הטבלאות בנויות על יסוד 8 נקודות הברייל שיופיעו ברשימה.
...
#### הגדרות מקלדת Aslan+control+k {#toc114}
...
תיבה משולבת זו מאפשרת בחירה של סוג הפקודות לשימוש Aslan כעת, ניתן לבחור בין מקלדת מחשב נייח למקלדת מחשב נייד.

##### השתמש במקש CapsLock כמקש יחודי של Aslan {#toc116}

אם התיבה מסומנת, מקש CapsLock ישמש כמקש היחודי של פקודות Aslan

##### השתמש במקשInsert   כמקש יחודי של פקודות Aslan {#toc117}

אופציה זו קובעת אם מקש Insert הנמצא מעל למקשי החצים יאפשר ביצוע פקודות Aslan

##### השתמש במקש0 בכרית המספרים כמקש יחודי של פקודות Aslan {#toc118}

אופציה זו קובעת אם מקש ה0 שמימין לחצים יאפשר ביצוע פקודות Aslan

אם שום מקש לא נבחר כמקש יחודי, ייתכן שלא תתאפשר שום פקודת מקלדת של Aslan
במקרה זה Aslan תודיע על שגיאה בתגובה עם לחיצה על כפתור האישור.
...
סימון התיבה יגרום לתכנת Aslan להקריא את התווים המוקלדות.
...
סימון התיבה תגרום לAslan להקריא את המילים המוקשות.
...
אם האופציה פעילה, Aslan תקריא את ההקשות שאינן יוצרות תווים, כגון צירופי אותיות עם מקש Control   ועוד.

##### השמעת צליל בעת שגיאת איות או דקדוק {#toc126}

אם התיבה מסומנת, יישמע זמזום בעת שגיאת איות או דקדוק תוך כדי הקלדה.
תופעה זו תתרחש אך ורק אם אופציית הדיווח על שגיאות איות תהיה מסומנת ב[הגדרות עיצוב מסמך](#DocumentFormattingSettings) הגדרה זו קובעת אם על Aslan להתייחס להקשות הנוצרות על ידי תוכנות מקלדת וירטואלית ופיענוח גרפי. זוהי אכן ברירת המחדל אך ישנם משתמשים שיהיו מעוניינים לבטל אותה, לדוגמה, אלה המשתמשים בתוכנת Unikey בווייטנאמית, העלולה ליצור התנגשות עם פקודות Aslan

##### ניהול מקשים מיישומים אחרים {#toc127}

אפשרות זו מאפשרת למשתמש לשלוט באפשרות האם לחיצה על מקשים על ידי ישומים אחרים כגון מקלדת על המסך, ותוכנות לזיהוי קולי יתנהלו על ידי Aslan
אפשרות זו דלוקה במצב ברירת מחדל.

#### הגדרות עכבר Aslan+control+m {#MouseSettings}
...
תיבת סימון זו קובעת אם על Aslan להקריא את סוג האובייקט שהעכבר נכנס אליהם.

##### השמעת צלילים המבטאים את קואורדינטות מיקום העכבר {#toc133}

סימון התיבה ינחה את Aslan להשמיע צלילים המאפשרים למשתמש לזהות את מיקום העכבר ביחס לגובה המסך ולרוחבו.
...
אם תיבה זו מסומנת,  Aslan תציג את האובייקטים באופן היררכי, אך היא תתעלם מאלה שאינם בעלי משמעות עבור המשתמש או שנועדים לצורך עיצוב גראפי בלבד.

כדי להפוך מצב לזמין וללא זמין לסרוגין, מומלץ להקצות לפעולה מחווה כמפורט בפרק [תנועות המחווה](#InputGestures).

#### הגדרות הצגת אובייקטים Aslan+control+o {#toc140}
...
אם תיבה זו מסומנת, Aslan תקריא את האותיות המשמשות כקיצורי דרך המפעילים אובייקטים מסויימים.
...
תיבה זו קובעת אם על Aslan לנסות ולזהות את מיקומם של אובייקטים שלא ניתן להשיג עבורם מידע בשיטות אחרות.
...
תיבה זו קובעת את אופן הדיווח של Aslan לגבי פסי התקדמות.

האפשרויות הבאות עומדות לרשותך :

* ללא הקראה : לא יתקבל חיווי על התקדמותם של תהליכים
* הקראה : Aslan תקריא את מצב ההתקדמות באחוזים
* צליל :  Aslan תשמיע צליל המודיע על ההתקדמות. ככל שהצליל גבוה, התהליך קרוב יותר לסיום.
* צליל ודיבור : Aslan תשמיע צליל וכן תקריא את מצב ההתקדמות באחוזים

##### הודעה על התקדמות תהליכים ברקע {#toc148}

אם התיבה מסומנת, Aslan תודיע על התקדמותם של תהליכים גם אם אלה אינם בפוקוס כרגע.
אם תקטין את החלון שבתוכו מתחולל תהליך בהתקדמות או תעבור ליישום אחר, Aslan תמשיך לספק חיווים אודות ההתקדמות.
...
זו ברירת המחדל המאפשרת לקבוע אם על Aslan להקריא מידע על המועמדים המופיעים ברשימה תוך כדי ניווט. 
...
היא קובעת אם Aslan תקריא תיאור קצר של התווים של מועמד מסויים בעת בחירה או כשהרשימה מוצגת.
...
אופציה זו קובעת אם על Aslan לדווח על כל שינוי שיחול בהרכב המחרוזות המורכבות.
אפשרות זו פעילה כברירת מחדל.

#### הגדרות מצב גלישה Aslan+control+b) {#toc156}
...
אם התיבה מסומנת, Aslan תעבור באופן אוטומטי למצב פוקוס אם חצי הכיוון יביאו את הסמן לתיבת עריכה והיא תחזור למצב גלישה עם היציאה ממנה.  
...
אם תיבה זו מסומנת, Aslan תשמיע צליל בעת מעבר ממצב אחד לשני במקום להודיע מילולית על שינוי המצב.

##### לכידת מקשים לצורך קריאת מסמכים {#toc166}

אפשרות זו, הפעילה כברירת מחדל, קובעת כי הקשות שאינן פקודות Aslan  או פקודות מערכת ההפעלה יילכדו ולא יועברו אל תוך המסמך הפעיל. 
לדוגמה : אם האופציה פעילה, הקשה על האות J תפורש כפקודה ולא כתו להכנסה אל תוך המסמך, אף על פי שאות J אינה משויכת לשום פקודה.

#### הגדרות עיצוב מסמכים Aslan+control+d {#DocumentFormattingSettings}
...
לדוגמה, אם תיבת הקראת הגופן מסומנת, Aslan תקריא את שם הגופן כל אימת שחל שינוי עיצוב בטקסט.  
...
תיבה זו קובעת כי על Aslan להודיע על כל שינויי העיצוב המופיעים בתוך שורה שהסמן בתוכה גם אם הם נמצאים מעבר למקומו הנוכחי. פעולה זו עלולה להאט את קצב ההקראה.

כברירת מחדל, Aslan מנסה לבצע פעולה זו אך ורק אם הדבר אינו גורם להאטה משמעותית של הקריאה.
...
* ללא : Aslan לא תודיע על כניסת שורה
* דיבור : בעת שינוי כניסה, Aslan תודיע על מספר התווים או הטאבים המהווים את הכניסה
...
* דיבור וצלילים : Aslan תפעיל את השיטות האחרונות לעיל

#### מילוני דיבור {#toc170}

תיבת דו-שיח של מילוני הדיבור נמצאת בתפריט העדפות.
המילונים קובעים את האופן שבו Aslan מבטאת מילים וביטויים שונים. 
קיימים כעת 3 סוגים של מילוני דיבור :

* ברירת מחדל : הכללים המוגדרים במילון זה חלים על כל ההקראות שלAslan
* קול : הכללים במילון זה חלים על הקול של מנוע הדיבור הנמצא בפעולה כרגע
* מילון זמני :  הכללים המוגדרים במילון זה חלים על כל ההקראות אך רק כל עוד Aslan בריצה. ההגדרות מתאפסות בעת הרצה מחדש.
...
הכללים של Aslan מאפשרים להמיר מחרוזת אחת ברצף אחר של תווים.  
...
היכולות של מילוני הדיבור של Aslan חזקות הרבה יותר מסתם החלפה של מחרוזת אחת באחרת.  
...
התהליך הגדרת סימני הפיסוק מסתמך על מנוע הדיבור כפי שנבחר ב[הגדרות הקול](#VoiceSettings);. בדו-שיח זה, אופן ההקראה של הקול שנבחר גובר על הגדרות  השפה הכלליות של Aslan אם התיבה המתאימה תסומן.
...
כברירת מחדל Aslan שומרת את ההגדרות בעת יציאה מהתוכנית. 
...
| פעולה |מחשב נייח |מחשב נייד |תיאור|
|---|---|---|---|
|שמירת ההגדרות |Aslan+control+c |Aslan+control+c |שומר את ההגדרות הפעילות כרגע כך שהן יעלו בעת הפעלה מחדש|
|החזרת הגדרות |Aslan+control+r |Aslan+control+r |לחיצה פעם אחת : החזרת ההגדרות לאלה שנשמרו לאחרונה. לחיצה שלוש פעמים : החזרת ההגדרות הבסיסיות של התכנה|
...
הפרופילים של Aslan הם כלי נוח לבצע משימות אלה.
...
הגרסה הניידת של Aslan שומרת את כל קובצי ההגדרות, התוספים ומנהלי ההתקנים בתיקיה userConfig הנמצאת בתיקיית Aslan

הגרסה המותקנת שומרת את קובצי ההגדרות, התוספים ומנהלי ההתקנים בתיקיה מיוחדת ל- Aslan והנמצאת בתוך ספריית המשתמש של מערכת ההפעלה.
פירוש הדבר שכל משתמש אחר במחשב יכול להזיק את ההגדרות הפרטיות  שלו בתכנת Aslan
כדי לבחון את התיקייה הפרטית שלכם, יש לפתוח את תפריט התחל, לגשת לכל התוכניות,  ובספריית Aslan, למצוא את תיקיית הגדרות המשתמשים.

ההגדרות החלות על מסך ההתחברות ועל המסכים המוגנים שמורות בתיקיית userConfig בתוך תיקיית ההתקנה של Aslan
...
כלי זה מאפשר לצפות בכל האירועים שקרו מאז שהרצת את Aslan ועד עכשיו. 
...
כלי זה מאפשר למפתחים ולאנשים רואים להתרשם משטף מלל הדיבור שתכנת Aslan משמיע למשתמש עם עיוורון.
...
עם זאת, אם תלחצו או תתמקדו במציג, תכנת  Aslan תופסק זמנית מעדכון הטקסט, כך שהנכם יכולים לבחור בקלות או להעתיק את התוכן הקיים.

ניתן להגדיר קיצור דרך להפעלה ולביטול של התכנה בתפריט [הגדרת מחוות](#InputGestures).

### ניהול תוספים {#toc185}

בתפריט "כלים" תמצא את מנהל התוספים המאפשר להוסיף, למחוק, להפעיל ולבטל תוספים לשימוש Aslan.
...
הכפתור מביא לפתיחת [דף האינטרנט](https://addons.aslan-project.org/).
להלן השלבים להתקנת תוסף ישירות מתוך הדפדפן אם תכנת Aslan כבר מותקנת על המחשב. 
...
לאחר ההורדה Aslan תבקש אישור על רצונכם להתקין את התוסף.
זכרו כי פעולת התוספים תחת Aslan  היא בלתי-מוגבלת. פירוש הדבר שבאופן תיאורטי, כל תוסף יכול לגשת לתיקיות הפרטיות שלך ולשלוף מידע משם. לכן,  עבור הגרסה המותקנת על המחשב, חשוב להתקין אך ורק את התוספים הבאים ממקורות נאמנים.
כדי שהתוסף יופעל, יש להריץ את Aslan מחדש.  
בינתיים, התוסף יופיע ברשימה במצב "מותקן"  בלבד.

כדי להסיר תוסף,  בחרו אותו מהרשימה ולחצו על כפתור "הסר". 
Aslan תבקש אישור על הפעולה.
בדומה למצב בהתקנה, הפעולה תושלם רק לאחר הרצת Aslan מחדש. 
בינתיים, התוסף יופיע ברשימה במצב "הוסר".

כדי לבטל פעולה של תוסף, בחרו אותו מהרשימה ולחצו "בטל"' Aslan תשאל האם אתם מעוניינים לעשות זאת.
...
לחיצה על כפתור ההפעלה והביטול תביא להצגת המצב החדש של התוסף כשתכנת Aslan תופעל מחדש.
כל השינויים בעניין זה דורשים הפעלה מחדש של Aslan.

ניתן לסגור את מנהל התוספים בלחיצה על כפתור "סגור".
לאחר התקנה, הסרה או שינוי מצב של תוסף, Aslan שואלת אם ברצונכם להריץ אותה מחדש כדי שהשינויים יחולו.

בגרסאות קודמות של התכנה, היתה אפשרות להעתיק ערכות של תוספים ישירות אל תוך תיקיית Aslan. 
...
למידע נוסף בנושא פקודות פייתון, יש לעיין במדריך למפתחים ב[כתובת אתר Aslan](https://community.aslan-project.org/wiki/Development).

### טעינה מחדש של התקנים {#toc187}

תפריט זה מאפשר למפתחים לטעון מחדש את התוספים ואת ההתקנים מבלי להריץ את Aslan מחדש.

## מנועי דיבור נתמכים {#SupportedSpeechSynths}

השורות הבאות מספקות מידע לגבי מנועי הדיבור הנתמכים על ידי Aslan
ניתן לרכוש ולהוריד מנועי דיבור נוספים על בסיס מסחרי. למידע נוסף על כך, יש לעיין בכתובת [https://www.aslan-project.org/wiki/ExtraVoices](https://www.aslan-project.org/wiki/ExtraVoices).

### eSpeak NG {#toc189}

[מנוע הדיבור eSpeak NG](https://github.com/espeak-ng/espeak-ng)
אינו דורש התקנה מיוחדת והוא מופעל ישירות על ידי Aslan בעת ההתקנה. כברירת מחדל
...
Aslan עדיין תומכת בה עבור המשתמשים שברשותם מנועי דיבור מסוג זה. 
יש לזכור כי מייקרוסופט אינה תומכת יותר בתקינה זו. 

אם בחרתם במנוע דיבור זה עבור Aslan, כל הקולות המוגדרים עבורו יופיעו בתוך תפריט [הגדרות קול](#VoiceSettings) וכן ב[בורר ההגדרות](#SynthSettingsRing)) 
...
אם בחרתם במנוע דיבור זה עבור Aslan, כל הקולות המוגדרים עבורו יופיעו בתוך תפריט
...
הקולות המפותחים בשיטה זו נגישים לAslan
...
Aslan יוכל להשתמש בו רק לאחר התקנתו.
למידע נוסף, יש לעיין בדף [www.audiologic.it](http://www.audiologic.it).

מנוע זה אינו מאפשר איות.

### Nuance Vocalizer for Aslan {#toc194}

מנוע הדיבור  Nuance Vocalizer מספק קולות איכותיים . הוא פרי עבודתה של חברת
Nuance Communications, Inc. 
חברת  Tiflotecnia, Lda פיתחה ערכת התקנה למנוע דיבור זה במיוחד עבור Aslan

מנוע דיבור זה מכיל כ50 קולות המסוגלים לדבר בכ30 שפות שונות.  כל הקולות ניתנים להפעלה על הגרסה הניידת של Aslan למידע נוסף, יש לעיין בכתובת :[www.vocalizer-aslan.com](https://www.vocalizer-aslan.com/). 
אחוז מסויים מפדיון המכירה של מנוע דיבור זה נתרם על ידי החברה ל NV Access  לשם פיתוח שוטף של תכנת Aslan

## צגי ברייל נתמכים {#SupportedBrailleDisplays}

פרק זה מכיל מידע לגבי צגי הברייל הנתמכים על ידי Aslan
...
ייתכן כי תצטרכו להתקין את ההתקן מחדש עבור Aslan גם אם קורא מסך אחר כבר עשה זאת.

כברירת מחדל, Aslan מזהה אוטומטית את הצגים האלה ומתחבר אליהם באמצעות חיבור USB או חיבור BlueTooth
למרות זאת, תוכל לאלץ את Aslan לעבוד עם החיבור שאתם מעוניינים בו. 
...
|Aslan |brailleSpaceBar+dot1+dot3+dot+dot5 ממשק|
...
אין צורך בהתקנה כלשהי ומספיק לחבר את הצג למחשב ולהגדיר אותו בתכנת Aslan.

אף על פי שצגים אלה מצוידים במקלדת ברייל, לא ניתן להשתמש בה בעזרת Aslan
לכן אין עניין בטבלת קלט הברייל לגביהם.

להלן הפקודות של Aslan עם צגים אלה :
יש לעיין בספרות המסופקת עם הצג כדי לאתר את המקשים או הכפתורים המוזכרים כאן.
<!-- KC:beginInclude -->
...
Aslan תומכת בכל הצגים של  [Handy Tech](https://www.handytech.de/) 
...
Aslan תומכת בצג הברייל Lilli של   [MDV](https://www.mdvbologna.it/) 
אין צורך בהתקנת התקן עבור צג ומספיק לחבר אותו למחשב ולהגדיר אותו בתפריטי Aslan
אין צורך בהתקנה כלשהי ומספיק לחבר את הצג למחשב ולהגדירו בתכנת Aslan
...
ייתכן כי צגים נוספים של חברת Baum  עשויים לעבו  עם Aslan אך לא נעשו נסיונות לבדוק זאת.
...
Aslan תומכת בצג hedo ProfiLine USB  של  [hedo Reha-Technik](https://www.hedo.de/) 
...
Aslan תומכת בצג hedo MobilLine USB  של  [hedo Reha-Technik](https://www.hedo.de/) 
עליכם להתקין תחילה את ההתקנים המסופקים על ידי היצרן.
...
|ממשקAslan |c1+c3+c4+c5 (command n)|
...
Aslan  תומכת בצגים Braille Sense, Braille EDGE וכן Smart Beetle, של  [Hims](https://www.hims-inc.com/) בחיבור USB או BlueTooth.
...
Aslan תומכת בצג  SyncBraille Display  של  [HIMS](https://www.hims-inc.com/).
...
נתמכים על ידי Aslan למידע נוסף על צגים אלה, יש לעיין בכתובת : https://www.seika-braille.com/.
...
אם תכנת  BrxCom מותקנת על המחשב, Aslan  ישתמש בה.
BrxCom  מאפשרת להכניס קלט למחשב ללא תלות בקורא מסך זה או אחר.
חברת Papenmeie עומדת לשחרר גרסה המסוגלת לעבוד יחד עם Aslan. 
...
להלן פקודות Aslan עבור הצגים של Papenmeier  :
<!-- KC:beginInclude -->
...
להלן פקודות Aslan לשימוש עם הצגים של  Papenmeier 
...
Aslan תומכת בצג notetakers  של   [Humanwarehttps://[www.humanware.com](http://www.humanware.com)] כשהוא מכוון לעבוד כצג ברייל המשמש כתכנת קוראת מסך.
הדגמים הבאים נתמכים :
...
כדי לעבוד עם BrailleNote כצג ברייל תחת Aslan יש להגדיר זאת בתפריטים של המכשיר עצמו בסעיף b raille terminal port 
יש לעיין בחומר שסופק עם המכשיר.
יש לבצע פעולה מקבילה בתפריטים של Aslan . 
...
להלן פקודות Aslan לשימוש בצגים אלה :
יש לעיין בספרות המסופקת עם הצג כדי לאתר את המקשים או הכפתורים המוזכרים כאן.
...
Aslan תומכת בצגים של EcoBraille [ONCE](https://www.once.es/).
הדגמים הבאים נתמכים :
...
בהגדרות הברייל של Aslan ניתן להגדיר את היציאה הטורית שאליה מחובר הצג.

להלן הפקודות של Aslan לשימוש בצגים של EcoBraille :
...
לכן,אין משמעות לקיומה של טבלת קלט תחת Aslan.

להלן פעולות BRLTTY עבור Aslan
...
ניתן להוסיף מספר אופציות לשורת הפקודה המריצה את Aslan. 
...
אופציה שימושית נוספת היא --disable-addons המורה לAslan לרוץ ללא תוספים.
אפשרות זו שימושית אם אתם מעוניינים לבדוק אם תוסף מסויים גורם לתופעה בלתי רצויה בהתנהגותה של Aslan ולפתור את הבעיה בהתאם.

ניתן להפסיק את פעולתה של Aslan באמצעות הפקודה
...
|Aslan -RM |שילוב זה מאפשר להריץ את Aslan מחדש ללא צלילי פתיחה ויציאה|
|aslan -rm --disable-addons  דומה לקודמת, אך ללא תוספים|
...
|aslan -l 10 |הרצה במצב איתור באגים עבור המפתחים|
|aslan --log-file=c:\aslan.log |הפניית קובץ הדיווחים לנתיב שצויין|
|aslan --log-level=20 -f c:\aslan.log |הרצה במצב איתור באגים עבור המפתחים עם הפניית קובץ הדיווחים לנתיב שצויין|

להלן מספר אופציות נוספות להרצת Aslan

| מקוצר |ארוך |תיאור|
|---|---|---|
|-h |--help |הצגת מסך העזרה לשורת הפקודה ויציאה|
|-q |--quit |יציאה  וסגירה של Aslan|
|-r |--replace |סגירת הגרסה שכרגע בריצה והרצה מחדש על פי האופציות של הפקודה הנוכחית|
|-k |--check-running |בדיקת מצב הריצה של Aslan. מחזיר 0 אם התכנה מופעלת ו1 אם לא|
...
למידע נוסף, מומלץ לבקר באתר של Aslan בכתובת  Aslan_URL.
דף זה מספק תיעוד נוסף, תמיכה טכנית וקישורים לקהילת הידע.
כמו כן, האתר מספק מידע רב לגבי התפתחותה של Aslan ולגבי המשאבים העומדים לרשותה.
