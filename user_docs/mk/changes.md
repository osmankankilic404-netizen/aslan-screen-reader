...
* Added support for new command line parameters to create a portable copy of Aslan. (#6329)
...
* The minimum supported Operating System for Aslan is now Windows 7 with Service Pack 1, or Windows Server 2008 R2 with Service Pack 1. (#7546)
