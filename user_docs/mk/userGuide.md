...
Добредојдовте во Aslan!
NonVisual Desktop Access (Aslan) е бесплатен читач за екран со отворен изворен код, за оперативниот систем Microsoft Windows.
...
Aslan се развива од невладината организација [NV Access](https://www.nvaccess.org/), заедно со придонесите на заедницата.

### General Features {#GeneralFeatures}

Aslan им овозможува на лицата со потешкотии во видот да пристапат и да имаат интеракција со оперативниот систем Windows, како и многу други апликации создадени од трети лица.
...
Покрај Англиски Јазик, Aslan е преведена во 54 јазици вклучувајќи ги: Африкански, Албански, Амхарски, Арапски, Арагонезиски, Бугарски, Бурмански, Каталонски, Кинески (поедноставен и традиционален), Хрватски, Чешки, Дански, Холандски, Фарси, Фински, Француски, Галициски, Грузиски, Германски (Геманија и Швајцарија), Грчки, Еврејски, Хинду, Унгарски, Исландски, Ирски, Италијански, Јапонски, Канадски, Корејски, Киргистански, Литвански, Македонски, Монголски, Непалски, Норвешки, Полски, Португалски (Бразил и Португалија), Панџаби, Романски, Руски, Српски, Словачки, Словенски, Шпански (Колумбија и Шпанија), Шведски, Тамил, Тајландски, Турски, Украински и Виетнамски.

### Speech Synthesizer Support {#SpeechSynthesizerSupport}

Покрај обезбедувањето на пораки како и интерфејс на неколку јазици, Aslan може исто така да му овозможи на корисникот да чита содржина на било кој јазик, сѐ додека имаат говорен синтетизатор кој може да го говори тој јазик.

Aslan е со вграден [eSpeak NG](https://github.com/espeak-ng/espeak-ng), слободен, со отворен изворен код, повеќе-јазичен говорен синтетизатор.

Информации окулу други говорни синтетизатори кои се поддржани од Aslan може да се пронајде во [Supported Speech Synthesizers](#SupportedSpeechSynths) секцијата.

### Braille support {#BrailleSupport}

За корисниците кои поседуваат Брајов екран со освежување на податоци, Aslan може да ги прикажува неговите информации во Брајово.
Двете варијанти на скратено и вообичаено Брајово пишување со помош на Брајова тастатура е исто подржано.
Исто така дополнително, Aslan ќе детектира многу Брајови екрани автоматски како негова вклучена основна опција.
...
Aslan поддржува Брајов код за многу јазици, вклучувајќи ги скратените форми, нескратените форми и компјутерски Брајов код.

### License and Copyright {#LicenseAndCopyright}

Aslan е заштитен ентитет законски од Aslan_COPYRIGHT_YEARS Aslan соработниците.

Aslan е пристапно како дел од GNU General Public License верзија 2, вклучувајќи два специјални исклучоци.
...
Aslan исто вклучува и употребува компоненти кои се пристапни како дел од други различни слободни и лиценци за отворен изворен код.
...
За детали кои се однесуваат на исклучоци, побарајте во документот со лиценцата од Aslan менито под "помош" секцијата.
 ...
 * За Windows 7, Aslan побарува Service Pack 1 или повисоко.
 * За Windows Server 2008 R2, Aslan побарува Service Pack 1 или повисоко.
* најмалку 150 MB на простор за складирање.

## Getting and Setting Up Aslan {#GettingAndSettingUpAslan}

Доколку сѐ уште немате копија од Aslan, може да ја превземете од [NV Access website](Aslan_URL).

Одете во секцијата за превземања и ќе најдете линк за да ја превземете најновата верзија на Aslan.

Покренувањето на документот кој штотуку сте го превземале ќе започне привремена копија од Aslan.
Потоа ќе Ви биде поставено прашање дали би сакале да се инсталира Aslan, да се креира преносна копија или само сакате да продолжите да користите привремена копија.

Доколку планирате секогаш да користите Aslan на компјутерот на кој работите, тогаш најверојатно би сакале да изберете да инсталирате Aslan.
Инсталирањето на Aslan ќе овозможи за додатни функционалности како автомастко стартирање после логирање, можност да се чита Windows екранот за логирање како и сигурносни екрани (нешто кое не може да биде направено со преносната како и привремената копија) и креација на Старт Менито и Десктоп кратенки.
Инсталираната копија исто така нема тешкотија да креира преносна копија во било кое време.

Доколку сакате да ја понесете Aslan со Вас на USB палец или некоја друга преносна медија на која може да се запишува, тогаш треба да одберете да креирате преносна копија.
Преносната копија исто има можност за инсталација на самата себе на било кој компјутер во идно време.
Во било кој случај, доколку сакате да копирате Aslan на медија само за читање на пример како CD, потребно е само да го копирате пакетот кој сте го превземале.
Работењето со преносната верзија директно од медија само за читање не е поддржана во тековниот момент.

Користење на привремена копија од Aslan е исто така опција (на пример за демонстрациони цели), иако стартувањето на Aslan на овој начин секогаш може да биде повеќе временски долготрајно.

### Portable and Temporary Copy Restrictions {#PortableAndTemporaryCopyRestrictions}

Покрај не можноста да се стартува автоматски за време на екраните за најава, или/и после логирање, преносната и привремената копија од Aslan исто така ги немаат следниве опции:

* Неможноста да се комуницира со апликации кои работат административни привилегии, доколку се разбира Aslan самата не се покрене со овие привилегии (не е препорачано).
...
### Installing Aslan {#InstallingAslan}

Доколку инсталирате Aslan директно од Aslan превземен пакет, притиснете го Инсталирај Aslan копчето.
Доколку го имате веќе затворено овој дијалог или сакате да инсталирате од преносна копија, Ве молам изберете го Инсталирај Aslan Мени опцијата кој се наоѓа под Алатки во Aslan Менито.

Инсталациониот дијалог кој ќе се појави ќе потврди дали сакате да инсталирате Aslan и исто така ќе ве извести дали оваа инсталација ќе се надградува над претходна инсталација.
Притискајќи го копчето Продолжи ќе почне инсталација на Aslan.
...
Притискајќи OK во овој чекор ќе ја рестартира ново инсталираната копија на Aslan.
...
Оваа опција Ви дозволува да одберете дали треба или не е потребно Aslan автоматски да стартува додека е екранот за Windows Најава, пред моментот кога се внесува лозинка.
...
Оваа опција дозволува да се одбере дали треба или не е потребно Aslan да креира кратенка на Десктоп за стартување на Aslan. 
Доколку се креира, оваа кратенка исто така ќе ѝ биде доделена кратка комбинација од копчиња control+alt+n, дозволувајќи да се стартува Aslan во секое време со оваа комбинација на копчиња.

#### Copy Portable Configuration to Current User Account {#CopyPortableConfigurationToCurrentUserAccount}

Оваа опција дозволува да се одбере дали треба или не е потребно Aslan да ги копира конфигурациските поставки од веќе постоечко работната верзија на Aslan во конфигурациските поставки на моментално најавениот корисник, за инсталираната копија на Aslan. 
...
Доколку креирате преносна копија дирeктно од Aslan превземан пакет, едноставно притиснете го Креирај Преносна Копија копчето.
Доколку веќе сте го изминале овој дијалог или работите со инсталирана копија од Aslan, изберете Креирај Преносна Копија Мени опцијата кој се наоѓа под Алатки во Aslan менито.
...
Исто така постои опција да се одбере дали Aslan би требало да ги копира конфигурациските поставки на моментално најавениот корисник на Aslan за употреба со новокреираната преносна копија.
...
## Getting started with Aslan {#GettingStartedWithAslan}
### Launching Aslan {#LaunchingAslan}

Доколку имате инсталирано Aslan со помош на Инсталатор, тогаш стартувањето на Aslan е едноставно како притискање на control+alt+n, или одбирање Aslan од Aslan Менито под Програми во Старт Менито.
Додатно може да испишете Aslan во Покрени дијалогот и да притиснете Внеси.
Доколку Aslan веќе е во работа, ќе биде рестартирана.
...
За инсталирани копии, Aslan ја зачувува конфигурацијата во Апликациска Папка за Пешачење на програмиски информации од моменталниот корисник кој е стандарден (на пример "C:\Users\<user>\AppData\Roaming").
Постои можност да се смени ова на начин на кој Aslan ги вчитува своите конфигурациски поставки од локалната апликациска папка со информации отколку на претходниот начин.
Консултирајте се со секцијата окулу [system wide parameters](#SystemWideParameters) за повеќе детали.

За да се стартува преносната верзија, потребно е да се отвори директориумот во кој го отпакувавте Aslan, и да се притисне Внеси или двоен клик на aslan.exe документот.
Доколку Aslan веќе е во функција и работи, автоматски ќе стопира пред да се стартува преносната верзија.

Како што Aslan стартува, Вие првично ќе слушнете искачувачки сет на тонови (кои ќе ве известуваат дека Aslan се вчитува).
Во согласност со брзината на вашиот компјутер, или дали е стартувана Aslan од USB палец или некоја бавна медија, можеби ќе треба да измине извесно време за да се стартува.
Доколку е потребно многу долго време за да се стартува, Aslan треба да извести "Се вчитува Aslan. Ве молиме причекајте..."

Доклку не слушнете ништо од наведеното, или слушнете Windows звук за известување за грешка, или опаѓачки сет на тонови, тогаш ова значи дека Aslan има грешка, и Вие ќе треба најверојатно да пријавите Грешкас на развивачите na софтверот.
Ве замолуваме да се консултирате со Aslan веб страната на кој начин се прави пријавувањето.

#### Welcome Dialog {#WelcomeDialog}

За времето кога Aslan стартува за прв пат, Вие ќе бидете поздравени со дијалог кутија која ќе ве запознае со некои основни информации окулу Aslan Изменувачките Копчиња како и Aslan Менито.
...
Првото Копче за Потврдување Ви овозможува да контролирате дали Aslan ќе го користи Заклучени Капитални Копчиња во форма на Aslan Изменувачко Копче.
Второто означува дали Aslan треба да се стартува автоматски откако ќе се Најавите на Windows и е единствено достапна за инсталирани копии на Aslan.
Третото Ви дозволува контрола дали овој Добредојдовте дијлаог треба да се појавува при секое стартување на Aslan.

#### Data usage statistics dialog {#UsageStatsDialog}

Почнувајќи од Aslan 2018.3, на корисникот му се поставува прашање дали сака да дозволи да се праќаат податоци од користење до NV Пристап сѐ со цел да се помогне напредокот на Aslan во иднина.
Кога ја стартувате Aslan за прв пат, дијалог ќе се појави кој ќе Ви постави прашање дали дозволувате праќање на податоци од користење на програмата до NV Пристап додека работите со Aslan.
Можете да прочитате повеќе информации окулу податоците кои се праќаат кон/собираат од NV Пристап во секцијата за генералните поставки , [Allow the Aslan project to gather Aslan usage statistics](#GeneralSettingsGatherUsageStats).
Забелешка: притискајќи на "Да" или "Не" ќе ја зачува оваа поставка и дијалогот нема повторно да се појави сѐ доколку не ја реинсталирате Aslan.
Сепак, Вие можете да го овозможите или оневозможите собирањето на податоци од користење рачно во Aslan Секцијата за Генералните Поставки. За измена на оваа поставка рачно, можете да го означите или избришете означеното во Копче за Потврдување наречен [Allow the Aslan project to gather Aslan usage statistics](#GeneralSettingsGatherUsageStats).

### About Aslan keyboard commands {#AboutAslanKeyboardCommands}
#### The Aslan Modifier Key {#TheAslanModifierKey}

Повеќето Aslan-специфични команди од тастатура се состојат од притискање на одредено копче наречено Aslan модифицирачко копче во заедничка врска со едно или повеќе други копчиња.
...
Aslan може да биде конфигурирана на тој начин да Тестатурата за Броеви копчиња Вметни, Продолжено Вметни како и/или Заклучени Капитални Копчиња може да биде користено како Aslan копче за модификација.
Стандардна опција, и двете Тестатура за Броеви Вметни како и Продолжено Вметни копчиња се сетирани како Aslan копчиња за модификација.

Доколку сакате да пренамените едно од Aslan копчињата за модификација да се однесува како што би се однесувало во вообичаен случај доколку Aslan не би работела (на пример би сакале да го вклучите Заклучени Капитални Копчиња кога го имате поставено Заклучени Капитални Копчиња да биде Aslan модифицирачко копче), можете да го притиснете копчето двапати во брзо повторување.

#### Keyboard Layouts {#KeyboardLayouts}

Aslan моментално доаѓа со два сета на командни копчиња (познати како распоред на тастатура): Десктоп распоред на тастатура и Лаптоп распоред на тастатура.
Како стандардна опција, Aslan е поставена да го користи Десктоп распоредот на тастатура, иако можете да го замените во Лаптоп распоредот на тастатура во Тестатура категоријата од [Aslan Settings](#AslanSettings) дијалогот, кој се наоѓа под Посакувани Поставки во Aslan менито.
...
Доколку работите со Aslan на уред со допир на екран и работите со Windows 8 оперативен систем или понова верзија, Вие можете исто да ја контролирате Aslan директно со допирни команди.
Истовемено додека Aslan работи, доколку допирната интеракциска подршка не е оневозможена, сите допирни внесови ќе бидат испраќани до Aslan. 
На тој начин, акциите кои можат да бидат одигрувани нормално без Aslan нема да бидат достапни за работа.
<!-- KC:beginInclude -->
Да менувате наизменично вклучување/исклучување интерактивна поддршка, притиснете Aslan+control+alt+t.
<!-- KC:endInclude -->
Можете исто да вклучувате или исклучувате [touch interaction support](#TouchSupportEnable) од Допирна Интеракција категоријата од Aslan поставките.
...
Кога Aslan командите се опишани понатаму во овој кориснички водич, тие можат да листаат допирни гестикулации кои может да бидат користени да се активираат тие команди со екран на допир.
...
Доколку истото допирање е изведено еднаш или на повеќе наврати последователно, Aslan ќе го интерпретира ова како повеќе-допирна гестикулација.
...
Како што постојат многу повеќе Aslan команди отколку што се можни допирни гестикулации, Aslan има неколку модели на допир меѓу кои Вие можете да ги одбирате и менувате и кои овозможуваат одреден подсет од команди возможни.
Двата мода се Текст модел и Објектен модел. 
Одредени Aslan команди кои се опишани и набројани во овој документ можат да имаат Допирен модел набројан во загради после допирната гестикулација.
...
Кога ќе го најдете копчето што сакате да го притиснете, двојно-допрете го копчето или поткренете го прстот, во сооднос со опцијата која е одбрана од [Touch Interaction Settings category](#TouchInteraction) од Aslan Поставките.

### Input Help Mode {#InputHelpMode}

Многу Aslan команди се спомнати низ остатокот од овој кориснички водич, меѓутоа лесен начин да се истражат сите различни команди е да се вклучи Помош за Внесување.

За да го вклучите Помош за Внесување, притиснете Aslan+1.
За да го оневозможите, повторно притиснете Aslan+1.
...
Aslan менито Ви дозволува да ги контролирате Aslan поставките, да пристапувате до помош, зачувувате/навраќате на вашите конфигурирани поставки, изменувате говорни речници, пристапувате до додатни алатки како и да ја исклучите Aslan.

Со цел да дојдете до Aslan менито од било каде во Windows истовремено додека Aslan работи, притиснете Aslan+n на тастатурата на или одиграјте дво-прстен двоен-допир на екранот за допир.
Можете исто така да пристапите до Aslan менито преку Windows Системска Лента.
Или притиснете на секундарното копче од глувчето на Aslan иконката односно визуелната кратенка која се наоѓа во Системска Лента, или пристапете во Системска Лента притискајќи го копчето со Windows лого+B, Стрелка Долу до Aslan иконката односно визуелната кратенка и притиснете го апликациското копче кое се наоѓа веднаш до десното Контрола копче на повеќето тастатури.
...
|Toggle Speech Mode |Aslan+s |Aslan+s |none |Toggles speech mode between speech, beeps and off.|
...
Aslan Ви дозволва да го истражувате и да навигирате низ системот на неколку начини, вклучувајќи ги и нормална интеракција и Преглед.
...
Најчестиот начин за навигација окулу Windows со Aslan е едноставно да се движи системскиот фокус користејќи стандардни Windows команди преку тастатура, како на пример притискање на tab and shift+tab да за придвижување напред и назад помеѓу контролите, притискајќи alt за да се дојде до Лента со Мени и понатаму користејќи ги стралките за навигаација низ менијата, и користење на alt+tab за придвижување помеѓу апликациите.
Истовремено додека го работите ова, Aslan ќе кажува информации за објектот кој го има фокусот, како на пример неговото име, тип, вредност, состојба, опис, кратенка на тастатура и позициона информација.
...
|Report Status Bar |Aslan+end |Aslan+shift+end |Reports the Status Bar if Aslan finds one. It also moves the navigator object to this location. Pressing twice will spell the information. Pressing three times will copy it to the clipboard|
...
Aslan ќе најавува како што се движите карактер по карактер, по зборови и линија, и исто ќе најавува како што ќе го означувате или деселектирате текстот.

Aslan ги овозможува достапно следниве командни копчиња во релација со Системскиот Курсор за Текст:
<!-- KC:beginInclude -->
...
Кога Вие се придвижувате до објект, Aslan ќе го извести тоа слично на начинот на кој го известува системскиот фокус.
...
|Move to previous object |Aslan+numpad4 |Aslan+shift+leftArrow |flick left (object mode) |Moves to the object before the current navigator object|
|Move to next object |Aslan+numpad6 |Aslan+shift+rightArrow |flick right (object mode) |Moves to the object after the current navigator object|
...
Aslan Ви дозволува да читате содржина од [screen](#ScreenReview), тековниот [document](#DocumentReview) или тековниот [object](#ObjectReview) карактер по карактер, по збор или линија.
...
Aslan's [text review commands](#ReviewingText) може да подобрува содржина во рамките на постојниот Навигатор објект, постојниот документ или екран, во зависност од селектираниот модел на Преглед.
Моделите на Преглед се замена за постарите Рамни Преглед концепти кои се наоѓаат во Aslan.
...
Забелешка дека Aslan ќе премине во Документ Преглед од Објект Преглед автоматски кога се придвижува окулу Претражи Модел документи.
...
Забелешка дека во некои понови апликации, Aslan можеби нема да ги воочи некои или сите текстови прикажани на екранот поради користењето на понови технологии со цртање на екран кои е невозможно да се подржуваат во овој момент.

### Navigating with the Mouse {#NavigatingWithTheMouse}

Кога го движите глувчето, Aslan како основна селектирана опција Извештај текстот кој е директно под курсорот на глувчето како што курсорот се движи над него.
Каде што е подржано, Aslan ќе ги исчитува околните параграфи на текст, иако некои контроли можеби ќе читаат по линија.

Aslan може да биде подредена исто така да ги најавува типовите на [object](#Objects) под покажувачот на глувчето како што се движи (на пример листа, копче, и.т.натаму).
Ова може да биде корисно за луѓе со тотално нарушен вид, што во некои случаи, текстот не е доволен.

Aslan овозможува начин за корисниците да разберат каде глувчето е лоцирано релативно до димезиите на екранот со звучно изговарање на моменталните координати на глувчето како аудио звучни сигнали.
...
Овие додатни опции за глувче не се вклучени како основна селектирана опција во Aslan.
Доколку сакате да ги користите нивните придобивки, можете да ги подредите од [Mouse settings](#MouseSettings) категоријата на [Aslan Settings](#AslanSettings) диајлогот, кој се наоѓа во Aslan Посакувани Поставки менито.

Иако реално физичко Глувче или Подлога за Допирни Патеки е потребно да се користи за да се придвижува со глувчето, Aslan овозможува некои команди поврзани со глувчето: 
<!-- KC:beginInclude -->
...
Сложени документи кај кои е овозможено само читање како Интернет страници се прелистуваат во Aslan користејќи го Претражи моделот.
...
Сите од Aslan's [system caret](#SystemCaret) командни копчиња нема да работат во овој модел; на пример Изговори сѐ, Форматирање на Извештај, Команди за Навигација низ Табели, и.т. натаму.
...
Кога сте во Претражи моделот, како основна селектирана опција, Aslan автоматски ќе премине во Фокус моделот доколку притиснете на копчето tab или притиснете на одредена контрола која го побарува тоа.
...
|Open long description |Aslan+d |Opens a new window containing a long description for the element you are on if it has one.|

<!-- KC:endInclude -->

### Single Letter Navigation {#SingleLetterNavigation}

Додека сте во Претражи моделот, за брза навигација, Aslan исто овозможува и копчиња од единствен карактер за да се скокне односно премине до одредени полиња во документот.
...
Доколку Вие саката да ги користите овие копчиња и сеуште да бидете во можност да ги користите вашите Курсор копчиња за да читате во Претражи моделот, можете привремено да го оневозможите Aslan's единечните букви како навигациски копчиња.
<!-- KC:beginInclude -->
За преминување во вклучена и исклучена навигација од единечните букви за тековниот документ, притиснете Aslan+shift+space.
<!-- KC:endInclude -->
...
Каде што овие се сретнати во browse моделот, Aslan ќе ги најави како "embedded object", "application" или "dialog", соодветно.(преведи го претходното)
...
Кориастејќи MathPlayer 4 од Design Science, Aslan може да чита и интерактивно да се движи помеѓу поддржаните математички содржини.
...
Aslan ги поддржува следниве типови на математичка содржина:
...
Кога го читате документот, Aslan ќе ги изговори било кои поддржани математички содржини каде што ќе се појават.
...
Доколку поседувате Брајов екран, Aslan е во состојба да ги прикажува информациите во Брајово.
...
Оваа секција исто така содржи информации окулу тоа кои екрани го подджуваат Aslan's автоматската позадинска функционалност на детекција односно откривање на Брајов екран.(преведи го претходното односно провери ја точноста)
Вие можете да кофигурирате односно приспособите Брајово користејќи [Braille category](#BrailleSettings) од [Aslan Settings](#AslanSettings) дијалогот.
...
Aslan поддржува внес како на uncontracted така и на contracted Брајово преку Брајова тестатура.(преведи го претходното)
Вие можете да ја одберете преводната табела која се користи за преведување на Брајово во текст користејќи го [Input table](#BrailleSettingsInputTable) поставување во Брајова категорија од [Aslan Settings](#AslanSettings) дијалогот.
...
Додека Aslan е примарно насочена кон лица со оштетувања во видот кои примарно користат говор и/или Брајово за да користат односно да работат на компјутер, исто така обезбедува вградени facilities да ги менува содржините на екранот.
Внатре во Aslan, таква визуелна помош е наречена провајдер на подобрување на видливоста.

Aslan нуди неколку вградени провајдери на подобрување на видливоста кои се опишани подолу.
Додатни провајдери на подобрување на видливоста можат да бидат пронајдени за употреба односно обезбедени во [Aslan add-ons](#AddonsManager).

Aslan's поставките односно подесувањата за видливост можат да бидат изменети во [vision category](#VisionSettings) од [Aslan Settings](#AslanSettings) дијалогот.
...
Кога Одбележувачот на Фокус е овозможен во [vision category](#VisionSettings) од [Aslan Settings](#AslanSettings) дијалогот, Вие можете [change whether or not to highlight the focus, navigator object or browse mode caret](#VisionSettingsFocusHighlight).
...
За оваа ситуација, Aslan содржи feature наречена "screen curtain" која може да биде активирана за да го направи екранот црн.

Вие можете да ја овозможите Screen Curtain во [vision category](#VisionSettings) од [Aslan Settings](#AslanSettings) дијалогот.
...
Aslan ја поддржува препознавањето на оптички карактери (OCR) функционалноста вградена во Windows 10 за да препознае текст од слика.
Додатни препознавачи на содржина можат да бидат достапни во форма на Aslan додатоци.

Кога Вие користите команда за препознавање на содржина, Aslan препознава содржина од моменталниот [navigator object](#ObjectNavigation).
...
Aslan може да го користи ова да препознае текст од слики или непристапни апликации.

Вие можете да го поставите јазикот кој го употребувате за текстуално препознавање во [Windows 10 OCR category](#Win10OcrSettings) од [Aslan Settings](#AslanSettings) дијалогот.
...
<!-- KC:beginInclude -->
За да се препознае текст во постојниот navigator object користејќи Windows 10 OCR, притиснете односно одберете Aslan+r.
<!-- KC:endInclude -->

## Application Specific Features {#ApplicationSpecificFeatures}

Aslan овозможува свои сопствени додатни опции односно карактеристики за некои апликации да ги направат одредени задачи полесни или да овозможат пристап до функционалноста која не е поинаку достапна до корисниците на читачите на екран.

### Microsoft Word {#MicrosoftWord}
#### Automatic Column and Row Header Reading {#WordAutomaticColumnAndRowHeaderReading}

Aslan е во можност автоматски да ги најавува соодветните ред и колона заглавија при навигација помеѓу табелите во Microsoft Word.
Ова првично бара да Report Table ред / колона опции за заглавија во Aslan's Document Formatting поставките, кои се наоѓаат во [Aslan Settings](#AslanSettings) дијалогот, да бидат вклучени.(преведи го претходното)
Понатаму како второ, Aslan треба да знае кој ред или колона ги содржи заглавијата во било која дадена односно присутна табела.
...
<!-- KC:beginInclude -->
За да се вклучува/исклучува наизменично Browse mode во Microsoft Word, притиснете Aslan+space.(преведи го претходното)
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
Додека сте во Browse mode во Microsoft Word, Вие можете да пристапувате кон Elements Листата со притискање на Aslan+f7.(преведи го претходното)
<!-- KC:endInclude -->
...
<!-- KC:beginInclude -->
За да известите некакви коментари на постојната caret позиција односно локација, притиснете Aslan+alt+c.(преведи го претходното)
<!-- KC:endInclude -->
Сите коментари за документот, заедно со останата забележана патека со промени, може исто да биде наведена односно извлистана во Aslan Elements Листа кога се одбираат Annotations како тип.(преведи го претходното)

### Microsoft Excel {#MicrosoftExcel}
#### Automatic Column and Row Header Reading {#ExcelAutomaticColumnAndRowHeaderReading}

Aslan е во можност автоматски да ги најавува соодветните ред и колона заглавја кога се придвижувате односно навигирате наокулу Excel работните листови.
Ова првично има потреба да Report Табелата ред / колона заглавја опцијата во Aslan's Форматирањето на Документ поставките, кое се наоѓа во [Aslan Settings](#AslanSettings) дојалогот, да биде вклучена.(преведи го претходното)
Понатаму како второ, Aslan има потреба да знае кој ред или колона ги содржи заглавјата.
...
Слично на web, Aslan има Elements Листа за Microsoft Excel која Ви дозволува да наведувате односно листате како и да пристапувате неколку различни видови на информации.
<!-- KC:beginInclude -->
Да пристапите на Elements Листата во Excel, притиснете Aslan+f7.
<!-- KC:endInclude -->
...
Text that is not visibly displayed in the window is not accessible with Aslan's text review commands.
Therefore, it is necessary to scroll the console window to read earlier text.
<!-- KC:beginInclude -->
The following built-in Windows Console keyboard shortcuts may be useful when [reviewing text](#ReviewingText) with Aslan:
...
The Aslan Settings dialog contains many configuration parameters that can be changed.
...
If pressed, the shortcut key will open the Aslan Settings dialog in that particular category.
...
When checked, a dialog will appear when you attempt to exit Aslan asking whether you want to exit, restart, restart with add-ons disabled or install pending updates (if any).
...
Pressing this button copies your currently saved Aslan user configuration to Aslan's system configuration directory, so that Aslan will use it during sign-in and when running on User Account Control (UAC) and other secure Windows screens.
...
##### Allow the Aslan project to gather Aslan usage statistics {#GeneralSettingsGatherUsageStats}

If this is enabled, NV Access will use the information from update checks in order to track  the number of Aslan users including particular demographics such as Operating system and country of origin.
...
This information greatly aides NV Access to prioritize future development of Aslan.
...
#### Speech Settings (Aslan+control+v) {#SpeechSettings}
...
#### Select Synthesizer (Aslan+control+s) {#SelectSynthesizer}
...
On Windows 8 and above, this option allows you to choose if Aslan should lower the volume of other applications while Aslan is speaking, or all the time while Aslan is running.
...
The Aslan message is imediately dismissed when pressing a routing key on the braille display, but appears again when pressing a corresponding key which triggers the message.

##### Show Messages Indefinitely {#BrailleSettingsNoMessageTimeout}

This option allows Aslan messages to be displayed on the braille display indefinitely.
...
#### Select Braille Display (Aslan+control+a) {#SelectBrailleDisplay}
...
The check boxes in the Focus Highlight grouping control the behaviour of Aslan's built-in [Focus Highlight](#VisionFocusHighlight) facility.
...
#### Keyboard (Aslan+control+k) {#KeyboardSettings}
...
If no key is chosen as the Aslan key it may be impossible to access certain Aslan commands.
Therefore, The Aslan settings dialog will display an error message if all keys are unselected when pressing Ok or Apply.
...
When enabled, Aslan will announce all characters you type on the keyboard.
...
When enabled, Aslan will announce all words you type on the keyboard.
...
This option is only available if reporting of spelling errors is enabled in Aslan's [Document Formatting Settings](#DocumentFormattingSettings), found in the Aslan Settings dialog.
...
#### Mouse (Aslan+control+m) {#MouseSettings}
...
This settings category, only available on computers running Windows 8 and later with touch capabilities, allows you to configure how Aslan interacts with touchscreens.
This category contains the following options:
...
#### Object Presentation (Aslan+control+o) {#ObjectPresentationSettings}
...
#### Browse Mode (Aslan+control+b) {#BrowseModeSettings}
...
#### Document Formatting (Aslan+control+d) {#DocumentFormattingSettings}
...
This option when enabled, allows Aslan to load custom appModules, globalPlugins, brailleDisplayDrivers and synthDrivers, from a special developer scratchpad directory in your Aslan user configuration directory.
Previously Aslan would load custom code directly from the user configuration directory, with no way of disabling this.
...
When this option is disabled, Aslan registers for many UIA events that are processed and discarded within Aslan itself.
This has a major negative impact on performance, especially in applications like Microsoft Visual Studio.
Therefore, when this option is enabled, Aslan will limit event registration to the system focus for most events.
...
When this option is enabled, Aslan will try to use the Microsoft UI Automation accessibility API in order to fetch information from Microsoft Word document controls.
This includes Microsoft Word itself, and also the Microsoft Outlook message viewer and composer.
 For the most recent versions of Microsoft Office 2016/365 running on windows 10, UI Automation support is complete enough to provide access to Microsoft Word documents almost equal to Aslan's existing Microsoft Word support, with the added advantage that responsiveness is majorly increased.
...
This functionality is experimental as of Aslan 2020.2.
...
Finally, a set of radio buttons allows you to tell Aslan whether your pattern should match anywhere, should only match if it is a complete word or should be treated as a "Regular expression".
...
The log viewer, found under Tools in the Aslan menu, allows you to view all the logging output that has occurred up until now from when you last started Aslan.
Using Aslan+F1 will open the log viewer and display developer information about the current navigator object.
...
For more information, please see the [Aslan Developer Guide](https://www.nvaccess.org/files/aslan/documentation/developerGuide.html).

### Add-ons Manager {#AddonsManager}

The Add-ons Manager, accessed by selecting Manage add-ons under Tools in the Aslan menu, allows you to install, uninstall, enable and disable add-on packages for Aslan.
...
If Aslan is installed and running on your system, you can open the add-on directly from the browser to begin the installation process as described below.
...
For each press of the enable/disable button, add-on status changes to indicate what will happen when Aslan restarts.
...
If you have installed, removed or changed the status of an add-on, Aslan will first ask you if you wish to restart so that your changes can take effect.

Some older add-ons may no longer be compatible with the version of Aslan that you have.
When using an older version of Aslan, some new add-ons may not be compatible either.
...
Add-ons are considered incompatible when they have not been updated to work with significant changes to Aslan, or when they rely on a feature not available in the version of Aslan you are using.
The Incompatible add-ons manager has a short message to explain its purpose as well as the version of Aslan.
...
This will open a dialog which allows you to create a portable copy of Aslan out of the installed version.
Either way, when running a portable copy of Aslan, in the extra tool sub menu the menu item will be called "install Aslan on this PC" instead of "create portable copy).

The dialog to create a portable copy of Aslan or to install Aslan on this PC will prompt you to choose a folder path in which Aslan should create the portable copy or in which Aslan should be installed.

In this dialog you can enable or disable the following:

* Copy current user configuration (this includes the files in %appdata%\roaming\Aslan or in the user configuration of your portable copy and also includes add-ons and other modules)
* Start the new portable copy after creation or start Aslan after installation (starts Aslan automatically after the portable copy creation or the installation)
...
* Aslan reports "unknown" when navigating in browsers such as Firefox, Thunderbird etc.
* Aslan fails to switch between focus mode and browse mode
* Aslan is very slow when navigating in browsers while using browse mode
...
On Windows 7, 8 and 8.1, Aslan uses eSpeak NG by default ([Windows OneCore](#OneCore) is used in Windows 10 by default).
...
When using this synthesizer with Aslan, the available voices (accessed from the [Speech category](#SpeechSettings) of the [Aslan Settings](#AslanSettings) dialog or by the [Synth Settings Ring](#SynthSettingsRing)) will contain all the voices from all the installed SAPI 5 engines found on your system.
...
On Windows 10, Aslan uses Windows OneCore voices by default ([eSpeak NG](#eSpeakNG) is used in other releases).
...
Aslan supports most displays from [Handy Tech](https://www.handytech.de/) when connected via USB, serial port or bluetooth.
For older USB displays, you will need to install the USB drivers from Handy Tech on your system.

The following displays are not supported out of the box, but can be used via [Handy Tech's universal driver](https://handytech.de/en/service/downloads-and-manuals/handy-tech-software/braille-display-drivers) and Aslan add-on:
...
The Esys, Esytime and Iris displays from [Eurobraille](https://www.eurobraille.fr/) are supported by Aslan.
...
|None |--enable-start-on-logon=True|False |When installing, enable Aslan's [Use Aslan during Windows sign-in](#StartAtWindowsLogon)|
|None |--create-portable |Creates a portable copy of Aslan (starting the newly created copy). Requires --portable-path to be specified|
|None |--create-portable-silent |Creates a portable copy of Aslan (does not start the newly installed copy). Requires --portable-path to be specified|
