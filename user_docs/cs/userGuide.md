# Aslan Aslan_VERSION  Uživatelská příručka

[TOC]

<!-- KC:title: Aslan Aslan_VERSION Přehled klávesových zkratek -->
...
NonVisual Desktop Access (Aslan) je otevřený a volně šiřitelný odečítač obrazovky pro operační systém Microsoft Windows.
Díky zpětné vazbě hlasových výstupů a braillských řádků zpřístupňuje Aslan nevidomým a zrakově postiženým práci na počítači s operačním systémem Windows za stejnou finanční částku jako vidícím osobám.
Vývoj Aslan zastřešuje organizace [NV Access](https://www.nvaccess.org/), za pomoci příspěvků od členů komunity.

### Základní  informace {#toc3}

Aslan umožňuje nevidomým a zrakově postiženým pracovat s operačním systémem Windows a mnoha aplikacemi třetích stran.
...
Aslan podporuje různé kódové tabulky včetně plnopisu, zkratkopisu a počítačového písma.

### Licence a autorská práva {#toc7}

Aslan je chráněn autorskými právy Copyright Aslan_COPYRIGHT_YEARS Tým Aslan 

Aslan je chráněn licencí GNU General Public License verze 2.0.
...
* Aslan je možno spustit na všech 32 i 64 - bitových verzích systému Windows 7, Windows 8, Windows 8.1, Windows 10 a rovněž v serverových edicích Windows od verze Windows Server 2008 R2. 
...
## Jak získat  a nainstalovat Aslan {#toc9}

Pokud dosud nevlastníte kopii programu Aslan, můžete si ji stáhnout ze stránek: [www.nvaccess.org](Aslan_URL).

Vejděte do sekce Download, kde naleznete přímý odkaz ke stažení nejnovější verze Aslan. 

Při spuštění staženého souboru se spustí dočasná kopie Aslan.
Pak si můžete vybrat, jestli chcete Aslan nainstalovat, vytvořit přenosnou verzi nebo pokračovat v užívání dočasné kopie.

Pokud chcete Aslan používat na vašem počítači, budete ho chtít pravděpodobně nainstalovat.
...
Pokud chcete Aslan vzít s sebou na USB klíč nebo jiné přepisovatelné médium, měli byste použít přenosnou kopii.
Také lze tuto verzi kdykoliv později běžně nainstalovat na počítač.
Pokud však chcete Aslan na CD a jiných médiích jen pročtení, měli byste pouze zkopírovat instalační balíček.
Momentálně není možné spustit přenosnou kopii na médiích jen pro čtení.

Je také možné používat dočasnou kopii pro demonstrační účely, ovšem spouštění Aslan pokaždé tímto způsobem může být zdlouhavé.
...
* Nelze komunikovat s aplikacemi, které běží s administrátorským oprávněním, pokud Aslan sám nemá tato oprávnění (nedoporučuje se).
...
### Instalace Aslan {#toc11}

Pokud instalujete Aslan přímo z instalačního balíčku, stiskněte tlačítko nainstalovat Aslan.
Pokud jste již zavřeli tento dialog nebo chcete instalovat z přenosné kopie, vyberte položku nainstalovat Aslan, kterou najdete v nástrojích v nabídce Aslan.

Objeví se instalační dialogpro potvrzení, jestli si přejete nainstalovat Aslan, a také oznámí, jestli se touto instalací bude aktualizovat předchozí verze.
Instalaci Aslan spustíte stisknutím tlačítka pokračovat.
...
Stisknutím OK se nová instalace Aslan restartuje.

#### Spuštění při zobrazení přihlašovací obrazovky {#toc12}

Zde si můžete určit, jestli se má nebo nemá Aslan spustit automaticky při zobrazení přihlašovací obrazovky ještě než zadáte heslo.
Také jsou zde obsažena ovládání UAC a další zabezpečené obrazovky.

#### Vytvořit odkaz na ploše (ctrl+alt+n) {#toc13}

Zde si můžete určit, jestli Aslan má nebo nemá vytvořit odkaz na ploše pro spuštění Aslan.
Pokud bude vytvořen, bude přiřazena zkratková klávesa control+alt+n, kterou můžete Aslan kdykoli spustit.

#### Zkopírovat nastavení z přenosné verze do aktuálního uživatelského účtu {#toc14}

Zde si můžete určit, jestli Aslan má nebo nemá zkopírovat nastavení právě spuštěné verze Aslan do nastavení instalované verze právě přihlášeného uživatele.
...
Pokud jste už zavřeli tento dialog nebo máte spuštěnou nainstalovanou verzi Aslan, vyberte položku vytvořit přenosnou kopii, která se nachází v nástrojích v nabídce Aslan.
...
## Začínáme s Aslan {#toc16}
### Spuštění Aslan {#toc17}

Když už máte nainstalovaný Aslan podle pokynů instalátoru, spustit Aslan je velmi jednoduché. Stačí stisknout klávesovou zkratku Ctrl+Alt+N nebo zvolit položku Aslan z nabídky Start/Programy/Aslan. 
Nvda můžete rovněž spustit vepsáním "aslan" do políčka spustit z nabídky start.

Pokud chcete spustit přenosnou verzi Aslan, vejděte do adresáře, kam jste si ji rozbalili, a na souboru Aslan.exe stiskněte Enter nebo na něj klikněte myší. 

Jakmile se Aslan spustí, ozve se úvodní znělka signalizující načítání Aslan.
V závislosti na tom, jak rychlý je váš počítač, nebo médium, z kterého Aslan spouštíte, může chvíli trvat, než se program načte.
Pokud spouštění trvá příliš dlouho, Aslan by měl ohlásit "Načítám, prosím, čekejte". 

Pokud se objeví chyba ohlášená zvukem Windows, nebo ozve-li se znělka signalizující ukončení Aslan, znamená to, že Aslan má problém při spouštění. Tuto chybu, prosím, ohlaste tvůrcům programu.
Informace o tom, jak chybu ohlásit, najdete na stránkách Aslan. 

Při prvním spuštění Aslan  se objeví uvítací dialog se základními informacemi o nabídce Aslan a o použití tzv. klávesy Aslan.
Více podrobností si můžete přečíst v následující kapitole.
Dále toto okno obsahuje dvě zaškrtávací políčka.
První políčko umožní zvolit, zda chcete používat capslock jako klávesu Aslan. Jestliže toto políčko není zaškrtnuté, pak jako klávesa Aslan bude použit Insert. Druhé zaškrtávací políčko umožňuje nastavit, zda se uvítací dialog má zobrazit po každém startu Aslan. 

### Klávesové zkratky {#toc18}
#### Klávesa Aslan {#toc19}

Většina klávesových zkratek Aslan je tvořena kombinací klávesy Aslan plus jedné či několika dalších kláves.
Výjimkou jsou příkazy pro pohyb čtecím kurzorem, pro které se používají klávesy numerického bloku. 

Aslan lze nastavit, aby se jako klávesa Aslan daly použít jak numerický a alfanumerický insert tak i capslock.

Implicitně jsou oba Inserty alfanumericky i numerický nastaveny jako klávesa Aslan.

Pozor! Mějte na paměti, že dvojitý stisk kterékoli z přednastavených kláves Aslan vyvolá původní funkci dané klávesy (např. přepnutí velkých písmen v případě klávesy capslock).

#### rozložení kláves {#toc20}

Aslan nyní obsahuje dva typy rozložení kláves.
Desktop pro práci se stolním pc a laptop pro práci na přenosném počítači. 
Implicitně je Aslan nastaven na rozložení desktop, což lze přepnout v dialogu Nastavení klávesnice, který se nachází v možnostech v nabídce Aslan.
...
### Dotyková gesta Aslan {#toc21}

Pokud používáte Aslan na zařízení s dotykovou obrazovkou a máte nainstalovaný systém Windows 8 a novější, můžete Aslan ovládat přímo pomocí dotykové obrazovky.
Pokud je Aslan spuštěn, všechny dotykové vstupy jsou na něj přesměrovány.
Proto některé akce, co jsou normálně dostupné bez Aslan, nelze provést.
...
Když budou později v této příručce popisovány příkazy Aslan, mohou obsahovat i dotyková gesta, kterými lze příkaz aktivovat na dotykové obrazovce.
...
Pokud se stejné klepnutí provede jednou nebo víckrát rychle za sebou, Aslan to rozpozná jako vícenásobné klepnutí.
...
Jelikož je více příkazů Aslan než dotykových gest, Aslan má několik dotykových režimů, mezi kterými můžete přepínat a které zpřístupňují určité podmnožiny příkazů.
...
Výukový režim spustíte stiskem kombinace kláves Aslan+1.
Vypnete jej opět použitím kombinace kláves Aslan+1. 
V případě stisku kombinace kláves nebo dotykového gesta, které představují jakýkoli příkaz programu Aslan, budou postupně přečteny názvy jednotlivých kláves a potom Aslan oznámí, o jaký příkaz se jedná.
Ve výukovém režimu se příkazy nespustí.

### Nabídka Aslan {#toc28}

Z nabídky programu Aslan můžete upravovat nastavení, přistupovat k nápovědě, znovu načítat či ukládat konfiguraci, upravovat řečové slovníky, přistupovat k dalším nástrojům a samozřejmě Aslan ukončit. 

Pro vyvolání nabídky Aslan lze kdekoli v systému Windows použít klávesovou zkratku Aslan+N nebo na dotykové obrazovce poklepat dvakrát dvěma prsty.
Tutéž nabídku je možné vyvolat též přes ikonu Aslan na systémové liště buď pravým tlačítkem myši,  nebo přechodem na systémovou lištu stiskem tlačítka Windows+B a zde šipkou dojet na ikonu Aslan a stisknout klávesu pro kontextové menu, která bývá na většině klávesnic umístěna vedle pravého Altu.
V případě, že klávesa pro vyvolání kontextové nabídky na klávesnici chybí, lze ji nahradit kombinací kláves Shift+F10.
Po zobrazení nabídky programu Aslan můžete použít horní a dolní šipku pro pohyb po položkách. Klávesou Enter danou volbu aktivujete.
...
|Nabídka Aslan |Aslan+n |Aslan+n |Dvojité klepnutí dvěma prsty |Zobrazí nabídku, ve které najdete položky pro nastavení, nástroje, nápovědu a další funkce programu Aslan.|
|Režim řeči |Aslan+s |Aslan+s |Žádný |Přepíná režim řeči mezi mluvení, pípání a vypnuto. Při vypnuté řeči je Aslan zticha, při pípání jsou hlášení nahrazena pípnutím a režim mluvení zajišťuje normální hlasovou odezvu.|
|Výukový režim |Aslan+1 |Aslan+1 |Žádný |Tento příkaz zapíná a vypíná výukový režim. V tomto režimu Aslan oznámí název jakékoli stisknuté klávesy. V případě stisku kombinace kláves, která představuje jakýkoli příkaz programu Aslan, budou postupně přečteny názvy jednotlivých kláves a potom Aslan oznámí, o jaký příkaz se jedná.|
|Ukončení Aslan |Aslan+q |Aslan+q |Žádný |Zde jsou dvě možnosti nastavení. Buď při stisku klávesy Aslan+q zazní znělka a program je ukončen, nebo se zobrazí dotaz, zda chceme Aslan ukončit. V obecném nastavení programu Aslan lze potvrzovací dialog před ukončením zapnout nebo vypnout.|
|Propuštění následující klávesy |Aslan+F2 |Aslan+F2 |Žádný |Další stisknutá klávesa nebude interpretována programem Aslan, ale bude předána ke zpracování ve Windows.|
|Režim spánku |Aslan+Shift+s |Aslan+Shift+z |Žádný |Režim spánku deaktivuje všechny klávesové zkratky a hlasový i braillský výstup v aktuálně spuštěné aplikaci. Toto je užitečné např. v samoozvučujících aplikacích, které sami poskytují některý z těchto výstupů. Opětovným stiskem klávesové zkratky režim spánku deaktivujete.|
...
|---|---|---|
|Datum a čas |Aslan+F12 |Oznámí aktuální čas. Stiskne-li se dvakrát rychle po sobě, bude ohlášeno aktuální datum.|
|Stav baterie |Aslan+Shift+b |Oznámí informace o stavu napájení. Buď oznámí stav nabití baterie v procentech, nebo oznámí napájení zapnuto. Je-li odpojeno napájení zesítě, potom kromě stavu baterie oznámí i zbývající čas provozu.|
|Přečti text ve schránce |Aslan+c |Pokud je ve schránce windows nějaký text, Aslan jej přečte. Neobsahuje-li schránka žádný text, Aslan to oznámí.|

<!-- KC:endInclude -->

## Pohyb s Aslan {#toc31}

Aslan nabízí uživateli několik způsobů pro pohyb v systému včetně klasické interakce a prohlížení.
...
Nejjednodušším způsobem pohybu v systému Windows s Aslan je použití obvyklých klávesových příkazů pro pohyb po ovládacích prvcích jako například: Tab a Shift+Tab pro pohyb po položkách, vyvolání panelu nabídek pomocí klávesy Alt, pohyby v nabídkách prostřednictvím kurzorových šipek či přepínání se mezi spuštěnými aplikacemi klávesami Alt+Tab. Při každém takovémto pohybu vám Aslan ohlásí, kde se nachází fokus, resp aktuálně zaměřený objekt. 
Když Aslan ohlašuje zaměřený objekt, je obvykle oznámeno jeho jméno, typ, stav, hodnota, popis, klávesová zkratka či informace o pozici objektu. Toto chování se od ostatních odečítačů příliš neliší, nicméně jména objektů se mírně lišit mohou. 
...
|---|---|---|---|
|Přečti fokus |Aslan+Tab |Aslan+Tab |ohlásí aktuálně zaměřený objekt, resp objekt, na kterém se nachází fokus. Stiskne-li se dvakrát rychle po sobě, informace bude vyhláskována.|
|Přečti titulek |Aslan+t |Aslan+t |Přečte titulek aktuálního aplikačního okna nebo okna v popředí. Stiskne-li se dvakrát rychle po sobě, titulek bude vyhláskován a trojitý stisk ho zkopíruje do schránky.|
|Přečti aktivní okno |Aslan+b |Aslan+b |Přečte obsah aktuálního okna v popředí. To může být užitečné např. při opětovném čtení informací v dialogových oknech.|
|Přečti stavový řádek |Aslan+End |Aslan+Shift+End |Přečte obsah stavového řádku aktuální aplikace, je-li dostupný. Tímto příkazem se ze stavového řádku stane prohlížený objekt.|
...
Aslan bude hlásit pohyb po znacích, slovech, řádcích, včetně označení a odoznačení textu. 

V souvislosti  s textovým kurzorem poskytuje Aslan následující klávesové zkratky:
<!-- KC:beginInclude -->

| Název |Klávesová zkratka pro desktop |Klávesová zkratka pro laptop |popis|
|---|---|---|---|
|Plynulé čtení |Aslan+šipka dolů |Aslan+a |V editačních polích a dokumentech přečte text od polohy textového kurzoru do konce, přičemž se textový kurzor plynule posouvá po řádcích.|
|Přečti aktuální řádek |Aslan+šipka nahoru |Aslan+l |V editačních polích a dokumentech přečte aktuální řádek pod textovým kurzorem. Stiskne-li se dvakrát rychle po sobě, řádek bude vyhláskován.|
|Přečti aktuální výběr |Aslan+Shift+šipka nahoru |Aslan+Shift+s |V editačních polích a dokumentech přečte označený text. Jestliže není označeno nic, Aslan to ohlásí.|
...
V těchto případech můžete využít objektovou navigaci Aslan.

Objektová navigace vám umožní pohyb  a získání informací o jednotlivých objektech.
Objekt zaměřený objektovou navigací oznámí Aslan podobně jako oznamuje systémový fokus.
...
| Název |Klávesová zkratka pro desktop |Klávesová zkratka pro laptop |Dotyk |Popis|
|---|---|---|---|---|
|aktuální prohlížený objekt |Aslan+numerická 5 |Aslan+Shift+o |Žádný |Ohlásí aktuální prohlížený objekt. Stiskne-li se dvakrát rychle po sobě, objekt bude vyhláskován a trojitý stisk ho zkopíruje do schránky.|
|Nadřazený objekt |Aslan+numerická 8 |Aslan+Shift+šipka nahoru |Švihnutí nahoru |Přejde o úroveň výš na nadřazený objekt právě prohlíženého objektu.|
|Předchozí objekt |Aslan+numerická 4 |Aslan+Shift+levá šipka |Švihnutí vlevo |Přejde na předchozí objekt od právě prohlíženého objektu.|
|Následující objekt |Aslan+numerická 6 |Aslan+Shift+pravá šipka |Švihnutí vpravo |Přejde na následující objekt od právě prohlíženého objektu.|
|Podřazený objekt |Aslan+numerická 2 |Aslan+Shift+šipka dolů |Švihnutí dolů |Přejde o úroveň níž na podřazený objekt právě prohlíženého objektu.|
|Prohlížený objekt na fokus |Aslan+numerické mínus |Aslan+Backspace |Žádný |Prohlíženým objektem se stane zaměřený objekt, neboli objekt, který má fokus a je-li zobrazen textový kurzor, pak na jeho pozici bude přemístěn i čtecí kurzor.|
|Předvolená akce |Aslan+numerický Enter |Aslan+Enter |Dvojité klepnutí |Provede výchozí akci právě prohlíženého objektu (např. je-li prohlíženým objektem tlačítko, tento příkaz simuluje stisk klávesy enter, či dvojklik)|
|Fokus nebo textový kurzor na pozici čtecího kurzoru |Aslan+Shift+numerické mínus |Aslan+Shift+Backspace |Žádný |Stiskne-li se jednou, nastaví fokus na prohlížený objekt, stiskne-li se dvakrát rychle za sebou, přesune textový kurzor na pozici čtecího kurzoru.|
|Poloha prohlíženého objektu |Aslan+numerická desetinná čárka |Aslan+Delete |Žádný |Ohlásí velikost a pozici prohlíženého objektu.|
...
Aslan umožňuje číst obsah [právě prohlíženého objektu](#ObjectNavigation), ale i obsah [plošného prohlížení](#FlatReview) po znacích, slovech nebo po řádcích.
...
| Název |Klávesová zkratka pro desktop |Klávesová zkratka pro laptop |Dotyk |Popis|
|---|---|---|---|---|
|Horní řádek |Shift+numerická 7 |Aslan+Ctrl+Home |Žádný |Přesune čtecí kurzor na horní řádek právě prohlíženého objektu.|
|Předchozí řádek |numerická 7 |Aslan+šipka nahoru |Švihnutí nahoru |Přesune čtecí kurzor na předchozí řádek právě prohlíženého objektu.|
|Aktuální řádek |numerická 8 |Aslan+Shift+tečka |Žádný |Přečte aktuální řádek, na němž se v rámci prohlíženého objektu nachází čtecí kurzor. Stiskne-li se dvakrát rychle po sobě, řádek bude vyhláskován a trojitý stisk ho vyhláskuje pomocí hláskovací tabulky.|
|Následující řádek |numerická 9 |Aslan+šipka dolů |Švihnutí dolů |Přesune čtecí kurzor na následující řádek právě prohlíženého objektu.|
|Spodní řádek |Shift+numerická 9 |Aslan+Ctrl+End |Žádný |Přesune čtecí kurzor na spodní řádek právě prohlíženého objektu.|
|Předchozí slovo |numerická 4 |Aslan+Ctrl+levá šipka |Švihnutí dvěma prsty vlevo |Přesune čtecí kurzor na předchozí slovo právě prohlíženého objektu.|
|Aktuální slovo |numerická 5 |Aslan+Ctrl+ tečka |Žádný |Přečte aktuální slovo, na němž se v rámci prohlíženého objektu nachází čtecí kurzor. Stiskne-li se dvakrát rychle po sobě, slovo bude vyhláskováno a trojitý stisk ho vyhláskuje pomocí hláskovací tabulky.|
|Následující slovo |numerická 6 |Aslan+Ctrl+pravá šipka |Švihnutí dvěma prsty vpravo |Přesune čtecí kurzor na následující slovo právě prohlíženého objektu.|
|Začátek řádku |Shift+numerická 1 |Aslan+Home |Žádný |Přesune čtecí kurzor na začátek aktuálního řádku v rámci prohlíženého objektu.|
|Předchozí znak |numerická 1 |Aslan+levá šipka |Švihnutí vlevo |Přesune čtecí kurzor na předchozí znak právě prohlíženého objektu.|
|Aktuální znak |numerická 2 |Aslan+tečka |Žádný |Přečte aktuální znak, na němž se v rámci prohlíženého objektu nachází čtecí kurzor. Stiskne-li se dvakrát za sebou, bude znak ohlášen pomocí hláskovací tabulky a trojitý stisk ohlásí jeho ascii a hexadecimální hodnotu.|
|Následující znak |numerická 3 |Aslan+pravá šipka |Švihnutí vpravo |Přesune čtecí kurzor na následující znak právě prohlíženého objektu.|
|Konec řádku |Shift+numerická 3 |Aslan+End |Žádný |Přesune čtecí kurzor na konec aktuálního řádku v rámci prohlíženého objektu.|
|Plynulé čtení čtecím kurzorem |numerické plus |Aslan+Shift+a |Švihnutí třemi prsty dolů |Přečte text od pozice čtecího kurzoru do konce, přičemž se čtecí kurzor plynule posouvá po řádcích.|
|nastav značku na pozici čtecího kurzoru |Aslan+F9 |Aslan+F9 |Žádný |Umístí značku na aktuální pozici čtecího kurzoru označující začátek úseku textu ke zkopírování.|
|Kopírování čtecím kurzorem |Aslan+F10 |Aslan+F10 |Žádný |Převezme text nacházející se mezi dříve umístěnou značkou a aktuální pozicí čtecího kurzoru včetně znaku na aktuální pozici a takto získaný úsek textu zkopíruje do schránky.|
|přečti formátování textu |Aslan+f |Aslan+f |Žádný |Ohlásí formátování textu na pozici čtecího kurzoru.|
...
|---|---|---|---|---|
|Přepnout do plošného prohlížení |Aslan+numerická 7 |Aslan+PageUp |Švihnutí dvěma prsty nahoru |Přepne se do plošného prohlížení na pozici, kde se nachází právě prohlížený objekt. Takto můžete začít prohlížet obsah obrazovky či dokumentu (jste-li zrovna uvnitř nějakého) pomocí příkazů pro prohlížení textu.|
|Přepnout na objektovou navigaci |Aslan+numerická 1 |Aslan+PageDown |Švihnutí dvěma prsty dolů |Zapne objektovou navigaci na pozici čtecího kurzoru v režimu plošného prohlížení. Je vyhledán objekt, jehož text právě čtete v režimu plošného prohlížení a čtecí kurzor je umístěn do tohoto objektu, aby bylo možno daný objekt prohlížet a pohybovat se po dalších objektech.|

<!-- KC:endInclude -->

### Navigace pomocí myši {#toc38}

Aslan je standardně nastaven tak, aby při pohybu myší ohlašoval objekty, na kterých se právě nachází ukazatel myši.
V některých případech přečte Aslan celý odstavec, v jiných situacích jen aktuální řádek textu.

Aslan je možné nastavit tak, že kromě textu bude ohlašovat i typ prvku, na kterém se nachází kurzor myši jako např. tlačítko, seznam, atd.
To může být užitečné pro zcela nevidomé uživatele, protože někdy jenom text nestačí.

Aslan uživateli nabízí i možnost akustické signalizace polohy myši na základě vzdálenosti od okrajů obrazovky.
...
Tyto funkce Aslan nejsou standardně zapnuty.
V dialogu [nastavení myši](#MouseSettings) se dají dodatečně aktivovat. 

Ačkoli se pro tenhle způsob navigace běžně používá trackpad nebo myš, Aslan poskytuje několik klávesových příkazů, které simulují některé její funkce.
<!-- KC:beginInclude -->

| Název |Klávesová zkratka pro desktop |Klávesová zkratka pro laptop |Popis|
|---|---|---|---|
|Levý klik |numerické lomeno |Aslan+[ |Klikne levým tlačítkem myši. Dvojkliku lze docílit dvojitým stiskem této klávesové zkratky.|
|Uzamknout levé tlačítko myši |Shift+numerické lomeno |Aslan+Ctrl+[ |Stiskne a uzamkne nebo opětovným stiskem uvolní levé tlačítko myši. Objekt přetáhnete tak, že stiskem této kombinace uzamknete (stisknete a podržíte) levé tlačítko myši, pak buď pohnete přímo myší, nebo použijete příkaz pro přesun ukazatele myši.|
|Pravý klik |numerická hvězdička |Aslan+] |Klikne pravým tlačítkem myši.|
|Uzamknout pravé tlačítko myši |Shift+numerická hvězdička |Aslan+Ctrl+] |Stiskne a uzamkne nebo opětovným stiskem uvolní pravé tlačítko myši. Objekt přetáhnete tak, že stiskem této kombinace uzamknete (stisknete a podržíte) pravé tlačítko myši, pak buď pohnete přímo myší, nebo použijete příkaz pro přesun ukazatele myši.|
|Myš na prohlížený objekt |Aslan+numerické lomeno |Aslan+Shift+m |Přesune kurzor myši na prohlížený objekt na pozici čtecího kurzoru.|
|Prohlížený objekt na myš |Aslan+numerická hvězdička |Aslan+Shift+n |Prohlíženým objektem se stane objekt pod kurzorem myši.|

<!-- KC:endInclude -->

## Režim prohlížení {#toc39}

Souhrnnější dokumenty jako jsou např. vebové stránky zobrazuje Aslan v TZV. režimu prohlížení. 
...
Jestliže v  režimu prohlížení kliknutím nebo stiskem klávesy Tab přejdete na jakýkoli formulářový prvek, Aslan automaticky aktivuje formulářový režim.
Naopak jestliže ve formulářovém režimu kliknutím nebo stiskem klávesy Tab přejdete na prvek, který formulářový režim nevyžaduje, Aslan se automaticky přepne do režimu prohlížení. 
...
Kromě toho si Přechod do formulářového režimu můžete také vynutit stiskem kombinace kláves Aslan+Mezerník, a v tomto případě zůstane formulářový režim zapnutý do té doby, než ho opětovným stiskem kláves Aslan+Mezerník nepřepnete do režimu prohlížení.

<!-- KC:beginInclude -->

| Název |Klávesová zkratka |Popis|
|---|---|---|
|Přepínání formulářového režimu a režimu prohlížení |Aslan+Mezerník |Přepíná mezi formulářovým režimem a režimem prohlížení|
...
|Obnovit obsah dokumentu v režimu prohlížení |Aslan+F5 |Obnoví obsah aktuálního dokumentu (užitečné, jestliže např. část dokumentu nebyla správně načtena)|
|Hledat |Aslan+Ctrl+F |Zobrazí dialog, ve kterém můžete zadat text pro vyhledávání v aktuálním dokumentu|
|Najít další |Aslan+F3 |Najde další výskyt textu, který byl předtím zadán při vyvolání dialogu hledat|
|Najít předchozí |Aslan+Shift+F3 |Najde předchozí výskyt textu, který byl předtím zadán při vyvolání dialogu hledat|
|dlouhý popis |Aslan+d |Otevře nové okno s dlouhým popisem pro prohlížený prvek, je-li k dispozici.|

<!-- KC:endInclude -->

### Příkazy rychlé navigace {#toc40}

V  režimu prohlížení Aslan podporuje jednoznakové příkazy pro rychlejší pohyb po prvcích obsažených v aktuálním dokumentu. 
...
Pokud se v dokumentu takový prvek objeví, Aslan ohlásí vnořený objekt, aplikaci nebo dialog.
...
| Název |Klávesová zkratka |Popis|
|---|---|---|
|Přejít do nadřazeného dokumentu |Aslan+Ctrl+Mezerník |Přemístí fokus z aktuálního vnořeného objektu do nadřazeného dokumentu, který tento objekt obsahuje|

<!-- KC:endInclude -->

## Příkazy Aslan specifické pro aplikace {#toc43}

Pro některé aplikace má Aslan k dispozici speciální příkazy pro usnadnění určitých úkolů nebo pokud nejsou funkce dostatečně dostupné pro uživatele odečítačů obrazovky.
...
| Název |Klávesová zkratka |Popis|
|---|---|---|
|Nastavení záhlaví sloupců |Aslan+shift+c |Jedním stisknutím informuje Aslan, že toto je řádek, který obsahuje záhlaví sloupců, která se mají oznamovat automaticky při pohybu mezi sloupci pod tímto řádkem. Dvojitým stiskem se nastavení zruší.|
|Nastavení záhlaví řádků |Aslan+shift+r |Jedním stisknutím informuje Aslan, že toto je sloupec, který obsahuje záhlaví řádků, která se mají oznamovat automaticky při pohybu mezi řádky za tímto sloupcem. Dvojitým stiskem se nastavení zruší.|
...
| Název |Klávesová zkratka |Popis|
|---|---|---|
|Poslední zpráva |Aslan+ctrl+1-4 |Přečte jednu z posledních zpráv podle toho, které číslo stisknete; např. Aslan+control+2 přečte předposlední zprávu.|
...
## Nastavení Aslan {#toc48}
### Nabídka možnosti {#toc49}

<!-- KC:settingsSection: || Název | Klávesová zkratka pro desktop | Klávesová zkratka pro laptop | Popis | -->
Většinu nastavení Aslan je možné měnit přímo v dialogových oknech dostupných z podnabídky Možnosti v nabídce Aslan.
...
#### Obecné nastavení (Aslan+Ctrl+G) {#toc50}
...
Jedná se o seznam umožňující výběr jazyku rozhraní a zpráv programu. Jsou zde obsaženy veškeré jazyky, do kterých byl doposud program Aslan přeložen. Implicitně je Aslan přednastaven tak, aby si zvolil jazyk podle nastavení vašeho operačního systému. K tomu slouží poslední položka v seznamu jazyků nazvaná Windows.

Při změně jazyka si Aslan vyžádá restart programu. Po potvrzení se Aslan ukončí a spustí se ve vámi zvoleném jazyce. 

##### Uložit nastavení při ukončení {#toc52}

Zaškrtnete-li tuto volbu, Aslan vždy při ukončení automaticky uloží aktuální nastavení. 

##### Upozornit před ukončením Aslan {#toc53}

Je-li tato volba zaškrtnuta, Aslan se vás před každým ukončením programu zeptá, zda jej chcete opravdu ukončit. 

##### Úroveň logování {#toc54}

Rozbalovací seznam, který uživateli umožňuje zvolit, jaké množství informací má Aslan zaznamenat v době, kdy je spuštěn. Jedná se  o informace obsahující např. případná chybová hlášení Aslan, informace o korektním běhu programu atd. Většinou se uživatel tímto nastavením nemusí zabývat, nicméně chcete-li např. poskytnout informace vývojářům programu o chybových hlášeních, je nastavení této volby na vyšší úroveň jednoznačně lepší. 

##### Automaticky spustit Aslan po přihlášení do systému {#toc55}

Pokud je tato volba zaškrtnutá, Aslan se automaticky spustí, jakmile se přihlásíte do Windows. Pozor! Tato volba je dostupná jen v instalační verzi aslan a nemůže být tudíž použita při spuštěné přenosné verzi Aslan.

##### Spouštět Aslan při zobrazení přihlašovací obrazovky (vyžaduje administrátorská oprávnění) {#toc56}

Jestliže se do Windows přihlašujete zadáním vašeho uživatelského jména a hesla, zaškrtnutím této volby zajistíte, aby se Aslan spustil již při zobrazení přihlašovací obrazovky do systému. Pozor! Tato volba je dostupná jen v instalační verzi aslan a nemůže být tudíž použita při spuštěné přenosné verzi Aslan.

##### Použít aktuální nastavení Aslan pro přihlašovací a další zabezpečené obrazovky (vyžaduje administrátorská oprávnění) {#toc57}

Po stisku tohoto tlačítka Aslan zkopíruje aktuální konfiguraci do systémové složky, aby mohla být použita v případě, že je Aslan spuštěn na přihlašovací nebo na jiných zabezpečených obrazovkách systému.
Chcete-li se ujistit, že budou správně překopírována veškerá nastavení, můžete uložit aktuální nastavení stiskem kombinace kláves Aslan+Ctrl+C nebo můžete použít volbu Uložit nastavení z nabídky Aslan. Pozor! Tato volba je dostupná jen v instalační verzi aslan a nemůže být tudíž použita při spuštěné přenosné verzi Aslan.

#### Výběr hlasového výstupu (Aslan+Ctrl+S) {#toc58}

Položku hlasové výstupy najdete v nabídce Možnosti. Po aktivování je možné vybrat, který hlasový výstup bude Aslan používat. 
...
V tomto rozbalovacím seznamu můžete nastavit hlasový výstup, který bude Aslan používat pro syntézu řeči.

Seznam podporovaných hlasových výstupů naleznete v kapitole [Podporované hlasové výstupy](#SupportedSpeechSynths).

Mezi hlasovými výstupy najdete i položku bez mluvení, která umožňuje používat Aslan úplně bez hlasového výstupu.
To může být užitečné v případě, že chcete používat Aslan jen z braillským řádkem nebo se to může hodit vidícím vývojářům, kteří chtějí používat zobrazovač řeči.

##### Výstupní zařízení {#toc60}

zde si můžete vybrat zvukovou kartu, kterou bude Aslan používat jak pro přehrávání zvuků, tak pro hlasový výstup.

#### Nastavení hlasu (Aslan+Ctrl+V) {#VoiceSettings}
...
Zaškrtnutím této volby zajistíte, aby Aslan u každého velkého písmene při psaní či při pohybu po znacích stoupl v intonaci. Jedná se o alternativu v kontrastu se standardním ohlašováním velkých písmen např. velké A, velké B, velké C apod. viz následující. 

##### Ohlásit velké písmeno slovem "velké" {#toc71}

Chcete-li nechat ohlásit velké písmeno slovem Velké, jenž bude předcházet vlastní písmeno, zaškrtněte toto políčko. Toto chování se uplatní při pohybu po znacích nebo při psaní. Aslan obvykle při velkém písmenu poněkud zvedne výšku hlasu, ale některé hlasové výstupy nemusejí na tento povel reagovat a pak může být tato možnost užitečná. 

##### Pípat před hláskováním velkých písmen {#toc72}

Je-li tato volba zaškrtnuta, Aslan před každým velkým písmenem v textu či při psaní krátce pípne. Tak jako možnost ohlašování velkého písmena slovem velké je tato volba důležitá u hlasových výstupů, které mají potíže se změnou výšky intonace u velkých písmen. 
...
Jestliže chcete změnit některé parametry hlasu, aniž byste museli vyvolávat dialog pro nastavení hlasu, můžete použít některé z klávesových zkratek dostupných kdekoli v systému při běhu Aslan.
<!-- KC:beginInclude -->

| Název |Klávesová zkratka pro desktop + Klávesová zkratka pro laptop |Popis|
|---|---|---|
|následující hlasový parametr |Aslan+Ctrl+šipka vpravo |Aslan+Shift+Ctrl+šipka vpravo |Přesune se na následující parametr v kruhu nastavení hlasového výstupu a oznámí jej. Z posledního parametru se Aslan automaticky přesune na první hlasový parametr.|
|předchozí hlasový parametr |Aslan+Ctrl+šipka vlevo |Aslan+Shift+Ctrl+šipka vlevo |Přesune se na předchozí parametr v kruhu nastavení hlasového výstupu a oznámí jej. Z prvního parametru se Aslan automaticky přesune na poslední hlasový parametr.|
|Zvýšit hodnotu hlasového parametru |Aslan+Ctrl+šipka nahoru |Aslan+Shift+Ctrl+šipka nahoru |Zvyšuje hodnotu aktuálně zvoleného parametru v kruhu nastavení hlasového výstupu. např. zrychlí tempo, vybere následující hlas, zesílí hlasitost|
|Snížit hodnotu hlasového parametru |Aslan+Ctrl+šipka dolů |Aslan+Shift+Ctrl+šipka dolů |snižuje hodnotu aktuálně zvoleného parametru v kruhu nastavení hlasového výstupu. např. zpomalí tempo, vybere předchozí hlas, zeslabí hlasitost|
...
Klávesová zkratka: Aslan+Ctrl+T
...
#### Nastavení klávesnice (Aslan+Ctrl+K) {#toc82}
...
##### Použít Caps Lock jako Aslan klávesu {#toc84}

Pokud je toto políčko zaškrtnuté, můžete Caps Lock použít jako Aslan klávesu. 

##### Použít numerický Insert jako Aslan klávesu {#toc85}

Pokud je toto políčko zaškrtnuté, můžete numerický Insert použít jako Aslan klávesu. 

##### Použít Insert jako Aslan klávesu {#toc86}

Pokud je toto políčko zaškrtnuté, můžete klávesu Insert použít jako Aslan klávesu. 

<!-- KC:setting -->

##### Hlásit psané znaky {#toc87}

Klávesová zkratka: Aslan+2
...
#### Nastavení myši (Aslan+Ctrl+M) {#toc91}
...
Zaškrtnutí tohoto políčka zajistí, že Aslan bude oznamovat tvar kurzoru myši vždy, když se změní. Změnou tvaru myši informuje systém mimo jiné o tom, že text je upravitelný, že se něco načítá atd. 

<!-- KC:setting -->

##### Oznamovat text pod kurzorem myši {#toc93}

|Klávesová zkratka pro desktop |Aslan+M|
|Klávesová zkratka pro laptop |Aslan+M|

Je-li tato volba zapnutá, Aslan bude oznamovat text, který se aktuálně nachází pod kurzorem myši. Takto můžete najít položky na obrazovce za pomoci myši a nemusíte použít objektovou navigaci. 
...
Je-li tato volba zaškrtnutá, Aslan bude ohlašovat typ objektu při přechodu myší přes něj. 

##### Pohyb myši indikovat zvukovým signálem {#toc96}

Při zaškrtnutí této volby bude Aslan signalizovat pohyb myši krátkým pípáním. Uživatel tedy bude mít celkové povědomí o aktuální pozici myši. 
...
|Klávesová zkratka pro desktop |Aslan+7|
|Klávesová zkratka pro laptop |Aslan+7|
...
Jestliže je tato volba zapnutá, Aslan bude filtrovat hierarchii zobrazených objektů tak, že vynechá nepoužitelné objekty.

#### Prezentace objektů (Aslan+Ctrl+O) {#toc103}

Tuto položku najdete v nabídce možnosti a obsahuje následující prvky:

##### Hlásit kontextovou nápovědu {#toc104}

Zaškrtnutí tohoto políčka zajistí, že  Aslan bude číst obsah kontextové nápovědy, je-li k dispozici. Řada oken a ovládacích prvků vyvolá malou textovou nápovědu, jestliže se nad ně přesune kurzor myši, nebo když se na ně přesune fokus. 

##### Hlásit obsah bublinové nápovědy {#toc105}

Při zaškrtnutí tohoto políčka bude Aslan ohlašovat obsah bublinové nápovědy, která se objeví na obrazovce. Bublinová nápověda je podobná kontextovým popiskům, ale plocha bubliny je obvykle větší a tato nápověda se používá vesměs pro sdělování systémových událostí jako je např. odpojení síťového kabelu, nalezení nového hardwaru, objevení se problémů se zabezpečením systému atd. 

##### Hlásit přístupové klávesy k objektům {#toc106}

Pokud je toto zaškrtávací políčko zaškrtnuto, Aslan bude ohlašovat klávesové zkratky, které jsou vázány k různým příkazům a objektům. Například: nabídka Soubor má přístupovou klávesu Alt+S, takže součástí informace při ohlášení nabídky bude i tato klávesová zkratka. 
...
Pokud je zaškrtnutá volba hlásit pozici objektu, pak toto nastavení umožňuje Aslan odhadnout pozici aktuálně zaměřeného objektu, není-li informace o pozici standardně dostupná.
Jestliže je toto políčko zaškrtnuté, Aslan bude ohlašovat informace o pozici pro větší množství  prvků jako jsou např. položky v nabídkách či panely nástrojů, i když tyto informace nemusí být vždy úplně přesné.
...
|Klávesová zkratka pro desktop |Aslan+U|
|Klávesová zkratka pro laptop |Aslan+u|
...
* Ohlašovat: Tato volba zajistí ohlašování hodnoty indikátoru průběhu v procentech. Vždy, když se hodnota změní, Aslan tuto změnu ohlásí.
* Pípat: Tato volba zajistí, že při každé změně indikátoru průběhu Aslan krátce pípne. Čím je tón pípání vyšší, tím vyšší je počet procent na indikátoru průběhu a  právě probíhající akce se blíží ke konci.
...
Pokud je tato volba zaškrtnuta, Aslan bude sledovat i průběh indikátorů, které nejsou zobrazeny v okně v popředí. Znamená to, že když minimalizujete okno, v němž je zobrazen indikátor průběhu, můžete dělat cokoli dalšího a Aslan bude i nadále sledovat aktualizaci tohoto průběhu a dle vámi zvoleného nastavení ji bude ohlašovat. 

Pozn. Pokud máte způsob ohlašování indikátoru průběhu nastaven na ohlašovat, Aslan bude u indikátorů průběhu na pozadí ohlašovat každých 10 procent, nikoli každé další procento.

<!-- KC:setting -->

##### Hlásit dynamicky měněný obsah {#toc111}

Klávesová zkratka: Aslan+5

Přepíná automatické ohlašování obsahu některých objektů jako např. terminály či příchozí text v chatovacích programech.

#### Nastavení režimu prohlížení (Aslan+Ctrl+B) {#toc112}
...
Jestliže je tato volba zaškrtnutá, Aslan bude přepínat mezi formulářovým režimem a režimem prohlížení při pohybu kurzorovými šipkami. Např. jestliže se při prohlížení webové stránky pod kurzorem objeví editační políčko, Aslan automaticky aktivuje formulářový režim a je tedy možné do políčka psát či libovolně upravovat jeho obsah. Pokud budete šipkou pokračovat v prohlížení stránky a kurzor opustí dané políčko, aktivuje se opět režim prohlížení. 

##### Zvuková indikace formulářového režimu a režimu prohlížení {#toc120}

Pokud je tato volba zaškrtnuta, Aslan bude přepínání mezi formulářovým režimem a režimem prohlížení signalizovat krátkými zvukovými návěstími. 

#### Ohlašování formátování dokumentu (Aslan+Ctrl+D) {#DocumentFormattingSettings}

Toto dialogové okno najdete v možnostech programu Aslan pod stejnojmenným názvem.

Téměř všechna zaškrtávací políčka slouží k nastavení ohlašování formátování, jehož změny mají být oznamovány při pohybu kurzorem v dokumentech či na webových stránkách. Jestliže např.  zaškrtnete ohlašování názvu písma, tak jakmile se při prohlížení jakéhokoli textu zobrazí jiný typ písma, Aslan danou změnu ohlásí.
...
Jestliže je tato volba zapnutá, Aslan se pokusí detekovat změny formátování na celém řádku a při čtení je všechny oznámí, i když to může do jisté míry negativně ovlyvnit výkonnost Aslan.

Implicitně Aslan detekuje formátování na pozici textového či čtecího kurzoru a volitelně může detekovat formátování na celém aktuálním řádku, pokud to nezpůsobí příliž velké spomalení.
...
Podnabídka Řečové slovníky, která se nachází v nabídce Možnosti, obsahuje tři různé typy uživatelských slovníků, ve kterých lze nastavit, jak má Aslan vyslovovat konkrétní slova, či fráze. 

* Výchozí slovník: Výrazy uložené v tomto slovníku ovlivní veškeré řečové projevy Aslan.
* Slovník pro aktuální hlas: Výrazy uložené v tomto slovníku ovlivní veškeré řečové projevy aktuálně používaného hlasu.
* Dočasný slovník: Výrazy uložené v tomto slovníku ovlivní veškeré řečové projevy Aslan, ale jen dočasně. Po ukončení Aslan bude obsah slovníku vymazán.
...
Pravidla pro řečové slovníky Aslan vám umožní změnit jakýkoli řetězec znaků na zcela odlišný řetězec.
Představte si, že např. chcete, aby Aslan řekl slovo "žába" vždy, když se v textu objeví slovo "pták".
...
Řečové slovníky Aslan toho dokáží mnohem víc, než jen zaměňovat slova.
Dialog pro přidání položky do slovníku obsahuje zaškrtávací políčko Rozlišovat velká a malá písmena, kterým můžete Aslan donutit rozlišovat, jestli text je a nebo není napsaný velkými písmeny.
Standardně Aslan velikost písmen ignoruje.
...
V tomto dialogu můžete měnit nejen výslovnost interpunkčních a dalších speciálních znaků, ale i úroveň vyslovování interpunkce, při které bude Aslan tyto znaky číst.
...
Aslan automaticky vaše nastavení neukládá, takže pokud ukončíte program a pak ho znovu spustíte, nastavení se vrátí do původních hodnot. Pokud chcete, aby Aslan nastavení automaticky ukládal, zaškrtněte příslušnou položku v dialogu Obecné nastavení.
Pro uložení nastavení Aslan můžete rovněž použít položku uložit nastavení v nabídce Aslan.

Jestliže  je Aslan spuštěn z média, které má atribut "jen pro čtení" jako např. CD, nebude možné vaše nastavení uložit a o této skutečnosti vás program bude informovat. 

Pokud jste při nastavování programu udělali chybu a potřebujete se vrátit k uložené konfiguraci, můžete využít možnost znovu načíst nastavení, kterou najdete přímo v nabídce Aslan.
...
| Název |Klávesová zkratka pro desktop + Klávesová zkratka pro laptop |Popis|
|---|---|---|
|Uložit nastavení |Aslan+Ctrl+c |Aslan+Ctrl+c |Uloží aktuální nastavení Aslan tak, aby se při ukončení Aslan neztratila|
|Načíst uložené nastavení |Aslan+Ctrl+r |Aslan+Ctrl+r |Načte naposledy uložené nastavení programu Aslan|

<!-- KC:endInclude -->

++ Konfigurační soubory a uživatelské profily ++Qig, kterou najdete ve složce přenosné verze Aslan.

Instalační verze Aslan si všechna nastavení, vlastní aplikační moduly či ovladače hlasových a braillských výstupů ukládá do složky Aslan, kterou najdete v uživatelském profilu systému windows. To znamená, že každý uživatel systému může mít své vlastní nastavení Aslan.
Složku s Vaším nastavením Aslan můžete otevřít např. pomocí zástupce, který se nachází v nabídce start, v  podnabídce programy, ve složce Aslan.

Nastavení, která se použijí v případě, že Aslan běží na přihlašovací nebo jiné zabezpečené obrazovce jsou uložena ve složce systemConfig, která je podsložkou instalačního adresáře Aslan.
Běžně není nutné do této složky zasahovat.
Jestliže chcete změnit konfiguraci Aslan pro přihlašovací obrazovku, přihlašte se do systému windows, nastavte si Aslan podle vašich představ, konfiguraci si uložte a potom pomocí tlačítka v dialogu Obecné nastavení ji zkopírujte na přihlašovací obrazovku.

## Další nástroje {#toc126}
### Zobrazit log {#toc127}

Prohlížeč logu, který je možné spustit z nabídky nástroje, Vám umožní zobrazit veškerý zápis do log souboru, který se zaznamenal od posledního spuštění Aslan.
...
Pro vidící vývojáře software nebo pro lidi, kteří představují Aslan vidícím zájemcům, existuje plovoucí okno, které zobrazuje veškerý text, jenž Aslan posílá hlasovému výstupu.
...
Python konzole programu Aslan, dostupná z nabídky nástroje, je nástroj určený především pro vývojáře, který umožňuje kontrolovat správnost běhu Aslan, zjišťovat stav vnitřních proměnných Aslan a také zkoumat hierarchii přístupnosti aplikací.
Pro více informací si, prosím, přečtěte [článek Python konzole (anglicky) na stránce Aslan](Aslan_URLwiki/PythonConsole).

### Znovu načíst zásuvné moduly {#toc130}

Tato položka aktivuje znovu načtení zásuvných a aplikačních modulů bez nutnosti restartovat Aslan. To může být užitečné pro vývojáře..

## Podporované hlasové výstupy {#SupportedSpeechSynths}

Tato kapitola obsahuje informace o hlasových výstupech podporovaných programem Aslan.

### eSpeak {#toc132}

Hlasový výstup [eSpeak](https://espeak.sourceforge.net/) je vestavěný přímo v programu Aslan a nepožaduje žádné speciální ovladače nebo jiné komponenty, které by se musely doinstalovávat.
Standardně se Aslan spouští s hlasovým výstupem eSpeak.
Tento hlasový výstup  by měl fungovat v každém systému, kde pracuje Aslan, což znamená, že Aslan můžete spouštět na libovoľném počítači, dokonce i z USB klíčenky nebo CD.
...
Aby jej bylo možné používat s Aslan, musí být tento hlasový výstup nainstalovaný v systému.
...
Tento hlasový výstup můžete stáhnout v sekci ke stažení na stránkách ruské komunity Aslan: https://ru.aslan-community.org/?page_id=10.

## Podporované braillské řádky {#SupportedBrailleDisplays}

Tato kapitola obsahuje informace o braillských řádcích podporovaných programem Aslan..

### Řádky Focus/PAC Mate společnosti Freedom Scientific {#toc138}

Aslan podporuje všechny braillské řádky Focus a PAC Mate společnosti [Freedom Scientific](https://www.freedomscientific.com/).
...
Aslan podporuje oba řádky [Optelec](https://www.optelec.com/), jak ALVA BC640 tak BC680.
Pro použití těchto řádků se nemusí instalovat žádné ovladače.
Stačí řádek zapojit a nastavit Aslan na jeho používání.

### Braillské řádky společnosti Handy Tech {#toc140}

Aslan podporuje všechny braillské řádky společnosti [Handy Tech](https://www.handytech.de/).
Pro některé starší USB řádky je nutné do systému doinstalovat USB ovladače Handy Tech.

### MDV Lilli {#toc141}

Braillský řádek Lilli od [MDV](https://www.mdvbologna.it/) je programem Aslan plně podporovaný.
Pro použití tohoto řádku se nemusí instalovat žádné ovladače.
Stačí řádek zapojit a nastavit Aslan na jeho používání.

### Braillské řádky Baum/Humanware/APH {#toc142}

Aslan podporuje některé řádky od [Baum](https://www.baum.de/cms/en/), [HumanWare](https://www.humanware.com/) a [APH](https://www.aph.org/) připojené přez USB nebo bluetooth.
...
Uživatelé si mohou vytvořit vlastní nebo pozměnit existující konfiguraci klávesových příkazů Aslan a to úpravou speciálně k tomu určeného souboru ve složce s uživatelským nastavením.
...
Každá sekce obsahuje mapování vstupních příkazů na skripty v jednom python modulu a třídě Aslan.
...
Zde je příklad, který vysvětluje, jak můžete příkaz Aslan+Shift+T přiřadit skriptu datum a čas.

Abyste zjistili správný název skriptu, název třídy a modulu, spustíte výukový režim stiskem Aslan+1 a potom stisknete Aslan+F12, protože to je nynější příkaz pro skript datum a čas.
Potom opětovným stiskem Aslan+1 vypnete výukový režim a přečtete si poslední řádky v okně prohlížeče logu.
...
Pokud tento soubor ještě neexistuje, vytvořte ve složce s uživatelským nastavením Aslan soubor gestures.ini s následujícím obsahem:

    [globalCommands.GlobalCommands]
    	dateTime = kb:Aslan+shift+t

Takto přiřadíte klávesový příkaz Aslan+Shift+T skriptu dateTime ve všech rozloženích klávesnice.

Všimněte si, že původní přiřazená klávesová zkratka Aslan+F12 bude stále funkční.
...
Aslan posílá stisk modifikačních kláves jako je Ctrl, Shift a Alt operačnímu systému i v případě, že jsou namapované na nějaký skript programu Aslan. Jestliže tedy použijete ve vstupním příkazu klávesu alt, může jeho stisk kromě vyvolání požadovaného skriptu Aslan rovněž zobrazit panel nabídek.
Proto je jako modifikátory vhodné používat zejména klávesy Aslan, ctrl a shift.

## Jak získat více informací {#toc146}

Protože se Aslan neustále vyvíjí, není možné zajistit funkčnost všech klávesových příkazů a postupů tak, jak jsou popsány v této příručce.
Jestliže  se vyskytnou problémy s některými zde popsanými příkazy, navštivte, prosím, webovou stránku programu Aslan a zkuste vyhledat aktuální informace. 

Hledáte-li další informace o Aslan, o jeho vývoji nebo hledáte-li pomoc, můžete rovněž navštívit stránku projektu na adrese Aslan_URL.
Na této stránce můžete rovněž najít přístup k emailovým konferencím pojednávajících o Aslan a odkazy na další komunitní projekty a stránky o Aslan.
