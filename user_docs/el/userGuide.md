# Aslan Aslan_VERSION Εγχειρίδιο Χρήσης

[TOC]

<!-- KC:title: Aslan Aslan_VERSION Γρήγορη Αναφορά Εντολών Πληκτρολογίου -->



## Εισαγωγή {#toc2}

Το NonVisual Desktop Access (Aslan) είναι ένας αναγνώστης οθόνης ανοικτού κώδικα για τα λειτουργικά συστήματα Microsoft Windows, ο οποίος διατίθεται δωρεάν.
...
Το Aslan αναπτύσσεται από την [NV Access](https://www.nvaccess.org/), με τη συμμετοχή της κοινότητας.

### Γενικά Χαρακτηριστικά {#toc3}

Το Aslan επιτρέπει στους τυφλούς και τους μερικώς βλέποντες να έχουν πρόσβαση και να αλληλεπιδρούν με τα λειτουργικά συστήματα των Windows και πολλές εφαρμογές τρίτων κατασκευαστών.
...
Εκτός από τα Αγγλικά, το aslan έχει μεταφραστεί σε 47 γλώσσες που συμπεριλαμβάνουν: Τα Αφρικανικά, αλβανικά, Αμαρικά, αραβικά,  Αραγονίκά, Πορτογαλικά Βραζιλίας, Βουλγαρικά, Καταλανικά, Ισπανικά Κολομβίας, κροατικά, τσεχικά, δανικά, ολλανδικά, περσικά, Φινλανδικά, Γαλλικά, Γαλικιανά, ελληνικά, γεωργιανά, Γερμανικά, Εβραϊκά, Χίντι, Ουγγρικά, Ισλανδικά, Ιρλανδικά, Ιταλικά, Ιαπωνικά, Κορεατικά, Νεπάλ, Νορβηγικά, Πολωνικά, Πορτογαλικά, Παντζάμπι, ρουμανικά, ρωσικά, σερβικά, σλοβακικά, σλοβενικά, ισπανικά, σουηδικά, Ταμίλ, Ταϊλανδέζικα, Παραδοσιακά και Απλοποιημένα κινέζικα, Τουρκικά, Ουκρανικά και Βιετναμέζικα.

### Υποστήριξη συνθετών φωνής {#toc5}

Εκτός από το γεγονός πως το aslan παρέχει τα μηνύματα του καθώς και το περιβάλλον χρήσης του σε διάφορες γλώσσες, το aslan επίσης μπορεί να βοηθήσει τον χρήστη να διαβάσει περιεχόμενο σε οποιαδήποτε γλώσσα, φτάνει ο χρήστης να διαθέτει ένα συνθέτη φωνής που να μπορεί να μιλήσει την συγκεκριμένη γλώσσα.

Το aslan έρχεται ενσωματωμένο με το [eSpeak](https://espeak.sourceforge.net/), έναν δωρεάν, ανοιχτού κώδικα, πολύγλωσσο συνθέτη φωνής.

Πληροφορίες για άλλους συνθέτες φωνής που υποστηρίζει το aslan μπορείτε να βρείτε στο κεφάλαιο [Υποστηριζόμενοι Συνθέτες φωνής](#SupportedSpeechSynths).

### Υποστήριξη braille {#toc6}

Για χρήστες που διαθέτουν κάποια οθόνη braille, το aslan μπορεί να  εξάγει όλες του τις πληροφορίες σε μορφή braille.
Για περισσότερες πληροφορίες μπορείτε να δείτε το κεφάλεο [υποστηριζόμενες οθόνες braille](#SupportedBrailleDisplays).

Το aslan υποστηρίζει κώδικες braille σε διάφορες γλώσσες, που συμπεριλαμβάνου braille με συντομεύσεις, braille χωρίς συντομεύσεις και braille για υπολογιστές.

### άδεια και δικαιώματα χρήσης {#toc7}

Το aslan είναι aslan copyright Aslan_COPYRIGHT_YEARS και σε όσους συμβάλουν στην ανάπτυξη του.

Το aslan καλύπτεται από την άδεια GNU General Public License (έκδοση 2).
 ...
 * Για τα Windows XP 32-bit, το aslan χρειάζεται το Service Pack 2 ή νεότερο.
 * Για τα Windows Server 2003, το aslan χρειάζεται το Service Pack 1 ή νεότερο.
* Μνήμη: 256 MB ή περισσότερη RAM
* Ταχύτητα επεξεργαστή: 1.0 ghz ή παραπάνω
* Περίπου 50 MB αποθηκευτικού χώρου.

## Λήψη και Διαμόρφωση του Aslan {#toc9}

Αν δεν έχετε ακόμα στη κατοχή σας ένα αντίγραφο του Aslan, μπορείτε να το κατεβάσετε από το [www.nvaccess.org](Aslan_URL).

Πηγαίνετε στην περιοχή download και ακολουθήστε το σύνδεσμο που θα βρείτε για να κατεβάσετε την τελευταία έκδοση του Aslan.

Εάν εκτελέσετε το αρχείο που μόλις κατεβάσατε, θα ξεκινήσει η εκτέλεση ενός προσωρινού αντίγραφου του Aslan.
Στη συνέχεια θα ερωτηθείτε αν θέλετε να εγκαταστήσετε το Aslan, να δημιουργήσετε ένα φορητό αντίγραφο ή αν θέλετε απλώς να συνεχίσετε να χρησιμοποιείτε το προσωρινό  αντίγραφο.

Για να χρησιμοποιείτε πάντα το Aslan σε αυτόν τον υπολογιστή, επιλέξτε την εγκατάσταση του Aslan.
Η εγκατάσταση του Aslan θα σας επιτρέψει να έχετε πρόσθετες λειτουργίες όπως η αυτόματη εκκίνηση του μετά την είσοδο στα Windows, η δυνατότητα να σας διαβάζει τις οθόνες της εισόδου στα Windows και άλλες οθόνες ασφαλείας των Windows (που δεν μπορεί να γίνει με το φορητό και το προσωρινό αντίγραφο), και η δημιουργία συντομεύσεων στο μενού Έναρξη και στην επιφάνεια εργασίας.
Επίσης, το εγκατεστημένο αντίγραφο του Aslan έχει τη δυνατότητα να δημιουργεί το ίδιο ανά πάσα στιγμή ένα φορητό αντίγραφο.

Αν θέλετε να πάρετε το Aslan μαζί σας σε ένα δίσκο USB ή άλλο μέσο ανάγνωσης, τότε επιλέξτε τη δημιουργία ενός φορητού αντίγραφου.
...
Ωστόσο, αν θέλετε να αντιγράψετε το Aslan σε ένα μέσο που είναι μόνο για ανάγνωση, όπως ένα CD, τότε πρέπει απλά να αντιγράψετε το πακέτο που κατεβάσατε.
Η εκτέλεση της φορητής έκδοσης απευθείας από μέσο μόνο για ανάγνωση δεν υποστηρίζεται προς το παρόν.

Η χρήση του προσωρινού αντίγραφου του Aslan είναι επίσης μία επιλογή (π.χ. για σκοπούς επίδειξης), αν και η εκκίνηση του Aslan κάθε φορά με αυτό τον τρόπο μπορεί να γίνει πολύ χρονοβόρα.

### Περιορισμοί του φορητού και του προσωρινού αντίγραφου {#toc10}

Εκτός από το γεγονός πως δεν μπορούν να ξεκινήσουν αυτόματα κατά την διάρκεια ή μετά την οθόνη εισόδου των windows, το φορητό και το προσωρινό αντίγραφο του aslan έχουν τους ακόλουθους περιορισμούς:

* την αδυναμία να συνεργαστούν με εφαρμογές που τρέχουν με δικαιώματα διαχειριστή, εκτός και αν το aslan τρέχει με τα ίδια δικαιώματα (Κάτι που δεν συστήνεται).
...
### Εγκατάσταση του Aslan {#toc11}

Αν εγκαταστήσετε το Aslan απευθείας από το πακέτο που έχετε κατεβάσει, πατήστε το κουμπί Εγκατάσταση του Aslan.
Αν έχετε ήδη κλείσει αυτό το παράθυρο διαλόγου ή αν θέλετε να εγκαταστήσετε το Aslan από ένα φορητό αντίγραφο του, παρακαλώ επιλέξτε Εγκατάσταση του Aslan από το μενού που βρίσκεται κάτω από τα Εργαλεία στο μενού του Aslan.

Το παράθυρο διαλόγου της εγκατάστασης που θα εμφανιστεί θα επιβεβαιώσει αν θέλετε να εγκαταστήσετε το Aslan και επίσης θα σας αναφέρει αν αυτή η εγκατάσταση πρόκειται να ενημερώσει μία προηγούμενη εγκατάσταση.
Πατώντας το κουμπί Συνέχεια ξεκινάει η εγκατάσταση του Aslan.
...
Πατώντας OK σε αυτό το σημείο, θα οδηγήσει σε επανεκκίνηση του νέου εγκατεστημένου αντιγράφου του Aslan.

#### Εκκίνηση στην Είσοδο των Windows (Windows Logon) {#toc12}

Αυτή η επιλογή σας επιτρέπει να επιλέξετε εάν το Aslan θα ξεκινάει αυτόματα στην οθόνη Εισόδου στα Windows, πριν σας ζητηθεί να πληκτρολογήσετε το συνθηματικό σας (password).
...
Αυτή η επιλογή σας επιτρέπει να επιλέξετε εάν το Aslan θα δημιουργήσει μία συντόμευση στην επιφάνεια εργασίας για την εκκίνηση του Aslan.
Αν δημιουργηθεί αυτή η συντόμευση, θα της ανατεθεί ο συνδυασμός συντόμευσης των πλήκτρων control+alt+n, η οποία θα σας επιτρέπει να ξεκινάτε ανά πάσα στιγμή το Aslan πατώντας αυτά τα πλήκτρα.

#### Αντιγραφή της Φορητής Διαμόρφωσης στο Λογαριασμό του Τρέχοντος Χρήστη {#toc14}

Αυτή η επιλογή σας επιτρέπει να επιλέξετε εάν το Aslan θα αντιγράψει τη διαμόρφωση χρήστη από το τρέχον εκτελούμενο αντίγραφο του Aslan στη διαμόρφωση για τον τρέχοντα συνδεδεμένο χρήστη, για το εγκατεστημένο αντίγραφο του Aslan.
...
Αν δημιουργείτε ένα φορητό αντίγραφο απευθείας από το πακέτο του Aslan που έχετε κατεβάσει, απλά πατήστε το κουμπί Δημιουργία Φορητού Αντίγραφου.
Αν έχετε ήδη κλείσει αυτό το παράθυρο διαλόγου ή αν τρέχετε ένα εγκατεστημένο αντίγραφο του Aslan, επιλέξτε τη Δημιουργία Φορητού Αντίγραφου που βρίσκεται κάτω από τα Εργαλεία στο μενού του Aslan.
...
Επίσης, υπάρχει η επιλογή για το εάν το Aslan θα αντιγράψει τη διαμόρφωση Aslan του τρέχοντος συνδεδεμένου χρήστη, η οποία θα χρησιμοποιηθεί με το νέο φορητό αντίγραφο που θα δημιουργηθεί.
...
## Γνωρίζοντας το Aslan {#toc16}
### Εκκίνηση του Aslan {#toc17}

Αν έχετε εγκαταστήσει το Aslan με τον οδηγό εγκατάστασης, τότε η εκκίνηση του Aslan είναι πανεύκολη, πατώντας control+alt+n ή επιλέγοντας Aslan από το μενού Aslan στο μενού Προγράμματα υπό το μενού Έναρξη. 
Επιπλέον, μπορείτε να πληκτρολογήσετε Aslan στο πλαίσιο διαλόγου Run και στη συνέχεια πατήστε Enter.
Μπορείτε επίσης να χρησιμοποιήσετε επιπρόσθετες εντολές οι οποίες σας επιτρέπουν να επανεκινήσετε το aslan (-r), να το κλείσετε (-q), να απενεργοποιήσετε τα πρόσθετα (--disable-addons), και λοιπά.

Για να εκκινήσετε τη φορητή έκδοση, πηγαίνετε στο φάκελο στον οποίο έχετε αποθηκεύσει το Aslan και πατήστε enter ή κάνετε διπλό κλικ στο aslan.exe.

Όταν αρχίσει η φόρτωση του Aslan, θα ακούσετε μια σειρά από αύξοντες τόνους που σας ενημερώνουν ότι έχει αρχίσει η φόρτωση. 
Ανάλογα με το πόσο γρήγορος είναι ο υπολογιστής σας ή αν τρέχετε το Aslan από USB ή από άλλο πιο αργό μέσο, μπορεί να διαρκέσει αρκετή ώρα η φόρτωση. 
Αν η φόρτωση αργεί πολύ, το Aslan πρέπει να πει “Φόρτωση του Aslan. Παρακαλώ περιμένετε…” 

Αν δεν ακούσετε τίποτα τέτοιο ή ακούσετε τον ήχο σφάλματος των Windows ή μια σειρά από φθίνοντες τόνους, αυτό σημαίνει ότι το Aslan παρουσιάζει σφάλμα και πιθανώς να χρειαστεί να το αναφέρετε στους δημιουργούς. 
Παρακαλούμε να επισκεφτείτε τη σελίδα του Aslan για να μάθετε πώς γίνεται αυτό.

Όταν ξεκινήσει το Aslan για πρώτη φορά, θα συναντήσετε ένα  παράθυρο διαλόγου που σας παρέχει κάποιες βασικές πληροφορίες για το πλήκτρο τροποποίησης του Aslan και το μενού του Aslan. 
...
Το πρώτο σας επιτρέπει να ελέγξετε αν το Aslan θα χρησιμοποιεί το Κλείδωμα Κεφαλαίων ως πλήκτρο τροποποίησης. 
Το δεύτερο καθορίζει αν το Aslan θα φορτώνει αυτόματα, μόλις συνδεθείτε στα Windows και διατίθεται μόνο για εγκατεστημένες εκδόσεις του Aslan. 
Το τρίτο σας επιτρέπει να ελέγξετε αν το πλαίσιο διαλόγου θα εμφανίζεται κάθε φορά που γίνεται φόρτωση του Aslan. 

### Σχετικά με τις εντολές πληκτρολογίου του Aslan {#toc18}
#### Το πλήκτρο τροποποίησης του Aslan {#toc19}

Οι περισσότερες εντολές του Aslan περιλαμβάνουν το πάτημα ενός συγκεκριμένου πλήκτρου, που ονομάζεται πλήκτρο τροποποίησης, σε συνδυασμό με ένα ή περισσότερα άλλα πλήκτρα. 
...
Το Aslan μπορεί να ρυθμιστεί έτσι ώστε το Insert, το Insert του αριθμητικού πληκτρολογίου και/ή το Κλείδωμα Κεφαλαίων να μπορούν να χρησιμοποιηθούν ως πλήκτρα τροποποίησης του Aslan. Τόσο το Insert όσο και το Insert του αριθμητικού πληκτρολογίου είναι προεπιλεγμένα ως πλήκτρα τροποποίησης.

Αν επιθυμείτε να συμπεριφέρεται ένα από τα πλήκτρα τροποποίησης του Aslan όπως θα συμπεριφερόταν αν δεν έτρεχε το Aslan, για παράδειγμα αν θέλετε να ενεργοποιήσετε το Κλείδωμα Κεφαλαίων ενώ αυτό είναι πλήκτρο τροποποίησης του Aslan, μπορείτε να το πατήσετε δυο φορές γρήγορα. 

#### Διατάξεις πληκτρολογίου {#toc20}

Το Aslan έρχεται με δύο σειρές από εντολές πληκτρολογίου (γνωστές ως διατάξεις πληκτρολογίου): η διάταξη επιτραπέζιου υπολογιστή και η διάταξη φορητού υπολογιστή. Η διάταξη για επιτραπέζιο υπολογιστή είναι προεπιλεγμένη, αλλά μπορείτε να αλλάξετε τη διάταξη σε διάταξη για φορητό υπολογιστή στις Ρυθμίσεις Πληκτρολογίου που βρίσκονται στις Ρυθμίσεις στο μενού του Aslan.
...
### Χειρονομίες Αφής Του Aslan {#toc21}

Αν χρησιμοποιείτε το Aslan σε μια συσκευή με οθόνη αφής που τρέχει Windows 8 ή νεότερο, μπορείτε επίσης να ελέγξετε το Aslan απευθείας μέσω της οθόνης αφής. 
Όταν τρέχει το Aslan, όλες οι εισαγωγές μέσω αφής θα πάνε κατευθείαν στο Aslan. 
Ως εκ τούτου, ενέργειες που μπορούν να γίνουν κανονικά χωρίς το Aslan δε θα είναι εφικτές.
...
Όταν οι εντολές του Aslan περιγραφούν αργότερα σε αυτό το εγχειρίδιο χρήσης, μπορεί να συνοδεύονται και από χειρονομία αφής που μπορεί να χρησιμοποιηθεί για να ενεργοποιηθεί αυτή η εντολή στην οθόνη αφής. 
...
Αν το ίδιο άγγιγμα εκτελείται μια ή περισσότερες φορές, με διαδοχική γρήγορη κίνηση, το Aslan θα το θεωρήσει αυτό ως πολλαπλό άγγιγμα. 
...
Καθώς υπάρχουν πολύ περισσότερες εντολές του Aslan σε σχέση με τις δυνατές χειρονομίες αφής, το Aslan έχει αρκετές λειτουργίες αφής τις οποίες μπορείτε να αλλάζετε και οι οποίες κάνουν διαθέσιμες συγκεκριμένες υποομάδες εντολών. 
Οι δύο λειτουργίες είναι η λειτουργία κειμένου και η λειτουργία αντικειμένου. 
Συγκεκριμένες εντολές του Aslan, που αναφέρονται σε αυτό το έγγραφο, μπορεί να αναφέρουν λειτουργία αφής μέσα σε αγκύλες, μετά τη χειρονομία αφής. 
...
Πολλές εντολές του Aslan αναφέρονται στη συνέχεια αυτού του εγχειριδίου, αλλά ένας εύκολος τρόπος να εξερευνήσετε όλες τις διαφορετικές εντολές είναι να ενεργοποιήσετε τη βοήθεια εισαγωγής.

Για να ενεργοποιήσετε τη βοήθεια εισαγωγής, πατήστε Aslan+1. 
Για να την απενεργοποιήσετε, πατήστε πάλι Aslan+1. 
...
### Το Μενού Του Aslan {#toc28}

Το μενού του Aslan σας επιτρέπει να ελέγξετε τις ρυθμίσεις του Aslan, να αποκτήσετε πρόσβαση στη βοήθεια, να αποθηκεύσετε/επαναφέρετε τη διαμόρφωσή σας, να τροποποιήσετε λεξικά εκφώνησης, να αποκτήσετε πρόσβαση σε πρόσθετα εργαλεία και να τερματίσετε το Aslan.

Για να εμφανίσετε το μενού του Aslan οπουδήποτε στα Windows, ενόσω εκτελείται το Aslan, πατήστε Aslan+n στο πληκτρολόγιο ή εκτελέστε διπλό άγγιγμα με δύο δάχτυλα στην οθόνη αφής. 
Μπορείτε, επίσης, να εμφανίσετε το μενού του Aslan μέσω της περιοχής συστήματος των Windows. 
Ή κάντε δεξί κλικ στο εικονίδιο του Aslan που βρίσκεται στην περιοχή συστήματος, ή πηγαίνετε στην περιοχή συστήματος πατώντας windows logo key+B. Πλοηγηθείτε με κάτω βέλος για να βρείτε το εικονίδιο του Aslan και πατήστε το πλήκτρο Applications που βρίσκεται δίπλα στο δεξί Control στα περισσότερα πληκτρολόγια. 
...
### Βασικές Εντολές Του Aslan {#toc29}
...
|Μενού Aslan |Aslan+n |Aslan+n |Διπλό άγγιγμα με 2 δάχτυλα |Εμφανίζει το μενού του Aslan που σας επιτρέπει να έχετε πρόσβαση σε προτιμήσεις, εργαλεία, βοήθεια, κ.λπ.|
|Εναλλαγή Λειτουργίας Εκφώνησης |Aslan+s |Aslan+s |Δεν υπάρχει |Εναλλάσσει τη λειτουργία εκφώνησης μεταξύ εκφώνησης, ήχων μπιπ και χωρίς εκφώνηση.|
|Εναλλαγή Λειτουργίας Βοήθειας Εισαγωγής |Aslan+1 |Aslan+1 |Δεν υπάρχει |Με το πάτημα οποιουδήποτε πλήκτρου (ή πλήκτρων) σε αυτή τη λειτουργία, αναφέρεται το πλήκτρο (ή τα πλήκτρα) και η περιγραφή οποιασδήποτε εντολής του Aslan που αντιστοιχεί σε αυτό.|
|Έξοδος Από Το Aslan |Aslan+q |Aslan+q |Δεν υπάρχει |Τερματίζει το Aslan|
|Διέλευση Επόμενης Εντολής |Aslan+f2 |Aslan+f2 |Δεν υπάρχει |Το Aslan επιτρέπει τη διέλευση της επόμενης εντολής κατ’ ευθείαν στην τρέχουσα εφαρμογή, ακόμα κι αν χρησιμοποιείται συνήθως ως εντολή του Aslan.|
|Εναλλαγή Λειτουργίας Ύπνου Εφαρμογής |Aslan+shift+s |Aslan+shift+z |Δεν υπάρχει |Η λειτουργία ύπνου απενεργοποιεί όλες τις εντολές του Aslan, καθώς και την εκφώνηση και την εξαγωγή braille για την τρέχουσα εφαρμογή. Αυτό είναι πολύ χρήσιμο για εφαρμογές που παρέχουν οι ίδιες δυνατότητα εκφώνησης των στοιχείων της οθόνης. Εκτελέστε ξανά την εντολή για να απενεργοποιήσετε τη λειτουργία εκφώνησης που παρέχει η δεδομένη εφαρμογή.|
...
|---|---|---|
|Αναφορά ημερομηνίας/ώρας |Aslan+F12 |Πατώντας μια φορά αναφέρεται η τρέχουσα ώρα. Πατώντας δύο φορές αναφέρεται η ημερομηνία.|
|Αναφορά Κατάστασης Μπαταρίας. |Aslan+shift+b |Αναφέρει την κατάσταση της μπαταρίας, δηλ. αν χρησιμοποιείται το εναλλασόμενο ρεύμα ή το ποσοστό της μπαταρίας που έχει φορτιστεί.|
|Αναφέρει το κείμενο στο πρόχειρο |Aslan+c |Αναφέρει το κείμενο στο πρόχειρο, αν υπάρχει.|

## Πλοήγηση με το Aslan {#toc31}

Το Aslan σας επιτρέπει να εξερευνήσετε και να πλοηγηθείτε στο σύστημα με διάφορους τρόπους, συμπεριλαμβανομένης της κανονικής αλληλεπίδρασης και της εξέτασης.
...
Κάνοντας αυτά, το Aslan αναφέρει πληροφορίες σχετικά με το αντικείμενο που έχει την εστίαση, όπως το όνομα του, ο τύπος του, η τιμή του, η κατάσταση του, η περιγραφή του, η συντόμευση πληκτρολογίου και πληροφορίες σχετικές με τη θέση του.
...
|---|---|---|---|
|Αναφορά τρέχουσας εστίασης |Aslan+tab |Aslan+tab |Αναφέρει το τρέχον αντικείμενο ή στοιχείο ελέγχου που έχει την Εστίαση Συστήματος. Πατώντας δύο φορές, συλαβίζει την πληροφορία.|
|Αναφορά τίτλου |Aslan+t |Aslan+t |Αναφέρει τον τίτλο του ενεργού παραθύρου. Πατώντας δύο φορές, συλαβίζει την πληροφορία. Πατώντας τρεις φορές, την αντιγράφει στο πρόχειρο.|
|Ανάγνωση τρέχοντος παραθύρου |Aslan+b |Aslan+b |Διαβάζει όλα τα στοιχεία ελέγχου στο ενεργό παράθυρο (χρήσιμο για διαλόγους).|
|Αναφορά Λωρίδας Κατάστασης |Aslan+end |aslan+shift+end |Αναφέρει τη Λωρίδα Κατάστασης, αν το Aslan βρει κάποια. Επιπλέον, μετακινεί το Αντικείμενο Πλοήγησης σε αυτή τη τοποθεσία.|
...
Κατά τη μετακίνηση σας με τον κέρσορα, το Aslan θα σας αναφέρει ανά χαρακτήρα, λέξη και γραμμή, και επίσης θα σας αναφέρει όταν επιλέγετε ή απο-επιλέγετε κείμενο.

Το Aslan παρέχει τις ακόλουθες εντολές πλήκτρων που σχετίζονται με τον Κέρσορα Συστήματος:
<!-- KC:beginInclude -->

| Όνομα |Πλήκτρο επιτραπέζιου υπολογιστή |Πλήκτρο φορητού υπολογιστή |Περιγραφή|
|---|---|---|---|
|Εκφώνηση όλων |Aslan+κάτωΒέλος |aslan+a |Ξεκινά να διαβάζει από την τρέχουσα θέση του κέρσορα, μετακινώντας τον καθώς διαβάζει.|
|Εκφώνηση τρέχουσας γραμμής |Aslan+πάνωΒέλος |aslan+L |Διαβάζει τη γραμμή στην οποία βρίσκεται ο κέρσορας. Πατώντας δύο φορές, θα προφέρει τη γραμμή ανά χαρακτήρα.|
|Εκφώνηση τρέχουσας επιλογής κειμένου |Aslan+Shift+πάνωΒέλος |aslan+shift+s |Διαβάζει οποιοδήποτε επιλεγμένο κείμενο.|
...
Όταν μετακινείστε σε ένα αντικείμενο, το Aslan θα σας δώσει μία αναφορά για αυτό με τον ίδιο τρόπο που αναφέρει την εστίαση συστήματος.
...
| Όνομα |Πλήκτρο επιτραπέζιου Υπολογιστή |Πλήκτρο φορητού Υπολογιστή |χειρονομία αφής |Περιγραφή|
|---|---|---|---|---|
|Αναφορά τρέχοντος αντικειμένου |Aslan+αριθμητικό5 |aslan+shift+o |Μη διαθέσημο |Αναφέρει το τρέχον Αντικείμενο Πλοήγησης. Πατώντας δύο φορές συλαβίζει την πληροφορία ανά χαρακτήρα, και πατώντας τρεις φορές αντιγράφει το όνομα και την τιμή του αντικειμένου στο πρόχειρο.|
|Μετακίνηση στο περιέχον αντικείμενο |Aslan+αριθμητικό8 |Aslan+shift+πάνωβέλος |σάρωση προς τα πάνω (Λειτουργία αντικειμένου) |Μετακινείται στο αντικείμενο που περιέχει το τρέχον Αντικείμενο Πλοήγησης.|
|Μετακίνηση στο προηγούμενο αντικείμενο |Aslan+αριθμητικό4 |Aslan+shift+αριστερόβέλος |σάρωση αριστερά (λειτουργία αντικειμένου) |Μετακινείται στο αντικείμενο ακριβώς πριν το τρέχον Αντικείμενο Πλοήγησης.|
|Μετακίνηση στο επόμενο αντικείμενο |Aslan+αριθμητικό6 |aslan+shift+δεξίβέλος |σάρωση δεξιά (λειτουργία αντικειμένου) |Μετακινείται στο αντικείμενο ακριβώς μετά το τρέχον Αντικείμενο Πλοήγησης.|
|Μετακίνηση στο πρώτο περιεχόμενο αντικείμενο |Aslan+αριθμητικό2 |Aslan+shift+κάτωβέλος |σάρωση προς τα κάτω (Λειτουργία εξέτασης) |Μετακινείται στο πρώτο αντικείμενο που περιέχεται από το τρέχον Αντικείμενο Πλοήγησης.|
|Μετακίνηση στο αντικείμενο εστίασης |Aslan+αριθμητικόΜείον |Aslan+backspace |μη διαθέσιμο |Μετακινείται στο αντικείμενο που έχει την Εστίαση Συστήματος, και επιπλέον θέτει τον Δρομέα Εξέτασης στη θέση του Κέρσορα Συστήματος, αν είναι εμφανής.|
|Ενεργοποίηση του τρέχοντος αντικειμένου πλοήγησης |Aslan+αριθμητικόEnter |Aslan+enter |διπλό άγγιγμα |Ενεργοποιεί το τρέχον Αντικείμενο Πλοήγησης (όμοια με το κλικ του ποντικιού ή το πάτημα του πλήκτρου κενού διαστήματος (spacebar) όταν έχει την Εστίαση Συστήματος).|
|Μετακίνηση της Εστίασης Συστήματος ή του κέρσορα στην τρέχουσα θέση εξέτασης |Aslan+shift+αριθμητικόΜείον |Aslan+shift+backspace |μη διαθέσιμο |Πατώντας μία φορά μετακινεί την Εστίαση Συστήματος στο τρέχον Αντικείμενο Πλοήγησης. Πατώντας δύο φορές μετακινεί τον Κέρσορα Συστήματος στη θέση του Δρομέα Εξέτασης.|
|Αναφορά διαστάσεων αντικειμένου πλοήγησης |Aslan+αριθμητικόDelete |Aslan+delete |μη διαθέσιμο |Αναφέρει τις διαστάσεις του τρέχοντος αντικειμένου πλοήγησης στην οθόνη επί τοις εκατό (συμπεριλαμβανομένης της απόστασης από τα αριστερά και την κορυφή της οθόνης, το πλάτος και το ύψος).|
...
Το Aslan σας επιτρέπει να διαβάζετε το περιεχόμενο του τρέχοντος [αντικειμένου πλοήγησης](#ObjectNavigation) (συμπεριλαμβανομένης της [ εξέτασης οθόνης#ScreenReview]) ανά χαρακτήρα, λέξη ή γραμμή.
...
| Όνομα |Πλήκτρο Επιτραπέζιου Υπολογιστή |Πλήκτρο Φορητού Υπολογιστή |χειρονομία αφής |Περιγραφή|
|---|---|---|---|---|
|Μετακίνηση στην ανώτατη γραμμή εξέτασης |shift+αριθμητικό7 |Aslan+control+home |μη διαθέσιμο |Μετακινεί τον Δρομέα Εξέτασης στην ανώτατη γραμμή του κειμένου.|
|Μετακίνηση στην προηγούμενη γραμμή εξέτασης |αριθμητικό7 |Aslan+πάνωβέλος |σάρωση προς τα πάνω (Λειτουργία κειμένου) |Μετακινεί τον Δρομέα Εξέτασης στην προηγούμενη γραμμή του κειμένου.|
|Αναφορά τρέχουσας γραμμής εξέτασης |αριθμητικό8 |Aslan+shift+τελία |μη διαθέσιμο |Αναγγέλλει την τρέχουσα γραμμή κειμένου στην οποία βρίσκεται ο Δρομέας Εξέτασης. Πατώντας δύο φορές, προφέρει τη γραμμή ανά χαρακτήρα. Πατώντας τρεις φορές, προφέρει τη γραμμή ανά χαρακτήρα χρησιμοποιώντας τις περιγραφές των χαρακτήρων.|
|Μετακίνηση στην επόμενη γραμμή εξέτασης |αριθμητικό9 |Aslan+κάτωβέλος |σάρωση προς τα κάτω (Λειτουργία κειμένου) |Μετακινεί τον Δρομέα Εξέτασης στην επόμενη γραμμή του κειμένου.|
|Μετακίνηση στην κατώτατη γραμμή εξέτασης |shift+αριθμητικό9 |Aslan+control+end |μη διαθέσιμο |Μετακινεί τον Δρομέα Εξέτασης στην κατώτατη γραμμή του κειμένου.|
|Μετακίνηση στην προηγούμενη λέξη εξέτασης |αριθμητικό4 |Aslan+control+αριστερό βέλος |σάρωση αριστερά με δύο δάκτυλα (Λειτουργία κειμένου) |Μετακινεί τον Δρομέα Εξέτασης στην προηγούμενη λέξη του κειμένου.|
|Αναφορά τρέχουσας λέξης εξέτασης |αριθμητικό5 |Aslan+control+τελία |μη διαθέσιμο |Αναγγέλλει την τρέχουσα λέξη του κειμένου στην οποία βρίσκεται ο Δρομέας Εξέτασης. Πατώντας δύο φορές, προφέρει τη λέξη ανά χαρακτήρα. Πατώντας τρεις φορές, προφέρει τη λέξη ανά χαρακτήρα χρησιμοποιώντας τις περιγραφές των χαρακτήρων.|
|Μετακίνηση στην επόμενη λέξη της εξέτασης |αριθμητικό6 |Aslan+control+δεξίβέλος |σάρωση δεξιά με 2 δάκτυλα (Λειτουργία κειμένου) |Μετακινεί τον Δρομέα Εξέτασης στην επόμενη λέξη του κειμένου.|
|Μετακίνηση στην αρχή της γραμμής εξέτασης |shift+αριθμητικό1 |Aslan+home |μη διαθέσιμο |Μετακινεί τον Δρομέα Εξέτασης στην αρχή της τρέχουσας γραμμής του κειμένου.|
|Μετακίνηση στον προηγούμενο χαρακτήρα εξέτασης |αριθμητικό1 |Aslan+αριστερόβέλος |σάρωση αριστερά (Λειτουργία κειμένου) |Μετακινεί τον Δρομέα Εξέτασης στον προηγούμενο χαρακτήρα της τρέχουσας γραμμής του κειμένου.|
|Αναφορά του τρέχοντος χαρακτήρα εξέτασης |αριθμητικό2 |Aslan+τελία |μη διαθέσιμο |Αναγγέλλει τον τρέχοντα χαρακτήρα στη γραμμή του κειμένου στην οποία βρίσκεται ο Δρομέας Εξέτασης. Πατώντας δύο φορές, αναγγέλλει μία περιγραφή ή ένα παράδειγμα αυτού του χαρακτήρα. Πατώντας τρεις φορές, αναγγέλλει την αριθμητική τιμή του χαρακτήρα στο δεκαδικό και στο δεκαεξαδικό σύστημα.|
|Μετακίνηση στον επόμενο χαρακτήρα εξέτασης |αριθμητικό3 |Aslan+δεξίβέλος |σάρωση δεξιά (Λειτουργία κειμένου) |Μετακινεί τον Δρομέα Εξέτασης στον επόμενο χαρακτήρα της τρέχουσας γραμμής του κειμένου.|
|Μετακίνηση στο τέλος της γραμμής εξέτασης |shift+αριθμητικό3 |Aslan+end |μη διαθέσιμο |Μετακινεί τον Δρομέα Εξέτασης στο τέλος της τρέχουσας γραμμής του κειμένου.|
|Εκφώνηση όλων με εξέταση |αριθμητικόΣυν |Aslan+shift+a |σάρωση προς τα κάτω με 3 δάκτυλα (Λειτουργία κειμένου) |Διαβάζει από την τρέχουσα θέση του Δρομέα Εξέτασης και τον μετακινεί καθώς διαβάζει.|
|Αντιγραφή από τον Δρομέα Εξέτασης |Aslan+f9 |Aslan+f9 |μη διαθέσιμο |Ξεκινάει να αντιγράφει κείμενο από την τρέχουσα θέση του Δρομέα Εξέτασης. Ουσιαστικά, η αντιγραφή δεν πραγματοποιείται μέχρι εσείς να πείτε στο Aslan μέχρι που θα αντιγράψει.|
|Αντιγραφή μέχρι τον Δρομέα Εξέτασης |Aslan+f10 |Aslan+f10 |μη διαθέσιμο |Αντιγράφει από τη θέση του Δρομέα Εξέτασης που έχει οριστεί με την Αντιγραφή από τον Δρομέα Εξέτασης, στην τρέχουσα θέση του Δρομέα Εξέτασης. Αφού πατήσετε αυτό το πλήκτρο, το κείμενο θα αντιγραφεί στο πρόχειρο των Windows.|
|Αναφορά μορφοποίησης κειμένου |Aslan+f |Aslan+f |μη διαθέσιμο |Αναφέρει τη μορφοποίηση του κειμένου όπου βρίσκεται ο Δρομέας Εξέτασης|
...
| Όνομα |Πλήκτρο επιτραπέζιου Υπολογιστή |Πλήκτρο φορητού Υπολογιστή |χειρονομία αφής |Περιγραφή|
|---|---|---|---|---|
|Μετάβαση στην επόμενη μέθοδο εξέτασης περιεχομένου |Aslan+αριθμητικό7 |Aslan+pageUp |σάρωση προς τα πάνω με δύο δάκτυλα |Μεταβαίνεται στην επόμενη διαθέσιμη μέθοδο εξέτασης περιεχομένου|
|Μετάβαση στην προηγούμενη μέθοδο εξέτασης περιεχομένου |aslan+αριθμιτικό1 |aslan+page down |σάρωση προς τα κάτω με δύο δάκτυλα |Μεταβαίνετε στην προηγούμενη μέθοδο εξέτασης περιεχομένου|
...
Σημειώστε πως σε κάποιες καινούριες εφαρμογές, το aslan ενδέχεται να μην μπορεί να δει μέρος ή ολόκληρο το κείμενο που εμφανίζεται στην οθόνη, λόγο κάποιων καινούριων τεχνολογιών απεικόνισης που δεν είναι δυνατό να υποστηριχτούν στο παρόν στάδιο.

### Πλοήγηση με το Ποντίκι {#toc41}

Όταν κινείτε το Ποντίκι, το Aslan αναφέρει εξ ορισμού το κείμενο που βρίσκεται ακριβώς κάτω από τον δείκτη του ποντικιού, όπως ο δείκτης μετακινείται πάνω του.
Όπου υποστηρίζεται, το Aslan θα διαβάσει την περιβάλλουσα παράγραφο κειμένου, αν και μερικά στοιχεία ελέγχου μπορούν να διαβαστούν μόνο ανά γραμμή.

Το Aslan μπορεί να διαμορφωθεί ώστε να αναγγέλλει επίσης τον τύπο του [αντικειμένου](#Objects) κάτω από το ποντίκι όπως κινείται (π.χ. λίστα, κουμπί κλπ.).
Αυτό μπορεί να είναι χρήσιμο για ολικά τυφλούς χρήστες, καθώς μερικές φορές μόνο το κείμενο δεν είναι αρκετό.

Το Aslan παρέχει στους χρήστες έναν τρόπο για να καταλαβαίνουν που βρίσκεται το ποντίκι σε σχέση με τις διαστάσεις της οθόνης, παίζοντας κατάλληλους ήχους μπιπ που αντιστοιχούν στις τρέχουσες συντεταγμένες του ποντικιού.
...
Αυτά τα επιπρόσθετα χαρακτηριστικά του ποντικιού δεν είναι ενεργοποιημένα εξ ορισμού στο Aslan.
Αν επιθυμείτε να εκμεταλλευτείτε τις δυνατότητες τους, μπορείτε να τα διαμορφώσετε από τις [Ρυθμίσεις Ποντικιού](#MouseSettings) που βρίσκονται στο μενού Προτιμήσεων του Aslan.

Αν και απαιτείται ένα πραγματικό ποντίκι ή μία ιχνόσφαιρα για να πλοηγηθείτε με το ποντίκι, το Aslan έχει μερικές εντολές πλήκτρων που σχετίζονται με το ποντίκι:
<!-- KC:beginInclude -->

| Όνομα |Πλήκτρο επιτραπέζιου Υπολογιστή |Πλήκτρο φορητού Υπολογιστή |Περιγραφή|
|---|---|---|---|
|Κλικ αριστερού πλήκτρου ποντικιού |αριθμητικόΔιαίρεση |Aslan+[ |Κλικάρει μία φορά το αριστερό πλήκτρο ποντικιού. Το γνωστό διπλό κλικ μπορεί να επιτευχθεί με το γρήγορο διαδοχικό διπλό πάτημα αυτού του πλήκτρου.|
|Κλείδωμα αριστερού πλήκτου ποντικιού |shift+αριθμητικόΔιαίρεση |Aslan+control+[ |Κλειδώνει κάτω το αριστερό πλήκτρο ποντικιού. Πατήστε ξανά για να το ελευθερώσετε. Για να σύρετε το ποντίκι, πατήστε αυτό το πλήκτρο για να κλειδώσετε κάτω το αριστερό πλήκτρο ποντικιού και κατόπιν μετακινείστε το ποντίκι είτε φυσικά είτε χρησιμοποιώντας μία από τις άλλες εντολές δρομολόγησης του ποντικιού.|
|Κλικ δεξιού πλήκτρου ποντικιού |αριθμητικόΕπί |Aslan+] |Κλικάρει μία φορά το δεξί πλήκτρο ποντικιού.|
|Κλείδωμα δεξιού πλήκτου ποντικιού |shift+αριθμητικόΕπί |Aslan+control+] |Κλειδώνει κάτω το δεξί πλήκτρο ποντικιού. Πατήστε ξανά για να το ελευθερώσετε. Για να σύρετε το ποντίκι, πατήστε αυτό το πλήκτρο για να κλειδώσετε κάτω το δεξί πλήκτρο ποντικιού και κατόπιν μετακινείστε το ποντίκι είτε φυσικά είτε χρησιμοποιώντας μία από τις άλλες εντολές δρομολόγησης του ποντικιού.|
|Μετακίνηση ποντικιού στο τρέχον Αντικείμενο Πλοήγησης |Aslan+αριθμητικόΔιαίρεση |Aslan+shift+m |Μετακινεί το ποντίκι στη θέση του τρέχοντος Αντικειμένου Πλοήγησης και του Δρομέα Εξέτασης.|
|Πλοήγηση στο αντικείμενο κάτω από το ποντίκι |Aslan+αριθμητικόΕπί |Aslan+shift+n |Θέτει το Αντικείμενο Πλοήγησης στο αντικείμενο που βρίσκεται στη θέση του ποντικιού.|

<!-- KC:endInclude -->

## Λειτουργία Περιήγησης {#toc42}

Η περιήγηση με το Aslan πολύπλοκων εγγράφων που είναι μόνο για ανάγνωση, όπως οι ιστοσελίδες, γίνεται με τη χρήση της Λειτουργίας Περιήγησης.
...
Όλες οι εντολές πλήκτρων του [Κέρσορα Συστήματος](#SystemCaret) του Aslan δουλεύουν σε αυτή τη λειτουργία. Για παράδειγμα, εκφώνηση όλου, αναφορά μορφοποίησης, εντολές πλοήγησης πίνακα κλπ.
...
Όταν βρίσκεστε σε Λειτουργία Περιήγησης, εξ ορισμού, το Aslan θα αλλάξει αυτόματα σε Λειτουργία Εστίασης αν μετακινηθείτε με το πλήτρο TAB ή κάνετε κλικ σε ένα στοιχείο ελέγχου που το απαιτεί.
...
| Όνομα |Πλήκτρο |Περιγραφή|
|---|---|---|
|Εναλλαγή Λειτουργιών Περιήγησης/Εστιάσης |Aslan+space |Εναλλάσσει μεταξύ των Λειτουργιών Εστίασης και Περιήγησης.|
...
|Ανανέωση εγγράφου Λειτουργίας Περιήγησης |Aslan+f5 |Επαναφορτώνει το περιεχόμενο του τρέχοντος εγγράφου (χρήσιμο αν κάποιο περιεχόμενο φαίνεται να λείπει από το έγγραφο)|
|Εύρεση |Aslan+control+f |Εμφανίζει ένα παράθυρο διαλόγου όπου μπορείτε να πληκτρολογήσετε κάποιο κείμενο προς αναζήτηση στο τρέχον έγγραφο.|
|Εύρεση επόμενου |Aslan+f3 |Βρίσκει στο έγγραφο την επόμενη εμφάνιση του κειμένου που αναζητήσατε προηγουμένως.|
|Εύρεση προηγούμενου |Aslan+shift+f3 |Βρίσκει στο έγγραφο την προηγούμενη εμφάνιση του κειμένου που αναζητήσατε προηγουμένως.|
|άνοιγμα εκτεταμένης περιγραφής |aslan+d |Ανοίγει ένα καινούριο παράθυρο που περιλαμβάνει μια εκτεταμένη περιγραφή για το στοιχείο στο οποίο βρήσκεσται αν υπάρχει|

<!-- KC:endInclude -->

### Πλοήγηση Ενός Γράμματος {#toc43}

Όταν βρίσκεστε σε Λειτουργία Περιήγησης, για ταχύτερη πλοήγηση, το Aslan παρέχει επίσης πλήκτρα μονών χαρακτήρων για να μεταβαίνετε σε συγκεκριμένους τομείς στο έγγραφο.
...
| Όνομα |Πλήκτρο |Περιγραφή|
|---|---|---|
|Λίστα στοιχείων λειτουργίας περιήγησης |Aslan+f7 |Εμφανίζει τη Λίστα Στοιχείων που περιέχει διάφορους τύπους στοιχείων από το τρέχον έγγραφο.|
...
Όταν εντοπίζονται τέτοια στοιχεία στη Λειτουργία Περιήγησης, το Aslan θα αναφέρει "ενσωματωμένο αντικείμενο", "εφαρμογή" ή "διάλογος" αντίστοιχα.
...
| Όνομα |Πλήκτρο |Περιγραφή|
|---|---|---|
|Μετακίνηση στο περιέχον έγγραφο της Λειτουργίας Περιήγησης |Aslan+control+space |Μετακινεί την εστίαση εκτός του τρέχοντος Ενσωματωμένου Αντικειμένου και εντός του εγγράφου που το περιέχει.|

<!-- KC:endInclude -->

## Ανάγνωση Μαθηματικού Περιεχομένου {#toc46}

Χρησιμοποιώντας το MathPlayer 4 από την Design Science, το Aslan μπορεί να διαβάσει και να πλοηγηθεί αλληλεπιδρώντας με υποστηριζόμενο μαθηματικό περιεχόμενο.
...
Το Aslan υποστηρίζει τις ακόλουθες μορφές μαθηματικού περιεχομένου:
...
Όταν διαβάζετε ένα έγγραφο, το Aslan θα εκφωνήσει οποιοδήποτε υποστηριζόμενο μαθηματικό περιεχόμενο εμφανιστεί.
...
| Όνομα |Πλήκτρο |Περιγραφή|
|---|---|---|
|Αλληλεπίδραση με μαθηματικό περιεχόμενο |Aslan+alt+m |Αρχίζει αλληλεπίδραση με μαθηματικό περιεχόμενο.|
...
Το Aslan υποστηρίζει τη δυνατότητα οπτικής αναγνώρισης χαρακτήρων (OCR) που έχει ενσωματωθεί στα Windows 10 προκειμένου να αναγνωρίσει κείμενο από εικόνες.
Επιπλέον αναγνώριση περιεχομένου είναι δυνατό να παρέχεται με τα πρόσθετα του Aslan.

Όταν χρησιμοποιείτε μια εντολή για αναγνώριση περιεχομένου, το Aslan αναγνωρίζει περιεχόμενο από το τρέχον αντικείμενο πλοήγησης #ObjectNavigation].
...
Το Aslan μπορεί να χρησιμοποιήσει αυτή τη δυνατότητα για να αναγνωρίσει κείμενο από εικόνες ή μη προσβάσιμες εφαρμογές.
...
<!-- KC:beginInclude -->
Για να αναγνωρίσετε το κείμενο στο τρέχον αντικείμενο πλοήγησης χρησιμοποιώντας την οπτική αναγνώριση χαρακτήρων στα Windows 10, πατήστε Aslan+r.
<!-- KC:endInclude -->

## Εντολές Του Aslan Για Συγκεκριμένες Εφαρμογές {#toc50}

Το Aslan παρέχει επιπλέον εντολές για κάποιες εφαρμογές, για να γίνουν ευκολότερα κάποιες εργασίες ή για να παρέχει πρόσβαση σε λειτουργίες που σε άλλη περίπτωση δεν είναι προσβάσιμες στους χρήστες αναγνωστών οθόνης.
...
|Αναφορά τρέχοντος σχολίου |Aslan+Alt+c |Αναφέρει το κείμενο του σχολίου στη θέση του κέρσορα του συστήματος.|
|Ορισμός κεφαλίδων στήλης |Aslan+shift+c |Πατώντας το μια φορά, λέτε στο Aslan ότι αυτό είναι το πρώτο κελί της κεφαλίδας στη σειρά που περιλαμβάνει κεφαλίδες στήλης, οι οποίες θα πρέπει να αναγγέλλονται αυτόματα όταν μετακινήστε μεταξύ στηλών κάτω από αυτή τη σειρά. Πατώντας το δυο φορές, θα εκκαθαρίσει τη ρύθμιση.|
|Ορισμός κεφαλίδων σειράς |Aslan+shift+r |Πατώντας το μια φορά, λέτε στο Aslan ότι αυτό είναι το πρώτο κελί της κεφαλίδας στη στήλη που περιλαμβάνει κεφαλίδες σειράς, οι οποίες θα πρέπει να αναγγέλλονται αυτόματα όταν μετακινήστε μεταξύ σειρών μετά από αυτή τη στήλη. Πατώντας το δυο φορές, θα εκκαθαρίσει τη ρύθμιση.|
...
|Αναφορά σχολίου |Aslan+alt+c |Αναφέρει το σχόλιο στο τρέχον κελί, αν υπάρχει.|
...
| Όνομα |Πλήκτρο |Περιγραφή|
|---|---|---|
|Εναλλαγή ανάγνωσης σημειώσεων ομιλητή |control+shift+s |Όταν τρέχει μια παρουσίαση διαφανειών, αυτή η εντολή εναλλάσσει μεταξύ των σημειώσεων του ομιλητή για τη διαφάνεια και του περιεχομένου της διαφάνειας. Αυτό επηρεάζει μόνο ό,τι διαβάζει το Aslan, όχι ό,τι εμφανίζεται στην οθόνη.|
...
| Όνομα |Πλήκτρο |Περιγραφή|
|---|---|---|
|Αναφορά πρόσφατου μηνύματος |Aslan+control+1-4 |Αναφέρει ένα από τα πρόσφατα μηνύματα, ανάλογα με τον αριθμό που έχει πατηθεί; για παράδειγμα, το Aslan+control+2 διαβάζει το δεύτερο πιο πρόσφατο μήνυμα.|
...
| Όνομα |Πλήκτρο |Περιγραφή|
|---|---|---|
|Εξέταση μηνύματος |Aslan+control+1-0 |Αναφέρει και μετακηνεί τον δρομέα εξέτασης σε ένα πρόσφατο μήνυμα, ανάλογα με τον αριθμό που θα πατήσουμε: Για παράδειγμα το Aslan+control+2 διαβάζει το δεύτερο πιο πρόσφατο μήνυμα.|

<!-- KC:endInclude -->

## Διαμόρφωση του Aslan {#toc58}
### Προτιμήσεις {#toc59}

<!-- KC:settingsSection: || Όνομα | Πλήκτρο Υπολογιστή Γραφείου | Πλήκτρο Υπολογιστή Laptop | Περιγραφή | -->
Οι περισσότερες ρυθμίσεις του Aslan μπορούν να αλλάξουν μέσα από διάφορα κουτιά διαλόγου που είναι προσβάσιμα από το υπό-μενού Προτιμήσεις του μενού του Aslan.
Σε όλα τα κουτιά διαλόγου των ρυθμίσεων του Aslan, πατώντας το OK εφαρμόζετε τις όποιες αλλαγές έχετε κάνει.
...
#### Γενικές Ρυθμίσεις (Aslan+control+g) {#toc60}
...
Ένα αναδυόμενο κουτί κειμένου σας επιτρέπει να επιλέξετε τη γλώσσα στην οποία θα εμφανίζεται η διεπαφή χρήστη του Aslan και τα μηνύματα.
Υπάρχουν πολλές γλώσσες, ωστόσο η εξ ορισμού επιλογή είναι "User Default, Windows".
Αυτή η επιλογή ορίζει στο Aslan να χρησιμοποιεί τη γλώσσα που είναι ρυθμισμένη στα Windows.

Σημειώστε ότι το Aslan πρέπει να επανεκκινηθεί όταν αλλάζετε τη γλώσσα.
Το Aslan θα σας ρωτήσει αν επιθυμείτε την επανεκκίνηση αν όντως αλλάξετε την επιλογή.
Πατήστε OK, και το Aslan θα επανεκκινηθεί.

##### Αποθήκευση Διαμόρφωσης κατά την Έξοδο {#toc62}

Αυτό είναι ένα κουτί επιλογής, το οποίο όταν είναι ενεργοπιημένο ορίζει στο Aslan να αποθηκεύει αυτόματα κατά την έξοδο την τρέχουσα διαμόρφωση.

##### Εμφάνιση επιλογών εξόδου κατά την έξοδο από το aslan {#toc63}

Αυτό είναι ένα κουτί επιλογής που σας επιτρέπει να επιλέξετε κατά πόσον θα εμφανίζεται ή όχι ένα κουτί διαλόγου όταν θέλετε να βγείτε από το aslan που θα σας ρωτά ποια λειτουργία θα θέλετε να πραγματοποιήσετε.
Όταν είναι ενεργοπιημένο, ένα παράθυρο διαλόγου θα εμφανιστεί όταν προσπαθήσετε να βγείτε από το aslan και θα σας ρωτά αν θέλετε να πραγματοποιήσετε έξοδο από το aslan, να κάνετε επανεκκίνηση ή να κάνετε επανεκκίνηση με όλα τα πρόσθετα απενεργοποιημένα.
Αν δεν είναι τσεκαρισμένο, το aslan θα πραγματοποιήσει έξοδο αμέσως.

##### Αναπαραγωγή ήχων κατά την εκκίνηση ή την έξοδο από το aslan {#toc64}

Αυτό είναι ένα κουτί επιλογής, το οποίο όταν είναι ενεργοποιημένο, ορίζει στο Aslan να αναπαράγει ήχους όταν πραγματοποιεί εκκίνηση ή έξοδο.

##### Επίπεδο Καταγραφής {#toc65}

Αυτό είναι ένα αναδυόμενο κουτί κειμένου που σας επιτρέπει να επιλέξετε τον όγκο καταγραφής του Aslan όταν αυτό εκτελείται.
...
##### Αυτόματη εκκίνηση του Aslan μετά την είσοδο στα Windows {#toc66}

Αν αυτή η επιλογή είναι ενεργοποιημένη, το Aslan θα ξεκινάει αυτόματα αμέσως μόλις κάνετε είσοδο στα Windows.
Αυτή η επιλογή είναι διαθέσιμη μόνο για εγκατεστημένα αντίγραφα του Aslan.

##### Χρήση του Aslan στην οθόνη εισόδου των Windows (απαιτεί δικαιώματα διαχειριστή) {#toc67}

Αν εισέρχεστε στα Windows δίνοντας ένα όνομα χρήστη (user name) και ένα συνθηματικό (password), τότε η ενεργοποίηση αυτής της επιλογής θα κάνει το Aslan να ξεκινάει αυτόματα και στην οθόνη εισόδου όταν αρχίζουν τα Windows.
Αυτή η επιλογή είναι διαθέσιμη μόνο για εγκατεστημένα αντίγραφα του Aslan.

##### Χρήση τρεχόντων αποθηκευμένων ρυθμίσεων στην είσοδο και σε άλλες οθόνες ασφαλείας (απαιτεί δικαιώματα διαχειριστή) {#toc68}

Με το πάτημα αυτού του κουμπιού, αντιγράφεται η τρέχουσα αποθηκευμένη διαμόρφωση χρήστη του Aslan στον φάκελο διαμόρφωσης συστήματος του Aslan, έτσι ώστε να την χρησιμοποιεί το Aslan όταν εκτελείται στις οθόνες εισόδου, Ελέγχου Λογαριασμού Χρήστη (UAC) και άλλες οθόνες ασφαλείας των Windows.
Για να είστε βέβαιοι ότι όλες οι ρυθμίσεις σας έχουν μεταφερθεί, φροντίστε ώστε πρώτα να αποθηκεύσετε την διαμόρφωση πατώντας control+Aslan+c ή την Αποθήκευση Διαμόρφωσης στο μενού του Aslan.
Αυτή η επιλογή είναι διαθέσιμη μόνο για εγκατεστημένα αντίγραφα του Aslan.

##### Αυτόματος έλεγχος ενημερώσεων του Aslan {#toc69}

Αν αυτή η επιλογή είναι ενεργοποιημένη, το Aslan θα ελέγχει αυτόματα για ενημερωμένες εκδόσεις του Aslan και θα σας πληροφορεί σχετικά.
Μπορείτε επίσης να ελέγχετε χειροκίνητα για ενημερώσεις επιλέγοντας Έλεγχος για νέα έκδοση κάτω από τη Βοήθεια στο μενού του Aslan.

#### Επιλογή Συνθέτη Ομιλίας (Aslan+control+s) {#toc70}

Ο διάλογος του Συνθέτη Ομιλίας, που βρίσκεται κάτω από το "Συνθέτης ομιλίας..." στο μενού Προτιμήσεις, σας επιτρέπει να επιλέξετε ποιό συνθέτη θα χρησιμοποιεί το Aslan για να μιλάει.
Μόλις επιλέξετε το συνθέτη της προτίμησης σας, μπορείτε να πατήσετε το OK και το Aslan θα τον φορτώσει προς χρήση.
Αν υπάρξει σφάλμα κατά τη φόρτωση του συνθέτη, το Aslan θα σας ενημερώσει με ένα μήνυμα και θα συνεχίσει χρησιμοποιώντας τον προηγούμενο συνθέτη.

##### Συνθέτης Ομιλίας {#toc71}

Αυτή η επιλογή σας επιτρέπει να διαλέξετε το συνθέτη που θέλετε να χρησιμοποιεί το Aslan για την έξοδο ομιλίας.

Για μία λίστα των συνθετών που υποστηρίζει το Aslan, δείτε τη παράγραφο [Υποστηριζόμενοι Συνθέτες φωνής](#SupportedSpeechSynths).

Ένα ειδικό στοιχείο που πάντα εμφανίζεται σε αυτή τη λίστα είναι το "Χωρίς ομιλία", που σας επιτρέπει να χρησιμοποιείτε το Aslan χωρίς έξοδο ομιλίας.
Κάτι τέτοιο μπορεί να είναι χρήσιμο για κάποιον που επιθυμεί να χρησιμοποιήσει το Aslan μόνο με συσκευή Braille, ή πιθανώς για βλέποντες προγραμματιστές που θέλουν να χρησιμοποιήσουν μόνο τον Προβολέα Ομιλίας.
...
Πλήκτρο: Aslan+shift+d

Στα windows 8 και μεταγενέστερα, αυτή η επιλογή σας επιτρέπει να διαλέξετε αν το aslan θα χαμηλώνει τον ήχο άλλων εφαρμογών όταν το aslan εκφωνεί κάτι, ή όλη την ώρα όσο το aslan τρέχει.

* Χωρίς βύθιση: Το aslan δεν θα χαμηλώνει ποτέ την ένταση άλλων ήχων.
* Βύθιση κατά την εκφώνηση και την αναπαραγωγή ήχων: Το aslan θα χαμηλώνει την ένταση άλλων ήχων μόνο όταν εκφωνεί κάτι ή παίζει ήχους. Αυτό ενδέχεται να μην δουλεύει με όλους τους συνθέτες.
* Πάντα βύθιση: Το aslan θα κρατήσει όλους τους άλλους ήχους χαμηλωμένους σε όλο το διάστημα κατά το οποίο τρέχει.

#### Ρυθμίσεις Φωνής (Aslan+control+v) {#VoiceSettings}
...
Αν χρησιμοποιείτε το συνθέτη eSpeak που έρχεται πακέτο μαζί με το Aslan, αυτό το αναδυόμενο κουτί κειμένου σας επιτρέπει να επιλέξετε μία Παραλλαγή με την οποία θα μιλήσει ο συνθέτης.
...
Ενεργοποιημένη εξορισμού, αυτή η επιλογή ορίζει στο aslan αν θα πρέπει να εμπιστεύεται την γλώσσα της τρέχουσας φωνής κατά την επεξεργασία συμβόλων ή χαρακτήρων.
Αν εντοπίσετε πως το aslan διαβάζει σημεία στίξης σε λάθος γλώσσα για έναν συνθέτη ή φωνή, μπορείτε να απενεργοποιήσετε αυτή την επιλογή για να αναγκάσετε το aslan να χρησιμοποιήσει την γενική ρύθμιση γλώσσας.
...
Αυτή η ρύθμιση είναι ένα κουτί επιλογής, το οποίο όταν είναι ενεργοποιημένο ορίζει στο Aslan να λέει τη λέξη "κεφαλαίο" μετά από κάθε κεφαλαίο γράμμα, όταν αυτό διαβάζεται σαν ένας ανεξάρτητος χαρακτήρας όπως στην περίπτωση της εκφώνησης ανά χαρακτήρα.
Συνήθως, το Aslan υψώνει λίγο τον τόνο σε κάθε κεφαλαίο γράμμα, αλλά μερικοί συνθέτες μπορεί να μην το υποστηρίζουν αυτό, οπότε αυτή η επιλογή μπορεί να χρησιμοποιηθεί.

##### Ήχος μπιπ για τα κεφαλαία {#toc87}

Αν αυτό το κουτί επιλογής είναι ενεργοποιημένο, το Aslan θα κάνει έναν μικρό ήχο μπιπ κάθε φορά που συναντάει ένα κεφαλαίο γράμμα μόνο του.
...
Αν θέλετε να κάνετε γρήγορα αλλαγές στις ρυθμίσεις του συνθέτη χωρίς να πηγαίνεται στο διάλογο των Ρυθμίσεων Φωνής, υπάρχουν κάποιες εντολές πλήκτρων του Aslan που σας επιτρέπουν καθώς τρέχετε το Aslan να κινείστε από οπουδήποτε ανάμεσα στις πιο συνηθισμένες ρυθμίσεις:
<!-- KC:beginInclude -->

| Όνομα |Πλήκτρο επιτραπέζιου Υπολογιστή |Πλήκτρο φορητού Υπολογιστή |Περιγραφή|
|---|---|---|---|
|Μετακίνηση στην επόμενη ρύθμιση συνθέτη |Aslan+control+δεξίΒέλος |Aslan+shift+control+δεξίΒέλος |Μετακινείται στην επόμενη μετά την τρέχουσα διαθέσιμη ρύθμιση της ομιλίας, κάνοντας κύκλο, αν τερματίσει, από την τελευταία ρύθμιση πάλι στην πρώτη.|
|Μετακίνηση στην προηγούμενη ρύθμιση συνθέτη |Aslan+control+αριστερόΒέλος |Aslan+shift+control+αριστερόΒέλος |Μετακινείται στην προηγούμενη μετά την τρέχουσα διαθέσιμη ρύθμιση της ομιλίας, κάνοντας κύκλο, αν φτάσει στην αρχή, από την πρώτη ρύθμιση πίσω στην τελευταία.|
|Αύξηση τρέχουσας ρύθμισης συνθέτη |Aslan+control+πάνωΒέλος |Aslan+shift+control+πάνωΒέλος |αυξάνει την τρέχουσα ρύθμιση ομιλίας στην οποία βρίσκεστε. Παράδειγμα, αυξάνει το ρυθμό, επιλέγει την επόμενη φωνή, αυξάνει την ένταση κλπ.|
|Μείωση τρέχουσας ρύθμισης συνθέτη |Aslan+control+κάτωΒέλος |Aslan+shift+control+κάτωΒέλος |μειώνει την τρέχουσα ρύθμιση ομιλίας στην οποία βρίσκεστε. Παράδειγμα, μειώνει το ρυθμό, επιλέγει την επόμενη φωνή, αυξάνει την ένταση κλπ.|
...
Ως προεπιλογή, το aslan χρησιμοποιεί αυτόματη ανίχνευση θύρας, που σημαίνει ότι η σύνδεση με την οθόνη braille θα γίνει αυτόματα ψάχνοντας για διαθέσιμες συσκευές usb ή bluetooth στο σύστημα σας.
Παρόλα αυτά, για ορισμένες οθόνες braille, ενδέχεται να μπορείτε να καθορίσετε ποια θύρα θα χρησιμοποιηθεί.
Συνήθης επιλογές είναι "Αυτόματη" (Η οποία λέει στο aslan να χρησιμοποιήσει την προεπιλεγμένη διαδικασία για αυτόματη επιλογή θύρας), "USB", "Bluetooth" και θύρες legacy serial communication αν η οθόνη braille σας υποστηρίζει τέτοιου είδους σύνδεσης.
...
Το aslan στο παρών στάδιο υποστηρίζει μόνο είσοδο braille για υπολογιστές, έτσι μόνο πίνακες braille σε οκτάστιγμα θα εμφανίζονται.
...
#### Ρυθμίσεις Πληκτρολογίου (Aslan+control+k) {#toc99}
...
Αυτό το αναδυόμενο κουτί κειμένου σας επιτρέπει να επιλέξετε τον τύπο της διάταξης πληκτρολογίου που θα χρησιμοποιεί το Aslan. Προς το παρόν οι δύο διαθέσιμες επιλογές είναι επιτραπέζιος Υπολογιστής (desktop) και Φορητός Υπολογιστής (laptop).

##### Χρήση του πλήκτρου Κλείδωμα Κεφαλαίων (Caps Lock) σαν το πλήκτρο τροποποιητή Aslan {#toc101}

Αν αυτό το κουτί επιλογής είναι τσεκαρισμένο, το πλήκτρο Κλείδωμα Κεφαλαίων (Caps Lock) θα χρησιμοποιείται σαν το πλήκτρο τροποποιητή Aslan.

##### Χρήση του Insert σαν το πλήκτρο τροποποιητή Aslan {#toc102}

Αν αυτό το κουτί επιλογής είναι τσεκαρισμένο, το πλήκτρο Insert (συνήθως βρίσκεται πάνω από τα πλήκτρα με τα βέλη, κοντά στο HOME και στο END) θα χρησιμοποιείται σαν το πλήκτρο τροποποιητή Aslan.

##### Χρήση του Insert του αριθμητικού πληκτρολογίου σαν το πλήκτρο τροποποιητή Aslan {#toc103}

Αν αυτό το κουτί επιλογής είναι τσεκαρισμένο, το πλήκτρο Insert του αριθμητικού πληκτρολογίου θα χρησιμοποιείται σαν το πλήκτρο τροποποιητή Aslan.

Αν δεν έχει οριστεί κανένα πλήκτρο σαν πλήκτρο τροποποιητή του aslan, ενδέχεται να είναι αδύνατο να έχετε πρόσβαση σε κάποιες εντολές του aslan.
...
Όταν είναι ενεργοποιημένο, το Aslan θα αναγγέλλει όλους τους χαρακτήρες που πατάτε στο πληκτρολόγιο.
...
Όταν είναι ενεργοποιημένο, το Aslan θα αναγγέλλει όλες τις λέξεις που γράφετε στο πληκτρολόγιο.
...
Όταν είναι ενεργοποιημένο, το Aslan αναγγέλλει όλα τα πλήκτρα που πατάτε και που δεν είναι χαρακτήρες. Αυτά περιλαμβάνουν συνδυασμούς πλήκτρων όπως το CONTROL μαζί με κάποιο άλλο γράμμα.

##### Διαχείριση εντολών από άλλες εφαρμογές {#toc111}

η επιλογή αυτή επιτρέπει στον χρήστη να ελέγξει αν πατήματα πλήκτρων που ορίζονται από εφαρμογές όπως εικονικά πληκτρολόγια οθόνης ή λογισμικά αναγνώρισης ομιλίας αν θα πρέπει να επεξεργάζονται από το aslan.
...
#### Ρυθμίσεις ποντικιού (Aslan+control+m) {#MouseSettings}
...
Όταν αυτό το κουτί επιλογής είναι τσεκαρισμένο, το Aslan αναγγέλλει το σχήμα του δείκτη του ποντικιού κάθε φορά που αλλάζει.
...
Όταν είναι ενεργοποιημένη, το Aslan αναγγέλλει το κείμενο που βρίσκεται κάτω από την τρέχουσα θέση του δείκτη ποντικιού. Αυτό σας επιτρέπει να βρίσκετε στοιχεία στην οθόνη, κουνώντας φυσικά το ποντίκι αντί να προσπαθείτε να τα βρείτε μέσω της πλοήγησης αντικειμένου.

##### Ανάλυση μονάδας κειμένου {#toc115}

Αν το Aslan είναι ρυθμισμένο να αναγγέλλει το κείμενο κάτω από το ποντίκι καθώς το κινείτε, αυτή η επιλογή σας επιτρέπει να επιλέξετε πόσο κείμενο θέλετε να εκφωνείται.
Οι επιλογές είναι χαρακτήρας, λέξη, γραμμή και παράγραφος.

##### Αναφορά ρόλου όταν το ποντίκι μπαίνει σε αντικείμενο {#toc116}

Όταν αυτό το κουτί επιλογής είναι τσεκαρισμένο, το Aslan αναγγέλλει τον ρόλο (τύπο) του αντικειμένου καθώς το ποντίκι κινείται μέσα του.

##### Αναπαραγωγή ακουστικών συντεταγμένων κατά την κίνηση του ποντικιού {#toc117}

Αν τσεκάρετε αυτό το κουτί επιλογής, το Aslan θα παίζει ήχους μπιπ καθώς θα κινείτε το ποντίκι, ώστε ο χρήστης να μπορεί να συμπεράνει που βρίσκεται το ποντίκι σε σχέση με τις διαστάσεις της οθόνης.
...
Όταν είναι ενεργοποιημένη, το Aslan φιλτράρει την ιεραρχία των αντικειμένων που δύναται να πλοηγηθούν, ώστε να αποκλείσει τα μη χρήσιμα αντικείμενα, όπως για παράδειγμα τα μη-ορατά αντικείμενα ή τα αντικείμενα που χρησιμοποιούνται για σκοπούς οπτικής διάταξης.

#### Ρυθμίσεις Παρουσίασης Αντικειμένου (Aslan+control+o) {#toc124}
...
Όταν αυτό το κουτί είναι επιλεγμένο, το Aslan αναφέρει τις επεξηγήσεις όπως εμφανίζονται.
...
Όταν αυτό το κουτί είναι επιλεγμένο, το Aslan αναφέρει τα μπαλόνια βοήθειας όπως εμφανίζονται.
...
Όταν αυτό το κουτί είναι επιλεγμένο, το Aslan συμπεριλαμβάνει στην αναφορά των αντικειμένων και των στοιχείων ελέγχου τα πλήκτρα συντόμευσης που συνδέονται με αυτά.
...
Αν η αναφορά της πληροφορίας θέσης αντικειμένου είναι ενεργοποιημένη, αυτή η επιλογή επιτρέπει στο Aslan να κάνει μία εικασία για την πληροφορία θέσης του αντικειμένου όταν αυτή δεν είναι διαθέσιμη με άλλο τρόπο για ένα συγκεκριμένο στοιχείο ελέγχου.

Όταν είναι ενεργοποιημένη, το Aslan αναφέρει την πληροφορία θέσης για περισσότερα στοιχεία ελέγχου όπως τα μενού και οι λωρίδες εργαλείων, ωστόσο αυτή η πληροφορία ενδέχεται να μην είναι ακριβής.
...
Αυτή η επιλογή ορίζει τον τρόπο με τον οποίο το Aslan θα αναφέρει τις ενημερώσεις Λωρίδων Προόδου σε εσάς.

Έχει τις ακόλουθες επιλογές:

* Απενεργοποιημένο: Οι Λωρίδες Προόδου δεν θα αναφέρονται όπως αλλάζουν.
* Εκφώνηση: Αυτή η επιλογή ορίζει στο Aslan να εκφωνεί τη Λωρίδα Προόδου σε ποσοστά. Κάθε φορά που αλλάζει η Λωρίδα Προόδου, το Aslan εκφωνεί τη νέα τιμή.
* Ήχος μπιπ: Αυτό ορίζει στο Aslan να αναπαράγει ένα μπιπ με αυξανόμενο τόνο κάθε φορά που αλλάζει η Λωρίδα Προόδου. Όσο υψηλότερος ο τόνος του μπιπ, τόσο η λωρίδα πλησιάζει την ολοκλήρωση.
* Ήχος μπιπ και εκφώνηση: Αυτή η επιλογή ορίζει στο Aslan να αναπαράγει ήχους μπιπ και να εκφωνεί τις αλλαγές της λωρίδας.

##### Αναφορά Λωρίδων Προόδου Υποβάθρου {#toc132}

Η επιλογή αυτού του κουτιού, ορίζει στο Aslan να εξακολουθεί να αναφέρει μία Λωρίδα Προόδου ακόμα και αν δεν είναι στο προσκήνιο.
Αν ελαχιστοποιήσετε ή φύγετε από ένα παράθυρο που περιέχει μία Λωρίδα Προόδου, το Aslan θα συνεχίσει να την παρακολουθεί και να την αναπαριστά, επιτρέποντας σας να κάνετε άλλες εργασίες όσο το Aslan παρακολουθεί την λωρίδα.
...
Αυτό το πλαίσιο διαλόγου σας επιτρέπει να ελέγξετε πώς το Aslan αναφέρει την είσοδο Ασιατικών χαρακτήρων, όπως με το INE  ή με μεθόδους εισόδου μέσω Υπηρεσιών Κειμένου.
...
Αυτή η επιλογή, που είναι ενεργοποιημένη από προεπιλογή, σας επιτρέπει να επιλέξετε αν το Aslan θα πρέπει να αναγγέλλει τον επιλεγμένο υποψήφιο, όταν εμφανίζεται μια λίστα υποψηφίων ή όταν αλλάζει η επιλογή.
...
Αυτή η επιλογή, που είναι ενεργοποιημένη από προεπιλογή, σας επιτρέπει να επιλέξετε αν το Aslan θα παρέχει μια σύντομη περιγραφή για κάθε χαρακτήρα σε έναν υποψήφιο, είτε όταν είναι επιλεγμένος είτε όταν γίνεται ανάγνωση αυτού, όταν εμφανίζεται η λίστα υποψηφίου.
...
Μπορείτε να επιλέξετε αν το Aslan θα πρέπει να αναγγέλλει νέους χαρακτήρες που εισάγονται σε αυτόν τον κώδικα ανάγνωσης, με αυτήν την επιλογή.
...
Αυτή η επιλογή σας επιτρέπει να επιλέξετε αν το Aslan θα πρέπει να αναφέρει τα νέα σύμβολα, καθώς εμφανίζονται στον κώδικα εισόδου.
Αυτή η επιλογή είναι ενεργοποιημένη από προεπιλογή.

#### Ρυθμίσεις Λειτουργίας Περιήγησης (Aslan+control+b) {#toc140}
...
Όταν είναι απενεργοποιημένη, αυτή η επιλογή ορίζει στο Aslan να αναφέρει μόνο πίνακες που περιέχουν δεδομένα (δηλαδή, όπου έχει νόημα να ξέρετε ότι αυτό είναι πίνακας).
Όταν είναι ενεργοποιημένη, το Aslan αναφέρει επίσης πίνακες που χρησιμοποιούνται αποκλειστικά για την οπτική διάταξη στοιχείων της σελίδας.
...
Η ενεργοποίηση αυτής της επιλογής επιτρέπει στο Aslan να εισέρχεται και να εξέρχεται από τη Λειτουργία Εστίασης όταν χρησιμοποιείτε τα πλήκτρα με τα βέλη.
Για παράδειγμα, αν σε μία ιστοσελίδα πηγαίνετε με τα βέλη προς τα κάτω και τοποθετηθείτε σε ένα κουτί επεξεργασίας κειμένου, το Aslan θα σας γυρίσει αυτόματα σε Λειτουργία Εστίασης. Αν με τα βέλη βγείτε έξω από το κουτί επεξεργασίας, το Aslan θα σας γυρίσει σε Λειτουργία Περιήγησης.

##### Ηχητική Ένδειξη των λειτουργιών Εστίασης και Περιήγησης {#toc149}

Αν αυτή η επιλογή είναι ενεργοποιημένη, το Aslan αναπαράγει ειδικούς ήχους όταν εναλλάσσει τις Λειτουργίες Περιήγησης και Εστίασης, αντί να εκφωνεί την αλλαγή.

##### Περιορισμός των χειρονομιών που δεν αφορούν σε εντολές για να μην επηρεάζεται το έγγραφο {#toc150}

Ενεργοποιημένη εξορισμού, η επιλογή αυτή σας επιτρέπει να επιλέξετε αν χειρονομίες (όπως πατήματα πλήκτρων) τα οποία δεν αποτελούν κάποια εντολή του aslan, και δεν θεωρούνται πλήκτρα εντολών γενικότερα, αν θα περιορίζονται στο να μεταβαίνουν στο έγγραφο στο οποίο εκείνη τη στιγμή εστιάζετε.
...
#### Ρυθμίσεις Μορφοποίησης Εγγράφων (Aslan+control+d) {#DocumentFormattingSettings}
...
Αν είναι ενεργοποιημένη, αυτή η επιλογή ορίζει στο Aslan να προσπαθεί να εντοπίσει όλες τις αλλαγές μορφοποίησης σε μία γραμμή καθώς τη διαβάζει, ακόμα και αν με τον τρόπο αυτό επιβραδύνεται η απόδοση του Aslan.

Εξ ορισμού, το Aslan θα εντοπίσει τη μορφοποίηση στη θέση του Κέρσορα Συστήματος / Δρομέα Εξέτασης, και σε μερικές περιπτώσεις μπορεί να εντοπίσει τη μορφοποίηση της υπόλοιπης γραμμής, μόνο αν κάτι τέτοιο δεν επιβαρύνει την απόδοση.
...
Το Aslan σας επιτρέπει να το κάνετε αυτό χρησιμοποιώντας τα προφίλ διαμόρφωσης.

Ένα προφίλ διαμόρφωσης περιλαμβάνει μόνο εκείνες τις ρυθμίσεις που έχουν αλλάξει κατά το χρόνο επεξεργασίας του προφίλ.
Οι περισσότερες ρυθμίσεις μπορούν να αλλάξουν, στα προφίλ διαμόρφωσης, με εξαίρεση αυτές στο πλαίσιο διαλόγου των γενικών ρυθμίσεων, οι οποίες αφορούν σε ολόκληρο το Aslan.
...
Μπορείτε να διαχειριστείτε τα προφίλ διαμόρφωσης, επιλέγοντας “Προφίλ διαμόρφωσης“ στο μενού του Aslan.
Εναλλακτικά, μπορείτε να χρησιμοποιήσετε την ακόλουθη εντολή:
<!-- KC:beginInclude -->

* Aslan+control+p: Εμφάνιση του πλαισίου διαλόγου για τα προφίλ διαμόρφωσης.
...
Οι φορητές εκδόσεις του Aslan αποθηκεύουν όλες τις ρυθμίσεις, τα προσαρμοσμένα appModules και τους προσαρμοσμένους οδηγούς σε ένα φάκελο που ονομάζεται userConfig, ο οποίος βρίσκεται στο φάκελο Aslan.

Οι εγκατεστημένες εκδόσεις του Aslan αποθηκεύουν όλες τις ρυθμίσεις, τα προσαρμοσμένα appModules και τους προσαρμοσμένους οδηγούς σε έναν ειδικό φάκελο του Aslan που βρίσκεται στο προφίλ χρήστη των Windows.
Αυτό σημαίνει ότι κάθε χρήστης στο σύστημα μπορεί να έχει τις δικές του ρυθμίσεις για το Aslan.
Για να μεταβείτε στο φάκελο των ρυθμίσεων για μια εγκατεστημένη έκδοση του Aslan, στο μενού Έναρξη πηγαίνετε στα Προγράμματα -> Aslan -> explore user configuration directory.

Οι ρυθμίσεις του Aslan, όταν τρέχει στις οθόνες σύνδεσης ή UAC, αποθηκεύονται στο φάκελο systemConfig, στο φάκελο εγκατάστασης του Aslan.
Συνήθως, αυτή η διαμόρφωση δε θα πρέπει να αγγίζεται.
Για να αλλάξετε τη διαμόρφωση του Aslan στις οθόνες σύνδεσης/UAC, διαμορφώστε το Aslan όπως επιθυμείτε, ενώ είστε συνδεδεμένοι στα Windows, αποθηκεύστε τη διαμόρφωση και πατήστε το κουμπί ”Χρήση αποθηκευμένων ρυθμίσεων στην οθόνη σύνδεσης και άλλες ασφαλείς οθόνες”, στο πλαίσιο διαλόγου Γενικές Ρυθμίσεις.

## Επιπλέον Εργαλεία {#toc161}
### Προβολέας Αρχείου Καταγραφής Συμβάντων {#toc162}

Ο προβολέας του αρχείου καταγραφής συμβάντων, που βρίσκεται κάτω από τα Εργαλεία στο μενού του Aslan, σας επιτρέπει να δείτε όλες τις εξαγωγές του αρχείου καταγραφής συμβάντων έως αυτή τη στιγμή από την τελευταία φορά που εκκινήσατε το Aslan..
...
Για προγραμματιστές χωρίς πρόβλημα όρασης ή ανθρώπους που παρουσιάζουν το Aslan σε κοινό χωρίς πρόβλημα όρασης, διατίθεται αναδυόμενο παράθυρο που σας επιτρέπει να δείτε όλο το κείμενο που εκφωνεί το Aslan τη δεδομένη στιγμή.

Για να ενεργοποιήσετε τον προβολέα εκφώνησης, επιλέξετε προβολέας εκφώνησης στα Εργαλεία υπό το μενού του Aslan.
...
Ωστόσο, αν κάνετε κλικ ή εστιάσετε εντός του προβολέα, το Aslan θα σταματήσει προσωρινά να ενημερώνει το κείμενο, έτσι ώστε εύκολα να μπορείτε να επιλέξετε ή να αντιγράψετε το τρέχον περιεχόμενο.

### Διαχειριστής Πρόσθετων {#toc164}

Ο διαχειριστής των πρόσθετων, ο οποίος ενεργοποιείται όταν επιλέξετε Διαχείριση Πρόσθετων κάτω από τα Εργαλεία στο μενού του Aslan, σας επιτρέπει να εγκαθιστάτε και να απεγκαθιστάτε πακέτα πρόσθετων για το Aslan.
Αυτά τα πακέτα προσφέρονται από την κοινότητα και περιέχουν κώδικα που μπορεί να προσθέσει ή να αλλάξει λειτουργίες για το Aslan ή ακόμα και να παρέχει υποστήριξη για επιπλέον οθόνες braille ή συνθέτες φωνής.

Ο διαχειριστής των πρόσθετων περιέχει μια λίστα που εμφανίζει όλα τα πρόσθετα που είναι εγκατεστημένα στη διαμόρφωση χρήστη του Aslan.
...
Αυτό το κουμπί ανοίγει τη σελίδα των πρόσθετων του Aslan https://addons.aslan-project.org/].
Αν το Aslan είναι εγκατεστημένο και τρέχει στο σύστημά σας, μπορείτε να ανοίξετε το πρόσθετο κατ’ ευθείαν από τον περιηγητή για να αρχίσει η διαδικασία εγκατάστασης, όπως περιγράφεται παρακάτω.
...
Αυτό θα σας επιτρέψει να αναζητήσετε ένα πακέτο πρόσθετου (αρχείο .aslan-addon) κάπου στον υπολογιστή σας ή σε κάποιο δίκτυο.
Όταν πατήσετε Άνοιγμα, η διαδικασία της εγκατάστασης θα αρχίσει.

Όταν γίνεται η εγκατάσταση ενός πρόσθετου, το Aslan θα σας ζητήσει αρχικά να επιβεβαιώσετε ότι πράγματι επιθυμείτε να εγκαταστήσετε το πρόσθετο.
Καθώς η λειτουργικότητα των πρόσθετων είναι απεριόριστη εντός του Aslan, το οποίο θεωρητικά μπορεί να σημαίνει πρόσβαση σε προσωπικά σας στοιχεία ή ακόμα και σε όλο το σύστημα, αν το Aslan είναι εγκατεστημένο αντίγραφο, είναι πολύ σημαντικό να εγκαθιστάτε πρόσθετα από πηγές που εμπιστεύεστε.
Όταν εγκατασταθεί το πρόσθετο, πρέπει να γίνει επανεκκίνηση του Aslan για να αρχίσει να τρέχει το πρόσθετο.
...
Το Aslan θα ρωτήσει αν πράγματι θέλετε να το κάνετε αυτό.
Όπως και με την εγκατάσταση, πρέπει να γίνει επανεκκίνηση του Aslan για να αφαιρεθεί πλήρως το πρόσθετο.
...
Αν έχετε εγκαταστήσει ή αφαιρέσει πρόσθετα, το Aslan αρχικά θα σας ρωτήσει αν θέλετε να γίνει επανεκκίνηση έτσι ώστε να ισχύσουν οι αλλαγές.

Στο παρελθόν ήταν δυνατό να επεκταθεί η λειτουργικότητα του Aslan με την αντιγραφή συγκεκριμένων πρόσθετων και οδηγών στο φάκελο της διαμόρφωσης χρήστη του Aslan.
Αν και η έκδοση αυτή του Aslan μπορεί ακόμα να τα φορτώνει, δε θα εμφανίζονται στο διαχειριστή των πρόσθετων.
...
Η κονσόλα Python του Aslan, που βρίσκεται στα Εργαλεία στο μενού του Aslan, είναι ένα αναπτυξιακό εργαλείο χρήσιμο για την αποσφαλμάτωση, τη γενική επιθεώρηση του εσωτερικού του Aslan ή την εξέταση της ιεραρχίας στην προσβασιμότητα μιας εφαρμογής.
Για περισσότερες πληροφορίες, παρακαλώ επισκεφθείτε το εγχειρίδιο για προγραμματιστές που διατίθεται στο τμήμα ανάπτυξης της σελίδας του Aslan https://community.aslan-project.org/wiki/Development].

### Επαναφόρτωση plugins {#toc166}

Αυτό το στοιχείο, όταν ενεργοποιηθεί, επαναφορτώνει modules εφαρμογών και καθολικά plugins χωρίς επανεκκίνηση του Aslan, το οποίο μπορεί να φανεί χρήσιμο στους προγραμματιστές.

## Υποστηριζόμενοι Συνθέτες φωνής {#SupportedSpeechSynths}

Αυτό το κεφάλαιο περιέχει πληροφορίες σχετικές με τους συνθέτες ομιλίας που υποστηρίζει το Aslan.
Για μία πιο πλήρη λίστα δωρεάν και εμπορικών συνθετών που μπορείτε να αγοράσετε και κατεβάσετε για να τους χρησιμοποιήσετε με το Aslan, παρακαλούμε δείτε τη σελίδα [https://www.aslan-project.org/wiki/ExtraVoices](https://www.aslan-project.org/wiki/ExtraVoices).

### eSpeak {#toc168}

Ο συνθέτης [eSpeak](https://espeak.sourceforge.net/) είναι απευθείας ενσωματωμένος στο Aslan και δεν απαιτεί άλλους ειδικούς οδηγούς ή συστατικά για να εγκατασταθεί.
Το Aslan εξ ορισμού χρησιμοποιεί τον eSpeak.
Καθώς αυτός ο συνθέτης είναι ενσωματωμένος στο Aslan, αυτή είναι μία πολύ καλή επιλογή για όταν τρέχετε το Aslan από ένα USB δισκάκι σε άλλο σύστημα.
...
Όταν χρησιμοποιείτε αυτό το συνθέτη με το Aslan, η λίστα των διαθέσιμων φωνών (προσβάσιμες από το [διάλογο Ρυθμίσεων Φωνής](#VoiceSettings) ή από τον [Δακτύλιο Ρυθμίσεων Συνθέτη](#SynthSettingsRing)) θα περιλαμβάνει όλες τις φωνές από όλες τις εγκατεστημένες μηχανές SAPI 4 στο σύστημα σας.

Αν έχετε εγκαταστήσει φωνές SAPI 4 αλλά ο συνθέτης δεν εμφανίζεται στη λίστα των συνθετών του Aslan, παρακαλούμε να εγκαταστήσετε το αρχείο εκτέλεσης του SAPI 4, διαθέσιο από τη διεύθυνση https://activex.microsoft.com/activex/controls/sapi/spchapi.exe.
...
Όταν χρησιμοποιείτε αυτό το συνθέτη με το Aslan, η λίστα των διαθέσιμων φωνών (προσβάσιμες από το [διάλογο Ρυθμίσεων Φωνής](#VoiceSettings) ή από τον [Δακτύλιο Ρυθμίσεων Συνθέτη](#SynthSettingsRing)) θα περιλαμβάνει όλες τις φωνές από όλες τις εγκατεστημένες μηχανές SAPI 5 στο σύστημα σας.
...
Αυτές οι φωνές μπορούν επίσης να χρησιμοποιηθούν με το Aslan.
...
Το τμήμα αυτό περιλαμβάνει πληροφορίες για τις οθόνες braille που υποστηρίζονται από το Aslan.
...
Αν το σύστημά σας τρέχει Windows 64 bit και οι οδηγοί είχαν ήδη εγκατασταθεί από άλλον αναγνώστη οθόνης, πιθανώς πρέπει να εγκαταστήσετε τους οδηγούς από τον παραπάνω σύνδεσμο, καθώς τα αρχεία που απαιτούνται από το Aslan μάλλον δεν έχουν εγκατασταθεί από τον άλλον αναγνώστη οθόνης. 

Από προεπιλογή, το Aslan μπορεί να εντοπίσει και να συνδεθεί σε αυτές τις οθόνες είτε μέσω USB είτε μέσω bluetooth. 
...
Αυτό μπορεί να είναι χρήσιμο αν θέλετε να συνδέσετε την οθόνη με το Aslan χρησιμοποιώντας bluetooth, αλλά να εξακολουθείτε να μπορείτε να τη φορτίσετε χρησιμοποιώντας USB ενέργεια από τον υπολογιστή σας.

Ακολουθούν οι αντιστοιχήσεις των πλήκτρων για την οθόνη Focus με το Aslan. 
...
|Μενού Aslan |brailleSpaceBar+κουκκίδα1+κουκκίδα3+κουκκίδα4+κουκκίδα5|
...
Απλά συνδέστε την οθόνη και διαμορφώστε το Aslan έτσι ώστε να τη χρησιμοποιήσει.

Ενώ οι οθόνες αυτές διαθέτουν braille πληκτρολόγιο, χειρίζονται οι ίδιες τη μετάφραση από το braille σε κείμενο. 
Ως εκ τούτου, η ρύθμιση του πίνακα εισαγωγής braille του Aslan δεν είναι ουσιώδης.

Ακολουθούν οι αντιστοιχήσεις των πλήκτρων για αυτή την οθόνη με το Aslan. 
...
Το Aslan υποστηρίζει όλες τις οθόνες της [Handy Tech](https://www.handytech.de/) όταν συνδεθούν μέσω USB ή bluetooth. 
...
Απλά συνδέστε την οθόνη και διαμορφώστε το Aslan έτσι ώστε να τη χρησιμοποιεί.
...
|Μενού Aslan |c1+c3+c4+c5 (command n)|
...
Το Aslan υποστηρίζει οθόνες Braille Sense και Braille EDGE displays από τη [Hims](https://www.hims-inc.com/) όταν συνδεθούν μέσω USB ή bluetooth. 
...
Παρότι στην περιοχή αυτή αναφέρεται μόνο το Window-Eyes, πρόκειται για ένα γενικό οδηγό USB που θα λειτουργήσει επίσης με το Aslan.

Ακολουθούν οι αντιστοιχήσεις των πλήκτρων για αυτές τις οθόνες με το Aslan. 
Παρακαλούμε να διαβάσετε την τεκμηρίωση της οθόνης για περιγραφές σχετικά με το πού μπορείτε να βρείτε αυτά τα πλήκτρα.
<!-- KC:beginInclude -->
...
Το Aslan υποστηρίζει την οθόνη SyncBraille Display από τη  [HIMS](https://www.hims-inc.com/).
...
Αν είναι εγκατεστημένο το  BrxCom, το Aslan θα χρησιμοποιήσει το BrxCom. 
...
Μια νέα έκδοση του BrxCom που λειτουργεί με το Aslan θα γίνει διαθέσιμη από τη Papenmeier σύντομα. 
...
Ακολουθούν οι εντολές  του Papenmeier για το Aslan:
<!-- KC:beginInclude -->
...
Το Aslan υποστηρίζει τη σειρά BrailleNote από τη [Humanware](https://www.humanware.com), όταν λειτουργεί ως οθόνη τερματικού για έναν αναγνώστη οθόνης. 
...
Αν η σύνδεσή σας υποστηρίζει περισσότερους από έναν τύπο σύνδεσης, όταν συνδέετε το BrailleNote στο Aslan, πρέπει να ορίσετε τη θύρα τερματικού braille στις ρυθμίσεις τερματικού braille. 
Παρακαλώ ελέγξτε το εγχειρίδιο του BrailleNote για λεπτομέρειες σχετικά με το Aslan. 
...
Ακολουθούν οι αντιστοιχήσεις των εντολών για το Aslan. 
...
Ακολουθούν οι αντιστοιχήσεις εντολών του BRLTTY για το Aslan. 
...
Το Aslan μπορεί να δεχθεί μία ή περισσότερες επιλογές κατά την εκκίνησή του, οι οποίες αλλάζουν τη συμπεριφορά του.
...
Οι επιλογές πρέπει να χωρίζονται από το όνομα του εκτελέσιμου αρχείου του Aslan και από άλλες επιλογές με διαστήματα.
Για παράδειγμα, η συντόμευση στην επιφάνεια εργασίας που δημιουργεί το Aslan κατά την εγκατάσταση, έχει την επιλογή -r η οποία λέει στο Aslan να κλείσει το τρέχον αντίγραφο πριν ξεκινήσει το νέο.
Μια άλλη χρήσιμη επιλογή είναι η --disable-addons, η οποία λέει στο Aslan να αναστείλει όλα τα τρέχοντα πρόσθετα.
...
Για παράδειγμα, μπορείτε να εξέλθετε από το τρέχον αντίγραφο του Aslan, εισάγοντας το παρακάτω στο παράθυρο διαλόγου εκτέλεση:
...
|aslan -rm |Με την εντολή αυτή πραγματοποιείται έξοδος από το τρέχον αντίγραφο του  Aslan και θα γίνει εκκίνηση ενός νέου αντιγράφου με απενεργοποιημένους τους ήχους εκκίνησης, κ.λπ.|
|aslan -rm --disable-addons |Το ίδιο με πριν, αλλά με απενεργοποιημένα τα πρόσθετα|
...
|aslan -l 10 |Λέει στο Aslan να αρχίσει με επίπεδο καταγραφής αποσφαλμάτωση|
|aslan --log-file=c:\aslan.log |Λέει στο Aslan να γράψει το αρχείο καταγραφής συμβάντων στο c:\aslan.log|
|aslan --log-level=20 -f c:\aslan.log |Λέει στο Aslan να αρχίσει με επίπεδο καταγραφής info και να γράψει το αρχείο καταγραφής συμβάντων στο c:\aslan.log|

Ακολουθούν οι επιλογές της γραμμής εντολών για το Aslan:

| Σύντομη |Εκτενής |Περιγραφή|
|---|---|---|
|-h |--help |Εμφάνιση βοήθειας γραμμής εντολών και έξοδος|
|-q |--quit |Κλείσιμο τρέχοντος αντιγράφου του Aslan|
|-r |--replace |Κλείσιμο τρέχοντος αντιγράφου του Aslan και έναρξη αυτού|
|-k |--check-running |Αναφορά αν το Aslan τρέχει μέσω του exit code; 0 αν ναι, 1 αν όχι|
...
|-c CONFIGPATH |--config-path=CONFIGPATH |Η διαδρομή στην οποία αποθηκεύονται όλες οι ρυθμίσεις του Aslan|
...
|None |--install |Εγκαθιστά το Aslan (εκκίνηση του πρόσφατα εγκατεστημένου αντιγράφου)|
|None |--install-silent |Εγκαθιστά σιωπηλά το Aslan (δεν ξεκινά το πρόσφατα εγκατεστημένο αντίγραφο)|
...
Για να γίνει αυτό, θα πρέπει να επεξεργαστείτε το αρχείο πληροφοριών προφοράς συμβόλων στο φάκελό σας της διαμόρφωσης χρήστη του Aslan.
Το αρχείο ονομάζεται symbols-xx.dic, όπου xx είναι ο κώδικας της γλώσσας.
Η μορφή αυτού του αρχείου καταγράφεται στο τμήμα Προφορά Συμβόλων (Symbol Pronunciation) στον οδηγό του Aslan για τους προγραμματιστές που βρίσκεται στο τμήμα ανάπτυξης στη σελίδα του Aslan https://community.aslan-project.org/wiki/Development].
Ωστόσο, δεν είναι δυνατό οι χρήστες να ορίσουν περίπλοκα σύμβολα.

## Περισσότερες Πληροφορίες {#toc192}

Αν χρειάζεστε περισσότερες πληροφορίες ή βοήθεια σχετικά με το Aslan, παρακαλούμε να επισκεφθείτε την ιστοσελίδα του Aslan στο Aslan_URL.
Εδώ μπορείτε να βρείτε επιπλέον τεκμηρίωση, καθώς και τεχνική υποστήριξη και πηγές της κοινότητας των χρηστών.
Αυτή η ιστοσελίδα παρέχει επίσης πληροφορίες και πηγές που αφορούν στην ανάπτυξη του Aslan.
...
|πλήκτρο τροποποίησης Aslan |Aslan modifier key|
|πλοήγηση |navigating|
|ρυθμιζόμενο |slider|
