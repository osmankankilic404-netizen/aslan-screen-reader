# Τι νέο υπάρχει στο aslan


## 2016.4

Στα σημαντικότερα σημεία αυτής της κυκλοφορίας συμπεριλαμβάνονται η βελτιωμένη υποστήριξη για το Microsoft Edge; η λειτουργία περιήγησης για την εφαρμογή Mail των Windows 10; και σημαντικές βελτιώσεις στα παράθυρα διαλόγου του Aslan.

### Νέα Χαρακτηριστικά

* Το Aslan τώρα μπορεί να αναφέρει την ύπαρξη εσοχής γραμμής χρησιμοποιώντας τόνους. Αυτό μπορεί να ρυθμιστεί χρησιμοποιώντας το αναδυόμενο κουτί Αναφορά Εσοχής Γραμμής στο παράθυρο διαλόγου Ρυθμίσεις Μορφοποίησης Εγγράφου του Aslan. (#5906)
...
* Διάφορα ζητήματα αναπλήρωσης και στοίχισης στα παράθυρα διαλόγου του Aslan έχουν αντιμετωπιστεί. (#6317, #5548, #6342, #6343, #6349)
...
* Στις ρυθμίσεις του Aslan για τη Μορφοποίηση Εγγράφου, η ”Αναγγελία αλλαγών στη μορφοποίηση μετά το δρομέα” έχει μετονομαστεί σε ”Αναφορά αλλαγών στη μορφοποίηση μετά το δρομέα”, επειδή επηρεάζει το braille όπως και την εκφώνηση. (#6336)
* Τροποποιήθηκε η εμφάνιση του “παραθύρου καλωσορίσματος” του Aslan. (#6350)
* Στα παράθυρα διαλόγου του Aslan τώρα τα κουμπιά ”ok" και ”Ακύρωση” είναι στοιχισμένα δεξιά στο παράθυρο διαλόγου. (#6333)
...
* Επιδιόρθωση σπάνιου ζητήματος κατά το οποίο στην έξοδο από το Aslan, με ανοιχτό τον προβολέα εκφώνησης, προέκυπτε σφάλμα. (#5050)
...
* Όταν πραγματοποιηθεί κλείσιμο από τη γραμμή εργαλείων ή τη συντόμευση Alt+F4, η κατάσταση του πλαισίου επιλογής για τον προβολέα εκφώνησης στο μενού του Aslan τώρα αντικατοπτρίζει την πραγματική ορατότητα του παραθύρου. (#6340)
...
* Στη λίστα γλωσσών στο παράθυρο διαλόγου των γενικών ρυθμίσεων του Aslan, γλώσσες όπως τα Αραγονικά τώρα εμφανίζονται σωστά στα Windows 10. (#6259)
* Τα προσομοιωμένα πλήκτρα συστήματος (π.χ. ένα κουμπί σε μια οθόνη braille που προσομοιώνει το πάτημα του πλήκτρου tab) παρουσιάζονται τώρα στην επιλεγμένη γλώσσα του Aslan στη βοήθεια εισόδου και στο παράθυρο διαλόγου για τις χειρονομίες εισόδου. Ως τώρα, παρουσιάζονταν στα Αγγλικά. (#6212)
* Η αλλαγή της γλώσσας του Aslan (στο παράθυρο διαλόγου Γενικές Ρυθμίσεις) τώρα δεν εφαρμόζεται έως ότου γίνει επανεκκίνηση του Aslan. (#4561)
...
* Είναι τώρα δυνατό να ορίσετε χειρονομίες για τις εντολές που αφορούν στον οδηγό για την οθόνη braille Handy Tech στο παράθυρο διαλόγου Χειρονομίες Εισόδου του Aslan. (#6461)
...
* Στο Microsoft Word, ο τίτλος ενός πίνακα αναφέρεται τώρα, αν έχει προστεθεί. Αν υπάρχει περιγραφή, μπορεί να αποκτήσει ο χρήστης πρόσβαση σε αυτή, χρησιμοποιώντας την εντολή για το άνοιγμα εκτενούς περιγραφής (Aslan+d) στη λειτουργία περιήγησης. (#5943)
* Στο Microsoft Word, το Aslan τώρα αναφέρει πληροφορίες θέσης όταν μετακινούνται οι παράγραφοι (alt+shift+κάτω βέλος και alt+shift+άνω βέλος). (#5945)
* Στο Microsoft Word, το διάστιχο γραμμής τώρα αναφέρεται μέσω της εντολής αναφοράς μορφοποίησης του Aslan, όταν αλλάζει με διάφορες συντομεύσεις του Microsoft word και όταν μετακινείται ο χρήστης σε κείμενο με διαφορετικό διάστιχο γραμμής, αν η Αναφορά Διάστιχου Γραμμής έχει ενεργοποιηθεί στις Ρυθμίσεις Μορφοποίησης Εγγράφου του Aslan. (#2961)
* Στον Internet Explorer, τα δομικά στοιχεία HTML5 τώρα αναγνωρίζονται. (#5591)
* Η αναφορά σχολίων (όπως στο Microsoft Word) μπορεί τώρα να απενεργοποιηθεί μέσω του πλαισίου επιλογής Αναφορά Σχολίων στο παράθυρο διαλόγου Ρυθμίσεις Μορφοποίησης Εγγράφου του Aslan. (#5108)
...
* Το Aslan τώρα αναφέρει τα χρώματα χρησιμοποιώντας ένα βασικό κατανοητό σύστημα 9 αποχρώσεων και 3 σκιάσεων, με διακυμάνσεις στη φωτεινότητα και την απαλότητα. Είναι προτιμότερο από το να χρησιμοποιούνται υποκειμενικά και λιγότερο κατανοητά ονόματα χρωμάτων. (#6029)
* Η ισχύουσα συμπεριφορά του Aslan+F9 και μετά Aslan+F10 έχει τροποποιηθεί ώστε να επιλέγεται το κείμενο στο πρώτο πάτημα του F10. Όταν το F10 πατηθεί δύο φορές (με γρήγορες διαδοχικές κινήσεις) το κείμενο αντιγράφεται στο πρόχειρο. (#4636)
...
* Στο Microsoft Word, το Aslan τώρα αναφέρει σωστές πληροφορίες όταν χρησιμοποιούνται οι εντολές του Word για την πλοήγηση σε πίνακα (alt+home, alt+end, alt+pageUp και alt+pageDown) και την επιλογή πίνακα (προστίθεται το Shift στις εντολές πλοήγησης). (#5961)
* Στα παράθυρα διαλόγου του Microsoft Word, η πλοήγηση αντικειμένου του Aslan έχει βελτιωθεί σημαντικά. (#6036)
...
* Στην εφαρμογή Mail των Windows 10, το Aslan δεν αποτυγχάνει πλέον να διαβάζει το περιεχόμενο των μηνυμάτων. (#5635)
...
* Στο Web Conference Plugin (όπως χρησιμοποιείται στο out-of-sight.net) το Aslan δεν αναπαράγει πλέον ήχους μπιπ και δεν εκφωνεί τις ενημερώσεις της γραμμής προόδου που σχετίζονται με ό,τι καταγράφει το μικρόφωνο. (#5888)
...
* Όταν γίνεται επεξεργασία των καταχωρήσεων στο λεξικό, ο χρήστης ενημερώνεται για μη έγκυρες συνήθεις εκφράσεις. Το Aslan δεν κρασάρει πλέον αν το λεξικό περιέχει μια μη έγκυρη συνήθη έκφραση. (#4834)
* Αν το Aslan δε μπορεί να επικοινωνήσει με μια οθόνη braille (π.χ. γιατί έχει αποσυνδεθεί), θα απενεργοποιήσει αυτόματα τη χρήση της οθόνης. (#1555)
* Έχει βελτιωθεί ελαφρώς το φιλτράρισμα στη λίστα στοιχείων στη λειτουργία περιήγησης, σε κάποιες περιπτώσεις. (#6126)
* Στο Microsoft Excel, τα μοτίβα παρασκηνίου που αναφέρει το Aslan ταιριάζουν τώρα με αυτά που χρησιμοποιούνται από το Excel. (#6092)
...
* Το Aslan εντοπίζει τώρα σωστά τα δευτερεύοντα κουμπιά δρομολόγησης στη σειρά οθονών braille ALVA BC640/680. (#5206)
* Το Aslan μπορεί ξανά να αναφέρει τις αναδυόμενες ειδοποιήσεις των Windows στις τελευταίες εκδόσεις των Windows 10. (#6096)
* Το Aslan σταματά πλέον να μην αναγνωρίζει πατήματα πλήκτρων σε συσκευές συμβατές με Baum και τις οθόνες braille HumanWare Brailliant B. (#6035)
* Αν έχει ενεργοποιηθεί η εμφάνιση αριθμών εκτός σύνδεσης στις Ρυθμίσεις Μορφοποίησης Εγγράφου του Aslan, η αρίθμηση των γραμμών εμφανίζεται τώρα στις οθόνες braille. (#5941)
* Όταν έχει απενεργοποιηθεί η εκφώνηση, η αναφορά αντικειμένων (π.χ. αν πατήσετε Aslan+tab για αναφορά εστίασης) τώρα εμφανίζεται στον προβολέα εκφώνησης όπως θα αναμενόταν. (#6049)
...
* Το Aslan δεν προκαλεί πλέον σφάλμα του Microsoft Word στα Windows XP μετά την εκκίνησή του. (#6033)
...
* Στο Microsoft Excel, το aslan τώρα αναφέρει το επίπεδο μιας ομάδας από κελιά, καθώς και αν είναι συνεπτυγμένη ή αναπτυγμένη. (#5690)
...
* Στο Microsoft Excel 2010 και νεότερο, η σκίαση των κελιών και τα μοτίβα του παρασκηνίου τώρα αναφέρονται. Η αυτόματη αναφορά ελέγχεται από την επιλογή Αναφορά Χρωμάτων στις Προτιμήσεις Μορφοποίησης Εγγράφου του Aslan. (#3683)
...
* Αν η αναφορά ορθογραφικών λαθών είναι ενεργοποιημένη και υποστηρίζεται στο στοιχείο ελέγχου που έχει εστίαση, το aslan θα αναπαράγει έναν ήχο για να σας προειδοποιήσει για ορθογραφικά λάθη που έγιναν κατά το γράψιμο. Αυτό μπορεί να απενεργοποιηθεί χρησιμοποιώντας την νέα ρύθμιση "να παίζει ήχος για ορθογραφικά λάθη κατά το γράψιμο" στις ρυθμίσεις πληκτρολογίου του aslan. (#2024)
* Γραμματικά σφάλματα τώρα αναφέρονται στο microsoft word. Αυτό μπορεί να απενεργοποιηθεί χρησιμοποιώντας την νέα ρύθμιση "Να αναφέρονται γραμματικά σφάλματα" στις προτιμήσεις μορφοποίησης εγγράφου του aslan. (#5877)

### Αλλαγές

* Στην λειτουργία περιήγησης και σε επεξεργάσιμα πεδία κειμένου, το aslan αντιμετωπίζει τώρα το αριθμητικό πλήκτρο του enter με τον ίδιο τρόπο όπως και το βασικό πλήκτρο του enter. (#5385)
* Το aslan έχει μεταβεί στον συνθέτη ομιλίας eSpeak NG. (#5651)
* Στο Microsoft Excel, το aslan δεν αγνοεί πλέον την επικεφαλίδα μίας στήλης όταν υπάρχει κενή γραμμή μεταξύ του κελιού και της επικεφαλίδας. (#5396)
...
* Στη λειτουργία περιήγησης, όταν επιχειρήσετε να χρησιμοποιήσετε την πλοήγηση χαρακτήρα για να μεταβείτε σε ένα στοιχείο που δεν υποστηρίζεται στο έγγραφο, το Aslan αναφέρει ότι δεν υποστηρίζεται αυτό, αντί να αναφέρει ότι δεν υπάρχει αυτό το στοιχείο σε αυτήν την κατεύθυνση. (#5691)
...
* το aslan δεν αναφέρει πλέον αχρείαστες πληροφορίες όταν γίνεται εναλαγή παραθύρων σε μια εφαρμογή java πολαπλών παραθύρων, όπως το IntelliJ ή το Android Studio. (#5732)
...
* Το aslan δεν κολλά πλέον μερικές φορές όταν γίνεται ενεργοποίηση της εξόδου braille. (#4457)
...
* Όταν γίνεται χρήση μιας οθόνης braille, πολλά μηνύματα του aslan που προηγουμένως μόνο αναγγέλλονταν τώρα εμφανίζονται επίσης και στο braille. (#5557)
...
* Στο google chrome και σε άλλους πλοηγούς που βασίζονται σε αυτό, μπορείτε τώρα να αναγκάσετε το aslan να μεταβεί σε λειτουργία περιήγησης σε διαδικτυακούς διαλόγους ή εφαρμογές. (#5818)
* Στο internet explorer και σε άλλα στοιχεία ελέγχου της microsoft, μετακινώντας την εστίαση σε συγκεκριμένα στοιχεία, το aslan δεν μεταβαίνει λανθασμένα σε λειτουργία περιήγησης. Αυτό συνέβαινε για παράδειγμα όταν γινόταν μετακίνηση σε εισηγήσεις σε πεδία διευθύνσεων όταν γινόταν σύνθεση μηνύματος στο gmail. (#5676)
* Στο Microsoft word, το aslan δεν παγώνει πλέον σε μεγάλους πίνακες όταν η αναφορά επικεφαλίδων για στήλες και γραμμές είναι ενεργοποιημένη. (#5878)
...
* Τα μέρη του aslan που είναι γραμμένα σε γλώσσα C++ τώρα κτίζονται με το Microsoft Visual Studio 2015. (#5592)
...
* Το aslan τώρα μπορεί να συνδεθεί με την οθόνη braille HIMS Smart Beetle μέσω bluetooth. (#5607)
* Το aslan μπορεί κατ επιλογή να χαμηλώνει τους υπόλοιπους ήχους όταν εγκατασταθεί σε windows 8 και μεταγενέστερα. Αυτό μπορεί να καθοριστεί χρησιμοποιώντας την επιλογή κατάστασης βύθισης ήχου στον διάλογο ρυθμίσεων συνθέτη του aslan ή πατώντας Aslan+shift+d. (#3830, #5575)
...
* Το aslan δεν κλείνει πλέον αθόρυβα όταν κλείνουμε ένα παράθυρο κονσόλας εντολών με alt+f4 στα windows 10. (#5343)
...
* Όταν γίνεται εστίαση σε ένα εναλλασσόμενο κουμπί, το aslan τώρα αναφέρει όταν αλλάζει από πιεσμένο σε μη πιεσμένο. (#5441)
...
* Το aslan δεν αποτυγχάνει πλέον να εμφανίσει σχόλια στην λίστα στοιχείων στο microsoft excel, αν ένα σχόλιό βρίσκεται σε ενοποιημένα κελιά. (#5704)
* Σε μια πολύ ασυνήθιστη περίπτωση, το aslan δεν αποτυγχάνει πλέον να διαβάσει περιεχόμενο φύλου στο microsoft excel όταν η αναφορά επικεφαλίδων στήλων και γραμμών είναι ενεργοποιημένη. (#5705)
...
* Το Aslan τώρα εμφανίζεται στο Κέντρο διευκόλυνσης πρόσβασης στα windows 8 και μεταγενέστερα. (#308)
* Όταν μετακινούμαστε ανάμεσα στα κελιά στο excel, αλλαγές μορφοποίησης τώρα αναφέρονται αυτόματα αν οι ανάλογες επιλογές είναι ενεργοποιημένες στο πλαίσιο διαλόγου Ρυθμίσεις Μορφοποίησης Εγγράφου του aslan. (#4878)
* Η επιλογή Αναφορά Έμφασης έχει προστεθεί στο πλαίσιο διαλόγου Ρυθμίσεις Μορφοποίησης του aslan. Ενεργοποιημένη από προεπιλογή, η επιλογή αυτή επιτρέπει στο aslan αυτόματα να αναφέρει την ύπαρξη κειμένου με έμφαση σε έγγραφα. Μέχρι τώρα, μόνο τα tags em και strong υποστηρίζονται στη Λειτουργία Περιήγησης για τον internet explorer και άλλα στοιχεία ελέγχου της microsoft. (#4920)
...
* Microsoft excel: Η εμφάνιση σε λίστα καθώς και η δυνατότητα μετονομασίας φύλλων είναι τώρα δυνατή από τη λίστα στοιχείων του aslan (aslan+f7). (#4630, #4414)
...
* Στο microsoft excel, το aslan τώρα αναφέρει τυχόντα μηνύματα εισόδου που έχουν σταλεί από το συγγραφέα του φύλλου στα κελιά. (#5051)
...
* Η επιλογή Αναφορά Αναθεωρήσεων Συντάκτη στο πλαίσιο διαλόγου Μορφοποίηση Εγγράφου του aslan είναι τώρα ενεργοποιημένη από προεπιλογή. (#4920)
...
* Διόρθωση της οπτικής εμφάνισης των κουμπιών στο προειδοποιητικό πλαίσιο διαλόγου που εμφανίζεται όταν προσπαθείτε να υποβαθμίσετε το aslan. (#5325)
* Στα windows 8 και μεταγενέστερα, το aslan τώρα ξεκινά πολύ γρηγορότερα, όταν είναι ρυθμισμένο να ξεκινά μετά την είσοδο στα windows. (#308)
 * Αν το ενεργοποιήσατε αυτό χρησιμοποιώντας μια προηγούμενη έκδοση του aslan, θα χρειαστεί να το απενεργοποιήσετε και να το ενεργοποιήσετε ξανά για να τεθεί σε ισχύ αυτή η αλλαγή. Ακολουθήστε αυτή τη διαδικασία:
  1. Ανοίξτε το πλαίσιο διαλόγου Γενικές Ρυθμίσεις.
  1. Αποεπιλέξτε την επιλογή Αυτόματη εκκίνηση του aslan μετά τη σύνδεσή μου στα windows.
  1. Πατήστε το κουμπί OK.
  1. Ανοίξτε ξανά το πλαίσιο διαλόγου Γενικές Ρυθμίσεις.
  1. Μαρκάρετε την επιλογή Αυτόματη εκκίνηση του aslan μετά τη σύνδεσή μου στα windows.
  1. Πατήστε το κουμπί OK.
* Βελτιώσεις στην απόδοση του UI Automation που συμπεριλαμβάνουν τον πλοηγό αρχείων ή την προβολή εργασιών. (#5293)
* Το aslan τώρα σωστά μεταβαίνει σε λειτουργία εστίασης όταν συναντάτε, χρησιμοποιώντας το πλήκτρο tab, ένα πλέγμα κουμπιών ελέγχου μόνο για ανάγνωση στη λειτουργία περιήγησης στο Mozilla Firefox, και άλλα κουμπιά ελέγχου Gecko. (#5118)
* Το aslan τώρα αναφέρει ορθά ότι "Δεν υπάρχει προηγούμενο" αντί για "δεν υπάρχει επόμενο", όταν δεν υπάρχουν άλλα αντικείμενα κατά τη σάρωση αριστερά σε κάποια οθόνη αφής.
...
* Το aslan δεν παγώνει σε κάποιες περιπτώσεις, όταν γίνεται επανασύνδεση της οθόνης braille HumanWare Brailliant BI/B series μέσω usb. (#5406)
...
* Το aslan δε θα παγώνει πλέον περιστασιακά όταν καλείτε το μενού έναρξης στα windows 10. (#5417)
...
* Το aslan τώρα αναφέρει σωστά την εστίαση όταν κλείνουν αναδυόμενα μενού σε μερικές εφαρμογές όπως το jarte. (#5302)
...
* Στη λειτουργία περιήγησης, μπορείτε τώρα να ενεργοποιήσετε ή να απενεργοποιήσετε την πλοήγησή ενός γράμματος πατώντας aslan+shift+διάστημα. Όταν είναι απενεργοποιημένη, τα πλήκτρα πλοήγησης ενός γράμματος περνούν κατευθείαν στην εφαρμογή, το οποίο είναι χρήσιμο για κάποιες διαδικτυακές εφαρμογές όπως το gmail, το twitter και το facebook. (#3203)
...
* όταν επιχειρήσετε να εγκαταστήσετε μια προηγούμενη έκδοση του aslan από εκείνη που είναι είδη εγκατεστημένη, θα προειδοποιηθείτε ότι αυτό δεν συνιστάται και πως το aslan θα πρέπει να απεγκατασταθεί πριν συνεχίσετε. (#5037)
...
* Στον Firefox, το Aslan δεν αναφέρει πλέον λανθασμένα το περιεχόμενο περιοχής καρτέλας όταν εστιάζετε εντός αυτής της περιοχής. (#4638)
...
* Όταν μια εφαρμογή ανταποκρίνεται πολύ αργά και μεταβείτε  εκτός αυτής, τώρα το aslan είναι πολύ καλύτερο στην απόκριση του σε άλλες εφαρμογές στις πλείστες των περιπτώσεων. (#3831)
...
* Στην οθόνη κλειδώματος των windows 10, δεν είναι πλέον δυνατή η ανάγνωση του πρόχειρου, η πρόσβαση σε τρέχουσες εφαρμογές με το δρομέα επανεξέτασης, η αλλαγή της διαμόρφωσης του aslan και άλλα. (#5269)
