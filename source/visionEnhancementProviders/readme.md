...
Aslan contains the following built-in vision enhancement providers:

* Aslan Highlighter which will react to changes in focus and draw a rectangle outline around the focused object.
...
See the AslanHighlighter module as an example.
EG:
...
For an example see AslanHighlighter.
