...
"""Provides access to built-in Aslan modules where they have been overridden by third party modules.
...
it can do this by importing aslanBuiltin.appModules.skype.
"""
